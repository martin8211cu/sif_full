...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisCFuncional#Attributes.name##Attributes.index#() {
		...
		popUpWindow#Attributes.name##Attributes.index#("/cfmx/home/menu/portlets/indicadores/ConlisCFuncional.cfm"+params,250,200,650,460);
	...
	function TraeCFuncional#Attributes.name##Attributes.index#(dato) {
		var params ="";
		params = "&id=#Attributes.id##Attributes.index#&name=#Attributes.name##Attributes.index#&desc=#Attributes.desc##Attributes.index#&conexion=#Attributes.conexion#&ecodigo=#Session.Ecodigo#&excluir=#Attributes.excluir#";
		if (dato != "") {
			document.getElementById("#Attributes.frame##Attributes.index#").src="/cfmx/home/menu/portlets/indicadores/rhcfuncionalquery.cfm?dato="+dato+"&form="+"#Attributes.form#"+params;
		}
		else{
...
<table width="" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td>
			<a href="##" tabindex="-1">
				<img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Centros Funcionales" name="imagen" 
				...
				<input type="hidden" name="#Attributes.id#Ocodigo" value="" >
				<input type="hidden" name="#Attributes.id#Dcodigo" value="" >
		</td>
	</tr>
</table>
<iframe name="#Attributes.frame##Attributes.index#" id="#Attributes.frame##Attributes.index#" 
		...
		src="" style="visibility:hidden;"></iframe>
