...
<cfquery datasource="#session.DSN#" name="items" cachedwithin="#CreateTimeSpan(0,0,-10,0)#" >
	select
			...
			coalesce((	select VSdesc
						...
						where Iid     = #translate_idioma.Iid#
						  and VSgrupo = 124
						  and VSvalor = <cf_dbfunction name="to_char" args="m.id_item"> ), m.etiqueta_item) as etiqueta
	from SRelacionado r
			join SMenuItem m
...
stm_bp("p0",[0,4,0,0,1,3,13,13,100,"",-2,"",-2,90,0,0,"##7F7F7F","##06437D","",3,0,0,"#Border_PopUpMenu#"]);

stm_ai("p0i0",[0,"<strong>Inicio</strong>","","",-1,-1,0,"/cfmx/","_self","","","","",0,0,0,"","",0,0,0,2,1,"##FFFFFF",1,"##FFFFFF",1,"","",3,3,0,0,"##FFFFFF","##FFFFFF","##FFFFFF","#MouseOver_MenuItem#","#FontOut#","#FontOver#",0,0]);
...
stm_aix("p1i0","p0i0",[1,"Organizar Mis Favoritos","","",-1,-1,0,"/cfmx/home/menu/portlets/shortcut_edit.cfm","_self","","","","",0,0,0,"","",0,0,0,0,1,"#Submenu_Background#",0,"#MouseOver_MenuItem#",0,"","",3,3,0,0,"#Submenu_ColorLetra#","#Submenu_ColorLetra#","#Submenu_ColorLetra#","#Submenu_ColorLetra#"]);
stm_aix("p1i1","p0i0",[1,"Personalizar esta página","","",-1,-1,0,"/cfmx/home/menu/portlets/indicadores/personalizar.cfm","_self","","","","",0,0,0,"","",0,0,0,0,1,"#Submenu_Background#",0,"#MouseOver_MenuItem#",0,"","",3,3,0,0,"#Submenu_ColorLetra#","#Submenu_ColorLetra#","#Submenu_ColorLetra#","#Submenu_ColorLetra#"]);
...
<cfloop query="items" >
	...
	<cfif items.profundidad gt 1 >
		<cfquery name="es_padre" dbtype="query">
			select * from items where papa = #items.item#
		</cfquery>
		<cfif es_padre.recordcount gt 0 >
