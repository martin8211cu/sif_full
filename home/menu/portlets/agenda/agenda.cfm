...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Calendario" Default="Calendario" returnvariable="LB_Calendario"/> 
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Horario" Default="Horario" returnvariable="LB_Horario"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Mi_Agenda" Default="Mi Agenda" returnvariable="LB_Mi_Agenda"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_RecursosHumanos" Default="Recursos Humanos" XmlFile="/sif/rh/generales.xml" returnvariable="LB_RecursosHumanos"/>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="20%" cellpadding="0" cellspacing="0">
                                                                    <td width="1%" align="right" valign="middle"><a href="Horario.cfm" target="_top" title="<cf_translate key='Modificar mi Horario'>Modificar mi Horario</cf_translate>"><img border="0" src="ftv4doc.gif" alt="<cf_translate key='Modificar mi Horario'>Modificar mi Horario</cf_translate>"></a></td>
                                                                    <td align="left" nowrap valign="middle"><a href="Horario.cfm" target="_top" title="<cf_translate key='Modificar mi Horario'>Modificar mi Horario</cf_translate>"><strong><cf_translate key='Modificar mi Horario'>Modificar mi Horario</cf_translate></strong></a></td>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    </table>
