<%--
	No esta sirviendo, puede ser que no este activado en el ICE como enviar los mensajes.
	danim,25/01/2005
--%><%@ page import="
 java.io.*,
...
%><%@ include file="sms-util.jsp" %><%@ include file="sms-config.jsp" %><%
	try {
		...
		addressRange.setTon(sourceTon);
		addressRange.setNpi(sourceNpi);
		addressRange.setAddressRange(sourceAddressRange);
