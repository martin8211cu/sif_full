...
<form name="form1" method="post" action=""><input type="hidden" name="go">
  <table border="1">
    <tr align="center">
      <th colspan="2"><strong>Revocar Permiso</strong></th>
    </tr>
    <tr>
    ...
    <tr align="center">
      <td colspan="2"><input name="go" type="submit" id="go" value="Revocar Permiso"></td>
    </tr>
  </table>
</form>

<cfif isdefined("form.go")>
	<strong>Revocar Permiso #form.agenda#</strong><br>
	<code>#agenda.RevocarPermiso(form.agenda,form.Usucodigo,form.permiso)#</code><br><br>
</cfif>
