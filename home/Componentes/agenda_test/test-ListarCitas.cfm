...
<form name="form1" method="post" action=""><input type="hidden" name="go">
  <table border="1">
    <tr align="center">
      <th colspan="2"><strong>Listar Citas </strong></th>
    </tr>
    <tr>
    ...
    <tr align="center">
      <td colspan="2"><input name="go" type="submit" id="go" value="Listar Citas"></td>
    </tr>
  </table>
</form>
...
<cfif isdefined("form.go")>
	...
	<!--- dd/mm/yyyy --->
	<strong>Listar Citas (#form.agenda#, #LSParseDateTime(form.fecha)#)</strong><br>
	<cfdump var="#agenda.ListarCitas(form.agenda,LSParseDateTime(form.fecha))#"><br><br>
</cfif>
