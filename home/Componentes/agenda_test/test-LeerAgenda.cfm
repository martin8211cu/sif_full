...
<form name="form1" method="post" action=""><input type="hidden" name="go">
  <table border="1">
    <tr align="center">
      <th colspan="2"><strong>Leer agenda </strong></th>
    </tr>
    <tr>
      <td>Agenda</td>
    ...
    <tr align="center">
      <td colspan="2"><input name="go" type="submit" id="go" value="Leer agenda"></td>
    </tr>
  </table>
</form>
...
<cfif isdefined("form.go")>
	<strong>Leer agenda #form.agenda#</strong><br>
	<cfdump var="#agenda.LeerAgenda(form.agenda)#"><br><br>
</cfif>
