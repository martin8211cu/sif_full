...
<cfparam name="form.propietario" default="">
...
<form name="form1" method="post" action=""><input type="hidden" name="go">
  <table border="1">
    <tr align="center">
      <th colspan="2"><strong>Crear agenda </strong></th>
    </tr>
    <tr>
      <td>Tipo</td>
      <td><input type="text" name="tipo" value="#form.tipo#" onFocus="this.select()"></td>
    </tr>
    <tr>
      <td>Nombre Agenda </td>
    ...
    <tr>
      <td>Propietario</td>
      <td><input type="text" name="propietario" value="#form.propietario#" onFocus="this.select()"></td>
    </tr>
    <tr>
    ...
    <tr align="center">
      <td colspan="2"><input name="go" type="submit" id="go" value="Crear Agenda"></td>
    </tr>
  </table>
</form>

<cfif isdefined("form.go")>
	<strong>Creando agenda #form.nombre_agenda#</strong><br>
	<code>#agenda.CrearAgenda(form.tipo,form.nombre_agenda,
		form.propietario,form.horario_habil,form.escala)#</code><br><br>
</cfif>
