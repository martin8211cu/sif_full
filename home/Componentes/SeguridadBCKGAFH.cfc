...
<cfcomponent>
	...
	<!--- este bloque debería guardarse en cache o en session --->
		<cfinvoke component="Politicas" method="trae_parametro_global" parametro="auth.orden"
			returnvariable="ret"/>
		<cfif ret is '0'><cfset ret = 'asp'></cfif>
		<cfset This.PoliticaAuthOrden = ret>
	
		<cfinvoke component="Politicas" method="trae_parametro_global" parametro="auth.nuevo"
			returnvariable="ret"/>
	...
	<cffunction name="generarPassword" access="public" returntype="boolean" output="false" displayname="Generar Password"
		...
		<cfset return_status = Len(this.AUTHLOOP_CAMBIA_PASSWORD(arguments.Usucodigo, nuevo_password)) NEQ 0>
		<cfif Arguments.notificar_por_email>
			<cfset This.enviarPassword(Arguments.Usucodigo, nuevo_password)>
		</cfif>
	...
	<cffunction name="cambiarUsuario" access="public" returntype="boolean" output="false" displayname="Selecciona un usuario definitivo"
		...
		<cfset ret = Len(this.AUTHLOOP_CAMBIA_PASSWORD (session.Usucodigo, Arguments.nuevo_password, session.AUTHBACKEND)) NEQ 0>
		<cfreturn ret>
	</cffunction>
	...
	<cffunction name="infoUsuario" access="public" returntype="query" output="false" displayname="Obtiene informacion del usuario">
		...
		<cfquery datasource="asp" name="__infousuario_query">
			select
	...
	<cffunction name="crearUsuario" access="public" returntype="numeric" output="true" displayname="Crear usuario nuevo"
		...
		<cftransaction>
			<cfquery datasource="asp" name="nuevo_usuario">
			...
			<cf_dbidentity2 datasource="asp" name="nuevo_usuario">
		</cftransaction>
		
		<cfset This.generarPassword( nuevo_usuario.identity, Arguments.notificar_por_email )>
	...
	<cffunction name="getUsuarioByCodNoEmp" access="public" returntype="query" output="false" displayname="Obtiene Referencia por Usucodigo">
		...
		<cfquery datasource="asp" name="__infousuario_query">
			...
			from Usuario a, UsuarioReferencia b, DatosPersonales c
	...
	<cffunction name="getUsuarioByCod" access="public" returntype="query" output="false" displayname="Obtiene Referencia por Usucodigo">
		...
		<cfquery datasource="asp" name="__infousuario_query">
			...
			from Usuario a, UsuarioReferencia b, DatosPersonales c, Direcciones d
			where a.Usucodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Arguments.Usucodigo#">
			and a.Usucodigo = b.Usucodigo
	...
	<cffunction name="enviarPassword" access="public" returntype="boolean" output="true">
		...
		<cfset _user_info = This.infoUsuario('','',Arguments.Usucodigo)>
		...
		<cf_datospersonales action="select" key="#_user_info.datos_personales#" name="_user_datos_personales">
	...
	<cffunction name="login_incorrecto">
		...
		<cfquery datasource="aspmonitor">
			...
			values (
				...
				<cfqueryparam cfsqltype="cf_sql_numeric" value="#Arguments.CEcodigo#"  null="#Len(Trim(Arguments.CEcodigo))  EQ 0#">,
				<cfqueryparam cfsqltype="cf_sql_numeric" value="#Arguments.Usucodigo#" null="#Len(Trim(Arguments.Usucodigo)) EQ 0#">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value=" ">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#Arguments.uid#">,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#Arguments.razon#">,
				<cfqueryparam cfsqltype="cf_sql_integer" value="#LIcontador#">,
				<cfqueryparam cfsqltype="cf_sql_timestamp" value="#Libloqueo#" null="#Len(Trim(Libloqueo)) EQ 0#">)
		</cfquery>
	</cffunction>
	...
	<cffunction name="AUTHLOOP_AUTENTICAR" access="package" output="false" returntype="string"
			displayname="Itera sobre los backend validos, regresa el que funcionó">
		<cfargument name="Usucodigo" type="numeric" required="true">
