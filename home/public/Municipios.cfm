...
<form action="../Users/gpaz/Documents/Mis archivos recibidos/Municipios.cfm" enctype="multipart/form-data" method="post">
	...
	<cftry>
		<cfloop condition="true">
			...
			<cfif rsExiste.existe gt 0>
				...
				Ya ha sido agregado <strong>#cols[3]# - #cols[4]#</strong> con el padre <strong>#cols[2]#</strong><br>
				</div>
				</cfoutput>
			<cfelse>
				<cfquery datasource="asp">
					insert into DistribucionGeografica(NGid, DGidPadre, DGcodigo, DGDescripcion, BMfecha, BMUsucodigo)
					values(
						#rsNivel.NGid#,
						#rsPadre.DGid#,
						'#cols[3]#',
				...
				Se agrega <strong>#cols[3]# - #cols[4]#</strong> con el padre <strong>#cols[2]#</strong><br>
				</div>
				</cfoutput>
			</cfif>
			<cfflush>
		...
		<cfcatch type="any">
			...
			Error en  <strong>#cols[3]# - #cols[4]#</strong> con el padre <strong>#cols[2]#</strong><br>
			</div>
			</cfoutput>
		</cfcatch>
