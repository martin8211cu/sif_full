...
<cfset LvarEcodigo = 2> <!--- 1 Desarrollo, 2 Producción --->
...
<cfif isdefined('rsValida') and rsValida.cantidad GT 10>
	<cfoutput>este proceso ya fue corrido al menos una vez, proceso cancelado...</cfoutput><br>
	<cfabort>
</cfif>
    ...
    <cftransaction>
	    ...
	    <cfquery datasource="#session.DSN#">
                ...
                values(
                    ...
                    null,
                    #LvarMcodigo#,
                    <cfqueryparam cfsqltype="cf_sql_money" value="#LvarQPCmonto#">,
                    0,
                    #now()#,
                    <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsDatosVenta.QPTPAN#">,
                    'Venta TAG' #_Cat# ' ' #_Cat# '#rsDatosVenta.QPTPAN#'
