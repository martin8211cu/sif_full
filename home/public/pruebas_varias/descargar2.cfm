...
<cffile action="write" file="#ExpandPath("#nombreXls#")#" output="Reporte3">
...
<cfheader name="Content-Disposition" value="inline; filename='#nombreXls#'">  
    <cfcontent type="application/vnd.ms-excel" file="#ExpandPath("#nombreXls#")#"> 