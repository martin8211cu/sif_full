...
<cf_dbtemp name="Gctas_V1" returnvariable="CTAS" datasource="#session.dsn#" temp="false">
	<cf_dbtempcol name="id"				type="numeric"  	mandatory="yes" identity="true"> 
...
<cffunction name="fnProcesaMayor" output="yes" access="private">
