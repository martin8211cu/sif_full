<cfcomponent displayname="Application" output="true" hint="Handle the application.">
	...
	<cfsetting requesttimeout="3600" showdebugoutput="true" enablecfoutputonly="false"/>
	...
	<cffunction name="OnRequestStart" access="public" returntype="boolean" output="false" hint="Fires at first part of page processing.">
		...
		<cfargument name="TargetPage" type="string" required="true"/>
			...
			<cfinclude template="/home/check/globalfunctions.cfm">
			<!--- <cfinclude template="/home/check/cache_app.cfm"> --->
	...
	<cffunction name="OnRequest" access="public" returntype="void" output="true" hint="Fires after pre page processing is complete.">
		...
		<cftry>
			<cfquery name="rsConfig" datasource="#session.DSN#" debug="no">
				...
				<!--- danim 2023-12-15.  TargetPage incluye "/cfmx" según la configuración del server.
					Usaremos endsWith para que no genere loop entre passch y wizBienvenida con usuario y empresa nuevas --->
				<cfif (rsConfig.recordCount LT 1 or rsConfig.Pvalor neq 'S')
				and !ARGUMENTS.TargetPage.endsWith("/home/public/logout.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/home/menu/passch.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/sif/ad/config/wizBienvenida.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/sif/ad/config/wizGeneral01.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/sif/ad/config/wizGeneral02.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/sif/ad/config/wizConfirma.cfm")
				and !ARGUMENTS.TargetPage.endsWith("/sif/ad/config/wizGeneralSQL.cfm")
				and isdefined("Session.Usucodigo") and Session.Usucodigo GT 1 and Session.CEcodigo GT 1>
					<!--- <cf_dump var="#ARGUMENTS.TargetPage#"> --->
					<!--- <cfinclude template="/sif/ad/config/wizBienvenida.cfm"> --->
					<cflocation url="/cfmx/sif/ad/config/wizBienvenida.cfm?from=Application.cfc&TargetPage=#Arguments.TargetPage#">
