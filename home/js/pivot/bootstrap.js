...
OAT.Loader.Files = { /* only those whose names differ */
	gmaps:"/cfmx/commons/js/pivot/customGoogleLoader.js",
	ymaps:"/cfmx/commons/js/pivot/customYahooLoader.js",
	openlayers:"/cfmx/commons/js/pivot/OpenLayers.js",
	gapi:"/cfmx/commons/js/pivot/gmapapi.js"
}
...
OAT.LoaderTMP = { /* second part of loader */
	...
	loadFeatures:function(features,callback) { /* load all these features and execute callback */
		...
		allNames.push('svg');
		allNames.push('graphsvg');
		
		allNames.push('canvas');
		allNames.push('sparkline');
		allNames.push('linechart');
		/* distinct values */
		var distinct = {};
