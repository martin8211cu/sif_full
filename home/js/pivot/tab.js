/*
 *  $Id: tab.js,v 1.7 2007/05/18 12:03:38 source Exp $
 *
...
OAT.TabPart = function(clicker, mover, parent) {
	var self = this;
	this.key = $Fred(clicker);
	this.value = $Fred(mover);
	this.window = false;
	this.parent = parent;
...
OAT.Tab = function(elm,optObj) {
	...
	self.options.dockElement = $Fred(self.options.dockElement);
