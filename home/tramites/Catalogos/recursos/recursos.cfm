		...
		<td valign="top" width="40%">	
					...
					<td nowrap>
						<cf_tabs>
							<cf_tab text="Recurso" id="req1" selected="#form.tabreq is 'req1'#">
								<cfinclude template="recursos-form.cfm">						
							</cf_tab>
									  ...
									  <tr>
										<td width="40%" valign="top">
											...
											returnvariable="pListaRet">
												...
												<cfinvokeargument name="etiquetas" value="Fecha<br>Desde,Fecha<br>Hasta,Hora<br>Desde,Hora<br>Hasta"/>												
										...
										<td width="60%" valign="top"><cfinclude template="agenda-form.cfm"></td>
									  </tr>
									</table>
								</cf_tab>
							</cfif>
			...
			<cfelse>
				...
				returnvariable="pListaRet">
					...
					<cfinvokeargument name="filtro" value="getDate() between r.vigente_desde and r.vigente_hasta order by id_tiporecurso,id_sucursal"/>
					<cfinvokeargument name="desplegar" value="codigo_recurso,nombre_recurso,nombre_sucursal"/>
					<cfinvokeargument name="etiquetas" value="C&oacute;digo,Recurso,Sucursal"/>
				...
				<script language="javascript" type="text/javascript">
					function funcNuevo(){
						document.lista.TAB.value = 8;
						document.lista.ID_INST.value = <cfoutput>#form.id_inst#</cfoutput>;		
					}				
