...
<cfif modo EQ "CAMBIO">
	<cfset titulo = rsTipoDato.nombre_tipo & Iif(Len(Trim(rsTipoDato.tipo)), DE(" : "), DE("")) & rsTipoDato.tipo>
<cfelseif isdefined("Form.tab") and Form.tab EQ 1>
	<cfset titulo = "Agregar un nuevo tipo de dato">
<cfelse>
	<cfset titulo = "Seleccione un tipo de dato">
</cfif>
