<cfif isdefined("Form.id_inst") and Len(Trim(Form.id_inst)) and isdefined("Form.id_funcionario") and Len(Trim(Form.id_funcionario))>
	...
	<cfquery name="rsDatos" datasource="#session.tramites.dsn#">
		select a.id_inst, a.id_funcionario,
			   b.ventanilla_default, b.funcionario_default,
			   c.id_ventanilla, c.codigo_ventanilla, c.nombre_ventanilla,
			   d.id_inst, d.id_sucursal, d.id_direccion, d.codigo_sucursal, d.nombre_sucursal, d.horario_sucursal
		from TPFuncionario a
			inner join TPRFuncionarioVentanilla b
				on b.id_funcionario = a.id_funcionario
			inner join TPVentanilla c
				on c.id_ventanilla = b.id_ventanilla
			inner join TPSucursal d
		  ...
		  <cfelse>
			  ...
			  <tr>
				<td colspan="2" align="center">
					<strong>El funcionario no esta asignado a ninguna ventanilla</strong>
				</td>
			  </tr>
		  </cfif>
		  <tr>
