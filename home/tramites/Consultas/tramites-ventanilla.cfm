...
<cf_template>
	...
	<cf_templatearea name="body">
		<cf_web_portlet_start titulo="Lista de Tr&aacute;mites">
					...
					<td colspan="4">
						...
						<table width="100%" cellpadding="2" cellspacing="0" class="areaFiltro">
							<tr>
								...
								<td style="width:10% " align="right" width="1px">
							...
							<tr>
								...
								<td align="right" nowrap><strong>Ventanilla:&nbsp;</strong></td>
								<td>
									<select name="id_ventanilla" >
										<option value="">-todos-</option>
										<cfoutput query="rsVentanillas">
											<option value="#rsVentanillas.id_ventanilla#" <cfif isdefined("form.id_ventanilla") and form.id_ventanilla EQ rsVentanillas.id_ventanilla>selected</cfif>>#rsVentanillas.nombre_ventanilla#</option>
										</cfoutput>
									</select>
								</td>
							</tr>
							...
							<tr>
								...
								<td><cfinclude template="../vistas/filtro_persona.cfm"></td>
								<td colspan="2" align="right"><input type="submit" name="Filtrar" value="Filtrar">
			...
			<!--
				...
				function limpiar(){
					...
					document.filtro.id_ventanilla.value = '';
