...
<cfif isdefined("url.id_registro") and len(url.id_registro)><cfset form.id_registro = url.id_registro></cfif>
...
<cfelse>
	<cfset rsVista_titulo_vista = "Lista de Documentos para Registro Individual">
</cfif>
<cf_template>
...
<cf_web_portlet_start titulo='#rsVista_titulo_vista#'>
	...
	<cfelse>
		<cfinclude template="vistasind-lista.cfm">
	</cfif>
<cf_web_portlet_end>
</cf_templatearea>
</cf_template>