...
<cfswitch expression="#Attributes.tipo_dato#">
	...
	<cfcase value="B">
		...
		<input type="checkbox" name="#Attributes.name#" <cfif Attributes.value eq 1>checked</cfif> id="#Attributes.name#" >
	</cfcase>
	<cfdefaultcase>
		...
		<input type="text" name="#Attributes.name#" value="#Attributes.value#" size="#Attributes.longitud#" maxlength="#Attributes.longitud#" onfocus="this.select()">
	</cfdefaultcase>
</cfswitch>
</cfoutput>