<cfset losdias="Lunes,Martes,Miércoles,Jueves,Viernes,Sábado,Domingo">
...
<cfquery datasource="#session.tramites.dsn#" name="citainf">
	select a.id_agenda,ciudad ||' ' || estado as direccion ,direccion1,direccion2,nombre_recurso,
	codigo_recurso,hora_desde,hora_hasta,cupo,
	d.numero_cupo, d.asistencia, d.ausencia, d.observaciones, 
	d.borrado, d.usuario_borrado, d.fecha_borrado
	from TPAgenda a
	join  TPCita d
...
<table width="510" border="0" align="center"  cellpadding="0" cellspacing="0">
	<tr>
			<td  align="center" colspan="2">
				**** ESTA PANTALLA SE ENCUENTRA AUN EN DESARROLLO ****
			</td>
	</tr>
