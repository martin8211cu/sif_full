	...
	<cfif len(trim(form.id_requisito))>
		<cfloop list="#form.id_requisito#" index="i">
			<cfquery name="instancia_req" datasource="#session.tramites.dsn#">
				...
				where ir.id_instancia = <cfqueryparam cfsqltype="cf_sql_numeric" value="#id_instancia#" >
...
<cflocation url="/cfmx/home/tramites/Operacion/gestion/gestion-form.cfm?id_persona=#form.id_persona#&id_tramite=#form.id_tramite#&identificacion_persona=#id.identificacion_persona#&id_tipoident=#id.id_tipoident#">