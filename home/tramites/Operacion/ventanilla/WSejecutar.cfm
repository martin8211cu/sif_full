		...
		<cftry>
			...
			<cfif LvarTipoProceso EQ "3">	<!--- Verifica Existencia --->
				...
				<script language="javascript">
						...
						<cfif LvarExistencia>
							alert("El documento Ya existe, el requisito ha sido rechazado");
						<cfelse>
							alert("El documento No existe, el requisito ha sido completado");
						</cfif>
					<cfelse>
						<cfif LvarExistencia>
							alert("El documento Ya existe, el requisito ha sido completado");
						<cfelse>
							alert("El documento No existe, el requisito ha sido rechazado");
						</cfif>
					</cfif>
				</script>
				<cfquery datasource="#session.tramites.dsn#">
					update TPInstanciaRequisito
					   set 
					   	<cfif LvarSatisfecho>
							completado = 1, rechazado=0
						<cfelse>
							completado = 0, rechazado=1
						</cfif>
