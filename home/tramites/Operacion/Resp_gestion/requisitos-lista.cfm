...
<cfoutput>
	...
	<tr bgcolor="##F5F5F5">
		<td width="1%">&nbsp;</td>
		<td width="37%" colspan="2"><strong>Requisito</strong></td>
...
<tr><td colspan="4"><blockquote style="border:1px solid gray ">
...
<img src="/cfmx/home/tramites/images/no-esta.gif"> No est&aacute; en el expediente</div>
</blockquote>
</td></tr>
		</table>
