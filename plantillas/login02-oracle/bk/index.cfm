...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top"><cfinclude template="/plantillas/login02-oracle/pubica2.cfm"></td>
	<td rowspan="2" valign="top" width="216">
		<cfif FindNoCase("/login02-oracle/index.cfm",CGI.SCRIPT_NAME) NEQ 0 and isDefined("Session.Usucodigo") and Session.Usucodigo is 0>
