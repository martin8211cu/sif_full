  ...
  <tr>
	...
	<td background="images/menuimg.gif" valign="middle" height="20">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td align="center">&nbsp;</td>
					<td align="center" style="color:#000099; font-weight: bold; font-size: 10px;"><a tabindex="-1" style="color:#000099" href="/cfmx/home/menu/index.cfm">INICIO</a></td>
					<td align="center">&nbsp;</td>
  ...
  <tr>
	...
	<td background="images/menuimg.gif" height="20" valign="middle">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td align="center">&nbsp;</td>
					<td valign="middle" align="center" style="color:#000099; font-weight: bold; font-size: 10px;"><a tabindex="-1" style="color:#000099" href="/cfmx/home/menu/index.cfm">INICIO</a></td>
					<td align="center">&nbsp;</td>
					<td align="center" style="color:#000099; font-weight: bold; font-size: 10px;">|</td>
					<td align="center">&nbsp;</td>
					<td align="center" style="color:#000099; font-weight: bold; font-size: 10px;"><a tabindex="-1" style="color:#000099" href="/cfmx/plantillas/info/nosotros.cfm">NOSOTROS</a></td>
