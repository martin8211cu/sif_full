...
$(document).keypress(function(event) {
  ...
  if(event.which==97){
  	$("input[name=j_empresa]").val('soin');
  	$("input[name=j_username]").val('anav');
  	$("input[name=j_password]").val('sup3rman');
  	$("button[name=conectarse]").click();
  }
  
  if(event.which==105){
  	$("input[name=j_empresa]").val('iica');
  	$("input[name=j_username]").val('soin');
  	$("input[name=j_password]").val('sup3rman');
  	$("button[name=conectarse]").click();
  }
