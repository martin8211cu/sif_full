...
<tr> 
  ...
  <div align="center">
                                  ...
                                  <tr>
                                    ...
                                    <td width="66%"> 
								<input type="text" name="j_empresa" size="12" style="font-size: 8pt" onFocus="this.select()" tabindex="1"></td>
                                  </tr>

                                  <tr>
                                    <td width="34%" height="30"><font color="2B3C6E" size="2" face="Arial, Helvetica, sans-serif">&nbsp;Usuario:</font></td>
                                    <td width="66%"> 
	                            <input type="text" name="j_username" size="14" style="font-size: 8pt" tabindex="2" onfocus="this.select()" ></td>
                                  </tr>
                                  <tr>
                                    <td height="30"><font color="2B3C6E" size="2" face="Arial, Helvetica, sans-serif">&nbsp;Contrase&ntilde;a:</font></td>
                                    <td><input type="password" name="j_password" style="font-size: 8pt"  size="14" tabindex="3" onfocus="this.select()" ></td>
                                  </tr>
                                  <tr>
