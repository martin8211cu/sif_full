...
var ENDSHOW_MESG="Fin de la presentación, haga clic para salir.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=6, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0061.htm", 1, 1),
   new hrefList("slide0080.htm", 1, 2),
   new hrefList("slide0079.htm", 1, 3),
   new hrefList("slide0059.htm", 1, 4),
   new hrefList("slide0081.htm", 1, 5),
   new hrefList("slide0063.htm", 1, 6)
);
