...
<table width="800" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="5">
			<map name="FPMap1">
            <area href="index.html" shape="rect" coords="169, 2, 290, 46">
            ...
            <area href="pagelogin.html" shape="rect" coords="719, 0, 796, 38">
            </map>
	...
	<tr>
		...
		<td rowspan="2" bgcolor="#C8E3F4">
			<p align="center"><img border="0" src="images/logo%20copy.gif" width="198" height="142"><body><cfparam name="url.errormsg" default="0"><form name="login" onsubmit="return validarLogin(this);" action="<cfoutput>#url.uri#</cfoutput>" method="post" >
...
<cfif Len(session.sitio.CEcodigo) EQ 0>
          <tr>
            ...
            <td align=left valign=top><!--DWLayoutEmptyCell--><font face="verdana, helvetica, arial" size="2" color="#ffffff">
...
<cfif Len(session.sitio.CEcodigo) EQ 0>
          ...
          <tr> 
            ...
            <td width="120" align="left" valign="top" > <font face="verdana, helvetica, arial" size="2" color="#ffffff"> 
              <cfparam name="url.errormsg" default="0"> 
...
<!---
</body><!--webbot bot="HTMLMarkup" endspan --></td>
		<td rowspan="3">
