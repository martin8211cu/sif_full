...
var ENDSHOW_MESG="Fin de la presentación, haga clic para salir.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=24, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0019.htm", 1, 17),
   new hrefList("slide0020.htm", 1, 18),
   new hrefList("slide0021.htm", 1, 19),
   new hrefList("slide0022.htm", 1, 20),
   new hrefList("slide0023.htm", 1, 21),
   new hrefList("slide0024.htm", 1, 22),
   new hrefList("slide0025.htm", 1, 23),
   new hrefList("slide0026.htm", 1, 24)
);
