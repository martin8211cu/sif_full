...
<cf_template>
	<cf_templatearea name="title">
		<cfoutput>Biblia en Línea</cfoutput></cf_templatearea>
	...
	<cfif isdefined("form.Libro") and len(form.Libro) gt 0>
		...
		<tr>
		   ...
		   <td class="etiqblack">Capítulo:</td>
		   <td class="textblack">#Form.Capitulo#</td>
		   </cfif>
		</tr>
		<cfif isdefined("Form.Versiculo") and len(Form.Versiculo)>
			<tr>
			   <td class="etiqblack">Versículo:</td>
			   <td class="textblack">#Form.Versiculo#</td>
	...
	<cfif rs.RecordCount gt 0>
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <cfoutput query="rs">
			...
			<tr>
				<td colspan="3" class="trblue" lass=" "><strong>Capítulo:</strong>#rs.Capitulo#</td>
			  </tr>
			</cfif>
			<tr <cfif rs.CurrentRow mod 2> class="listapar"<cfelse> class="listaimpar"</cfif>>
				<td width="79" valign="top" class="textblack">#rs.versiculo#</td>
				<td width="519" colspan="2" class="textblack">#rs.Texto#</td>
			</tr>
		  </cfoutput>
		</table>
	</cfif>
