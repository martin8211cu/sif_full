...
<cfoutput>
	<cfif rsActividades.recordCount GT 0>
		...
		<table cellspacing="0" cellpadding="2" width="100%">
			<tr>
				<td colspan="3" align="center"><span class="style90">Actividades Especiales de #ListGetAt(meses, DatePart('m', Now()), ',')#</span></td>
			</tr>
		<cfloop query="rsActividades">
			<cfif corte NEQ rsActividades.Dia>
				<cfset corte = rsActividades.Dia>
				<tr>
				  <td colspan="3" align="middle" class="style1 ver11"><strong class="style1 style1">#corte# </strong></td>
				</tr>
			</cfif>
			<tr>
			  <td width="55" align="right" class="ver11 style1">#rsActividades.HoraIComun#:#Iif(Len(rsActividades.MinIComun) EQ 1, DE("0" & rsActividades.MinIComun), DE(rsActividades.MinIComun))# #rsActividades.SufHoraI#</td>
			  <td class="style1">&nbsp;</td>
			  <td width="162" class="ver11 style1">#rsActividades.MEVevento#</td>
			</tr>
		</cfloop>
		</table>
	</cfif>
