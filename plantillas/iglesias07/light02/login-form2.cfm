...
<cfparam name="url.uri" default="/cfmx/plantillas/light02/index.cfm">
<style type="text/css">
<!--
...
<cfif (not isdefined("session.usucodigo")) or session.usucodigo is 0>
	<form name="login" onsubmit="javascript:return validarLogin(this)" action="<cfoutput>#url.uri#</cfoutput>" method="post" style="margin:0">
		<table background="/cfmx/plantillas/light02/images/fondo_rombos9.gif" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber4" height="11">
...
<tr>
		...
		<cfif IsDefined("url.errormsg")>
			<table background="/cfmx/plantillas/light02/images/fondo3.gif" border="0" cellpadding="1" cellspacing="1" width="180">	  
			  <tr>
...
<cfelse>
	...
	<input type="hidden" name="uri" value="/cfmx/plantillas/light02/index.cfm">
	</form>
</cfif>
