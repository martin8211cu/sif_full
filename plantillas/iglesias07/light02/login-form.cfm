<cfparam name="url.uri" default="/cfmx/plantillas/light02/login.cfm">
	  ...
	  <table width="618" cellpadding="2" cellspacing="0" border="0" >
		...
		<tr> 
		  ...
		  <td width="258" valign="top" class="g">
			<table width="273" height="150" border="0" cellpadding="0" cellspacing="0" background="/cfmx/plantillas/light02/images/main05.jpg" style="background-repeat:no-repeat ">
			  <tr>
				<td width="23">&nbsp;</td>
...
<div align="center">
				<input type="checkbox" name="recordar" value="checkbox">
				  <span class="style1" style="font-size:10px">Recordar mi usuario en este computador</span>
				</div></td>
			  </tr>
			</table>			
			</td>
