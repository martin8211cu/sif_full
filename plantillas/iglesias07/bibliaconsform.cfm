...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td nowrap class="etiqblack">Libro: </span></td>
    <td>
      <select name="Libro">
  		<optgroup label="Antiguo Testamento" style="font-weight:bold:;background-color:#99CCFF">
		...
		<optgroup label="Nuevo Testamento" style="font-weight:bold:;background-color:#CCFFFF">
