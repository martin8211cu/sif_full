...
<cf_template>
	<cf_templatearea name="title">
		<cfoutput>Biblia en Línea</cfoutput>
	</cf_templatearea>
	...
	<cfif isdefined("form.Libro") and len(form.Libro) gt 0>
		...
		<tr>
		   ...
		   <td class="right">Capítulo:</td>
		   <td class="right">#Form.Capitulo#</td>
		   </cfif>
		</tr>
		<cfif isdefined("Form.Versiculo") and len(Form.Versiculo)>
			<tr>
			   <td class="right">Versículo:</td>
			   <td class="right">#Form.Versiculo#</td>
			   <td class="right">&nbsp;</td>
			</tr>
		</cfif>
		</tr>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <cfoutput query="rs">
			...
			<tr <cfif rs.CurrentRow mod 2> class="listapar"<cfelse> class="listaimpar"</cfif>>
				<td width="79" valign="top" class="right">#rs.versiculo#</td>
				<td width="519" colspan="2" class="right">#rs.Texto#</td>
			</tr>
		  </cfoutput>
		</table>
	</cfif>
