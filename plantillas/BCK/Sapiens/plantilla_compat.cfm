...
<cfset session.sitio.skinlist = 'soinasp01_compat.css,Estándar'>
					...
					<table width="392" border="0" cellspacing="0" cellpadding="0" align="right" >
					  <tr>
						<td width="382" height="33" align="right" valign="bottom"><span class="toprightitems">
							...
							<a style="color: #2B3C6E;" href="/cfmx/home/menu/micuenta/index.cfm">Preferencias</a> | 
							<a style="color: #2B3C6E;" href="/cfmx/home/public/logout.cfm">Salir</a></span>
				...
				<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" background="/cfmx/plantillas/login02/images/temp/03-01.jpg">
					<tr> 
						<td><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"> 
							<a href="index.cfm" style="color:#FFFFFF; text-decoration:none" onMouseOut="this.style.color='#FFFFFF'" onMouseOver="this.style.color='#3399CC'">inicio</a> |
