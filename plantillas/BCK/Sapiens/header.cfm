...
<table border="0" cellspacing="0" cellpadding="0" height="90" width="980" class="iconoTop" align="center">
  <!--DWLayoutTable-->
  <tr height="35">
    <td width="160" rowspan="3" valign="top" class="logoTop" height="35">
	...
	<cfif IsDefined('session.Usucodigo') And Len(session.Usucodigo) and Session.Usucodigo NEQ 0>
     ...
     <td width="40" rowspan="2" align="center" valign="middle" nowrap="nowrap">
