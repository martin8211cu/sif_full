...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top"><cfinclude template="/plantillas/login-DB2/pubica2.cfm"></td>
	<td rowspan="2" valign="top" width="216">
		<cfif FindNoCase("/login-DB2/index.cfm",CGI.SCRIPT_NAME) NEQ 0 and isDefined("Session.Usucodigo") and Session.Usucodigo is 0>
		  <img border="0" src="images/bottom1.jpg" width="216" height="24">
		  <cfinclude template="/plantillas/login-DB2/login-form2.cfm">
		  <img border="0" src="images/bottom1.jpg" width="216" height="24">
	  	</cfif>
	</td>
  </tr>
