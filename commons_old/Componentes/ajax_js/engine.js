...
DWREngine.defaultMessageHandler = function(message) {
  if (typeof message == "object") 
  {
	...
	{
		alert(message.name + ": " + message.description);
	}
	else if (message.description)
	{
		alert("message.description: " + message.description);
	}
	else
	{
		alert("object message: " + message.toString());
	}
  }
  else if (typeof message == "String") 
  {
    ...
    else 
	{
  	...
  	alert ("Ocurrio un Error desconocido "  + message.toString());
};
