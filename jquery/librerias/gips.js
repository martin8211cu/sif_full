(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 500, autoHide: false, pause: 5000, animationSpeed: 500, placement: 'top', theme: 'red', imagePath: 'images/close.png', text: 'Texto que quieras que aparezca' }, options);
            return this.each(function () {
                ...
                var toolTipContainer = $('<div class="gips-container"><div id="gips-body" class="gips-body ' + settings.theme + '">' +  '<p id="text" class="gips-text">' + settings.text + '</p>' +
                ...
                control.mouseover(function () {
                    ...
                    if (placement == 'right') {
						...
						toolTipBody.css('top', -5);
                        toolTipIcon.css('top', -7);
                    }
