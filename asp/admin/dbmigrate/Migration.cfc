...
<cfset Removed_column = t.Translate('Removed_column','Columna Eliminada','/TableDefinition.xml')>
	...
	<cffunction name="init" returntype="Migration" access="public">
		...
		<cfscript>
		var dbType = $getDBType(arguments.dataSourceName);
		if(dbType == '') {
    ...
    announce("#Dropped_table# #arguments.name#");
		</cfscript>
	</cffunction>
	...
	<cffunction name="removeColumn" returntype="void" access="public" hint="removes a column from a database table">
		...
		<cfargument name="campo" type="string" required="false" default="" hint="campo">
		...
		if(arguments.referenceName != "") {
			arguments.columnName = arguments.referenceName & arguments.campo;
		}
		$execute(this.adapter.dropColumnFromTable(name=arguments.table,columnName=arguments.columnName));
		announce("#Removed_column# #arguments.columnName# from #arguments.table#");
		</cfscript>
	</cffunction>
	...
	<cffunction name="dropReference" returntype="void" access="public" hint="drop a foreign key constraint from the database, using the reference name that was used to create it">
		...
		<cfargument name="columnName" type="string" required="false" default="" hint="column name to remove">
		<cfargument name="campo" type="string" required="false" default='id' hint="campo">
		<cfscript>
		dropForeignKey(arguments.table,"FK_#arguments.table#_#arguments.referenceName#");
		if(arguments.referenceName != "") {
			arguments.columnName = arguments.referenceName & arguments.campo;
		}
		$execute(this.adapter.dropColumnFromTable(name=arguments.table,columnName=arguments.columnName));
