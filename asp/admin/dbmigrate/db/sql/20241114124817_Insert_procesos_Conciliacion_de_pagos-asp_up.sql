        ...
        BEGIN
            IF NOT EXISTS (SELECT 1 FROM SProcesos WHERE SPcodigo = 'PAGOSNOREF' and SMcodigo='CREDCB')
              INSERT INTO SProcesos (SScodigo, SMcodigo, SPcodigo, SPdescripcion, SPhomeuri, SPmenu, BMfecha, BMUsucodigo, SPanonimo, SPpublico, SPinterno)
                           VALUES ('CRED', 'CREDCB', 'PAGOSNOREF', 'Conciliación de pagos no referenciados', '/crc/cobros/operacion/ConciliacionPagosNRef.cfm', 1, GETDATE(), 1, 0, 0, 0)
            ...
            BEGIN
                 ...
                 values ('CRED', 'CREDCB', 'PAGOSNOREF', '/crc/cobros/operacion/ConciliacionPagosNRef.cfc', 'P', 0, GETDATE(), 1)
            END
            ...
            BEGIN
                 insert into SComponentes (SScodigo, SMcodigo, SPcodigo, SCuri, SCtipo, SCauto, BMfecha, BMUsucodigo)
                 values ('CRED', 'CREDCB', 'PAGOSNOREF', '/crc/cobros/operacion/ConciliacionPagosNRef_form.cfm', 'P', 0, GETDATE(), 1)
            END
            ...
            BEGIN
                 insert into SComponentes (SScodigo, SMcodigo, SPcodigo, SCuri, SCtipo, SCauto, BMfecha, BMUsucodigo)
                 values ('CRED', 'CREDCB', 'PAGOSNOREF', '/crc/cobros/operacion/ConciliacionPagosNRef_sql.cfm', 'P', 0, GETDATE(), 1)
            END

            IF NOT EXISTS (SELECT 1 FROM SProcesos WHERE SPcodigo = 'PAGONOREFA' and SMcodigo='CREDCB')
              INSERT INTO SProcesos (SScodigo, SMcodigo, SPcodigo, SPdescripcion, SPhomeuri, SPmenu, BMfecha, BMUsucodigo, SPanonimo, SPpublico, SPinterno)
                           VALUES ('CRED', 'CREDCB', 'PAGONOREFA', 'Aprobación de pagos no referenciados', '/crc/cobros/operacion/ConciliacionPagosNRef-Aprobador.cfm', 1, GETDATE(), 1, 0, 0, 0)
            ...
            BEGIN
                 insert into SComponentes (SScodigo, SMcodigo, SPcodigo, SCuri, SCtipo, SCauto, BMfecha, BMUsucodigo)
                 values ('CRED', 'CREDCB', 'PAGONOREFA', '/crc/cobros/operacion/ConciliacionPagosNRef.cfc', 'P', 0, GETDATE(), 1)
            END
            ...
            BEGIN
                 insert into SComponentes (SScodigo, SMcodigo, SPcodigo, SCuri, SCtipo, SCauto, BMfecha, BMUsucodigo)
                 values ('CRED', 'CREDCB', 'PAGONOREFA', '/crc/cobros/operacion/ConciliacionPagosNRef_form.cfm', 'P', 0, GETDATE(), 1)
            END
            ...
            BEGIN
                 insert into SComponentes (SScodigo, SMcodigo, SPcodigo, SCuri, SCtipo, SCauto, BMfecha, BMUsucodigo)
                 values ('CRED', 'CREDCB', 'PAGONOREFA', '/crc/cobros/operacion/ConciliacionPagosNRef_sql.cfm', 'P', 0, GETDATE(), 1)
            END
        END;
