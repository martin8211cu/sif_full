...
--->
<cfcomponent extends="asp.admin.dbmigrate.Migration" hint="Modificacion_Tabla_FAPreFacturaE">
  <cffunction name="up">
    <cfscript>
	    changeColumn(table='FAPreFacturaE', columnType='string',limit='250', columnName='NumOrdenCompra', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		changeColumn(table='FAPreFacturaE',columnName='string',limit='20');
    </cfscript>
  </cffunction>
</cfcomponent>
