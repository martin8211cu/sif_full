...
--->
<cfcomponent extends="asp.admin.dbmigrate.Migration" hint="addCol_Fecha_Contraresibo_EDocumentosCxC">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='EDocumentosCxC', columnType='date', columnName='EDfechacontrarecibo', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		  removeColumn(table='EDocumentosCxC',columnName='EDfechacontrarecibo');
    </cfscript>
  </cffunction>
</cfcomponent>
