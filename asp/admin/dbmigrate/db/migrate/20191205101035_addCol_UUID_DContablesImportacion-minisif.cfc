...
--->
<cfcomponent extends="asp.admin.dbmigrate.Migration" hint="addCol_UUID_DContablesImportacion">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='DContablesImportacion', columnType='string', columnName='uuid', null=true, limit=100);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='DContablesImportacion',columnName='uuid');
    </cfscript>
  </cffunction>
</cfcomponent>
