<cfcomponent extends="asp.admin.dbmigrate.Migration" hint="addCol_lineaRemision_OrdenCompra">
  <cffunction name="up">
    <cfscript>
      execute("
                SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[DDocumentosCPR] CHECK CONSTRAINT [DDocumentosCPR_CK21]
              ...
              ");
	    addColumn(table='DOrdenCM', columnType='numeric', columnName='DRemisionlinea', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
      execute("
              ...
              ");
		removeColumn(table='DOrdenCM',columnName='DRemisionlinea');
    </cfscript>
  </cffunction>
</cfcomponent>
