...
--->
<cfcomponent extends="asp.admin.dbmigrate.Migration" hint="ModificarPropiedades">
  <cffunction name="up">
    <cfscript>
	    changeColumn(table='FADOrdenImpresion ', columnType='float', columnName='OIDPrecioUni', default='', null=true);
		changeColumn(table='FAPreFacturaD  ', columnType='float', columnName='PrecioUnitario', default='', null=true);
	    changeColumn(table='FAPreFacturaE  ', columnType='float', columnName='Total', default='', null=true);

    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		changeColumn(table='FADOrdenImpresion ', columnType='money', columnName='OIDPrecioUni', default='', null=true);
		changeColumn(table='FAPreFacturaD  ', columnType='money', columnName='PrecioUnitario', default='', null=true);
	    changeColumn(table='FAPreFacturaE  ', columnType='money', columnName='Total', default='', null=true);
