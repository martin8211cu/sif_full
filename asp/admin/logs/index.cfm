<cf_templateheader title="Logs del Sistema">

<cf_web_portlet_start titulo="Logs del Sistema">
<cfinclude template="/home/menu/pNavegacion.cfm">

<cfsetting showdebugoutput="no" requesttimeout="200" />
<cfset rootDir = Server.ColdFusion.RootDir>
...
<cfoutput>
	...
	<cfset logsPath = rootDir & "#s#logs">
	<cfset logs= DirectoryList(logsPath,false,"name","")> 
	<div class="col-md-4">
        <div class="hpanel">
            <div class="panel-heading hbuilt">
                <div class="panel-tools">
                    <a class="showhide"><i class="fa fa-file text-info"></i></a>
                        Seleccione un archivo
                </div>
            </div>
            <div class="panel-body">
                <cfform name="form1" id="form1" action = "index.cfm" method="post" preservedata="true" > 
					<label for="listDirectory">Archivos: </label>
					<cfselect name="listInfo" id="listInfo" onChange="form1.submit()"> 
						<option value="">-- Seleccione --</option> 
						<cfloop array="#logs#" item="log">
							<option value="#log#"  <cfif IsDefined("FORM.listInfo") and log eq FORM.listInfo>selected</cfif>  >#log#</option> 
						</cfloop>
					</cfselect> 
				</cfform>
            </div>
	...
	<cfif IsDefined("FORM.listInfo")>
		<div class="col-md-12">
			<div class="hpanel">
				<div class="panel-heading hbuilt">
					<div class="panel-tools">
						<a class="showhide"><i class="fa fa-eye text-info"></i></a>
							Contenido del archivo Log
					</div>
				</div>
				<div class="panel-body">			
					<cfif IsDefined("FORM.listInfo")> 
						<cfset logsFile = rootDir & "#s#logs#s##FORM.listInfo#">
						<cfif not fileExists(logsFile)>
							<h5>Error: log file #logsFile# does not exist</h5>
							<cfabort />
						<cfelse>
							<h5>#logsFile#</h5>
							<pre>
								...
								<cftable query="qResult" startRow="1" colSpacing="3" HTMLTable colHeaders>
									<cfcol header="" align="Left" width="2" text="#COLUMN_1#">
									<cfcol header="" align="Left" width="1" text="#COLUMN_3#">
									<cfcol header="" align="Left" width="1" text="#COLUMN_4#">
									<cfcol header="" align="Left" width="15" text="#COLUMN_6#">
								</cftable>
							</pre>
						</cfif>
