...
<form name="form1" method="post" action="generar.cfm">
<cfoutput>
<input type="hidden" name="ck" value="#HTMLEditFormat(url.ck)#">
<input type="hidden" name="dsn" value="#HTMLEditFormat(url.dsn)#">
</cfoutput>
  <table border="0" cellpadding="2" cellspacing="0">
    ...
    <tr class="tituloListas">
      <td colspan="3" valign="top" class="subTitulo"> <strong>Ha seleccionado las siguientes tablas para generar sus triggers </strong></td>
    </tr>
    ...
    <tr class="tituloListas">
      <td colspan="3" valign="top" class="subTitulo">Presione este bot&oacute;n para generar estos triggers </td>
    </tr>
    <tr align="right">
      <td colspan="3" valign="top"><input type="submit" name="Submit" value="Generar" class="BtnAplicar"></td>
    </tr>
  </table>
</form>
