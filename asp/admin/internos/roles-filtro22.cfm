<cfquery datasource="asp" name="roles">
	select 	{fn concat({fn concat(rtrim(SScodigo) ,'.')}, rtrim(SRcodigo))} as codigo,
...
<cfoutput>
<form action="roles.cfm" method="get" name="filtro" id="filtro"><table border="0" cellspacing="0" cellpadding="0" bgcolor="##ededed" style="border:1px solid black ">
  <tr>
    <td colspan="3">Criterio de b&uacute;squeda </td>
    <td width="24">&nbsp;</td>
  </tr>
  <tr>
    <td width="26">&nbsp; </td>
