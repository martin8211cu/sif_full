...
<form method="post" name="form1" action="ValTab_sql.cfm" onSubmit="return valida();">
	<cfoutput>
		<table width="300" align="center" border="0">
			<tr valign="baseline">
				<td nowrap align="right"><strong>Codigo:</strong></td>
				<td>
			...
			<tr valign="baseline">
				<td colspan="2" align="right" nowrap>
					<cf_botones modo="#modo#" include="Regresar, Detalles">
				</td>
			</tr>
...
<script language="JavaScript">
	...
	{
		location.href='/cfmx/home/menu/modulo.cfm?s=sys&m=config';
		return false;
	}

	function funcDetalles()
	{
		location.href='/cfmx/asp/valtab/Valtab_detalles.cfm?valtabId=' + document.form1.id.value;
		return false;
	}	
