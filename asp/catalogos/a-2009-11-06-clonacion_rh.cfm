...
<cfoutput>
	<table cellpadding="0" cellspacing="0" border="0" >
			...
			<tr><td>&nbsp;</td><td style="font:Arial, Helvetica, sans-serif; font-size:9px">Origen</td><td style="font:Arial, Helvetica, sans-serif; font-size:9px">Destino</td></tr>
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="DRegimenVacaciones"/>Detalle Regimen Vacaciones</td></tr>
				<cfset Org = reg('DRegimenVacaciones',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('DRegimenVacaciones',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				
			<!---	<tr><td class="label"><input name="Clonar" type="checkbox" value="RHComponentesAgrupados"/>Grupos Componentes Salariales</td>
				<cfset Org = reg('RHComponentesAgrupados',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('RHComponentesAgrupados',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="FDeduccion"/>Formulas por Tipos de Deduccion</td>
				<cfset Org = reg('FDeduccion',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('FDeduccion',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				...
				<tr><td class="label"><input name="Clonar" type="checkbox" value="CIncidentes,CIncidentesD"/>Conceptos de Pago</td>
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="CIncidentesD"/>Detalle de Incidencias</td>
				<cfset Org = reg('CIncidentesD',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('CIncidentesD',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				...
				<tr><td class="label"><input name="Clonar" type="checkbox" value="ECargas"/>Cargas Patronales</td>
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="TDCalendario"/>Deducciones por Calendario</td>
				<cfset Org = reg('TDCalendario',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('TDCalendario',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="CCalendario"/>Conceptos Pago por Calendario</td>
				<cfset Org = reg('CCalendario',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('CCalendario',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="RHExcluirDeduccion"/>Deducciones Excluir por Calendario</td>
				<cfset Org = reg('RHExcluirDeduccion',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('RHExcluirDeduccion',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				...
				<tr><td class="label"><input name="Clonar" type="checkbox" value="RHJornadas"/>Jornadas</td>
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="ConceptosTipoAccion"/>Conceptos Calculo por Tipo de Accion</td>
				<cfset Org = reg('ConceptosTipoAccion',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('ConceptosTipoAccion',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
				...
				<!---<tr><td class="label"><input name="Clonar" type="checkbox" value="RHComportamientoJornada"/>Comportamiento de Jornadas</td>
				<cfset Org = reg('RHComportamientoJornada',#form.DSNO#,#form.EcodigoO#)>
				<cfset Des = reg('RHComportamientoJornada',#form.DSND#,#form.EcodigoD#)>
				<td>&nbsp;<label style="cursor:pointer">(#Org.total#)</label></td>
				<td>&nbsp;<label style="cursor:pointer">(#Des.total#)</label> </tr>--->
		...
		<td valign="top">
			...
			<td>
				<table cellpadding="0" cellspacing="0" width="100%" border="0">
					...
					<tr>
						<td></td>
						<td>
							<cf_rhempleado size="30" Ecodigo ="#form.EcodigoO#" DSN ="#form.DSNO#" form="formsubmit" >				
						</td>
			...
			<tr>
				...
				<!---<tr id="tr_Carg" <cfif not isdefined("form.Cargos")>style="display:none" </cfif>><td>&nbsp;</td>
					<td><!---<cfdump var="#form#">--->
