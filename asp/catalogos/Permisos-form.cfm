...
<cfquery name="rsModulos" datasource="asp">
	...
	order by a.SScodigo,SMdescripcion
</cfquery>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0" >
				...
				<tr><td colspan="3">
					<table border="0" width="100%" class="areaFiltro">
						...
						<tr>
						<td nowrap width="1%" class="selectpicker">Mostrar M&oacute;dulos:&nbsp;</td>
						<td class="selectpicker">

							<select name="fModulo" onChange="javascript:filtrar();"  class="selectpicker" >
								<option value="">Todos</option>
								<cfloop query="rsModulos">
									<cfset modulo = (rsModulos.SScodigo) & "|" & (rsModulos.SMcodigo) >
									<option value="#(rsModulos.SScodigo)#|#(rsModulos.SMcodigo)#" <cfif isdefined("form.fModulo") and form.fModulo eq modulo >selected</cfif> >#rsModulos.SScodigo#-#HTMLEditFormat(rsModulos.SMdescripcion)#</option>
								</cfloop>
							</select>
						</td>
						</tr>
				...
				<tr class="tituloLista" >
					<td class="selectpicker"><b>Empresa&nbsp;&nbsp; </b></td>
					<td class="selectpicker"><b>M&oacute;dulo</b></td>
					<td class="selectpicker"><b>Proceso</b></td>
				</tr>
