...
<form name="form1" method="post" action="clonacion-sql.cfm" >	
	...
	<input type="hidden" name="EcodigoD" 		value= "<cfif isdefined('form.EcodigoD') and len(trim(form.EcodigoD))>#form.EcodigoD#<cfelse>111</cfif>">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<!---or (isdefined("form.EcodigoDE") and len(form.EcodigoDE) gt 0))--->
