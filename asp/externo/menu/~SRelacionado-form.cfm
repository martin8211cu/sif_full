...
<cfparam name="url.id_hijo" default="">
...
<cfquery datasource="asp" name="data">
	...
	from  SRelacionado
		...
		and 
		id_hijo =
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#url.id_hijo#" null="#Len(url.id_hijo) Is 0#">
...
<!--
	function validar(formulario)
	{
		...
		// Validando tabla: SRelacionado - Páginas Relacionadas
				...
				// Columna: id_hijo id_hijo numeric
				if (formulario.id_hijo.value == "") {
					error_msg += "\n - id_hijo no puede quedar en blanco.";
					error_input = formulario.id_hijo;
				}
...
<form action="SRelacionado-apply.cfm" onsubmit="return validar(this);" method="post" name="form1" id="form1">
	...
	Páginas Relacionadas
		...
		<tr><td valign="top">id_hijo
		</td><td valign="top">
		
			<input name="id_hijo" id="id_hijo" type="text" value="#HTMLEditFormat(data.id_hijo)#" 
				maxlength=""
				onfocus="this.select()"  >
