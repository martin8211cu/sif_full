...
<table border="0" cellpadding="0" cellspacing="2" width="100%" align="center" >
	...
	<tr>
		<td align="right" width="1%"><cf_translate XmlFile="/sif/rh/generales.xml" key="LB_DESCRIPCION">Descripci&oacute;n</cf_translate>:&nbsp;</td>
	...
	<tr>
		<td align="right" valign="top" nowrap="nowrap"><cf_translate key="instrucciones"><cf_translate key="LB_Instrucciones">Instrucciones</cf_translate></cf_translate>:&nbsp;</td>
		<td>
			...
			<cfif modo_parte neq 'ALTA'>
				<cf_rheditorhtml name="PCPinstrucciones" value="#trim(pcpdata.PCPinstrucciones)#">
			<cfelse>
				<cf_rheditorhtml name="PCPinstrucciones" height="150">
			</cfif>
	...
	returnvariable="MSG_DeseaEliminarLaParte"/>	
		...
		<td colspan="2" align="center">
			...
			<cfif modo_parte neq 'ALTA'>
				...
				<input type="button" name="NuevaParte" value="<cfoutput>#BTN_Nuevo#</cfoutput>" onClick="location.href='cuestionario.cfm?PCid=#form.PCid#&tab=2';" >
			</cfif>
		</td>
	</tr>
