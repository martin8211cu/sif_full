                                    ...
                                    <cfif LvarPPorientacion eq 0>
                                        ...
                                        <td colspan="2" align="top">
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                <cfif LvarPPorientacion eq 1 >
													<tr>	
														<td width="<cfif LvarPPorientacion eq 0>99%<cfelse>200</cfif>" style="padding-left:3px;" nowrap><font size="2">#trim(datarespuestas.PRtexto)#</font></td>
													</tr>
													<tr>
														<td width="1%" align="left">
														   <img src="/cfmx/sif/imagenes/radio.gif" >
														</td>
													</tr>
												<cfelse>	
													<tr>
									 ...
									 <cfif LvarPPorientacion eq 0>
                                        ...
                                        <td colspan="2" align="right">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="right">
												 ...
												 <cfif LvarPPorientacion eq 1 >
													<tr>	
														<td  width="<cfif LvarPPorientacion eq 0>99%<cfelse>300</cfif>" style="padding-left:3px;" valign="top"><font size="2">#trim(datarespuestas.PRtexto)#</font></td>
													</tr>
													<tr>
													   <td width="1%" valign="top">
															<img src="/cfmx/sif/imagenes/unchecked.gif"/>
														</td>
													</tr>
												<cfelse>
													<tr>
