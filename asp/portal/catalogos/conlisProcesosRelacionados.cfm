...
<script language="JavaScript" type="text/javascript">
	function Asignar(SPcodigo,SPproceso) {
		window.opener.document.form2.SPdestino.value=SPcodigo;
		window.opener.document.form2.SPproceso.value=SPproceso;
		window.close();
	}
...
<body>
<cfoutput>
<form style="margin:0; " name="filtroEmpleado" method="post" action="conlisProcesosRelacionados.cfm">
