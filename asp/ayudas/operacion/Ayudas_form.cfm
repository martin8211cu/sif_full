...
<cfif modo neq "ALTA">
  <cfquery name="rsLinea" datasource="sifcontrol">
	  select Ayid, Acodigo, Iid, Adesc, Atipo
	  from Ayuda 
...
<form action="Ayudas_SQL.cfm" method="post" name="form1" onSubmit="MM_validateForm('Acodigo','','R');return document.MM_returnValue">
	<table width="100%">
		<tr valign="baseline">
			<td width="4%">C&oacute;digo:</td>
			<td width="96%"><input name="Acodigo" type="text" value="<cfif modo neq "ALTA"><cfoutput>#rsLinea.Acodigo#</cfoutput></cfif>" size="80" maxlength="255" alt="El campo Código"></td>
		</tr>
		<tr>	
			<td colspan="4">Idioma:
			  <select name="Iid">
			...
			Din&aacute;mica:
		    <input type="checkbox" name="Atipo" <cfif modo neq "ALTA" and rsLinea.Atipo eq 1>checked</cfif> />
			</td>
		</tr>
		...
		<tr valign="baseline">
			<td align="left" valign="top" colspan="6">
				<cfif modo neq 'ALTA'>
					<cf_rheditorhtml name="Adesc" value="#rsLinea.Adesc#">
				<cfelse>
					<cf_rheditorhtml name="Adesc">
				</cfif>			
			</td>		
		</tr>
