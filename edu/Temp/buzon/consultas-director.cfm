...
<cfquery datasource="#Session.DSN#" name="qryTiposMat">
...
<cfquery datasource="#Session.DSN#" name="qryNiveles">
...
<cfquery name="qryGrupos" datasource="#Session.DSN#">
...
<cfquery datasource="#Session.DSN#" name="qryEncargados">
	...
	where en.EEcodigo = ene.EEcodigo
		and ene.CEcodigo=<cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.CEcodigo#">
			...
			Select a.Ecodigo
				...
				where a.CEcodigo in (
						...
						from Director d,
							...
							Nivel n,
							CentroEducativo ce
			where d.Usucodigo=<cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Usucodigo#">									and d.Ulocalizacion=<cfqueryparam cfsqltype="cf_sql_char" value="#Session.Ulocalizacion#">
...
<cfquery datasource="#Session.DSN#" name="qryAlumnos">
	Select distinct convert(varchar,a.persona) as persona, Pemail1,convert(varchar,Usucodigo) as Usucodigo,Ulocalizacion, (Papellido1+ ' ' + Papellido2 + ', ' + Pnombre) as nombreAlumno
		...
		where a.CEcodigo in (
				...
				from Director d,
					...
					Nivel n,
					CentroEducativo ce
			where d.Usucodigo=<cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Usucodigo#">
