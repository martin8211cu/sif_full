...
<cfoutput>
	<form name="lista" method="post" action="take-action.cfm">
...
<cfoutput query="rsMensaje">
	...
	<table width="98%" align="center" border="0" cellspacing="0" cellpadding="2" class="MessageHeader">
	  <tr>
		...
		<td class="subrayado" style="padding-right: 10px;">#Borigen#</td>
	  </tr>
	  <tr>
		<td width="10%" align="right" style="padding-left: 10px; padding-right: 10px; font-weight: bold;">Para:</td>
		<td class="subrayado" style="padding-right: 10px;">#Bdestino#</td>
	  </tr>
	  <tr>
	    <td align="right" style="padding-left: 10px; padding-right: 10px; font-weight: bold;">Asunto:</td>
	    <td class="subrayado" style="padding-right: 10px;">#Btitulo#</td>
      </tr>
	  <tr>
	    <td align="right" style="padding-left: 10px; padding-right: 10px; font-weight: bold;">Fecha:</td>
	    <td class="subrayado" style="padding-right: 10px;">#Trim(ListGetAt(dias, DatePart('w', Bfecha), ','))# #DatePart('d', Bfecha)# de #Trim(ListGetAt(meses, DatePart('m', Bfecha), ','))# del #DatePart('yyyy', Bfecha)# #Hora#</td>
      </tr>
	</table>
