...
select a.Aid, b.Adescripcion, b.Acodigo, a.Eexistencia from Existencias a, Articulos b
...
<form action="" method="post" name="conlis">
  <table width="53%" border="0" cellspacing="0">
    <tr> 
      <td width="44%" bgcolor="#006699" class="titulo"><div align="left"><font color="#FFFFFF">C&oacute;digo</font></div></td>
      <td width="28%" bgcolor="#006699" class="titulo"><div align="left"><font color="#FFFFFF">Art&iacute;culo</font></div></td>
      <td width="1%" class="titulo"><div align="right"><font color="#FFFFFF"> 
    ...
    <cfoutput query="conlis" startRow="#StartRow_conlis#" maxRows="#MaxRows_conlis#"> 
      <tr> 
        ...
        <td colspan="2" <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><a href="javascript:Asignar(#conlis.Aid#, '#JSStringFormat(conlis.Adescripcion)#', #conlis.Eexistencia#);">#conlis.Adescripcion#</a></td>
      </tr>
    </cfoutput> 
    <tr> 
      <td colspan="3">&nbsp; </td>
