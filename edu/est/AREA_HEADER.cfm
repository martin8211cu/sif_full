...
<cfparam default="Estudiante" name="title">
<cfparam default="Estudiante" name="moduleName">
<cfparam default="/cfmx/edu/est/consultarActividades.cfm" name="moduleRef">
<cfoutput>
...
<cfset modulo = 'consultarActividades.cfm'>