  ...
  {
    link="/cfmx/edu/responsable/consultarCurso.cfm?Tipo="+LprmTipo+"&Codigo="+LprmCodigo+"&Periodo="+document.frmActividades.cboPeriodo.value+"&E="+document.frmActividades.cboAlumno.value;
  ...
  {
    link="/cfmx/edu/responsable/consultarCurso.cfm?Tipo=C&Codigo="+LprmCodigo+"&Periodo="+document.frmActividades.cboPeriodo.value+"&TipoLista="+LprmTipoLista+"&E="+document.frmActividades.cboAlumno.value+"&AllC=1";
    LvarWin = window.open(link, "TemasxEvaluacion", "left=100,top=50,scrollbars=yes,resiable=yes,width=600,height=500,alwaysRaised=yes");
	LvarWin.focus();
	return;
  }
  ...
  {
    link="/cfmx/edu/responsable/BusquedaMaterial.cfm?E="+document.frmActividades.cboAlumno.value;
    LvarWin = window.open(link, "MaterialApoyo", "left=100,top=50,scrollbars=yes,resizable=yes,width=650,height=550,alwaysRaised=yes");
	LvarWin.focus();
	return;
  }
   function fnConsultarNotas(LprmCodigo)
  {
    link="/cfmx/edu/responsable/Consultas/ListaNotasFinalesEnc.cfm?Ecodigo="+document.frmActividades.cboAlumno.value+"&Grupo="+document.frmActividades.GRcodigo.value;
    LvarWin = window.open(link, "MaterialApoyo", "left=100,top=50,scrollbars=yes,resizable=yes,width=650,height=550,alwaysRaised=yes");
	LvarWin.focus();
	return;
  }
