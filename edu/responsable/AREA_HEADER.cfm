...
<cfparam default="Responsables" name="title">
<cfparam default="Responsables" name="moduleName">
<cfparam default="/cfmx/edu/responsable/MenuRES.cfm" name="moduleRef">
<cfoutput>
