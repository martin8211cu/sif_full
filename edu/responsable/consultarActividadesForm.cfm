		...
		function VerNotasProgreso(){
			<cfoutput>
				...
				<cfelse>
					...
					alert('La Institución decidió no publicar las notas de progreso en este día, consulte luego o consulte al administrador');	
				</cfif>
			</cfoutput>
		}
		function VerNotasFinales(){
			<cfoutput>
				...
				<cfelse>
					...
					alert('La Institución decidió no publicar las notas finales en este día, consulte luego o consulte al administrador');	
				</cfif>
			</cfoutput>
		}
