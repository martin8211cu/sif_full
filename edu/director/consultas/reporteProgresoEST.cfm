...
<cfset Form.cboGrupo = Form.cboGrupo1>
...
<script language="JavaScript" src="commonDocenciaEST1_00.js"></script>
<script language="JavaScript" type="text/JavaScript">
function fnReLoad1 (LprmNivel, LprmCurso, LprmPeriodo)
{
  if (LprmNivel > 0)
  {
  ...
  document.frmProgreso.action="reporteProgresoEST.cfm";
...
function fnImprimir(LprmTipo)
{
  if (LprmTipo == 1)
  {
	...
	fnCambiarTD(document.getElementById('TDgrupo'), document.frmProgreso.cboGrupo1.options[document.frmProgreso.cboGrupo1.selectedIndex].text);
...
<div id="DivCombos1">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr>
        <td>Grupo:</td>
        <td><select name="cboGrupo1" id="cboGrupo1" 
		style="font:10px Verdana, Arial, Helvetica, sans-serif;"
		onChange="fnReLoad1(0);">
            <option value="-1" <cfif isdefined("form.cboGrupo1") and form.cboGrupo1 EQ "-1">selected</cfif>>** 
            TODOS LOS GRUPOS**</option>
            <cfoutput query="qryGrupos"> 
              <option value="#qryGrupos.GRcodigo#" <cfif isdefined("form.cboGrupo1") and form.cboGrupo1 EQ #qryGrupos.GRcodigo#>selected</cfif>>#qryGrupos.GRnombre#</option>
            </cfoutput> </select></td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td width="201"> <input name="btnImprimir" type="button" 
...
<div id="DivCombos2" style="display:none;">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr> 
        ...
        <td width="201"> <input name="btnNormal" type="button" 
  ...
  <cfif LvarAlumno neq qryProgreso.Ecodigo>
    ...
    <cfif form.cboAlumno1 eq -1 or true>
      ...
      <tr><td class="#LvarLinPar#" style="font-size:14px;font-weight:bold;text-align:left;" colspan="#LvarBlanks#">
	    <a href="javascript:fnReLoad1(4,-1,-1);">
  ...
  <cfif LvarNivel lte 3 and LvarCurso neq qryProgreso.Ccodigo and qryProgreso.Ccodigo neq 1e18>
    ...
    <cfif form.cboCurso1 eq -1 or true>
      ...
      <tr><td class="#LvarLinPar#" style="font-size:13px;font-weight:bold;text-align:left;" colspan="#LvarBlanks#">
	    <a href="javascript:fnReLoad1(3,#trim(qryProgreso.Ccodigo)#,-1);">
  ...
  <cfif LvarNivel lte 2 and LvarPeriodo neq qryProgreso.PEcodigo and qryProgreso.PEcodigo neq 1e18>
    ...
    <cfif form.cboPeriodo1 eq -1 or true>
      ...
      <tr><td class="#LvarLinPar#" style="font-size:12px;font-weight:bold;text-align:left;" colspan="#LvarBlanks#">
	    <a href="javascript:fnReLoad1(2,#trim(qryProgreso.Ccodigo)#,#trim(qryProgreso.PEcodigo)#);">
  ...
  <cfif LvarNivel lte 1 and LvarConcepto neq qryProgreso.ECcodigo and qryProgreso.ECcodigo neq 1e18>
    ...
    <tr>
	  <td class="#LvarLinPar#" style="font-size:10px;font-weight:bold;text-align:left;">
	    <a href="javascript:fnReLoad1(1,#trim(qryProgreso.Ccodigo)#,#trim(qryProgreso.PEcodigo)#);">
  ...
  <cfif form.cboSimple eq "1">
	  ...
	  <cfelseif LvarNivel eq 2>
		<cfif qryProgreso.Nivel eq 2>
		  <td class="#LvarLinPar#" style="width:300px;text-align:left;">
			<a href="javascript:fnReLoad1(1,#trim(qryProgreso.Ccodigo)#,#trim(qryProgreso.Ecodigo)#,#trim(qryProgreso.PEcodigo)#);">
	  ...
	  <cfelseif LvarNivel eq 3>
		<cfif qryProgreso.Nivel eq 3>
		  <td class="#LvarLinPar#" style="width:300px;text-align:left;">
			<a href="javascript:fnReLoad1(2,#trim(qryProgreso.Ccodigo)#,#trim(qryProgreso.Ecodigo)#,#trim(qryProgreso.PEcodigo)#);">
	  ...
	  <cfelseif LvarNivel eq 4>
		  <td class="#LvarLinPar#" style="width:300px;text-align:left;">
			<a href="javascript:fnReLoad1(3,#trim(qryProgreso.Ccodigo)#,#trim(qryProgreso.Ecodigo)#,-1);">
			  #qryProgreso.Cnombre#
			</a>
		  </td>
		  <td class="#LvarLinPar#">#qryProgreso.GanadoC#&nbsp;</td>
