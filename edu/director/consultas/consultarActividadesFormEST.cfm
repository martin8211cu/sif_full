<cfinclude template="commonDocenciaEST.cfm"> 
...
<cfscript>
  sbInitFromSession("cboGrupo", "-1",false);
...
<cfinclude template="qrysAlumnoCursoPeriodoEST.cfm">
		  ...
		  <td colspan="3" class="areaFiltro" nowrap>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<td nowrap width="31%">Grupo: 
				  <select name="cboGrupo" id="select" style="font:10px Verdana, Arial, Helvetica, sans-serif;" onChange="fnReLoad();">
					<option value="-1" <cfif isdefined("form.cboGrupo") and form.cboGrupo EQ "-1">selected</cfif>>** 
					TODOS LOS GRUPOS **</option>
					<cfoutput query="qryGrupos"> 
					  <option value="#qryGrupos.GRcodigo#" <cfif isdefined("form.cboGrupo") and form.cboGrupo EQ #qryGrupos.GRcodigo#>selected</cfif>>#qryGrupos.GRnombre#</option>
					</cfoutput> </select></td>
				<td nowrap width="33%">Alumno: 
		...
		<tr> 
		  <td width="10%" rowspan="6" align="right" valign="middle" style="padding-left: 10px; padding-right: 10px" nowrap> 
			<table border="1">
			  <tr> 
				<td align="right"> 
					<!--- <cf_Educleerimagen Tabla="PersonaEducativo" ruta="/cfmx/edu/Utiles/sifleerimagencont.cfm" Campo="Pfoto" Condicion="persona=#LvarPersonaAlumno#" Conexion="#Session.Edu.DSN#" autosize="false" width="85" height="113">  --->
		  ...
		  <td width="60%" rowspan="6" valign="top" nowrap><cfoutput> 
			  <table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr> 
				  <!--- <td colspan="4" align="center" class="tituloAlterno" style="border-bottom: solid ##000000 1px; border-top: solid ##000000 1px;"><a href="javascript: ligaMensajeria('#trim(form.cboAlumno)#','#trim(form.cboPeriodo)#');">O</a>pciones 
					de Men&uacute;</td> --->
					<td colspan="4" align="center" class="tituloAlterno" style="border-bottom: solid ##000000 1px; border-top: solid ##000000 1px;">Opciones 
					de Men&uacute;</td>
				</tr>
				<tr> 
				  <td style="padding-right: 5px;"> <a href="javascript:a=window.open('reporteProgresoEST.cfm?N=4&G=#trim(form.cboGrupo)#&E=#trim(form.cboAlumno)#&C=#trim(form.cboCurso)#&P=#trim(form.cboPeriodo)#', 'ReporteProgreso','left=50,top=10,scrollbars=yes,resiable=yes,width=700,height=550,alwaysRaised=yes');a.focus();"><img src="/cfmx/edu/Imagenes/evaluaciones2.gif" border="0" title="Reporte de Progreso del Curso"></a> 
				  </td>
				  <td nowrap style="padding-right: 10px;"><font size="2"><a href="javascript:a=window.open('reporteProgresoEST.cfm?N=4&G=#trim(form.cboGrupo)#&E=#trim(form.cboAlumno)#&C=#trim(form.cboCurso)#&P=#trim(form.cboPeriodo)#', 'ReporteProgreso','left=50,top=10,scrollbars=yes,resiable=yes,width=700,height=550,alwaysRaised=yes');a.focus();">Notas 
				...
				<tr> 
				  ...
				  <td align="left" nowrap style="padding-right: 10px;"><font size="2"><a href="javascript:fnConsultarCursoDet('E',document.frmActividades.cboCurso.value);">Plan 
					de Evaluaciones</a></font></td>
				</tr>
				<tr> 
				  <td> 
					<!--- <a href="javascript:a=window.open('/cfmx/edu/responsable/comunicados.cfm', 'Comunicados','left=50,top=10,scrollbars=yes,resiable=yes,width=500,height=350,alwaysRaised=yes','Comunicados');a.focus();"><img src="/cfmx/edu/Imagenes/comunicado.gif" border="0" title="Comunicados"></a>  --->
					<a href="/cfmx/edu/buzon/index.cfm?a=#LSDateFormat(Now(), 'ddmmyyyy')##LSTimeFormat(Now(),'hhmmss')#"><img src="/cfmx/edu/Imagenes/comunicado.gif" border="0" title="Comunicados"></a> 
				  </td>
				  ...
				  <td align="left" nowrap style="padding-right: 10px;">&nbsp;</td>
				</tr>			
				<!--- <tr> 
				  <td><a href="javascript:fnConsultarCursoDet('O',document.frmActividades.cboCurso.value);"><img src="/cfmx/edu/Imagenes/observaciones.gif" border="0" title="Observaciones y Anotaciones"></a></td>
				  <td nowrap style="padding-right: 10px;"><font size="2"><a href="javascript:fnConsultarCursoDet('O',document.frmActividades.cboCurso.value);">Observaciones 
				...
				<tr> 
				  <!--- <td style="padding-right: 5px;"> <a href="javascript:a=window.open('/cfmx/edu/responsable/comunicadoAlProfesor.cfm?Tipo=M0&Codigo=#trim(form.cboAlumno)#&Periodo=#trim(form.cboPeriodo)#&C=#trim(form.cboCurso)#', 'ComunicadosAlProfesor','left=50,top=10,scrollbars=yes,resiable=yes,width=500,height=350,alwaysRaised=yes','Comunicados al Profesor');a.focus();"><img src="/cfmx/edu/Imagenes/comunicado.gif" border="0" title="Comunicados al Profesor"></a> 
				  </td>
				  <td nowrap style="padding-right: 10px;"><font size="2"><a href="javascript:a=window.open('/cfmx/edu/responsable/comunicadoAlProfesor.cfm?Tipo=M0&Codigo=#trim(form.cboAlumno)#&Periodo=#trim(form.cboPeriodo)#', 'ComunicadosAlProfesor','left=50,top=10,scrollbars=yes,resiable=yes,width=500,height=350,alwaysRaised=yes','Comunicados al Profesor');a.focus();">Comunicados 
					al Profesor</a></font></td> --->
		  ...
		  <table width="100%" border="0" cellpading="-1" cellspacing="-1" style="border-bottom: 1px solid ##FFFFFF;">
			...
			<cfloop query="qryActividades"> 
			  ...
			  <cfif fnEsLeccion(LvarFecha, false)>
				...
				<td class="#LvarCeldaCurso#">
				  <a href="javascript:fnConsultarActividades('','#lsdateformat(LvarFecha,"DD/MM/YYYY")#');" class="CeldaFechaRef"></a>
				  <div style="width=100%;cursor:hand;">
					<a href="javascript:fnConsultarActividades('','#lsdateformat(LvarFecha,"DD/MM/YYYY")#');" class="CeldaFechaRef">
