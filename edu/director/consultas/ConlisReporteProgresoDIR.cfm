...
function fnReload (LprmNivel, LprmCurso, LprmAlumno, LprmPeriodo)
{
  ...
  document.frmProgreso.action="./ConlisReporteProgresoDIR.cfm";
...
<!--- 				<input name="btnImprimir" type="button" 
				...
				<cfoutput>
					<input name="btnImprimir" type="button" 
						onClick="javascript:printURL('ConlisReporteProgresoDIRimpr.cfm?Nivel=#form.Ncodigo#&profesor=#form.cboProfesor#&curso=#form.cboCurso#&Alumno=#Form.cboAlumno#&periodo=#form.cboPeriodo#&NivelDatos=#form.cboNivel#&tipoRep=#form.cboSimple#<cfif isdefined('form.chkSinBlancos')>&sinBlanco=#form.chkSinBlancos#</cfif>&Imprimir=SI');fnImprimir(1);"
					value="Imprimir"> 
				</cfoutput>
			</td>
		  </tr>
