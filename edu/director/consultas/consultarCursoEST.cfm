...
<div class="CeldaHdr" style="border-top:1px solid ##E6E6E6;">#qryCurso.NombreCurso#</div>
  <table width="100%" border="0" cellpading="0" cellspacing="0" class="TxtNormal">
	<tr>
	  ...
	  <td align="center">
		<a href="consultarCursoEST.cfm?Tipo=#url.Tipo#&Codigo=#url.Codigo#&G=#Url.G#&Periodo=#url.Periodo#&TipoLista=T<cfif isdefined("url.AllC")>&AllC=1</cfif>"><img src="/cfmx/edu/Imagenes/tema.gif" border="0" title="Temario del Curso"></a>&nbsp;&nbsp;
		<a href="consultarCursoEST.cfm?Tipo=#url.Tipo#&Codigo=#url.Codigo#&G=#Url.G#&Periodo=#url.Periodo#&TipoLista=E<cfif isdefined("url.AllC")>&AllC=1</cfif>"><img src="/cfmx/edu/Imagenes/evaluaciones.gif" border="0" title="Plan de Evaluaciones del Curso"></a>&nbsp;&nbsp;
		<a href="javascript:a=window.open('reporteProgresoEST.cfm?N=3&E=#trim(qryAlumno.Codigo)#&C=#trim(LprmCcodigo)#&P=#trim(url.Periodo)#&G=#Url.G#', 'ReporteProgreso','left=50,top=10,scrollbars=yes,resiable=yes,width=700,height=550,alwaysRaised=yes');a.focus();"><img src="/cfmx/edu/Imagenes/evaluaciones2.gif" border="0" title="Reporte de Progreso del Curso"></a>&nbsp;&nbsp;
		<a href="consultarCursoEST.cfm?Tipo=#url.Tipo#&Codigo=#url.Codigo#&Periodo=#url.Periodo#&G=#Url.G#&TipoLista=O<cfif isdefined("url.AllC")>&AllC=1</cfif>"><img src="/cfmx/edu/Imagenes/observaciones.gif" border="0" title="Observaciones y Anotaciones del Curso"></a>&nbsp;&nbsp;
<!--- 		<a href="consultarCursoEST.cfm?Tipo=#url.Tipo#&Codigo=#url.Codigo#&Periodo=#url.Periodo#&TipoLista=A<cfif isdefined("url.AllC")>&AllC=1</cfif>"><img src="/cfmx/edu/Imagenes/asistencia.gif" border="0" title="Control de Asistencia del Curso"></a>&nbsp;&nbsp;
		<a href="consultarCursoEST.cfm?Tipo=#url.Tipo#&Codigo=#url.Codigo#&Periodo=#url.Periodo#&TipoLista=M<cfif isdefined("url.AllC")>&AllC=1</cfif>"><img src="/cfmx/edu/Imagenes/comunicado.gif" border="0" title="Comunicado al profesor"></a>&nbsp;&nbsp;
 --->	  </td>
	</tr>
  </table>
  <br>
...
<cfif isdefined("url.AllC")>
  ...
  <select name="cboCurso" 
	...
	onChange="javascript: location.href= 'consultarCursoEST.cfm?Tipo=#url.Tipo#&G=#Url.G#&Codigo='+this.value+'&Periodo=#url.Periodo#&TipoLista=#url.TipoLista#&AllC=1';">
...
<cfif isdefined("url.Codigo") and url.Codigo neq "">
  ...
  <cfif isdefined("url.TipoLista")>
    ...
    <cfelseif url.TipoLista eq "M">
		...
		<cfif #Codigo# neq "">
		  <td width="75"><a href="consultarCursoEST.cfm?Tipo=#url.TipoLista#&Codigo=#Codigo#&Periodo=#url.Periodo#&TipoLista=#url.TipoLista#&G=#Url.G#" class="Lin#LvarLinPar#">#lsDateFormat(Fecha,"DD/MM/YYYY")#</a></td>
		  <td width="100%"><a href="consultarCursoEST.cfm?Tipo=#url.TipoLista#&Codigo=#Codigo#&Periodo=#url.Periodo#&TipoLista=#url.TipoLista#&G=#Url.G#" class="Lin#LvarLinPar#">#Nombre#</a></td>
