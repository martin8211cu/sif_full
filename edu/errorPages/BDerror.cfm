...
<link href="/cfmx/edu/css/portlets.css" rel="stylesheet" type="text/css">
</head>

<body>
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr> 
    <td width="24%"><img src="/cfmx/edu/Imagenes/logo.gif" width="170" height="62"></td>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td width="4%"><span class="titulo"></span></td>
    <td width="8%" bgcolor="#003366"><font color="#FFFFFF"><cfif isdefined("Session.rutaImagenes")><img src="/cfmx/edu/Imagenes/Stop01_T.gif" width="48" height="48"></cfif><span class="titulo"></span></font></td>
