...
<cfif  isdefined("form.btnSalir")>
	...
	<script language="JavaScript1.2" type="text/javascript">
		function Asignar() {
			window.opener.document.<cfoutput>#form.form#.</cfoutput>.value=<cfoutput>#form.checkTabla#</cfoutput>;
 			window.close();
		}
	</script>
</cfif>
	<cfif isdefined("Form.checkTabla")>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
    <td align="center"> 
      <form name="filtros" action="../../ced/consultas/ConlisMateriaTabla.cfm" method="post">
        &nbsp; <strong>Materias del Nivel para mostrar según Tablas de Evaluación:</strong> 
              ...
              <tr> 
                <td>
					<form name="lista" method="post" action="../../ced/consultas/ConlisMateriaTabla.cfm">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="80%">
									...
									<cfoutput query="rsCursos">
										<cfif rsCursos.Ctabla EQ 1>
											<tr>
												<td>
													<!--- <input type="checkbox" name="checkCurso" value="#rsCursos.Ccodigo#" class="areaFiltro"
													<cfif (isdefined("codigosCursos") AND Find(rsCursos.Ccodigo&",",codigosCursos) IS NOT 0)
													OR isdefined("Form.checkTodosCursos")>checked</cfif>> --->
												</td>
												<td>
													#rsCursos.Cnombre#
												</td>
