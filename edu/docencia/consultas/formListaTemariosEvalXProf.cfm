...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr class="tituloAlterno"> 
    <td colspan="3" align="center" class="tituloAlterno"><strong>DE <cfoutput>#rsProfesor.nombre#</cfoutput>
      </strong></td>
  </tr>  
  <tr> 
  ...
  <cfif rsTemaEval.recordCount GT 0>
		<cfoutput query="rsTemaEval">
			...
			<cfif vCurso NEQ rsTemaEval.curso>
				<cfif isdefined('form.rdCorte') and form.rdCorte EQ 'PXC' and vCont GT 0 and isdefined('form.imprime')>
					<tr>
					...
					<tr class="tituloAlterno"> 
						<td colspan="3" align="center" class="tituloAlterno"><strong>DE #rsProfesor.nombre#
						</strong></td>
					</tr>  
					<tr> 
				...
				<cfset vMes ="">
				<tr> 		
          			<td colspan="3" class="areaFiltro">
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
						  <tr>
							<td>Periodo: #rsTemaEval.PEdescripcion#</td>
							<td>Periodo de Evaluaci&oacute;n: #rsPerEvaluacion.PEdescripcion#</td>
						  </tr>
						  <tr>
                			<td>Curso: #rsTemaEval.descrCurso#</td>
							<td>&nbsp;</td>
						  </tr>
						</table>
					</td>
