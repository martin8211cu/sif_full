		...
		<cfquery datasource="#Session.Edu.DSN#" name="rsEvalXProf">
			exec sp_EVALDOCENTE 
				@CCentro = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Edu.CEcodigo#">
				  , @Splaza = <cfqueryparam cfsqltype="cf_sql_numeric" value="#usr.num_referencia#">
				...
				<cfloop query="rsEvalXProf" >
					<cfif vCursos NEQ #rsEvalXProf.Ccodigo#>
						...
						<cfset contCursos = contCursos + 1>
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1" class="areaFiltro">
								<tr> 
								  <td>Curso: 
									#rsEvalXProf.CursoNombre#</td>
								  <td>Periodo 
									de Evaluacion: #rsEvalXProf.PEdescripcion#</td>
								</tr>
								<tr>
								  <td>Nivel:#rsEvalXProf.Ndescripcion#</td>
								  <td>Grupo: #rsEvalXProf.GRnombre#
								  </td>
								</tr>
							  </table>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="1">		<!--- ABRE LA TABLA --->
							  <tr>
								...
								<cfif rsConceptos.recordCount GT 0>
									<cfloop query="rsConceptos">
										<td width="15%" nowrap align="center"><strong>#rsConceptos.ECnombre# <cfif isdefined('form.ckPxC')>(#rsEvalXProf.ECCporcentaje# %)</cfif></strong></td>
									</cfloop>
								</cfif>
