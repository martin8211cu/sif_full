...
<cfparam default="Docencia" name="title">
<cfparam default="Docencia" name="moduleName">
<cfparam default="/cfmx/edu/docencia/MenuDOC.cfm" name="moduleRef">
<cfoutput>
