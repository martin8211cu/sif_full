...
<cfquery datasource="#Session.Edu.DSN#" name="rsPlaza">
	Select distinct convert(varchar, Splaza) as Splaza
	from Staff 
	where CEcodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Edu.CEcodigo#">
	  and Splaza in (<cfqueryparam cfsqltype="cf_sql_numeric" value="#ValueList(usr.num_referencia,',')#" list="yes" separator=",">)
</cfquery>
...
<form action="SQLDocumentos.cfm" method="post" enctype="multipart/form-data" id="formDocumentos" name="formDocumentos">
	...
	<input name="Splaza" id="Splaza"    value="<cfoutput>#rsPlaza.Splaza#</cfoutput>" type="hidden">
    ...
    <tr> 
      ...
      <td width="50%" rowspan="8" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="65%" align="left" valign="top" nowrap >
				<select name="cbTipoDoc" id="cbTipoDoc" onChange="javascript: cambioTipoDoc(this); crearNuevoTipo(this);">
          ...
          <tr> 
            <td valign="top" nowrap > 
              <div style="display: ;" id="verTitResumen"><strong> 
                Texto </strong></div>
          ...
          <cfoutput query="rsMateriaTipo"> 
            <cfif modo EQ "CAMBIO">
              <cfquery dbtype="query" name="rsDocumMatTipoCount">
              	 Select MTcodigo from rsDocumMatTipo 
			  	 where id_documento = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.id_documento#">
                   and MTcodigo = <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsMateriaTipo.MTcodigo#">
              </cfquery>
            </cfif>
            <tr> 
...
<form action="documentos.cfm" method="post" name="FiltroDocumentos">	
  <table class="areaFiltro" width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="21%" nowrap >Titulo</td>
    ...
    <tr> 
      ...
      <td nowrap><select name="cbTipoMatFiltro" id="cbTipoMatFiltro">
          <option value="-1" <cfif isdefined('form.cbTipoMatFiltro') and form.cbTipoMatFiltro EQ '-1'> selected</cfif>>-- 
          Todos --</option>
          <cfoutput query="rsMateriaTipo"> 
	...
	<tr>
		<td valign="top">
					...
					<cfif isdefined("Form.Splaza") >
						...
						<cfset navegacion = navegacion & Iif(Len(Trim(navegacion)) NEQ 0, DE("&"), DE("")) & "plaza=" & plaza>
					</cfif>
 					<cfif f1 NEQ ''>
