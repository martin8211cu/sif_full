...
<cfparam default="Asistentes" name="title">
<cfparam default="Asistentes" name="moduleName">
<cfparam default="/cfmx/edu/asistencia/MenuAST.cfm" name="moduleRef">
<cfoutput>
