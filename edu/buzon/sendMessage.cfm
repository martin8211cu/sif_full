...
<cfquery name="rolesUsr" datasource="#Session.Edu.DSN#">
	...
	where a.Usucodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Edu.Usucodigo#">
	  ...
	  and e.consecutivo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Edu.CEcodigo#">
...
<cfif isdefined("Form.o") and Form.o EQ 2>
	...
	<cfif isdefined("Form.senderRol") and Len(Trim(Form.senderRol)) NEQ 0
	      ...
	      and ListFind(Replace(ValueList(rolesUsr.rol, ','), ' ', '', 'all'), 
					   ...
					   ',') NEQ 0>
		<cfif Form.senderRol EQ 4>
			<cfinclude template="sendMessage-admin.cfm">
		<cfelseif Form.senderRol EQ 5>
...
<cfelseif isdefined("Form.o") and Form.o EQ 4 and isdefined("Form.Bcodigo") and Len(Trim(Form.Bcodigo)) NEQ 0>
	...
	<cfquery name="qryCorreos" datasource="#Session.Edu.DSN#">
