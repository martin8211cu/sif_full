...
function show_calendar1(str_target, str_datetime, str_path) {
	...
	var str_buffer = new String (
		...
		str_target+"', '"+ dt2dtstr(dt_prev_month)+"'+document.cal.time.value, '"+str_path+"');\">"+
		...
		+str_target+"', '"+dt2dtstr(dt_next_month)+"'+document.cal.time.value, '"+str_path+"');\">"+
