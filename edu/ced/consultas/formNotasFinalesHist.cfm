  	...
  	<cfquery datasource="#Session.Edu.DSN#" name="rsNotasFinales_Principal">
		set nocount on
			exec sp_NOTASFINALES_HIST
				...
				, @subcursolectivo =  <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.SPEcodigo#">
				, @cursolectivo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.PEcodigo#">
...
--->
 	...
 	<cfquery name="rsNotasFinales" dbtype="query">
		...
		where TipoNI = 'N'
		order by NombreAl, Morden, Orden,  Orden_Comp
		<!--- order by NombreAl, Norden, Gorden, Morden, PEorden, PEdescripcion, GRnombre, Orden --->
	</cfquery>
...
<cfif  isdefined("Session.Idioma") and Session.Idioma EQ "ES_CR">
	<cfset tituloDefault = "Informe Histórico de Notas Finales">
<cfelseif isdefined("Session.Idioma") and Session.Idioma EQ "EN" >
	<cfset tituloDefault = "Historical Report Card">
</cfif>
  ...
  <tr> 
   <td colspan="3"> 
		<cfif rsNotasFinales.recordCount GT 0>
			...
			<!--- <cfif vCursoLectivo NEQ rsNotasFinales.SPEdescripcion> --->
				...
				<cfoutput>
					<cfif vAlumno NEQ rsNotasFinales.NombreAl>
										...
										<table width="100%" border="0" cellspacing="1" cellpadding="1" class="subrayado">
											<tr> 
												<cfif isdefined('form.ckPG')>
													...
													<td><strong>#Request.Translate('RptProgTit29','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</strong></strong>
														<cfset prom = 0>
						...
						<cfif isdefined('form.rdCortes') and form.rdCortes EQ 'PxA' and vContAlumnos GT 1 and isdefined('form.imprime')>
									...
									<tr>
										<td align="center">
											------------------ <strong><cfoutput>#Request.Translate('RptProgTit30','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</cfoutput></strong> ------------------								
										</td>
									</tr>
								</table>
							</td>
					...
					<td colspan="3">										
						...
						<tr> 
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1">
								  <tr>
								  	<td>
										<strong>#Request.Translate('RptProgTit26','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#:</strong> #rsNotasFinales.SPEdescripcion#
									</td>
									<td>
										<strong>#Request.Translate('RptProgTit25','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')# :</strong> #rsNotasFinales.Ndescripcion#
									</td>
								  </tr>
								  
								  <tr>
									<td width="50%"><strong>#Request.Translate('RptProgTit09','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')# :</strong>#rsNotasFinales.NombreAl#</td>
									<td width="50%"><strong>#Request.Translate('RptProgTit11','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#:</strong> #rsNotasFinales.GRnombre#</td>
								  </tr>
								  ...
								  <cfif isdefined("form.TituloProfClase") and len(trim(form.TituloProfClase)) neq 0>
									<tr>
										<td >
											 <strong>
												#Request.Translate('RptProgTit15','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')# &nbsp; &nbsp; </strong> #form.TituloProfClase#
								  ...
								  <!--- <tr>
									<td><strong>#Request.Translate('RptProgTit25','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')# :</strong> #rsNotasFinales.Ndescripcion#</td>
							...
							<td>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="1" class="subrayado">								
								  <tr> 
									...
									<cfif isdefined('form.ckPCF')>
										<td width="15%" align="center"><strong>#Request.Translate('RptProgTit27','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</strong></td>
									</cfif>
									<cfif isdefined('form.ckEst')>
										<td width="15%" align="center"><strong>#Request.Translate('RptProgTit28','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</strong></td>
									</cfif>
													...
													<cfloop query="rsNotas">
														<td width="15%" align="center">
															<strong>
																...
																<!--- aqui va el Valor de los cursos pintados --->
																<cfif len(trim(#rsNotas.Cal_Per#)) neq 0>
																	<cfquery datasource="#Session.Edu.DSN#" name="rsEvaluacionValores">
																		select EVTcodigo , EVvalor, EVdescripcion, EVequivalencia
																		from EvaluacionValores
							...
							<td> 
								<table width="100%" border="0" cellspacing="1" cellpadding="1" class="subrayado">
									<tr> 
										<cfif isdefined('form.ckPG')>
											<td  nowrap width="4%">&nbsp;</td>									  
											<td><strong>#Request.Translate('RptProgTit29','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</strong>
												<cfset prom = 0>
												<cfquery name="rsPromedio" dbtype="query">
												select sum(Cal_Per) as Promedio, count(*) as num , max(EstadoPeriodo) as EstadoPeriodo
												from rsNotasFinales
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td align="center">------------------ <strong><cfoutput>#Request.Translate('RptProgTit30','','/cfmx/edu/Utiles/Reportes.xml','#Session.Idioma#')#</cfoutput></strong> ------------------</td>
  </tr>
</table> 