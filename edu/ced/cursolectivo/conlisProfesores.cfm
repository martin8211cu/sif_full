...
<body>
	...
	<cfif isdefined("Form.update")>
		<cfquery name="updateCurso" datasource="#Session.Edu.DSN#">
			update Curso
			<cfif Len(Trim(Form.Splaza)) NEQ 0>
			   set Splaza = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.Splaza#">
			<cfelse>
			   set Splaza = null
			</cfif>
			where Ccodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.Curso#">
		</cfquery>
	...
	<cfif not isdefined("Form.update")>
	<form name="filtro" method="post" action="conlisProfesores.cfm">
	...
	<form name="updateForm" method="post" action="conlisProfesores.cfm">
		<input type="hidden" name="update">
		<input type="hidden" name="Splaza" value="">
