...
Mask.prototype.attach = function (o, mascara, tipo, fnOnBlur, fnOnKeyDown, fnOnKeyUp, fnOnChange){
	...
	o.onkeydown = new Function("return " + this.ref + ".isAllowKeyPress(this);"+fnOnKeyDown);
...
// 07/MAY/2004
// Variable global para almacenar el tama�o de la selecci�n
// *************************************************
var GvarRLon;
// *************************************************
Mask.prototype.isAllowKeyPress = function (o){
	...
	// Ing. Oscar Bonilla, MBA
	// 27/MAY/2004
	// Almacena el tama�o de la seleccion
	// *********************************
...
Mask.prototype.setDateKeyPress = function (_v, _d){
	...
	for( i=0; i < e.length; i++ ){
		...
		if( x == "m" ){
			...
			// Ing. Oscar Bonilla, MBA
			// 07/MAY/2004
			// Ajusta los a�os a la derecha igual que el dia y el mes
			// *****************************
