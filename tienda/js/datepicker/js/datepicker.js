 ...
 * Version: 1.03
 * Created: 2001-10-??
 * Updated: 2002-02-10	Changed _update method to only update the text nodes
 *                      instead rewriting the entire table. Also added support
 *                      For mouse wheel in IE6
 ...
 *			2002-01-19	Added a popup that is shown when the user clicks on the
 *						month. This allows navigation to 6 adjacent months.
 *			2002-04-10	Fixed a bug that occured in the popup when a date was
 *						selected that caused surroundung months to "overflow"
 *						This had the effect that one could get two October
 *						months listed.
 *
