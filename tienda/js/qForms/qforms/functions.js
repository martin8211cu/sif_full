...
for(var i=0;i<string.length;i++){if(validchars.indexOf(lc.charAt(i))!=-1)tmp+=string.charAt(i);
}
return tmp;
}
...
for(var i=0;i<obj.options.length;i++){for(var j=0;j<obj.options.length-1;j++){if(orderAsc &&(byText && obj.options[j].text>obj.options[j+1].text)||(!byText && obj.options[j].value>obj.options[j+1].value)){tmpTxt=obj.options[j].text;
...
} else if(!orderAsc &&(byText && obj.options[j].text<obj.options[j+1].text)||(!byText && obj.options[j].value<obj.options[j+1].value)){tmpTxt=obj.options[j].text;
tmpVal=obj.options[j].value;
tmpSel=obj.options[j].selected;
obj.options[j].text=obj.options[j+1].text;
obj.options[j].value=obj.options[j+1].value;
