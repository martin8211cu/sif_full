...
<!--
	function validar(f) {
		return confirm("¿Está seguro de que desea realizar el cargo a tarjeta de este pedido?. \r\nUna vez que el cargo haya sido autorizado, este envío no se podrá modificar.");
		return true;
	}
-->
</script>
<cfinclude template="/home/menu/pNavegacion.cfm">
		...
		<form name="form1" action="despacho3_go.cfm" method="post" style="margin:0 " onSubmit="return validar(this);">
		<cfinclude template="despacho_hdr.cfm">
			...
			<cfquery datasource="#session.dsn#" name="this_cant">
			  ...
			  <tr>
				...
				<td width="76"  class="picklist_data">#nombre_presentacion#&nbsp;</td>
			  ...
			  <tr>
			    <td>&nbsp;</td>
			    <td colspan="2" valign="top"><cfset despacho_progreso_paso = 3>
			    ...
			    <td colspan="4" valign="top" ><table width="350"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="137" align="right" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data">&nbsp;</td>
                    <td width="70"  bordercolor="#CCCCCC" class="picklist_data">&nbsp;</td>
                  </tr>
                  <tr>
                    <td bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data">Subtotal Productos </td>
                    <td align="right" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data"><cfoutput>#NumberFormat(envio.subtotal, ',0.00')#</cfoutput>&nbsp;</td>
                    <td  bordercolor="#CCCCCC" class="picklist_data">&nbsp;</td>
                  </tr>
                  <tr>
                    <td bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data">Gastos por env&iacute;o </td>
                    <td align="right" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data"><cfoutput>#NumberFormat(envio.gastos_envio, ',0.00')#</cfoutput>&nbsp;</td>
                    <td  bordercolor="#CCCCCC" class="picklist_data">&nbsp;</td>
                  </tr>
                  <tr>
                    <td bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data">Total</td>
                    <td align="right" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="picklist_data"><cfoutput>#NumberFormat(envio.total, ',0.00')#</cfoutput>&nbsp;</td>
                    <td  bordercolor="#CCCCCC" class="picklist_data">&nbsp;</td>
                  </tr>
                  <tr>
		    ...
		    <table width="667" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="649" align="center"><input name="submit" type="submit" value="Realizar cargo a tarjeta de crédito"></td>
              </tr>
            </table>
		    <br>
</form>
