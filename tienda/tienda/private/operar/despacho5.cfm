...
<!--
	function validar(f) {
		return confirm("¿Está seguro de que desea cerrar este pedido?. \r\nUna vez cerrado, solamente se podrá consultar en las estadísticas de ventas.");
		return true;
	}
-->
</script>
...
<cfinclude template="/home/menu/pNavegacion.cfm">
		...
		<form name="form1" action="despacho5_go.cfm" method="post" style="margin:0 " onSubmit="return validar(this);">
		<cfinclude template="despacho_hdr.cfm">
			...
			<cfquery datasource="#session.dsn#" name="this_cant">
			  ...
			  <tr>
			    <td width="77" class="picklist_data">#sku#</td>
			  ...
			  <tr>
			    <td width="77">&nbsp;</td>
			    <td colspan="2"><cfset despacho_progreso_paso = 5>
      ...
      (tracking number) </td>
                    <td align="right" valign="top" class="picklist_data"><cfoutput>#envio.tracking_no#</cfoutput></td>
                    <td valign="top" class="picklist_data">&nbsp;</td>
                  </tr>
                </table></td>
	          </tr>
		    ...
		    <table width="667" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="649" align="center"><input name="submit" type="submit" value="Cerrar pedido"></td>
              </tr>
            </table>
		    <br>
</form>
