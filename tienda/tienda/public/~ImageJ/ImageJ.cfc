<cfcomponent displayname="ImageJ imaging API wrapper" hint="version 0.9, 24 april 2003, Benoit Hediard (ben@benorama.com)">
...
<cffunction name="open" output="false">
...
<cffunction name="resize" output="false" hint="Resizes the image, based on height value, width value or a maximum value (height or width)">
	<cfargument name="value" type="numeric" required="true">
	<cfargument name="type" type="string" required="false" default="auto" hint="Possible value : auto, width or height">
	<cfset var width = 0>
	<cfset var height = 0>
	<cfset var resizedWidth = 0>
	<cfset var resizedHeight = 0>
	...
	switch (arguments.type) {
		case "height":
			resizedHeight = arguments.value;
			resizedWidth = round(resizedHeight * width / height);
			break;
		case "width":
			resizedWidth = arguments.value;
	...
	<cfset imageProcessor = imageProcessor.resize(javaCast("int",resizedWidth),javaCast("int",resizedHeight))>
	<cfset imagePlus.setProcessor("",imageProcessor)>
