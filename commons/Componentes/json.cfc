...
<cfcomponent displayname="JSON" output="No">
	<cffunction name="decode" access="remote" returntype="any" output="no"
		...
		<cfelse>
			...
			method="Translate"
			Key="LB_jason1"
			Default="El documento que est&aacute; tratando de descifrar no es v&aacute;lida en formato JSON"
			returnvariable="LB_jason1"/> 
			<cf_throw message="#LB_jason1#" errorCode="12035">
		</cfif>
	</cffunction>
