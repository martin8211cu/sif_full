...
<cffunction name="pListaRH" access="public" returntype="string" output="true">
	...
	<cfargument name="ajustar" type="string" required="true" default="N"> <!--- Ajusta la columna (S,N)--->
	...
	<cfargument name="keys_checkbox_function" type="string" required="false" default="">
	...
	<cfinvoke component="pListas" method="pListaQuery" returnvariable="pListaRet">
			...
			<cfinvokeargument name="keys_checkbox_function" 	value="#Arguments.keys_checkbox_function#">
