						...
						<cfset write_to_buffer(' <td class="tituloListas" align="#Trim(alin[i])#"> ')>
							...
							<cfswitch expression="#LvarFormato#">
								...
								<cfcase value="M,P,R,N,F,I">
                                    ...
                                    <cfsavecontent variable="_LvarinputNumber"><cf_inputNumber name="filtro_#HTMLEditFormat(Trim(arDesplegar[i]))#" value="#replace(temp_value,',','','all')#" form="#params.formName#" decimales="#decimales#" style="width:100%"></cfsavecontent>
