/*
 *  $Id: declarative.js,v 1.3 2007/06/26 13:14:35 source Exp $
 *
			...
			switch (o.name) {
				case "tab_content":
					...
					for (var j=0;j<OAT.Declarative.objects["tab"].length;j++) {
						...
						if (t.div == $Fred(pid)) { t.add(o.params.clicker,o.elm); }
					}
				break;
				case "dock_content":
					var pid = o.params.parent;
					for (var j=0;j<OAT.Declarative.objects["dock"].length;j++) {
						...
						if (d.div == $Fred(pid)) { d.addObject(o.params.column,o.params.clicker,o.elm); }
					}
				break;
				case "panelbar_content":
					...
					for (var j=0;j<OAT.Declarative.objects["panelbar"].length;j++) {
						...
						if (p.div == $Fred(pid)) { p.addPanel(o.params.clicker,o.elm); }
					}
				break;
			} /* switch */
		}
