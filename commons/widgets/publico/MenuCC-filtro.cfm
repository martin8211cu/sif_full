...
<cfset MSG_Oficina 	= t.Translate('MSG_Oficina','El Filtro de oficina es el único que afecta la lista y además los gráficos. Los demás solo afectan la lista.','/commons/widgets/publico/MenuCC.xml')>
...
<cfoutput>
	<cfsavecontent variable="_Filtro">
		...
		<form name="formfiltro" action="MenuCC-iframe.cfm" method="post" style="margin:0;">
