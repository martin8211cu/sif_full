...
<cfif rsProc.recordcount>
	<table width="100%" border="0" cellspacing="0" align="center">
		...
		<cfoutput>
			...
			<td nowrap class="LbTottomline"   align="right" bgcolor="lightgrey"><b><font size="1">#ListGetAt(meses, Mes, ',')#&nbsp;#Periodo#</font></b></td>
			<td nowrap class="LbTottomline"   align="right" bgcolor="lightgrey"><b><font size="1">#ListGetAt(meses, MesAnt, ',')#&nbsp;#PeriodoAnt#</font></b></td>
			<td nowrap class="RLTbottomline"   align="right" bgcolor="lightgrey"><b><font size="1">#ListGetAt(meses, MesPer, ',')#&nbsp;#Periodo1#</font></b></td>
		</cfoutput>
		</tr>
