...
<!--- *************************************************** --->
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<form action="/cfmx/commons/widgets/publico/MenuMB-iframe.cfm" method="post" name="sql">
			<tr class="leftline">
            	<cfoutput>
			...
			<tr class="leftline">
				<td  colspan="4" bgcolor="gainsboro" align="Center">
					<b ><cfoutput>#LB_SaldoActual#</cfoutput></b>
				</td>
			</tr>
		</form>
	</table>
...
<!--- *************************************************** --->
	...
	<table width="100%" border="0" cellspacing="0" align="center">
		...
		<tr>
			...
			<td  nowrap  class="LbTottomline" align="right" bgcolor="##98B1C4"><b ><cfoutput>#LB_Saldo#</cfoutput></b></td>
		...
		<cfloop query="rsOficinasC">
			...
			<tr>
				<td width="70%" class="leftline" colspan="1" bgcolor="lightslategray"><b >#rsOficinasC.Odescripcion#</b></td>
			...
			<cfloop query="rsMonedasC">
				...
				<tr>
					<td  class="leftline" colspan="1" bgcolor="##98B1C4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b >#rsMonedasC.Mnombre#</b></td>
				...
				<cfloop query="rsBancosC">
					<cfset Banco = #Bid#>
					<tr>
						<td  class="leftline" colspan="1" bgcolor="##C8D7E3" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>#rsBancosC.Bdescripcion#</b></td>
					...
					<cfloop query="rsCuentasC">
						...
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font >#TRIM(rsCuentasC.CBdescripcion)#&nbsp;&nbsp;</font><font color="dimgray" >[#rsCuentasC.CBcodigo#]</font></td>
				...
				<tr>
					...
					<td nowrap class="leftline"  align="right" bgcolor="gainsboro"><B><font  color="<cfif TotalMoneda lt 0>##FF0000<cfelse>##000000</cfif>">#LSNumberFormat( TotalMoneda,',9.00')#</font></B></td>
					<td nowrap class="rightline" align="right" bgcolor="gainsboro">&nbsp;</td>
				</tr>
			</cfloop>
		</cfloop>
