...
<cfset MSG_Moneda = t.Translate('MSG_Moneda','Moneda','/sif/generales.xml')>
<cfset LB_Documento = t.Translate('LB_Documento','Documento','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_Socio 	= t.Translate('LB_Socio','Socio','/commons/widgets/publico/MenuCC.xml')>
...
<cfset LB_Contacto 	= t.Translate('LB_Contacto','Contacto','/commons/widgets/publico/MenuCC.xml')>
...
<cffunction name="getTollTipText" returntype="string" output="true">
	...
	<cfsavecontent variable="Info">
		<table width="100%%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<strong>#LB_Socio# : </strong>#Socio.SNnombre#<strong>.</strong>
				</td>
			</tr>
			<cfif len(trim(Socio.SNtelefono))>
				<tr>
					<td>
						<strong>#LB_Telefono# : </strong>#Socio.SNtelefono#<strong>.</strong>
					</td>
				</tr>
			</cfif>
			<cfif len(trim(Socio.SNdireccion))>
				<tr>
					<td>
						<strong>#LB_Direccion# : </strong>#Socio.SNdireccion#<strong>.</strong>
					</td>
				</tr>
			</cfif>
			<tr>
				<td>
					<strong>#LB_Contacto# : </strong><cfif len(trim(Socio.SNCnombre))>#Socio.SNCnombre#<cfelse>N/A</cfif><strong>.</strong>
				</td>
			</tr>
			<cfif len(trim(Socio.SNCtelefono))>
				<tr>
					<td>
						<strong>#LB_Telefono# : </strong>#Socio.SNCtelefono#<strong>.</strong>
					</td>
				</tr>
			</cfif>
			...
			<cfif len(trim(Socio.SNCdireccion))>
				<tr>
					<td>
						<strong>#LB_Direccion# : </strong>#Socio.SNCdireccion#<strong>.</strong>
					</td>
				</tr>
			</cfif>
		</table>
...
<cfset MSG_Vencim = t.Translate('MSG_Vencim','Vencimientos de Saldos de Los &Uacute;ltimos 30 D&iacute;as (Analisis por','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_Total 	= t.Translate('LB_Total','Total','/sif/generales.xml')>
<cfset LB_Saldo 	= t.Translate('LB_Saldo','Saldo','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_VerDet 	= t.Translate('LB_VerDet','Ver Detalles','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_CerrarDet	= t.Translate('LB_CerrarDet','Cerrar Detalles','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_VerDoc 	= t.Translate('LB_VerDet','Ver Documentos','/commons/widgets/publico/MenuCC.xml')>
<cfset LB_CerrarDoc	= t.Translate('LB_CerrarDet','Cerrar Documentos','/commons/widgets/publico/MenuCC.xml')>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0" style="border:0;">
	...
	<cfoutput>
		<tr>
		  ...
		  #MSG_Vencim# <input class="cfmenu_titulo" type="radio" onclick="javascript:funcAnalisis(2);" <cfif Form.Analisis eq 2>checked</cfif> />#MSG_Moneda# / <input class="cfmenu_titulo" type="radio" onclick="javascript:funcAnalisis(1);" <cfif Form.Analisis eq 1>checked</cfif> />#LB_Cliente#)
		  </td>
		</tr>
	...
	<cfif Lista.recordcount eq 0>
		<tr>
            ...
            <cfset MSG_NoReg = t.Translate('MSG_NoReg','No se encontraron registros','/commons/widgets/publico/MenuCC.xml')>
				--- #MSG_NoReg# ---
			</td>
		</tr>
	</cfif>
