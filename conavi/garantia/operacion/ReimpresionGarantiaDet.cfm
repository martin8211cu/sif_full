...
<cf_rhimprime datos="/conavi/garantia/operacion/imprimeGarantia.cfm" regresar="/cfmx/conavi/garantia/operacion/ReimpresionGarantia.cfm">
...
<cfquery name="rsEncabezado" datasource="#session.dsn#">
		select eg.COEGReciboGarantia, eg.COEGNumeroControl, eg.COEGPersonaEntrega, eg.COEGIdentificacion, eg.COEGTipoGarantia,
			...
			group by eg.COEGReciboGarantia, eg.COEGNumeroControl, eg.COEGPersonaEntrega, eg.COEGIdentificacion, eg.COEGTipoGarantia,
...
<table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
		<tr>
			<td align="right">
			  ...
			  <table width="100%" align="left" border="0" height="74">
				  <tr>
					<td width="75%"  align="center"><span class="style17">CONSEJO NACIONAL DE VIALIDAD</span></td>
		...
		<tr>
		  <td align="center"><span class="style18"><strong>Reimpresión Recibo de Garantía: #rsEncabezado.COEGReciboGarantia#-#rsEncabezado.COEGVersion# &nbsp; No. Control: #rsEncabezado.COEGNumeroControl#</strong></span></td>
		</tr>
		<tr>
			<td>
		...
		<tr><td align="left"><span class="style19">Consejo Nacional de Vialidad. Tel:(506)2225-4425 ó 2283-9717 Apto. 616-2010 San José, Costa Rica</span></td>
		</tr>
</table>
</cfoutput>
