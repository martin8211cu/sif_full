...
<cfquery name="rsGarantias" datasource="#session.DSN#">
        ...
        where b.Ecodigo = #session.Ecodigo#
            ...
            <cfif isdefined('form.filtros_COEGReciboGarantia') and len(trim(form.filtros_COEGReciboGarantia)) and form.filtros_COEGReciboGarantia neq -1>
            	and b.COEGReciboGarantia = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Replace(form.filtros_COEGReciboGarantia,',','','all')#">
            </cfif>	
			...
			order by COEGReciboGarantia,COEGid
    </cfquery>
