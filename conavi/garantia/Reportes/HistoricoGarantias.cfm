<cf_templateheader title="CONAVI GARANTIAS - HISTORICO">
...
<cfoutput>
<form name="form1" method="get" action="DetalleHistoricoGarantia.cfm">
				...
				<cf_conlis
					...
					Tabla=" COHEGarantia a
							...
							left join SNegocios c
								on c.SNid = a.SNid"
					Columnas="a.COEGid, a.COEGReciboGarantia, a.CMPid, a.COEGTipoGarantia, a.COEGEstado, a.COEGVersion, a.SNid, c.SNnombre, b.CMPProceso, 
                    		  case a.COEGEstado 
					...
					Filtro=" a.Ecodigo=#session.Ecodigo# and COEGVersionActiva = 1 order by a.COEGReciboGarantia "
					Desplegar="CMPProceso, SNnombre, COEGReciboGarantia, Estado, COEGPersonaEntrega, COEGIdentificacion, COEGContratoAsociado"
					Etiquetas="Proceso, Provedor, N° Garantia, Estado, Persona Entrega, Identificación, Asoc Contr"
					filtrar_por="CMPProceso, SNnombre, COEGReciboGarantia, COEGEstado, COEGid, COEGPersonaEntrega, COEGIdentificacion, COEGContratoAsociado"
					Formatos="S,S,I,I,U,U,U"
					Align="left,left,left,left,left,left,center"
					form="form1"
					Asignar="COEGVersion,COEGid, CMPProceso, COEGReciboGarantia,COEGEstado, COEGPersonaEntrega, COEGIdentificacion, COEGContratoAsociado"
