...
<BODY BGCOLOR=E9E9E9 LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0 onLoad="MM_preloadImages('images/sitioh52_06.jpg','images/sitioh52_07.jpg','images/sitioh52_08.jpg','images/sitioh52_09.jpg','images/sitioh5_05.jpg')">
              ...
              <tr> 
                <td height="124" valign="top" bgcolor="#FFFFFF"> 
                  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td height="50" colspan="2"><img src="images/concurso2.jpg" width="500" height="50"></td>
                      <td width="24%" rowspan="2" align="right" valign="top"><a href="http://www.carmadigital.tv/"><img src="images/carma.gif" width="88" height="106" border="0"></a></td>
                    </tr>
                    <tr>
                      <td width="24%" valign="top">&nbsp;</td>
                      <td width="52%" align="center" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Se ha perdido el balance<br>
El aire se extingue<br>
La tierra se devuelve<br>
El agua se detiene<br>
Y el fuego expira<br>
Todo lo que ser&aacute; se ha perdido<br>
Y no vivir&aacute; nadie que lo recuerde</font></td>
                    </tr>
                    <tr> 
                      <td colspan="3" valign="top">  
                        ...
                        <center>
                          ...
                          <p>&nbsp;</p>
                          <p>Sin embargo existe una esperanza, encontrar entre los elementos a la poseedora del quinto elemento, aquel que dar&aacute; el equilibrio entre elementos y la vida. En alguna de ellas se encuentra.<br>
                            El resultado esta en tus manos ay&uacute;danos a encontrar al 5 elemento. Forma parte de esta b&uacute;squeda eligiendo al 5 elemento mediante tu voto en alguna de estas opciones y a su vez gana premios con solo escribir t&uacute; nombre y correo electr&oacute;nico *.
                          </p>
                          <p><strong>(*) Luego de la votaci&oacute;n escribe t&uacute; nombre completo y correo electr&oacute;nico se te enviar&aacute; posteriormente un formulario para incluir entre los datos la direcci&oacute;n donde se har&aacute;n llegar diferentes premios. </strong> </p>
                          </font>
                        </center>                        <cfquery datasource="h5_votacion" name="datos">
							select * from Concursante order by concursante
						</cfquery>                        <cfoutput>
                          <table width="95%" border="0" align="center" cellpadding="5" cellspacing="2">
                            <tr> 
						    <cfset elem0 = ''>
						    <cfloop query="datos"><cfif datos.CurrentRow le datos.RecordCount / 2>
                              <td align="center"><a href="andreav.cfm?id=#URLEncodedFormat(datos.concursante)#"><img src="fotos/#datos.foto#0_sm80.jpg" width="120" height="160" border="0"></a></td>
							  <cfif datos.elemento neq elem0>
							  <cfset elem0 = datos.elemento>
							  <td rowspan="2" width="5" align="center" valign="middle"><img src="images/#LCase(datos.elemento)#-round.gif" width="71" height="71"></td>
							  </cfif>
						    </cfif></cfloop>
                            </tr>
                            <tr> 
						    <cfloop query="datos"><cfif datos.CurrentRow le datos.RecordCount / 2>
                              <td valign="top"><div align="center"><font color="##666666" size="1" face="Verdana, Arial, Helvetica, sans-serif">#datos.nombre_concursante#<br>
                                  <a href="andreav.cfm?id=#URLEncodedFormat(datos.concursante)#">Ver fotos &gt;&gt;</a><br>
                                  <br>
                                  </font></div></td>
						   </cfif></cfloop>
                            </tr><tr> 
						    <cfloop query="datos"><cfif datos.CurrentRow gt datos.RecordCount / 2>
                              <td align="center"><a href="andreav.cfm?id=#URLEncodedFormat(datos.concursante)#"><img src="fotos/#datos.foto#0_sm80.jpg" width="120" height="160" border="0"></a></td>
							  <cfif datos.elemento neq elem0>
							  <cfset elem0 = datos.elemento>
							  <td rowspan="2" width="5" align="center" valign="middle"><img src="images/#LCase(datos.elemento)#-round.gif" width="71" height="71"></td>
						  ...
						  </cfoutput>                        <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Fotograf&iacute;as por Roc&iacute;o Escobar<br>
						  </font><font size="2" face="Arial, Helvetica, sans-serif"><br>
				          VOTAR ES MUY SENCILLO<br>
                          <a href="#" onClick="MM_openBrWindow('votar2.cfm','Votar','width=725,height=350')"><img src="images/votaya.jpg" width="100" height="38" border="0"></a> </font></p>
						  <p>&nbsp;</p></td>
                    </tr>
                  </table></td>
              </tr>
