	...
	<cfoutput>
		...
		<table cellpadding="2" cellspacing="0" align="center">
			  <tr>
				...
				<td colspan="2" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; ">
					...
					<span class="titulo">Bienvenido Hermano en Nuestra Fe! <br>
					</span>					<br>
					Usted est&aacute; siendo incorporado al directorio de nuestra congregaci&oacute;n con los datos que nos ha suministrado. &nbsp; &nbsp;
					Verifique que la informaci&oacute;n que acaba de indicar es correcta.<br>
					<br>
				<cfif Continuar>
					Su dirección de correo electr&oacute;nico ser&aacute; utilizada para generar la cuenta de acceso a nuestro portal. <strong>Por favor verifique que el e-mail sea correcto.</strong> <br>
					<br>
					Debe suministrarnos la palabra de paso que desea utilizar para acceder a los servicios de nuestra congregaci&oacute;n. Si es correcto, seleccione la opcion "REGISTREME"
					<br>
					<br>
				<cfelse>
					<font color="##FF0000">
					Su dirección de correo electr&oacute;nico est&aacute; siendo utilizado por otro usuario de nuestro portal. <br>
					<br>
					Debe suministrarnos una direcci&oacute;n de correo &uacute;nica para ser utilizada como cuenta de acceso (Login)<br>
					<br>
					<br>
					</font>
				</cfif><!--- Continuar --->				</td>
		...
		Femenino
			  ...
			  <tr>
				...
				<td class="formatoFont2" nowrap>
					<cfset empresa = ListToArray(Form.Iglesia, '|')>
					<cfquery name="rsIglesia" datasource="asp">
						select Enombre as nombre_comercial
						from Empresa
						where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#empresa[1]#">
						and CEcodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.CEcodigo#">
					</cfquery>
					#rsIglesia.nombre_comercial#
				</td>
			  </tr>
			  <tr>
				<td align="center">&nbsp;</td>
			  ...
			  <tr>
				<td colspan="3" align="center" valign="top" nowrap>
					...
					<cfif Continuar>
						<input type="submit" name="btnRegistrar" value="CONTINUAR >>">
					</cfif>
				</td>
			  </tr>
			  <tr>
