...
<cfquery name="RsUsuarios" datasource="asp">
	select  a.Usucodigo,a.Usulogin,	{fn concat({fn concat({fn concat({fn concat(b.Pnombre , ' ' )}, b.Papellido1 )}, ' ' )}, b.Papellido2 )} as nombre
	from Usuario a 
...
<cfquery name="rsEImportadorUsuario" datasource="sifcontrol">	
	...
	Eliminable = {fn concat('<img border=''0'' onClick=''eliminar(',{fn concat(<cf_dbfunction name="to_char" args="Usucodigo" datasource="sifcontrol">,');'' src=''/cfmx/sif/imagenes/Borrar01_S.gif''>')})}
		...
		<tr>
			<td valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							<cfinclude template="/sif/rh/portlets/pNavegacion.cfm">					
						</td>
					</tr>
				</table>					
