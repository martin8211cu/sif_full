...
<cfoutput>
	...
	<cfif bt.IBinvalidos NEQ 0>
		[ <a href="/cfmx/hosting/tratado/importar/importar-errores.cfm?id=#url.id#&amp;hash=#url.hash#" 
	...
	<tr>
		...
		[ <a href="/cfmx/hosting/tratado/importar/importar-rechazo.cfm?id=#url.id#&hash=#url.hash#" 
		    style="text-decoration:underline;color:##0066cc;background-color:##cccccc"
			target="_blank">Ver listado</a> ] 
		</td>
	</tr></cfif>
