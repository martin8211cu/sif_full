...
<cfquery datasource="aspsecure" name="cantidad">
	select coalesce ( max ( ae.prioridad ), 0 ) as cantidad
...
<input type="hidden" name="autorizador" value="#autorizador.autorizador#">
  <table border="0" width="100%">
    ...
    <tr>
      ...
      <td valign="top">
	  <cfif Len(comercio.comisionporc) and comercio.comisionporc neq 0>
	  #NumberFormat(comercio.comisionporc,'0.00')# %
	  </cfif>
	  <cfif Len(comercio.comisionfija) and comercio.comisionfija neq 0>
	  #comercio.moneda# #LSCurrencyFormat(comercio.comisionfija,'none')#
	  </cfif>
	  </td>
    </tr>
    <tr>
