...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	...
	<cfinclude template="/rh/Utiles/params.cfm">
        ...
        <cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
            <form name="form1" method="post" action="ResumenAportesE-form.cfm">
                <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
                    <tr><td colspan="2">&nbsp;</td></tr>
                    <tr>
						<td width="50%" valign="top">
                       		<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
                            	<cf_translate key="LB_ResumenDeCuentaCorrienteEmpleado">
                            	Resumen de Cuenta Corriente Empleado
                                </cf_translate>
                        	<cf_web_portlet_end>
                      	</td>
                        <td>
                        	<table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
								...
								<tr>
                                	<td align="right" nowrap><cf_translate key="LB_Periodo">Periodo</cf_translate>:</td>
                                    <td>
                            	...
                            	<tr>
                                	<td align="right" nowrap><cf_translate key="LB_Mes">Mes</cf_translate>:</td>
