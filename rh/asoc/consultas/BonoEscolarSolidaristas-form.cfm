		...
		<table width="100%" cellpadding="2" cellspacing="0" border="0">
			<tr>
				<td valign="top" colspan="2">
	                ...
	                <cf_reportWFormat url="/rh/asoc/consultas/BonoEscolarSolidaristas-rep.cfm" orientacion="portrait" regresar="BonoEscolarSolidaristas.cfm" params="#params#" pagina="true">
				</td>	
			</tr>
		</table>	
    <cf_web_portlet_end>		
