...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	...
	<cfinclude template="/rh/Utiles/params.cfm">
        ...
        <cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
            <form name="form1" method="post" action="DetalleAportesE-form.cfm">
                <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
                    <tr><td colspan="2">&nbsp;</td></tr>
                    <tr>
						<td width="50%" valign="top">
                       		<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
                            	<cf_translate key="LB_ReporteDetalleAportes">
                            	Reporte de Detalle de Aportes por Empleado muestra los aportes en un mes determinado para todos los empleados.
                                </cf_translate>
                        	<cf_web_portlet_end>
                      	</td>
                        <td>
                        	<table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
                            	<tr>
                                	<td align="right" nowrap><cf_translate key="LB_EmpleadoInicio">Empleado Inicio</cf_translate>:</td>
                                    <td>
                                    	<cf_conlis
										   ...
										   tabindex="1"
										    alt="ID,#LB_Identificacion#,#LB_Empleado#"> 
										
                                    </td>
                                </tr>
								<tr>
                                	<td align="right" nowrap><cf_translate key="LB_EmpleadoFin">Empleado Fin</cf_translate>:</td>
                                    <td>
                                    	<cf_conlis
										   ...
										   filtro="a.Ecodigo = #session.Ecodigo# order by DEidentificacion1"
                            	...
                            	<tr>
                                	<td align="right" nowrap><cfoutput>#LB_Periodo#</cfoutput>:</td>
                                    <td>
										<cfquery name="rsPeriodos" datasource="#session.DSN#">
											select distinct ACASperiodo
											from ACAportesSaldos
										</cfquery>
										<select name="anno" tabindex="1">
											<cfoutput query="rsPeriodos">
											<option value="#ACASperiodo#">#ACASperiodo#</option>
											</cfoutput>
										</select>
									</td>
                                </tr>
...
<cf_qforms form="form1">
	<cf_qformsrequiredfield args="anno,#LB_Periodo#">
</cf_qforms>