...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	...
	<cfif isdefined("Url.ACCTid") and not isdefined("Form.ACCTid")>
		<cfparam name="Form.ACCTid" default="#Url.ACCTid#">
		<cfset form.modo = 'CAMBIO'>
	</cfif>
		
	<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
		<cfoutput>#pNavegacion#</cfoutput>
		<cfinclude template="CreditosTipo-etiquetas.cfm">
				...
				<td valign="top" width="40%">		
					<cfinvoke 
					 ...
					 returnvariable="pListaRet">
						...
						<cfinvokeargument name="columnas" value="ACCTid, ACCTcodigo, ACCTdescripcion "/>
						...
						<cfinvokeargument name="keys" value="ACCTid"/>
						<cfinvokeargument name="irA" value="CreditosTipo.cfm"/>
						<cfinvokeargument name="mostrar_filtro" value="true"/>
						<cfinvokeargument name="filtrar_automatico" value="true"/>
					</cfinvoke>
				</td>
				<td valign="top" width="60%" align="center">	
					<cfinclude template="CreditosTipo-form.cfm">
				</td>
			</tr>
		</table>	
	<cf_web_portlet_end>
