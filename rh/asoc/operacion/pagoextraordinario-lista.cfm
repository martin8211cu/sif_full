			...
			<tr>
				<td valign="top">
					...
					<cfinvoke component="sif.Componentes.TranslateDB"
						...
						Default="Registro de Pagos Extraordinario"
						VSgrupo="103"
...
--->
						<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
						  ...
						  <tr>
							<td>
								<form name="filtro" method="post" action="pagoextraordinario-lista.cfm"  >
							...
							<td>
								...
								<cfinvoke 
								 ...
								 returnvariable="pListaRet">
									<cfinvokeargument name="tabla" value=" 	ACCreditosRegistroPagoE a
									...
									<cfinvokeargument name="columnas" value="  a.ACCRPEid,
																			   e.DEidentificacion, 
																			   ...
																			   b.ACCTcapital - b.ACCTamortizado as saldo,
																			   a.ACCRPEmonto as monto_pago #extra#"/>
									<cfinvokeargument name="desplegar" value="DEidentificacion,asociado,tipo_credito,inicio,monto, amortizado, saldo, monto_pago"/>
									<cfinvokeargument name="etiquetas" value="#LB_Identificacion#, #LB_Asociado#,#LB_Tipo_Credito#,#LB_Fecha_Inicio#, #LB_Monto#, #LB_Amortizado#, #LB_Saldo#, #LB_Monto_Pago#"/>
									<cfinvokeargument name="formatos" value="S,S,S,D,M,M,M,M"/>
									<cfinvokeargument name="filtro" value=""/>
									<cfinvokeargument name="align" value="left,left, left, center, right, right, right, right"/>
									<cfinvokeargument name="ajustar" value="S"/>
									<cfinvokeargument name="checkboxes" value="N"/>
									<cfinvokeargument name="keys" value="ACCRPEid"/>
