...
<cfif modocambio>
	<cfquery name="rsForm" datasource="#session.dsn#">
    	SELECT a.ACARid, b.ACAid, a.ACAAid, c.ACATcodigo, c.ACATdescripcion, a.ACARfecha, abs(a.ACARmonto) as ACARmonto, a.ACARreferencia, a.ts_rversion
...
<cfoutput>
<form action="retiroAportes-sql.cfm" method="post" name="form1">
	<cfif modocambio>
      ...
      <tr>
        ...
        <td>
            ...
            <cf_conlis readonly="#modocambio#"
                ...
                filtro="ACAid = $ACAid,numeric$ and ACATpermiteRetiro = 1 and a.ACAestado = 0"
...
<script language="javascript" type="text/javascript">
	function funcNuevo(){
		...
		document.form1.action = "retiroAportes.cfm";
	}
</script>