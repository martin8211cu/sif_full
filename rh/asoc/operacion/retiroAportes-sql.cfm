...
<cfif isdefined("ALTA")>
    ...
    <cfquery name="rsInsert" datasource="#session.dsn#">
        ...
        VALUES (
            ...
            'A', 
            <cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.ACARmonto,',','','all')*-1#">, 
...
<cfelseif isdefined("CAMBIO")>
	...
	<cfquery name="rsACAportesRegistro" datasource="#session.dsn#">
        ...
        SET ACARfecha = <cfqueryparam cfsqltype="cf_sql_date" value="#Now()#">, 
        	ACARmonto = <cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.ACARmonto,',','','all')*-1#">, 
...
<cflocation url="retiroAportes.cfm?#params#">