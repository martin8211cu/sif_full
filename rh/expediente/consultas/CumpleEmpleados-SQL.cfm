...
<cfquery name="rsReporte" datasource="#session.DSN#">
	...
	from DatosEmpleado a
		...
		<cfif isdefined("Url.optCumple") and Url.optCumple EQ 0> 
			<!--- Cumpleaños de Hoy --->
			and <cf_dbfunction name="date_part" args="DD,a.DEfechanac"> = <cf_dbfunction name="date_part" args="DD,#fechaActual#">
			and <cf_dbfunction name="date_part" args="MM,a.DEfechanac"> = <cf_dbfunction name="date_part" args="MM,#fechaActual#">
		<cfelseif isdefined("Url.optCumple") and Url.optCumple EQ 1> 
			<!--- Cumpleaños de esta semana --->
			and <cf_dbfunction name="date_part" args="WK,a.DEfechanac"> = <cf_dbfunction name="date_part" args="WK,#fechaActual#">
		<cfelse>
			<!--- Cumpleaños del mes --->
			and <cf_dbfunction name="date_part" args="MM,a.DEfechanac"> = <cfqueryparam cfsqltype="cf_sql_integer" value="#Url.mes#">
		</cfif>
...
<cfelseif rsReporte.recordcount NEQ 0>
	...
	<cfelse>
		<cfinvoke component="sif.Componentes.Translate"
			method="Translate"
			Key="LB_ConsultaDeCumpleannosDeEmpleados"
			Default="Consulta de Cumpleaños de Empleados"
			returnvariable="LB_ConsultaDeCumpleannosDeEmpleados"/> 
			...
			<cfoutput query="rsReporte" group="CFid">
				...
				<cfoutput>
					<tr>
						...
						<td align="left" class="xl24">#LSDateFormat(DEfechanac, "DD/MM/YYYY")#</td>
					</tr>
