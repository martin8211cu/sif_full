...
<cfinvoke Key="LB_CumpleannosDeEmpleados" Default="Cumpleaños de Empleados" returnvariable="LB_CumpleannosDeEmpleados" component="sif.Componentes.Translate" method="Translate"/> 								
...
<cfoutput>
	<form method="get" name="form1" action="CumpleEmpleados-SQL.cfm">
			...
			<tr valign="top">
					...
					<table width="100%">
						<tr>
							<td height="173" valign="top">	
								<cf_web_portlet_start border="true" titulo="#LB_CumpleannosDeEmpleados#" skin="info1">
									<div align="justify">
									  <p>
									  ...
									  Se ordena por: Centro Funcional y fecha de cumpleaños.
									  </cf_translate>
									  </p>
								</div>
				...
				<td width="50%" valign="top">
					<table width="100%" cellpadding="2" cellspacing="0" align="center">
						...
						<tr>
							<td nowrap="nowrap"><strong><cf_translate  key="LB_Cumpleannos">Cumpleaños</cf_translate>: </strong>						  </td>
