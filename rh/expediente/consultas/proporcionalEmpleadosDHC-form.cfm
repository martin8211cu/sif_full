...
<cfsilent>
	...
	<cfinvoke component="sif.Componentes.Translate"
		...
		returnvariable="JSMSG_ProporcionalSalario"/> 
	<cfinvoke component="sif.Componentes.Translate"
		method="Translate"
		Key="LB_Debe_estar_en_el_rango_de_0_a_100"
		Default="Debe estar en el rango de 0 a 100"
		returnvariable="LB_Rango"/> 
...
<form name="form1" method="post" action="#Gvar_action#" style="margin:0;">
	...
	<table width="80%" cellpadding="2" cellspacing="0" border="0" align="center">
		...
		<tr id="NAplicadas">
			...
			<td>
				<cf_rhcalendariopagos form="form1" historicos="true" tcodigo="true" index="1" tabindex="1">
			</td>
			<td>
		...
		<tr id="NNoAplicadas" style="display:none">
			<td nowrap align="right"> <strong><cf_translate  key="LB_Nomina">N&oacute;mina</cf_translate> :&nbsp;</strong></td>
			<td>
				<cf_rhcalendariopagos form="form1" historicos="false" tcodigo="true" index="2" tabindex="1">
			</td>
			<td>
		...
		<tr>
			<td nowrap align="right"> <strong><cf_translate  key="JSMSG_ProporcionalSalario">Proporcional Salario</cf_translate> :&nbsp;</strong></td>
			<td><cf_inputNumber name="porcentaje" decimales="2" enteros="3" tabindex="1" value="0.00">%</td>
			<td>&nbsp;</td>
		</tr>
...
<script language="javascript" type="text/javascript">
	...
	function _validateForm1(){
		if (!objForm._allowSubmitOnError) {
			...
			if (objForm.porcentaje.getValue()=='') {
				objForm.porcentaje.throwError("#JSMSG_El_campo# #JSMSG_ProporcionalSalario# #JSMSG_es_requerido#");
			}
			else{
				if (parseFloat(objForm.porcentaje.getValue()) > 100 ) {
					objForm.porcentaje.throwError("#JSMSG_El_campo# #JSMSG_ProporcionalSalario# #LB_Rango#");
				}
			}
		}
	}
