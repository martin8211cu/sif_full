<cf_template template="#session.sitio.template#">
	...
	<cf_templatearea name="body">
		...
		<cfinvoke component="sif.Componentes.Translate"
			method="Translate"
			Key="LB_ConsultaTipoAccionPorEmpresa"
			Default="Consulta Tipo Acci&oacute;n por Empresa"
			returnvariable="LB_ConsultaTipoAccionPorEmpresa"/>
		<cf_web_portlet_start titulo="#LB_ConsultaTipoAccionPorEmpresa#">
