				  	 ...
				  	 <td align="center">
						<table width="75%" cellpadding="3" cellspacing="0">
							<tr class="tituloListas">
								...
								<td align="left" nowrap><cf_translate key="LB_TipoAccion">Folio</cf_translate></td>
								<td align="left" nowrap><cf_translate key="LB_TipoAccion">Descripci&oacute;n</cf_translate></td>
							...
							<tr class="<cfif rstipo_accion_empleado.DEidentificacion NEQ NumEmpleado>listaNon<cfelse>listaPar</cfif>" 
								...
								<td nowrap align="left" >#rstipo_accion_empleado.RHfolio#</td>
								<td nowrap align="left" >#rstipo_accion_empleado.Observaciones#</td>
                                ...
                                <cfquery name="rsTipoComp" datasource="#session.DSN#">
                                		select RHTcomportam from RHTipoAccion 
										where Ecodigo = #session.Ecodigo# 
										and RHTcodigo = '#rstipo_accion_empleado.CodigoAccion#'
                                </cfquery>
                                <cfif isdefined('rsTipoComp') and rsTipoComp.RHTcomportam NEQ 1 and rsTipoComp.RHTcomportam NEQ 2 and rsTipoComp.RHTcomportam NEQ 8>
                                	<cfif rstipo_accion_empleado.Fhasta NEQ '6100-01-01'>
                                		<td nowrap align="left">#(DateDiff('d',rstipo_accion_empleado.Fdesde,rstipo_accion_empleado.Fhasta))+1#</td>
                                    <cfelse>
