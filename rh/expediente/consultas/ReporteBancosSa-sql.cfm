...
<cfsilent><!--- Quitar cuando se desea debuguear --->
	...
	<cf_dbtemp name="salida" returnvariable="salida">
        ...
        <cf_dbtempcol name="Banco" 		type="char(30)" mandatory="no"> <!---SML. Modificacion para agregar el Banco--->
	...
	<cfquery datasource="#session.dsn#">
		insert #salida# (DEid, Nombre, Identificacion, Monto, Banco, Cuenta)
		select a.DEid, upper(coalesce(a.DEinfo1, {fn concat(a.DEapellido1, {fn concat('  ', {fn concat(a.DEapellido2, {fn concat('  ',a.DEnombre)})})})})),
			a.DEidentificacion , b.SEliquido / c.TipoCambio, d.Bdescripcion, a.CBcc
		from DatosEmpleado a, HSalarioEmpleado b, #calendario# c, Bancos d <!---SML. Modificacion para agregar el Banco--->
		where a.Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Ecodigo#">
		and a.DEid = b.DEid
		and b.RCNid = c.RCNid
        and a.Bid = d.Bid <!---SML. Modificacion para agregar el Banco--->
	...
	<cfquery name="rsReporte" datasource="#session.dsn#">
		select Identificacion, Nombre, Monto, Banco, Cuenta from #salida#
		order by 2
	</cfquery>
...
<cf_htmlReportsHeaders 
	irA="ReporteBancosSa.cfm"
	FileName="Reporte_de_Bancos_SA.xls"
	title="#LB_Reporte_de_Bancos_SA#">
<cf_templatecss>
<table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td colspan="15">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr><td>
					<cfinvoke key="LB_ReporteDeBancosSA" default="Reporte de Bancos (S.A.)" returnvariable="LB_ReporteDeBancosSA" component="sif.Componentes.Translate"  method="Translate"/>
					<cfinvoke key="LB_Tipo_De_Cambio" default="Tipo de Cambio" returnvariable="LB_Tipo_De_Cambio" component="sif.Componentes.Translate"  method="Translate"/>
					<cf_EncReporte
						Titulo="#LB_ReporteDeBancosSA#"
						Color="##E3EDEF"
						filtro1="#LB_Tipo_De_Cambio# (#rsCalendario.Moneda#):#LSCurrencyFormat(rsCalendario.TipoCambio,'none')#"	
					>
				</td></tr>
			</table>
		</td>
	...
	<tr>
        ...
        <td  class="tituloListas" valign="top"><strong>#LB_Banco#</strong>&nbsp;</td>
