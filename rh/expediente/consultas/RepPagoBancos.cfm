<cf_template template="#session.sitio.template#">
	...
	<cf_templatearea name="body">
		...
		<cf_web_portlet titulo="#LB_ReporteDeNomina#" >
			...
			<form name="form1" method="post" action="RepPagoBancos_Desp.cfm" style="margin:0;">
				<table width="80%" cellpadding="2" cellspacing="0" border="0" align="center">
					...
					<tr>
						<td align="right" nowrap="nowrap">
							<strong><cf_translate key="LB_NumeroDeLineasPorPagina">N&uacute;mero de L&iacute;neas por Página</cf_translate>:&nbsp;</strong></td>
						<td><cf_monto name="CantLineas" decimales="0" size="15" value="0"></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">
							<input name="MontoxPagina" id="MontoxPagina" type="checkbox" tabindex="1" onclick="javascript: Verificar();" checked="checked">
							<label for="MontoxPagina" style="font-style:normal;font-weight:normal"><strong><cf_translate  key="LB_IncluirMontoPorPagina">Incluir Monto por P&aacute;gina</cf_translate></strong></label>
						</td>
					</tr>
<!---					<tr>
