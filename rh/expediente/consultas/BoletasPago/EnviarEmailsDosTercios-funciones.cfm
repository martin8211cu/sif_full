...
<cffunction access="private" name="prepararCorreo" output="true" returntype="string">
	...
	<cfinvoke component="sif.Componentes.Translate"	method="Translate" xmlfile="/rh/expediente/consultas/HResultadoCalculo.xml"  key="LB_Boleta_Pago" Default="Boleta de Pago"	returnvariable="LB_Boleta"/> 	
	<cfinvoke component="sif.Componentes.Translate"	method="Translate"	xmlfile="/rh/expediente/consultas/HResultadoCalculo.xml" 	key="LB_Retroactivos"	Default="R"	returnvariable="LB_Retroactivos"/> 
	<cfinvoke component="sif.Componentes.Translate"	method="Translate"	xmlfile="/rh/expediente/consultas/HResultadoCalculo.xml" 	key="LB_Renta"	Default="Renta"	returnvariable="LB_Renta"/> 
