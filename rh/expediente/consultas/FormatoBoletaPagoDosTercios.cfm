	...
	<!---CarolRS. Se agrego a la condicion "isdefined('form.RCNid') and len(trim(form.RCNid))" paar evitar error, que daba desde recepcion de pagos en la impresion de l abota de pago--->
    <cfif isdefined("rsFormato") and rsFormato.Pvalor EQ '10' and isdefined('form.RCNid') and len(trim(form.RCNid))> 
		...
		<cfinvokeargument name="chkIncidencias" value="#form.SEincidencias#"/>
		<cfinvokeargument name="chkCargas" value="#form.SEcargasempleado#"/>
		<cfinvokeargument name="chkDeducciones" value="#form.SEdeducciones#"/>
		</cfinvoke>
	...
	<cfelseif isdefined("rsFormato") and rsFormato.Pvalor EQ '30'>
		<!---*******************************************************************---->
		<!---FORMATO PARA 1/2 DE PAGINA (COOPELESCA)--->
		<!---*******************************************************************---->
		<cfinclude template="FormatoBoletaPagoMediaPag.cfm">
    <cfelseif isdefined("rsFormato") and rsFormato.Pvalor EQ '50'>
	    <cfinclude template="FormatoBoletaPagoEstandar.cfm">
	<cfelse>
	   	<!---*******************************************************************---->
			...
			<cfoutput><table width="#vs_width#"  border="0" cellspacing="0" cellpadding="0" align="center"></cfoutput><!----950---->	
				...
				<cfoutput query="ConceptosPago" group="DEid">
								...
								<td valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<!---	<td width="226" valign="top">											
												<cfif len(trim(vs_puntoventa))>
													<cfif len(trim(vs_puntoventa)) GT 20>
														#Mid(vs_puntoventa, 1, 20)#
													<cfelse>
														#vs_puntoventa#
													</cfif>
												<cfelse>
							...
							<!----
							 <tr>
							   <td valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="101" valign="top"><strong><cf_translate  key="LB_Empleado">Empleado:</cf_translate></strong>&nbsp;</td>
											<td width="399" valign="top" align="left">#vs_empleado#</td>																		
											<td width="350" valign="top">
												<b><cf_translate key="LB_Cuenta">Cuenta</cf_translate></b>
												<cfif len(trim(vs_cuenta)) GT 39>
													&nbsp;#Mid(vs_cuenta,1,39)#
												<cfelse>
													&nbsp;#vs_cuenta#
								...
								<td valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="120" align="right" valign="top"><strong><cf_translate  key="LB_PuntoVenta">Punto Venta:</cf_translate></strong>&nbsp;</td>
					...
					<cfoutput>					
						...
						<tr>
							<td valign="top" width="#vn_250#" nowrap>
