...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	key="MSG_Debe_seleccionar_un_empleado"
	Default="Error, debe seleccionar a un empleado para acceder esta opción"
	returnvariable="vSeleccionarEmpleado"/>
	...
	function validaDEid(k,liga){
		...
		if(k==1){
			...
			if(empl != ''){
				...
				alert('<cfoutput>#vSeleccionarEmpleado#</cfoutput>');
			}
		}
	}
</script>
