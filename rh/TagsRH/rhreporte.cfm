...
<cfif Attributes.objetosForm>
	...
	<cfloop list="#Form.FieldNames#" index="i">
		<cfif ListContainsNoCase(parametros, i & "=") EQ 0>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#DFDFDF">
  <tr align="left"> 
	<td nowrap>
		...
		<cfset sistema = 'RH'>
		<cfif isdefined("session.menues.SScodigo") and len(trim(session.menues.SScodigo))>
			<cfset sistema = session.menues.SScodigo >
		</cfif>
		
		<cfif isdefined('Session.Params.ModoDespliegue') and Session.Params.ModoDespliegue EQ 1>
			<a href="/cfmx/home/menu/sistema.cfm?s=<cfoutput>#sistema#</cfoutput>"><cfoutput><cf_translate XmlFile="/rh/generales.xml"  key="LB_RecursosHumanos">Recursos Humanos</cf_translate></cfoutput></a>
		<cfelseif isdefined('Session.Params.ModoDespliegue') and Session.Params.ModoDespliegue EQ 0>
			<a href="/cfmx/rh/autogestion/plantilla/menu.cfm"><cfoutput> <cf_translate XmlFile="/rh/generales.xml"  key="LB_Autogestion">Autogestión</cf_translate></cfoutput></a>
		</cfif>
	</td>
	<td>|</td>
	<cfif len(trim(Attributes.modulo)) gt 0 and len(trim(Attributes.modulolink)) gt 0 and len(trim(Attributes.modulodesc)) gt 0>
		<td nowrap>
			<cfoutput><a href="#Attributes.modulolink#">#Attributes.modulodesc#</a></cfoutput>
		</td>
		<td>|</td>
	</cfif>
	<td>
	...
	<a href="<cfoutput>#Attributes.principal#</cfoutput>"><cfoutput>#LB_Regresar#</cfoutput></a>
	<cfelse>
	<a href="javascript: history.back();"><cfoutput>#LB_Regresar#</cfoutput></a>
	</cfif>
	</td>
	<td align="right" width="100%">
	<cfoutput>
		<a href="javascript:printURL('/cfmx/rh/Utiles/genImpr.cfm#parametros#');"><cfoutput><cf_translate  XmlFile="/rh/generales.xml" key="LB_Imprimir">Imprimir</cf_translate></cfoutput></a>
	</cfoutput>
	</td>
  </tr>
</table>
