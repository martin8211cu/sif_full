...
<cf_templateheader title="#LB_RecursosHumanos#">
		...
		<cf_templatecss>
		<cf_web_portlet_start border="true" titulo="#LB_Expediente#" skin="#Session.Preferences.Skin#">
		...
		<table width="99%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro" align="center">
		  <tr> 
			<td width="9%" align="right"><div align="left"><cf_translate key="LB_Identificacion" xmlFile="/rh/generales.xml">Identificación</cf_translate></div></td>
			<td width="16%"> 
			  <div align="left">
			...
			<td width="7%" align="right"><div align="left"><cf_translate key="LB_Nombre" xmlFile="/rh/generales.xml">Nombre</cf_translate></div></td>
			<td width="48%"> 
			  <div align="left">
			...
			<td width="20%" align="center">
			  <input name="btnBuscar" type="submit" id="btnBuscar" value="<cf_translate key="LB_Filtrar" xmlFile="/rh/generales.xml">Filtrar</cf_translate>">
			</td>
		  </tr>
		</table>
		</form>
			...
			<TABLE width="99%" cellpadding="0" cellspacing="0" align="center">
				<tr><td>
					<cfquery name="lista" datasource="#session.DSN#">
						...
						</cfif>  <!--- se comenta para que tome en cuenta empleados inactivos tambien--->
							<!---and exists (	select 1
												from LineaTiempo lt
