		...
		// Validando tabla: RHEmpleadoCurso - RHEmpleadoCurso
				...
				*/
				...
				if (formulario.RHEMnotamin.value == "") {
					...
					error_msg += "\n - El campo Nota Mínima es requerido.";
				...
				// Columna: RHEMestado Estado int
				if (formulario.RHEMestado.value == "") {
					error_msg += "\n - El campo Estado es requerido.";
					error_input = formulario.RHEMestado;
				}
...
<form action="RHEmpleadoCurso-apply.cfm" onsubmit="return validar(this);" method="post" name="formec" id="form1">
	<table width="100%" cellpadding="1" cellspacing="0">
		
		<tr>
			<td valign="top" align="right">Curso:&nbsp;</td><td valign="top">
		...
		<tr>
			<td valign="top" align="right">Fecha Inicio:&nbsp;</td><td valign="top">
				<cfset fechai = '' >
		...
		<tr>
			<td valign="top" align="right">Fecha Final:&nbsp;</td><td valign="top">
				<cfset fechaf = '' >
		...
		<tr>
			<td valign="top" align="right">Nota Mínima:&nbsp;</td>
			<td valign="top">
		...
		<tr>
			<td valign="top" align="right">Nota obtenida:&nbsp;</td>
			<td valign="top">
