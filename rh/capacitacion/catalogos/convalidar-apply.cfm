...
<cfif IsDefined("form.Cambio")>
	<cfquery datasource="#session.dsn#">
		...
		, RHEMhoras = <cfqueryparam cfsqltype="cf_sql_float" value="#replace(form.RHEMhoras,',','','all')#" null="#Len(form.RHEMhoras) Is 0#">
	...
	<cflocation url="convalidar.cfm?DEid=#URLEncodedFormat(form.DEid)#&RHECid=#URLEncodedFormat(form.RHECid)#&tab=10">
...
<cfelseif IsDefined("form.Alta")>
	<cfquery datasource="#session.dsn#">
		insert into RHEmpleadoCurso ( DEid, Ecodigo, Mcodigo, RHEMnotamin, RHEMnota, RHECtotempresa, RHECtotempleado,
			idmoneda, RHECcobrar, RHEMestado, RHECfdesde, RHECfhasta, BMfecha, BMUsucodigo, RHEMhoras)
		values (
			...
			<cfqueryparam cfsqltype="cf_sql_float" value="#replace(form.RHEMhoras,',','','all')#" null="#Len(form.RHEMhoras) Is 0#">
			)
	</cfquery>
<cfelse>
...
<cflocation url="convalidar.cfm?DEid=#form.DEid#">
