		...
		<tr>
			<td width="50%">
				<cf_web_portlet_start border="true" titulo="Consulta de Evaluaciones" skin="info1">
					<div align="justify">
						<p>Reporte que muestra el listado de los Empleados a los que se les realizo una deducci&oacute;n por concepto de cursos reprobados, dicho listado es filtrado por un rango de fechas establecido</p>
					</div>
				<cf_web_portlet_end>
			</td>
			<td width="50%">
