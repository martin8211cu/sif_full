<cfinvoke component="sif.Componentes.Translate"
	...
	returnvariable="LB_ReporteInformacionDetalladaDeCursos"/> 
		...
		<cf_web_portlet_start titulo="#LB_ReporteInformacionDetalladaDeCursos#">
			<cfinclude template="/home/menu/pNavegacion.cfm">
			<table width="98%" cellpadding="0" cellspacing="0" align="center">			
			<tr>
				<td width="1">&nbsp;</td>
				<td><cfinclude template="Rep_InformacionCursos-rep.cfm"></td>
			</tr>
			...
			<tr>
				...
				<cfoutput>
				<form action="Rep_InformacionCursos.cfm"><input type="submit" value="#BTN_Regresar#" tabindex="1"></form></center></td>
				</cfoutput>
			</tr>
			</table>
		<cf_web_portlet_end>
