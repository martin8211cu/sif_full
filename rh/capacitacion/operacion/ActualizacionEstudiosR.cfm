<cfinclude template="ActualizacionEstudiosR-translate.cfm">
<cf_templateheader title="#LB_nav__SPdescripcion#">
		...
		<cfset CurrentPage=GetFileFromPath(GetTemplatePath())>
			...
			<table width="99%" cellpadding="0" cellspacing="0" align="center">
				<tr>
					...
					<cfinvoke 
						...
						align="left,left"
						formatos="S,S"
						tabla="RHEducacionEmpleado a
								inner join DatosEmpleado b
									on b.DEid = a.DEid
									and b.Ecodigo = a.Ecodigo"
						filtro="a.RHEestado = 0
								  and a.Ecodigo = #session.Ecodigo#"
						ira="ActualizacionEstudiosR.cfm"
			...
			<cfelse>
				<cfinclude template="ActualizacionEstudiosR-form.cfm">
			</cfif>
		<cf_web_portlet_end>
<cf_templatefooter>