...
<cfparam name="form.RHEEfhasta" default="#LSDateFormat(Now())#" type="numeric">
...
<cfif isdefined("form.Alta") or isdefined("form.Cambio")><!--- Requeridos en estas acciones --->
	...
	<cfif isdefined("form.Alta")>
		...
		<cfif datosemp.RecordCount and Len(datosemp.llave)>
			...
			<cfif empleado.RecordCount Is 0><cfset empleado = StructNew()></cfif>
		</cfif>
	</cfif>
<cftransaction>
	<cfif isdefined("form.Alta")>
		<cfparam name="empleado.DEid" default="0">
		<cfparam name="empleado.CFid" default="0">
		<cfif Len(empleado.DEid) Is 0><cfset empleado.DEid = 0></cfif>
		<cfif Len(empleado.CFid) Is 0><cfset empleado.CFid = 0></cfif>
		<cfquery name="ABC_Evaluacion" datasource="#Session.DSN#">
			insert into RHRelacionCap (Mcodigo, RHRCdescripcion, Ecodigo, 
			...
			values(
				...
				, <cfqueryparam cfsqltype="cf_sql_numeric" value="#empleado.DEid#">
				, <cfqueryparam cfsqltype="cf_sql_numeric" value="#empleado.CFid#">
				...
				, 0 <!--- 0=solicitud de capacitación por autogestión --->
	...
	<cfelseif isdefined("form.Baja")>
		...
		<cfif estado.RecordCount>
			<cfif ListFind('0', estado.RHRCestado)>
				<cfquery name="ABC_Evaluacion" datasource="#Session.DSN#">
	...
	<cfelseif isdefined("form.Aplicar")>
		...
		<cfset modoreturn="APLICADA">
	</cfif>
</cftransaction>

<cfif modoreturn EQ 'APLICADA'>
