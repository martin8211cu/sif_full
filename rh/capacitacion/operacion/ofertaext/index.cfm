...
<cf_web_portlet_start titulo="Oferta Externa de Cursos">
	...
	<cfquery datasource="#session.dsn#" name="lista">
		<cf_dbrowcount1 rows=200 datasource=#session.dsn#>
		select i.RHIAid, i.RHIAnombre, m.Mcodigo, m.Msiglas, m.Mnombre,
			...
			(select count(1) from RHOfertaAcademica oa
				where oa.Mcodigo = m.Mcodigo
				  and oa.RHIAid  = i.RHIAid) as existe
			from RHInstitucionesA i , RHMateria m
		...
		<cf_dbrowcount2_a rows=200 datasource=#session.dsn#>
	...
	<cfquery datasource="#session.dsn#" name="grupo">
      ...
      <table width="100%"  border="0" >
        <tr align="center">
          <td valign="top"><table width="750" border="0" style="border:1px solid black; background-color:#CCCCCC " cellpadding="2" cellspacing="0">
            <tr>
              ...
              <td style="font-size:16px" class="subtitulo"><cf_translate key="LB_OfertaExternaDeCursos" xmlFile="/rh/generales.xml">Oferta Externa de Cursos</cf_translate> </td>
            </tr>
            <tr>
              <td rowspan="3" valign="top"><img src="info.gif" width="31" height="30"></td>
              <td>1.<cf_translate key="AyudaPaso1Oferta" xmlFile="/rh/generales.xml">Seleccione la institución y cursos que desea incluir o excluir de la oferta externa</cf_translate> .</td>
            </tr>
            <tr>
              <td> 2. <cf_translate key="AyudaPaso2Oferta" xmlFile="/rh/generales.xml">Presione el botón de mostrar para obtener la lista de cursos y su disponibilidad en la oferta externa</cf_translate>. </td>
            </tr>
            <tr>
              <td>3. <cf_translate key="AyudaPaso3Oferta" xmlFile="/rh/generales.xml">Marque las casillas correspondientes a los cursos que imparte cada institución</cf_translate>.</td>
            </tr>
          </table>
            </td>
        </tr>
        ...
        <tr>
          <td valign="top"><form action="ofertaext-apply.cfm" method="post" name="form1" id="form1"><table  width="100%" border="0" cellpadding="2" cellspacing="0">
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
              <td>&nbsp;</td>
