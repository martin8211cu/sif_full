...
<cfset filtro = " exists (select 1 from EncuestaSalarios m where m.Eid = Encuesta.Eid)" >
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<form style="margin: 0; " name="filtro" method="post" action="datosEncuestas-proceso.cfm">
		...
		<td>
			<cfinvoke 
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="columnas" value="Eid, Edescripcion, Efecha, Efechaanterior, 1 as Paso"/>
				...
				<cfinvokeargument name="irA" value="datosEncuestas-proceso.cfm"/>
