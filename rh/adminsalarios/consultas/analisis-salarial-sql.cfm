<cfif isdefined("Form.paso") and Len(Trim(Form.paso))>
	<cfif Form.paso EQ 1>
		<cfinclude template="analisis-salarial-sqlpaso1.cfm">
	<cfelseif Form.paso EQ 2>
		<cfinclude template="analisis-salarial-sqlpaso2.cfm">
	<cfelseif Form.paso EQ 3>
		<cfinclude template="analisis-salarial-sqlpaso3.cfm">
	<cfelseif Form.paso EQ 4>
		<cfinclude template="analisis-salarial-sqlpaso4.cfm">
	</cfif>
</cfif>

<cfoutput>
	<form name="form1" method="post" action="analisis-salarial.cfm">
		<cfif isdefined("Form.paso") and Len(Trim(Form.paso))>
