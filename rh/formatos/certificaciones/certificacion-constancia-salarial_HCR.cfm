...
==========================================================================================
--->
		<cf_dbtemp name="constancias_coopelesca_v8" returnvariable="datos" datasource="#session.dsn#">
	...
	--->
		...
		<!---  CALCULA VALOR CUOTA ASOCIACION --->
			<cfquery name="rsAsociacion" datasource="#session.DSN#">
				...
				and upper(b.DCcodigo) = 'ASEOB' <!--- OJO ESTE PARAMETRO ES DE COOPELESCA, PUEDE VARIAR DEPENDIENDO CLIENTE --->
			</cfquery>
		...
		<!---  CALCULA RENTA REAL 
			   (CORREGIR PUES ESTE DATO NO ES REAL POR EJEMPLO CASO MENSUAL Y USO DE RCNID Y RCNID-1) --->
		<cfquery name="rsRenta" datasource="#session.DSN#">
...
--->
	...
	<cfquery datasource="#session.DSN#" name="rsPeriodos">
		select 	coalesce(#preservesinglequotes(v_datediff)#,0) as DiasDif
		from #datos#
	</cfquery>
...
--->
	...
	select ((#v_salariopromedio# - DIRinf ) * (DIRporcentaje / 100)) + DIRmontofijo as renta_promedio
		from EImpuestoRenta a, DImpuestoRenta b, RHParametros c, #datos# d
		where a.EIRid = b.EIRid
		and a.EIRestado = 1
		and c.Pcodigo = 30
	...
	<!--- ACTUALIZACION DE DATOS EN TABLA TEMPORAl--->
		<cfquery datasource="#session.DSN#">
			...
			set	fechaingreso 		= '#fechaingreso#', 
				...
				liquido_base_ded 	= #salario_base - cargas_base - asociacion_base#, 
				liquido_promedio 	= #v_salariopromedio - cargas_promedio - asociacion_promedio#, 
...
--->
		...
		<cfquery datasource="#session.DSN#" name="letras">
			select liquido_base_ded, salario_base,salario_promedio,liquido_promedio from  #datos#
		</cfquery>
		...
		<cfinvoke component="sif.Componentes.montoEnLetras" method="fnMontoEnLetras" returnvariable="LvarEnLetras">
			<cfinvokeargument name="Monto" value="#letras.salario_promedio#"/>
		</cfinvoke>
		<cfset salariopromedio_letras = ' #LvarEnLetras#' >
		
		<cfinvoke component="sif.Componentes.montoEnLetras" method="fnMontoEnLetras" returnvariable="LvarEnLetras">
			<cfinvokeargument name="Monto" value="#letras.liquido_promedio#"/>
		</cfinvoke>
		<cfset liquido_promedio_letras = ' #LvarEnLetras#' >
<!--- 
	==========================================================================================
...
<cfquery name="rsQuery" datasource="#session.DSN#">
	select 	DEid,
			...
			<cfqueryparam cfsqltype="cf_sql_varchar" value="#salariopromedio_letras#"> as salariopromedio_letras,
			<cfqueryparam cfsqltype="cf_sql_varchar" value="#liquido_promedio_letras#"> as liquido_promedio_letras,
