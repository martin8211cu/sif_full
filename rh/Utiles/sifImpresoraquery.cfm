    ...
    <cfelseif isdefined("url.campo") and len(trim(url.campo)) and url.campo eq 2>
		...
		<cfif rs.recordcount gt 0>
			<script language="JavaScript" type="text/javascript">
				...
				location.href="/rh/Utiles/sifImpresoraInserta.cfm?valor=<cfoutput>#url.valor#&descripcion=#url.descripcion#&formulario=#url.formulario#&codigo=#url.codigo#</cfoutput>" + params;
			</script>
		<cfelse>
