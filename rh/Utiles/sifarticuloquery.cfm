...
<cfif isdefined("url.dato") and url.dato NEQ "">
	<cfif find("Cformato", url.IACcampo)>
        ...
        <cfelse>
        	<cfthrow message="Debe definir el Complemento Financiero para Compras/Ventas con Servicios, en el catálogo de Socios, tab Información Contable." detail="Proceso cancelado.">
		</cfif>
