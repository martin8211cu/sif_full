...
<tr>
	<td>
		<cfoutput>
			<form style="margin:0;" name="filtroClinteDetCorp2" method="post" action="ConlisClienteDetCorp2.cfm" >
				<table width="100%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro">
					<tr>
				<td align="right"><strong>C&oacute;digo</strong></td>
				<td> 
					<input name="CDCidentificacion" type="text" id="codigo" size="20" maxlength="9" onClick="this.select();" value="<cfif isdefined("Form.CDCidentificacion")>#Form.CDCidentificacion#</cfif>">
				</td>
	...
	<tr><td>
		<cfquery name="rsLista" datasource="#session.DSN#">
			...
			<cfif isdefined("Form.CDCidentificacion") and Len(Trim(Form.CDCidentificacion)) >
				and upper(CDCidentificacion) like '%#trim(ucase(form.CDCidentificacion))#%'
			</cfif>
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="irA" value="ConlisClienteDetCorp2.cfm"/>
