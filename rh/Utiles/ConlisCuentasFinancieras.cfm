...
<script language="JavaScript1.2" type="text/javascript" src="/cfmx/rh/js/sinbotones.js"></script>
<cfoutput>
...
<form name="frmLista" action="#LvarCFM#" method="post" onSubmit="return (Cmayor.value != Cmayor.defaultValue); sinbotones();">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="120" nowrap>
				<cfif form.Ctipo EQ 'A'><cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate><strong><cf_translate  key="LB_Activo">Activo</cf_translate></strong>:
				<cfelseif form.Ctipo EQ 'P'><cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate><strong><cf_translate  key="LB_Pasivo">Pasivo</cf_translate></strong>:
				<cfelseif form.Ctipo EQ 'C'><cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate><strong><cf_translate  key="LB_Capital">Capital</cf_translate></strong>:
				<cfelseif form.Ctipo EQ 'I'><cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate><strong><cf_translate  key="LB_Ingreso">Ingreso</cf_translate></strong>:
				<cfelseif form.Ctipo EQ 'G'><cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate><strong><cf_translate  key="LB_Gasto">Gasto</cf_translate></strong>:
				<cfelse>
				<cf_translate  key="LB_CuentaMayor">Cuenta Mayor </cf_translate>:
				</cfif>
			</td>
			<td>
			<cfif isdefined("url.Cmayores")>
...
<cfif Lvar_CMayorError >
				...
				<cfif isdefined("rsCPvigencia")>
					<cf_translate  key="LB_LaCuentaMayor">- La cuenta Mayor</cf_translate> '#form.Cmayor#' <cf_translate  key="LB_NoTieneVigenciaParaEl"> no tiene vigencia para el </cf_translate> '#form.CPVfecha#'
					<cfset form.Cmayor = "1">
				<cfelseif form.Cmayor NEQ "" AND rsMayor.recordcount EQ 0>
					- <cf_translate  key="LB_CUENTAMAYORNOEXISTE">CUENTA MAYOR NO EXISTE </cf_translate>
				<cfelseif form.Cmayor NEQ "" AND form.Ctipo NEQ "">
					- <cf_translate  key="LB_CUENTAMAYORNOES">CUENTA MAYOR NO ES </cf_translate> 
						<cfif form.Ctipo EQ 'A'>ACTIVO
						<cfelseif form.Ctipo EQ 'P'><cf_translate  key="LB_PASIVO">PASIVO</cf_translate> 
						<cfelseif form.Ctipo EQ 'C'><cf_translate  key="LB_CAPITAL">CAPITAL</cf_translate> 
						<cfelseif form.Ctipo EQ 'I'><cf_translate  key="LB_INGRESO">INGRESO</cf_translate> 
						<cfelseif form.Ctipo EQ 'G'><cf_translate  key="LB_CGASTO">GASTO </cf_translate>
						</cfif>
				</cfif>
				</strong></font>
			</td>
...
<cfexit>
			...
			<td align="right">
				<cfinvoke component="sif.Componentes.Translate"
				method="Translate"
				Key="BTN_VerCuentasExistentes"
				Default="Ver cuentas existentes"
				returnvariable="BTN_VerCuentasExistentes"/>			
	...
	<cfif NOT Lvar_ConPlanCtas>
		<tr>
			<td width="120" nowrap>
				<cf_translate  key="LB_MascaraDeLaCuenta">Mascara de la Cuenta</cf_translate> : 
			</td>
		...
		<tr>
			<td width="120" nowrap>
				<cf_translate  key="LB_CuentaFinanciera">Cuenta Financiera</cf_translate>:
			</td>
			<td colspan="2">
	...
	<cfelse>
		...
		<cfloop query="rsMascara">
			...
			<cfif rsMascara.PCNlongitud NEQ len(LvarMascara[i])>
				...
				<cfthrow message="#MSG_ErrorEnLaDefinicionDeLosNivelesDeLaMascaraPlandeCuentas# #i-1#  #MSG_ConLaMascaraAsignadaALaCuentaMayor#">
			</cfif>
		</cfloop>
		<tr>
			<td width="120" nowrap>
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td nowrap="nowrap">
							<cf_translate  key="LB_MascaraDelPlan">Mascara del Plan :</cf_translate>
						</td>
						<td>
							<img	alt="Estructura de Máscara y Detalle del Plan de Cuentas" 
									onClick="sbPintaMascara();"
									style="cursor:pointer;"
									src="/cfmx/rh/imagenes/Base.gif"
							>&nbsp;
						</td>
					</tr>
				</table>
