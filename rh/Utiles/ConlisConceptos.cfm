...
function Asignar(id, codigo,desc,unidad) {
...
<td valign="top" width="20">
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="columnas" value="Cid,Ccodigo,Cdescripcion,Ucodigo"/>
			...
			<cfinvokeargument name="fparams" value="Cid, Ccodigo, Cdescripcion,Ucodigo"/>
