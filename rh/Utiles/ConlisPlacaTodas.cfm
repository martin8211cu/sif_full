...
<td valign="top">
	...
	<form name="filtroPlaca" method="post" action="ConlisPlacaTodas.cfm">
	...
	<cfquery name="rsLista"  datasource="#session.DSN#" maxrows="500">
			...
			union
			select CRDRplaca as Aplaca,A.CRDRdescripcion as Adescripcion 
	...
	<cfinvoke 
	 ...
	 returnvariable="pListaRet">
		...
		<cfinvokeargument name="irA" value="ConlisPlacaTodas.cfm"/>
