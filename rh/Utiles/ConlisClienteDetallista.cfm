	...
	<tr><td>
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="columnas" value="CDid,CDidentificacion,CDnombre||' ' || CDapellido1 || ' ' || CDapellido2 as CDnombre, coalesce(CDlimitecredito,0) as CDlimitecredito, coalesce(CDcreditoutilizado,0) as CDcreditoutilizado"/>
