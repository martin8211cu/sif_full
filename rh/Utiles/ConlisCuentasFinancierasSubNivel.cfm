...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<body style="margin:0;"> 
		...
		<cfif form.RefID EQ -1 OR form.RefValor EQ "">
			<td align="center" class="tituloListas" style="font-size:11px"><cfoutput><strong>Lista del Catálogo para el Nivel #form.nivel# (depende del valor en el Nivel #form.nivelDepende#)</strong></cfoutput></td>
		<cfelse>
