		...
		#HTMLEditFormat(Trim(ARBOL.Ccodigoclas))# - #HTMLEditFormat(Trim(ARBOL.Cdescripcion))#
			...
			<cfinvoke 
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="columnas" value="Ccodigo, Ccodigoclas, Cdescripcion, Cnivel, CAid"/>
				...
				<cfinvokeargument name="fparams" value="Ccodigo, Ccodigoclas, Cdescripcion, Cnivel, CAid"/>
