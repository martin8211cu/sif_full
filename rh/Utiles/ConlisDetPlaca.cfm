...
<html>
<head>
<title>Lista de Detalle de Placas</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<cf_templatecss>

<style type="text/css">
	<!--- estos estilos se usan para reducir el tamao del HTML del arbol --->
	.ar1 {
...
<td valign="top">
	...
	<cfquery name="rsLista"  datasource="#session.DSN#">
		...
		select 	B.CRDRplaca as Aplaca,
				B.CRDRdescripcion	as Adescripcion
	...
	<cfinvoke 
	 ...
	 returnvariable="pListaRet">
		...
		<cfinvokeargument name="etiquetas" value="Placa, Descripci n"/>
		<cfinvokeargument name="formatos" value=""/>
		<cfinvokeargument name="align" value="left, left"/>
		<cfinvokeargument name="ajustar" value=""/>
		<cfinvokeargument name="irA" value="ConlisDetPlaca.cfm"/>
