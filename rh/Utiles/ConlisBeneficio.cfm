...
<cfquery name="rsLista" datasource="#Session.DSN#">
	...
	<cfif isdefined("Form.Bcodigo") and Len(Trim(Form.Bcodigo)) NEQ 0>
		and upper(a.Bcodigo) like <cfqueryparam cfsqltype="cf_sql_char" value="%#UCase(Form.Bcodigo)#%">
	</cfif>
	<cfif isdefined("Form.Bdescripcion") and Len(Trim(Form.Bdescripcion)) NEQ 0>
		and upper(a.Bdescripcion) like <cfqueryparam cfsqltype="cf_sql_char" value="%#UCase(Form.Bdescripcion)#%">
	</cfif>
...
<cfinvoke 
 ...
 returnvariable="LvarResult">
	...
	<cfinvokeargument name="fparams" value="Bid, Bcodigo, Bdescripcion, Mcodigo, Bmontostd, Bporcemp, Btercero, SNcodigo, SNnumero, SNnombre"/>
