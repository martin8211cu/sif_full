...
<cfset level = 1>
	<tr onMouseOver="files_over(this)" onMouseOut="files_out(this)">
		<td width="16">
		<a href="files.cfm"><img src="/cfmx/rh/imagenes/foldericon.png" width="16" height="16" border="0"></a></td>
...
<cfloop list="#url.p#" delimiters="/" index="dirpart">
	...
	<cfif DirectoryExists(path & '/' & dirpart)>
		...
		<td width="16">
		<a href="files.cfm?p=#URLEncodedFormat(miniurl)#"><img src="/cfmx/rh/imagenes/foldericon.png" width="16" height="16" border="0"></a></td>
...
<cfloop query="dir2">
	...
	<td colspan="#level#">&nbsp;</td><td><a href="files.cfm?p=#URLEncodedFormat(p & '/' & name)#">
		<img src="/cfmx/rh/imagenes/foldericon.png" width="16" height="16" border="0"></a></td>
	...
	<cfelse>
		...
		<img src="/cfmx/rh/imagenes/file.png" width="16" height="16" border="0"></a></td>
