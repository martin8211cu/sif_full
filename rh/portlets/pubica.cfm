<cfif isdefined("Session.Usucodigo") and Len(trim(Session.Usucodigo)) GT 0>
	<cfinclude template="/rh/Utiles/sifConcat.cfm">
			...
			<tr>
				<td width="25%">
					<a href="/jsp/sdc/org/agenda/">
						<img alt="Ir a agenda personal" src="/cfmx/rh/imagenes/agenda.gif" width="32" height="25" align="ABSMIDDLE" border="0" />
					</a>
					<a href="/jsp/sdc/org/agenda/">
				...
				<td class="tituloAlterno" width="50%">
					<cfif rsNombre.recordCount EQ 1>
							...
							<a href="/cfmx/home/menu/micuenta/"><img alt="Ir a configuraci&oacute;n personal" src="/cfmx/rh/imagenes/yo.gif" width="32" height="25" align="ABSMIDDLE" border="0" /></a>
					<cfelse>
						Sin conexi&oacute;n
					</cfif>
				</td>
...
<!--- 					<a href="/jsp/sdc/org/buzon/">#rsMensajes.mensaje#</a>
					<a href="/jsp/sdc/org/buzon/"><img alt="ir al buz&oacute;n" src="/cfmx/rh/imagenes/buzon.gif" width="34" height="23" align="ABSMIDDLE" border="0" /></a>  --->
					<!--- <a href="/cfmx/sif/framework/buzon/index.cfm">#rsMensajes.mensaje#</a> 
					<a href="/cfmx/sif/framework/buzon/index.cfm"><img alt="ir al buz&oacute;n" src="/cfmx/rh/imagenes/buzon.gif" width="34" height="23" align="ABSMIDDLE" border="0" /></a>--->			  </td>
			</tr>
		</table>
	</cfoutput>
</cfif>