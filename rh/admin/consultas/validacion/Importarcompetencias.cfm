...
Default="Importador de Pesos por Compentencias del Puesto"
VSgrupo="103" returnvariable="LB_nav__SPdescripcion"/>
	...
	<table width="98%" align="center" cellpadding="2" cellspacing="0">
		<tr>
			<td width="50%" valign="top">
				<cf_sifFormatoArchivoImpr EIcodigo = 'IMPCOMPETPUE'>
			</td>
			<td width="50%" valign="top">
				<cf_sifimportar EIcodigo="IMPCOMPETPUE" mode="in" />
			</td>
		</tr>
	</table>
 <cf_web_portlet_end>
