...
<cfif isdefined("Form.HYERVfechaalta") and Len(Trim(Form.HYERVfechaalta)) NEQ 0>
	<cfset filtro = filtro & " and a.HYERVfechaalta  >= " & LSParseDatetime(Form.HYERVfechaalta) & 
							 " and a.HYERVfechaalta  < " & dateadd('d',1,LSParseDateTime(Form.HYERVfechaalta))>
...
<cfquery name="rsUsuarios" datasource="asp">
	...
	<cfif rsUsuariosRegistro.recordCount GT 0>
		where u.Usucodigo in (<cfqueryparam cfsqltype="cf_sql_numeric" 
											list="yes" separator="," 
											value="#ValueList(rsUsuariosRegistro.Usucodigo, ',')#">)
	<cfelse>
		where u.Usucodigo = 0
	</cfif>
...
<span style="font-family:Geneva, Arial, Helvetica, sans-serif;font-size:24px;text-align:center;width:100%;font-weight:bold;background-color:#fff">
	<cf_translate key="LB_SeleccioneUnaRelacion">Seleccione una Relaci&oacute;n</cf_translate>
</span>
<cfoutput>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td style="border-bottom: 1px solid black">
		<strong><cf_translate key="LB_RelacionesDeValoracionDePuestosEncontradas">Relaciones de Valoración de Puestos Encontradas</cf_translate>: </strong>
	</td>
  </tr>
  <tr>
    <td>
		...
		<cfinvoke component="sif.Componentes.Translate"
			method="Translate"
			Key="MSG_NoHayNigunaRelacionDeValoracionDePuestosPendientePorAplicar"
			Default="No hay niguna relaci&oacute;n de valoraci&oacute;n de puestos pendiente por aplicar"
			returnvariable="MSG_NoHayNigunaRelacionDeValoracionDePuestosPendientePorAplicar"/>
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="columnas" value="HYERVid, HYERVdescripcion, HYERVfecha as fvigencia, 
													 HYERVestado, Usucodigo, HYERVfechaalta as fregistro"/>
			...
			<cfinvokeargument name="filtro" value=" a.Ecodigo = #Session.Ecodigo# 
													#filtro#
													and a.HYERVestado != 0
													order by a.HYERVfecha, a.HYERVid, a.HYERVfechaalta"/>
			<cfinvokeargument name="align" value="left, center, center"/>
			<cfinvokeargument name="ajustar" value="N"/>
			<cfinvokeargument name="botones" value=""/>
			<cfinvokeargument name="funcion" value="selectvalues"/>
			...
			<cfinvokeargument name="EmptyListMsg" value="-- #MSG_NoHayNigunaRelacionDeValoracionDePuestosPendientePorAplicar# --"/>
		</cfinvoke>
	</td>
  </tr>
</table>
