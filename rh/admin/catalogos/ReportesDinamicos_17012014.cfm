...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Posicion" Default="N&uacute;m. Columna" returnvariable="LB_Posicion"/>	
...
<cfif modo NEQ 'ALTA'>
    ...
    <cfif modoD NEQ 'ALTA'>
		<cfquery name="rsFormD" datasource="#session.DSN#">
        	select RHCRPTcodigo,RHCRPTdescripcion, RHRPTNOrigen,RHRPTNcolumna
            		...
            		<input name="RHRPTNid" type="hidden" value="<cfif isdefined('form.RHRPTNid')>#RHRPTNid#</cfif>">
                    	<table width="75%" cellpadding="2" cellspacing="2" border="0">
                            <tr>
                                ...
                                <td width="75%">
                                  	<input name="RHRPTNcodigo" type="text" maxlength="14" tabindex="1" value="<cfif modo NEQ 'ALTA'>#rsForm.RHRPTNcodigo#</cfif>"/>
                                </td>
                            </tr>
                            <tr>
