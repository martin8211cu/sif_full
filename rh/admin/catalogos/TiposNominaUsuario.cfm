...
<!---<cfinvoke component="rh.Componentes.TiposNominaPermisos" returnvariable="cPermisos"/>
<cfset qPermisos = cPermisos.GetPermisos("Tcodigo=#url.Tcodigo#")>
--->	
	<cf_templateheader title="#LB_RecursosHumanos#">
		...
		<cfif isdefined("url.Tcodigo") and len(trim(url.Tcodigo)) NEQ 0 and not isdefined("form.Tcodigo")>
		...
		<!---<cfparam name="form.Tcodigo" type="numeric" default="">--->
		
		<cfquery name="rsRHTipoNomina" datasource="#session.DSN#">
			select Tdescripcion 
			from TiposNomina
			where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
			  and Tcodigo = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.Tcodigo#">
		</cfquery>
		<cfif isdefined("rsRHTipoNomina") and rsRHTipoNomina.RecordCount neq 0 and not isdefined("form.Tdescripcion")>
			<cfset form.Tdescripcion = rsRHTipoNomina.Tdescripcion>
		</cfif>
		...
		<cfset filtro = "">
		<cfset navegacion = "&Tcodigo=" & #form.Tcodigo# &"especial=" & #form.especial#>
		...
		<cfinvoke component="sif.Componentes.Translate"
			method="Translate"
			Key="LB_CatalogoDeTiposDeNominaPorUsuario"
			Default="Cat&aacute;logo de Tipos de N&oacute;mina por Usuario"
			returnvariable="LB_CatalogoDeTiposDeNominaPorUsuario"/>

		<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_CatalogoDeTiposDeNominaPorUsuario#">
			<cfset regresar = "/cfmx/rh/admin/catalogos/TiposNomina.cfm">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" colspan="2">
						<strong><font size="2">
							<cf_translate key="LB_PermisoAUsuariosDelTipoDeNomina">Permiso a Usuarios del tipo de N&oacute;mina</cf_translate>:
						</font></strong> 
						<font size="2"><cfoutput>#form.Tdescripcion#</cfoutput></font>
					</td>
				</tr>
				...
				<tr>
					<td valign="top" width="40%">
						...
						<cfquery name="rsUsuariosTipoNomina" datasource="#Session.DSN#">
							select distinct Usucodigo
							from TiposNominaPermisos
							where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">
							and Tcodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#form.Tcodigo#">
						</cfquery>
						
						<cfif rsUsuariosTipoNomina.recordCount GT 0>
							<cfset filtro = filtro & " and a.Usucodigo in (#ValueList(rsUsuariosTipoNomina.Usucodigo, ',')#)">
						<cfelse>
						...
						<cfinvoke 
						 ...
						 returnvariable="pListaRet">
							...
							<cfinvokeargument name="columnas" value="a.Usucodigo, b.Pid,{fn concat({fn concat({fn concat({fn concat(b.Pnombre , ' ' )}, b.Papellido1 )}, ' ' )}, b.Papellido2 )}  as nombre, '#form.Tcodigo#' as Tcodigo, '#Form.especial#' as especial"/>
							...
							<cfinvokeargument name="irA" value="TiposNominaUsuario.cfm"/>
					...
					<td width="60%" valign="top">
						...
						<cfinclude template="TiposNominaUsuario-form.cfm">
					</td>
				</tr>
			</table>
