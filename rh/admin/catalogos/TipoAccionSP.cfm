<cfinvoke component="sif.Componentes.TranslateDB" method="Translate" returnvariable="nombre_proceso" 			Default="Tipos de Acción Especial" VSgrupo="103" VSvalor="#session.monitoreo.SScodigo#.#session.monitoreo.SMcodigo#.#session.monitoreo.SPcodigo#"/>
<cfinvoke component="sif.Componentes.Translate"   method="Translate" returnvariable="LB_TiposDeAccionEspecial" 	Default="Tipos de Acción Especial" Key="LB_TiposDeAccionEspecial"/>		
<cfinvoke component="sif.Componentes.Translate"   method="Translate" returnvariable="LB_CODIGO" 				Default="Código" 		Key="LB_CODIGO" 	 XmlFile="/rh/generales.xml"/>
<cfinvoke component="sif.Componentes.Translate"   method="Translate" returnvariable="LB_DESCRIPCION" 			Default="Descripción" 	Key="LB_DESCRIPCION" XmlFile="/rh/generales.xml"/>
<cfinvoke component="sif.Componentes.Translate"   method="Translate" returnvariable="BTN_Filtrar" 				Default="Filtrar" 		Key="BTN_Filtrar" 	 XmlFile="/rh/generales.xml"/>
<cfinvoke component="sif.Componentes.Translate"   method="Translate" returnvariable="BTN_Limpiar" 				Default="Limpiar" 		Key="BTN_Limpiar" 	 XmlFile="/rh/generales.xml"/>
...
<cfset filtro = "Ecodigo = #Session.Ecodigo# and RHTespecial = 1 ">
<cfset navegacion = "">
<cfif isdefined("form.fRHTcodigo") and len(trim(form.fRHTcodigo)) gt 0 >
	<cfset filtro = filtro & " and RHTcodigo like '%#form.fRHTcodigo#%' " >
...
<cf_templateheader title="#nombre_proceso#">
    ...
    <link href="/cfmx/rh/css/rh.css" rel="stylesheet" type="text/css">
	  <cf_web_portlet_start titulo="#LB_TiposDeAccionEspecial#">
              ...
              <tr> 
                <td width="41%" valign="top">
					...
					<cfinvoke component="rh.Componentes.pListas" method="pListaRH" returnvariable="pListaRet">
                        ...
                        <cfinvokeargument name="irA" 		value="TipoAccionSP.cfm"/>
                        <cfinvokeargument name="keys" 		value="RHTid"/>
                        <cfinvokeargument name="navegacion" value="#navegacion#"/>
					</cfinvoke>
				</td>
                <td width="1%" valign="top">&nbsp;</td>
                <td width="58%" valign="top"><cfinclude template="formTipoAccionSP.cfm"></td>
              </tr>
			 </table>
	  <cf_web_portlet_end>
<cf_templatefooter>