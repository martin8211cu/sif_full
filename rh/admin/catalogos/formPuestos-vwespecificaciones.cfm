...
<!--- 	select a.RHTPid, a.RHPcodigo, a.RHPdescpuesto, 
			...
			d.ts_rversion, d.RHDPespecificaciones
	...
	select a.RHTPid, a.RHPcodigo, a.RHPdescpuesto, a.RHOcodigo, 
		   b.RHOdescripcion, a.RHTPid, c.RHTPdescripcion,d.ts_rversion,  d.RHDPespecificaciones
	...
	<tr> 
      <td colspan="2">
			<cfinvoke component="sif.Componentes.Translate"
				method="Translate"
				Key="MSG_NoSeHaDefinido"
				Default="No se ha definido"
				returnvariable="MSG_NoSeHaDefinido"/>
		#iif(len(trim(rsForm.RHDPespecificaciones)),DE(trim(rsForm.RHDPespecificaciones)),DE(MSG_NoSeHaDefinido))#
      </td>
    </tr>	
	<tr><td colspan="2">&nbsp;</td></tr>
  </table>
