...
<cf_translatedata name="get" tabla="RHColumnasReporte" col="RHCRPTdescripcion" returnvariable="LvarRHCRPTdescripcion"/>
<cf_dbfunction name="sPart" args="#LvarRHCRPTdescripcion#$1$80" returnvariable="RHCRPTdescripcion" delimiters="$">
...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_ListaDeCargasObreroPatronales"    Default="Lista de cargas obrero patronales"    returnvariable="LB_ListaDeCargasObreroPatronales"/>
...
<cf_templateheader>
    ...
    <cf_web_portlet_start border="true"  skin="#session.preferences.skin#" >
        ...
        <cfif modo NEQ 'ALTA'>
            <cf_translatedata name="get" tabla="RHReportesNomina" col="RHRPTNdescripcion" returnvariable="LvarRHRPTNdescripcion">
        	<cfquery name="rsForm" datasource="#session.DSN#">
            	select RHRPTNcodigo,#LvarRHRPTNdescripcion# as RHRPTNdescripcion
                from RHReportesNomina
                where Ecodigo  = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
                  and RHRPTNid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.RHRPTNid#">
            </cfquery>
            <cf_translatedata name="validar" tabla="RHReportesNomina" col="RHRPTNdescripcion" filtro="RHRPTNid = #form.RHRPTNid#"/>
            <cfif modoD NEQ 'ALTA'>
                <cf_translatedata name="get" tabla="RHColumnasReporte" col="RHCRPTdescripcion" returnvariable="LvarRHCRPTdescripcion">
        		<cfquery name="rsFormD" datasource="#session.DSN#">
                	select RHCRPTcodigo,#LvarRHCRPTdescripcion# as RHCRPTdescripcion, RHRPTNOrigen
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            		...
            		<input name="RHRPTNid" type="hidden" value="<cfif isdefined('form.RHRPTNid')>#RHRPTNid#</cfif>">
                    	<table width="75%" cellpadding="2" cellspacing="2" border="0">
                            <tr>
                                ...
                                <td width="75%">
                                  	<cfif modo NEQ 'ALTA'>#rsForm.RHRPTNcodigo#</cfif>
                                </td>
                            </tr>
                            <tr>
                           	  	<td width="25%" align="right"><strong>#LB_DESCRIPCION#:</strong>&nbsp;</td>
                                <td width="75%">
 									 <cfif modo NEQ 'ALTA'>#rsForm.RHRPTNdescripcion#</cfif>
                                </td>
                            </tr>
                            <tr><td colspan="2" align="center"><cf_botones modo="CAMBIO" exclude="ALTA,NUEVO,BAJA,CAMBIO,LIMPIAR" regresar="ReportesDinamicos-lista.cfm" tabindex="1"></td></tr>
			...
			<tr>
				...
				<td width="50%" valign="top">
                     <cfif modoD NEQ 'ALTA'>
                        <!---<cf_translatedata name="validar" tabla="RHColumnasReporte" col="RHCRPTdescripcion" filtro="RHCRPTid = #form.RHCRPTid#"/>----->
                    </cfif>
