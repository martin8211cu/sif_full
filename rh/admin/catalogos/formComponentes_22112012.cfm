  ...
  <tr>
    ...
    <td valign="top">
		...
		<td>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="1%" valign="baseline"><input name="CSsalarioEspecie" id="CSsalarioEspecie" tabindex="1" type="checkbox" <cfif MODO neq 'ALTA' and rsForm.CSsalarioEspecie eq 1>checked</cfif> value="checkbox" ></td>
