...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td><cfif modo NEQ 'ALTA' and modoD NEQ 'ALTA'>#rsFormD.RHCRPTcodigo#</cfif></td>
	</tr>
	<tr>
   		<td align="right"><strong>#LB_DESCRIPCION#:</strong>&nbsp;</td>
        <td><cfif modo NEQ 'ALTA' and modoD NEQ 'ALTA'>#rsFormD.RHCRPTdescripcion#</cfif></td>
    </tr>
    <tr>
   		<td align="right"><strong>#LB_Origendedatos#:</strong>&nbsp;</td>
        <td>
            <select name="RHRPTNOrigen" id="RHRPTNOrigen">
              <option value="0" <cfif modo NEQ 'ALTA' and modoD NEQ 'ALTA' and rsFormD.RHRPTNOrigen EQ 0>selected="true"</cfif>><cf_translate key="LB_EmpresaActual">Empresa Actual</cf_translate></option>
              <option value="1" <cfif modo NEQ 'ALTA' and modoD NEQ 'ALTA' and rsFormD.RHRPTNOrigen EQ 1>selected="true"</cfif>><cf_translate key="LB_OtrosPatronos">Otros Patronos</cf_translate></option>
              <option value="2" <cfif modo NEQ 'ALTA' and modoD NEQ 'ALTA' and rsFormD.RHRPTNOrigen EQ 2>selected="true"</cfif>><cf_translate key="LB_Expatronos">Ex-patronos</cf_translate></option>
            </select>
        </td>
    </tr>
    <tr>
    	<td colspan="2"><cf_botones modo="#modoD#" sufijo='D' exclude="NUEVO,BAJA,ALTA,LIMPIAR" form="form2" tabindex="1"></td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
   </tr>
    	...
    	<td colspan="2" align="center">
        	<table width="90%" cellpadding="0" cellspacing="0">
            	<tr>
                    ...
                    <td><cf_botones values="+" names="AgregaI" form="form2"  tabindex="1"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><cf_botones values="+" names="AgregaD" form="form2" tabindex="1"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
						<cf_conlis 
							...
							title="#LB_ListaDeCargasObreroPatronales#"
                    ...
                    <td><cf_botones values="+" names="AgregaC" form="form2" tabindex="1"></td>
                </tr>
