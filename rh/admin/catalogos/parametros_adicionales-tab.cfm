...
<cfparam name="url.Desc" default="">
		...
		<cfquery name="rsModulos" datasource="asp">
			select '' SMCODIGO , 'Parametros Generales' SMdescripcion
        </cfquery>
<cfoutput>
		<!--- <form action="parametros_adicionales-sql.cfm" method="post" name="form_param"> --->
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td>
						<div align="center">
							<input type="submit" name="GuardaAdicional" class="btnGuardar" value="Aceptar">
						</div>
					</td>
				</tr>
			</table>
...
<cffunction name="pintaParametro">
	...
	<cfoutput>
		<cfif Arguments.TipoDato eq "F">
			<cf_sifcalendario form="form_param" value="#Arguments.valor#" name="f_#Arguments.Codigo#">
