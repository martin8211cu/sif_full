...
<!--- 	select a.RHTPid, a.RHPcodigo, a.RHPdescpuesto, 
	...
	select a.RHTPid, coalesce(a.RHPcodigoext, a.RHPcodigo) as RHPcodigo, a.RHPdescpuesto, a.RHOcodigo, 
...
<cfoutput>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
      <td colspan="2">
	  	<cfif len(trim(rsForm.RHDPmision)) GT 0 >
			#trim(rsForm.RHDPmision)#
		<cfelse>
