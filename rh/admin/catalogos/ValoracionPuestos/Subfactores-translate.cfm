...
<cfinvoke Key="LB_Factor" Default="Factor" returnvariable="LB_Factor" component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke Key="LB_CodigoP" Default="C&oacute;digo Padre" returnvariable="LB_CodigoP" component="sif.Componentes.Translate" method="Translate" XmlFile="/rh/generales.xml"/>
...
<cfinvoke Key="LB_RHHSFpuntuacion" Default="Puntuaci&oacute;n" returnvariable="LB_RHHSFpuntuacion" component="sif.Componentes.Translate" method="Translate"/>	
...
<cfinvoke returnvariable="nombre_proceso" component="sif.Componentes.TranslateDB" method="Translate" VSvalor="#session.monitoreo.SScodigo#.#session.monitoreo.SMcodigo#.#session.monitoreo.SPcodigo#" Default="SubFactores" VSgrupo="103"/>
...
<cfinvoke Key="MSG_RHHSFpuntuacion" Default="Puntuación" returnvariable="MSG_RHHSFpuntuacion" component="sif.Componentes.Translate" method="Translate"/>
