				...
				<cfif not existe>
					...
					<cftransaction>
						<cfquery name="CFuncional" datasource="#Session.DSN#">
							insert into CFuncional( CFuaprobado,
							                        Ecodigo, 
													CFcodigo, 
													Dcodigo, 
													Ocodigo, 
							...
							values (
								<cfif isdefined("form.CFuaprobado") and len(trim(form.CFuaprobado))><cfqueryparam cfsqltype="cf_sql_numeric" value="#form.CFuaprobado#"><cfelse>null</cfif>, 
				...
				<cftransaction>
					...
					<cfquery name="CFuncional" datasource="#Session.DSN#">
						update CFuncional set
						    CFuaprobado             = <cfif isdefined("form.CFuaprobado") and len(trim(form.CFuaprobado))><cfqueryparam cfsqltype="cf_sql_numeric" value="#form.CFuaprobado#"><cfelse>null</cfif>, 
							...
							CFComplementoCtaGastoCS	= <cfif isdefined("form.CFComplementoCtaGastoCS") and len(trim(form.CFComplementoCtaGastoCS))><cfqueryparam cfsqltype="cf_sql_varchar" value="#form.CFComplementoCtaGastoCS#"><cfelse>null</cfif>,	
