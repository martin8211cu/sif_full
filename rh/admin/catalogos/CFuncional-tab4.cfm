...
<cfquery name="rsCFuncional" datasource="#session.dsn#">
	select CFid,CFcodigo, CFdescripcion from CFuncional where CFcodigo='#form.CFcodigo#' and Ecodigo=#session.Ecodigo#
</cfquery>
...
<cfif isdefined("rsCFuncional.CFid") and len(trim(rsCFuncional.CFid)) gt 0 >
	<cfset navegacion = navegacion & Iif(Len(Trim(navegacion)) NEQ 0, DE("&"), DE("")) & "CFpk=" & rsCFuncional.CFid>
</cfif>
...
<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_UsuarioAutorizadores# para #LB_RecursosHumanos# y #LB_Compras#">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<form style="margin:0;" name="filtro" method="post">
				...
				>
					<cfinvokeargument name="tabla" value="CFautoriza cfa, Usuario a, DatosPersonales b"/>
					...
					"/>
					<cfinvokeargument name="desplegar" value="Pid, Usulogin, nombre, Jefe"/>
					<cfinvokeargument name="etiquetas" value="#LB_INDENTIFICACION#,Login,#LB_NOMBRE#, JEFE"/>
					...
					<cfinvokeargument name="formName" value="formListCFA">
			...
			<td width="60%" valign="top">
				<cfinclude template="formCFautoriza.cfm">
			</td>
