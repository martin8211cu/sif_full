	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
	    <td colspan="2" class="tituloAlterno" align="center">
			<cfif modo NEQ 'ALTA'>
				<cf_translate key="LB_ModificacionDelTipoDeExpediente">Modificaci&oacute;n del Tipo de Expediente</cf_translate>
			<cfelse>
				<cf_translate key="LB_NuevoTipoDeExpediente">Nuevo Tipo de Expediente</cf_translate>
			</cfif>
		</td>
      </tr>
	  ...
	  <tr>
		<td colspan="2">
			<div align="center">
				...
				<!---  Botones a otros catálogos --->
				<cfif modo NEQ 'ALTA'>
					<cfinvoke component="sif.Componentes.Translate"
					method="Translate"
					Key="BTN_Formatos"
					Default="Formatos"
					returnvariable="BTN_Formatos"/>
					<cfinvoke component="sif.Componentes.Translate"
					method="Translate"
					Key="BTN_Conceptos"
					Default="Conceptos"
					returnvariable="BTN_Conceptos"/>
					<cfinvoke component="sif.Componentes.Translate"
					method="Translate"
					Key="BTN_Usuarios"
					Default="Usuarios"
					returnvariable="BTN_Usuarios"/>
				
					<input name="btnFormatos" type="submit" tabindex="1" value="#BTN_Formatos#" onClick="javascript: this.form.botonSel.value = this.name; deshabilitarValidacion(); FormatosTipo();">
					<input name="btnConceptos" type="submit" tabindex="1" value="#BTN_Conceptos#" onClick="javascript: this.form.botonSel.value = this.name; deshabilitarValidacion(); ConceptosTipo();">
					<input name="btnUsuarios" type="submit" tabindex="1" value="#BTN_Usuarios#" onClick="javascript: this.form.botonSel.value = this.name; deshabilitarValidacion(); UsuariosTipo();">
				</cfif>
			</div>
		</td>
	  </tr>
