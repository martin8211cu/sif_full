...
<form name="form1" method="post" action="TiposNominaUsuario-SQL.cfm">
  <cfoutput>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
		...
		<cfelse>
			...
			<cfquery name="rsUsuariosAutorizados" datasource="#Session.DSN#">
				select distinct Usucodigo from TiposNominaPermisos 
				where Ecodigo = <cfqueryparam value="#session.Ecodigo#" cfsqltype="cf_sql_integer">
				and Tcodigo = <cfqueryparam value="#form.Tcodigo#" cfsqltype="cf_sql_char"> 
			</cfquery>
	...
	<tr><td colspan="2" align="center">
		<cfset regresa = 'TiposNomina.cfm?Tcodigo=' & form.Tcodigo>
		<cfif modo neq "ALTA">
...
<script language="JavaScript1.2" type="text/javascript">
	...
	document.location.href = 'TiposNomina.cfm?Tcodigo=' & id;
	}
