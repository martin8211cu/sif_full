...
<cfinvoke component="sif.Componentes.Translate"
method="Translate"
Key="LB_Tipos_de_Partido"
Default="Tipos de Partido"
returnvariable="LB_Tipos_de_Partido"/>
...
<cf_templateheader title="#LB_Tipos_de_Partido#">
<cfset filtro = "">
							<cfif isdefined("form.codigo") and len(trim(form.codigo)) gt 0 >
								<cfset filtro = filtro & " and upper(EDTPcodigo) like '%#ucase(form.codigo)#%' " >
							</cfif>
							<cfif isdefined("form.descripcion") and len(trim(form.descripcion)) gt 0 >
								<cfset filtro = filtro & " and upper(EDTPdescripcion) like '%#ucase(form.descripcion)#%' " >
							</cfif>
							<cfset filtro = filtro & "order by EDTPcodigo">

					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr> 
							<td valign="top">
						<cf_web_portlet_start titulo="#LB_Tipos_de_Partido#">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<form name="filtro" method="post">
					...
					<cfquery name="rsLista" datasource="#session.DSN#">
									select EDTPid, EDTPcodigo, EDTPdescripcion
									from EDTiposPartido
									where 1=1
						...
						<cfinvoke 
									...
									<cfinvokeargument name="desplegar" value="EDTPcodigo, EDTPdescripcion"/>
									...
									<cfinvokeargument name="irA" value="TiposPartido.cfm"/>
									<cfinvokeargument name="keys" value="EDTPid"/>
									<cfinvokeargument name="EmptyListMsg" value="true"/>
											...
											<td width="50%" valign="top"><cfinclude template="TiposPartido-form.cfm"></td>
										</tr>
									</table>
							  </td>
