...
Key="LB_Roles"
Default="Roles"
returnvariable="LB_Roles"/>

<cf_templateheader title="#LB_Roles#">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr> 
							<td valign="top">
						<cf_web_portlet_start titulo="#LB_Roles#">
						<cfset filtro = "">
						...
						<cfquery name="rsLista" datasource="#session.DSN#" result="rsListaGrupoNivel">
								...
								<cfinvoke 
									...
									<cfinvokeargument name="irA" value="RolPersona.cfm"/>
									<cfinvokeargument name="keys" value="TPid"/>
									<cfinvokeargument name="EmptyListMsg" value="true"/>
								</cfinvoke> 
									
											<!--- AREA DE BUSQUEDA --->
											<td width="50%" valign="top"><cfinclude template="RolPersona-form.cfm"></td>
										</tr>
									</table>
							  </td>
