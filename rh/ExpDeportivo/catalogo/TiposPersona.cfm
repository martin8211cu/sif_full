...
<cfinvoke component="sif.Componentes.Translate"
method="Translate"
Key="LB_Tipos_de_Persona"
Default="Tipos de Persona"
returnvariable="LB_Tipos_de_Persona"/>

<cf_templateheader title="#LB_Tipos_de_Persona#">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr> 
							<td valign="top">
						<cf_web_portlet_start titulo="#LB_Tipos_de_Persona#">
						<cfset filtro = "">
							<cfif isdefined("form.codigo") and len(trim(form.codigo)) gt 0 >
								<cfset filtro = filtro & " and upper(TPcodigo) like '%#ucase(form.codigo)#%' " >
							</cfif>
							...
							<cfset filtro = filtro & "order by TPcodigo">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<!--- AREA DE BUSQUEDA --->
												<form name="filtro" method="post">
													<table border="0" width="100%" class="tituloListas">
														...
														<tr> 
															<td><input type="text" name="codigo" tabindex="1" value="<cfif isdefined("form.codigo") and len(trim(form.codigo)) gt 0 ><cfoutput>#form.codigo#</cfoutput></cfif>" size="5" maxlength="5" onFocus="javascript:this.select();"></td>
						...
						<cfquery name="rsLista" datasource="#session.DSN#" result="rsListaGrupoNivel">
								...
								<cfinvoke 
									...
									<cfinvokeargument name="irA" value="TiposPersona.cfm"/>
									<cfinvokeargument name="keys" value="TPid"/>
									<cfinvokeargument name="EmptyListMsg" value="true"/>
								</cfinvoke> 
									
											<!--- AREA DE BUSQUEDA --->
											<td width="50%" valign="top"><cfinclude template="TiposPersona-form.cfm"></td>
										</tr>
									</table>
							  </td>
