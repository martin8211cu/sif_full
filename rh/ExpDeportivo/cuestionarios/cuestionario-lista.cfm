...
method="Translate"
Key="LB_DefinicionDeFormularios"
Default="Definici&oacute;n de Formularios"
returnvariable="LB_DefinicionDeFormularios"/>

<cf_templateheader title="#LB_DefinicionDeFormularios#">
<cf_web_portlet_start titulo="#LB_DefinicionDeFormularios#">
<cfinclude template="/home/menu/pNavegacion.cfm">
				...
				<table width="100%" cellpadding="1" cellspacing="0" class="areaFiltro">
					<tr>
						...
						<td rowspan="2" width="20%" valign="middle" align="center">
							...
							<input type="button" name="Limpiar" value="#LB_LIMPIAR#" class="btnLimpiar"  onclick="javascript: limpiar();"/> 						
						</td>
					</tr>
					<tr>
	...
	<script language="javascript1.2" type="text/javascript">
		function limpiar () {
			document.filtro.fPCcodigo.value ="";
			document.filtro.fPCnombre.value ="";
			document.filtro.fPCcodigo.value ="";
		}
	</script>
