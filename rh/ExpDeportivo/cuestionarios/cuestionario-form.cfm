...
<cfinvoke Key="MSG_DeseaEliminarElFormulario" Default="Desea eliminar el Formulario?" returnvariable="MSG_DeseaEliminarElFormulario" component="sif.Componentes.Translate" method="Translate"/>				
	...
	<table width="100%" cellpadding="2" cellspacing="0" border="0">
		<form name="form1" method="post" action="cuestionario-sql.cfm" onSubmit="return validar(this);" style="margin:0; ">
				...
				<table align="center" cellpadding="0" cellspacing="0" width="99%">
					<tr>
						<cfif modo neq 'ALTA'>
							...
							<cf_translate key="LB_Formularios">Formularios</cf_translate>
							</td>
							
							<td>
								<a href="##" tabindex="-1">
								<img src="/cfmx/rh/imagenes/search.gif" 
									alt="Previsualizar" 
									name="imagen" 
									border="0" 
									align="absmiddle" 
			...
			<tr>
				...
				<td align="right" width="1%"><cf_translate key="LB_Formulario">Formulario</cf_translate>:&nbsp;</td>
				...
				<td>
					<select name="PCtipo" class="flat">
						...
						<option value="40" <cfif modo neq 'ALTA' and pcdata.PCtipo eq 40 >selected</cfif>><cf_translate key="CMB_Otros">Otros</cf_translate></option>
						 --->						
						 <option value="50" <cfif modo neq 'ALTA' and pcdata.PCtipo eq 50 >selected</cfif>><cf_translate key="CMB_Formulario">Formulario</cf_translate></option>
						 <option value="60" <cfif modo neq 'ALTA' and pcdata.PCtipo eq 60 >selected</cfif>><cf_translate key="CMB_Medico">Medico</cf_translate></option>
			...
			<tr><td colspan="6" align="center">
				...
				<cfelse>
					...
					<input type="submit" name="PCEliminar" value="<cfoutput>#BTN_Eliminar#</cfoutput>" onClick="javascript:if (confirm('<cfoutput>#MSG_DeseaEliminarElFormulario#</cfoutput>')){ btnSelected='Eliminar'; return true;} return false;">
				</cfif>
