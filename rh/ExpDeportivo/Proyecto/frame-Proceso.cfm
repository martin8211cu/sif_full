		...
		<table border="0" cellpadding="2" cellspacing="0">
			<cfif Left(Session.Progreso.Pantalla,1) EQ "1">
			  <tr>
				...
				<td class="etiquetaProgreso" nowrap><a href="javascript: showList(true);" tabindex="-1">Seleccionar Instituci&oacute;n</a></td>
			  </tr>
			  <tr>
				<td>&nbsp;</td>
				<td width="1%" align="right"><img src="/cfmx/rh/imagenes/iindex.gif" border="0"></td>
				<td class="etiquetaProgreso" nowrap><a href="/cfmx/rh/ExpDeportivo/Proyecto/Proyecto.cfm?o=2" tabindex="-1">Nueva Instituci&oacute;n</a></td>
			  </tr>
