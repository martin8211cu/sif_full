...
returnvariable="CMB_Seleccionar"/>	
	...
	<select name="EDvid2" id="EDvid2" onFocus="javascript:this.select();">
		<option value=""><cfoutput>#CMB_Seleccionar#</cfoutput></option>
<cfloop query ="rs">
	<cfoutput>
	 <option value="#rs.EDvid#"<cfif Modo eq 'CAMBIO' and form.EDPequipo2 eq rs.EDvid>selected</cfif>>#rs.TEdescripcion# - #rs.Edescripcion#</option> 
    </cfoutput>
</cfloop>
</select>
