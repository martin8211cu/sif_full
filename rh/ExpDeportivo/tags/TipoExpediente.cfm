...
<script>            
            ...
            function doConlis() {
                       popUpWindow("../catalogo/AgregarTEX.cfm?popup=s" ,250,200,650,350);
            }

</script>

<select name="TiposExpediente" id="TiposExpediente">
<option value=""><cfoutput>#CMB_Seleccionar#</cfoutput></option>
<cfloop query ="rs">
	<cfoutput>
		<option value="#rs.EDEXid#">#rs.EDEXcod# - #rs.EDEXdes#</option>
    </cfoutput>
</cfloop>
</select>
