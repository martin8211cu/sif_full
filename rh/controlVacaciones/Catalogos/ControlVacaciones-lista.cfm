			...
			<tr>
				<td valign="top">
					...
					<cf_web_portlet_start border="true" titulo="<cfoutput>#nombre_proceso#</cfoutput>" skin="#Session.Preferences.Skin#">
						...
						<cfif isdefined("Url.DVAid") and not isdefined("Form.DVAid")>
							<cfparam name="Form.DVAid" default="#Url.DVAid#">
						</cfif>
						...
						<cfif isdefined("Form.sel") and form.sel NEQ 1>
	   					...
	   					<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr style="display: ;" id="verFiltroListaEmpl"> 
								<td> 
							  		<form name="formFiltroListaEmpl" method="post" action="ControlVacaciones-lista.cfm">
