	...
	<cftry>
		...
		<cfquery name="ABC_Vacaciones" datasource="#Session.DSN#">
			<cfif isdefined("Form.btnAgregar")>
				insert into DVacacionesEmpleado(DEid, Ecodigo, DVEfecha,DVEdescripcion, DVEdisfrutados, DVEcompensados, DVEenfermedad, DVEmonto, Usucodigo, Ulocalizacion)
				values (
...
<cfset actionsc = "ajusteVacaciones-cons.cfm">
