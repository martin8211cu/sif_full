...
<!--- Reporte del epleado realizado por el evaluador --->
  <cfquery name="rsProc" datasource="#session.DSN#">
				...
				select a.RHUMid
					...
					,rhp.RHPdescripcion
					,rhpu.RHPdescpuesto 
					,isnull(RHCMhorasadicautor,0) as RHCMhorasadicautor
		...
		<cfif rsProc.RecordCount NEQ 0>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;" align="center" class="areaFiltro">
				<tr> 
					<td colspan="4"  valign="middle" align="center"><strong style="font-family:'Times New Roman', Times, serif; font-size:13pt; font-variant:small-caps; font-weight:bolder; padding-left:20px"><cfoutput>#rsProc.Enombre#</cfoutput></strong></td>
				</tr>
				<tr> 
					<td colspan="4" align="center">
						<strong style="font-family:'Times New Roman', Times, serif; font-size:12pt; font-variant:small-caps; font-weight:bolder; padding-left:20px">
				...
				<cfoutput query="rsProc">
					...
					<cfif supervisor NEQ rsProc.NombreUsuario>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;" align="center">
							...
							<cfif rsProc.CurrentRow NEQ 1>
								<tr class="listaCorte" >
									<td width="50%" colspan="5">Total de Horas Extras Autorizadas por Supervisor: #rsProc.NombreUsuario#</td>
									<td width="10%" align="left">#LSNumberFormat(TotalExtrasSP,',9.00')#</td>
								</tr>
							</cfif>
							<tr > 
								<td colspan="6" align="center"><font size="2"><strong>Centro Funcional: &nbsp;</strong>#rsProc.CFdescripcion#<strong></strong></font>&nbsp;</td>
							</tr>
							<tr > 
					...
					<cfif IdEmpleado NEQ rsProc.cedula >
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;" align="center">
							...
							<tr > 
								<td colspan="6" align="center"><font size="2"><strong>Puesto: &nbsp;</strong>#rsProc.RHPdescpuesto#<strong></strong></font>
								&nbsp;</td>
							</tr>  
							<cfif isdefined("form.fdesde") and len(trim(form.fdesde)) neq 0 and isdefined("form.fhasta") and len(trim(form.fhasta)) neq 0 >
								<tr > 
							...
							<tr class="listaCorte" >
									...
									<!--- <td width="10%"><strong>Horas Rebajadas</strong></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;" align="center">
						...
						<tr>
							...
							<td width="10%" class="<cfif NumLinea MOD 2>listaPar<cfelse>listaNon</cfif>" align="left">#LSNumberFormat(rsProc.RHCMhorasadicautor,',9.00')#</td>
				...
				<cfif #temp# GT 0>
					<tr > 
						<td colspan="6" align="left"><strong>Este reporte es de carater temporal , ya que no se ha cerrado el Procesamiento de marcas.</strong></td>
					</tr>  
				</cfif>
				<tr > 
					<td colspan="6" align="center">&nbsp;</td>
		...
		<cfelse>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" >
				...
				<tr > 
					<td colspan="6" align="center"><font size="2"><strong>No hay registros</strong></font>
					&nbsp;</td>
				</tr>  
				 <tr><td><hr width="100%" size="0" color="##000000"></td></tr>
			</table>
