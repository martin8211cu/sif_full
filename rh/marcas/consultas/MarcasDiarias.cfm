	...
	<table width="100%" cellpadding="2" cellspacing="0">
		<tr>
			...
			<cfinvoke component="sif.Componentes.Translate"
				method="Translate"
				Key="LB_DiarioMarcas"
				Default="Reporte Diario de marcas"
			...
			<cfoutput>
				<form method="post" name="form1" action="MarcasDiarias-vista.cfm">
									...
									<tr>
										<td height="173" valign="top">																											
											<cf_web_portlet_start border="true" titulo="#titulo#" skin="info1">
												<div align="justify">
												  <p>
												  	<cf_translate  key="AYUDA_EsteReporteseMuestranLasMarcasDiariasPorEmpleadoDelCentroFuncional">														  
													  En &eacute;ste reporte 
													  se muestran las marcas diarias por empleado del centro funcional
													  </cf_translate>
												  </p>
											</div>
										  <cf_web_portlet_end>							  
								  ...
								  <tr> 
									 ...
									 <tr>
										...
										<td>
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr>
													<td width="1%" valign="middle"><input type="checkbox" name="resumido"></td>
