...
<cfif isdefined("Form.fDEnombre") and Len(Trim(Form.fDEnombre)) NEQ 0>
	<cfset filtro = filtro & " and upper({fn concat(a.DEapellido1,{fn concat(' ',{fn concat(a.DEapellido2,{fn concat(',',a.DEnombre)})})})})  like '%" & UCase(Form.fDEnombre) & "%'">
...
<cfif isdefined("Form.RHPMid") and Len(Trim(Form.RHPMid))>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr id="trEmpleados" style="display: none; ">
		<td valign="top">
		  	<form name="filtroListaEmp" method="post" action="Marcas.cfm" style="margin: 0; ">
				<cfif isdefined("Form.RHPMid") and Len(Trim(Form.RHPMid))>
						...
						<cfinvoke 
						 ...
						 returnvariable="pListaEmpl">
							...
							<cfinvokeargument name="filtro" value=" b.Ecodigo = #Session.Ecodigo# 
																	...
																	and (um.RHUMtmarcas = 1 or um.RHUMgincidencias = 1)
																	#filtro# 
																	group by a.DEid,a.DEidentificacion, a.DEapellido1, a.DEapellido2, a.DEnombre"/>
							<cfinvokeargument name="align" value="left, left, right, right"/>
							<cfinvokeargument name="ajustar" value="N"/>
							<cfinvokeargument name="irA" value="Marcas.cfm"/>
							<cfinvokeargument name="navegacion" value="#navegacion#"/>
	  ...
	  <tr id="trMantenimiento" style="display: none; ">
		<td valign="top">
			<cfif isdefined("Form.showDetail") and Form.showDetail EQ 1>
				<cfinclude template="MarcasDetalle-form.cfm">
			<cfelse>
				<cfinclude template="MarcasControl-form.cfm">
			</td></tr></cfif>
