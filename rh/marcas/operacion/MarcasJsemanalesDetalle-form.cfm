...
<cfif rsPermisoGenIncidencia.recordCount GT 0>
	...
	<cfif isdefined("Form.GenDetalle") and Form.GenDetalle EQ 1>
		...
		<cfif rsCount.cant EQ 0>
			<cfinclude template="GenerarDetalleJsemanales.cfm">
		</cfif>
		<cfinclude template="modificaResultadoJsemanales.cfm">
	</cfif>
	...
	<cfoutput>
		<form name="goControl" method="post" action="MarcasJsemanales.cfm" style="margin: 0; ">
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<td width="50%" valign="top">
						<form name="form1" method="post" action="MarcasJsemanalesDetalle-SQL.cfm">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="2">
							  <tr>
								<td class="tituloAlterno" colspan="2" align="center" nowrap>
									<cfif modo EQ 'CAMBIO'><cf_translate key="LB_Modificar">Modificar</cf_translate><cfelse><cf_translate key="LB_Agregar">Agregar</cf_translate></cfif><cf_translate key="LB_Incidencias_por_Horas_Extra"> Incidencias por Horas Extra</cf_translate>
								</td>
							  </tr>
							  <tr>
							  ...
							  <tr>
								<td colspan="2" valign="top" nowrap class="fileLabel" align="center">
								  ...
								  <input type="button" name="btnRegresar" value="#BTN_Regresar#" onClick="javascript: regresar();">
								  <cfif modo EQ "CAMBIO">
									<cfset ts = "">
									<cfinvoke 
