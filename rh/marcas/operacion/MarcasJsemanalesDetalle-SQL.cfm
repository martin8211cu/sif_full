...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="MSG_No_se_puede_insertar_mas_de_un_Concepto_de_Incidencia"
	Default="No se puede insertar más de un Concepto de Incidencia."	
	returnvariable="MSG_MasDeUnConcepto"/>
	...
	<cfif not isdefined("Form.btnNuevo")>
		...
		<cfif isdefined("Form.Alta") or isdefined("Form.Cambio")>
			...
			<cfif chkExists.recordCount GT 0>
				<cf_throw message="#MSG_MasDeUnConcepto#" errorcode="4040">
				<cfabort>
			</cfif>
		</cfif>
