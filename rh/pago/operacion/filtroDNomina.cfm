...
<cfif isdefined("Form._DRIdentificacion") and Len(Trim(Form._DRIdentificacion)) NEQ 0>
	<cfset filtro = filtro & " and upper(a.DRIdentificacion) like '%" & #UCase(Form._DRIdentificacion)# & "%'">
...
<cfif isdefined("Form._Nombre") and Len(Trim(Form._Nombre)) NEQ 0>
	<cfset filtro = filtro & " and upper({fn concat({fn concat({fn concat({fn concat(DRNapellido1 , ' ' )}, DRNapellido2 )}, ' ' )}, DRNnombre )}) like '%" & #UCase(Form._Nombre)# & "%'">
...
<cfif isdefined("Form._DRNperiodo") and Len(Trim(Form._DRNperiodo)) NEQ 0>
	<cfset filtro = filtro & " and a.DRNperiodo >= "& LSParseDateTime(Form._DRNperiodo)>
