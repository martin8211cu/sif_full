...
<cffunction access="public" name="enviarCorreo" output="true" returntype="boolean">
...
<cffunction access="public" name="getRHPvalor" output="false" returntype="string">
...
<cffunction access="public" name="getEmailFromAdmin" output="false" returntype="string">
...
<cffunction access="public" name="getEmailFromJefe" output="false" returntype="string">
	<cfargument name="DEid" required="yes" type="numeric">
	<cfset Lvar_RHPid = 0>
	<cfset Lvar_CFid = 0>
	<cfset Lvar_DEid = 0>
...
<!--- 	<cfset Lvar_RHPid = rsPlaza.RHPid>
	<cfquery name="rsCFid" datasource="#session.DSN#">
		select CFid
		from RHPlazas 
		where RHPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Lvar_RHPid#">
	</cfquery>
	<cfset Lvar_CFid = rsCFid.CFid>
