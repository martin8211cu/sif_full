...
<cfinclude template="../boleta/ParametrizaBoletaPago.cfm">
...
<cfif isdefined("Form._DRNestado") and Len(Trim(Form._DRNestado)) NEQ 0 and (Trim(Form._DRNestado) NEQ 0)>
	<cfset filtro = filtro & " and a.DRNestado = " & Trim(Form._DRNestado)>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	function funcEnviarSMS() {
		...
		var left = (screen.width - width) / 2;
		<cfoutput>
		var nuevo = window.open('/cfmx/rh/pago/operacion/EnviarSMS.cfm?ERNid=#Form.ERNid#','ListaEmpleados','menu=no,scrollbars=yes,top='+top+',left='+left+',width='+width+',height='+height);
		</cfoutput>
		nuevo.focus();
	}
	...
	function funcMensajeBoleta(){
		location.href = '../../admin/catalogos/MensajeBoletaPago.cfm?ruta=../../pago/operacion/PNomina.cfm?ERNid='+document.formSel.ERNid.value;
	}
</script>
  ...
  <tr>
    <td width="65%" valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="95%" align="center">
		  ...
		  <tr>
			<td>
				<table width="100%"  border="0" cellspacing="2" cellpadding="0">
				  <tr>
					<td valign="middle" width="1%" align="right" nowrap><strong><cf_translate  key="LB_Ver">Ver</cf_translate>:&nbsp;</strong></td>
		  ...
		  <!--- <tr>
			<td>
				<form action="SQLPNomina.cfm" method="post" name="formSel">
...
<br><br><br><br>
		<table border="0" cellspacing="0" cellpadding="0" width="95%" align="center">
		<form action="SQLPNomina.cfm" method="post" name="formButs">
		<input type="hidden" name="ERNid" value="<cfoutput>#Form.ERNid#</cfoutput>">
		  <tr>
		  	<td class="ayuda">
				<table border="0" cellspacing="0" cellpadding="0" width="95%" align="center">
		  ...
		  <tr>
			...
			<cfquery name="rsExportado" datasource="#session.DSN#">
				select ERNexportado from ERNomina
				where ERNid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.ERNid#">
			</cfquery>
