	...
	<cfif rsTNom.RecordCount gt 0 and rsTNom.CalculaCargas eq 1>
		...
		<cfquery name="inserted"  datasource="#session.dsn#">
			...
			values (
					...
					<!--- TESDPmontoVencimientoOri --->		<cfif isDefined("rsNominaT") and rsNominaT.RecordCount GT 0>, round(#rsNominaT.sumHDRNliquido#,2)<cfelse>, 0</cfif>
					<!--- TESDPmontoSolicitadoOri --->		<cfif isDefined("rsNominaT") and rsNominaT.RecordCount GT 0>, round(#rsNominaT.sumHDRNliquido#,2)<cfelse>, 0</cfif>
					<!--- TESDPmontoAprobadoOri --->		<cfif isDefined("rsNominaT") and rsNominaT.RecordCount GT 0>, round(#rsNominaT.sumHDRNliquido#,2)<cfelse>, 0</cfif>
					<!--- TESDPmontoAprobadoLocal --->		<cfif isDefined("rsNominaT") and rsNominaT.RecordCount GT 0>, round(#rsNominaT.sumHDRNliquido#,2)<cfelse>, 0</cfif>
					<!--- TESDPimpNCFOri --->				, 0
