...
<form action="SQLRNomina.cfm" method="post" name="form" <cfif modo neq 'AlTA'>onSubmit="javascript: fnfinalizar(document.form);"</cfif>>
    ...
    <tr> 
      <td nowrap> 
        <!--- Tipo de Nómina --->
		<cfif modo neq 'AlTA'>
        	<cf_rhtiponominaCombo index="0" query="#rsERNomina#" todas="False">
		<cfelse>
      ...
      <td nowrap colspan="5">&nbsp;
						...
						<tr>
							...
							<td nowrap>
								...
								<a href="javascript:doConlisDeducciones(0);" tabindex="-1"> 
									<img src="/cfmx/rh/imagenes/Description.gif" width="18" height="14" border="0"> 
								</a> 
								</cfif>
							</td>
						</tr>						
		...
		<tr> 
			<td nowrap align="center" colspan="4"> <input name="txtEnterSI" tabindex="-1" type="text" size="1" maxlength="1" readonly="true" class="cajasinbordeb"> 
				<cfoutput> 
					<cfif modo eq 'ALTA'>
						<input type="submit" alt="0" name='ALTA' value="#BotonAgregar#" onClick="javascript: return setBtn(this);" tabindex="3">
						<input type="reset" name="Limpiar" value="#BotonLimpiar#" tabindex="3">
					<cfelse>
						<cfif dmodo eq 'ALTA'>
							<input type="submit" alt="4" name='DALTA' value="#BotonAgregar#" onClick="javascript: return setBtn(this);" tabindex="3">
							<input type="reset" name="DLimpiar" value="#BotonLimpiar#" tabindex="3">
						<cfelse>
							<input type="submit" alt="5" name="DCambio" value="#BotonCambiar#" onClick="javascript: return setBtn(this);" tabindex="3">
							<input type="submit" alt="6" name="DBaja" value="#BotonBorrar#" onClick="javascript: return setBtn(this);" tabindex="3">
							<input type="submit" alt="7" name="DNuevo" value="#BotonNuevo#" onClick="javascript: return setBtn(this);" tabindex="3">
						</cfif>
						<cfinvoke component="sif.Componentes.Translate"
						method="Translate"
						Key="LB_EliminarNomina"
						Default="Eliminar N&oacute;mina"
						returnvariable="LB_EliminarNomina"/> 
						
						<cfinvoke component="sif.Componentes.Translate"
						method="Translate"
						Key="LB_PasarVerificacin"
						Default="Pasar a Verificaci&oacute;n"
						returnvariable="LB_PasarVerificacin"/> 
						
						<input type="submit" alt="2" name="Baja" value="#LB_EliminarNomina#" onClick="javascript: return setBtn(this);" tabindex="3">
						<input type="submit" alt="8" name="Listo" value="#LB_PasarVerificacin#" onClick="javascript: return setBtn(this);" tabindex="3">
					</cfif>
				</cfoutput> 
				<cfif modo neq 'AlTA'>
					<cfoutput>
