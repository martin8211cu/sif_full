...
<!--- INFORMACION DEL MES --->
		...
		<cfif Parametro311.recordcount GT 0> <!--- Existe el Parámetro en el Cliente --->
		...
		<cfelse>
				<cfif isdefined("url.Poliza") and len(trim(url.Poliza))> <!--- Uso Exportador de Múltiples Pólizas --->
