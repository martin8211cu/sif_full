...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="LB_Exportar_Interfaz_para_Contabilidad_BNVital"
	Default="Exportar a Interfaz para Contabilidad de BN Vital"	
	returnvariable="LB_Exportar_Interfaz_para_Contabilidad_BNVital"/>	
	...
	<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
		<cf_web_portlet_start titulo="<cfoutput>#LB_Exportar_Interfaz_para_Contabilidad_BNVital#</cfoutput>">
			...
			<form name="form1" action="../operacion/InterfaseContabilidadBNV.cfm" method="get">
					...
					<tr>
						<td width="45%" valign="top">															
							<cf_web_portlet_start border="true" titulo="#BTN_Exportar_Mediante_Interfaz#" skin="info1">
								<div align="justify">
								  <p><cf_translate key="LB_ConsultaNominasParaContabilidadPresupuestoBNvital">Permite escoger alguna Nóminas aplicadas y exportarla mediante la interfaz de Contabilidad para BN Vital</cf_translate></p>
								</div>
							<cf_web_portlet_end>
						</td>
