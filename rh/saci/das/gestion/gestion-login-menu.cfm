		...
		<form name="formCuadroOpt" action="#CurrentPage#" method="get" style="margin: 0;">
			...
			<table border="0" cellpadding="2" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td  nowrap>
					<a href="javascript: goPage2(document.formCuadroOpt, 0, 1);" tabindex="-1" onMouseOver="javascript: window.status = ''; return true;" onMouseOut="javascript: window.status = ''; return true;">
						<cfif Form.lpaso EQ 0><strong></cfif>Datos<cfif Form.lpaso EQ 0></strong></cfif>
					</a>
				</td>
			  </tr>
			  ...
			  <tr>
				...
				<td  nowrap>
					...
					<a href="javascript: goPage2(document.formCuadroOpt, 4, 1);" tabindex="-1" onMouseOver="javascript: window.status = ''; return true;" onMouseOut="javascript: window.status = ''; return true;">
						...
						<cfif Form.lpaso EQ 4><strong></cfif>Password Servicio<cfif Form.lpaso EQ 4></strong></cfif>
					<cfif ExisteLog>
					</a>
					</cfif>
				</td>
			  ...
			  <cfif form.rol EQ "DAS">	
				<tr>
					...
					<td  nowrap>
						<cfif ExisteLog>
						<a href="javascript: goPage2(document.formCuadroOpt, 7, 1);" tabindex="-1" onMouseOver="javascript: window.status = ''; return true;" onMouseOut="javascript: window.status = ''; return true;">
						</cfif>
							<cfif Form.lpaso EQ 7><strong></cfif>Sobre<cfif Form.lpaso EQ 7></strong></cfif>
						<cfif ExisteLog>
						</a>
						</cfif>
					</td>
			  ...
			  <!--- 8: para das o dso solamente --->
			  <cfif form.rol EQ "DAS">
				<tr><td colspan="2"> <hr /></td></tr>
				  <tr>
					<td align="right"><!---<img src="/cfmx/saci/images/number9_16.gif" border="0">---></td>
					<td  nowrap>
						<cfif ExisteLog>
				  ...
				  <!--- 9 --->
				  <tr>
					<td align="right"><!---<img src="/cfmx/saci/images/number10_16.gif" border="0">---></td>
					<td  nowrap>
						<cfif ExisteCuenta>
						<a href="javascript: goPage2(document.formCuadroOpt, 9, 1);" tabindex="-1" onMouseOver="javascript: window.status = ''; return true;" onMouseOut="javascript: window.status = ''; return true;">
						</cfif>
							<cfif Form.lpaso EQ 9><strong></cfif>Retiro de login<cfif Form.lpaso EQ 9></strong></cfif>
						<cfif ExisteCuenta>
						</a>
						</cfif>
					</td>
