		...
		<script language="javascript" type="text/javascript">
			function goPage2(f, cpaso) {
				if (f.cue.value == '' && cpaso != '1') {
					...
					if (cpaso == '5') {	<!---Limpia el id del Producto a repragramar en caso de que exista alguno--->
						f.pkg_rep.value = "";
					}
			  ...
			  <tr>
				...
				<td  nowrap>
					...
					<a href="javascript: goPage2(document.formCuadroOpt, 5);" tabindex="-1" onMouseOver="javascript: window.status = ''; return true;" onMouseOut="javascript: window.status = ''; return true;">
						...
						<cfif Form.cpaso EQ 5><strong></cfif>Reprogramación<cfif Form.cpaso EQ 5></strong></cfif>
					<cfif ExisteCuenta>
					</a>
					</cfif>
				</td>
