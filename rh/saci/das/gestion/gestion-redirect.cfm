...
<cfif isdefined("Form.tab") and Len(Trim(Form.tab))>		<!--- Tabs en los datos del cliente--->
...
<cfif isdefined("Form.pkg_rep") and Len(Trim(Form.pkg_rep))><!--- id del contrato en Reprogramación --->
	<cfset params = params & Iif(Len(Trim(params)), DE("&"), DE("?")) & "pkg_rep=" & Form.pkg_rep>
<cfelseif isdefined("url.pkg_rep") and Len(Trim(url.pkg_rep))>
	<cfset params = params & Iif(Len(Trim(params)), DE("&"), DE("?")) & "pkg_rep=" & url.pkg_rep>
</cfif>

<cfif isdefined("Form.adser") and Len(Trim(Form.adser))>	<!--- Agregar servicios--->
...
<cfif isdefined("Form.pintaBotones") and Len(Trim(Form.pintaBotones))>	<!--- Pinta Botones--->
	<cfset params = params & Iif(Len(Trim(params)), DE("&"), DE("?")) & "pintaBotones=" & Form.pintaBotones>
<cfelseif isdefined("url.pintaBotones") and Len(Trim(url.pintaBotones))>
	<cfset params = params & Iif(Len(Trim(params)), DE("&"), DE("?")) & "pintaBotones=" & url.pintaBotones>
</cfif>
