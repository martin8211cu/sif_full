...
<html><head><title>Bloqueo de logines expirados</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head><body>
...
Este proceso se encarga de revisar 
si las contraseñas temporales se han cambiado dentro del tiempo establecido.
En caso contrario se bloquea el usuario.
<br /> <br />
...
<cfinvoke component="saci.comp.ISBbloqueoLogin"
	method="bloquearLoginesExpirados"
		Ecodigo="#rsEmpresas.Ecodigo#" datasource="#rsEmpresas.DSN#" />
