...
<form method="post" name="form1" action="vendedor-registro-apply.cfm" onsubmit="return validar(this);" style="margin:0">
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr><td align="center">
			<cf_botones names="Guardar,Nuevo,Eliminar,Lista" values="Guardar,Nuevo,Eliminar,Lista Vendedores" tabindex="1">
		</td></tr>
	</table>
</form>
...
<!--
	...
	if(!btnSelected('Eliminar', formulario)){
