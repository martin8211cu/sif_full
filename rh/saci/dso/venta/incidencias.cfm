...
<cfif isdefined("url.AGid") and Len(url.AGid)>
			...
			<cfinvoke 
				 ...
				 method="pLista">
					  ...
					  <cfinvokeargument name="columnas" value="a.INid 
																...
																, a.CTid
																, a.Contratoid"/>
					  <cfinvokeargument name="desplegar" value="Inombre,PQnombre,IEstado,INobsCrea"/>
...
<cfelse>
	  <cfthrow message="No se encontró el Agente, por favor verifíquelo.">
</cfif>
