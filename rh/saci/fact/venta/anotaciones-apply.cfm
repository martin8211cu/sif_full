...
<cfif not isdefined("form.Nuevo") and not isdefined("form.Baja")>
	...
	<cfif isdefined('form.Contratoid') and form.Contratoid NEQ ''>
		<cfset params= params & "&Contratoid=#form.Contratoid#">
	</cfif>	
	
	<cflocation url="anotaciones.cfm?Pagina=#Form.Pagina#&Filtro_Inombre=#Form.Filtro_Inombre#&HFiltro_Inombre=#Form.Filtro_Inombre#&Filtro_IEstado=#Form.Filtro_IEstado#&HFiltro_IEstado=#Form.Filtro_IEstado#&Filtro_INobsCrea=#Form.Filtro_INobsCrea#&HFiltro_INobsCrea=#Form.Filtro_INobsCrea##params#">
<cfelse>
