<!---Este archivo es usado en varias pantallas---->
<cfparam name="formName" default="formRepresentantes">
<cfinvoke component="sif.Componentes.pListas" method="pLista"
	tabla="ISBpersonaRepresentante a
			inner join ISBpersona b
				on b.Pquien = a.Pcontacto"
	columnas="b.Pquien as Pquien_CT, b.Pid as Pid_CT, 
				case b.Ppersoneria when 'J' then  b.PrazonSocial
