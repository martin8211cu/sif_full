		...
		<tr>
			<td width="100%" height="27">
				<table width="98%"  border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="98%" id="AutoNumber2">
								<tr>
									<td height="23" bgcolor="#FFFFFF">
										<table width="123%" height="100" border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" id="AutoNumber2" style="border-collapse: collapse">
											<tr>
												<td width="100%" height="21" background="images/bottom1.jpg">
													<p style="margin-top: 3; margin-bottom: 0; color: #FFFFFF; font-size: 14px;"><b> <font face="Verdana">Misi&oacute;n</font></b>
											  </td>
											</tr>
											
											<tr>
												<td width="90%" background="images/fondo_rombos9.gif">
													<table width="190" border="0" cellspacing="3" cellpadding="3">
														<tr>
															<td width="177" class="paragraph  style14">
																<span class="style59">Proveer a nuestros Clientes de Innovaci&oacute;n e Infraestructura tecnol&oacute;gica para apoyar decididamente su desarrollo empresarial. </span>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									<td width="100%" height="23" background="images/bottom1.jpg">
										<p style="margin-top: 3; margin-bottom: 0; color: #FFFFFF; font-size: 14px;"><b> <font face="Verdana">Visi&oacute;n</font></b>
									</td>
								</tr>
								
								<tr>
									<td width="50%" background="images/fondo_rombos9.gif">
										<table width="189" border="0" cellspacing="3" cellpadding="3">
											<tr>
												<td width="177" class="paragraph  style14">
													<span class="style14 style18">
													<span class="style60">Mantenernos como una compa&ntilde;&iacute;a multinacional de vanguardia tecnol&oacute;gica, l&iacute;der en la distribuci&oacute;n de soluciones empresariales completas para la administraci&oacute;n corporativa de informaci&oacute;n en las &aacute;reas de Misi&oacute;n Cr&iacute;tica, Soporte a la Toma de Decisiones y Expansi&oacute;n del Negocio.
													</span>
													</span>
												</td>
											</tr>
					...
					<tr>
						<td bgcolor="#FFFFFF">
							<table width="189"  border="0" align="left" cellpadding="1" cellspacing="0">
								<tr>
									<td height="22" background="images/bottom1.jpg"><span class="style47"><font face="Verdana" size="2">L&iacute;neas de Negocio </font></span>
									</td>
								</tr>
...
<script  language="JavaScript" src="/cfmx/rh/js/DHTMLMenu/stm31.js"></script>
    ...
    <table width="100%">
      <tr>
        <td width="100%">
          <cfinclude template="/plantillas/login02/pubica2.cfm">
        </td>
      ...
      <tr>
        <td valign="top"> <br>
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber3">
              <tr>
                <td valign="top" width="20%"><div align="justify" class="style10">
				...
				<!---
				<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="270" height="350" hspace="0" vspace="0" align="baseline">
