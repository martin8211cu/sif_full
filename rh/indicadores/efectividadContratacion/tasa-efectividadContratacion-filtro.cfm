...
<cfinvoke Key="LB_TasaDeEfectividadDeContrataciones" Default="Tasa de Efectividad de Contrataciones" returnvariable="LB_TasaDeEfectividadDeContrataciones" component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#LB_RecursosHumanos#">
	<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_TasaDeEfectividadDeContrataciones#">
		<form method="get" name="form1" action="tasa-rotacion.cfm" >
		...
		<script type="text/javascript" language="javascript1.2">
			function desplegar(){
				...
				var nuevo = window.open('/cfmx/rh/indicadores/efectividadContratacion/tasa-efectividadContratacion.cfm'+params,'GraficoRotacion','menubar=yes,resizable=yes,scrollbars=yes,top='+top+',left='+left+',height='+height+',width='+width);
			}
		</script>		
	<cf_web_portlet_end>
<cf_templatefooter>
