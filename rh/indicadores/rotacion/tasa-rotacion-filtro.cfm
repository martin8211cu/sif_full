...
<cfinvoke Key="LB_IndicadorDeRotacionDePersona" Default="Indicador de Rotacion de Personal" returnvariable="LB_IndicadorDeRotacionDePersona" component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#LB_RecursosHumanos#">
	<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_IndicadorDeRotacionDePersona#">
		...
		<script type="text/javascript" language="javascript1.2">
			function desplegar(){
				...
				var nuevo = window.open('/cfmx/rh/indicadores/rotacion/tasa-rotacion.cfm'+params,'GraficoRotacion','menubar=yes,resizable=yes,scrollbars=yes,top='+top+',left='+left+',height='+height+',width='+width);
			}
		</script>		
	<cf_web_portlet_end>
<cf_templatefooter>
