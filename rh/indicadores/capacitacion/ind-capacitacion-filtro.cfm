...
<cf_templateheader title="#LB_RecursosHumanos#">
	<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_IndCapacitacion#">
		...
		<script type="text/javascript" language="javascript1.2">
			function desplegar(){
				...
				var nuevo = window.open('/cfmx/rh/indicadores/capacitacion/ind-capacitacion.cfm'+params,'GraficoCapacitacion','menubar=yes,resizable=yes,scrollbars=yes,top='+top+',left='+left+',height='+height+',width='+width);
			}
		</script>		
	<cf_web_portlet_end>
<cf_templatefooter>
