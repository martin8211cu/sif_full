...
<cfset LB_ReporteEscalaSalarialSalarioPensionable = t.translate('LB_ReporteEscalaSalarialSalarioPensionable','Reporte Escala Salarial Salario pensionable para calcular las contribuciones al Plan de Jubilaciones y Pensiones de la OEA')>
<cfset LB_ReporteEscalaSalarial = t.translate('LB_ReporteEscalaSalarial','Reporte Escala Salarial - Pensionable')>
...
<cf_templateheader title="#LB_ReporteEscalaSalarial#"> 
	<cf_web_portlet_start titulo="#LB_ReporteEscalaSalarialSalarioPensionable#">
		<br/>
		<div class="row">
			...
			<div class="col-sm-6">
				<cf_web_portlet_start >
					<cfinclude template="RepEscalaSalarial-FormPensionable.cfm">		
				<cf_web_portlet_end>	
			</div>
		</div>
		<br/>
