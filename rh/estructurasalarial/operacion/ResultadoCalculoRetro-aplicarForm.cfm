...
<form action="ResultadoCalculoRetro-aplicarSql.cfm" method="post" name="form1" onSubmit="javascript: return funcFinish();">
	<table width="95%" border="0" cellspacing="0" cellpadding="2" align="center">
		...
		<tr><td nowrap colspan="2" align="center">
			<cf_botones values="#BTN_Aplicar#" names="btnAplicar">
		</td></tr>
		<tr><td nowrap colspan="2">&nbsp;</td></tr>
	</table>
