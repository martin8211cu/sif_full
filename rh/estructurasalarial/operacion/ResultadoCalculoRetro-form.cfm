...
<table width="97%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;" align="center">
  ...
  <tr>
	<td nowrap colspan="8" class="<cfoutput>#Session.Preferences.Skin#_thcenter</cfoutput>">
		<cf_translate key="LB_InformacionResumida">
			<div align="center">Informaci&oacute;nResumida</div>
		</cf_translate>
	</td>
  </tr>
  <cfinclude template="../../nomina/operacion/frame-SalarioEmpleado.cfm"><!--- Informacion Resumida --->
</table>
<br>
<form action="ResultadoCalculoRetro-sql.cfm" method="post" name="form1">
  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;" align="center">
    <tr> 
      <td nowrap colspan="9" bgcolor="#EEEEEE"><div align="center"><strong><font color="#666666">
	  	<cf_translate key="LB_InformacionDetallada">Informaci&oacute;n Detallada</cf_translate>
	  </font></strong></div></td>
    </tr>
    <cfinclude template="../../nomina/operacion/frame-PagosEmpleado.cfm"></td>
    <!--- Salarios --->
    <tr valign="top"> 
      <td nowrap colspan="8">&nbsp;</td>
    </tr>
    <cfinclude template="../../nomina/operacion/frame-IncidenciasCalculo.cfm"></td>
    <!--- Incidencias --->
    <tr valign="top"> 
      <td nowrap colspan="8">&nbsp;</td>
    </tr>
    <cfinclude template="../../nomina/operacion/frame-CargasCalculo.cfm"></td>
    <!--- Cargas --->
    <tr valign="top"> 
      <td nowrap colspan="8">&nbsp;</td>
    </tr>
    <cfinclude template="../../nomina/operacion/frame-DeduccionesCalculo.cfm"></td>
    <tr valign="top"> 
      <td nowrap colspan="8">&nbsp;</td>
    </tr>
    ...
    <!--- Deducciones --->
    <tr valign="top"> 
      <td nowrap colspan="8"><div align="center"><font color="#FF0000">&iexcl; 
    ...
    <cfoutput> 
      <tr valign="top"> 
        <td nowrap colspan="8" align="center">  
          ...
          <input type="submit" name="AltaI" value="#BTN_AgregarIncidencia#" onclick="javascript:return btnAgregarIncidencia();"> 
		  <cfif isdefined('rsRelacionCalculo') and not rsRelacionCalculo.CPnodeducciones>
          <input type="submit" name="AltaD" value="#BTN_AgregarDeduccion#" onclick="javascript:return btnAgregarDeduccion();"> 
		  </cfif>
          ...
          <input type="submit" name="Baja" value="#BTN_Eliminar#" onclick="javascript:return btnEliminarChecked();"> 
		  <input type="submit" name="butRestaurar" value="#BTN_Restaurar#" onclick="javascript:return btnRestaurar();">
		  <input type="submit" name="btnRegresar" value="#BTN_Regresar#"  onclick="javascript:document.form1.action='ResultadoCalculoRetro-lista.cfm';">
        </td>
      </tr>
      <tr valign="top"> 
        <td nowrap colspan="8" align="center">
