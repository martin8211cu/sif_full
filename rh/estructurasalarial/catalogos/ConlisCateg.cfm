...
<body>
	...
	<cfif isdefined("Form.RHPcodigo") and Len(Trim(Form.RHPcodigo)) NEQ 0>
		<cfset filtro = filtro & " and upper(ltrim(rtrim(RHPcodigo))) = '" & Ucase(Trim(Form.RHPcodigo)) & "'">
	...
	<form name="formfiltrocateg" method="post" action="ConlisCateg.cfm" style="margin:0 ">
