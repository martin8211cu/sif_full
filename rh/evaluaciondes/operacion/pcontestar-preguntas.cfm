...
<cfquery name="datarespuestas" datasource="#session.DSN#">
	...
	<cfif data.PPtipo eq 'U' >
								...
								<td align="1%" >
									<cfif len(trim(datarespuestas.PRvalor))>
										<input style="border:0;"
												...
												onclick="javascript:validar_radio(#LvarPCid#, #datarespuestas.parte#, #pregunta#, this);">
									</cfif>
								</td>
							</tr>
		...
		<tr><td></td><td colspan="10"><table width="100%"><tr><td><a href="javascript:limpiar_radio(#LvarPCid#,#datarespuestas.parte#,#pregunta#)"><font color="##666666">[<cf_translate key="LB_LimpiarLasRespuestaDadasAEstaPregunta">Limpiar las respuestas dadas a esta pregunta</cf_translate>]</font></a></td><td></td></tr></table></td></tr>
		<tr><td width="1%" >&nbsp;</td>
         <cfif LvarPPorientacion eq 1 >
            </tr>
         </cfif>
	...
	<cfelseif data.PPtipo eq 'M'>
						...
						<cfif LvarPPorientacion eq 1 >
							...
							<tr>
								<td width="1%" valign="top">
									<cfif len(trim(datarespuestas.PRvalor))>
										<input  style="border:0; margin:0;"
											id="p_#pregunta#_#datarespuestas.PRid#"
											type="checkbox" <cfif isdefined('contestada') and datarespuestas.PRid eq contestada >checked</cfif>
											name="p_#pregunta#_#datarespuestas.PRid#"
											value="#datarespuestas.PRid#"
											onclick="javascript:validar_check(#LvarPCid#, #datarespuestas.parte#, #pregunta#, this);">
									</cfif>
								</td>
							</tr>
						<cfelse>
		...
		<tr><td></td><td colspan="10"><table width="100%"><tr><td><a href="javascript:limpiar_check(#LvarPCid#,#datarespuestas.parte#,#pregunta#)"><font color="##666666">[<cf_translate key="LB_LimpiarLasRespuestaDadasAEstaPregunta">Limpiar las respuestas dadas a esta pregunta</cf_translate>]</font></a></td><td></td></tr></table></td></tr>
		<tr><td>&nbsp;</td>
	 <cfif LvarPPorientacion eq 1 >
        </tr>
    </cfif>
						...
						<td width="1%">
							<select name="p_#pregunta#_#datarespuestas.PRid#" onchange="javascript:validar_combo(#LvarPCid#, #datarespuestas.parte#, #pregunta#, this);" >
								...
								<cfloop from="1" to="#ArrayLen(valores)#" index="i">
									<option value="#i#" <cfif isdefined('contestada') and trim(contestada) eq i >selected</cfif>>#valores[i]#</option>
								</cfloop>
							</select>
							<script type="text/javascript" language="javascript1.2">
								size = respuestas[#pregunta#].length
