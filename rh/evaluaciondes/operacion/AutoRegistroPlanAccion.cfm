...
<cfinvoke component="sif.Componentes.Translate"
method="Translate"
Key="LB_AutoRegistroDePlanDeAccion"
Default="Auto Registro de Plan de Acción"
returnvariable="LB_AutoRegistroDePlanDeAccion"/> 
...
select <cf_dbfunction name="to_number" args="llave"> as DEid 
from UsuarioReferencia ue 
where ue.Ecodigo =  #session.EcodigoSDC# and ue.STabla = 'DatosEmpleado' and ue.Usucodigo = #session.Usucodigo# 
</cfquery>

<cfquery name="rsUsr" datasource="#session.DSN#">
select  de.DEid, de.DEidentificacion, de.DEnombre || ' ' || de.DEapellido1 || ' ' || de.DEapellido2  NOMBREEMP
from DatosEmpleado de
where  de.DEid=#rsUsr.DEid# 
...
<cfif isdefined("form.PROCESAR")>
	...
	<cfquery name="rsRHListaEvalDes" datasource="#session.DSN#">
		...
		and DEid =     <cfqueryparam cfsqltype="cf_sql_numeric" value="#rsUsr.DEid#">
	</cfquery>
</cfif>
﻿<cf_templateheader title="#LB_RecursosHumanos#">
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr><td>
			<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_AutoRegistroDePlanDeAccion#">
				<form name="form1" method="post" action="AutoRegistroPlanAccion.cfm" style="margin:0; " onSubmit="javascript: return validardatos();">
				<cfoutput>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="30%" align="center" valign="top">
							<cf_web_portlet_start border="true" titulo="#LB_AutoRegistroDePlanDeAccion#" skin="info1">
							...
							<table width="90%" align="center" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<cfif isdefined("form.PROCESAR")>
										...
										<br><strong><cf_translate  key="LB_Inicio">Inicio</cf_translate></strong> :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#LSDateFormat(rsRHEEvaluacionDes.inicio,'dd/mm/yyyy')#&nbsp;
										<br><strong><cf_translate  key="LB_Finalizacion">Finalización</cf_translate></strong> :&nbsp;#LSDateFormat(rsRHEEvaluacionDes.fin,'dd/mm/yyyy')#</td>
										<input type="hidden" name="RHEEID" id="RHEEID" value="#form.RHEEID#">
									<cfelse>
										<td ><cf_rhevaluacion size="60" DEid="#rsUsr.DEid#"></td>
									</cfif>
								</tr>
								<tr>
									<td width="10%" align="right" nowrap ><strong><cf_translate  key="LB_Empleado">Empleado</cf_translate></strong>:&nbsp;</td>
									<!---<cfif isdefined("form.PROCESAR")>--->
										<td>#rsUsr.DEIDENTIFICACION#&nbsp;&nbsp;&nbsp;#rsUsr.NOMBREEMP#</td>
										<input type="hidden" name="DEid" id="DEid" value="#rsUsr.DEID#">
									<!---<cfelse>
								...
								<cfif isdefined("form.PROCESAR")>
									<tr>
										...
										<td >
											...
											<cf_sifeditorhtml name="RHLEobservacion" indice="1" value="<cfoutput>#miHTML#</cfoutput>" height="300">
				...
				<input name="DEIDENTIFICACION2" 	type="hidden" value="<cfif isdefined("rsUsr.DEIDENTIFICACION")><cfoutput>#rsUsr.DEIDENTIFICACION#</cfoutput></cfif>">	
				<input name="NOMBREEMP2" 		type="hidden" value="<cfif isdefined("rsUsr.NOMBREEMP")><cfoutput>#rsUsr.NOMBREEMP#</cfoutput></cfif>">	
				</form>
				...
				<script language="javascript1.2" type="text/javascript">
					function modificar(){
						document.form1.action ="AutoRegistroPlanAccion-sql.cfm";
					}
