<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="MG_No_se_ha_definido_el_cuestionario"
	Default="No se ha definido el cuestionario."
	returnvariable="MG_No_se_ha_definido_el_cuestionario"/> 
...
<cfelseif isdefined("form.GENERAR")>
	...
	<cfif isdefined("form.PCcodigo") and len(trim(form.PCcodigo))>
		...
		<cfif len(trim(rsCuestionario.PCid)) eq 0 >
			<cf_throw message="#MG_No_se_ha_definido_el_cuestionario#" errorcode="8035">
		</cfif>
	...
	<cfinvoke component="rh.Componentes.RH_Benziger" method="procesar_persona">
