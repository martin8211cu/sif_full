...
<cfinvoke key="LB_Reporte_Notas_del_Evaluado_Por_Pregunta" default="Reporte Notas del Evaluado por Pregunta" returnvariable="LB_Reporte_Notas_del_Evaluado_Por_Pregunta" component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#LB_RecursosHumanos#">
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_Reporte_Notas_del_Evaluado_Por_Pregunta#">
				
				<form name="form1" method="post" action="NotasPorPregunta-rep.cfm" style="margin:0; " onsubmit="javascript: return validar(this);">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="50%" align="center" valign="top">
							<cf_web_portlet_start border="true" titulo="#LB_Reporte_Notas_del_Evaluado_Por_Pregunta#" skin="info1">
								<table width="100%" align="center">
									<tr>
										<td>
											<p><cf_translate key="AYUDA_Notas_del_Evaluado_Por_Pregunta">
											Este Reporte muestra las notas del Evaluado por pregunta, asi como la nota indicada de cada evaluador.
