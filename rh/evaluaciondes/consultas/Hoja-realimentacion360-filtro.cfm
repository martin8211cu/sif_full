		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr><td>
				<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_nav__SPdescripcion#">
					<form name="form1" method="post" action="Hoja-realimentacion360.cfm" style="margin:0; " onsubmit="javascript: return validar(this);">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td width="50%" align="center" valign="top">
								<cf_web_portlet_start border="true" titulo="#LB_Hoja_de_Realimentacion360#" skin="info1">
									<table width="100%" align="center">
										<tr><td><p>
										<cf_translate  key="Ayuda_Reporte">
											En este reporte se puede consultar las notas obtenidas de un empleado para una determinada evaluaci&oacute;n por habilidades de tipo 360	
										</cf_translate>
										</p></td></tr>
									</table>
								<cf_web_portlet_end>
							...
							<td colspan="2" valign="top">
								<table width="90%" align="center" cellpadding="2" cellspacing="0">
									<tr>
										...
										<td ><cf_rhevaluacion size="60" tipo = "4" Cerradas = "S"></td>
									</tr>
									<tr>
