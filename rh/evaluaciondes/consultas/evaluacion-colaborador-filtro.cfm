...
<cfinvoke key="LB_Evaluacion" default="Evaluaci&oacute;n" returnvariable="LB_Evaluacion" component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_EvaluacionesPorColaborador" default="Evaluaciones por Colaborador" returnvariable="LB_EvaluacionesPorColaborador" component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="MSG_ElCampoEmpleadoEsRequerido." default="El campo Empleado es requerido." returnvariable="MSG_ElCampoEmpleadoEsRequerido" component="sif.Componentes.Translate" method="Translate"/>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				...
				<form name="form1" method="get" action="evaluacion-colaborador.cfm" style="margin:0; " onsubmit="javascript: return validar(this);">
						...
						<td width="50%" align="center" valign="top">
							<cf_web_portlet_start border="true" titulo="#LB_EvaluacionesPorColaborador#" skin="info1">
								<table width="100%" align="center">
									<tr><td><p><cf_translate key="AYUDA_EstaConsultaMuestraUnListadoDeLasCalisficacionesParaUnEmpleado">Esta consulta muesta un listado de las calificaciones para un empleado seg&uacute;n la Relaci&oacute;n de Evaluaci&oacute;n seleccionada.<br>El campo Evaluaci&oacute;n es y el colaborador son requeridos por la consulta.</cf_translate></p></td></tr>
								</table>
							<cf_web_portlet_end>
						</td>
						<td colspan="2" valign="top">
							<table width="90%" align="center" cellpadding="2" cellspacing="0">
								<tr>
									...
									<td>
										<cf_rhevaluacion size="60" tabindex="1" tipo="1">
										<!--- SE UTILIZA EL TAG DE CONLIS PARA CREAR LA LISTA LIMITANDOLA A LAS
											EVALUACIONES QUE SON DE HABILIDADES --->
								...
								<tr><td colspan="2" align="center"><input type="submit" name="Consultar" value="<cfoutput>#BTN_Consultar#</cfoutput>" tabindex="1"></td>
								</tr>
							</table>
						</td>
					</tr>
