		...
		<tr>
			<td>
				...
				<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_EvaluacionesPorColaborador#">
					<form name="form1" method="get" action="habilidadesNota.cfm" style="margin:0; " onSubmit="javascript: return validar(this);">
						...
						<tr>
							...
							<td width="50%" align="center" valign="top">
								<cf_web_portlet_start border="true" titulo="#LB_EvaluacionesPorColaborador#" skin="info1">
									<table width="100%" align="center">
										<tr><td><p><cf_translate key="AYUDA_EstaConsultaMuestraUnListadoDeLasCalificacionesParaUnEmpleadoSegunLaRelacionDeEvaluacionSeleccionada">Esta consulta muesta un listado de las calificaciones para un empleado seg&uacute;n la Relaci&oacute;n de Evaluaci&oacute;n seleccionada.<br>El campo Evaluaci&oacute;n es y el colaborador son requeridos por la consulta.</cf_translate></p></td></tr>
									</table>
								<cf_web_portlet_end>
							</td>
							<td colspan="2" valign="top">
								<table width="90%" align="center" cellpadding="2" cellspacing="0">
									<tr>
										<td width="40%" align="right" nowrap ><cf_translate key="LB_Evaluacion">Evaluaci&oacute;n</cf_translate>:&nbsp;</td>
										...
										<table width="100%"  cellpadding="0" cellspacing="0">
											<tr>
											  <td align="right"><table width="100%">
												  <tr>
													<td align="right" width="50%"><input name="nota" id="2" type="radio" value="2"  onclick="javascript: cambio()" <cfif isdefined("form.nota") and form.nota EQ 2>checked</cfif> /></td>
													<td align="left" nowrap="nowrap"><cf_translate key="RAD_NotaMayorA">Nota mayor a</cf_translate>:</td>
												  </tr>
											  </table></td>
											  <td align="left">
												<!--- <cfset i=0>
												<select name="n_mayor">
													<option value=""></option>
													<cfloop condition="i LTE 100">
													<option value="#i#"   <cfif isdefined("form.nota") and form.nota EQ 2 and isdefined("form.n_mayor") and form.n_mayor EQ i>selected</cfif>><cfoutput>#i#</cfoutput></option>
													<cfset i=i+1>
													</cfloop>
												</select> --->
											...
											<tr>
											  <td align="right"><table width="100%">
												  <tr>
													<td align="right"  width="50%"><input name="nota"id="3" type="radio" value="3"  onclick="javascript: cambio()" <cfif isdefined("form.nota") and form.nota EQ 3>checked</cfif> /></td>
													<td align="left" nowrap="nowrap"><cf_translate key="RAD_NotaMenorA">Nota menor a</cf_translate>:</td>
												  </tr>
											  </table></td>
											  <td align="left">
											...
											<tr>
											  <td align="right"><table width="100%">
												  <tr>
													<td align="right"  width="50%"><input name="nota" id="1" type="radio" value="1" onclick="javascript: cambio()" <cfif isdefined("form.nota") and form.nota EQ 1>checked</cfif>/></td>
													<td align="left" nowrap="nowrap"><cf_translate key="RAD_RangoDeNotas">Rango de notas</cf_translate>:</td>
												  </tr>
											  </table></td>
									...
									<tr>
										...
										<td>
											<select name="formato">
												<option value="flashpaper"><cf_translate key="LB_Flaspaper" XmlFile="/rh/generales.xml">Flashpaper</cf_translate></option>
