...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="MSG_DebeSeleccionarLaEvaluacion"
	Default="Debe seleccionar la Evaluación."
	returnvariable="MSG_DebeSeleccionarLaEvaluacion"/>
<script language="JavaScript" type="text/javascript">
	...
	function doConlisEmpleados<cfoutput>#index#</cfoutput>() {
		...
		if (evaluacion.value != '' ){
			...
			alert('<cfoutput>#MSG_DebeSeleccionarLaEvaluacion#</cfoutput>');
		}	
	}
