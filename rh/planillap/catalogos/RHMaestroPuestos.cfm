...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#LB_MaestroDePuestosPresupuestarios#'>
...
<cfif modo neq 'ALTA'>
	<cfquery datasource="#session.dsn#" name="data">
		select 	a.RHMPPid, a.RHMPPcodigo, a.RHMPPdescripcion,
				...
				b.RHCcodigo, b.RHCdescripcion, a.Complemento 
	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td colspan="2" class="formButtons" align="center">
				...
				<input type="button" name="btn_regresar" value="Regresar" onClick="javascript: location.href='RMaestroPuestoP-lista.cfm';">
			</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
	</table>
