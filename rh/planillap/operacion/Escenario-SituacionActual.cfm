<script type="text/javascript" language="javascript1.2">
	function funcMuestraComponentes(prn_RHSAid){
		...
		document.getElementById("ComponenteSA").src="SA-ComponentePlazas.cfm?RHEid="+document.form2.RHEid.value+"&RHSAid="+prn_RHSAid+"&RHETEid="+document.form2.RHETEid.value;
		return false;
	}
	...
	function funcRegresaPlazas(prn_RHEid){		
		...
		document.getElementById("PlazaSA").src="SA-PPresupuestarias.cfm?RHEid="+prn_RHEid+"&RHETEid="+document.form2.RHETEid.value;
	...
	function funcNavega(prs_opcion){
		...
		*//////////////////////////////////////////////		
		if (prs_opcion == 'PP'){				
			...
			document.getElementById("PlazaSA").src="SA-PPresupuestarias.cfm?RHEid="+document.form2.RHEid.value+"&RHETEid="+document.form2.RHETEid.value;
			document.getElementById("PlazaSA").width = 950;
			document.getElementById("PlazaSA").height = 300;
			document.getElementById("ComponenteSA").width = 0;
			document.getElementById("ComponenteSA").height = 0;
...
<form name="form2" action="" method="post">
	<table width="100%" cellpadding="0" cellspacing="0">
				...
				<table width="100%" border="0" class="navbar">
					<tr><td>  
						<table width="50" border="0" >				  
							...
							<input type="hidden" name="RHETEid" value="<cfif isdefined("form.RHETEid") and len(trim(form.RHETEid))>#form.RHETEid#</cfif>">	<!---Llave del escenario de la lista--->
		...
		<tr><td valign="top">
			<cfoutput>
				<iframe id="PlazaSA" frameborder="0" name="PlazaSA" width="950"  height="300" style="visibility:visible;border:none; vertical-align:top" src="SA-PPresupuestarias.cfm?RHEid=#form.RHEid#<cfif isdefined("form.RHETEid") and len(trim(form.RHETEid))>&RHETEid=#form.RHETEid#</cfif>"></iframe>
