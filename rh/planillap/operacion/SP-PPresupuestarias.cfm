...
<script type="text/javascript" language="javascript1.2">
	...
	function funcEliminar(prn_RHSAid){
		if(confirm('¿Desea Eliminar el Registro?') ){
			document.formSolicitudPlaza.RHSAidEliminar.value = prn_RHSAid;
	...
	function funcComponentesMasivos(){
		...
		var params ="?RHEid="+document.formSolicitudPlaza.RHEid.value+'&prs_origen=psolicitadas';
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center" >  
	  <tr>
		<td width="40%" class="tituloListas" >
			<strong style="color:##003366; font-family:'Times New Roman', Times, serif; font-size:13pt; font-variant:small-caps; font-weight:bolder;">Plazas Solicitadas</strong></td>
		<td colspan="3" class="tituloListas"><table width="65%" cellpadding="0" cellspacing="0" align="right"><tr>
			<td width="33%" align="center">
				<input type="button" name="btn_masivo" value="Componentes Masivos" onclick="javascript: funcComponentesMasivos();">
			</td>
			<td width="33%" align="center">
				<input type="button" name="btn_eliminar" value="Eliminar" onclick="javascript: funcEliminarMasivo();">
			</td>
			<td width="33%" >
				<input type="submit" name="btn_importar" value="Importar" onclick="return funcValida();">
			</td>		
		</tr></table></td>
	  </tr>
