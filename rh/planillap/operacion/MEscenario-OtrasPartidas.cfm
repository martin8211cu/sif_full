<script type="text/javascript" language="javascript1.2">
	function funcMuestraDetalles(prn_RHOPid){
		...
		document.getElementById("Detalle").src="MEOtrasPartidasD.cfm?RHEid="+document.form2.RHEid.value+"&RHOPid="+prn_RHOPid;
	}
	...
	function funcNavega(prs_opcion){
		...
		*//////////////////////////////////////////////		
		if (prs_opcion == 'OP'){				
			...
			document.getElementById("OtrasO").src="MEOtrasPartidas.cfm?RHEid="+document.form2.RHEid.value;
			document.getElementById("OtrasO").width = 950;
			document.getElementById("OtrasO").height = 300;
			document.getElementById("Detalle").width = 0;
			document.getElementById("Detalle").height = 0;
...
<form name="form2" action="" method="post">
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr><td valign="top">
			<cfoutput><iframe id="OtrasO" frameborder="0" name="OtrasO" width="950"  height="300" style="visibility:visible;border:none; vertical-align:top" src="MEOtrasPartidas.cfm?RHEid=#form.RHEid#&RHEfdesde=#data.RHEfdesde#&RHEfhasta=#data.RHEfhasta#"></iframe></cfoutput>
