	...
	<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
		<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="Plazas Presupuestarias Vacantes">
			...
			<table width="100%" border="0" cellspacing="0">			  
			  ...
			  <tr>
				<td valign="top">
					<form name="form1" action="PlazasPresupuestariasVacantes-SQL.cfm" method="post" onsubmit="javascript: return funcValidaciones();">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td width="49%" valign="top">															
									<cf_web_portlet_start border="true" titulo="Plazas Presupuestarias Vacantes" skin="info1">
										<div align="justify">
										  <p>Reporte de plazas presupuestarias activas o congeladas (o ambos)
										  que est&eacute;n vacantes.</p>
										</div>
									<cf_web_portlet_end>
							  </td>
								<td width="51%">
									<table width="99%" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td width="37%" align="right"><strong>Fecha corte:&nbsp;</strong></td>
											<td width="63%">                            
