...
<cfparam name="Attributes.ruta" default="/cfmx/rh/Reclutamiento/curriculumExterno/Utiles/sifleerimagencont2.cfm"  type="string">
<!--- <cfparam name="Attributes.ruta" default="/cfmx/rh/Reclutamiento/curriculumExterno/Utiles/sifleerimagencont.cfm"  type="string"> --->
...
<cfif Attributes.desplegar>
	...
	<cfelse>
        ...
        <img 
            name="#Attributes.imgname#" 
            src="/cfmx/rh/Reclutamiento/curriculumExterno/images/UserIcon.png" 
            <cfif Attributes.width NEQ -1> width="#Attributes.width#"</cfif><cfif Attributes.height NEQ -1> height="#Attributes.height#"</cfif> 
            <cfif attributes.border>border="1" bodercolor="#Attributes.bordercolor#"<cfelse>border="0"</cfif>>  		
        </cfoutput>
	</cfif>
