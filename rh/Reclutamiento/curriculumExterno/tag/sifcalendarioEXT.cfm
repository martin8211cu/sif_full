...
<cfif Request.jsMask EQ false>
	...
	<script language="JavaScript" src="/cfmx/rh/Reclutamiento/curriculumExterno/tag/calendar.js"></script>
	<script src="/cfmx/rh/Reclutamiento/curriculumExterno/js/MaskApi/masks.js"></script>
      ...
      <td nowrap valign="#Attributes.valign#">
		...
		<input
			...
			<cfif Attributes.readOnly>
				tabindex="-1"
				readonly
				style=" font-size:10px;border:solid 1px ##CCCCCC; background:inherit;"
			</cfif>
			id="#Attributes.name#" 
			...
			<cfif Attributes.image and not Attributes.readOnly>
				<a href="javascript:void(0)" tabindex="-1" id="img_#Attributes.form#_#Attributes.name#"> 	
					<img src="/cfmx/rh/imagenes/DATE_D.gif" alt="Calendario" name="Calendar#Attributes.name#" width="16" 
						height="14" border="0" 
