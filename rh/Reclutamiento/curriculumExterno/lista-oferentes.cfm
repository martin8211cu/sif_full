...
<cf_templateheader title="#ListaDeOferentesExternos#">
		...
		<cfif isdefined("Form.nombreFiltro") and Len(Trim(Form.nombreFiltro)) NEQ 0>
			<!---<cfset filtro = filtro & " and upper(RHOapellido1 || ' ' || RHOapellido2 || ', ' || RHOnombre) like '%" & #UCase(Form.nombreFiltro)# & "%'">--->
				...
				<td>
					<cfquery name="rsLista" datasource="#session.DSN#">
						select RHOid, RHOidentificacion, 
							{fn concat(RHOapellido1,{fn concat(' ',{fn concat(RHOapellido2,{fn concat(', ',RHOnombre)})})})} as nombreOferente, 
					...
					<cfinvoke 
						...
						<cfinvokeargument name="etiquetas" value="#LB_Identificacion#,#LB_OferenteExterno#"/>
