						...
						<tr> 
							...
							<td> 
								<cfif isdefined("rsOferente.RHOfechanac") and len(trim(rsOferente.RHOfechanac))>
									<cf_sifcalendarioEXT form="form1" value="#LSDateFormat(rsOferente.RHOfechanac,"DD/MM/YYYY")#" name="RHOfechanac" tabindex="1">				   
								<cfelse>
									<cf_sifcalendarioEXT form="form1" value="" name="RHOfechanac" tabindex="1">				   
								</cfif>
							</td>
