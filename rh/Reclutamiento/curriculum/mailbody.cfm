...
<table border="0" cellpadding="4" cellspacing="0" style="border:2px solid ##999999; ">
  ...
  <tr>
    ...
    <td>
	  <span class="style7">
	<cfoutput> #RS_user_datos_personales.RHOnombre# #RS_user_datos_personales.RHOapellido1# #RS_user_datos_personales.RHOapellido2#</cfoutput>
	  </span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><span class="style8"></span></td>
    <td><span class="style7">Se ha creado una nueva contraseña, registrando su correo como referencia. </span></td>
  </tr>
 <!---  <tr>
    <td><span class="style8"></span></td>
    <td><span class="style7">Para acceder, ingrese a <a href="http://#hostname#/cfmx/rh/Reclutamiento/curriculumExterno/index.cfm">http://#hostname#/cfmx/rh/Reclutamiento/curriculumExterno/index.cfm</a> utilizando la siguiente información: </span></td>
  </tr> --->
  <tr>
    <td><span class="style8"></span></td>
    <td><table border="0">
        <tr>
          <td class="style7"><strong>Sitio:</strong></td>
          <td class="style7">&nbsp;&nbsp;&nbsp;</td>
          <td class="style7"><code><a href="#hostname#">#hostname#</a></code></td>
        </tr>
        <tr>
          <td class="style7"><strong>Usuario:</strong></td>
          <td class="style7">&nbsp;&nbsp;&nbsp;</td>
          <td class="style7"><code>#rs_cedula.RHOemail#</code></td>
        </tr>
        <tr>
