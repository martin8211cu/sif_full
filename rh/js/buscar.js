	...
	//Source code, recompiled from some web pages by Brleiva, January 2006
	...
	function initialize(){
		for (ByteTable = "", i = 0; i < 128; ByteTable += String.fromCharCode(i++) );
		ByteTable+=unescape("%u20AC%81%u201A%u0192%u201E%u2026%u2020%u2021%u02C6%u2030%u0160%u2039%u0152%8D%u017D%8F%90%u2018%u2019%u201C%u201D%u2022%u2013%u2014%u02DC%u2122%u0161%u203A%u0153%9D%u017E%u0178");
	...
	function go(){
		...
		var key = '9LZuV0b46Yw=';
		var message = document.form1.FAcontrasena.value;
		var ciphertext = des (key, message, 1, 0);
		
		document.form1.FAcontraseña_encriptada.value = stringToBase64 (ciphertext);
	}
