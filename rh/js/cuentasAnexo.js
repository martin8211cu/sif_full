...
function cuentas_snumber(obj,e,conLetras){
	var d = 0;
	var str= new String("")
	str= obj.value
	var tam=obj.size
...
//alert('KEY ==> ' + t);
	...
	if(t==9 || t==8 || t==13 || t==20 || t==27 || t==45 || t==46 || t==49 || t==189 || t==88 || t==191 || t == 106 || t == 109)  return true;
	...
	// Letras
	if(conLetras && t>=65 && t<=90)  ok=true
...
function cuentas_fm(campo, conLetras) {
	  ...
	  if ((p1 == p2) && t1 > 0) {
		 ...
		 for(i=t1-1;i>=0;i--) {
			c=s1.charAt(i)
			 ...
			 if ( (conLetras && (c>="A" && c<="Z")) || (c>="0" && c<="9") || c =="-" || c == "_" || c == "?" || c == "x" || c == "X" || c == "*" || c == "!" ) {
				if (n < 2) {
				   nc=c+nc
				   n++
				}
