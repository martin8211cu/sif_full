...
");\">Present</A>]</TD><TD BGCOLOR='#e0e0e0' ALIGN=center>");
...
"';if (window.opener.funcFecha) {window.opener.funcFecha()};window.close();\">" + 
...
"onClick=\"self.opener." + this.gReturnItem + ".value='" + 
this.format_data(vDay) + 
"';if (self.opener.funcFecha) {self.opener.funcFecha()};window.close();\">" + 
this.format_day(vDay) + 
"</A>" + 
"</FONT></TD>";
vDay=vDay + 1;
...
Calendar.prototype.get_encabezado = function(aMonth, aYear) {
	...
	temp += "<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0'><TR valign=\"center\">";
	 temp += "<TD valign=\"center\" BGCOLOR='#e0e0e0'><FONT FACE='" + fontface + "' SIZE=2><B>Month: </B></FONT>\n";
...
");\">\n";
	...
	temp += "</SELECT>\n";
	temp += "</TD>\n";
	temp += "<TD BGCOLOR='#e0e0e0' valign=\"center\"><FONT FACE='" + fontface + "' SIZE=2><B>Year: </B></FONT>";
