...
function CF_onEnter_Initializate(enterAction)
{
	if (",submit,tab,none,".indexOf(","+Gvar_CF_onEnterAction+",") == -1) Gvar_CF_onEnterAction = "submit";
	if (",submit,tab,none,".indexOf(","+enterAction+",") == -1) enterAction = Gvar_CF_onEnterAction;
	Gvar_CF_onEnterAction = enterAction;
	
	var LvarNewEvent = "sbCF_onEnter_changeOnKeysEvents ();";
