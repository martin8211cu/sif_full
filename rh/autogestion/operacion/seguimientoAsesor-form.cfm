...
<cfif isdefined ('form.RHPid') and len(trim(form.RHPid)) gt 0>
	...
	<table border="0">
			...
			<td>
				<table border="0">
					...
					<tr>
						...
						<td>						
							<cf_conlis title="LISTA DE ASESORES"
		...
		<tr><td><hr></td></tr>
		<tr><td bgcolor="999999" colspan="4" align="center">Procedimiento a Seguir</td></tr>
		<tr>
			<td>
			<table>
				<tr>
					<td><input type="radio" name="radio1" value="1" />Acción de Personal</td>
					<td nowrap="nowrap"><input type="radio" name="radio1" value="2" />Listado</td>
					<td nowrap="nowrap"><input type="radio" name="radio1" value="3" />Concurso</td>
				</tr>
			</table>
			</td>
		</tr>
