...
<cfsilent>
    <cfquery name="rsAvisos" datasource="#session.dsn#">
        select 	a.IdNoticia, a.FechaNoticia,b.DescCategoria,a.Titulo,Contenido,RutaImagen ,a.FechaDesde,a.FechaHasta
...
<!--- <marquee direction="up" scrollAmount=1 style="width:450;height:90"> --->
<table width="100%" border="0" cellpadding="0"  cellspacing="0">
    ...
    <cfloop query="rsAvisos">
		...
		<cfif vb_ver><!---Si la noticia es visible para el usuario---->
			...
			<cfif isdefined("rsAvisos.RutaImagen") and len(trim(rsAvisos.RutaImagen)) and rsAvisos.RutaImagen neq 'Ninguna'>
				<tr>
					<td valign="top">
							<img  height="50px" width="50px" src="#rsAvisos.RutaImagen#">
					</td>
					<td valign="top">
