...
<cfsilent>
    ...
    select  a.SPorden,
            ...
            inner join SMenues c 	
                ...
                and c.SMNtitulo in ('Administración','Incidencias','Control de Marcas','Trámites','Control Activos','Otros')
            where a.SScodigo = 'RH'
             and a.SMcodigo = 'AUTO'
             and a.SPmenu = 0
			...
			select  c.SPorden,
					...
					c.SPhomeuri as dir, 
					'Incidencias' SMNtitulo,
					<cf_jdbcquery_param cfsqltype="cf_sql_numeric" value="null"> as SMNcodigoPadre,
					900 as SMNorden,
					1 as SMNcolumna
