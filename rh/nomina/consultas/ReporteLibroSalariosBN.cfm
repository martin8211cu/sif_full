...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
        ...
        <cfif isdefined("url.Fdesde") and len(trim(url.Fdesde)) GT 0>
			...
			<cfif isdefined('url.ExcluirSalariosenCero')><cfset params = params & '&ExcluirSalariosenCero=1'></cfif>
            <cf_reportWFormat url="/rh/nomina/consultas/ReporteLibroSalariosReporteBN.cfm" orientacion="landscape"
             regresar="ReporteLibroSalariosBN.cfm" params="#params#">
        <cfelse>     
            <cfinclude template="ReporteLibroSalariosFiltroBN.cfm">
        </cfif>
	<cf_web_portlet_end>
<cf_templatefooter>