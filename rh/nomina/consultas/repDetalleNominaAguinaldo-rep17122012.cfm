            ...
            set Dfaltas = 
             ...
             , Dincap = 
                ...
                , TDLab = 
						...
						when DATEDIFF(dd,EVfantig, <cfqueryparam cfsqltype="cf_sql_date" value="#ffinal#">)> 366
						then 366
						else DATEDIFF(dd,EVfantig, <cfqueryparam cfsqltype="cf_sql_date" value="#ffinal#">) + 1
						end     
