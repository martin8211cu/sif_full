...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_REsum_RelacionPuestos" Default="Resumen General de Relación de Puestos x Programa" returnvariable="LB_REsum_RelacionPuestos"/>
...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_REsum_RelacionPuestos#">
		<cfinclude template="/rh/portlets/pNavegacion.cfm">		
		<form name="form1" method="post" action="RepRelaciondePuestosXPrograma-form.cfm">
		<cfoutput>
