			  ...
			  <tr>
				...
				<td width="300" valign="top">
					...
					<cf_web_portlet_start tipo="mini" titulo="#LB_ayuda#" tituloalign="left" wifth="300" height="300">
						<p><cf_translate  key="LB_texto_de_ayuda">
								* Este reporte requiere de Dato Variable en Mantenimiento de Empleados. 
						</cf_translate></p>
						<p>Formato del Archivo Banco Popular Costa Rica</p>
					
					<table align="center" border="1" cellspacing="0" cellpadding="3">
						<td align="center" bgcolor="#CCCCCC">Identificaci&oacute;n</td>
						<td align="center" bgcolor="#CCCCCC">Nombre</td>
						<td align="center" bgcolor="#CCCCCC">Columna Blanco</td>
						<td align="center" bgcolor="#CCCCCC"># Cuenta</td>
						<td align="center" bgcolor="#CCCCCC">Monto</td>
						<td align="center" bgcolor="#CCCCCC">% Deducci&oacute;n</td>
					</table>	
				    <cf_web_portlet_end>
				</td>
				...
				<td width="400" valign="top">
					...
					<cf_web_portlet_start tipo="mini" titulo="#LB_filtros#" tituloalign="left" wifth="300" height="300">
						<form name="form1" method="post" action="repSalarioEscolar-form.cfm">
						<cfoutput>
