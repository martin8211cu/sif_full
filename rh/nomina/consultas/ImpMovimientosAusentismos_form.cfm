...
<!--- 	<cfset RegistroPatronal = #rsRegistro.Pvalor#> --->
    ...
    select <cf_dbfunction name="to_char" args="de.DESeguroSocial" len="11"> as SeguroSocial,
    		de.DEapellido1, de.DEapellido2, de.DEnombre,b.DEid,
          ...
          group by b.DEid,de.DESeguroSocial,de.DEapellido1,de.DEapellido2,de.DEnombre,a.RHTcomportam,b.DLfvigencia,b.DLffin,b.RHfolio,de.DEidentificacion
	</cfquery>
...
<!--- 			<cfset hilera = REReplaceNoCase(hilera,'Ãœ','U',"all")> --->
	...
	<cfheader name="Content-Disposition" value="attachment;filename=ImpMovAusentismos.dat">
