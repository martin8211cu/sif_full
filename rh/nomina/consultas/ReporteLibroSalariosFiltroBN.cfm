...
<cfinvoke Key="LB_ExcluirSalariosenCero" Default="Excluir Salarios en Cero" returnvariable="LB_ExcluirSalariosenCero" component="sif.Componentes.Translate" method="Translate"/>
<cfoutput>
    	...
    	<td width="80%" valign="top">
			<cf_web_portlet_start style="box" titulo="#LB_nav__SPdescripcion#">
        		<table width="100%" align="center">
                	<tr>
                    	<td>
                          	<form action="ReporteLibroSalariosBN.cfm" method="get" name="form1" style="margin:0" enctype="multipart/form-data">
                           		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="margin:0">
									...
									<tr> <td nowrap align="right"><strong><cf_translate  key="LB_ExcluirSalariosenCero">Excluir Salarios en Cero</cf_translate> :&nbsp;</strong></td>
                                        <td><input type="checkbox" name="ExcluirSalariosenCero" id="ExcluirSalariosenCero" value="0" checked="checked" /></td> 
									</tr>
                                    <tr>
