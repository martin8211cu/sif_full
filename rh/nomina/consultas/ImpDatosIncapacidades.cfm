<cf_templateheader title="Importaci&oacute;n Datos de Incapacidades">
	<cf_web_portlet_start titulo="Importaci&oacute;n Datos de Incapacidades">
	<br>
	<cfoutput>
	<form name="form1" action="ImpDatosIncapacidades_form.cfm" method="post" onsubmit="return validar(this);">
