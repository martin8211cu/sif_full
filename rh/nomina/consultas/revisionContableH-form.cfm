...
<cfsavecontent variable="myquery">
	...
	group by a.tipo, a.Ocodigo, a.Ccuenta, cc.Cformato, a.CFcuenta, cf.CFcodigo, n.RCtc, cc.Cdescripcion, cf.CFdescripcion
	order by cc.Cformato, cf.CFcodigo
	</cfoutput>
</cfsavecontent>

 <cf_htmlreportsheaders
			title="Revision Contable Hist&oacuterico" 
			filename="RevisionContable#lsdateformat(now(),'yyyymmdd')##LSTimeFormat(now(),'hhmmss')#.xls" 
			ira="revisionContableH-filtro.cfm">
