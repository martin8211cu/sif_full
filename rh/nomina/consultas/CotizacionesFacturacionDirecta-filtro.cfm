...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_ReporteCotizacionesFactDir#">
		...
		<form name="form1" method="post" action="CotizacionesFacturacionDirecta-form.cfm">
		<cfoutput>
							...
							<td valign="top">
								<cf_web_portlet_start border="true" titulo="Descripci&oacute;n" skin="info1">
									<div align="justify">
										...
										Reporte utilizado para proporcionar las indicaciones necesarias para la elaboraci&oacute;n y presentaci&oacute;n de la planilla mensual de cotizaciones R&eacute;gimen Salud obrero-patronal, en forma mecanizada.
										</cf_translate>
										</p>
									</div>
								<cf_web_portlet_end>									  
