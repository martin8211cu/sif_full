...
<div class="row">
	...
	<div class="col-md-10">
	<cfoutput>
		<form name="form1" class="form form-horizontal" action="PlusesSalarialesEmpleadoSTL-sql.cfm" method="post">
			...
			<div class="form-group selectEmp col-sm-12">	
				<div class="col-sm-2">
					<label><strong>Componentes de Anualidad:</strong></label>
				</div>
				<div class="col-sm-6 listEmp">	

						<cf_conlisV8 
			title="Lista de Componentes Salariales para anualidad" 
			desplegables = "N,S,S" 
			modificables = "N,S,N" 
			size = "0,10,30" 
			tabla="ComponentesSalariales cs
				    inner join CIncidentes ci
				        on cs.CIid=ci.CIid and ci.CItipo =3 and coalesce(cs.CSRecargoFunciones,0)=0" 
			columnas="cs.CSid,CScodigo,CSdescripcion" 
			campos="CSid,CScodigo,CSdescripcion" 
			filtro="cs.Ecodigo = #Session.Ecodigo#"
