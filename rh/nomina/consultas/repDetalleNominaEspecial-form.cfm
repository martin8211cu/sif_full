            	...
            	<td colspan="3">
                    <table  width="80%" cellpadding="2" cellspacing="0" border="0" align="center" >
                        ...
                        <tr id="NNoAplicadas" >
                            ...
                            <td>
                                <cf_rhcalendariopagos form="form1" historicos="false" tcodigo="true" index="2" tabindex="1" pintaRCDescripcion="true" Excluir="0,2">
                            </td>
                            <td>
                        ...
                        <tr id="NAplicadas" style="display:none">
                            <td nowrap align="right"> <strong><cf_translate  key="LB_Nomina">N&oacute;mina</cf_translate> :&nbsp;</strong></td>
                            <td>
                                <cf_rhcalendariopagos form="form1" historicos="true" tcodigo="true" index="1" tabindex="1" pintaRCDescripcion="true" Excluir="0,2">
                            </td>
                            <td>
