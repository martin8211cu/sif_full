...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Periodo" Default="A&ntilde;o" returnvariable="LB_Periodo"/>
...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_ReporteDeDeduccionesMagisterio#">
		<cfinclude template="/rh/portlets/pNavegacion.cfm">		
		<form name="form1" method="post" action="RepDeduccJuntaPensionesMagis-form.cfm" onsubmit="return validar()">
		<cfoutput>
		<table cellpadding="3" cellspacing="0" align="center" border="0">								
			...
			<tr> 
			<td nowrap class="fileLabel" align="right"><cf_translate key="LB_CodigoDelCalendarioDePago">C&oacute;digo del Calendario de Pago</cf_translate> :&nbsp;</td>
			<td nowrap colspan="7">
			...
			<tr><td>&nbsp;</td>
				<td> <input type="checkbox" name="muestraResum"/>
				<cf_translate key="LB_MostrarResumido">Mostrar Resumido</cf_translate>&nbsp; </td>
			</tr>
...
<script type="text/javascript" language="javascript1.2">
	...
	function validar(){
		...
		if (document.form1.periodo.value == ""){
			err = err +  "Debe seleccionar a el periodo.\n";
		}
		if (document.form1.mes.value == ""){
			err = err +  "Debe seleccionar a el mes.\n";
		}
		if (document.form1.CPid.value == ""){
			err = err +  "Debe seleccionar a el calendario de pago.\n";
		}
		if(err == ""){
			return true;
		}
