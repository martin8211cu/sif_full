		...
		<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#vTitulo#">
			<table width="100%" cellpadding="2" cellspacing="0">
				<tr>
					<td>
						<cfoutput>
						<form method="post" name="filtro" action="revisionContableH-filtro.cfm" style="margin:0;">
				...
				<tr>
					<td>
						...
						<form name="form1" method="post" style="margin:0" action="revisionContableH.cfm"  >
							<cfinvoke 
							 ...
							 returnvariable="pListaRet">
								...
								<cfinvokeargument name="irA" value="revisionContableH.cfm"/>
							</cfinvoke>
						</form>
					</td>
				</tr>
