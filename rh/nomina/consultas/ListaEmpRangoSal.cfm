...
<cf_dump var="#url#">--->
	...
	method="Translate"
	Key="LB_RecursosHumanosListadoDeEmpleadosPorRangoDeSalarios"
	Default="Recursos Humanos - Listado de Empleados por Rango de Salarios"
	returnvariable="LB_RecursosHumanosListadoDeEmpleadosPorRangoDeSalarios"/>
				...
				<td valign="top">	
					<cf_web_portlet_start border="true" titulo="#LB_ListadoDeEmpleados#" skin="#Session.Preferences.Skin#"> 
						...
						<cfif isDefined("url.btnFiltrar")> 
							...
							<cfinclude template="ListaEmpRangoSal-reporte.cfm">
						<cfelse>
							<!--- Filtro --->
							<cfinclude template="/rh/portlets/pNavegacion.cfm">
							<cfinclude template="ListaEmpRangoSal-Filtro.cfm">
						</cfif>
					<cf_web_portlet_end> 
				</td>	
			</tr>
