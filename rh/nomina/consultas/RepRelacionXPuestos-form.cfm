...
group by  cat.RHCcodigo,puestos.RHPdescpuesto,puestos.RHPcodigo  ,montCateg.RHMCmonto ,montCateg.RHMCmontoAnt 	
order by  cat.RHCcodigo ,puestos.RHPdescpuesto, puestos.RHPcodigo ,montCateg.RHMCmonto ,montCateg.RHMCmontoAnt 
...
<cfinclude template="RepRelacionXPuestos-rep.cfm">