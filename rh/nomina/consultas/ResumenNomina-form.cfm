...
<!---<style type="text/css">
	...
	.nominas div { float: left; }
	.calPGProc, .calPGAply { margin-left: 3px; }
	.btnsRep { margin-top: 15px; margin-bottom: 40px; }
</style>--->
...
<cfoutput>
	<form name="form1" style="margin:0" action="ResumenNomina-sql.cfm" method="post">
	...
	<!---	<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-12 nominas">
				...
				<div class="calPGProc">	
					<cf_rhcalendariopagos form="form1" historicos="false" tcodigo="true" descsize="20" index="1" tabindex="1">
				</div>	
				<div class="calPGAply" style="display:none">	
					<cf_rhcalendariopagos form="form1" historicos="true" tcodigo="true" descsize="20" index="2" tabindex="2">
				</div>			
			</div>
		</div>--->
		...
		<div class="form-group"> 
	        <div class="col-sm-10 col-sm-offset-2 btnsRep">
