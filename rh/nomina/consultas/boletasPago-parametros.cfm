...
<cfquery name="rsEmpresa" datasource="#session.dsn#">
	...
	where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDC#">
		...
		<cf_web_portlet_start border="true" titulo="Resumen de Boletas de Pago" >
		<cfinclude template="/rh/portlets/pNavegacion.cfm">
			<cfoutput>
			<form style="margin:0" action="boletasPago.cfm" method="get" name="form1" id="form1" onsubmit="javascript: return validar();"  >
			<table align="center" border="0" cellspacing="0" cellpadding="4" width="100%" >

				<tr>
					<td align="right" valign="middle" width="30%"><strong><cf_translate key="LB_Consultar_por" xmlfile="/rh/nomina/consultas/boletasPago.xml">Consultar por</cf_translate>:&nbsp;</strong></td>
					<td>
						<select name="nominas" onchange="javascript: conlisRelacion(this.value);">
							<option value="A"><cf_translate key="LB_Relaciones_de_Calculo_abiertas" xmlfile="/rh/nomina/consultas/boletasPago.xml">Relaciones de C&aacute;lculo abiertas</cf_translate></option>
							<option value="H"><cf_translate key="LB_Relaciones_de_Calculo_cerradas" xmlfile="/rh/nomina/consultas/boletasPago.xml">Relaciones de C&aacute;lculo cerradas</cf_translate></option>
						</select>
					</td>
				</tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								...
								<td width="100%" nowrap="nowrap"><label for="dependencias"><cf_translate key="LB_Incluir_Centros_Funcionales_dependientes" xmlfile="/rh/nomina/consultas/boletasPago.xml">Incluir Centros Funcionales dependientes</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								...
								<td width="100%" nowrap="nowrap"><label for="Encabe"><cf_translate key="LB_Incluir_Encabezado_Por_Boleta" xmlfile="/rh/nomina/consultas/boletasPago.xml">Incluir Encabezado por Boleta</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								...
								<td width="100%" nowrap="nowrap"><label for="resumido"><cf_translate key="LB_Resumir_Incidencias" xmlfile="/rh/nomina/consultas/boletasPago.xml">Resumir Incidencias</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
