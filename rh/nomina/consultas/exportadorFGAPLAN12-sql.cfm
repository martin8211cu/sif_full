...
<cfelse>
	...
	<cfelse>
       ...
       <cfquery name="ERR" datasource="#session.DSN#">					
			select  x.DEidentificacion #cat# replicate(' ',9-#lId#) #cat# x.codigo #cat# replicate(' ',10-#LvarMontoStrL#) #cat# #LvarMonto#
            from (
            	<!----Tipos de deduccion--->
                select ltrim(rtrim(e.DEidentificacion))as DEidentificacion,ltrim(rtrim(td.TDcodigo)) as codigo,b.DCvalor as monto
                ...
                <!---Conceptos de pago--->
                select ltrim(rtrim(e.DEidentificacion))as DEidentificacion,ltrim(rtrim(ci.CIcodigo))as codigo,b.ICvalor as monto
                from HSalarioEmpleado a
                ...
                group by x.DEidentificacion, x.codigo 
                order by x.DEidentificacion, x.codigo 
		</cfquery>
	</cfif>
