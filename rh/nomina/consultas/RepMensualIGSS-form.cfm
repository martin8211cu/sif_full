		...
		<table width="100%" cellpadding="2" cellspacing="0" border="0">
			<tr>
				<td valign="top" colspan="2">
					...
					<cfif isdefined('form.Obsv')>
						<cfset params = params & '&Obsv=' & form.Obsv>
					</cfif>
	                <cf_reportWFormat url="/rh/nomina/consultas/RepMensualIGSS-rep.cfm" orientacion="portrait" regresar="RepMensualIGSS.cfm" params="#params#" pagina="true">
				</td>	
			</tr>
		</table>	
    <cf_web_portlet_end>		
