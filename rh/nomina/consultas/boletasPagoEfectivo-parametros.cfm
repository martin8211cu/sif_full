...
<cfinvoke key="LB_Nomina" default="Nomina" xmlfile="/rh/nomina/consultas/boletasPago.xml"	 returnvariable="vRelacion" component="sif.Componentes.Translate" method="Translate"/>
...
<cfquery name="rsEmpresa" datasource="#session.dsn#">
	...
	where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDC#">
		...
		<cf_web_portlet_start border="true" titulo="Boletas de Pago Efectivo" >
		<cfinclude template="/rh/portlets/pNavegacion.cfm">
			<cfoutput>
			<form style="margin:0" action="boletasPagoEfectivo.cfm" method="get" name="form1" id="form1" onsubmit="javascript: return validar();"  >
			<table align="center" border="0" cellspacing="0" cellpadding="4" width="100%" >
				
				<tr>
					<td align="right" valign="middle" width="30%"><strong><cf_translate key="LB_Consultar_por" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Consultar por</cf_translate>:&nbsp;</strong></td>
					<td>
						<select name="nominas" onchange="javascript: conlisRelacion(this.value);">
							<option value="A"><cf_translate key="LB_Relaciones_de_Calculo_abiertas" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Pago en Efectivo de C&aacute;lculo abierto</cf_translate></option>
							<option value="H"><cf_translate key="LB_Relaciones_de_Calculo_cerradas" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Pago en Efectivo de C&aacute;lculo cerrado</cf_translate></option>
						</select>
					</td>
				</tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								...
								<td width="100%" nowrap="nowrap"><label for="dependencias"><cf_translate key="LB_Incluir_Centros_Funcionales_dependientes" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Incluir Centros Funcionales dependientes</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								<td width="1%"><input type="checkbox" name="Encabezado" id="Encabezado" checked="checked"/></td>
								<td width="100%" nowrap="nowrap"><label for="Encabe"><cf_translate key="LB_Incluir_Encabezado_Por_Boleta" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Incluir Encabezado por Boleta</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								<td width="1%"><input type="checkbox" name="agrupar" id="agrupar" checked/></td>
								<td width="100%" nowrap="nowrap"><label for="agrupar"><cf_translate key="LB_AgruparPorCentroFuncional" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Agrupar por Centro Funcional</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table width="100%" cellpadding="1" cellspacing="0">
							<tr>
								<td width="1%"><input type="checkbox" name="resumido" id="resumido" checked/></td>
								<td width="100%" nowrap="nowrap"><label for="resumido"><cf_translate key="LB_Resumir_Incidencias" xmlfile="/rh/nomina/consultas/boletasPagoEfectivo.xml">Resumir Incidencias</cf_translate></label></td>
							</tr>
						</table>
					</td>
				</tr>
