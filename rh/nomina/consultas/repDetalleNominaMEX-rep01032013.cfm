...
<cfsilent>
    ...
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Vac1213"	Default="Vacaciones 2012-2013" returnvariable="LB_Vac1213"/>
    
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_VACNS0910"	Default="Vac NS 2009-2010" returnvariable="LB_VACNS0910"/>
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_VACNS1011"	Default="Vac NS 2010-2011" returnvariable="LB_VACNS1011"/>
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_VACNS1112"	Default="Vac NS 2011-2012" returnvariable="LB_VACNS1112"/> 
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_VACNS1213"	Default="Vac NS 2012-2013" returnvariable="LB_VACNS1213"/> 
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_VACNS1314"	Default="Vac NS 2013-2014" returnvariable="LB_VACNS1314"/> 
    ...
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_PrimaVacGrNS"	Default="Prima Vac Grv NS" returnvariable="LB_PrimaVacGrNS"/>
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_PrimaVacExNS"	Default="Prima Vac Exc NS" returnvariable="LB_PrimaVacExNS"/>  
    ...
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_InfonaCF"	Default="Infonavit CF" returnvariable="LB_InfonaCF"/>
    ...
    <cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_PriAntigueda"Default="Primas Antigüedad"			returnvariable="LB_PriAntigueda"/>   
	...
	<cf_dbtemp name="salida" returnvariable="salida">
        ...
        <cf_dbtempcol name="InfonaCF" 		type="money"       	mandatory="no">
        ...
        <cf_dbtempcol name="Vac1213"		type="money"       	mandatory="no"> 
        ...
        <cf_dbtempcol name="VACNS1314"		type="money"       	mandatory="no"> 
...
<cfquery datasource="#session.dsn#" name="rsEmpleados">
	insert #salida# (DEid, Identificacion, Nombre,Ape1,Ape2, FechaDesde, FechaHasta, CFcodigo, CFdescripcion,CSsalario )
        select distinct a.DEid, a.DEidentificacion, a.DEnombre, a.DEapellido1, a.DEapellido2, c.CPdesde, c.CPhasta
                ,f.CFcodigo
                ,f.CFdescripcion
                ,0
...
<cfelse>
<cfquery datasource="#session.dsn#" name="rsEmpleados">
	insert #salida# (DEid, IdNomina, Identificacion, Nombre,Ape1,Ape2, FechaDesde, FechaHasta, CFcodigo, CFdescripcion,CSsalario )
...
<!---Modificacion para actualiza el valor del subsidio al salario SML --->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdSubsidio">
    update #salida#
    set Subsidio = 
    coalesce((
    select sum(a.DCvalor)*-1 from #vDeduccionesCalculo# a, DeduccionesEmpleado b, #calendario# x
                where a.DEid = #salida#.DEid and a.RCNid = #salida#.IdNomina 
                        and a.RCNid = x.RCNid 
                        and a.DEid = b.DEid
                        and a.Did = b.Did
                        and b.TDid  in (select distinct a.TDid
...
<!---Modificacion para Deduccion de Infonavit SMG SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdInfonaSMG">
    update #salida#
    set InfonaSMG = 
...
<!---Modificacion para Deduccion de Infonavit SDI SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdInfonaSDI">
    update #salida#
    set InfonaSDI = 
...
<!---Modificacion para Deduccion de Pension Alimenticia SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set PensionAlime = 
...
<!---Modificacion para Deduccion de Cuota Sindical SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set CuoSindical = 
...
<!---Modificacion para Deduccion de Ayuda Sindical SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set AyuSindical = 
...
<!---Modificacion para Deduccion de Descuento Sindical SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set DescSindical = 
...
<!---Modificacion para Deduccion Prestamos Pesonales SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPrestPerso">
    update #salida#
    set PrestPerso = 
...
<!---Modificacion para Deduccion Cargas IMSS SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdCargaIMSSo">
    update #salida#
    set CargaIMSS = 
...
<!---Modificacion para Concepto de pago Impuntual SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set Impuntual =  
...
<!---Modificacion para Bono empleado laborados SML---> 
<cfelse>
 update #salida#
		set BonoEmple =  
        	coalesce((
...
<!---Modificacion para Pie de Maquina laborados SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PieMq =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Comision sobre ventas MEX SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set ComVentas =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Horas Extra Dobles Excentas laborados SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set HExDobleE =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Total Horas Extra Dobles Excentas SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set THExDobleE =  coalesce((select coalesce(sum(a.ICvalor),0) 
...
<!---Modificacion para Horas Extra Dobles Gravables SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set HExDobleG =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para que Total Horas Extra Dobles Gravables SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set THExDobleG =  coalesce((select coalesce(sum(a.ICvalor),0) 
...
<!---Modificacion para Horas Extra Triples SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set HExTriple =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Total Horas Extra Triples SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set THExTriple =  coalesce((select coalesce(sum(a.ICvalor),0) 
...
<!---Modificacion para Prima Dominical Excenta SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriDomExc =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Prima Dominical Gravable SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriDomGrv =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Prima Vacacional Excenta SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacExc =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Prima Vacacional Gravable SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacGrv =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Pago Aguinaldo Excento SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PagAguiExc =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Pago Aguinaldo Gravado SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PagAguiGrv =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para PTU en dias SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PTUDias =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para PTU en Importe SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PTUImp =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para PREMIOS DE ASISTENCIA SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PreAsist =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para PREMIOS DE PUNTUALIDAD SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PrePunt =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para PROPORCION VACACION FINIQUITO SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set ProVacFin =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para OTRAS PRESTACIONES SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set OtraPrest =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para FESTIVO LABORADO SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set FestLab =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO SALARIO SML --->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetSal =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO PREMIO DE ASISTENCIA SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPreAsist =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO PREMIO DE PUNTUALIDAD SML --->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPrePunt =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO AGUINALDO SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPreAgui =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para VACACIONES 2009-2010 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set Vac0910 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para VACACIONES 2010-2011 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set Vac1011 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para VACACIONES 2011-2012 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set Vac1112 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES SINDICAL 2012-2013--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VAC1213 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VAC1213'		<!---VACACIONES NO SINDICAL 2011-2012--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES SINDICAL 2012-2013 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VAC1213 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO TED SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetTED =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO TET SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetTET =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO VACACIONES SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetVac =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO PRIM. VAC SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPrimVac =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO PIE DE MAQUINA SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPieMaq =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para que salgan dias laborados SML --->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetValDesp =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para DEVOLUCION CREDITO INFON SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set DevInfona =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para DEVOL DE DSCTO HERRAMIEN SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set DevDtoHer =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO P. DOMINICAL SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPrimDom =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para RETROACTIVO DIA FESTIVO SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetDiaFest =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para DESCANSO LABORADO SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set DescLabo =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Retroactivo Proporción Aguinaldo Finiquito SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RPAguiFin =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Retroactivo Proporción Vacaciones Finiquito SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RPVacFin =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Retroactivo Proporción Prima Vacacional Finiquito SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RPPVacFin =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Retroactivo Prima Dominical Exenta SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetPrimDomE =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Modificacion para Retroactivo TED Exenta SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetTEDEx =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Prima Vacacional Excenta No Sindical--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacExNS =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'PriVacExNS'	<!---Prima Vacacional Excenta--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para Prima Vacacional Excenta No Sindical SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacExNS =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---Prima Vacacional Gravable No Sindical--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacGrNS =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'PriVacGrNS'	<!---Prima Vacacional Gravable--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion Prima Vacacional Gravable No Sindical SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set PriVacGrNS =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES NO SINDICAL 2009-2010--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS0910 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VACNS0910'	<!---VACACIONES NO SINDICAL 2009-2010--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion VACACIONES NO SINDICAL 2009-2010 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS0910 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES NO SINDICAL 2010-2011--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1011 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VACNS1011'		<!---VACACIONES NO SINDICAL 2010-2011--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES NO SINDICAL 2010-201 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1011 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES NO SINDICAL 2011-2012--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1112 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VACNS1112'		<!---VACACIONES NO SINDICAL 2011-2012--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES NO SINDICAL 2011-2012 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1112 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES NO SINDICAL 2012-2013--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1213 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VACNS1213'		<!---VACACIONES NO SINDICAL 2011-2012--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES NO SINDICAL 2012-2013 SML--->
<cfelse>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1213 =  coalesce((select coalesce(sum(a.ICmontores),0) 
...
<!---VACACIONES NO SINDICAL 2013-2014--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#">
   update #salida#
		set VACNS1314 =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'VACNS1314'		<!---VACACIONES NO SINDICAL 2011-2012--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES NO SINDICAL 2012-2013 SML--->
...
<!---Deduccion de Infonavit Cuota Fija--->
<cfif form.Tfiltro EQ 1>
<cfquery datasource="#session.dsn#" name="UpdInfonaCF">
    update #salida#
    set InfonaCF = 
    coalesce((
    select sum(a.DCvalor) from #vDeduccionesCalculo# a, DeduccionesEmpleado b, #calendario# x
                        ...
                        and b.TDid  in (select distinct a.TDid
                            from RHReportesNomina c
                                inner join RHColumnasReporte b
                                            ...
                                            on a.RHCRPTid = b.RHCRPTid
                                     on b.RHRPTNid = c.RHRPTNid
                                    and b.RHCRPTcodigo = 'InfonaCF' 	<!---Deduccion de Infonavit Cuota Fija--->
                            where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                              and c.Ecodigo = #session.Ecodigo#)
                        ),0)
</cfquery>
<!---Modificacion para Deduccion de Infonavit Cuota Fija SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdInfonaCF">
    update #salida#
    set InfonaCF = 
...
<!---Modificacion para SALIDA ANTICIPADA SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set SalAntic = 
...
<!---Modificacion para OTRAS DEDUCCIONES SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set OtrasDeduc = 
...
<!---Modificacion para AGUINALDO PAGADO SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set AguiPag = 
...
<cfquery datasource="#session.dsn#">
   update #salida#
		set RetIMSS =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid 
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                                from RHReportesNomina c
                                                    inner join RHColumnasReporte b
                                                                ...
                                                                on a.RHCRPTid = b.RHCRPTid
                                                         on b.RHRPTNid = c.RHRPTNid
                                                        and b.RHCRPTcodigo = 'RetIMSS'		<!---VACACIONES NO SINDICAL 2011-2012--->
                                                where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
</cfquery>
<!---Modificacion para VACACIONES NO SINDICAL 2011-2012 SML--->
...
<!---Modificacion para RETROACTIVO IMSS SML---> 
<!---<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set RetIMSS = 
...
<!---Modificacion para RETROACTIVO RETENCION SINDICAL SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set RetReteSind = 
...
<!---Modificacion para DSCTO. HERRAMIENTAS DE TRAB SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set DescHerTrab = 
...
<!---Modificacion para DSCTO. EQUIPO DE SEGURID SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set DescEquSeg = 
...
<!---Modificacion para ANTICIPO DE NOMINA SML--->
<cfelse>
<cfquery datasource="#session.dsn#" name="UpdPensionAlimeo">
    update #salida#
    set AntiNomin = 
...
<!---Modificacion para que salgan dias SDI SML --->
<cfelse>
<cfquery datasource="#session.dsn#" name="rsISPT">
    update #salida#
            set ISPT = 
                coalesce(
                        ...
                        from #vSalarioEmpleado# se
                            inner join  #calendario# x 
                                on se.RCNid = x.RCNid
                                where se.DEid = #salida#.DEid and se.RCNid = #salida#.IdNomina),0)
...
<cfquery datasource="#session.dsn#">
   update #salida#
		set PropAguiExc =  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid and a.RCNid = #salida#.IdNomina
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                               ...
                                               where c.RHRPTNcodigo = 'MX002'				 <!---Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0)
								<!---coalesce((select coalesce(sum(a.RHLIexento),0) 
...
<cfquery datasource="#session.dsn#">
   update #salida#
		set PropAguiGrv= coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid and a.RCNid = #salida#.IdNomina
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
                                               ...
                                               where c.RHRPTNcodigo = 'MX002'				<!--- Codigo Reporte Dinamico --->
                                                  and c.Ecodigo = #session.Ecodigo#)),0) 
								<!---coalesce((select coalesce(sum(a.RHLIgrabado),0) 
                                        from RHLiqIngresos a 
                                            inner join DLaboralesEmpleado dl
                                                on a.DLlinea = dl.DLlinea
                                            where a.DEid = #salida#.DEid  
...
<cfquery datasource="#session.dsn#">
   update #salida#
		set ProPrVacExc=  coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid and a.RCNid = #salida#.IdNomina
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
...
<cfquery datasource="#session.dsn#">
   update #salida#
		set ProPrVacGrv= coalesce((select coalesce(sum(a.ICmontores),0) 
                                    from #vIncidenciasCalculo# a, #calendario# x 
                                    where a.DEid = #salida#.DEid and a.RCNid = #salida#.IdNomina
                                        and a.RCNid = x.RCNid 
                                        and CIid  in (select distinct a.CIid
...
<tr>
 ...
 <!--- orden de las columnas en el reporte (encabezados )------->
    ...
    <td  class="tituloListas" valign="top" align="right"><strong>#LB_Vac1112#</strong>&nbsp;</td>
     <td  class="tituloListas" valign="top" align="right"><strong>#LB_Vac1213#</strong>&nbsp;</td>
    ...
    <td  class="tituloListas" valign="top" align="right"><strong>#LB_VACNS1314#</strong>&nbsp;</td>
    ...
    <td  class="tituloListas" valign="top" align="right"><strong>#LB_PrimaVacGrNS#</strong>&nbsp;</td>
    <td  class="tituloListas" valign="top" align="right"><strong>#LB_PrimaVacExNS#</strong>&nbsp;</td>
    ...
    <td  class="tituloListas" valign="top" align="right"><strong>#LB_InfonaCF#</strong>&nbsp;</td>
	...
	<cfoutput> <!---- pintado de la informacion----->
		...
		<tr class="<cfif rsReporte.CurrentRow mod 2>listaPar<cfelse>listaNon</cfif>">
            ...
            <td nowrap align="right">#LSCurrencyformat(rsReporte.Vac1112,'none')#</td>
             <td nowrap align="right">#LSCurrencyformat(rsReporte.Vac1213,'none')#</td>
            ...
            <td nowrap align="right">#LSCurrencyformat(rsReporte.VACNS1213,'none')#</td>
             <td nowrap align="right">#LSCurrencyformat(rsReporte.VACNS1314,'none')#</td>
            ...
            <td nowrap align="right">#LSCurrencyformat(rsReporte.InfonaCF,'none')#</td>
