...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="Reporte Modificacion SDI para IDSE">
		...
		<form name="form1" method="post" onsubmit="return validaCampos()" action="RepImpIDSE-form.cfm" >
		<cfoutput>
			...
			<td>
				<table cellpadding="3" cellspacing="0" align="center" border="0">
					...
					<tr id="TR_Mes">
						...
						<td>
							<cfset FechaInicio = DateFormat(Now(),'dd/mm/yyyy')>
				            <cf_sifcalendario form="form1" name="FechaInicio" value="#FechaInicio#" >
                        <!---<select name="mes"  >
					...
					<tr>
						...
						<td>
							...
							<cfquery name="rsRegistro" datasource="#session.dsn#">
								...
								and o.Onumpatronal is not null
							</cfquery>
							<cfoutput>
								<select name="RegPat" onchange="">
...
<script type="text/javascript" language="javascript1.2">
	...
	function validaCampos(){
			...
			if(document.form1.RegPat.value == "" ||
				...
				document.form1.FechaInicio.value == "")
			{

				alert("Debe llenar completamente el formulario");
