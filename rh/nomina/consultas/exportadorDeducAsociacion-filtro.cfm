...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_GeneracionDeArchivoParaAsociacionSolidarista#">
		<cfinclude template="/rh/portlets/pNavegacion.cfm">		
		<cfoutput>
		<form name="form1" method="post" action="exportadorDeducAsociacion-form.cfm" onSubmit="javascript: return funcValidar();">
