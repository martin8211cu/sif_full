<cf_templateheader title="Importaci&oacute;n de Movimientos ">
	<cf_web_portlet_start titulo="Importaci&oacute;n de Movimientos">
	<br>
	<cfoutput>
	<form name="form1" action="ImportacionMovimientos_form.cfm" method="post" onsubmit="return validar(this);">
