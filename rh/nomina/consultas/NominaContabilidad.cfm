...
<cf_templateheader title="#LB_nav__SPdescripcion#">
		...
		<cfif isdefined('form.CPid')>
            ...
            <cf_reportWFormat url="/rh/nomina/consultas/NominaContabilidadReporte.cfm" orientacion="landscape"
             regresar="NominaContabilidad.cfm" params="#params#">
        <cfelse>     
            <cfinclude template="NominaContabilidadFiltro.cfm">
        </cfif>
	<cf_web_portlet_end>
<cf_templatefooter>