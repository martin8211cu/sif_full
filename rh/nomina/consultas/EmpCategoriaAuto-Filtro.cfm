...
<form name="filtro" method="get" action="EmpCategoriaAuto.cfm">
		...
		<tr>
			<td>
				<table border="0" cellpadding="1" cellspacing="1" align="center">
					...
					<tr>
						<td width="162" align="right"><strong><cf_translate key="LB_CategoriaDesde">Categor&iacute;a desde</cf_translate>:&nbsp;</strong></td>
						<td colspan="3"><cf_rhcategorias index="0" form="filtro"></td>
					</tr>
					<tr>
						<td align="right"><strong><cf_translate key="LB_CategoriaHasta">Categor&iacute;a hasta</cf_translate>:&nbsp;</strong></td>
						<td  colspan="3"><cf_rhcategorias index="1" form="filtro"></td>
					</tr>
					<tr>
						<td align="right"><strong><cf_translate key="LB_FechaDesde">Fecha desde</cf_translate>&nbsp;</strong></td>
						<td width="12"><cf_sifcalendario name = "FechaD" form="filtro"></td>
						<td><strong><cf_translate key="LB_hasta">hasta</cf_translate>&nbsp;</strong></td>
						<td width="228"><cf_sifcalendario name = "FechaH" form="filtro"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<cfoutput>										
						<input type="submit" name="btnFiltrar" value="#BTN_Consultar#">
 ...
 <script language="JavaScript" type="text/javascript">
	...
	objForm.FechaD.description = "Fecha DESDE";
	objForm.FechaH.required = true;
	objForm.FechaH.description = "Fecha HASTA";*/
