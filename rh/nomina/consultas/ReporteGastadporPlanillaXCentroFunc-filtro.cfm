...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_RepGastoXPlanillaXUnid#">
		<cfinclude template="/rh/portlets/pNavegacion.cfm">		
		<form name="form1" method="post" action="ReporteGastadporPlanillaXCentroFunc-form.cfm">
		<cfoutput>
		<table cellpadding="3" cellspacing="0" align="center" border="0">					
		<tr> 
			<td nowrap class="fileLabel"><strong><cf_translate key="LB_CodigoDelCalendarioDePago">Código del Calendario de Pago</cf_translate> :&nbsp;</strong></td>
			<td nowrap >		
     	...
     	<tr>		   
		   ...
		   <cf_rhperiodos name="anno" tabindex="1"></td></tr>		
		 <tr>		 	
			<td align="center" colspan="2">
			<strong>#LB_Fecha_hasta#&nbsp;:&nbsp;</strong><cf_sifcalendario  value="#LSDateFormat(Now(),'dd/mm/yyyy')#"></td>					
	    </tr>					 
		</tr>		
				<tr>									
