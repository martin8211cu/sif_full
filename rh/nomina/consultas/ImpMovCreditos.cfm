<cf_templateheader title="Importaci&oacute;n de Movimientos de Cr&eacute;dito">
	<cf_web_portlet_start titulo="Importaci&oacute;n de Movimientos de Cr&eacute;dito">
	<br>
	<cfoutput>
	<form name="form1" action="ImpMovCreditos_form.cfm" method="post" onsubmit="return validar(this);">
