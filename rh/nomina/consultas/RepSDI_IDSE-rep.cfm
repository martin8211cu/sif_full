...
<cfset RegPatron = #regPat#> <!---Registro Patronal IMSS --->
...
<!---                        <cfthrow message="#rsDatosEmpleado.RecordCount#">--->
                            ...
                            <cfif linea GT 1>
                                ...
                                <cfset periodoRpte = '#periodoRpte##LSDateFormat(FechaInicio,"ddmmyyyy")#'>
...
<!---                          <cfif linea EQ 3>    <cfthrow message="#linSdi#-#replace(LSCurrencyformat(sueldo,'none'),'.','')#-"></cfif>--->
                                 ...
                                 <cfset hilera = hilera & '     0700000'>
                                 <cfset hilera = hilera & RepeatString(" ",5-len(trim(numEmp))) &'#numEmp#' & '      '>
