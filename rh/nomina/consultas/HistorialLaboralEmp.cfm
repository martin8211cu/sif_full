...
--->
	...
	method="Translate"
	Key="LB_RecursosHumanosReporteHistorialLaboral"
	Default="Recursos Humanos - Reporte Historial Laboral"
	returnvariable="LB_RecursosHumanosReporteHistorialLaboral"/>
				...
				<td valign="top">	
					<cf_web_portlet_start border="true" titulo="#LB_ListadoDeEmpleados#" skin="#Session.Preferences.Skin#"> 
						...
						<cfif isDefined("url.btnFiltrar")> 
							...
							<cfinclude template="HistorialLaboralEmp-reporte.cfm">
						...
						<cfelse>
							<!--- Filtro --->
							<cfinclude template="/rh/portlets/pNavegacion.cfm">
							<cfinclude template="HistorialLaboralEmp-Filtro.cfm">
						</cfif>
					<cf_web_portlet_end> 
				</td>	
			</tr>
