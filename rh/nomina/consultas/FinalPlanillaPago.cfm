...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
		...
		<cfif isdefined('form.CPid')>
            ...
            <cf_reportWFormat url="/sif/rh/nomina/consultas/FinalPlanillaPagoReporte.cfm" orientacion="landscape"
             regresar="FinalPlanillaPago.cfm" params="#params#">
        <cfelse>     
            <cfinclude template="FinalPlanillaPagoFiltro.cfm">
        </cfif>
	<cf_web_portlet_end>
<cf_templatefooter>