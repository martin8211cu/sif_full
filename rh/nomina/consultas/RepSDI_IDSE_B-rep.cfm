...
<cfif #form.Mes# GTE 11>
	<cfset PeriodoDos = form.periodo +1>
<cfelse>
	<cfset PeriodoDos = form.periodo>
</cfif> 

<cfswitch expression="#form.Mes#">
	<cfcase value="1">  <cfset vBimestre = ' Enero - Febrero '><cfset periodoRpte ='#periodoRpte#0103#PeriodoDos#'></cfcase>
    <cfcase value="3">  <cfset vBimestre = ' Marzo - Abril '><cfset periodoRpte = '#periodoRpte#0105#PeriodoDos#'> </cfcase>
    <cfcase value="5">  <cfset vBimestre = ' Mayo - Junio '><cfset periodoRpte = '#periodoRpte#0107#PeriodoDos#'>  </cfcase>
    <cfcase value="7">  <cfset vBimestre = ' Julio - Agosto '><cfset periodoRpte = '#periodoRpte#0109#PeriodoDos#'> </cfcase>
    <cfcase value="9">  <cfset vBimestre = ' Septiembre - Octubre '><cfset periodoRpte = '#periodoRpte#0111#PeriodoDos#'> </cfcase>
    <cfcase value="11"> <cfset vBimestre = ' Noviembre - Diciembre '><cfset periodoRpte = '#periodoRpte#0101#PeriodoDos#'> </cfcase>
</cfswitch>
