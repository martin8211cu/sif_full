<cf_templateheader title="Importaci&oacute;n de Trabajadores">
	<cf_web_portlet_start titulo="Importaci&oacute;n de Trabajadores">
	<br>
	<cfoutput>
	<form name="form1" action="ImpTrabajadores_form.cfm" method="post" onsubmit="return validar(this);">
