...
<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
	<table width="100%" cellpadding="1" cellspacing="0">
		<tr>
			<td valign="top">	
				<cf_web_portlet_start border="true" titulo="Asiento de Liquidación de Cesant&iacute;a" skin="#Session.Preferences.Skin#"> 
					<form name="form1" method="get" action="asientoLiquidacion.cfm" onSubmit="javascript: return validar();">
