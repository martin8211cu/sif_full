	...
	<cfif not isdefined("url.CPid")>
		...
		method="Translate"
		Key="LB_Error_No_se_ha_seleccionado_el_calendario_de_Pagos"
		Default="Error. No se ha seleccionado el calendario de Pagos"
		returnvariable="LB_Error_No_se_ha_seleccionado_el_calendario_de_Pagos"/> 
	
		<cf_throw message="#LB_Error_No_se_ha_seleccionado_el_calendario_de_Pagos#" errorCode="1050">
	</cfif>
							...
							<tr>
								<td>
									<cfif isdefined("url.DEid")>
										<iframe width="100%" height="500" frameborder="0" src="asientoAcumulacion-form.cfm?CPid=<cfoutput>#url.CPid#</cfoutput>&DEid=<cfoutput>#url.DEid#</cfoutput>" ></iframe>
									<cfelse>
										<iframe width="100%" height="500" frameborder="0" src="asientoAcumulacion-form.cfm?CPid=<cfoutput>#url.CPid#</cfoutput>" ></iframe>
									</cfif>
								</td>
							</tr>
						</table>
