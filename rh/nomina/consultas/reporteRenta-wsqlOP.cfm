...
<cfoutput>
<table width="108%" height="27" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td>
...
<table width="100%" cellpadding="2" cellspacing="0" align="center">
	<tr>
		...
		<td class="tituloListas" align="right" nowrap ><cf_translate  key="LB_SalarioGravableOtrosPat">Sal Gravable O.P.</cf_translate></td>
		<td class="tituloListas" align="center" ><cf_translate  key="LB_MontoRentaOtrosPat">Monto Renta O.P.</cf_translate></td>
	...
	<cfif data.recordcount gt 0>
		<cfoutput query="data">
			<tr>
				...
				<td style="border-bottom: 1px solid gray;" align="right">#LSNumberFormat(data.SalGrabaOP,',9.00')#</td>
				<td style="border-bottom: 1px solid gray;" align="right">#LSNumberFormat(data.MonRentaOP,',9.00')#</td>
        	...
        	<cfif data.recordcount gt 0>
                <tr bordercolor="#FFFFFF"><cfoutput>
					...
					<td style="font-weight:bold" align="right">#LSNumberFormat(dataTOTAL.SalGrabaOPTOTAL,',9.00')#</td>
					<td style="font-weight:bold" align="right">#LSNumberFormat(dataTOTAL.MonRentaOPTOTAL,',9.00')#</td>
