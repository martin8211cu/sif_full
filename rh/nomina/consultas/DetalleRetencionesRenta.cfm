...
<cf_templateheader title="#LB_nav__SPdescripcion#">
	<cf_web_portlet_start titulo="#LB_nav__SPdescripcion#">
        ...
        <cfif isdefined("url.EIRid") and len(trim(url.EIRid)) GT 0>
            <cf_reportWFormat url="/rh/nomina/consultas/DetalleRetencionesRenta-Rep.cfm"
             regresar="DetalleRetencionesRenta.cfm" params="EIRid=#url.EIRid#">
        <cfelse>     
            <cfinclude template="DetalleRetencionesRenta-filtro.cfm">
        </cfif>
	<cf_web_portlet_end>
<cf_templatefooter>