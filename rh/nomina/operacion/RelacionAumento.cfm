...
<cfinvoke Default="Registro de Aumentos Salariales" VSgrupo="103" returnvariable="nombre_proceso" component="sif.Componentes.TranslateDB" method="Translate" VSvalor="#session.monitoreo.SScodigo#.#session.monitoreo.SMcodigo#.#session.monitoreo.SPcodigo#"/>
		...
		<tr>
			<td valign="top">		                    
				<cf_web_portlet_start border="true" titulo="#nombre_proceso#" skin="#Session.Preferences.Skin#">  		          
					...
					<cfinclude template="RelacionAumento-form.cfm">                  
				<cf_web_portlet_end>
			</td>	
		</tr>
	</table>	
