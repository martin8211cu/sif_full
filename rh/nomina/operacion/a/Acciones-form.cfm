...
<cfif modo EQ "CAMBIO">
	...
	<cfquery name="rsTipoAccionComp" datasource="#Session.DSN#">
		...
		RHTcsalariofijo, coalesce(RHTporcPlazaCHK, 0) as RHTporcPlazaCHK, b.RHTsubcomportam 
    ...
    <tr> 
        ...
        <td nowrap>
            ...
            <cfelseif isdefined("rsTipoAccionDef") and not isdefined("tabChoice")>
            	<cf_rhtipoaccion query="#rsTipoAccionDef#" hidectls="tdFfinetq,tdFfintxt,trEmpresa,trIncapacidad" combo="true" tabindex="1"> 
			<!--- Modo Alta --->
            <cfelse>
				<!--- Pantallas desde el Administrador --->
				<cfif Session.Params.ModoDespliegue EQ 1>
					<cf_rhtipoaccion hidectls="tdFfinetq,tdFfintxt,trEmpresa,trIncapacidad" combo="true" tabindex="1">
				<!--- Acceso restringido de Tipos de acciones desde autogestion --->
				<cfelseif Session.Params.ModoDespliegue EQ 0>
					<cf_rhtipoaccion hidectls="tdFfinetq,tdFfintxt,trEmpresa,trIncapacidad" combo="true" autogestion="true" tabindex="1">
				</cfif>
			</cfif> 
		</td>
...
<!---20100320 ljimenez se pintan nuevas opciones de detalle en la accion de personal tipo incapacidad Legislacion MEXICO --->
	...
	<cfif #UsaSBC# EQ 1>
	  <tr id="trIncapacidad" <cfif not (modo EQ "CAMBIO" and rsAccion.RHTcomportam EQ 5 and rsAccion.RHTsubcomportam GT 0)> style="display: none;"</cfif>> 
        ...
        <td>
			<cfif modo EQ "ALTA">
				<span id="contenedor_Riesgos">
					<select name="TipoRiesgo"  id="TipoRiesgo" tabindex="1" onchange="ajaxFunction1_ComboConsecuencia();">
        ...
        <td>
			<cfif modo EQ "ALTA">
				...
				<span id="contenedor_Consecuencia">
					<select name="Consecuencia" id="Consecuencia"  tabindex="1" onchange="ajaxFunction1_ComboControlIncapacidad();">
        ...
        <td>
			<cfif modo EQ "ALTA">
				<span id="contenedor_ControlIncapacidad">
					<select name="ControlIncapacidad"  id="ControlIncapacidad" tabindex="1">
