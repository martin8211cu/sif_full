			...
			<form name="lista" method="get" action="Incidencias.cfm">
				<cfinvoke component="rh.Componentes.pListas"
				 ...
				 returnvariable="pListaRet">
					...
					<cfinvokeargument name="desplegar" value="Ifecha, CIdescripcion, NombreEmp, Ivalor, Imonto,Icpespecial"/>
					<cfinvokeargument name="etiquetas" value="#vFecha#,#vConcepto#, #vEmpleado#, #vCantidadMonto#,#vMontoCalculado#, #vIcpespecial#"/>
					<cfinvokeargument name="formatos" value="D,V,V,V,V,V"/>
