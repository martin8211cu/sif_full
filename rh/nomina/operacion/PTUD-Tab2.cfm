...
<cfquery name="rsEmpresa" datasource="#session.DSN#">
	select e.Ecodigo,Edescripcion
	from Empresas e inner join Usuario u 
	on e.cliente_empresarial = u.CEcodigo
	inner join Empresa c on e.Ecodigo = c.Ereferencia 
...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="LB_Eliminar_la_Empresa"
	Default="Eliminar la Empresa"	
	returnvariable="LB_Eliminar_la_Empresa"/>	
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
...
<script language="JavaScript" type="text/javascript">
	function showDependencia(p) {
		...
		var f = document.getElementById("trEmpresa");
	...
	function EliminarDAM(id,valor) {
		...
		if (valor == 6) { var msg = '#MSG_Empresa#'; }
			...
			<td colspan="4">
				<table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
					<tr>
                        ...
                        <td nowrap><input name="opcion" type="radio" value="6" onclick="javascript: showDependencia(6);"></td>
						<td class="fileLabel"><cf_translate key="LB_Empleado">Empresa</cf_translate></td>
                       	<!--- </cfif> --->
					</tr>
					<tr>
						<td colspan="2">
        ...
        <tr id="trEmpresa" style="display: none;">
			<td colspan="4">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						<td colspan="4" class="fileLabel"><cf_translate key="LB_Empresa">Empresa</cf_translate>:</td>
					</tr>
						...
						<td nowrap>
							<select name="Empresas">
								<cfloop query="rsEmpresa">
									<option value="#rsEmpresa.Ecodigo#">#rsEmpresa.Edescripcion#</option>
								</cfloop>
							</select>
						</td>
						<td nowrap colspan="2">
					...
					<table width="600" cellpadding="0" cellspacing="0" border="0">
						...
						<cfif isdefined("Form.RHPTUEid") and len(trim(Form.RHPTUEid))>
							<cfquery name="rsEmpresas" datasource="#session.DSN#">
								select a.RHPTUDid,b.Edescripcion
								from RHPTUD a
						...
						<cfif isdefined("rsEmpresas") and rsEmpresas.recordcount GT 0 >
							<tr>
								<td class="fileLabel">&nbsp;&nbsp;<cf_translate key="LB_Empresas">Empresas</cf_translate></td>
							</tr>
							<tr>
								<td>
									<table width="90%" cellpadding="0" cellspacing="0" border="0" align="center">
										...
										<cfloop query="rsEmpresas">
											<tr nowrap align="left" class=<cfif CurrentRow MOD 2>"listaNon"<cfelse>"listaPar"</cfif> onMouseOver="style.backgroundColor='##E4E8F3';" onMouseOut="style.backgroundColor='<cfif CurrentRow MOD 2>##FFFFFF<cfelse>##FAFAFA</cfif>';" >
												<td height="20">&nbsp;&nbsp;#rsEmpresas.Edescripcion#</td>
												<td width="10%" align="right">
													<input name="btnEliminar" type="image" alt="#LB_Eliminar_la_Empresa#"  onClick="javascript: return EliminarDAM('#rsEmpresas.RHPTUDid#','6');"  src="/cfmx/rh/imagenes/Borrar01_T.gif" width="16" height="16" tabindex="-1">
												</td>
											</tr>					
										</cfloop>
									</table>
