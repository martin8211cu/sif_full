...
<cfif isdefined ('url.xTipoRiesgo') and #url.xTipoRiesgo# GT 0 and (isdefined('url.xRHTsubcomportam') and url.xRHTsubcomportam EQ 1 or isdefined('url.xRHTsubcomportam') and url.xRHTsubcomportam EQ 2)>
