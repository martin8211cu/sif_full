...
<cfif rsTiposNomina.RecordCount gt 0>
	<cfset form.Tcodigo = rsTiposNomina.Tcodigo>
</cfif>
...
<form name="form1" method="post" action="PTU-RelacionCalculoTab5-sql.cfm" ><!--- onsubmit="return fnVerifica(document.form1.RCNid.value);" --->
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="2" align="center">
      <tr>
        ...
        <td nowrap>
			<cf_rhtiponominaCombo index="0" onChange="changeCalculo" combo="true" todas="false" Ecodigo="#rsEmpresa.Ecodigo#">
		</td>
      </tr>
      <tr>
