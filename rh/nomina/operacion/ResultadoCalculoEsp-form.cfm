...
<br>
<form action="ResultadoCalculoEsp-sql.cfm" method="post" name="form1">
  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;" align="center">
    <tr> 
    ...
    <cfoutput> 
      <tr valign="top"> 
        <td nowrap colspan="8" align="center">  
          ...
          <input type="submit" name="AltaI" 		class="btnNuevo" 	value="#BTN_Agregar_Incidencia#" onclick="javascript:return btnAgregarIncidencia();"> 
          <input type="submit" name="AltaD" 		class="btnNuevo" 	value="#BTN_Agregar_Deducccion#" onclick="javascript:return btnAgregarDeduccion();"> 
          <input type="submit" name="Baja"  		class="btnEliminar" value="#BTN_Eliminar#" 			 onclick="javascript:return btnEliminarChecked();"> 
		  <input type="submit" name="butRestaurar" 	class="btnGuardar" 	value="#BTN_Restaurar#" 		 onclick="javascript:return btnRestaurar();">
  		  <input type="submit" name="btnRegresar" 	class="btnAnterior" value="#BTN_Regresar#"  		 onclick="javascript:document.form1.action='ResultadoCalculoEsp-lista.cfm';">
        </td>
      </tr>
      <tr valign="top"> 
        <td nowrap colspan="8" align="center">
