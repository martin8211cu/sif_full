...
<script language="JavaScript">
	...
	function habilitarValidacion() {
		<cfif RHTespecial neq 1> <!--- Funciones para acciones normales --->
			...
			<cfif usaEstructuraSalarial EQ 1 and rsAccion.RHTccatpaso EQ 1>
				document.form1.RHTTid1.disabled = false;
				document.form1.RHMPPcodigo1.disabled = false;
				document.form1.RHCcodigo1.disabled = false;
			</cfif>
			<cfif rsAccionesVal.RHCatParcial eq 1>
				document.form1.RHTTid2.disabled = false;
				document.form1.RHMPPcodigo2.disabled = false;
				document.form1.RHCcodigo2.disabled = false;
			</cfif>
			...
			<cfif usaEstructuraSalarial EQ 1 and rsAccion.RHTccatpaso EQ 1>
				objForm.RHTTid1.required = true;
				//objForm.RHCcodigo.required = true;
				objForm.RHCid1.required = true;
				//objForm.RHMPPcodigo.required = true;
				objForm.RHMPPid1.required = true;
			</cfif>
			<cfif rsAccionesVal.RHCatParcial eq 1>
				objForm.RHTTid2.required = true;
				//objForm.RHCcodigo.required = true;
				objForm.RHCid2.required = true;
				//objForm.RHMPPcodigo.required = true;
				objForm.RHMPPid2.required = true;
			</cfif>
			<cfoutput>
			<cfloop query="rsComponentesAccion">
	...
	function deshabilitarValidacion() {
		<cfif RHTespecial neq 1> <!--- Funciones para acciones normales --->
			...
			<cfif rsAccionesVal.RHCatParcial eq 1>
				objForm.RHTTid2.required = false;
				objForm.RHCid2.required = false;
				objForm.RHMPPid2.required = false;
			</cfif>
			<cfoutput>
			<cfloop query="rsComponentesAccion">
	...
	<cfif modo NEQ "ALTA">
		 <cfif RHTespecial neq 1> <!--- Funciones para acciones normales --->
			...
			<cfif usaEstructuraSalarial EQ 1 and rsAccion.RHTccatpaso EQ 1>
				objForm.RHTTid1.required = true;
				objForm.RHTTid1.description = "#MSG_Tipo_de_Tabla#";
				objForm.RHCid1.required = true;
				objForm.RHCid1.description = "#MSG_Categoria#";
				objForm.RHMPPid1.required = true;
				objForm.RHMPPid1.description = "#MSG_Puesto#";
			</cfif>
			<cfif rsAccionesVal.RHCatParcial eq 1>
				objForm.RHTTid2.required = true;
				objForm.RHTTid2.description = "#MSG_Tipo_de_Tabla#";
				objForm.RHCid2.required = true;
				objForm.RHCid2.description = "#MSG_Categoria#";
				objForm.RHMPPid2.required = true;
				objForm.RHMPPid2.description = "#MSG_Puesto#";
			</cfif>
			<cfloop query="rsComponentesAccion">
				objForm.RHDAunidad_#rsComponentesAccion.currentRow#.required = true;
