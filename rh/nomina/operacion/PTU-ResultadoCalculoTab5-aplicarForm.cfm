...
<cfquery datasource = "#session.DSN#" name="rsEmpresa"> <!---SML Modificacion para guardar los calculos de PTU en su empresa correspondiente--->
    ...
    where CPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#rsRelacionCalculo.RCNid#">
</cfquery>
...
<form action="PTU-ResultadoCalculoTab5-aplicarSql.cfm" method="post" name="formT5Aplica">
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
			...
			<td nowrap width="80%">
				<cf_sifCuentaCliente tabindex="1" vMcodigo="#rsRelacionCalculo.Mcodigo#" form="formT5Aplica" Ecodigo="#rsEmpresa.Ecodigo#">
			</td>
		</tr>
		<tr><td nowrap colspan="2">&nbsp;</td></tr>
