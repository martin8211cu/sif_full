...
<cfinvoke key="MSG_Tipo_de_Tabla" default="Tipo de Tabla"	 returnvariable="MSG_Tipo_de_Tabla" component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Categoria" default="Categoría"	 returnvariable="MSG_Categoria" component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Puesto" default="Puesto"	 returnvariable="MSG_Puesto" component="sif.Componentes.Translate" method="Translate"/>
...
<cfif modo EQ "CAMBIO">
	...
	<cfquery name="rsTipoAccionComp" datasource="#Session.DSN#">
		...
		RHTcsalariofijo, coalesce(RHTporcPlazaCHK, 0) as RHTporcPlazaCHK 
...
<cfinclude template="AccionesRecargos-queries.cfm">						<!---*** Este archivo es compartido con las acciones de los demas comportamientos --->

<!--- VARIABLE PARA DEFINIR PERMISO PARA MODIFICAR LA ACCION 
	SE DEFINE ACTIVA PARA LAS ACCIONES NORMALES --->

<cfif isdefined('rsAccion.DEid') and len(trim(rsAccion.DEid))>
...
<cfoutput>
<form name="form1" method="post" action="/cfmx/rh/nomina/operacion/AccionesRecargos-sql.cfm" onsubmit="javascript: return validaForm(this);">
...
"
    ...
    <tr> 
        ...
        <td nowrap>
			...
			<cfif modo NEQ "ALTA">
				<input type="hidden" name="RHTid" value="#rsAccion.RHTid#">
            ...
            <cfelseif isdefined("rsTipoAccionDef") and not isdefined("tabChoice")>
            	<cf_rhtipoaccion query="#rsTipoAccionDef#" hidectls="tdFfinetq,tdFfintxt,trEmpresa" combo="true" tabindex="1"> 
			<!--- Modo Alta --->
            <cfelse>
				<!--- Pantallas desde el Administrador --->
				<cfif Session.Params.ModoDespliegue EQ 1>
					<cf_rhtipoaccion hidectls="tdFfinetq,tdFfintxt,trEmpresa" combo="true" tabindex="1">
				<!--- Acceso restringido de Tipos de acciones desde autogestion --->
				<cfelseif Session.Params.ModoDespliegue EQ 0>
					<cf_rhtipoaccion hidectls="tdFfinetq,tdFfintxt,trEmpresa" combo="true" autogestion="true" tabindex="1">
				</cfif>
			</cfif> 
		</td>
        ...
        <td nowrap>
            ...
            <cfelse>
				...
				<cf_sifcalendario form="form1" value="#fecha#" name="DLfvigencia" tabindex="1">	
          	</cfif> 
        </td>
        ...
        <td nowrap>
			<cfif not (modo EQ "CAMBIO" and rsAccion.RHTpfijo EQ 0)>
				...
				<cfelse>
					...
					<cf_sifcalendario form="form1" value="" name="DLffin" tabindex="1">
					</div>
				</cfif>
			</cfif>
        </td>
      ...
      <tr id="trEmpresa" <cfif not (modo EQ "CAMBIO" and rsAccion.RHTcomportam EQ 9 and rsAccion.RHTcempresa EQ 1)> style="display: none;"</cfif>> 
        ...
        <td colspan="5" nowrap>
			<cfif modo EQ "ALTA">
				<select name="EcodigoRef" tabindex="1">
      ...
      <tr> 
        ...
        <td colspan="5" nowrap>
			...
			<cfelse>
				<input type="text" name="DLobs" size="130" maxlength="255" value="<cfif modo NEQ "ALTA">#HtmlEditFormat(rsAccion.DLobs)#</cfif>" tabindex="1">
			</cfif>
		</td>
      </tr>
      <tr> 
        <td colspan="6" align="center">
			<cfif modo EQ "ALTA">
				...
				<input name="btnAgregar" type="submit" value="<cfoutput>#BTN_Agregar#</cfoutput>" tabindex="1">
				<cfif not isdefined("tabChoice")>
				<input type="button" name="Regresar" value="<cfoutput>#BTN_ListaDeAcciones#</cfoutput>" onclick="javascript:Lista();" tabindex="1">
				</cfif>
            <cfelse>
            </cfif>
		</td>
        		...
        		<td colspan="6">
						  ...
						  <tr>
							<td width="45%" valign="top">
								<cfinclude template="AccionesRecargosSP-form-sitact.cfm">
							</td>
							<td width="55%" valign="top">
								  <cfinclude template="AccionesRecargosSP-form-sitpos.cfm">  
							</td>
						  </tr>
						</table>
				</td>
        		...
        		<td colspan="6">
		 			...
		 			<cfelse>
						 ...
						 <table width="100%" border="0" cellspacing="0" cellpadding="2">
						  <tr>
							<td width="45%" valign="top">
								<cfinclude template="AccionesRecargos-form-sitact.cfm">
							</td>
							<td width="55%" valign="top">
								<cfinclude template="AccionesRecargos-form-sitpos.cfm">
							</td>
						  </tr>
						  <tr <cfif modo EQ "CAMBIO" and RHTNoMuestraCS eq 1 >style="display:none"</cfif>>
							<td valign="top">
								<cfinclude template="AccionesRecargos-form-compact.cfm">
							</td>
							<td valign="top">
								<cfinclude template="AccionesRecargos-form-comppos.cfm">
							</td>
						  </tr>
						  <tr>
							<td valign="top">
							...
							<td valign="top">
								<!---<cfinclude template="AccionesRecargos-form-recpos.cfm">---><!---recargo propuesto--->
							</td>
						  </tr>
						</table>
				 </cfif>
      ...
      <tr>
        <td colspan="6" align="center">
			<cfif isdefined("Request.ConsultaAcciones") and Request.ConsultaAcciones EQ 1>
				...
				<input type="button" name="btnRegresar" value="Regresar" onclick="javascript: history.go(-1);">
				<cfelse>
				<input type="button" name="btnRegresar" value="Regresar" onclick="javascript: atras();">
				</cfif>
			<cfelse>
				<input type="hidden" name="botonSel" value="">
				<input type="submit" name="Cambio" value="#BTN_Guardar#" tabindex="1" onclick="javascript: this.form.botonSel.value = this.name; if (window.habilitarValidacion) habilitarValidacion(); this.form.action = '/cfmx/rh/nomina/operacion/AccionesRecargos-sql.cfm';">
				<cfif Lvar_Modifica>
				<input type="submit" name="Baja" value="#BTN_Eliminar#" tabindex="1" onclick="javascript: this.form.botonSel.value = this.name; if (window.deshabilitarValidacion) deshabilitarValidacion(); this.form.action = '/cfmx/rh/nomina/operacion/AccionesRecargos-sql.cfm'; return confirm('#MSG_EliminarAccion#');">
				</cfif>
				<input type="submit" name="Nuevo" value="#BTN_Nuevo#" tabindex="1" onclick="javascript: this.form.botonSel.value = this.name; if (window.deshabilitarValidacion) deshabilitarValidacion(); this.form.action = '/cfmx/rh/nomina/operacion/AccionesRecargos-sql.cfm';">
				...
				<input type="submit" name="btnAplicar" value="#BTN_Aplicar#" tabindex="1" onclick="javascript: 
					...
					if (confirm('#MSG_VacacionesPosteriores#')) {
						...
						this.form.chk.value = '#rsAccion.RHAlinea#'; this.form.botonSel.value = this.name; if (window.habilitarValidacion) habilitarValidacion(); this.form.action = '/cfmx/rh/nomina/operacion/AccionesRecargos-sql-save-apply.cfm';
					<cfif rsAccion.RHTcomportam EQ 2 and rsVacacionesPosteriores.cant GT 0>
					} else {
						return false;
					}
...
<script language="JavaScript">
	<cfif RHTespecial neq 1><!--- Funciones para acciones normales --->
		...
		function __isVacaciones() {
			if (this.required && (new Number(qf(this.value)) < (new Number(qf(this.obj.form.vacadias.value)) - 3) || new Number(qf(this.value)) > new Number(qf(this.obj.form.vacadias.value)))) {
				this.error = "<cfoutput>#MSG_ElValorDelCampo#</cfoutput> " + this.description + " <cfoutput>#MSG_DebeSerMayorA#</cfoutput> " + (parseFloat(this.obj.form.vacadias.value)>3?parseFloat(this.obj.form.vacadias.value) - 3:0) + " <cfoutput>#MSG_YMenorOIgualA#</cfoutput> " + parseFloat(this.obj.form.vacadias.value);
			}
		}
	</cfif>
	<cfif modo NEQ "ALTA">
	function habilitarValidacion() {
		<cfif RHTespecial neq 1> <!--- Funciones para acciones normales --->
			//Habilitar campos
			<cfif usaEstructuraSalarial EQ 1 and rsAccion.RHTccatpaso EQ 1>
				document.form1.RHTTid.disabled = false;
				document.form1.RHMPPcodigo.disabled = false;
				document.form1.RHCcodigo.disabled = false;
			</cfif>
			/*objForm.RHTTid.obj.disabled = false;
			objForm.RHMPPcodigo.disabled = false;
			objForm.RHCcodigo.disabled = false;*/
			//========================================================		
	...
	<cfif modo NEQ "ALTA">
		 <cfif RHTespecial neq 1> <!--- Funciones para acciones normales --->
			...
			<cfif usaEstructuraSalarial EQ 1 and rsAccion.RHTccatpaso EQ 1>
				objForm.RHTTid.required = true;
				objForm.RHTTid.description = "#MSG_Tipo_de_Tabla#";
				objForm.RHCid.required = true;
				objForm.RHCid.description = "#MSG_Categoria#";
				objForm.RHMPPid.required = true;
				objForm.RHMPPid.description = "#MSG_Puesto#";
			</cfif>
			<cfloop query="rsComponentesAccion">
				objForm.RHDAunidad_#rsComponentesAccion.currentRow#.required = true;
	...
	<cfelseif modo EQ "ALTA">
		var arrayparams, plazofijo, comportam, cambioempr;
