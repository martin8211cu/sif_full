...
<cfoutput>
	<form name="formE" method="post" style="margin: 0;" action="PTU-sql.cfm">
        ...
        <table width="85%" border="0" cellspacing="0" cellpadding="0" style="padding-left: 5px; padding-right: 5px;" align="center">
          ...
          <tr id="trTablaImpuesto">
            <td height="22" class="fileLabel" nowrap><cf_translate key="LB_Tabla_Impuesto">Tabla de Impuesto de Renta</cf_translate></td>
            <td height="22" nowrap>
            <cfset values = ''>
            <cfif modoE EQ "CAMBIO">
            	<cfquery name="rsTraeIRenta" datasource="#session.DSN#">
                	...
                	from ImpuestoRenta 
                    where IRcodigo=<cfqueryparam cfsqltype="cf_sql_char" value="#Trim(rsRHPTUE.EIRid)#">
                </cfquery>
          ...
          <tr id="trTablaDias">
            <td height="22" class="fileLabel" nowrap><cf_translate key="LB_Tabla_Impuesto">Dias Laborados considerados para Calculo de PTU</cf_translate></td>
            <td height="22" nowrap>
			<input type="text" name="txtCantDias" value="<cfif modoE EQ "CAMBIO"> #rsRHPTUE.RHPTUECantDias#</cfif>" size="10" />
            </td>
          </tr>
          <tr>
          	<td>&nbsp;</td>
...
<script language="javascript" type="text/javascript">
	function funcAlta(){
		<cfoutput>
			...
			objFormE.txtCantDias.required = true;
			objFormE.txtCantDias.description = "#LB_txtCantDias#";
		</cfoutput>
	}
