...
<!--- OPARRALES Salario Minimo, valor solo informativo --->
<cfquery name="rsParamSalMin" datasource="#session.dsn#">
	select Pvalor
	   from RHParametros
...
<!---<cf_dump var = "#rsEmpleadosPTUconsultar#">--->
    ...
    <form name="form1" style="margin: 0;" >
        <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" style="border: 1px solid gray;">
            ...
            <tr class="letra14">
                ...
                <td align="right"><label title="Monto parcial dividido entre total de sueldo pagados de todo el año (todos los empleados)"> #numberformat(rsEmpleadosPTUconsultar.RHPTUEMFactorCuotaDiaria,',._____')#</label></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr class="letra14">
            ...
            <tr class="letra14">
                ...
                <td align="right">
					<label title="Parametro de RH: Salario Mínimo General Zona A (SMGA)">
						<cfif rsParamSalMin.RecordCount EQ 0>
							NO DEFINIDO
						<cfelse>
							#rsEmpleadosPTUconsultar.Msimbolo# #numberformat(rsParamSalMin.Pvalor,',.__')#
						</cfif>
					</label>
				</td>
                <td>&nbsp;</td>
			...
			<tr class="letra14">
                <td><strong><label title="Parametro de RH: Salario Mínimo General Zona A (SMGA)">UMA:</label></strong> </td>
