<cfif NOT ISDEFINED('form.RCNid') AND ISDEFINED('Arguments.RCNid')>
	<cfset form.RCNid = Arguments.RCNid>
</cfif>
<cfif NOT ISDEFINED('Lvar_Regresar') AND ISDEFINED('Arguments.Lvar_Regresar')>
	<cfset Lvar_Regresar = Arguments.Lvar_Regresar>
</cfif>
	...
	<cf_templatearea name="body">
		...
		<script language="javascript1.2" type="text/javascript">
			...
			function detalle(cfcuenta, rcnid){
				...
				popUpWin = open('ResultadoCalculo-erroresDetalle.cfm?cfcuenta='+cfcuenta, 'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width='+width+',height='+height+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
			}
		</script>
		...
		<!---<cf_web_portlet_start titulo="<cfoutput>#titulo#</cfoutput>" border="true" >--->
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr><td>&nbsp;</td></tr>
				<tr><td><cfinclude template="/rh/portlets/pRelacionCalculo.cfm"></td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td>
							...
							<table width="95%" align="center" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<cfoutput query="errores_pres" group="Cformato">
										<tr>
											<td>#errores_pres.Cformato#  #errores_pres.Nombre#</td>
