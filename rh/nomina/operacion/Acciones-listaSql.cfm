...
<cfif isdefined("Form.btnAplicar")>
	...
	<cfif LvarPP eq 1>
			<cfif rsConsTipoAccion.RHTnoveriplaza EQ 0 and len(trim(form.RHPid))>
				...
				<cfif session.usulogin eq 'soinrh' and LvarM>
					rsPorcPlaza<cfdump var="#rsPorcPlaza#"><br>
				</cfif>
		...
		<cfif IsDefined("info_tramite.RHTidtramite") AND Len(info_tramite.RHTidtramite) GT 0>
			...
			<cftransaction>
				<cfif info_tramite.RHAccionRecargo GT 0 or info_tramite.RHTcomportam EQ 12> <!---Si el comportamiento es de recargo utiliza una copia del componente adaptada para este tipo de accion--->
		...
		<cfelse>
			...
			<cfif info_tramite.RHAccionRecargo GT 0 or info_tramite.RHTcomportam EQ 12 or info_tramite.RHTcomportam EQ 15> 
