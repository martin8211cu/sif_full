			...
			<cftransaction>
				...
				<cfquery name="rsConceptos" datasource="#Session.DSN#">
					select a.DLfvigencia, 
						   ...
						   c.CIid, 
						   c.CIcantidad, c.CIrango, c.CItipo, c.CIcalculo, c.CIdia, c.CImes, c.CIsprango,c.CIspcantidad
...
<!---					<cfdump var="#values.get('importe').toString()#">
					<cfdump var="#values.get('resultado').toString()#">
					<cf_dump var="#values.get('cantidad').toString()#">--->
