...
<!---        <cfinvoke component="rh.Componentes.RH_RelacionCalculo" method="RelacionCalculo" returnvariable="NewERNid">
        	<cfinvokeargument name="Ecodigo" 		value="#rsEmpresa.Ecodigo#">
