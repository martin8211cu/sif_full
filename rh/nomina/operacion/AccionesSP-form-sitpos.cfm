...
<cfinvoke key="LB_El_texto_supera_la_cantidad_de_caracteres_permitidos" Default="El texto supera la cantidad de caracteres permitidos" returnvariable="LB_El_texto_supera_la_cantidad_de_caracteres_permitidos" component="sif.Componentes.Translate" method="Translate"/>
...
<cfelseif RHTcomportam EQ 10> <!--- anotación --->
	<cfoutput>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;">
		  <tr>
			<td class="#Session.Preferences.Skin#_thcenter" colspan="2"><div align="center"><cf_translate key="LB_Situacion_Propuesta">Situaci&oacute;n Propuesta</cf_translate></div></td>
...
<cfelseif RHTcomportam EQ 14> <!--- CAMBIO DE PUESTO --->	
	<cfoutput>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;">
		  <tr>
			<td class="#Session.Preferences.Skin#_thcenter" colspan="2"><div align="center"><cf_translate key="LB_Situacion_Propuesta">Situaci&oacute;n Propuesta</cf_translate></div></td>
		  ...
		  <tr>
			...
			<td height="25" nowrap>
				<cfquery name="rsPuesto" datasource="#Session.DSN#">
					...
					and x.RHPcodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#rsAccion.RHPcodigo#">
				</cfquery>
				<cfif not  Lvar_modifica>
					#rsAccion.RHPcodigo# - #rsAccion.RHPdescpuesto#
				<cfelse>
