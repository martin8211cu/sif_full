...
<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="LB_Asiento_Contable"
	Default="Asiento Contable"
	returnvariable="LB_Asiento_Contable"/> 		
	...
	<cf_templateheader title="#LB_RecursosHumanos#" template="#session.sitio.template#">
		...
		<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_Asiento_Contable#">
			<table width="100%" cellpadding="2" cellspacing="0">
				<tr>
					<td>
						<cfoutput>
						<form method="post" name="filtro" action="ExportarAsientoIM.cfm" style="margin:0;">
					...
					<td>
						...
						<cfinvoke 
						 ...
						 returnvariable="pListaRet">
							...
							<cfinvokeargument name="irA" value="SQL_ExportarAsientoIM.cfm"/>
						</cfinvoke>
					</td>
				</tr>
			</table>
