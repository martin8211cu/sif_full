...
<cfinvoke Key="LB_Porc_Salario_fijo" Default="% Salario fijo" returnvariable="LB_Porc_Salario_fijo" component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke Key="LB_Jornada" Default="Jornada" returnvariable="LB_Jornada" component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke Key="MSG_La_accion_no_se_puede_aplicar_porque_los_siguientes_valores_no_son_modificables" Default="La acci&oacute;n no se puede aplicar porque los siguientes valores no son modificables:"	 returnvariable="MSG_Error" component="sif.Componentes.Translate" method="Translate"/>
...
<cfquery name="rsActual" datasource="#session.DSN#">
	...
	where <cfqueryparam cfsqltype="cf_sql_timestamp" value="#LSParseDateTime(Form.DLfvigencia)#"> between a.LTdesde and a.LThasta
        ...
        and RHPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#rsAccion.Plaza#">
</cfquery>
