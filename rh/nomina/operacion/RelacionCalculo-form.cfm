...
<cfquery name="PaySchedAfterRestrict" datasource="#Session.DSN#">
	...
	and not exists (
		select 1
		from HRCalculoNomina i
		where a.Tcodigo = i.Tcodigo
		and a.Ecodigo = i.Ecodigo
		and a.CPdesde = i.RCdesde
		and a.CPhasta = i.RChasta
		and a.CPid = i.RCNid
	)
	order by CPhasta
</cfquery>
...
<cfoutput>
<form name="form1" method="post" action="RelacionCalculo-sql.cfm">
	<table width="95%" border="0" cellspacing="0" cellpadding="2" align="center">
		...
		<tr> 
			<td align="right" nowrap class="fileLabel"><cf_translate key="LB_CodioCalendarioDePago">C&oacute;digo Calendario de Pago:</cf_translate></td>
			<td nowrap>
