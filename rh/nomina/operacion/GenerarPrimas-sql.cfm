...
<cf_dbtemp name="tmpPrimas" returnvariable="PrimaVac" datasource="#session.DSN#">
	...
	<cfset Fdesde = #LSDateFormat(form.FechaDesde, "dd/mm/yyyy")#>
	
    <cfset Fhasta = Dateadd('d',#form.DiasT#, dateformat(#Fdesde#,"dd/mm/yyyy"))>
...
<cfloop query="rsEmpleadosPrima">
    ...
    <cfif isdefined('rsConcepto') and rsConcepto.RecordCount>
		...
		<cfset FFinCalc 	= Dateadd('d',#form.DiasT#, dateformat(#form.FechaDesde#,"dd/mm/yyyy"))>
        <cfset FFin = LSDateFormat(#FFinCalc#, 'DD/MM/YYYY')>
