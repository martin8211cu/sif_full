...
<cfsilent>
<cfinvoke Default="Reposici&oacute;n de Dias de Faltas" VSgrupo="103" returnvariable="nombre_proceso" component="sif.Componentes.TranslateDB" method="Translate" VSvalor="#session.monitoreo.SScodigo#.#session.monitoreo.SMcodigo#.#session.monitoreo.SPcodigo#"/>
						...
						<cfif isdefined("Form.sel") and form.sel NEQ 1>
	   					...
	   					<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr style="display: ;" id="verFiltroListaEmpl"> 
								<td> 
							  		<form name="formFiltroListaEmpl" method="post" action="RelacionDevolucionFaltas-lista.cfm">
								  		...
								  		<tr>
											<td>
												...
												<cfinvoke 
													...
													<cfinvokeargument name="irA" value="RelacionDevolucionFaltas-form.cfm"/>
			  					  		...
			  					  		<tr>
								  			<td align="center">
												<form name="formNuevoEmplLista" method="post" action="">
