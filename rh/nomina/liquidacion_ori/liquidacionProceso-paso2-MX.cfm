...
<cfset TotalRealL = fnFormatMoney(TotalL - ISPTSL - Infonavit)> <!---Modificacion por coma (,) SML--->
<!---<cfthrow message="#SalarioMensual#">--->
...
<!---<cfthrow message= "#MontoGrabadoF#,#LISR113F.DIRinf#,#LISR113F.DIRporcentaje#">--->
...
<table align="center" width="60%" border="0" cellspacing="0" cellpadding="3">
	...
	<tr>
		...
		<cfset MSG = MSG & "<span><strong>Percepciones Gravables</strong></span></table>">
	...
	<tr>
		...
		<cfset MSG = MSG & "
		<span>
			<strong>Percepciones Exentas</strong>
		</span>
		</table>">
	...
	<tr>
		...
		<table align='center' border='0' cellspacing='0' cellpadding='2'>
			...
			<span><strong>Total Finiquito</strong></span>
		</table>">
    ...
    <cfset ParteExenta = 0>
		...
		<table align='center' border='0' cellspacing='0' cellpadding='2'>
			...
			<span><strong>Base Impuesto</strong></span>
		</table>">
	...
	<tr>
		...
		<table align='center' border='0' cellspacing='0' cellpadding='2'>
			...
			<span><strong>ISPT Liquidación</strong></span>
		</table>">
