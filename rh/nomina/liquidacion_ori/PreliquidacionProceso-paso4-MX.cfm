...
<cfquery name="refrescarDeducciones1" datasource="#Session.DSN#">
	...
	and not exists (	select 1
						...
						where RHLiqDeduccionPrev.Did = DeduccionesEmpleado.Did
						and (	
...
<cfif not isdefined("Form.Nuevo")>
	<cfif isdefined("Form.RHLPDid") AND Len(Trim(Form.RHLPDid)) GT 0>
		<cfset modo = "CAMBIO">
	<cfelse>
		<cfset modo = "ALTA">
	</cfif>
...
<cfif modo NEQ "ALTA">
	<cfquery name="rsRHLiqDeduccionPrev" datasource="#Session.DSN#">
		select  b.RHLPDid, b.RHPLPid, b.DEid, b.Did, b.RHLDdescripcion, b.RHLDreferencia, b.SNcodigo, b.importe as Ivalor, b.fechaalta, 
				b.RHLDautomatico, b.BMUsucodigo, b.ts_rversion, 
				de.SNnombre, de.SNnumero, dempl.Dmetodo, b.RHLDporcentaje
		from RHLiqDeduccionPrev b
		...
		where b.RHLPDid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.RHLPDid#">
		  and b.RHPLPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#RHPLPid#">
	</cfquery>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function doConlisDeducciones() {
		...
		popUpWindow("conlisPreDeducEmpleado-MX.cfm?RHPLPid=<cfoutput>#RHPLPid#</cfoutput>",l,t,w,h);
	}
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
		<form action="#CurrentPage#" method="post" name="form1" onSubmit="javascript: return validaForm(this);">
			...
			<cfif modo EQ "CAMBIO">
				<input name="RHLPDid" type="hidden" value="#rsRHLiqDeduccionPrev.RHLPDid#">
			</cfif>
			<cfset ts = "">
			<cfif modo NEQ "ALTA">
				<cfinvoke component="sif.Componentes.DButils" method="toTimeStamp"returnvariable="ts">
					<cfinvokeargument name="arTimeStamp" value="#rsRHLiqDeduccionPrev.ts_rversion#"/>
				</cfinvoke>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
			  <tr>
				...
				<td>
					<input name="Dmetodo"  id="Dmetodo" type="hidden" value="<cfif modo neq 'ALTA' and rsRHLiqDeduccionPrev.Dmetodo eq 0>0<cfelse>1</cfif>">
					<input name="Did"  id="Did" type="hidden" value="<cfif modo NEQ "ALTA" >#rsRHLiqDeduccionPrev.Did#</cfif>">
					<input name="Ddescripcion" type="text"  value="<cfif modo NEQ "ALTA" >#rsRHLiqDeduccionPrev.RHLDdescripcion#</cfif>"  tabindex="-1" readonly size="50" maxlength="180">
			    ...
			    <td>
					<cfif modo EQ "CAMBIO">
						<cf_sifsociosnegocios2 idquery="#rsRHLiqDeduccionPrev.SNcodigo#">
					<cfelse>
			  ...
			  <tr>
				...
				<td nowrap>
				  <input name="Ivalor" type="text" id="Ivalor" disabled="disabled" size="18" maxlength="15" onfocus="this.value=qf(this); this.select();" onblur="javascript: fm(this,2);"  onkeyup="if(snumber(this,event,2)){ if(Key(event)=='13') {this.blur();}}" style="text-align: right;" value="<cfif modo NEQ "ALTA" and isdefined("rsRHLiqDeduccionPrev")>#LSCurrencyFormat(rsRHLiqDeduccionPrev.Ivalor, 'none')#<cfelse>0.00</cfif>" tabindex="1">
				</td>
				<td class="fileLabel" align="right">#vReferencia#:</td>
				<td>
					<input name="referencia" id="referencia" type="text" value="<cfif modo NEQ "ALTA" >#rsRHLiqDeduccionPrev.RHLDreferencia#</cfif>" tabindex="-1" size="50" maxlength="180">
				</td>
			  </tr>

				<tr id="tr_porcentaje" <cfif modo neq 'ALTA' and rsRHLiqDeduccionPrev.Dmetodo eq 0>style="display:;"<cfelse>style="display:none;"</cfif>   >
					<td width="15%" class="fileLabel" nowrap align="right" id="etiquetaLabel" >#vPorcentaje#:</td>
					<td nowrap>
					  <input name="RHLDporcentaje" type="text" id="RHLDporcentaje" size="10" maxlength="6" onfocus="this.value=qf(this); this.select();" onblur="javascript: fm(this,2);"  onkeyup="if(snumber(this,event,2)){ if(Key(event)=='13') {this.blur();}}" style="text-align: right;" value="<cfif modo NEQ "ALTA" and isdefined("rsRHLiqDeduccionPrev")>#LSCurrencyFormat(rsRHLiqDeduccionPrev.RHLDporcentaje, 'none')#<cfelse>0.00</cfif>" tabindex="1">
					</td>
				</tr>
  ...
  <tr>
    <td>
		 <cfquery name="rsRHLiqDeduccionPrev" datasource="#session.DSN#">
			select	4 as paso, a.RHPLPid, a.DEid, 
			b.RHLPDid, b.Did, RHLDdescripcion as nombre, b.RHLDreferencia, b.SNcodigo, b.importe, 
