...
<cfif isdefined("Form.DLlinea") and Len(Trim(Form.DLlinea)) NEQ 0>
	<cfset navegacion = navegacion & Iif(Len(Trim(navegacion)) NEQ 0, DE("&"), DE("")) & "DLlinea=" & Form.DLlinea>
</cfif>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	<cfquery name="rsLista" datasource="#session.DSN#">
		...
		where lp.DLlinea = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.DLlinea#">
