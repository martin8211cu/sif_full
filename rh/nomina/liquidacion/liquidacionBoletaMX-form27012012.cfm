		...
		<tr>
			<td>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						<td align="justify" style="padding-right: 30px;" colspan="2">Recib&iacute; de <strong>#Session.Enombre#</strong> la cantidad de <strong>&nbsp;#rsEncabezado.Msimbolo#&nbsp;#fnFormatMoney(rsLF.RHLFLresultado)# (#MontoLetras# #rsEncabezado.Mnombre#)</strong>, por concepto de SUELDO, FINIQUITO Y LIQUIDACI&Oacute;N, manifestando que he venido laborando en forma ordinaria, precisamente hasta el d&iacute;a de hoy en que doy por terminada m&iacute; relaci&oacute;n de tabajo, y con motivo de la <strong>RENUNCIA</strong> voluntaria e irrevocable al puesto y trabajo que ven&iacute;a desempe&ntilde;ando, mencionando que a la fecha no se me adeuda cantidad alguna por conceptos de salarios devengados, vacaciones, prima vacacional, aguinaldo, tiempo extraordinario. reparto de utilidades, s&eacute;ptimos d&iacute;as, d&iacute;as de descanso obligatorio, ni por ninguna otra prestaci&oacute;n a la Ley Federal del Trabajo vigente o a m&iacute; contrato individual de trabajo, me pudiesen corresponder, si&eacute;ndome cubiertas las prestaciones que a continuaci&oacute; se precisan:</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
						<tr><td>&nbsp;</td></tr>
					...
					<tr><td colspan="2"><table width="70%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td>#rsEncabezado.Msimbolo#&nbsp;#fnFormatMoney(rsTotalPer.total+rsTotalOtros.total)#</td>
						</tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td colspan="2">
