<cfif not isdefined("Form.Nuevo")>
		 ...
		 <cfif isdefined("Form.Alta")>
		 	<cftransaction>
				<cfquery name="RHLiqIngresos" datasource="#session.DSN#">
					insert into RHLiqIngresos (DLlinea, DEid, CIid, Ecodigo, RHLPdescripcion, importe, BMUsucodigo, fechaalta, RHLIFiniquito)
					select 
						DLlinea,
						DEid,
				...
				<cfquery name="insert" datasource="#session.DSN#">
					insert into DDConceptosEmpleado (DLlinea, CIid, DDCimporte, DDCres, DDCcant, DDCcalculo, BMUsucodigo)
				...
				<cfinvoke component="rh.Componentes.RHLiquidacionMX" method="fnCalculaEG">
					<cfinvokeargument name="RHLPid" value="#RHLiqIngresos.identity#">
				</cfinvoke>
			</cftransaction>		
		...
		<cfelseif isdefined("Form.Baja")> 
			...
			<cfquery datasource="#Session.DSN#">
				delete from DDConceptosEmpleado
		...
		<cfelseif isdefined("Form.Cambio")>
 			<cftransaction>
				...
				<cfinvoke component="rh.Componentes.RHLiquidacionMX" method="fnCalculaEG">
					<cfinvokeargument name="RHLPid" value="#Form.RHLPid#">
				</cfinvoke>
			</cftransaction>
		<cfelseif isdefined("Form.Guardar")>
			<cftransaction >
				...
				<cfquery name="insert" datasource="#session.DSN#">
					insert into RHLiqIngresos (DLlinea, DEid, CIid, Ecodigo, RHLPdescripcion, importe, BMUsucodigo, fechaalta, cesantia, motivoliq, RHLIFiniquito)
					select DLlinea, DEid,
						<cfqueryparam cfsqltype="cf_sql_numeric" value="#form.CIid#">,
						Ecodigo,
			...
			<cfloop query="rsLiqIng">
				<cfinvoke component="rh.Componentes.RHLiquidacionMX" method="fnCalculaEG">
					<cfinvokeargument name="RHLPid" value="#rsLiqIng.rsLiqIng#">
				</cfinvoke>
			</cfloop>
