...
<cfif not isdefined("Form.Nuevo")>
	<cfif isdefined("Form.RHLCid") AND Len(Trim(Form.RHLCid)) GT 0>
		<cfset modo = "CAMBIO">
	<cfelse>
		<cfset modo = "ALTA">
	</cfif>
...
<cfif modo NEQ "ALTA">
	<cfquery name="rsRHLiqCargas" datasource="#Session.DSN#">
		select a.RHLCid, a.DLlinea, a.DEid, a.DClinea, a.SNcodigo, a.Ecodigo, a.RHLCdescripcion, 
		a.importe, a.fechaalta, a.RHLCautomatico, a.BMUsucodigo, a.ts_rversion
		from RHLiqCargas a
		where a.RHLCid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.RHLCid#">
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <td>
		<form action="#CurrentPage#" method="post" name="form1" onSubmit="javascript: return validaForm(this);">
			...
			<input name="DLlinea" type="hidden" value="#DLlinea#">
				...
				<input name="RHLCid" type="hidden" value="<cfif modo EQ "CAMBIO">#rsRHLiqCargas.RHLCid#</cfif>">
			
			<cfset ts = "">
			<cfif modo NEQ "ALTA">
				<cfinvoke component="sif.Componentes.DButils" method="toTimeStamp"returnvariable="ts">
					<cfinvokeargument name="arTimeStamp" value="#rsRHLiqCargas.ts_rversion#"/>
				</cfinvoke>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
			  <tr>
				...
				<td nowrap>
                  <input name="DCdescripcion" disabled type="text" value="<cfif modo NEQ "ALTA" >#rsRHLiqCargas.RHLCdescripcion#</cfif>" size="50" maxlength="50">
                  <cfif modo eq 'ALTA'>
				...
				<td id="TDValor" nowrap>
                  <input name="Ivalor" type="text" id="Ivalor" size="18" maxlength="15" onfocus="this.value=qf(this); this.select();" onblur="javascript: fm(this,2);"  onkeyup="if(snumber(this,event,2)){ if(Key(event)=='13') {this.blur();}}" style="text-align: right;" value="<cfif modo NEQ "ALTA" and isdefined("rsRHLiqCargas")>#LSCurrencyFormat(rsRHLiqCargas.importe, 'none')#<cfelse>0.00</cfif>" tabindex="1">
                </td>
			  </tr>
			  <tr>
				<td colspan="4">&nbsp;</td>
  ...
  <tr>
    <td>
		 <cfquery name="rsRHLiqCargas" datasource="#session.DSN#">
			select	2 as paso, a.DLlinea, a.DEid, 
