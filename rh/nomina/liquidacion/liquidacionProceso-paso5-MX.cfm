					...
					<table width="95%" border="0">
						<tr>
							<td width="183">
								...
								<cfquery name="rsSumRHLiqDeduccionISR" dbtype="query">
									select sum(importe) as totDeducISR
									from rsRHLiqDeduccion
									where RHLDid <> -1
								</cfquery>
								 <cfinvoke
...
--->				
					...
					<cfset totLiq = rsLF.RHLFLresultado  - rsSumRHLiqCargas.totCargas - (Trim(rsSumRHLiqDeduccion.totDeduc) eq '' ? 0 : rsSumRHLiqDeduccion.totDeduc)>
					<cfset totLiq = rsLF.RHLFLresultado - (Trim(rsSumRHLiqDeduccionISR.totDeducISR) eq '' ? 0 : rsSumRHLiqDeduccionISR.totDeducISR)>
