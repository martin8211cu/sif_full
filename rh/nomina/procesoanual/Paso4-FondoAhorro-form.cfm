...
<!---<cfif isdefined("url.RCNid") and isdefined("Form.RCNid") and len(trim(Form.RCNid)) EQ 0>
	<cfset url.Primera = 1>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;" align="center">
  ...
  <cfinclude template="../operacion/frame-SalarioEmpleado.cfm"><!--- Información Resumida --->
</table>
<br>
<form action="FondoAhorro-form.cfm?tab=4&Primera=1" method="post" name="form4a">
  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="sectionTitle" style="padding-left: 5px; padding-right: 5px;" align="center">
    <tr> 
    ...
    <cfinclude template="../operacion/frame-PagosEmpleado.cfm"></td>
    <!--- Salarios --->
    <tr valign="top"> 
      <td nowrap colspan="9">&nbsp;</td>
    </tr>
    <cfinclude template="../operacion/frame-IncidenciasCalculo.cfm"></td>
    <!--- Incidencias --->
    <tr valign="top"> 
      <td nowrap colspan="9">&nbsp;</td>
    </tr>
    <cfinclude template="../operacion/frame-CargasCalculo.cfm"></td>
    <!--- Cargas --->
    <tr valign="top"> 
      <td nowrap colspan="9">&nbsp;</td>
    </tr>
    <cfinclude template="../operacion/frame-DeduccionesCalculo.cfm"></td>
    <tr valign="top"> 
      <td nowrap colspan="9">&nbsp;</td>
    </tr>
      ...
      <tr valign="top"> 
        <td nowrap colspan="9" align="center">  
          <input name="txtEnterSI" type="text" size="1" maxlength="1" readonly="true" class="cajasinbordeb"> 
  		  <input type="submit" name="btnRegresar" value="#BTN_Regresar#">
        </td>
      </tr>
      <tr valign="top"> 
        <td nowrap colspan="8" align="center">
        	<input name="RHCFOAid" type="hidden" value="#RHCFOAid#" />
