...
<cf_dbtemp name="DatosEmpleado" returnvariable="DatosEmpleado">
        ...
        <cf_dbtempcol name="DEidentificacion" type="varchar(600)"    mandatory="no">
...
<cfinclude template="repPTU-rep.cfm">
	...
	<cffunction name="fnDiasPagar" access="public" output="true" returntype="numeric"  hint="Calculos de D�as a Pagar">
        ...
        <cfif rsLineaTiempo.recordcount gt 0>
		   ...
		   <cfif DateCompare(rsLineaTiempo.EVfantig, rsLineaTiempo.LTdesde, 'd') LTE 0>
			...
			<!--- Puede ser que se quieran los d�as n�mina pero tienen que confirmar los 360 d�as, en vez de los 365, se deja la prevista--->
			 <cfquery name="rsDiasNomina" datasource="#arguments.conexion#">
				...
				from HPagosEmpleado a
					...
					on b.RCNid = a.RCNid
				where b.RCdesde >= '#LSDateFormat(varFechaDesde)#'
					and b.RChasta <= '#LSDateFormat(varFechaHasta)#'
					and a.DEid = #arguments.DEid#
    ...
    <cffunction name="fnSueldoAnual" access="public" output="true" returntype="numeric"  hint="Calculos de D�as a Pagar">
		<cfargument name="DEid" type="numeric" required="yes" hint="ID del encabezado del PTU (tab1)">
