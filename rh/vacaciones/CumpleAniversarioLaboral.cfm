...
<cfinvoke Key="LB_ConsultaDeAniversarioLaboral" Default="Consulta de Aniversario Laboral" returnvariable="LB_ConsultaDeAniversarioLaboral" component="sif.Componentes.Translate" method="Translate"/>
<!--- VARIABLES DE TRADUCCION --->
<cf_templateheader title="#LB_RecursosHumanos#">
	...
	Motivo: Creacion del reporte  --->
		<cf_web_portlet_start skin="#Session.Preferences.Skin#" titulo="#LB_ConsultaDeAniversarioLaboral#">
			<cfset modulo = "pp">
			...
			<table width="100%" border="0" cellspacing="0">
			  ...
			  <tr>
				<td valign="top">
					<cfinclude template="CumpleAniversarioLaboral_form.cfm">
				</td>
			  </tr>
			</table>
		<cf_web_portlet_end>
