       ...
       <cfquery name="rsSumas" datasource="#arguments.conexion#">
        ...
        <cfquery datasource="#arguments.conexion#">
            ...
            set
                ...
                RHPTUEMExenta					= #rsUMA.Pvalor# * 10,
                RHPTUEMGravable					= ((#LvarDiasAPagar# * ((#LvarRHPTUEMonto# / 2) / #LvarTotalDiasLaborados#)) + (#LvarSueldoAnual# * ((#LvarRHPTUEMonto# / 2) / <cfif LvarTotalSueldoPagado eq 0>1<cfelse>#LvarTotalSueldoPagado#</cfif>))) - (#rsUMA.Pvalor# * 10)
            where RHPTUEid = #arguments.RHPTUEid#
            and DEid = #LvarDeid#
        </cfquery>
        </cfloop>
        ...
        <cfquery datasource="#arguments.conexion#">
        	update RHPTUEMpleados
            	set 
                    ...
                    RHPTUEMGravable = case when RHPTUEMTotalPTU > RHPTUEMExenta then RHPTUEMTotalPTU - RHPTUEMExenta else 5.00 <!---RHPTUEMGravable---> end
            from RHPTUEMpleados
            where RHPTUEid = #arguments.RHPTUEid#
        </cfquery>
