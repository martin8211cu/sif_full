...
<cfcomponent>
	<cffunction name="AddBitacoraSDI" access="public">
        ...
        <cfif isdefined('RHTcomportam') and RHTcomportam EQ 1>
        	<cfquery name="rsValidarBimestreAnterior" datasource="#session.DSN#">
        		select COUNT(1) as cantidad from RHHistoricoSDI
				where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Arguments.Ecodigo#">
					and Bimestrerige = <cfqueryparam cfsqltype="cf_sql_integer" value="#vBimestreRige#">
		...
		<cfquery name="rsInsert" datasource="#Arguments.DSN#">
			...
			values(
                ...
                <cfif Arguments.RHHfuente EQ 1> 1 <cfelse> 0 </cfif>
				)
		</cfquery>
		<cfreturn>
	</cffunction>
