<cfcomponent>
			...
			<cfquery name="rsMontos" datasource="#Arguments.Conexion#">
				...
				from RHLiqIngresosPrev a
					inner join CIncidentes b
						on b.CIid = a.CIid
				where RHPLPid = #Arguments.RHPLPid#
					and coalesce(RHLIFiniquito,0) = <cfif Arguments.Tipo eq 'F'> 1 <cfelseif Arguments.Tipo eq 'L'> 0 </cfif>
			</cfquery>
		</cfif>
		<cfreturn rsMontos>	
	</cffunction>
	...
	<cffunction name="fnEsFiniquito" access="public" returntype="boolean">
		...
		<cfquery name="rsEsFiniquito" datasource="#Arguments.Conexion#">
			...
			from RHLiqIngresosPrev
			where RHLPPid = #Arguments.RHLPid#
		</cfquery>
	...
	<cffunction name="getLiqIngresosPorDLlinea" returntype="query">
		...
		<cfquery name="rsLiqIng" datasource="#Arguments.Conexion#">
			...
			<cfif Isdefined('Arguments.RHLIFiniquito') and Arguments.RHLIFiniquito neq -1>
				and coalesce(RHLIFiniquito,0) = #Arguments.RHLIFiniquito#
			</cfif>
		</cfquery>		
		<cfreturn #rsLiqIng#>
	</cffunction>
	...
	<cffunction name="fnAltaLF" access="public" returntype="numeric">
		...
		<cfquery name="rsAltaFL" datasource="#Arguments.Conexion#">
			insert into RHLiqFLPrev (RHPLPid, DEid, RHLFLtGrabadoF, RHLFLtExentoF, RHLFLisptF, RHLFLISPTRealL, RHLFLinfonavit, RHLFLtotalL, RHLFLsalarioMensual,
	...
	<cffunction name="fnGetLF" access="public" returntype="query">
		...
		<cfquery name="rsAltaFL" datasource="#Arguments.Conexion#">
			select a.RHLFLid, a.RHPLPid, a.DEid, a.RHLFLtGrabadoF, a.RHLFLtExentoF, a.RHLFLisptF, a.RHLFLinfonavit, a.RHLFLtotalL, a.RHLFLsalarioMensual,
				a.RHLFLisptSalario, a.RHLFLisptL, a.RHLFLresultado, a.Ecodigo, a.BMUsucodigo, b.RHPLPfsalida,RHLFLISPTRealL
			from RHLiqFLPrev a
...
<!---		<cfset Neto = TotalRealF - ISPTF + MontoGrabadoL - ISPTL>--->
    ...
    <cffunction name="fnRetencionISPT" access="public" returntype="numeric">
		...
		<cfset Salario90dias = varUMA*90> <!---Obtiene el salario por noventa dias--->
           
        <cfquery name="rsDetalleRHLiquidacionPersonal" datasource="#session.DSN#">
			select RHPLPfingreso as EVfantig, RHPLPfsalida as DLfechaaplic
