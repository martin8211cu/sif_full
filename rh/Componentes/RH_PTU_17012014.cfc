           ...
           <!--- <cfthrow message= "#Arguments.validaTcodigo#">--->
            ...
            <cfquery datasource="#Arguments.conexion#" name = "Prueba">
            	insert into RHPTUEMpleados (
                        ...
                        RHPTUEMfecha, 
                        BMUsucodigo)
            		select a.DEid, c.RHPTUEid,a.Ecodigo, min(LTdesde) as FechaDesde, max(LThasta) as FechaHasta,
						d.Dcodigo, 
                        d.Ocodigo, 
                        d.RHPcodigo,
                        <cfqueryparam cfsqltype="cf_sql_date" value="#Now()#">,
       ...
       <cfquery name="rsSumas" datasource="#arguments.conexion#">
        ...
        <cfquery datasource="#arguments.conexion#">
            ...
            set 
                ...
                RHPTUEMCuotaDiaria				= <cfif #LvarSueldoAnual# GT #arguments.MontoMaximoNS#>
                ...
                RHPTUEMTotalPTU					= (#LvarDiasAPagar# * ((#LvarRHPTUEMonto# / 2) / #LvarTotalDiasLaborados#))
                									<cfif #LvarSueldoAnual# GT #arguments.MontoMaximoNS#>
                									+ (#arguments.MontoMaximoNS# * ((#LvarRHPTUEMonto# / 2) / <cfif LvarTotalSueldoPagado eq 0>1<cfelse>#LvarTotalSueldoPagado#</cfif>)),
                                                  <cfelseif #LvarSueldoAnual# LTE #arguments.MontoMaximoNS#>
                									 + (#LvarSueldoAnual# * ((#LvarRHPTUEMonto# / 2) / <cfif LvarTotalSueldoPagado eq 0>1<cfelse>#LvarTotalSueldoPagado#</cfif>)),
                                                   </cfif>
                ...
                RHPTUEMGravable					= ((#LvarDiasAPagar# * ((#LvarRHPTUEMonto# / 2) / #LvarTotalDiasLaborados#)) + (#LvarSueldoAnual# * ((#LvarRHPTUEMonto# / 2) / <cfif LvarTotalSueldoPagado eq 0>1<cfelse>#LvarTotalSueldoPagado#</cfif>))) - (#rsParamSalMin.Pvalor# * 15)
            where RHPTUEid = #arguments.RHPTUEid#
            and DEid = #LvarDeid#
        </cfquery>
        </cfloop>
        ...
        <cfquery datasource="#arguments.conexion#">
        	update RHPTUEMpleados
            	set RHPTUEMExenta = case when RHPTUEMTotalPTU >= RHPTUEMExenta then RHPTUEMExenta else RHPTUEMTotalPTU end, 
        ...
        <cfquery datasource="#arguments.conexion#">
        	update RHPTUEMpleados
            set RHPTUEMGravadaMensual = ((RHPTUEMGravable / 366) * 30.4),
            	RHPTUEMBaseGravable =  ((RHPTUEMGravable / 366) * 30.4) + RHPTUEMSueldoMensual
            where RHPTUEid = #arguments.RHPTUEid#
        </cfquery>
