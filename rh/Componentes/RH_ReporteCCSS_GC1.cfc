<!--- 	Migracion a ANSI SQL del procedimiento almacenado rh_ReporteCCSS_GC1.
			CREATE  proc rh_ReporteCCSS_GC1
...
--->
<cfcomponent>
	<cffunction name="rh_ReporteCCSS_GC1" access="public" returntype="query">
		...
		<cfif rs_oficina.recordcount gt 0 and rs_calendario.recordcount gt 0> <!--- if principal --->
			...
			<cfif arguments.masivo eq 0 >
				...
				<cfquery datasource="#arguments.conexion#">
					insert into #Salida1#( NUMPAT, cedula, Nombre, actual, anterior,  Mensaje )
