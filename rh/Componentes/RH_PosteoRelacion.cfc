<cfcomponent>
	<cffunction name="PosteoRelacion" access="public" output="true" returntype="numeric">
		...
		** en el cálculo de una relación de nómina. 
		...
		<cf_dbtemp name="ERNominav3" returnvariable="ERNomina" datasource="#Arguments.Conexion#">
		...
		<cf_dbtemp name="DRNominav3" returnvariable="DRNomina" datasource="#Arguments.Conexion#">
		...
		<!--- ALGUNAS VARIABLES --->
			...
			<cfif vERNid eq 0 >
				<cfthrow message="No pudo generar la Relación de Nómina.">
			</cfif>	
			...
			<cftransaction>
				...
				<cfquery datasource="#arguments.conexion#">
					...
					FROM DeduccionesCalculo b
                    	inner join DRNomina dn
                        	on dn.DEid = b.DEid 
				...
				<cfquery datasource="#arguments.conexion#">
					...
					FROM CargasCalculo b
                    	inner join DRNomina dn
                        	on dn.DEid = b.DEid
                        inner join DCargas a 
				...
				<cfquery datasource="#arguments.conexion#">
					...
					set CPfcalculo = <cf_dbfunction name="now">, 
