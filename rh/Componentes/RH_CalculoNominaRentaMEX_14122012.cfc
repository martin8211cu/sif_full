    ...
    <cffunction name="fnCalculaISPT" access="public" returntype="numeric">
      ...
      <!---  <cfquery datasource="#session.DSN#" name="upAguiMes">
		...
		<cfloop query="rsDatos">
			<cfset ISPT_AguiMenGra = fnCalculaISPT(rsDatos.AguiMenGra,Arguments.IRcodigo)> <!---SML. Modificacion para que considera la tabla de renta en la nomina de aguinaldo--->
			<cfset ISPT_SalarioM = fnCalculaISPT(rsDatos.SalarioM,Arguments.IRcodigo)> <!---SML. Modificacion para que considera la tabla de renta en la nomina de aguinaldo--->
