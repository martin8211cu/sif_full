	   ...
	   <cfdump var="#cantidad_horas#">   --->
		...
		<cfif rsSalBrutoRelacion.RecordCount NEQ 0>
			<cfif rsSalBrutoRelacion.Monto GT 0>
				<!---<cfset x= funcInsertaLinea(arguments.DEid,arguments.RCNid,'#rsSalBrutoRelacion.CSdescripcion#',cantidad+DiasNoLaborados,rsSalBrutoRelacion.Monto+MontoNoLaborados,VN_CUENTALINEAS,1,
											arguments.empleado,arguments.cuenta,arguments.etiquetacuenta,arguments.departamento,arguments.puntoventa,arguments.orden)>
--->
<!---				<cfset x= funcInsertaLinea(arguments.DEid,arguments.RCNid,'#rsSalBrutoRelacion.CSdescripcion#',0,rsSalBrutoRelacion.Monto+MontoNoLaborados,VN_CUENTALINEAS,1,
										arguments.empleado,arguments.cuenta,arguments.etiquetacuenta,arguments.departamento,arguments.puntoventa,arguments.orden)>											
--->
				<cfset x= funcInsertaLinea(arguments.DEid,arguments.RCNid,'#rsSalBrutoRelacion.CSdescripcion#',0,rsSalBrutoRelacion.Monto,VN_CUENTALINEAS,1,
										arguments.empleado,arguments.cuenta,arguments.etiquetacuenta,arguments.departamento,arguments.puntoventa,arguments.orden)>											
	...
	<cffunction name="funcFaltas">
		...
		<cfquery name="rsFaltas" datasource="#Session.DSN#">	
				select sum(PEcantdias * coalesce(RHTfactorfalta,1)) as PEcantdias, ((sum(Coalesce(PEsalarioref,0) / <cf_dbfunction name="to_number" args="Coalesce(c.FactorDiasSalario,'1')"> * PEcantdias))* coalesce(RHTfactorfalta,1)) as monto, d.RHTdesc
					from #pref#PagosEmpleado a
					 inner join #pref#RCalculoNomina b
						on a.RCNid = b.RCNid
					 inner join TiposNomina c
