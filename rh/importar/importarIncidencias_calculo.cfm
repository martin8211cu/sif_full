									...
									<cfif session.Incidencias.impcalculo><!---Si es importacion de incidencias tipo calculo--->											
											...
											<cftransaction>
												<cfquery datasource="#session.DSN#" name="rsInsert">
														insert into IMPIncidentes (DEid, CIid, CFid, FinicioNomina, Ifecha, Ivalor, Ifechasis, Usucodigo, Ulocalizacion, RCNid, Icpespecial, IfechaRebajo, RHJid,Iobservacion)
													...
													<cfloop list="#listaIdIncidencias#" index="Id">			<!--- recorre la lista de incidencias--->
															...
															<cfquery name="rsDatosConcepto" datasource="#Session.DSN#"><!---Obtener datos de la incidencia, requeridos por la calculadora--->
																	select 	b.CIrango,
																			...
																			b.CImes,
																			b.CIcalculo,
																			coalesce(FinicioNomina,c.Ifecha) as Finicio,
                                                                            c.Ifecha,
																...
																</cfif> Se comenta, porque el modo de actualizacion es incorrecto--->
																...
																<cfif rsDatosConcepto.RecordCount NEQ 0>		
																	...
																	<cfset presets_text = Calculadora.get_presets(LSParseDateTime(rsDatosConcepto.Finicio),<!---fecha1_accion--->
																	...
																	<cfset calc_error = Calculadora.getCalc_error()>
																	...
																	<!---
																		...
																		<cfdump  var="#values.get('resultado').toString()#" abort>
