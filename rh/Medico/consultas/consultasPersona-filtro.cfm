	...
	<cfinvoke component="sif.Componentes.Translate"
		method="Translate"
		Key="LB_Consultas_Medicas_por_Empleados"
		Default="Consultas M&eacute;dicas por Empleado"
			...
			<tr>
				<td valign="top">	
					<cf_web_portlet_start border="true" titulo="#LB_Titulo#" skin="#Session.Preferences.Skin#"> 
						<form name="form1" method="get" action="consultasPersona.cfm" style="margin:0;">
