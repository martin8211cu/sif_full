	...
	<cfinvoke component="sif.Componentes.Translate"
	method="Translate"
	Key="LB_Detalle_de_citas_por_persona"
	Default="Detalle de Citas por Colaborador"
	returnvariable="LB_Detalle_de_citas_por_persona"/>
...
<cf_templateheader title="#LB_RecursosHumanos#">
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr><td>
				<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="#LB_Detalle_de_citas_por_persona#">
					<cfoutput>
					<form name="form1" method="post" action="DetalleCitas.cfm" style="margin:0; ">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td width="50%" align="center" valign="top">
								<cf_web_portlet_start border="true" titulo="#LB_Detalle_de_citas_por_persona#" skin="info1">
									<table width="100%" align="center">
										<tr><td><p>
										<cf_translate  key="Ayuda_Reporte">
											En este reporte se puede consultar la citas de los colaborador
											un rango definido de fechas.
										</cf_translate>
										</p></td></tr>
									</table>
								<cf_web_portlet_end>
							...
							<td colspan="2" valign="top">
								<table width="90%" align="center" cellpadding="2" cellspacing="0">
									<tr>
										...
										<td>
											<cf_sifcalendario conexion="#session.DSN#" form="form1" name="desde" value="" tabindex="1">
										</td>
									</tr>
									<tr>
										<td width="10%" align="right" nowrap ><cf_translate key="LB_FechaHasta">Fecha hasta</cf_translate>:&nbsp;</td>
										<td>
											<cf_sifcalendario conexion="#session.DSN#" form="form1" name="hasta" value="" tabindex="1">
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td width="10%" align="right" nowrap ><cf_translate  key="LB_colaborador">Colaborador</cf_translate>:&nbsp;</td>
