	...
	<cfinvoke component="sif.Componentes.Translate"
		method="Translate"
		Key="LB_Diagnosticos_mas_frecuentes_por_Departamento"
		Default="Diagn&oacute;sticos m&aacute;s frecuentes por Departamento"
			...
			<tr>
				<td valign="top">	
					<cf_web_portlet_start border="true" titulo="#LB_Titulo#" skin="#Session.Preferences.Skin#"> 
						<form name="form1" method="get" action="diagnosticoDepartamento.cfm" style="margin:0;">
