	...
	<cftransaction>
		<cftry>
			...
			<cfquery datasource="#arguments.conexionD#" name="x">
				insert into DVacacionesEmpleado(Ecodigo,DEid,#campos#)
					Select #EcodigoNuevo#, c.DEid, #Scampos#
						From #TablaOrigen# a, #PadreOrigen# b, #PadreDestino# c
							Where a.DEid = b.DEid
								...
								and c.DEid not in (select a.DEid from DVacacionesEmpleado a, DatosEmpleado b
														where b.Ecodigo = #EcodigoNuevo#
														and a.DEid = b.DEid)
			</cfquery>
			<!---<cf_dump var="#x#">--->
...
<cfelse>
	<cfquery datasource="#arguments.conexionD#" name="x">
		Select #EcodigoNuevo# as Ecodigo, c.DEid, #Scampos#
			From #TablaOrigen# a, #PadreOrigen# b, #PadreDestino# c
				Where a.DEid = b.DEid
					and b.Ecodigo			=	#EcodigoViejo#
					and b.DEidentificacion	=	c.DEidentificacion
	...
	<cfloop query="x">
		...
		<cfset sql_insert = "insert into #arguments.Tabla#(Ecodigo,DEid,#campos#) values (#x.Ecodigo#, #x.DEid#, #insert_campos#">
	...
	<cfset txtfile = #LvarDir#&'046-DVacacionesEmpleado.txt'>
	<cffile action="write" nameconflict="overwrite" file="#txtfile#" output="#hilera#" charset="utf-8">

	<cfset session.LvarFiles = session.LvarFiles & '046-DVacacionesEmpleado.txt,'>
