	...
	<cftransaction>
		<cftry>
			<cfquery datasource="#arguments.conexionD#" name="x">
				insert into EVacacionesEmpleado(DEid,#campos#)
					Select c.DEid, #Scampos#
						From #TablaOrigen# a, #PadreOrigen# b, #PadreDestino# c
							Where a.DEid = b.DEid
								...
								and c.DEid not in (select a.DEid from EVacacionesEmpleado a, DatosEmpleado b
...
<cfelse>
	...
	<cfset txtfile = #LvarDir#&'045-EVacacionesEmpleado.txt'>
	<cffile action="write" nameconflict="overwrite" file="#txtfile#" output="#hilera#" charset="utf-8">

	<cfset session.LvarFiles = session.LvarFiles & '045-EVacacionesEmpleado.txt,'>
