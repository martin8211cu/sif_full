...
<body>
  ...
  <cfif rsDatosfac.TipoPagoSAT EQ 2 or rsDatosfac.TipoPagoSAT EQ 3>			  
	  <cfset varCuentaPago = #rsDatosfac.Cta_tipoPago#>
  <cfelse>
    <cfset varCuentaPago = ''>
  </cfif>
  ...
  <cfdocument format="PDF" filename="c:/enviar/#Session.FileCEmpresa#/#Session.Ecodigo#/#rsDatosfac.fac#.pdf" overwrite="true">  
    <cfoutput>
    <table border="0">
      <table border="0" cellspacing="0" cellpadding="0" class="areaFiltro" width="100%" style="font-family:'Garamond';">
        <tr>
          <td width="35%">
                <!--- DATOS EMPRESA --->
            <table border="0" cellspacing="0" cellpadding="0" class="areaFiltro" width="100%"  style="font-size:12px">
              <tr>
                <td width="300" height="65" valign="top" class="logoTop" >
                  <cfimage action="writeToBrowser" source="#logo.Elogo#" width="100%">
                </td>            
              </tr>
              ...
              <cfif rsValFiscE.DirecFisc EQ 1>
                <tr><td align = "left"><strong>#rsDatosEmpresa.Calle# #rsDatosEmpresa.NumExt# #rsDatosEmpresa.NumInt#</strong></td></tr>
                <tr><td align = "left"><strong>#rsDatosEmpresa.Colonia# #rsDatosEmpresa.Localidad#</strong></td></tr>
                <tr><td align = "left"><strong>#rsDatosEmpresa.Delegacion# </strong></td></tr>
                <cfif isDefined('rsDatosEmpresa.Referencia') and len('rsDatosEmpresa.Referencia')>
                  <tr><td align = "left"><strong>#rsDatosEmpresa.Referencia#</strong></td></tr>
                </cfif>
                <tr><td align = "left"><strong>C.P. #rsDatosEmpresa.codPostal# #rsDatosEmpresa.Estado# #rsDatosEmpresa.Pais#</strong></td></tr>
              <cfelse>
                <tr><td align = "left"><strong>#rsDatosEmpresa.direccion1#</strong></td></tr>
                <tr><td align = "left"><strong>#rsDatosEmpresa.direccion2#</strong></td></tr>  
                <tr><td align = "left"><strong>#rsdatosfac.dir#</strong></td></tr>     
              </cfif>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="areaFiltro" width="100%" >
        ...
        <tr>
        	<td>
            <!--- CLIENTE --->
            <table border="1" cellspacing="0" cellpadding="0"  width="99%" style="font-size:12px">
              <tr>
              ...
              <tr>
                ...
                <cfelse>
                  <td align = "left" >
                    #rsDatosfac.sndireccion# #rsDatosfac.sndireccion2#
                    <br>
                    #rsDatosfac.dir#
                  </td>
                </cfif>
        ...
        <tr>
          <td>
            ...
            <table border="1" cellspacing="0" cellpadding="2" class="areaFiltro"  style="font-size:12px" width="99%">
              <tr>
              ...
              <tr>
               <!--- <td align = "center" width="20%" ><strong>#Trim(rsDatosfac.nombre_tipopago)#</strong></td>--->
			    <td align = "center" width="20%" ><strong>#Trim(lVarTipoPago)#</strong></td>
                <td align = "center" width="20%" ><strong>#Trim(varCuentaPago)#</strong></td>
        ...
        <tr>
          <td>
            <table border="1" cellspacing="0" cellpadding="2" class="areaFiltro" font style="font-size:12px" width="99%">
              <tr>
        ...
        <tr>
          <td>
            <table border="1" cellspacing="0" cellpadding="2" class="areaFiltro" width="99%">
              <tr>
                <td align = "left" style="font-size:12px"><strong>Observaciones: #rsdatosfac.observaciones# #rsdatosfac.OIObservacion# </strong></td>
              </tr> 
            </table>
          </td>
        </tr>
                ...
                <td width="77%">
                  ...
                  <table border="0"  width="99%"  style="font-size:10px">
                    ...
                    <cfloop condition="renglon LE #LEN(rsdatosfac.cadenaSAT)#">
                      ...
                      <tr>                    
                        <td><strong style="font-family: 'Courier New'; font-size:8px;">#Mid(rsdatosfac.cadenaSAT,renglon_ini,100)#</strong></td>
                      </tr>
                    ...
                    <cfloop condition="renglon LE #LEN(rsdatosfac.sello)#">
                      <cfset renglon = #renglon#+100>
                      <tr>                   
                        <td><strong style="font-family: 'Courier New'; font-size:8px;">#Mid(rsdatosfac.sello,renglon_ini,100)#</strong></td>
                      </tr>
                      <cfset renglon_ini = #renglon#+1>
                    </cfloop>
                    <tr>
                    ...
                    <cfloop condition="renglon LE #LEN(rsdatosfac.selloSAT)#">
                      <cfset renglon = #renglon#+100>
                      <tr>                    
                        <td><strong style="font-family: 'Courier New'; font-size:8px;">#Mid(rsdatosfac.selloSAT,renglon_ini,100)#</strong></td>
                      </tr>
                      <cfset renglon_ini = #renglon#+1>
                    </cfloop>
                  </table>
...
<cfif trim(#rsDatosfac.Cta_tipoPago#) NEQ 'No identificado'>
  <cfset varCuentaPago = #rsDatosfac.Cta_tipoPago#>
<cfelse>
    <cfset varCuentaPago = ''>
</cfif>
...
HelveticaSemiSmall= Font.init(Font.HELVETICA, 7.0);
...
if (rsValFiscE.DirecFisc == 1){
  paragraph.init("#rsDatosEmpresa.Calle# #rsDatosEmpresa.NumExt# #rsDatosEmpresa.NumInt#", HelveticaSemiSmall);
  combParagraph.add(paragraph);

  paragraph.init("#rsDatosEmpresa.Colonia# #rsDatosEmpresa.Localidad#", HelveticaSemiSmall);
  combParagraph.add(paragraph);

  paragraph.init("#rsDatosEmpresa.Delegacion#", HelveticaSemiSmall);
  combParagraph.add(paragraph);

  if( len(trim(rsDatosEmpresa.Referencia))){
    paragraph.init("#rsDatosEmpresa.Referencia#", HelveticaSemiSmall);
    combParagraph.add(paragraph);
  }
  paragraph.init("C.P. #rsDatosEmpresa.codPostal# #rsDatosEmpresa.Estado# #rsDatosEmpresa.Pais#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
}else{
  paragraph.init("#rsDatosEmpresa.direccion1#", HelveticaSemiSmall);
  combParagraph.add(paragraph);

  paragraph.init(#rsDatosEmpresa.direccion2#, HelveticaSemiSmall);
  combParagraph.add(paragraph);

  paragraph.init("C.P. #rsDatosEmpresa.codpostal# #rsDatosEmpresa.ciudad# #rsDatosEmpresa.estado#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
}
...
combParagraph.add(paragraph);
if (rsValFiscE.DirecFisc == 1){
  paragraph.init("#rsDomFiscCliente.Calle# #rsDomFiscCliente.NumExt# #rsDomFiscCliente.NumInt#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
  paragraph.init("#rsDomFiscCliente.Colonia# #rsDomFiscCliente.Localidad#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
  paragraph.init("#rsDomFiscCliente.Delegacion#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
  if( len(trim(rsDomFiscCliente.Referencia))){
    paragraph.init("#rsDomFiscCliente.Referencia#", HelveticaSemiSmall);
    combParagraph.add(paragraph);
  }
  paragraph.init("C.P. #rsDomFiscCliente.codPostal# #rsDomFiscCliente.Estado# #rsDomFiscCliente.Pais#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
}else{
  paragraph.init("#rsDatosfac.sndireccion# #rsDatosfac.sndireccion2#", HelveticaSemiSmall);
  combParagraph.add(paragraph);
  paragraph.init(#rsDatosfac.dir#, HelveticaSemiSmall);
  combParagraph.add(paragraph);
}
...
paragraph.init("Método de Pago: #rsDatosfac.nombre_TipoPago# #varCuentaPago#", HelveticaNormalB);
  cell = PdfPCell.init( paragraph );
  //cell.setColspan( javacast("int", 2) );
  cell.setHorizontalAlignment(Element.ALIGN_CENTER);
  tableSB.addCell( cell );
...
document.close();
   ...
   <cfset archivo = "C:/enviar/#Session.FileCEmpresa#/#Session.Ecodigo#/#rsDatosfac.fac#.xml">           
			
	<cfif #rsDatosfac.snemail# neq "">
			<CFMAIL TO="#rsDatosfac.snemail#"  CC="facturacion@aph.mx" BCC="irodriguez@aph.mx"
           	 FROM="facturacion@aph.mx"
		     type="text"
			 SUBJECT="Factura Electronica #rsDatosfac.fac#">
			 <cfmailparam file="C:\enviar\#Session.FileCEmpresa#\#Session.Ecodigo#\#rsDatosfac.fac#T.xml">
			 <cfmailparam file="C:\enviar\#Session.FileCEmpresa#\#Session.Ecodigo#\#rsDatosfac.fac#.pdf">
