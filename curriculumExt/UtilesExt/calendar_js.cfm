...
"';if (window.opener.funcFecha) {window.opener.funcFecha('" +this.gReturnItem + "')};window.close();\">" + 
...
"onClick=\"self.opener." + this.gReturnItem + ".value='" + 
this.format_data(vDay) + 
"';if (self.opener.funcFecha) {self.opener.funcFecha('" +this.gReturnItem + "')};window.close();\">" + 
this.format_day(vDay) + 
"</A>" + 
"</FONT></TD>";
vDay=vDay + 1;
