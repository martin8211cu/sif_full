...
<cfoutput>
  <table border="0" cellpadding="4" cellspacing="0" style="border:2px solid ##999999; ">
    ...
    <tr>
     ...
     <tr>
    <td><span class="style8"></span></td>
    <td><span class="style7">antes de acceder a la aplicaci&oacute;n, es necesario autorizar el usuario. <a href="http://#hostname#/cfmx/curriculumExt/index.cfm?authentication=#authentication#">http://#hostname#/cfmx/curriculumExt/index.cfm?authentication=#authentication#</a> </span></td>
  </tr> 	
    <tr>
      <td><span class="style8"></span></td>
      <td><span class="style8"></span></td>
