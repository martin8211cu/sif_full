<!---
	...
	<cf_dbfunctionExt name="OP_concat"	args=""  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="concat"	args="hilera1,hilera2,'hilera3','hilera4'"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_char"	args="hilera"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="length"	args="hilera"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="sPart"		args="hilera_principal,inicio,tamaño"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="sReplace"	args="hilera_principal,hilera_a_buscar,hilera_a_cambiar"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="sRepeat"	args="hilera_a_repetir,cantidad"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="sFind"		args="hilera_principal,hilera_a_buscar [,posicion_inicial=1]"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	...
	<cf_dbfunctionExt name="to_integer"	args="HileraConNumeros_o_Numero"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_number"		args="HileraConNumeros_o_Numero [,decimales_a_truncar=0]"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_float"		args="HileraConNumeros_o_Numero [,decimales_a_redondear=10]"  [datasource="<dsn>"] [returnvariable="<variable>"] >

	<cf_dbfunctionExt name="to_char_integer"	args="HileraConNumeros_o_Numero"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_char_float"		args="HileraConNumeros_o_Numero [,decimales_a_truncar=0]"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_char_money"		args="HileraConNumeros_o_Numero"  [datasource="<dsn>"] [returnvariable="<variable>"] >

	<cf_dbfunctionExt name="mod"				args="Divisor,Dividiendo"  [datasource="<dsn>"] [returnvariable="<variable>"] >
		Divisor y Dividiendo son CAMPOS o CONSTANTES numéricas.
		
	<!--- Funciones especiales para condiciones: where, when, having --->

	<cf_dbfunctionExt name="findoneof"			args="Hilera_principal,Caracteres_a_buscar_sin_apostrofes"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	...
	<cf_dbfunctionExt name="now"		args=""  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="today"		args=""  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="date_part"	args="parte_Fecha_sin_apostrofes, Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_date00"	args="Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
		to_date00 = to_datechar = elimina la hora de un dato fecha
		
	<!--- De hilera_a_DD/MM/YYYY a Fecha --->
	<cf_dbfunctionExt name="to_date"		args="FechaDMY"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_datetime"	args="FechaDMY"  [datasource="<dsn>"] [returnvariable="<variable>"] >

	<!--- De Fecha a Hilera --->
	<cf_dbfunctionExt name="date_format"	args="Fecha,formato_sin_apostrofes"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_sdate"		args="Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_sdateDMY"	args="Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="to_chartime"	args="Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >

	<!--- Sumas a fecha --->
	<cf_dbfunctionExt name="dateadd"		args="cantidad, Fecha [, parte_Fecha_sin_apostrofes_deCantidad=DD]"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="dateaddx"		args="parte_Fecha_sin_apostrofes, cantidad, Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="dateaddm"		args="cantidad_meses, Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="timeadd"		args="cantidad_segundos, Fecha"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="dateaddString"	args="cantidad_dias, Hilera_FechaDMY_sin_apostrofes"  [datasource="<dsn>"] [returnvariable="<variable>"] >

	<!--- Diferencia de fechas --->
	<cf_dbfunctionExt name="datediff"			args="FechaInicial, FechaFinal [,parte_Fecha_sin_apostrofes_deResultado=DD]"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="datediffstring"	args="Hilera_FechaDMY_sin_apostrofes_INICIAL, Hilera_FechaDMY_sin_apostrofes_FINAL"  [datasource="<dsn>"] [returnvariable="<variable>"] >
	<cf_dbfunctionExt name="timediff"			args="FechaInicial, FechaFinal"  [datasource="<dsn>"] [returnvariable="<variable>"] >
...
<cfset LvarDBtype		= Application.dsinfo.type>
...
<cffunction name="fnDbFunction" returntype="string">
	...
	<!--- Funciones de Hileras --->
	<cfset valid_functions = valid_functions & "op_concat,concat,to_char,length,">
	...
	<cfif ListFind(valid_functions, Attributes.name) Is 0>
		<cfthrow message="cf_dbfunctionExt: funcion '#Attributes.name#' inválida. Las funciones válidas son: #valid_functions#">
	</cfif>
	...
	<cfif ListFind('sybase,sqlserver', LvarDBtype)>
		...
		<cfelseif Attributes.name is 'concat' >
			<cfif ListLen(Attributes.args, Attributes.delimiters) LT 2>
				<cfthrow message="Argumentos incorrectos: por lo menos 2 hileras">
			<cfelse>
		...
		<cfelseif Attributes.name is 'mod'>
			<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 2>
				<cfthrow message="Argumentos incorrectos: se requieren dos argumentos">
			<cfelse>
		...
		<cfelseif Attributes.name is 'findOneOf'>
			<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 2>
				<cfthrow message="Argumentos incorrectos">
			<cfelse>
		...
		<cfelse>
			<cfthrow message="Nombre de dbfunctionExt invalido: #Attributes.name#">
		</cfif>
<!---*****************--->
<!---***** ORACLE ****--->	
<!---*****************--->
	...
	<cfelseif LvarDBtype is 'oracle'>
		...
		<cfelseif Attributes.name is 'to_char_float'>
			<cfreturn "trim(to_char(TRUNC(#Attributes.args#,6), '999999999999999990.999999'))">
		<cfelseif Attributes.name is 'to_char_currency'>
	...
	<cfelseif LvarDBtype is 'db2'>
		<cfset LvarASP = ucase(application.dsinfo.asp.SCHEMA)>
		<cfset OP_CONCAT = " || ">
		<cfif ListFind(date_functions, Attributes.name)>
			<cfreturn fnDateFunctions()>
		<cfelseif Attributes.name is 'to_char'>
			<cfreturn "RTRIM(CAST(#Attributes.args# AS CHAR(254)))">
		<cfelseif Attributes.name is 'op_concat'>
			<cfreturn OP_CONCAT>
		<cfelseif Attributes.name is 'concat' >
			<cfif ListLen(Attributes.args, Attributes.delimiters) LT 2>
		...
		<cfelseif Attributes.name is 'to_char_integer'>
			<cfreturn "#LvarASP#.TO_CHAR(#Attributes.args#,'999999999999999990')">
		<cfelseif Attributes.name is 'to_char_float'>
			<cfreturn "#LvarASP#.TO_CHAR(#Attributes.args#, '999999999999999990.999999')">
		<cfelseif Attributes.name is 'to_char_currency'>
			<cfreturn "#LvarASP#.TO_CHAR(#Attributes.args#, '9,999,999,999,999,990.99')">
	...
	<cfelse>
		<cfthrow message="Tipo de base de datos desconocido para cf_dbfunctionExt: #LvarDBtype#">
	</cfif>
</cffunction>
...
<cffunction name="fnDateFunctions" returntype="string">
	...
	<cfelseif Attributes.name is 'dateadd'>
		...
		<cfelseif ListLen(Attributes.args, Attributes.delimiters) EQ 3 OR ListLen(Attributes.args, Attributes.delimiters) EQ 4>
			...
			<cfreturn fnDateadd(#LvarDPart#, #LvarNumero#, #LvarFecha#)>
		<cfelse>
			<cfthrow message="Argumentos incorrectos: args='numero, fecha [, datePart]'">
		</cfif>
	 <cfelseif Attributes.name is 'dateaddm'>
		<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 2>
			<cfthrow message="Argumentos incorrectos: args='meses, fecha'">
		<cfelse>
			<cfset LvarDPart	= "mm">
			<cfset LvarNumero	= trim(ListGetAt(Attributes.args, 1, Attributes.delimiters))>
			<cfset LvarFecha	= fnGetDate(ListGetAt(Attributes.args, 2, Attributes.delimiters))>
	...
	<cfelseif Attributes.name is 'dateaddx'>
		<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 3>
			<cfthrow message="Argumentos incorrectos: args='tipo, numero_de_tipo, fecha'">
		<cfelse>
			<cfset LvarDPart	= trim(ListGetAt(Attributes.args, 1, Attributes.delimiters))>
	...
	<cfelseif Attributes.name is 'timeadd'>
		<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 2>
			<cfthrow message="Argumentos incorrectos: args='segundos, fecha'">
		<cfelse>
			<cfset LvarDPart	= "ss">
			<cfset LvarNumero	= trim(ListGetAt(Attributes.args, 1, Attributes.delimiters))>
			<cfset LvarFecha	= fnGetDate(ListGetAt(Attributes.args, 2, Attributes.delimiters))>
	...
	<cfelseif Attributes.name is 'dateaddstring'>
		<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 2>
			<cfthrow message="Argumentos incorrectos: args='dias, hileraFechaSinApostrofes'">
		<cfelse>
			<cfset LvarDPart	= "dd">
			<cfset LvarNumero	= trim(ListGetAt(Attributes.args, 1, Attributes.delimiters))>
			<cfset LvarFecha	= fnGetDate("'#ListGetAt(Attributes.args, 2, Attributes.delimiters)#'")>
	...
	<cfelseif Attributes.name is 'datedifftot' >
		<cfif ListLen(Attributes.args, Attributes.delimiters) NEQ 3>
			<cfthrow message="Argumentos incorrectos: args='dateIni, dateFin , datePart'">
		</cfif>
		<cfset LvarDPart = trim(lcase(ListGetAt(Attributes.args,3,Attributes.delimiters)))>
		...
		<cfelseif ListLen(Attributes.args, Attributes.delimiters) EQ 3 OR ListLen(Attributes.args, Attributes.delimiters) EQ 4>
			...
			<cfif ListLen(Attributes.args, Attributes.delimiters) EQ 4>
				...
				<cfif NOT isboolean(LvarTS)>
					<cfthrow message="Argumento oracleTimestamp debe ser true o false: args='dateIni, dateFin [, datePart]'">
				</cfif>
			</cfif>
			...
			<cfreturn fnDatediff (LvarDPart, LvarFechaIni, LvarFechaFin)>
		<cfelse>
			<cfthrow message="Argumentos incorrectos: args='dateIni, dateFin [, datePart=dd [, oracleTimestamp=false]]'">
		</cfif>
	<cfelseif Attributes.name is 'datediffstring'>
		<cfif ListLen(Attributes.args, Attributes.delimiters) EQ 2 OR ListLen(Attributes.args, Attributes.delimiters) EQ 3>
			<cfif ListLen(Attributes.args, Attributes.delimiters) EQ 3>
				...
				<cfif NOT isboolean(LvarTS)>
					<cfthrow message="Argumento oracleTimestamp debe ser true o false: args='dateIni, dateFin, oracleTimestamp'">
				</cfif>
			</cfif>
			<cfset LvarDPart	= "dd">
			<cfset LvarSinHora = (LvarDBtype EQ 'oracle')>
			...
			<cfreturn fnDatediff (LvarDPart, LvarFechaIni, LvarFechaFin)>
		<cfelse>
			<cfthrow message="Argumentos incorrectos: args='dateIni, dateFin [, oracleTimestamp=false]'">
		</cfif>
...
<cffunction name="fnFechaSinHora" returntype="string" access="private">
	...
	<cfelse>
		...
		<cfelseif LvarDBtype EQ 'db2'>
			<cfreturn "(#LvarFecha# - hour(#LvarFecha#) HOURS - minute(#LvarFecha#) MINUTES - second(#LvarFecha#) SECONDS)">
		</cfif>
	</cfif>
</cffunction>
...
<cffunction name="fnDateAdd" returntype="string">
	...
	<cfif ListFind('sybase,sqlserver', LvarDBtype)>
		<cfif NOT listFind("yy,mm,wk,dd,hh,mi,ss,ms",Arguments.DPart)>
			<cfthrow message="Argumentos incorrectos: solo se permite en datepart: yy,mm,wk,dd,hh,mi,ss,ms">
		</cfif>
...
<cffunction name="fnDMYtoDate" returntype="string">
	...
	<cfif mid(LvarFecha,1,1) EQ "'">
		<cfif right(LvarFecha,1) NEQ "'">
			<cfthrow message="La constante fecha no está delimitada por apóstrofes: #LvarFecha#">
		</cfif>
	...
	<cfelseif mid(LvarFecha,1,1) EQ "{">
		<cfif right(LvarFecha,1) NEQ "}">
			<cfthrow message="La constante fecha JDBC no está delimitada por llaves: #LvarFecha#">
		</cfif>
		<cfif left(LvarFecha,4) NEQ "{d '" and left(LvarFecha,5) NEQ "{ts '">
			<cfthrow message="La constante fecha JDBC solo se puede definir como {d } o {ts }: #LvarFecha#">
		</cfif>
...
<cffunction name="fnDateFormat" returntype="string" output="false">
	...
	<cfloop condition="LvarPto LTE len(formato)">
		...
		<cfelseif mid(Arguments.formato,LvarPto,1) EQ " ">
			...
			<cfset LvarPto=LvarPto + 1>
		<cfelse>
			<cfthrow message="Formato de fecha incorrecto: '#mid(Arguments.formato,LvarPto,2)#'">
		</cfif>
	</cfloop>
...
<cffunction name="fnDatePart" returntype="string">
	...
	<cfif ListFind('sybase,sqlserver', LvarDBtype)>
		<cfswitch expression="#UCase(Arguments.part)#">
			...
			<cfdefaultcase>
				<cfthrow message="datepart inválida para dbfunctionExt: '#Arguments.part#'">
			</cfdefaultcase>
		</cfswitch>
	<cfelseif LvarDBtype is 'oracle'>
		<cfswitch expression="#UCase(Arguments.part)#">
...
<cffunction name="fnToday" access="public" output="no">
	...
	<cfelseif LvarDBtype EQ "oracle">
		<cfreturn "TO_DATE(CURRENT_DATE)">
	<cfelseif LvarDBtype EQ "db2">
		<cfreturn "CURRENT DATE">
	</cfif>
</cffunction>
