...
<cfset LvarDSNs = arrayNew(2)>
	...
	<cfset LvarDSNs[3][1] = "ORACLE"> 	<cfset LvarDSNs[3][2] = "asp_oracle">	<cfset LvarDSNs[3][3] = "">
	<cfset LvarDSNs[4][1] = "DB2"> 		<cfset LvarDSNs[4][2] = "asp_db2">		<cfset LvarDSNs[4][3] = "">
...
<cfset x("date_Part", "ssSS,#LvarFechaIni#")>
...
<cffunction name="x" output="yes">
    ...
    <tr><td nowrap>
    &LTcf_dbfunctionExt name="#Arguments.Name#"<BR>args="#Arguments.Args#"<cfif Arguments.Del NEQ ","> delimiters="#Arguments.del#"</cfif><cfif Arguments.Dec NEQ ""> dec="#Arguments.dec#"</cfif>&GT
			<BR>
	...
	<cfloop from="1" to="#arraylen(LvarDSNs)#" index="i">
		...
		<cfif find(LvarNow1,Arguments.args)>
			<cftry>
				<cf_dbfunctionExt name="now" args="" datasource="#LvarDSNs[i][2]#" returnvariable="LvarNow">
		...
		<cftry>
			<cf_dbfunctionExt name="#Arguments.Name#" args="#Arguments.Args#" dec="#Arguments.Dec#" datasource="#LvarDSNs[i][2]#" returnvariable="LvarDBfunction" delimiters="#Arguments.del#">
		...
		<cftry>
			...
			<cfquery name="rsSQL" datasource="#LvarDSNs[i][2]#">
				...
				select case when <cf_dbfunctionExt name="#Arguments.Name#" args="#Arguments.Args#" datasource="#LvarDSNs[i][2]#" delimiters="#Arguments.del#"> then 'OK'
							else 'NO TA' end as X
				<cfelseif Arguments.Name EQ "OP_concat">
				select 'HO' <cf_dbfunctionExt name="#Arguments.Name#" datasource="#LvarDSNs[i][2]#"> 'LA' as X
				<cfelse>
