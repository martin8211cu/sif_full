...
<cfparam name="Attributes.ruta" default="/UtilesExt/sifleerimagencont2.cfm"  type="string">
<!--- <cfparam name="Attributes.ruta" default="/UtilesExt/sifleerimagencont.cfm"  type="string"> --->

<cf_dump var="#gettempdirectory()#">
