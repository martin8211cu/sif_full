...
function doConlisPistas<cfoutput>#Attributes.Codigo_pista#</cfoutput>() {
	...
	popUpWindow("/UtilesExt/ConlisPistas.cfm"+params,250,200,650,400);
}
...
function TraePista<cfoutput>#Attributes.Codigo_pista#</cfoutput>(valor) {
	...
	if (valor!="") {
		document.all["<cfoutput>#Attributes.frame#</cfoutput>"].src="/UtilesExt/sifPistasquery.cfm?valor="+valor+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
	}
	else{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="98%" nowrap>
			<a href="##" tabindex="-1"><img id="Almimagen" src="/imagenes/Description.gif" alt="Lista de Almac&eacute;nes" name="Almimagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisPistas#Attributes.Codigo_pista#();'></a>
