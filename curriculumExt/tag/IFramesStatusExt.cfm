...
<cfif NOT listFind("initform,jsappend,jsiframeend", Attributes.action)>
	<cfthrow message="ERROR EN LA DEFINICION DEL CF_IFramesStatus: El atributo ACTION unicamente puede tener los valores: intiForm,jsAppend,jsIFrameEnd">
</cfif>
<cfif Attributes.action EQ "jsappend" AND Attributes.Campo EQ "">
	<cfthrow message="ERROR EN LA DEFINICION DEL CF_IFramesStatus: El Action='jsAppend' requiere el atributo campo='NOMBRE_CAMPO'">
</cfif>
</cfsilent>
<cfif Attributes.action EQ "initform">
	...
	<cfif not isdefined("request.scriptOnEnterKeyDefinition")><cf_onEnterKeyExt></cfif>
	</cfoutput>
<cfelseif Attributes.action EQ "jsappend">
	<cfsilent>
	<cfif not isdefined("request.IFramesStatus.#Attributes.form#")>
		<cfthrow message="ERROR EN LA DEFINICION DEL CF_IFrameStatus: No se ha inicializado el form='#Attributes.form#' con Action='intiForm'">
	</cfif>
	</cfsilent>
	<cfoutput>
...
<cfelseif Attributes.action EQ "jsiframeend">
	<cfif NOT isdefined("url.CampoOnTrae")>
		<cfthrow message="ERROR EN LA DEFINICION DEL CF_IFramesStatus: No se invocó el IFrame con el parametro URL: CampoOnTrae='CAMPO'">
	</cfif>
	<cfoutput>
