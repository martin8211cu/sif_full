...
<cfparam name="Attributes.onBlur" default="" type="string"> <!--- funcin en el evento onBlur --->
<cfparam name="Attributes.onChange" default="" type="string"> <!--- funcin en el evento onChange --->
<cfparam name="Attributes.formato" default="dd/mm/yyyy" type="string"> <!--- funcin en el evento onBlur --->
	...
	<tr valign="#Attributes.valign#"> 
      <td nowrap valign="#Attributes.valign#">
		...
		<input 
			...
			id="#Attributes.name#"  style="font-size:10px" tabindex="1"
			...
			<a href="##" tabindex="-1"> <img  id="#Attributes.name#IMG" src="DATE_D.gif" alt="Calendario" name="Calendar#Attributes.name#" width="16" height="14" border="0" onClick="javascript: showCalendar('document.#Attributes.form#.#Evaluate('Attributes.name')#');"></a>
			</cfif> ---> <font  style="font-size:10px">(DD/MM/AAAA)</font>
			<script language="JavaScript1.2">
