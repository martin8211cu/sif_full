...
<TABLE width="#Attributes.fontSize*16+2#" border="0" cellspacing="0" class="calndr_style" callpadding="2">
...
<TR>
  <TD colspan="7" class="calndr_navbtn">    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="31%" align="left"><input name="calformyr#Request.calendarid#" id="calformyr#Request.calendarid#" type="text" class="calndr_font" style="width:50px" value="2004" size="5" maxlength="4" onKeyUp="calndr_set(#Request.calendarid#)" onChange="calndr_set(#Request.calendarid#)" ></td>
...
<TD width="15%" align="center" style="background-color: skyblue">D</TD>
<TD width="14%" align="center" style="background-color: skyblue">L</TD>
<TD width="14%" align="center" style="background-color: skyblue">M</TD>
<TD width="14%" align="center" style="background-color: skyblue">M</TD>
<TD width="14%" align="center" style="background-color: skyblue">J</TD>
<TD width="14%" align="center" style="background-color: skyblue">V</TD>
<TD width="15%" align="center" style="background-color: skyblue">S</TD>
</TR>
<TR>
