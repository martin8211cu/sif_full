...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisMarcaMod<cfoutput>#Attributes.nameMar#</cfoutput>(opc) {
		<cfoutput>	
			...
			if(opc == 1){	// Conlis de Marcas
				params = "?form=#Attributes.form#&name=#Attributes.nameMar#&desc=#Attributes.descMar#&key=#Attributes.keyMar#&conexion=#Attributes.conexion#&nameMod=#Attributes.nameMod#&descMod=#Attributes.descMod#&keyMod=#Attributes.keyMod#";
				
				popUpWindow#Attributes.nameMar#("/UtilesExt/ConlisMarcas.cfm"+params,250,200,650,400);
			}else{	//Conlis de Modelos
				params = "?form=#Attributes.form#&nameMod=#Attributes.nameMod#&descMod=#Attributes.descMod#&keyMod=#Attributes.keyMod#&conexion=#Attributes.conexion#&marca=" + document.#Attributes.form#.#Evaluate('Attributes.descMar')#.value + "&codMarca=" + document.#Attributes.form#.#Evaluate('Attributes.keyMar')#.value;
				
				popUpWindow#Attributes.nameMar#("/UtilesExt/ConlisModelos.cfm"+params,250,200,650,400);			
			}
		</cfoutput>			
	}
	...
	function TraeMarcaMod<cfoutput>#Attributes.nameMar#</cfoutput>(dato, opc) {
		<cfoutput>	
			...
			if(opc == 1){	//Marcas
				...
				if (dato!="") {
					document.all["#Attributes.frameMar#"].src="/UtilesExt/sifMarcaModQuery.cfm?dato="+dato
    ...
    <td width="50%" nowrap>
		<cfoutput>
			...
			<tr>
				...
				<td>
					<a href="##" tabindex="-1"><img src="/imagenes/Description.gif" alt="Lista de Marcas" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doConlisMarcaMod#Attributes.nameMar#(1);'></a>
					</cfif>
				</td>
			</tr>
			</table>
    ...
    <td width="50%" nowrap>
		<table width="" border="0" cellspacing="0" cellpadding="0">
      	...
      	<input type="text"
				...
				<td>
				<a href="##" tabindex="-1"><img src="/imagenes/Description.gif" alt="Lista de Modelos" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript: validaDoConlis<cfoutput>#Attributes.nameMod#</cfoutput>();'></a>					
				</td>
				</cfif>
				</tr>
			</table>				
