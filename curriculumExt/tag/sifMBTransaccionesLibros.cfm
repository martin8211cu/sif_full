...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisMBTransaccionesLibros<cfoutput>#Attributes.name#</cfoutput>() {
		var params ="";
		params = "<cfoutput>?form=#Attributes.form#&tipo=#Attributes.tipo#&id=#Attributes.id#&name=#Attributes.name#&desc=#Attributes.desc#&conexion=#Attributes.conexion#&empresa=#Attributes.empresa#</cfoutput>";

		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/UtilesExt/ConlisMBTransaccionesLibros.cfm"+params,250,200,650,400);
	}
	//Obtiene la descripción con base al código
	function TraeMBTransaccionesLibros<cfoutput>#Attributes.name#</cfoutput>(dato) {
		var params ="";
		params = "<cfoutput>&id=#Attributes.id#&tipo=#Attributes.tipo#&name=#Attributes.name#&desc=#Attributes.desc#&conexion=#Attributes.conexion#&ecodigo=#Attributes.empresa#</cfoutput>";
		if (dato!="") {
			var fr = document.getElementById("<cfoutput>#Attributes.frame#</cfoutput>");
			fr.src = "/UtilesExt/sifMBTransaccionesLibrosquery.cfm?dato="+dato+"&form="+"<cfoutput>#Attributes.form#</cfoutput>"+params;
		}
		else{
	...
	<tr>
		...
		<td nowrap>
			<input type="text"
				...
				maxlength="80">
			<a href="##" tabindex="-1"><img src="/imagenes/Description.gif" alt="Lista Clasificaci&oacute;n Socios de Negocios" name="imagen" width="18" height="14" border="0" align="absmiddle" onclick='javascript: doConlisMBTransaccionesLibros#Attributes.name#();'></a>
		</td>
	</tr>
	</cfoutput>
</table>
