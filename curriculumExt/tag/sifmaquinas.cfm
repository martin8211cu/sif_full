...
function doConlisMaquinas<cfoutput>#Attributes.FAM09MAQ#</cfoutput>() {
    ...
    popUpWindow<cfoutput>#Attributes.FAM09MAQ#</cfoutput>("/UtilesExt/ConlisMaquinas.cfm"+params,250,200,650,400);
...
function TraeMaquina<cfoutput>#Attributes.FAM09MAQ#</cfoutput>(valor) {
	...
	if (valor!="") {
		document.all["<cfoutput>#Attributes.frame#</cfoutput>"].src="/UtilesExt/sifMaquinasquery.cfm?valor="+valor+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
...
value="<cfif isdefined("Attributes.idquery") and len(trim(Attributes.idquery)) >#Trim(Evaluate(queryName).FAM12CODD)#</cfif>" >
 --->
   ...
   <td nowrap width="1%">
	...
	<td width="98%">
		<a  href="##" tabindex="-1"><img id="FAM09MAQ" src="/imagenes/Description.gif" alt="Lista de Maquinas" name="BidImagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisMaquinas#Attributes.FAM09MAQ#();'></a>
	</td>
