...
<script language="JavaScript">
	...
	function doConlisMenus<cfoutput>#Attributes.id_root#</cfoutput>() {
		...
		var params ="";
		params = "<cfoutput>?formulario=#Attributes.form#&id=#Attributes.id_menu#&codigo=#Attributes.id_root#&desc=#Attributes.nombre_menu#&excluir=#Attributes.excluir#</cfoutput>";
		...
		popUpWindow<cfoutput>#Attributes.id_menu#</cfoutput>("/UtilesExt/ConlisMenus.cfm"+params,250,200,650,400);
		
	}
	function TraeMenus<cfoutput>#Attributes.id_root#</cfoutput>(valor) {
		var params ="";
		params = "<cfoutput>&id=#Attributes.id_menu#&desc=#Attributes.nombre_menu#&codigo=#Attributes.id_root#&excluir=#Attributes.excluir#&frame=#Attributes.frame#</cfoutput>";
		...
		if (valor!='') {
			document.all["<cfoutput>#Attributes.frame#</cfoutput>"].src="/UtilesExt/sifMenusquery.cfm?valor="+valor+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
...
<tr>
   ...
   <td nowrap width="1%">
	...
	<td width="98%">
		<a  href="##" tabindex="-1"><img id="id_root" src="/imagenes/Description.gif" alt="Lista de Transacciones de Depósito" name="BidImagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisMenus#Attributes.id_root#();'></a>
	</td>
