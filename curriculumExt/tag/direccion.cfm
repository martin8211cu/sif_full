...
<cffunction name="ReadDataObject">
	...
	<cfquery datasource="asp" name="ReadDataObject_QueryDirecciones">
...
<cfif attributes.action is 'input'>
	...
	<cfif Len(Trim(Attributes.title))>
	    ...
	    <tr>
	      <td nowrap align="right"><font  style="font-size:#Attributes.tamano_letra#px"><cfif Attributes.negrita><b></cfif><cf_translate  key="LB_AtencionA">Atenci&oacute;n a</cf_translate>:&nbsp;<cfif Attributes.negrita></b></cfif></font></td>
	    ...
	    <tr>
	      ...
	      <td valign="top"><input tabindex="#Attributes.tabindex#" style="font-size:#Attributes.tamano_letra#px" name="#Attributes.prefix#codPostal" type="text" id="#Attributes.prefix#codPostal" onFocus="this.select()" value="#userdata.codPostal#" size="30" maxlength="60"></td>
    </tr>
	    <tr>
	      ...
	      <td valign="top">
            <select name="#Attributes.prefix#pais" id="#Attributes.prefix#pais" style="font-size:#Attributes.tamano_letra#px" tabindex="#Attributes.tabindex#" >
              <cfloop query="rsPais">
...
<cfelseif attributes.action is 'display'>
	...
	<cfoutput>
		...
		<td   align="left"nowrap><cfif Attributes.negrita><b></cfif><cf_translate  key="LB_Estado">Estado</cf_translate><cfif Attributes.negrita></b></cfif></td>
		<td align="right" nowrap>
		#userdata.estado# </td>
		</tr></cfif>
