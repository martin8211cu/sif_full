...
<cfif ThisTag.ExecutionMode is 'end'>
	...
	<cfif ListFind('sybase,sqlserver', dbtype)>
		...
		<cfif Attributes.jdbc>
			<cf_jdbcqueryEXT_open update="yes" datasource="#Attributes.datasource#">
			<cfoutput>
...
<cffunction name="sbCreateSequenceOracleTemp" output="no">
	...
	<cfif Attributes.jdbc>
		<cf_jdbcqueryEXT_open update="yes" datasource="#Attributes.datasource#"><cfoutput>#line_feed
