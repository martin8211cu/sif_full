...
<cfif attributes.action is 'input'>
	...
	<cfif Len(Trim(Attributes.title))>
	    ...
	    <tr>
	      ...
	      <td valign="top"><input <cfif len(trim(Attributes.tabindex))>tabindex = "#Attributes.tabindex#"</cfif> name="#Attributes.prefix#codPostal" type="text" id="#Attributes.prefix#codPostal" onFocus="this.select()" value="#userdata.codPostal#" size="30" maxlength="60"></td>
    </tr>
