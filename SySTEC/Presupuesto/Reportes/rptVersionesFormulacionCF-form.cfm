...
<cfoutput>
<form method="post" action="rptVersionesFormulacionCF-imprimir.cfm" name="form1"  onSubmit="return validar();"  style="MARGIN:0;">
	<table align="center" border="0" cellspacing="2" cellpadding="2" >
		<tr>
			<td nowrap><strong>Versión Formluación:</strong></td>
			<td nowrap>
				<select name="CVid" size="1" id="CVid" tabindex="1">
				  <cfloop query="rsVersiones">
					<option value="#rsVersiones.CVid#">#rsVersiones.CVdescripcion#</option>
				  </cfloop>
				</select>			
			</td>
			<td><input type="checkbox" name="chkAprobadas" value="1" <cfif isdefined("form.chkAprobadas")>checked</cfif> onClick="this.form.action='';this.form.submit();"> Ver Versiones ya aprobadas</td>
		</tr>
				<tr>
		...
		<tr>
			<td nowrap><strong>Cuenta Presupuestal:</strong></td>
			<td nowrap="nowrap">
		...
		<tr>  
			<td  align="center" colspan="2">
				<input type="submit" name="Procesar" value="Procesar" id="Procesar" tabindex="1" class="btnSiguiente">
				<input type="reset" name="Limpiar"  onClick="javascript: if (window.OcultarCeldas) return OcultarCeldas();" value="Limpiar" tabindex="1" class="btnLimpiar">
