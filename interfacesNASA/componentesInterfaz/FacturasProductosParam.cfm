...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Compra de Productos'>

<cfset Bpreicts = Application.dsinfo.preicts.schema>
<cfquery name="rsictsSoin" datasource="sifinterfaces">
	select CodICTS,SoinFeederCF
     from int_ICTS_SOIN
...
<cfoutput>
	<form name="form1" method="post" action="ProcFactProd.cfm" onsubmit="return waitmsg();">
