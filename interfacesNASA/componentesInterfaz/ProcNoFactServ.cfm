...
<cf_templateheader title="Procesa Documentos NoFact de Servicios">
	  <cf_web_portlet_start titulo="Procesa Documentos NoFact de Servicios #etiquetaT#">
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnImprimir">
				<cfif isdefined("url.ModoV")>
					<cfif url.ModoV EQ 1>
						<cflocation url="/cfmx/interfacesNASA/Consultas/SQLNoFactProductosR2.cfm?Regresa=ProcNoFactServ.cfm&ModoV=1&CodICTS=#form.CodICTS#">
					<cfelse>
						<cflocation url="/cfmx/interfacesNASA/Consultas/SQLNoFactProductosR2.cfm?Regresa=ProcNoFactServ.cfm&ModoV=2&CodICTS=#form.CodICTS#">			
					</cfif>
				</cfif>
				<cflocation url="/cfmx/interfacesNASA/Consultas/SQLNoFactProductosR2.cfm?Regresa=ProcNoFactServ.cfm">
			</cfif>
		</cfif>
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnRegresar">
				...
				<cflocation url="/cfmx/interfacesNASA/componentesInterfaz/NoFactServiciosParam.cfm">
			</cfif>
		</cfif>
		<cfif isdefined("Form.botonsel")>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnErrores(#varErrores#)">
				<cfif isdefined("url.ModoV")>
					<cfif url.ModoV EQ 1>
						<cflocation url="/cfmx/interfacesNASA/Consultas/SQLNoFactProductosErroresR2.cfm?Regresa=ProcNoFactServ.cfm&ModoV=1&CodICTS=#form.CodICTS#">
					<cfelse>
						<cflocation url="/cfmx/interfacesNASA/Consultas/SQLNoFactProductosErroresR2.cfm?Regresa=ProcNoFactServ.cfm&ModoV=2&CodICTS=#form.CodICTS#">			
					</cfif>
				</cfif>
			</cfif>
		</cfif>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnMostrar_Doctos._Costo_Parcial_rev_ICTS">
				<cflocation url="/cfmx/interfacesNASA/componentesInterfaz/ProcNoFactServ.cfm?ModoV=2&botonsel=nada&CodICTS=#form.CodICTS#">
			<cfelseif form.botonsel EQ "btnOcultar_Doctos._Costo_Parcial_rev_ICTS">
				<cflocation url="/cfmx/interfacesNASA/componentesInterfaz/ProcNoFactServ.cfm?ModoV=1&botonsel=nada&CodICTS=#form.CodICTS#">
			</cfif>
		</cfif>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnTerminado">
				...
				<cflocation url="/cfmx/interfacesNASA/componentesInterfaz/terminado.cfm?Regresa=ProcNoFactServ.cfm">
			</cfif>
		</cfif>

		<cfif isdefined("Form.generar")>
			<cfinclude template="NoFactServiciosA-sql.cfm">
			<cfset Mvista = 1>
		...
		<cfinclude template="NoFactServiciosA-lista.cfm">
