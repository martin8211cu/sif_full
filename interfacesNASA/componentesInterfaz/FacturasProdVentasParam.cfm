...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Venta de Productos'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcFactProdVent.cfm" onsubmit="return waitmsg();">
