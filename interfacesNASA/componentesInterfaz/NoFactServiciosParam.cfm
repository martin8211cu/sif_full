<!--- Extracción  de ICTS de Servicios No FACT --->
		
<cf_templateheader title="SIF - Interfaces P.M.I.">
<cfinclude template="/sif/portlets/pNavegacion.cfm">
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Documentos NoFact de Servicio'>

<cfset Bpreicts = Application.dsinfo.preicts.schema>
<cfquery name="rsictsSoin" datasource="sifinterfaces">
	select CodICTS,SoinFeederCF from int_ICTS_SOIN
...
<cfif isdefined('rsictsSoin') and Len(rsictsSoin.CodICTS) and rsictsSoin.RecordCount GTE 1>
    ...
    <cfif  rsictsSoin.SoinFeederCF NEQ 1>
    	<cfthrow message="La Empresa #session.enombre# utiliza un Feeder Externo." >
    	<cfabort>
    </cfif>  
<cfelse>
...
<cfoutput>
	<form name="form1" method="post" action="ProcNoFactServ.cfm" onsubmit="return waitmsg();">
