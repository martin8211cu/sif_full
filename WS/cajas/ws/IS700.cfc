...
<!--- <cfset LvarTiempo = GetTickCount()> --->
    ...
    <cffunction name="procesarTransaccion" access="private" returnType="string" hint="Funcion para procesar un unico Registro">
        ...
        <cfloop from="1" to="#nDetalles#" index="i" >
			...
			<!--- Aca empieza el cambio para redondear al 2 digito decimal --->
			<!--- Robert Castilo, 21/09/2011 --->
			<cfset Dif_DebCred = abs(TotalC - TotalD)>
						
			<!---- <cfif TotalC NEQ TotalD> ---->
			<cfif Dif_DebCred gt 0.001>
			
			<!--- Aca termina el cambio para redondear al 2do digito decimal --->
			<!--- Robert Castilo, 21/09/2011 --->
...
<!---                    <cfset resultadoITC = "[insertaFAX001]:" & #cfcatch.message# & ", Detalle2:" & #cfcatch.detail# & ", SQL:" & #sqlIDT#>--->
	...
	<cffunction name="ActualizaTrans" acess="private" returntype="string">
		  ...
		  <cftry>
			...
			<cfquery name="ActTrans1" datasource="CAJAS">
			    update FAX001
			...
			<cfquery name="ActTrans2" datasource="CAJAS">
			  	insert FAX011 (FAM01COD, FAX01NTR, FAX11LIN, FAM09MAQ, FAX11REC, FAX11STS, FAX09SER,
					 ...
					 values (<cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.CAJA#">,	
							 ...
							 <cfqueryparam cfsqltype="cf_sql_char" value="FC">,
							 <cfqueryparam cfsqltype="cf_sql_char" value="#Documento#">)
			</cfquery>
                               
			<cfquery name="ActTrans3" datasource="CAJAS">
			...
			<cfquery name="ActTrans4" datasource="CAJAS">
	 		   update FAX004EX 
			...
			<cfquery name="ActTrans5" datasource="CAJAS">
			   update FAX001
		  ...
		  <cfif resultado NEQ "OK" >    
              <cfthrow message="[UPDATE MULTIPLE]: #resultado#" >
          </cfif>
