...
<cf_dbfunction name="to_char" args="WTCid"  returnvariable="WTCid" >
<cf_dbfunction name="to_char" args="WECid"  returnvariable="WECid" >
<cfinvoke component="sif.Componentes.pListas" method="pListaRH"
 returnvariable="pLista">
	<cfinvokeargument name="tabla" value="WEContable"/>
	<cfinvokeargument name="columnas" value="#WTCid# as WTCid, #WECid# as WECid, Cdescripcion, Cformato #aditionalCols#"/>
