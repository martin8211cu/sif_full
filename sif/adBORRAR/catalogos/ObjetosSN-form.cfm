...
<form enctype="multipart/form-data" action="ObjetosSN-sql.cfm" method="post" name="form6" onsubmit="javascript:document.form6.dir.value=document.form6.OLPdato.value;"><!---  --->
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0" align="center">
		<tr>
			<td align="center" colspan="2"><strong>Objetos del Socio de Negocios</strong></td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="SNOarchivo"  value="<cfif modo neq 'ALTA'>#HTMLEditFormat(rsSNegociosObjeto.nombre_archivo)#</cfif>" size="60" maxlength="100"></td>
		</tr>	

		<tr>
			<td align="right" nowrap><strong>Archivo:</strong>&nbsp;</td>
			<td>
				<input type="file" name="OLPdato" value="" onblur="javascript:document.form6.nArchivo.value=this.value;">
