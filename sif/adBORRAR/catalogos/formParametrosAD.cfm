...
<cfset rsCuentaManual 		 = ObtenerDato(2)>
...
<form action="SQLParametrosAD.cfm" method="post" name="form1" onSubmit="MM_validateForm('periodo','','R','periodoAux','','RinRange1950:2099');return document.MM_returnValue">
	<table width="85%" border="0" cellpadding="0" cellspacing="0" align="center">
		...
		<tr>
			<td width="2%">&nbsp;</td>
			<td align="right" nowrap>Indicar Cuentas Contables Manualmente:&nbsp;</td>
			...
			<td>
				<table width="97%" class="ayuda" align="center">
					<tr>
						<td align="center">
							<p align="justify">Indicar Cuentas Contables Manualmente.</p>
						</td>	
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td>
				<table width="97%" class="ayuda" align="center">
					<tr>
						<td align="center">
							<p align="justify">Activar Transaccionabilidad de Actividad Empresarial</p>
						</td>	
					</tr>
				</table>
			</td>
