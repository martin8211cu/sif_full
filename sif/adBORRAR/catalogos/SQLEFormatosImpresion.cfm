		...
		<cfif isdefined("form.btnAgregar")>
			<cfquery name="insert_FMT001" datasource="#session.DSN#">
				insert into FMT001 ( FMT01COD, Ecodigo, FMT01DES, FMT01TOT, FMT01LIN, FMT01DET, FMT01PDT, FMT01USR, FMT01FEC, FMT01LAR,
					...
					values(
						<cfqueryparam value="#rtrim(form.FMT01COD)#"   cfsqltype="cf_sql_varchar">,
						<cfqueryparam value="#session.Ecodigo#" cfsqltype="cf_sql_integer" null="#IsDefined('form.esglobal')#"  >,
						...
						<cfif Len(Trim(form.FMT01FEC)) gt 0>
							<cfqueryparam value="#LSParseDateTime(form.FMT01FEC)#" cfsqltype="cf_sql_timestamp">
						<cfelse>
						...
						<cfqueryparam cfsqltype="cf_sql_integer" value="#form.FMT01tipfmt#">,
