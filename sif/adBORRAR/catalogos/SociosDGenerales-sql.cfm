...
<cfif not isdefined("Form.Nuevo")>
	...
	<cfif isdefined("Form.ALTA")>
		...
		<cftransaction>
			...
			<cfif not modalidad.altalocal><cfset form.ALTA_CORPORATIVO = 1></cfif>
			<cfif modalidad.replicar and form.ALTA_CORPORATIVO>
				...
				<cfset validaIdentificacion(session.EcodigoCorp, Form.SNidentificacion) >
				<cftry>
			...
			<cfif Len(form.ESNid) EQ 0><cfset form.ESNid = minESNid(session.Ecodigo)></cfif>
			...
			<cfset validaIdentificacion(session.Ecodigo, Form.SNidentificacion) >
