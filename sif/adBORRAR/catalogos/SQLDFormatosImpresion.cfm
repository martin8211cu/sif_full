...
<cfparam name="action" default="DFormatosImpresion.cfm">
	...
	<cftry>
		...
		<cfif isdefined("form.btnAgregar")>
			<cfquery name="insert_FMT002" datasource="#session.DSN#">
				insert into FMT002 ( FMT01COD, FMT02LIN, FMT02DES, FMT02LON, FMT02DEC, FMT02FMT, FMT02TPL, FMT02TAM, 
					...
					values(
						...
						<cfqueryparam value="#form.FMT02LON#"   cfsqltype="cf_sql_float" >,
	 ...
	 <cfinvoke component="sif/Componentes/DButils" method="toTimeStamp" artimestamp="#form.ts_rversion#" returnvariable="ts"></cfinvoke>
			...
			<cfquery name="update_FMT002" datasource="#session.DSN#">
				update FMT002
				   set FMT02CAM = <cfqueryparam value="#form.FMT02CAM#" cfsqltype="cf_sql_varchar" >
					  ...
					  ,FMT02LON = <cfqueryparam value="#form.FMT02LON#"   cfsqltype="cf_sql_float" >
