<cftransaction>
	...
	<cfif isDefined("Form.hayCuentaManual") and Len(Trim(form.hayCuentaManual)) GT 0>
		<cfif Form.hayCuentaManual NEQ '-1'>
			<cfset a = updateDato(2,fnChk("form.chkCuentaManual"))>
		<cfelse>
			<cfset b = insertDato(2,'CG','Indicar Cuentas Contables Manualmente', fnChk("form.chkCuentaManual"))>
		</cfif>
	</cfif>
