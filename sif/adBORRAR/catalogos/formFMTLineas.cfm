...
<cfquery name="rsForm" datasource="#session.DSN#">
	select FMT09LIN, FMT09COL, FMT09FIL, FMT09CLR, FMT09HEI, FMT09WID, FMT09GRS, FMT09CFN, ts_rversion
	from FMT009
...
<cfquery name="rsLinea" datasource="#session.DSN#">
	select coalesce(max(FMT09LIN)+1,1) as FMT09LIN
...
<form name="form1" method="post" onSubmit="return validar();" action="SQLFMTLineas.cfm" >
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><input type="text" name="FMT09FIL" maxlength="7" size="9" value="<cfif modo neq 'ALTA'><cfoutput>#LSNumberFormat(rsForm.FMT09FIL,',9.0000')#</cfoutput><cfelse>0.0000</cfif>" style="text-align: right;" onblur="fm(this,4);" onfocus="javascript:this.value=qf(this); this.select();"  onkeyup="javascript:if(snumber(this,event,4)){ if(Key(event)=='13') {this.blur();}}" alt="La Fila" ></td>
		</tr>
		<tr>
			<!--- Pos.y --->
			<td align="right" nowrap>Columna:&nbsp;</td>
			<td><input type="text" name="FMT09COL" maxlength="7" size="9" value="<cfif modo neq 'ALTA'><cfoutput>#LSNumberFormat(rsForm.FMT09COL,',9.0000')#</cfoutput><cfelse>0.0000</cfif>" style="text-align: right;" onblur="fm(this,4);" onfocus="javascript:this.value=qf(this); this.select();"  onkeyup="javascript:if(snumber(this,event,4)){ if(Key(event)=='13') {this.blur();}}" alt="La Columna" ></td>
		</tr>

		<tr>
			<!--- Pos.x --->
			<td align="right" nowrap>Alto:&nbsp;</td>
			<td><input type="text" name="FMT09HEI" maxlength="7" size="9" value="<cfif modo neq 'ALTA'><cfoutput>#LSNumberFormat(rsForm.FMT09HEI,',9.0000')#</cfoutput><cfelse>0.0000</cfif>" style="text-align: right;" onblur="fm(this,4);" onfocus="javascript:this.value=qf(this); this.select();"  onkeyup="javascript:if(snumber(this,event,4)){ if(Key(event)=='13') {this.blur();}}" alt="El Alto" ></td>
		</tr>
		<tr>
			<!--- Pos.y --->
			<td align="right" nowrap>Ancho:&nbsp;</td>
			<td><input type="text" name="FMT09WID" maxlength="7" size="9" value="<cfif modo neq 'ALTA'><cfoutput>#LSNumberFormat(rsForm.FMT09WID,',9.0000')#</cfoutput><cfelse>0.0000</cfif>" style="text-align: right;" onblur="fm(this,4);" onfocus="javascript:this.value=qf(this); this.select();"  onkeyup="javascript:if(snumber(this,event,4)){ if(Key(event)=='13') {this.blur();}}" alt="El Ancho" ></td>
		</tr>
		<tr>
			<!--- Pos.y --->
