...
<cfquery name="rsIdioma" datasource="#session.DSN#">
 ...
 <table align="center" cellpadding="2" cellspacing="3" border="0">
	<tr>
		<td align="left" valign="middle"><font size="-4"><strong>Socio&nbsp;de &nbsp;Negocios:&nbsp;</strong></font></td>
		<td align="left" valign="middle"><cfoutput><font size="-1"><strong>#rsSocios.SNnombre#</strong></font></cfoutput></td>
		<td align="left" valign="middle"><font size="-4"><strong>Identificaci&oacute;n:&nbsp;</strong></font></td>
		<td align="left" valign="middle"><cfoutput>#rsSocios.SNidentificacion#</cfoutput></td>
		<td align="left" valign="middle">&nbsp;</td>
	  	<td rowspan="2" align="left" valign="middle"><cfif modalidad.modalidad></cfif><font size="-4"><strong>Modalidad <br>
	  		Corporativa:&nbsp;</strong></font></td> 
		<td align="left" valign="middle"><cfoutput>#HTMLEditFormat(modalidad.nombre)#</cfoutput></td>
	</tr>
	<tr>
		<td align="left" valign="middle"><font size="-4"><strong>N&uacute;mero de Socio:&nbsp;</strong></font></td>
		<td  align="left" valign="middle"><cfoutput>#rsSocios.SNnumero#</cfoutput></td>
		<td align="left" valign="middle"><font size="-4"><strong>Correo:&nbsp;</strong></font></td>
