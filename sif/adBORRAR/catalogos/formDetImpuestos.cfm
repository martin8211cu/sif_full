...
<cfif modo NEQ 'ALTA'>
	...
	<cfquery name="rsdata" datasource="#session.DSN#">
		select Icodigo, DIcodigo, DIdescripcion, DIporcentaje, Ccuenta, DIcreditofiscal, ts_rversion 
		from DImpuestos
		where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
			and Icodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#form.Icodigo#">
...
<form style="margin:0;" name="form1" action="SQLDetImpuestos.cfm" method="post">
	<table width="100%" cellpadding="2" cellspacing="0" border="0" >
		...
		<tr>
			<td align="right" nowrap ><strong>Cta. Contable:</strong>&nbsp;</td>
			<td>
				<cfif modo NEQ "ALTA" and rsdata.Ccuenta neq -1 >
