...
<cfif LvarCxC>
	<cfset LvarTipoT = "CC">
	<cfset LvarTituloT = "Cuentas por excepción por Transacciones de CxC">
<cfelse>
	<cfset LvarTipoT = "CP">
	<cfset LvarTituloT = "Cuentas por excepción por Transacciones de CxP">
</cfif>
...
<cfoutput>
<fieldset style="border:1px solid ##CCCCCC"><legend><strong>#LvarTituloT#</strong></legend>
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<tr>
	  ...
	  <td nowrap>Transacci&oacute;n #LvarTipoT#</td>
	  <td>&nbsp;</td>
	</tr>
	...
	<tr> 
		...
		<cfif LvarCxC>
			<input type="submit" name="btnAgregar#LvarTipoT#T" value="Agregar" class="btnGuardar" onClick="MM_validateForm('#LvarTipoT#Tcodigo','','R','CFcuenta#LvarTipoT#T','','R');return document.MM_returnValue;">
		<cfelse>
			<input type="submit" name="btnAgregar#LvarTipoT#T" value="Agregar" class="btnGuardar" onClick="MM_validateForm('#LvarTipoT#Tcodigo','','R','CFcuenta#LvarTipoT#T','','R');return document.MM_returnValue;">
		</cfif>
	...
	<tr>
	  <td nowrap align="right" >&nbsp;</td>
	  <td nowrap colspan="2">Cuenta Financiera</td>
	</tr>
