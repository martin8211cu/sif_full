...
<cfif isdefined("rsDirPrin") and rsDirPrin.DirDireccion eq rsDirPrin.DirSocio>
...
<form action="SociosDireccion-sql.cfm" method="post" name="form8direccion">
  ...
  <table width="67%" height="75" align="center" cellpadding="0" cellspacing="2">
    <tr> 
      <td colspan="1" align="left" class="subTitulo" valign="baseline" nowrap>Modificar la direcci&oacute;n </td>
	  <td>
	...
	<tr>
      <td valign="middle" nowrap><div align="right"><strong>Nombre:</strong>&nbsp;</div></td>
    ...
    <tr>
      ...
      <td width="73%" valign="middle" nowrap>
        ...
        <label for="SNDactivo">Activo</label>  </td>
    </tr>
