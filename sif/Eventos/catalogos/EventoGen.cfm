                ...
                onSubmit="javascript: document.form1.EVcodigo.disabled = false; return true;"> 
                    <table width="80%" align="center" border="0" >
                        <tr>
                            ...
                            <td colspan="2">
                        <input name="EVcodigo" <cfif modo NEQ "ALTAGEN"> class="cajasinbordeb" readonly tabindex="-1" <cfelse> 
                                tabindex="1"</cfif> type="text" value="<cfif modo NEQ "ALTAGEN">#rsForm.EVcodigo#<cfelseif isdefined('rsForm.EVcodigo')>#rsForm.EVcodigo#</cfif>" 
                                size="5" maxlength="5" />
                            </td>
                        </tr>	
                        <tr>
                            ...
                            <td colspan="2">
                            <input type="text" name="EVdescripcion" maxlength="40" size="40" id="EVdescripcion" tabindex="1" style="border-spacing:inherit" value="<cfif modo NEQ 'ALTAGEN'>#trim(rsForm.EVdescripcion)#</cfif>" />
                        </td>
                        </tr>	
                        <tr>
...
<!---                            <td>
                                ...
                                <cfif modo NEQ "ALTAGEN" and isdefined("rsForm.AgregaOperacion") and #rsForm.AgregaOperacion# EQ 1> checked </cfif>> <strong>Agrega Id.Operación</strong>
                            </td>
--->                        
						</tr>	
                        ...
                        <tr valign="baseline"> 
                            <td colspan="3" align="center" nowrap>
								<input name="btnEnviar" type="submit" id="btnEnviar" value=<cfif modo NEQ "ALTAGEN">"Actualizar"<cfelse>"Agregar"</cfif> tabindex="2" />
                            </td>
                        </tr>
                    </table>
                    <cfset ts = "">
                    <cfif modo NEQ "ALTAGEN">
