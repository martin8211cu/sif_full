<cfcomponent>
	...
	<cffunction name="ALTA"   access="public" returntype="string">
		...
		<cfargument name="DVcodigo"       type="string"  required="true">
		<cfargument name="DVdescripcion"  type="string"  required="true">
		<cfargument name="DVetiqueta"     type="string"  required="true">
		<cfargument name="DVencabezado"   type="string"  required="true">
		...
		<cfquery datasource="#Arguments.Conexion#" name="rsDVdatosVariables">
			insert into DVdatosVariables (
				Ecodigo,DVcodigo,DVdescripcion,DVetiqueta,DVencabezado,DVexplicacion,
				DVtipoDato,DVlongitud,DVdecimales,DVmascara,DVobligatorio,BMUsucodigo )
			values(
				#Arguments.Ecodigo#,
				<cf_jdbcquery_param cfsqltype="cf_sql_char" 		value="#TRIM(Arguments.DVcodigo)#">,
				<cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVdescripcion)#">,
				<cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVetiqueta)#">,
				<cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVencabezado)#">,
	...
	<cffunction name="CAMBIO" access="public" returntype="string">
		...
		<cfquery datasource="#Arguments.Conexion#">	
			update DVdatosVariables set 
				DVcodigo 	  = <cf_jdbcquery_param cfsqltype="cf_sql_char" 		value="#TRIM(Arguments.DVcodigo)#">,
				DVdescripcion = <cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVdescripcion)#">,
				DVetiqueta	  = <cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVetiqueta)#">,
				DVencabezado  = <cf_jdbcquery_param cfsqltype="cf_sql_varchar" 		value="#TRIM(Arguments.DVencabezado)#">,
	...
	<cffunction name="ALTALISTA"  access="public" returntype="string">
		...
		<cfquery datasource="#Arguments.Conexion#">	
			insert into DVlistaValores (DVid,DVLcodigo,DVLdescripcion,BMUsucodigo)
			values(
	...
	<cffunction name="PrintDatoVariable"  access="public" returntype="numeric">
		...
		<cfloop query="DatoVariable">
			  ...
			  <td><cfoutput><strong>#DatoVariable.DVetiqueta#:&nbsp;</strong></cfoutput></td>
			  <td>
			  	 <!---Tipo Listas--->
				 <cfif DatoVariable.DVtipoDato EQ 'L'>
				 	<cfquery name="ValorDatoVariable" datasource="#Arguments.Conexion#">	
						select rtrim(DVLcodigo) DVLcodigo, rtrim(DVLdescripcion) DVLdescripcion from DVlistaValores where DVid = #DatoVariable.DVid#
					</cfquery>
					<cfif Arguments.readonly>
						<cfoutput>#DatoVariable.DVVvalor#-#ValorDatoVariable.DVLdescripcion#</cfoutput>
					<cfelse>
						<select name="<cfoutput>#name#</cfoutput>">
				 ...
				 <cfelseif DatoVariable.DVtipoDato EQ 'F'>
				 	<cfif Arguments.readonly>
						<cf_sifcalendario form="#Arguments.form#" value="#DatoVariable.DVVvalor#" name="#name#" readOnly="true">
					<cfelse>
				 		<cf_sifcalendario form="#Arguments.form#" value="#DatoVariable.DVVvalor#" name="#name#">
					</cfif>
				 <!---Tipo Combo--->
				...
				<cfelseif DatoVariable.DVtipoDato EQ 'C'>
					...
					<cfelse>
						<input type="text" name="<cfoutput>#name#</cfoutput>" value="<cfoutput>#DatoVariable.DVVvalor#</cfoutput>"><cfoutput>#DatoVariable.DVmascara#</cfoutput>
				...
				<cfelseif DatoVariable.DVtipoDato EQ 'N'>
					<cfif Arguments.readonly>
						<cfoutput>#DatoVariable.DVVvalor#</cfoutput>
					<cfelse>
						<cf_monto name="#name#" decimales="#DatoVariable.DVdecimales#" value="#DatoVariable.DVVvalor#" size="#DatoVariable.DVlongitud#" form="#Arguments.form#">
					</cfif>
				<!---Tipo Hora--->
				<cfelseif DatoVariable.DVtipoDato EQ 'H'>
					<cfif Arguments.readonly>
						<cf_hora name="#name#"  value="#DatoVariable.DVVvalor#" form="#Arguments.form#" readOnly="true">
					<cfelse>
						<cf_hora name="#name#"  value="#DatoVariable.DVVvalor#" form="#Arguments.form#">
					</cfif>
				 <cfelse>
...
">
		...
		<cfelse>
			<cfset Columns = "DVE.TEVid,DVE.TEVcodigo,DVE.TEVDescripcion">
