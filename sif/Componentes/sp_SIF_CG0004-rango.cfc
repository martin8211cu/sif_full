<cfcomponent>
	<cffunction name="CreaCuentas" access="public" output="false" returntype="string">
		<cf_dbtemp name="CG0004_cuentas">
			...
			<cf_dbtempcol name="PeriodoI"		type="int">
			<cf_dbtempcol name="MesI"			type="int">
            <cf_dbtempcol name="PeriodoF"		type="int">
			<cf_dbtempcol name="MesF"			type="int">
	...
	<cffunction name='balanceComprob' access='public' output='false' returntype="numeric">
		...
		<cfargument name='periodoI' type='numeric' required="yes">
		<cfargument name='mesI' type='numeric' required="yes">
       	<cfargument name='periodoF' type='numeric' required="yes">
		<cfargument name='mesF' type='numeric' required="yes">
		...
		<cfset LvarMesReporteI = Arguments.mesI>
		<cfset LvarPeriodoReporteI = Arguments.periodoI>
        
       	<cfset LvarMesReporteF = Arguments.mesF>
		<cfset LvarPeriodoReporteF = Arguments.periodoF>
		...
		<cfquery name="A_Cuentas" datasource="#arguments.conexion#">
			insert INTO #cuentas# (
					Ecodigo, mayor, descrip, Ccuenta, PeriodoI, MesI,PeriodoF, MesF, 
					Oficina, 
			...
			select 	b.Ecodigo,	b.Cmayor, 
					...
					a.Ccuenta, #arguments.periodoI#, #arguments.mesI#,#arguments.periodoF#, #arguments.mesF#,
			...
			<cfloop condition = "nivelactual LESS THAN arguments.nivel">
				<cfquery name="A2_Cuentas" datasource="#arguments.conexion#">
					insert INTO #cuentas# (
							...
							PeriodoI, MesI,PeriodoF, MesF, Oficina,
					...
					select 
						...
						<cfelse>
						  ...
						  b.Ccuenta
						, #arguments.periodoI#, #arguments.mesI#,#arguments.periodoF#, #arguments.mesF#, a.Oficina
		...
		<cfif not arguments.MesCierre>
			<cfif arguments.Mcodigo EQ -2>
				<cfset LvarCalculoMontoLocal = CalculoMontoLocal(#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#)>
			<cfelseif arguments.Mcodigo EQ -3 or arguments.Mcodigo EQ -4>
				<cfset LvarCalculoMontosConvertidos = CalculoMontosConvertidos(#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#,lvarB15V)>
			<cfelse>
				<cfset LvarMonedaOrigen = MonedaOrigen(#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#)>
			</cfif>
		<cfelseif arguments.MesCierre>
			...
			<cfif arguments.Mcodigo EQ -2>
				<cfset LvarCalculoMontoLocalMesCierre = CalculoMontoLocalMesCierre(#arguments.Ecodigo#,#arguments.nivel#,#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#)>
			<cfelseif arguments.Mcodigo EQ -3 or arguments.Mcodigo EQ -4>
				<cfset LvarCalculoMontosConvertidosCierre = CalculoMontosConvertidosCierre(#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#,lvarB15V)>
			<cfelse>
				<cfset LvarMonedaOrigenMesCierre = MonedaOrigenMesCierre(#arguments.Ecodigo#,#arguments.nivel#,#arguments.Mcodigo#,#arguments.periodoI#,#arguments.mesI#,#arguments.periodoF#,#arguments.mesF#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#)>
			</cfif>
		</cfif>
			...
			update #cuentas# set 
				saldoini = coalesce((select sum(#mySLinicial#)
						  ...
						  where a.Ccuenta = #cuentas#.Ccuenta
							and a.Speriodo >= #cuentas#.PeriodoI
                           	and a.Speriodo <= #cuentas#.PeriodoF
							and a.Smes >= #cuentas#.MesI
   							and a.Smes <= #cuentas#.MesF
	...
	<cffunction name="CalculoMontosConvertidosCierre" access='private' output="no">
		...
		<cfset LvarMesSiguienteI = arguments.MesI + 1>
   		<cfset LvarMesSiguienteF = arguments.MesF + 1>
		<cfset LvarPeriodoSiguienteI = arguments.PeriodoI>
   		<cfset LvarPeriodoSiguienteF = arguments.PeriodoF>
		<cfif LvarMesSiguienteI GT 12>
			<cfset LvarMesSiguienteI = 1>
			<cfset LvarPeriodoSiguienteI = arguments.PeriodoI + 1>
		</cfif>
        <cfif LvarMesSiguienteF GT 12>
			<cfset LvarMesSiguienteF = 1>
			<cfset LvarPeriodoSiguienteF = arguments.PeriodoF + 1>
		</cfif>
		...
		<cfquery datasource="#arguments.conexion#">
			update #cuentas# set 
				saldoini = coalesce((select sum(#mySLinicial#)
					  from SaldosContablesConvertidos a
					  where a.Ccuenta = #cuentas#.Ccuenta
						and a.Speriodo >= #LvarPeriodoSiguienteI#
                        and a.Speriodo <= #LvarPeriodoSiguienteF#
						and a.Smes >= #LvarMesSiguienteI#
   						and a.Smes <= #LvarMesSiguienteF#
						and a.Ecodigo = #cuentas#.Ecodigo
						and a.Mcodigo = #cuentas#.Mcodigo
						<cfif arguments.incluirOficina or arguments.Ocodigo NEQ -1 or arguments.myGOid NEQ -1>
							and a.Ocodigo = #cuentas#.Oficina
	...
	<cffunction name="CalculoMontoLocalMesCierre" access='private'>
		...
		<cfquery datasource="#arguments.conexion#">
			...
			where 
              e.Eperiodo >= #arguments.periodoI#
              and e.Eperiodo <= #arguments.periodoF#
			  and e.Emes >= #arguments.mesI#
   			  and e.Emes <= #arguments.mesF#
