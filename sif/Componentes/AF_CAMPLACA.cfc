<cfcomponent>
	...
	<cffunction name="AF_CAMPLACAACT" access="public" returntype="numeric" output="true">
		...
		<!---Inicio Insert encabezado del cambio de placa--->
		<cftransaction>
			<cfif Arguments.AGTPid is 0>
				...
				<!---Inserta encabezado del cambio de placa--->
