<cfcomponent>
	...
	<cffunction name='balanceComprob' access='public' output='false' returntype="numeric">
			...
			select 	b.Ecodigo,	b.Cmayor,
					<cfif Arguments.myGEid EQ -1>
                        <cfswitch expression = "#arguments.DescAlt#">
                            <cfcase value="L">
                                <cfif #rsDescAlt.Pvalor# eq 0> a.Cdescripcion, <cfelse> b.CdescripcionA, </cfif>
                            </cfcase>
                            <cfcase value="A">
                                <cfif #rsDescAlt.Pvalor# eq 0> b.CdescripcionA, <cfelse> a.Cdescripcion,</cfif>
                            </cfcase>
                        </cfswitch>
					<cfelse>
						coalesce(
		...
		<cfif not arguments.MesCierre>
			<cfif arguments.Mcodigo EQ -2>
				<cfset LvarCalculoMontoLocal = CalculoMontoLocal(#arguments.periodo#,#arguments.mes#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#,#Arguments.TipoCmb#)>
		...
		<cfelseif arguments.MesCierre>
			...
			<cfif arguments.Mcodigo EQ -2>
				<cfset LvarCalculoMontoLocalMesCierre = CalculoMontoLocalMesCierre(#arguments.Ecodigo#,#arguments.nivel#,#arguments.periodo#,#arguments.mes#,#arguments.conexion#,#arguments.incluirOficina#,#arguments.Ocodigo#,#arguments.myGOid#,#Arguments.TipoCmb#)>
			<cfelseif arguments.Mcodigo EQ -3 or arguments.Mcodigo EQ -4>
	...
	<cffunction name="CalculoMontoLocalMesCierre" access='private'>
		...
		<cfquery datasource="#arguments.conexion#">
			update #cuentas# set 
				 saldoini = coalesce((
								select sum(#mySLinicial# + DLdebitos - CLcreditos) * #Arguments.TipoCmb#
								from SaldosContables a
								where a.Ccuenta = #cuentas#.Ccuenta
								  and a.Speriodo = #cuentas#.Periodo
								  and a.Smes = #cuentas#.Mes
