...
<form name="form1" method="post" action="sp_SIF_CG0005_sql.cfm">
  <p>&nbsp;</p>
  <table width="200" border="0" align="center">
    ...
    <tr>
      <td colspan="4" align="center"><span class="style1">Balance de General (sp_SIF_CG0005)</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <table width="200" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><input name="btnBalanceGen" type="submit" id="btnBalanceGen" value="Prueba"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
