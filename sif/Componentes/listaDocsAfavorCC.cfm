...
<cf_templateheader title="SIF - Cuentas por Cobrar">
	<cfinclude template="../../portlets/pNavegacion.cfm">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Lista de Documentos a Favor sin Aplicar'>			
 			<form style="margin:0" action="listaDocsAfavorCC.cfm" method="post" name="form1">           
		      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tituloListas">
                ...
                <tr> 
				  ...
				  <td width="1%">
				  	<input name="NuevoE" type="submit" value="Nuevo" onclick= "javascript:document.form1.action='AplicaDocsAfavorCC.cfm';">
				  </td>
				  <cfif rsDocumentos.RecordCount>
				  <td width="1%">
					<input name="Aplicar" type="submit" value="Aplicar" onclick= "return valida();">
				  </td>
				  </cfif>
				   <td width="1%">
				    <cfif rsDocumentos.RecordCount GT 0>
						<input name="Reporte" type="submit" id="Reporte" value="Reporte" onClick="javascript: document.form1.method='get'; document.form1.action='../reportes/ReporteAplicaDoc.cfm'">
				  	</cfif>
				   </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr class="tituloListas"> 
                  ...
                  <td><strong>Fecha</strong></td>
                  <td nowrap><div align="right"><strong>Moneda</strong></div></td>
...
<script language="JavaScript1.2">
	...
	function validaChecks(){
		...
		if (f.chk != null) {
			if (f.chk.value) {
				if (!f.chk.checked) { 
					alert("Debe escoger un documento de pago para aplicar");
					return false;
				} else {
			...
			alert("No hay documentos de pago para aplicar");
			return false;
		}
	}
