...
<cfcomponent>
	...
	<cffunction name="AF_DepreciacionFiscalActivosAcel" access="public" returntype="numeric" output="true">
		...
		<cfargument name="FDepreciacion" type="string" default="" required="no">
		...
		<cfif Arguments.debug>
			<h2>AF_DepreciacionFiscalActivosAcelerada</h2>
				...
				<cfquery name="rsIndiceF" datasource="#arguments.conexion#">
					...
					<cfquery name="rsCalculoDepLineaRecta" datasource="#arguments.conexion#">
						insert into ADTProceso
							...
							,TAmontodepadqFiscal                                   										<!---23--->			
                            ,TAmontodepmejFiscal																		<!---24--->
						...
						select 
                            ...
                            ,<cf_dbfunction name="date_part" args="YYYY,b.Afechaaltaadq" returnvariable="LvarPeriodo">
                             <cf_dbfunction name="date_part" args="MM,b.Afechaaltaadq" returnvariable="LvarMes">	
                            ...
                            ,0.00	as TAmontodepadqFiscal				<!---23--->
                            
                            ,0.00 as TAmontodepmejFiscal									<!---24--->
                            
                            ,0.00 as  TAmontodepadq <!---25--->
                            
                            ,0.00 as  TAmontodepmej   <!--- 26--->
 						...
 						from AFSaldos a
							inner join Activos b 
                                ...
                                and <cf_dbfunction name="to_date00" args="b.Afechainidep"> <= <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#rsFechaAux.value#"> <!---Preguntar a Aaron--->
...
<!---==============================================================================================================================
                    ...
                    <cfquery name="rsCalculoActualizaADQ" datasource="#arguments.conexion#">
<!---==============================================================================================================================
							Claculo Fiscal Monto Adquisicion Actualizado * Porcentaje de aplicacion Fiscal
							--->	
                    
                    UPDATE ADTProceso
                    set TAmontodepadqFiscal = TAmontolocadq * case 
                    											when coalesce(ac.ACPorcentajeFiscal,0) <= 0 
                                                                	then 0 
                                                                else ac.ACPorcentajeFiscal / 100
                                                                end
                         from ADTProceso ap 
                         inner join Activos b 
								on b.Ecodigo = ap.Ecodigo
...
<!---==============================================================================================================================
                    ...
                    UPDATE ADTProceso
                    set TAmontodepmejFiscal = TAmontolocmej * case 
                    											when coalesce(ac.ACPorcentajeFiscal,0) <= 0 
                                                                	then 0 
                                                                else ac.ACPorcentajeFiscal / 100
                                                                end
