<cf_templateheader title="Lista de Planes de Pago">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Registro de Pagos Extraordinarios'>
		...
		<table border="0" width="100%" cellpadding="4" cellspacing="0">
			<tr>
				<td valign="top">
					<cf_web_portlet_start border="true" titulo="Registro de Pagos Extraordinarios" skin="info1">
						<table width="95%" align="center">
							Registro de pagos extraordinarios:<br>
							<li>El empleado al que quiere registrar el pago.</li><br>
							<li>El tipo de deducci&oacute;n asociado al empleado.</li><br><br>
				...
				<td align="center" valign="top">
					<form name="form1" method="post" style="margin: 0;" action="listaRegistroPagosE.cfm" onSubmit="return validar();" >
