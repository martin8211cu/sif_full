...
<cfoutput>
<form style="margin: 0" action="gruposEmpresas.cfm" name="GEmpresas" method="post">
...
<script language="javascript" type="text/javascript">
	...
	function funcImprime(){
		location.href='gruposEmpresas-listado-sql.cfm';
		return false;
	}
	var f = document.GEmpresas;
	f.Codigo_F.focus();
</script>
