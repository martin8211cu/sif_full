...
<!---====================Eliminar  cta Homologacion=======================--->	
	<cfelseif isdefined("Form.Baja")>
		...
		<cflocation url="ANhomologacionCta.cfm?ANHid=#form.ANHid#&ANHCid=#form.ANHCid#">
		<cfset modo="ALTA">
<!---====================Modificar cta Homologacion=======================--->
	...
	<cfelseif isdefined("Form.VerCtas")>			
		<cflocation url="ANhomologacionCta.cfm?VER&ANHid=#form.ANHid#&ANHCid=#form.ANHCid#">
	<!---====================ANhomologacionFmts=======================--->		
...
<form action="ANhomologacionCta.cfm" method="post" name="sql">
