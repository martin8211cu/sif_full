...
<cfoutput>
<form style="margin: 0" action="gruposOficinas.cfm" name="Goficinas" method="post">
...
<script language="javascript" type="text/javascript">
	function funcNuevo(){
		location.href='gruposOficinas-form.cfm';
		return false;
	}
	function funcImprime(){
		location.href='gruposOficinas-listado-sql.cfm';
		return false;
	}
