...
<cfset strVersion = ListToArray(SERVER.ColdFusion.ProductVersion, ",") />
<cfset mayorVersion = strVersion[1]>
<cfset strWS = "anexosWS">
<cfif mayorVersion GT 8>
  <cfset strWS = "anexosWSCF11">
</cfif>
 ...
 <Worksheet ss:Name="SoinXLOP">
  <Table ss:ExpandedColumnCount="12" ss:ExpandedRowCount="#LvarRows#" x:FullColumns="1"
   ...
   <Row>
    ...
    <Cell><Data ss:Type="String">#LvarANserver#/cfmx/sif/an/WS/#strWS#.cfc?WSDL</Data></Cell>
   </Row>
   <Row>
