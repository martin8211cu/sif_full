<cfcomponent output="no">
	...
	<cffunction name="Version" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="Numero" 	type="string"  	required="yes">

		<!--- <cfset monitorObj = CreateObject("component","componentes.monitor")>
		<cfset monitorObj.dumpToFile("#Arguments.Numero#")> --->
		<cfset LvarVersionXLA = 0>
        <cftry>
			<cfset LvarVersionXLA = Arguments.Numero + 0>
        <cfcatch type="any">
        	<!--- <cfset monitorObj.dumpToFile("Error")> --->
    	</cfcatch>
        </cftry>
	...
	<cffunction name="GrabarAnexoDisenoRAN_2" access="remote" output="no" returntype="string">
		...
		<cfset arrRangos = listToArray(Arguments.Rangos, "|",false)>
		...
		<cfset LvarRangosN = arrayLen(arrRangos)>
		<cfloop index="i" from="1" to="#LvarRangosN#">
			<cfif arrRangos[i] EQ "EOF">
				<cfbreak>
			</cfif>

			<cfif arrRangos[i] NEQ ":">
				<cfset LvarRango = listToArray(arrRangos[i])>
				<!---
	...
	<cffunction name="GrabarAnexoDisenoXLS" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="AnexoId"  type="string" 	required="yes">
	...
	<cffunction name="sbGrabarAnexoDisenoXLS" access="private" output="no" returntype="string">
		<cfargument name="AnexoId"  type="string" 	required="yes">
		<cfargument name="XLS" 		type="binary"  	required="yes">
	...
	<cffunction name="GrabarAnexoDisenoZIP" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="AnexoId"  type="string" 	required="yes">
	...
	<cffunction name="sbGrabarAnexoDisenoZIP" access="private" output="no" returntype="string">
		<cfargument name="AnexoId"  type="string" 	required="yes">
		<cfargument name="ZIP" 		type="binary"  	required="yes">
	...
	<cffunction name="GrabarAnexoDisenoXLS_EnCalculo" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="ACid"  	type="string" 	required="yes">
		<cfargument name="XLS" 		type="binary"  	required="yes">
	...
	<cffunction name="GrabarAnexoDisenoZIP_EnCalculo" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="ACid"  	type="string" 	required="yes">
		<cfargument name="ZIP" 		type="binary"  	required="yes">
	...
	<cffunction name="LeerCalculos" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" type="string"  required="yes">
		<cfargument name="ACkey" type="string"  required="yes">
		<cfargument name="ACid"  type="string" required="yes">
		...
		<cfset LvarListCalculos = ArrayToList(LvarCalculos, "|")> 
		<cfset sbActualizarSeguridad (Arguments.WSkey, Arguments.ACkey, false)>
		<cfreturn LvarListCalculos>
	</cffunction>
	...
	<cffunction name="GrabarAnexoCalculoXLS" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="ACid"  	type="string" 	required="yes">
		<cfargument name="XLS" 		type="binary"  	required="yes">
	...
	<cffunction name="GrabarAnexoCalculoZIP" access="remote" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string"  	required="yes">
		<cfargument name="ACkey" 	type="string"  	required="yes">
		<cfargument name="ACid"  	type="string" 	required="yes">
		<cfargument name="ZIP" 		type="binary"  	required="yes">
...
--->
	...
	<cffunction name="sbVerificarSeguridad" access="private" output="no" returntype="string">
		<cfargument name="WSkey" 	type="string" 	required="yes">
		<cfargument name="ACkey" 	type="string" 	required="yes">
		<cfargument name="ACid"  	type="string"	required="yes">
	...
	<cffunction name="sbActualizarSeguridad" access="private" output="no" returntype="string">
		<cfargument name="WSkey" 		type="string"  required="yes">
		<cfargument name="ACkey" 		type="string"  required="yes">
