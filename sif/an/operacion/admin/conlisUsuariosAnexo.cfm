...
<cfquery name="lista" datasource="#session.DSN#">
	select  a.Usucodigo, b.Pnombre#_Cat#' '#_Cat#b.Papellido1#_Cat#' '#_Cat#b.Papellido2 as usuario
	from Usuario a	
		inner join DatosPersonales b
			on a.datos_personales = b.datos_personales
	where  a.CEcodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.CEcodigo#">
		and a.Usucodigo in (select Usucodigo
						from vUsuarioProcesos
						where SScodigo = 'SIF'
							and SMcodigo = 'AN'
							and Usucodigo = a.Usucodigo							
						)	
	<cfif isdefined("Form.Pnombre") and Len(Trim(Form.Pnombre)) NEQ 0>
	...
	order by b.Pnombre, b.Papellido1, b.Papellido2
</cfquery>
...
<cfinvoke 
 ...
 returnvariable="pListaEduRet">
	...
	<cfinvokeargument name="irA" value="conlisUsuariosAnexo.cfm"/>
