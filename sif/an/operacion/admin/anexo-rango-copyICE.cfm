...
<table width="793" border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="5" class="subTitulo">Copia de anexos </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="5">Utilice esta página para copiar las cuentas contables asignadas a cada celda del anexo. </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="5" class="subTitulo">Modificaciones al copiar </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
	  ...
	  <label for="sel_mes_modoR">
      Relativo:    </label></td>
    <td><input name="sel_mes_rel" type="text" id="sel_mes" size="10" maxlength="5" onfocus="this.select()" onchange="this.form.mod_mes.checked=true" />
(meses hacia delante)</td>
    <td rowspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td>
      <input name="sel_mes_modo" id="sel_mes_modoF" type="radio" value="F" />
      <label for="sel_mes_modoF">
      Fijo: </label></td>
    <td>
      ...
      <select name="sel_mes_ano" onchange="this.form.mod_mes.checked=true" >
	  <cfloop from="-10" to="-2" index="i">
