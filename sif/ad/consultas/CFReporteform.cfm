...
<cfquery name="rsReporte" datasource="#session.dsn#">
	select 
			...
			cf.Ocodigo,
			cf.CFdescripcion,
			cf.CFidresp, (select CFdescripcion from CFuncional where CFid= cf.CFidresp) as CFresponsable,
			cf.CFcuentac,
			cf.CFcuentaaf,
...
<cfelse>
	...
	-->
		...
		<cfoutput query="rsReporte" group="CFcodigo">
			<tr>
				<td height="26" align="left" nowrap="nowrap"><span class="style2">#repeatstring("&nbsp;&nbsp;&nbsp;",listlen(rsReporte.CFpath,"/")-1)##rsReporte.CFcodigo#</span></td>
				...
				<td align="left" style="font-size:9px"><span class="style2"><cfif isdefined('rsReporte.CFresponsable') and len(trim(rsReporte.CFresponsable))>#rsReporte.CFresponsable#</cfif></span></td>
			<cfif  isdefined ('form.gast')>
		...
		<cfif  isdefined ('form.inven') or isdefined ('form.inver') or isdefined ('form.act') or isdefined ('form.ingr') or isdefined ('form.Otrosingr') or isdefined ('form.Otrosgast')>
				<cfif isdefined ('form.inven')> 
					<tr>	
						...
						<td colspan="2" width="15%"  align="left" nowrap="nowrap" ><span class="style2">Cuenta Gasto x Consumo Inventario</span></td>
				...
				<cfif isdefined ('form.inver')> 
					<tr>				
						<td><span class="style2"></span></td>
						<td colspan="2" width="15%"  align="left" nowrap="nowrap" ><span class="style2">Cuenta Inversión x Compra Activo</span></td>
				...
				<cfif isdefined ('form.act')> 
					<tr>				
						<td><span class="style2"></span></td>
						<td colspan="2" width="15%"  align="left" nowrap="nowrap" ><span class="style2">Cuenta Gasto x Depreciación Activo</span></td>
				...
				<cfif isdefined ('form.Otrosingr')> 
					<tr>				
						<td><span class="style2"></span></td>
						<td colspan="2" width="15%"  align="left" nowrap="nowrap" ><span class="style2">Cuenta Ingreso por Retiro Activo</span></td>
				...
				<cfif isdefined ('form.Otrosgast')> 
					<tr>				
						<td><span class="style2"></span></td>
						<td colspan="2" width="15%"  align="left" nowrap="nowrap" ><span class="style2">Cuenta Gasto por Retiro Activo</span></td>
