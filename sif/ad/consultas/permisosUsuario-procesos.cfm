...
<table width="95%" align="center" cellpadding="3" cellspacing="0" border="0">
		<cfoutput query="data" group="Enombre">
			...
			<cfif not ( isdefined("form.empresa") and len(trim(form.empresa))) >
				<tr><td bgcolor="##CCCCCC" colspan="4" style="padding:4px;" ><strong>Empresa: #Enombre# </strong></td></tr>
			</cfif>
		...
		<cfif registros eq 0>
			<tr><td>&nbsp;</td></tr>
			<tr><td align="center" colspan="3">--- No se encontraron registros ---</td></tr>
			<tr><td>&nbsp;</td></tr>			
		<cfelse>
			<tr><td>&nbsp;</td></tr>
			<tr><td align="center" colspan="3">--- Fin de la consulta ---</td></tr>
			<tr><td>&nbsp;</td></tr>			
		</cfif>
		</cfoutput>		
</table>		
