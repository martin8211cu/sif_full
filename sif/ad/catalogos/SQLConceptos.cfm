...
<cfif not isdefined("Form.Nuevo")>
	<cfif isdefined("Form.Alta")>
		...
		<cfquery name="insConceptos" datasource="#Session.DSN#">
			insert into Conceptos (Ecodigo, Ccodigo, Cdescripcion, CCid, Ctipo, Ucodigo, Cimportacion, cuentac, Cformato, CcodigoAlterno, Cd151, Cporc,CexcostosAuto, CComodinExtra,codIEPS,afectaIVA,FlujoEfec,CGeneraSol,ClaveSAT)<!---Agregue FlujoEfec RVD--->
			values (
				 ...
				 <cfqueryparam cfsqltype="cf_sql_char" value="#Form.CcodigoAlterno#">,
                 <cfif isdefined("form.Cd151")>1,<cfelse>0,</cfif>
                 <cfqueryparam cfsqltype="cf_sql_double" value="#form.Cporc#" null="#Len(form.Cporc) eq 0#">,
                 <cfif isdefined("form.ExCostosAuto")>1<cfelse>0</cfif>,
                 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.ComodinExtra#">,
				 ...
				 <cfif isdefined("form.FlujoEfec")>1<cfelse>0</cfif>,<!---Agregue FlujoEfec RVD--->
				 <cfif isdefined("form.chkGenSol")>1<cfelse>0</cfif>,<!---SML. 12-02-2015. Modificacion para Nomina SES Mexico--->
	...
	<cfelseif isdefined("Form.Cambio")>
		...
		<cfquery name="updConceptos" datasource="#Session.DSN#">
			update Conceptos set
				...
				CcodigoAlterno = <cfqueryparam cfsqltype="cf_sql_char" value="#Form.CcodigoAlterno#">,
            	Cd151 = <cfif isdefined("form.Cd151")>1<cfelse>0</cfif>
                <cfif isdefined("form.costoA") and form.Ctipo eq "G">
                	,Cporc = <cfqueryparam cfsqltype="cf_sql_double" value="#form.Cporc#" null="#Len(form.Cporc) eq 0#">
                </cfif>
                ,CexcostosAuto = <cfif isdefined("form.ExCostosAuto")>1<cfelse>0</cfif>
                ,CComodinExtra = <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.ComodinExtra#">
				...
				,FlujoEfec = <cfif isdefined("form.FlujoEfec")>1<cfelse>0</cfif>
                ,CGeneraSol = <cfif isdefined("form.chkGenSol")>1<cfelse>0</cfif><!---SML. 12-02-2015. Modificacion para Nomina SES Mexico--->
		...
		<cfquery name="updGEconceptoGasto" datasource="#Session.DSN#">
			update GEconceptoGasto set
				GECdescripcion=<cf_jdbcquery_param LEN="30" cfsqltype="cf_sql_varchar" value="#Form.Cdescripcion#">
