			...
			<cfloop query="niveles">
				<cfquery name="rsExiste" datasource="#session.DSN#">
					...
					where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
                        ...
                        and Cid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.cid_c#">
				</cfquery>
								
				<cfif rsExiste.RecordCount GT 0>
					<cfset Request.Error.Backs = 1>
					<cfthrow message="La clasificación y concepto de servicio ya han sido asignados">
				<cfelse>		
					<cfquery name="insert" datasource="#Session.DSN#">
						insert into ClasificacionItemsProv (Ecodigo,SNcodigo,CCid,Ccodigo,nivel,BMUsucodigo,fechaalta,AClaId, Cid)
							values(	<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#" >,
									...
									null,
                                    <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.Cid_C#">
									)	
					</cfquery>
				</cfif>
			</cfloop>
...
<form action="ClasificacionSocioNeg.cfm" method="post" name="sql">
	...
	<input type="hidden" name="SNcodigo" value="<cfif isdefined("Form.SNcodigo")>#Form.SNcodigo#</cfif>">
</form>
</cfoutput>
