...
<cfinvoke key="La_oficina_no_puede_ser_borrada_debido_a_que_posee_registros_asociados." default="La oficina no puede ser borrada debido a que posee registros asociados." returnvariable="LB_ErrorOficina" component="sif.Componentes.Translate" method="Translate"/>

<!--- Validacion para que el Numero de guia contenga siempre 5 caracteres --->
<cfif len(form.ONumGuia) lt 5>
	<cfset form.ONumGuia = trim(RepeatString('0',5-len(form.ONumGuia))&form.ONumGuia)>
</cfif>
...
<cfif not isdefined("Form.Nuevo")>
	<cfif isdefined("Form.Alta")>
		...
		<cfif rsOficodigo.RecordCount LTE 0>
			...
			<cf_direccion action="readform" form="form" name="direccion">
			<cf_direccion action="insert" form="form" data="#direccion#" name="direccion">
			...
			<cfquery name="rsAlta" datasource="#Session.DSN#">
				...
				,Onumpatronal, Oadscrita, Onumpatinactivo, ZEid, SScodigo, SRcodigo, RHRiesgoid,ONumGuia)
				values
				(
					 #session.Ecodigo# ,
                     ...
                     <cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.tipoRiesgo#">,
					 <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.ONumGuia#">
				 )
			 </cfquery>
             ...
             <cfinvoke component="sif.Componentes.DatosVariables" method="GETVALOR" returnvariable="CamposForm">
                ...
                <cfinvokeargument name="DVVidTablaVal"  value="#rsCont.Cont#">
	...
	<cfelseif isdefined("Form.Baja")>
		<cftry>
			...
			<cfcatch type="any">
			 <cf_throw message="#LB_ErrorOficina#" errorcode="59">
			</cfcatch>
		</cftry>
	...
	<cfelseif isdefined("Form.Cambio")>
		...
		<cf_direccion action="readform"  form="form" name="direccion">
		<cf_direccion action="update" form="form" data="#direccion#" name="direccion">
		...
		<cfquery name="rsCambio" datasource="#Session.DSN#">
			update Oficinas set
                ...
                RHRiesgoid		= <cfif isdefined("form.tipoRiesgo") and len(trim(form.tipoRiesgo))><cfqueryparam cfsqltype="cf_sql_numeric" value="#Form.tipoRiesgo#"><cfelse>null</cfif>,
				ONumGuia		= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.ONumGuia#">
			where Ecodigo = #Session.Ecodigo#
				and Ocodigo = <cfqueryparam value="#Form.Ocodigo#" cfsqltype="cf_sql_integer">
        ...
        <cfinvoke component="sif.Componentes.DatosVariables" method="GETVALOR" returnvariable="CamposForm">
           <cfinvokeargument name="DVTcodigoValor" value="OF">
           <cfinvokeargument name="Tipificacion"   value="#Tipificacion#">
           <cfinvokeargument name="DVVidTablaVal"  value="#Form.Ocodigo#">
           <cfinvokeargument name="DVVidTablaSec" 	value="0">
        </cfinvoke>
