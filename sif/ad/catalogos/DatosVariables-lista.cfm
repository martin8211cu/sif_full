...
<cfif isdefined('form.Filtro_DVcodigo') and len(trim(form.Filtro_DVcodigo))>
	<cfset filtro = filtro & " and upper(DVcodigo) like '%#ucase(form.Filtro_DVcodigo)#%'">
</cfif>
<cfif isdefined('form.Filtro_DVdescripcion') and len(trim(form.Filtro_DVdescripcion))>
	<cfset filtro = filtro & " and upper(DVdescripcion) like '%#ucase(form.Filtro_DVdescripcion)#%'">
</cfif>	
...
<cfquery name="ListaDV" datasource="#session.dsn#">
	select DVid , DVcodigo, DVdescripcion, 
...
<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" >
		...
		<cfinvokeargument name="desplegar" 			value="DVcodigo, DVdescripcion, DVtipoDato, DVobligatorio"/>
