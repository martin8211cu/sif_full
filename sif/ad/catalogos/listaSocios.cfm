...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Corporativo" Default= "Corporativo" XmlFile="listaSocios.xml" returnvariable="LB_Corporativo"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Requeridos" Default= "Requeridos" XmlFile="listaSocios.xml" returnvariable="LB_Requeridos"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Alertas" Default= "Alertas" XmlFile="listaSocios.xml" returnvariable="LB_Alertas"/>
...
<cfelseif isdefined('session.menues.smcodigo') and session.menues.smcodigo EQ 'CC'>
	<cfset vFiltro = "and (sn.SNtiposocio = 'C' or sn.SNtiposocio = 'A')">
<cfelseif isdefined('session.LvarModulo') and session.LvarModulo EQ 'CP'>
	<cfset vFiltro = "and (sn.SNtiposocio = 'P' or sn.SNtiposocio = 'A')">
<cfelseif isdefined('session.menues.smcodigo') and session.menues.smcodigo EQ 'CP'>
	<cfset vFiltro = "and (sn.SNtiposocio = 'P' or sn.SNtiposocio = 'A')">
</cfif>
			<cfinvoke
				...
				<cfinvokeargument name="filtro" value="Ecodigo=#session.Ecodigo# #vFiltro# order by SNnumero, SNnombre"/>
				<cfinvokeargument name="desplegar" value="SNnumero, SNnombre, SNidentificacion, SNtiposocio, Usuario, corp, requeridos, alertas, esp"/>
				<cfinvokeargument name="etiquetas" value="#LB_Numero#, #LB_Nombre#, #LB_Identificacion#, #LB_Tipo#, #LB_Usuario#, #LB_Corporativo#, #LB_Requeridos#,  #LB_Alertas#,  "/>
