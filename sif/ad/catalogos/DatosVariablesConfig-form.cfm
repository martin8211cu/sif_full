		...
		<cfif isdefined('url.DVTcodigo') and len(trim(url.DVTcodigo)) GT 0>
			...
			<tr>
				...
				<cfelse>
					...
					<cfelseif ListFind('FA,FA_CLASIF,FA_CONCEP', url.DVTcodigo)>
                    	<cfinclude template="DatosVariablesConfig-FA.cfm">
                    <cfelseif ListFind('OF', url.DVTcodigo)>
                    	<cfinclude template="DatosVariablesConfig-OF.cfm">    
                    <cfelse>
