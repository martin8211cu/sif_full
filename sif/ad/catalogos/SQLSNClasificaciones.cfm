...
<cfif isdefined("Form.Alta")>
	...
	<cftransaction>
		<cfif (isDefined('form.hayCredCob') and form.hayCredCob eq 1)>
			<cfquery datasource="#session.DSN#">
				update  SNClasificacionE
				set SNCredyC = 0
		...
		<cfquery name="rsinsert" datasource="#Session.DSN#">
			insert into SNClasificacionE (Ecodigo, CEcodigo, SNCEcodigo, SNCEdescripcion, SNCEcorporativo, PCCEobligatorio, 
										  PCCEactivo, SNCEalertar, PCEcatid, UsucodigoInclusion, SNCtiposocio, BMUsucodigo, SNCredyC)
			values (
...
<cfelseif isdefined("Form.Cambio")>
	...
	<cfquery name="ABC_SNClasificacion" datasource="#Session.DSN#">
		update SNClasificacionE set 
			...
			SNCredyC	 = <cfif isdefined("Form.SNCredyC")>
								 <cfqueryparam cfsqltype="cf_sql_numeric" value="1">
							<cfelse>
								 <cfqueryparam cfsqltype="cf_sql_numeric" value="0">
							</cfif>
