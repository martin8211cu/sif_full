...
<form action="SQLParametrosCuentasAD.cfm" method="post" name="form1">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td><div align="right">Cuenta Utilidad del Periodo para Reportes:</div></td>
    ...
    <tr> 
	  <cfset hayCuentaUtilAnterior = 0 >
      <cfset cuenta301 = ObtenerCuenta(301)>
	  <cfif cuenta301.RecordCount GT 0 >
        <cfset hayCuentaUtilAnterior = 1 >
      </cfif>
	  
	  <cfset hayCuentaIngresosYGastos = 0 >
      <cfset cuenta302 = ObtenerCuenta(302)>
	  <cfif cuenta302.RecordCount GT 0 >
        <cfset hayCuentaIngresosYGastos = 1 >
      </cfif>
	  
	  <cfset hayCuentaAhorroGestion = 0 >
      <cfset cuenta303 = ObtenerCuenta(303)>
	  <cfif cuenta303.RecordCount GT 0 >
        <cfset hayCuentaIngresosYGastos = 1 >
      </cfif>
	  	  
	  <cfset hayCuentaDesahorroGestion = 0 >
      <cfset cuenta304 = ObtenerCuenta(304)>
	  <cfif cuenta304.RecordCount GT 0 >
        <cfset hayCuentaDesahorroGestion = 1 >
      </cfif>
	  
	  <cfset hayCuentaUtilResAhorro = 0 >
      <cfset cuenta305 = ObtenerCuenta(305)>
	  <cfif cuenta305.RecordCount GT 0 >
        <cfset hayCuentaUtilResAhorro = 1 >
      </cfif>
	  
	    <cfset hayCuentaUtilResDesahorro = 0 >
      <cfset cuenta306 = ObtenerCuenta(306)>
	  <cfif cuenta306.RecordCount GT 0 >
        <cfset hayCuentaUtilResdesahorro = 1 >
      </cfif>
	  
      <td><div align="right">Tipo Cierre Anual de Resultados:</div></td>
      <td>
		<select name="TipoCierre" onchange="document.getElementById('divUAC').style.visibility='visible',
document.getElementById('divUPA').style.visibility=(this.value == '0')?'hidden':'visible', 
document.getElementById('divREU').style.visibility=(this.value == '0' || this.value == '1')?'hidden':'visible',
document.getElementById('divREP').style.visibility=(this.value == '0' || this.value == '1')?'hidden':'visible',
document.getElementById('divCIG').style.visibility=(this.value == '0' || this.value == '1')?'hidden':'visible', document.getElementById('divCAH').style.visibility=(this.value == '0' || this.value == '1')?'hidden':'visible',
document.getElementById('divCDA').style.visibility=(this.value == '0' || this.value == '1')?'hidden':'visible';" >
			<option value="0"<cfif cuenta301.Ccuenta EQ ""> selected</cfif>>Cerrar Resultados únicamente contra Utilidad Acumulada</option>
			<option value="1"<cfif cuenta301.Ccuenta NEQ "" and cuenta302.Ccuenta EQ ""> selected</cfif>>Resultados contra Utilidad Período Anterior y esta contra Utilidad Acumulada Períodos Trasanteriores</option>
			<option value="2"<cfif cuenta301.Ccuenta NEQ "" and cuenta302.Ccuenta NEQ ""> selected</cfif>>Cerrar Resultados contra Cuenta de Resumen de Ingresos y Gastos</option>
		</select>
	  </td>
    </tr>
    ...
    <tr> 
      ...
      <td>
	  	<div id="divUAC" <cfif hayCuentaUtilAcumulada NEQ 1>style="visibility:visible"</cfif>> 
	  	<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta#" auxiliares="N" movimiento="S" frame="frame5" ccuenta="CcuentaUtilAcumulada" cdescripcion="CdescripcionUtilAcumulada" cformato="CformatoUtilAcumulada">
		</div>
		<input type="hidden" name="hayCuentaUtilAcumulada" value="<cfoutput>#hayCuentaUtilAcumulada#</cfoutput>">
	  </td>	
	    
    </tr>
	
	<tr> 
      <td><div align="right">Cuenta de Utilidad Período Anterior:</div></td>
      <td>
	  	<div id="divUPA" <cfif hayCuentaUtilAnterior NEQ 1>style="visibility:visible"</cfif>>
			<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta301#" auxiliares="N" movimiento="S" frame="frame5b" ccuenta="CcuentaUtilAnterior" cdescripcion="CdescripcionUtilAnterior" cformato="CformatoUtilAnterior">
		</div>
		<input type="hidden" name="hayCuentaUtilAnterior" value="<cfoutput>#hayCuentaUtilAnterior#</cfoutput>">
	  </td>
    </tr>
	
	<!--- cuenta de resultado ejercicio utilidad---->
	<tr> 	 
	  <td><div align="right">Resultados del Ejercicio Utilidad (Ahorro):</div></td>
	  <td>
	  	 <div id="divREU" <cfif hayCuentaUtilResAhorro NEQ 1>style="visibility:visible"</cfif>> 
	  	<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta305#" auxiliares="N" movimiento="S" frame="frame5a1" ccuenta="CcuentaResulAhorro" cdescripcion="CdescripcionResulAhorro" cformato="CformatoResulAhorro">
		</div>
		<input type="hidden" name="hayCuentaUtilResAhorro" value="<cfoutput>#hayCuentaUtilResAhorro#</cfoutput>">		
	  </td>		  
    </tr>
	
	<!--- cuenta de resultado ejercicio perdida--->
	<tr> 
	  <td><div align="right">Resultados del Ejercicio Perdida (Desahorro):</div></td>
	  <td>
	  	<div id="divREP" <cfif hayCuentaUtilResDesahorro NEQ 1>style="visibility:visible"</cfif>> 
	  	<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta306#" auxiliares="N" movimiento="S" frame="frame5a2" ccuenta="CcuentaResulDesahorro" cdescripcion="CdescripcionResulDesahorro" cformato="CformatoResulDesahorro">
		</div>
		<input type="hidden" name="hayCuentaUtilResDesahorro" value="<cfoutput>#hayCuentaUtilResDesahorro#</cfoutput>">		
	  </td>	 	 
    </tr>
	
	<!--- cuenta de ingresos y gastos---->
	<tr> 
	   	<td><div align="right">Cuenta de Resumen de Ingresos y Gastos:</div></td>
		<td>
		   <div id="divCIG" <cfif hayCuentaIngresosYGastos NEQ 1>style="visibility:visible"</cfif>>
		 	<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta302#" auxiliares="N" movimiento="S" frame="frame5c" ccuenta="CcuentaIngresosYGastos" cdescripcion="CdescripcionCtaIngresosYGastos" cformato="CformatoIngresosYGastos">
		 	</div>
			<input type="hidden" name="hayCuentaIngresosYGastos" value="<cfoutput>#hayCuentaIngresosYGastos#</cfoutput>">			
		 </td>		 
	</tr>	 
	
	<!--- cuenta de ahorro de la gestión---->	 	
	<tr>			
		<td><div align="right">Cuenta de Ahorro de la Gestión:</div></td>
		<td>
			<div id="divCAH" <cfif hayCuentaAhorroGestion NEQ 1>style="visibility:visible"</cfif>>
		 		<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta303#" auxiliares="N" movimiento="S" frame="frame5d" ccuenta="CcuentaAhorroGestion" cdescripcion="CdescripcionCtaAhorroGestion" cformato="CformatoAhorroGestion">
	  	    </div>
			<input type="hidden" name="hayCuentaAhorroGestion" value="<cfoutput>#hayCuentaAhorroGestion#</cfoutput>">
		</td>		
	 </tr>
	
	<!--- cuenta de desahorro de la gestión--->
	<tr> 
    	<td><div align="right">Cuenta de Desahorro de la Gestión:</div></td>
	    <td>
			<div id="divCDA" <cfif hayCuentaDesahorroGestion NEQ 1>style="visibility:visible"</cfif>>
		 		<cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta304#" auxiliares="N" movimiento="S" frame="frame5e" ccuenta="CcuentaDesahorroGestion" cdescripcion="CdescripcionCtaDesahorroGestion" cformato="CformatoDesahorroGestion">
	  	    </div>
			<input type="hidden" name="hayCuentaDesahorroGestion" value="<cfoutput>#hayCuentaDesahorroGestion#</cfoutput>">
		</td>		
	 </tr>
...
<script language="JavaScript1.2">
	function valida() {
		...
		<!---if (document.form1.TipoCierre.value == 0) {
			if (document.form1.CcuentaUtilAcumulada.value == ''){
				if (document.form1.CcuentaUtilAcumulada.value == ''){
					Mensaje ='\nDebe digitar la Cuenta de Utilidad Acumulada';
				}
				alert(Mensaje);
				return false;
			}
		...
		if (document.form1.TipoCierre.value == 1) {
			if (document.form1.CcuentaUtilAnterior.value == '' || document.form1.CcuentaUtilAcumulada.value == ''){
				var Mensaje = 'Debe digitar las siguientes cuentas:';
				if (document.form1.CcuentaUtilAcumulada.value == ''){
					Mensaje = Mensaje + '\nCuenta de Utilidad Acumulada';
				}
				if (document.form1.CcuentaUtilAnterior.value == ''){
					Mensaje = Mensaje + '\nCuenta de Utilidad Anterior';
				}
				alert(Mensaje);
				return false;
			}
		...
		if (document.form1.TipoCierre.value == 2) {
			if (document.form1.CcuentaIngresosYGastos.value == '' || document.form1.CcuentaAhorroGestion.value == '' || document.form1.CcuentaDesahorroGestion.value == '' || document.form1.CcuentaResulAhorro.value == '' || document.form1.CcuentaResulDesahorro.value == ''){
				var Mensaje = 'Debe digitar las siguientes cuentas:';
				if (document.form1.CcuentaIngresosYGastos.value == ''){
					Mensaje = Mensaje + '\nCuenta de Resumen de Ingresos y Gastos';
				}
				if (document.form1.CcuentaAhorroGestion.value == ''){
					Mensaje = Mensaje + '\nCuenta Ahorro de la Gestion';
				}
				if (document.form1.CcuentaDesahorroGestion.value == ''){
					Mensaje = Mensaje + '\nCuenta Desahorro de la Gestion';
				}
				if (document.form1.CcuentaResulAhorro.value ==''){
					Mensaje = Mensaje + '\nCuenta Resultados del Ejercicio Utilidad (Ahorro)';
				}
				if (document.form1.CcuentaResulDesahorro.value ==''){
					Mensaje = Mensaje + '\nCuenta Resultados del Ejercicio Perdida (Desahorro)';
				}
				alert(Mensaje);
				return false;
			}
