...
<cfquery name="rsSNegociosObj" datasource="#session.DSN#">
	...
	'<img alt=''Descargar Archivo'' border=''0'' src=''../../imagenes/descargar.png'' height=''16'' width=''16'' onClick=''javascript:descargar('
		...
		<cfelse>
			...
			<cfinvoke
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="desplegar" value="nombre_archivo, SNOdescripcion, imagen"/>
				<cfinvokeargument name="etiquetas" value="#LB_FileName#, #LB_DESCRIPCION#, #LB_Descar#"/>
