			...
			<cftransaction>
				<cfquery name="rsInsertSNLC" datasource="#session.DSN#">
					...
					values(
							...
							<cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNLtotal,',','','all')#">,
							<cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNmontoLimiteCC,',','','all')#">,
							<cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNLadicional,',','','all')#">,
		...
		<cfif rsExisteLimite.Cantidad EQ 0>
			...
			<cfquery name="rsUpdateSNLC" datasource="#session.DSN#">
				...
				set Vigente 	 = <cfif isdefined('form.Vigente')>1<cfelse>0</cfif>,
					...
					SNLtotal 	 = <cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNLtotal,',','','all')#">,
					SNLactual 	 = <cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNmontoLimiteCC,',','','all')#">,
					SNLadicional = <cfqueryparam cfsqltype="cf_sql_money" value="#Replace(Form.SNLadicional,',','','all')#">,
