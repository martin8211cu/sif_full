...
<cfquery datasource="#session.dsn#" name="selectNuevo">
	select
		...
		id_direccion, EcodigoInclusion, SNinclusionAutoriz, SNidEquivalente, SNidCorporativo 
	from SNegocios
...
<cfquery datasource="#session.dsn#" name="nuevo">
	insert into SNegocios (
       ...
       <cfqueryparam       cfsqltype="cf_sql_blob"              value="#selectNuevo.SNdocAsociadoCC#"     null="#not isdefined('form.SNdocAsociadoCC')#">,
