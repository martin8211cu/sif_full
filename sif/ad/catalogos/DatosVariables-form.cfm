...
<cfif modo EQ 'CAMBIO'>
	<cfquery name="DV" datasource="#session.dsn#">
		select DVid , DVcodigo, DVdescripcion, DVetiqueta, DVencabezado, DVtipoDato, DVlongitud, DVdecimales, DVmascara, DVobligatorio, DVexplicacion
		from DVdatosVariables
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr><td>Codigo:		</td><td><input name="DVcodigo" 	 type="text" value="<cfoutput>#DV.DVcodigo#</cfoutput>" 	 size="30" maxlength="10"> </td></tr>
	<tr><td>Descripción:</td><td><input name="DVdescripcion" type="text" value="<cfoutput>#DV.DVdescripcion#</cfoutput>" size="30" maxlength="100"></td></tr>
	<tr><td>Etiqueta:	</td><td><input name="DVetiqueta" 	 type="text" value="<cfoutput>#DV.DVetiqueta#</cfoutput>" 	 size="30" maxlength="40"> </td></tr>
	<tr><td>Encabezado:	</td><td><input name="DVencabezado"  type="text" value="<cfoutput>#DV.DVencabezado#</cfoutput>"  size="30" maxlength="20"> </td></tr>
...
<cf_qforms>
	<cf_qformsRequiredField name="DVcodigo" 	 description="Codigo">
	<cf_qformsRequiredField name="DVdescripcion" description="Descripción">
	<cf_qformsRequiredField name="DVetiqueta" 	 description="Etiqueta">
	<cf_qformsRequiredField name="DVencabezado"  description="Encabezado">
...
<script language="JavaScript" type="text/javascript">
	function showChkbox(f) {
		...
		Mask_1.attach(document.form1.DVcodigo, Mask_1.mask, "string");
		Mask_1.attach(document.form1.DVencabezado, Mask_1.mask, "string");
