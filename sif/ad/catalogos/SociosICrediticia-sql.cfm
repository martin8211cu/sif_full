...
<cftransaction>
	...
	<cfquery name="update" datasource="#Session.DSN#">
		update SNegocios set  
            ...
            <cfif form.SNtiposocio NEQ 'C' and form.SNcodigo NEQ 9999> 
            	<cfif isdefined("Form.chkRemision")>
            remisionProveedor  = <cfqueryparam cfsqltype="cf_sql_integer" value="#Form.chkRemision#" null="#len(trim(form.chkRemision)) EQ 0#">,
            	intfazLD=2,
            	<cfelse>
                	remisionProveedor  = 0,
                    intfazLD=0,
