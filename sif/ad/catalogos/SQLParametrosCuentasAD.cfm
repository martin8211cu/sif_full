<cfif isDefined("Form.Aceptar")>
	...
	<cftry>		
		...
		<cfif isDefined("Form.hayCuentaIngresosYGastos") and Len(Trim(hayCuentaIngresosYGastos)) GT 0>
			<cfif form.TipoCierre EQ "0" or form.TipoCierre EQ "1">
				<cfset Form.CcuentaIngresosYGastos = "">
			</cfif>
			<cfif Form.hayCuentaIngresosYGastos EQ "1">
				<cfset a = updateCuenta(302,Form.CcuentaIngresosYGastos)>
			<cfelseif Form.hayCuentaIngresosYGastos EQ "0">
				<cfset b = insertCuenta(302,'CG','Cuenta de Resumen de Ingresos y Gastos',Form.CcuentaIngresosYGastos)>
			</cfif>
		</cfif>
		
		<cfif isDefined("Form.hayCuentaAhorroGestion") and Len(Trim(hayCuentaAhorroGestion)) GT 0>
			<cfif form.TipoCierre EQ "0" or form.TipoCierre EQ "1">
				<cfset Form.CcuentaAhorroGestion = "">
			</cfif>
			<cfif Form.hayCuentaAhorroGestion EQ "1">
				<cfset a = updateCuenta(303,Form.CcuentaAhorroGestion)>
			<cfelseif Form.hayCuentaAhorroGestion EQ "0">
				<cfset b = insertCuenta(303,'CG','Cuenta de Ahorro de la Gestion',Form.CcuentaAhorroGestion)>
			</cfif>
		</cfif>
		
		<cfif isDefined("Form.hayCuentaDesahorroGestion") and Len(Trim(hayCuentaDesahorroGestion)) GT 0>
			<cfif form.TipoCierre EQ "0" or form.TipoCierre EQ "1">
				<cfset Form.CcuentaDesahorroGestion = "">
			</cfif>
			<cfif Form.hayCuentaDesahorroGestion EQ "1">
				<cfset a = updateCuenta(304,Form.CcuentaDesahorroGestion)>
			<cfelseif Form.hayCuentaDesahorroGestion EQ "0">
				<cfset b = insertCuenta(304,'CG','Cuenta de Desahorro de la Gestion',Form.CcuentaDesahorroGestion)>
			</cfif>
		</cfif>
		
		<cfif isDefined("Form.hayCuentaUtilResAhorro") and Len(Trim(hayCuentaUtilResAhorro)) GT 0>
			<cfif form.TipoCierre EQ "0" or form.TipoCierre EQ "1">
				<cfset Form.CcuentaResulAhorro = "">
			</cfif>
			<cfif Form.hayCuentaUtilResAhorro EQ "1">
				<cfset a = updateCuenta(305,Form.CcuentaResulAhorro)>
			<cfelseif Form.hayCuentaUtilResAhorro EQ "0">
				<cfset b = insertCuenta(305,'CG','Resultado del Ejercicio Utilidad (Ahorro)',Form.CcuentaResulAhorro)>
			</cfif>
		</cfif>
		
		<cfif isDefined("Form.hayCuentaUtilResDesahorro") and Len(Trim(hayCuentaUtilResDesahorro)) GT 0>
			<cfif form.TipoCierre EQ "0" or form.TipoCierre EQ "1">
				<cfset Form.CcuentaResulDesahorro = "">
			</cfif>
			<cfif Form.hayCuentaUtilResDesahorro EQ "1">
				<cfset a = updateCuenta(306,Form.CcuentaResulDesahorro)>
			<cfelseif Form.hayCuentaUtilResDesahorro EQ "0">
				<cfset b = insertCuenta(306,'CG','Cuenta de Desahorro de la Gestion',Form.CcuentaResulDesahorro)>
			</cfif>
		</cfif>

		<cfif isDefined("Form.hayCuentaUtilAnterior") and Len(Trim(form.hayCuentaUtilAnterior)) GT 0>
			<!---<cfthrow message="TIPO CIERRE #form.TipoCierre# anterior #Form.hayCuentaUtilAnterior#">--->
			<cfif form.TipoCierre EQ "0" OR Form.CcuentaUtilAnterior EQ Form.CcuentaUtilAcumulada>
				<cfset Form.CcuentaUtilAnterior = "">
			</cfif>
			<cfif Form.hayCuentaUtilAnterior EQ "1">				
				<cfset a = updateCuenta(301,Form.CcuentaUtilAnterior)>
			<cfelseif Form.hayCuentaUtilAnterior EQ "0">
				<cfset b = insertCuenta(301,'CG','Cuenta de Utilidad del Periodo Anterior',Form.CcuentaUtilAnterior)>
			</cfif>
		</cfif>
