...
<table width="67%" height="75%" align="center" cellpadding="1" cellspacing="0" border="0">
  ...
  <tr>
    ...
    <tr>
        <td>&nbsp;</td>
        <td align="right" nowrap><cf_translate key="LB_Tipo_de_Riesgo">Tipo de Riesgo</cf_translate>:</td>
    	<td>&nbsp;</td>
        <td>
            <cfquery name="rsTpoRiesgo" datasource="#session.DSN#">
				...
				and RHRiesgoid > 0 <!--- Debe existir un registro en la bd con valor 0 RHRiesgoid el cual perimitir� guardar sin elegir riegos y en la vista solo se muestran los valores del 1 para arriba--->
            ...
            <select name="tipoRiesgo">
                ...
                <cfloop query="rsTpoRiesgo">
                    <option value="#rsTpoRiesgo.RHRiesgoid#" <cfif modo NEQ "ALTA" and rsTpoRiesgo.RHRiesgoid eq rsOficinas.RHRiesgoid >selected</cfif> >#rsTpoRiesgo.RHRiesgocodigo# #rsTpoRiesgo.RHRiesgodescripcion#</option>
                </cfloop>
            </select>
        </td>
    	<td>&nbsp;</td>
 ...
 <tr>
	<td>&nbsp</td>
	<td align="right" nowrap><cf_translate key="LB_NumeroGuia">N&uacute;mero de Gu&iacute;a</cf_translate></td>
	<td>&nbsp</td>
	<td><input type="text" maxlength="5" size="10" name="ONumGuia" id="ONumGuia" value="<cfif modo neq 'ALTA'>#rsOficinas.ONumGuia#</cfif>"></td>
	<td>&nbsp</td>
 </tr>
 <tr>
 	<td>&nbsp;</td>
 ...
 <!---Se agrega el rol para autorizador de tramites--->
  ...
  <tr>
    ...
    <td colspan="3">
      ...
      <cfif #modo# NEQ "ALTA">
        <cf_direccion action="input" key="#rsOficinas.id_direccion#" form="form" title="" tabindex="1">
        <cfelse>
        <cf_direccion action="input" form="form" title="" tabindex="1">
      </cfif>
    </td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td  nowrap colspan="3" align="center"><strong>Datos Variables</strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  	  <td>&nbsp;</td>
...
<!--- *************************************************** --->
  ...
  <tr valign="baseline">
    <td colspan="5" align="center" nowrap>
      ...
      <input name="importar" value="Importar" class="btnNormal" type="button" onclick="funcImportar();">
  		<cfif modo neq "ALTA">
      		<input name="CargosOP" value="Cargos por Oficina" class="btnNormal" type="button" onclick="funcCargosOP();">
        </cfif>
    </td>
  </tr>
  <cfif modo neq "ALTA">
  ...
  <!---<cfif Cantidad GT 0>
	<cfinvoke component="sif.Componentes.DatosVariables" method="QformDatoVariable">
		...
		<cfinvokeargument name="objForm" 		value="form">
	</cfinvoke>
  </cfif>--->
  </form>
</cfoutput>
...
<cf_qforms form="form">
	...
	<cf_qformsRequiredField name="estado" description="#MSG_Estado#">
</cf_qforms>
...
<script type="text/javascript" language="javascript">
	function funcCargosOP(){
		document.form.action = "/cfmx/sif/ad/catalogos/CargaOficina.cfm<cfif isdefined("Form.Ocodigo")>?Ocodigo=#Form.Ocodigo#</cfif>";
		document.form.submit();
		}
</script>