...
<cfif not isdefined("Form.NuevoDireccion")>
	<cfif isdefined("Form.AltaDireccion")>
		...
		<cftransaction>
		<cfquery datasource="#session.dsn#" name="insertDir">
		...
		<cfquery datasource="#session.dsn#" name="insertDir">
			select top(1) id_direccion from SNDirecciones 
				where SNcodigo = <cfqueryparam value="#Form.SNcodigo#" cfsqltype="cf_sql_integer">
				order by id_direccion desc;
		</cfquery>
		<cfset insertDirID = insertDir.id_direccion>
		<cfif isDefined('form.SNDprincipal')>
			<cfquery datasource="#session.dsn#">
				Update SNegocios set 
					  id_direccion = <cfqueryparam cfsqltype="cf_sql_numeric" value="#insertDirID#">
	...
	<cfelseif isdefined("Form.CambioDireccion")>
		...
		<!---
		--->
		<cf_sifdireccion action="select" name="la_direccion" key="#form.id_direccion#">
		<cfif isDefined('form.SNDprincipal')>
			<cfquery datasource="#session.dsn#">
				Update SNegocios set 
