<script language="JavaScript1.2" type="text/javascript">
	...
	function AgregarComboPROY(combo,codigo) {
		...
		combo.length=0;
		<cfoutput query="rsCTA">
			if ((#Trim(rsCTA.LLAVE)#==codigo) && (#rsCTA.CGE5COD#==document.form1.CGE5COD.value) && (#Trim(rsCTA.CP6RUB)#==document.form1.CP6RUB.value) &&(#Trim(rsCTA.CP7SUB)#==document.form1.CP7SUB.value)) {
