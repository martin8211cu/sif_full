...
<script language="JavaScript" type="text/javascript">
	...
	function doCJC_Conlis<cfoutput>#Attributes.name#</cfoutput>() {
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/V5/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>.cfm"+params,250,200,650,400);
	}
	...
	function TraeDescripcion<cfoutput>#Attributes.name#</cfoutput>(dato) {
		...
		if (dato != "") {
			...
			frame.src = "/cfmx/sif/V5/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>query.cfm?dato="+dato+"&form="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
