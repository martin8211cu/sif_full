...
<cf_templateheader title="SIF - Cuentas por Pagar">
				...
				<td valign="top">						
					<cfparam name="PageNum_rsLineas" default="1">
						<cfif isDefined("Form.Aplicar") and Len(Trim(Form.IDpago)) NEQ 0>
                            ...
                            <!---<cf_dump var = "#Form#">--->
							<!--- ejecuta el proc.--->
							<cfinvoke component="sif.Componentes.CP_PosteoDocsFavorPagosAnticipos"
		...
		<table width="100%" border="0">
			<tr>
				<td valign="top">
					<cfset regresar = "listaDocsAfavorPagosAnticipos.cfm">
					<cfinclude template="../../portlets/pNavegacionCP.cfm">
				</td>
			</tr>
			<tr><td width="77%" valign="top"> <cfinclude template="formDocsAfavorPagosAnticipos.cfm"></td></tr>
			<cfif Len(Trim("IDpago")) NEQ 0>
				<cfif modo NEQ "ALTA">
