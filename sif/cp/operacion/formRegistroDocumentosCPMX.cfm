...
var popUpWin=0; 
	...
	function Verifica(){
		...
		else if (document.form1.DDtipo.value == 'F'){ 
			document.form1.CFcodigo.disabled = false;
			document.form1.Ecodigo_CcuentaD.disabled = false;
			document.getElementById("imagenCxP").style.visibility = "visible";
			document.getElementById('hhref_CcuentaD').style.visibility = "visible";
		...
		else if (document.form1.DDtipo.value == 'P'){
			document.form1.CFcodigo.disabled = false;
			document.form1.Ecodigo_CcuentaD.disabled = false;
			document.getElementById("imagenCxP").style.visibility = "visible";
			}
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="39%"><cfoutput>
                ...
                <!--- <input name="Folio" <cfif modo NEQ "ALTA"> class="cajasinborde" readonly tabindex="-1" <cfelse> 
				tabindex="1"</cfif> type="text" value="<cfif modo NEQ "ALTA">#rsDocumento.folio#<cfelseif isdefined('Form.Folio')>#form.Folio#</cfif>" 
				size="20" maxlength="20" /> --->
            </cfoutput> </td>
		...
		<table style="width:100%" border="0" cellpadding="1" cellspacing="0">
		  ...
		  <tr>
			...
			<td style="width:100%" colspan="8" >
				<select id="DDtipo" name="DDtipo" <cfif LvarPlanDeCompras AND modoDet NEQ 'ALTA'> disabled="disabled"</cfif> onChange="javascript:limpiarDetalle();cambiarDetalle();Verifica();" 
				...
				<td colspan="8">
					...
					<cfif modoDet NEQ "ALTA">
						<cf_cuentas onchangeIntercompany="LimpiarCF()" Intercompany="yes" conexion="#Session.DSN#" conlis="S" query="#rsLinea#" auxiliares="N" movimiento="S" 
								ccuenta="CcuentaD" cfcuenta="CFcuentaD" cdescripcion="CdescripcionD"  cmayor="CmayorD"  cformato="CformatoD" readOnly="true"
