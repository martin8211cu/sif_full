...
<form name="form1" id="form1" action="SQLRegistroDocumentosCP.cfm" method="post">
    ...
    <input name="URLira"			id="URLira" 			type="hidden" value="<cfoutput>#URLira#</cfoutput>">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="right"   nowrap="nowrap" valign="top">Direcci&oacute;n facturaci&oacute;n:&nbsp;</td>
            ...
            <tr>
             <!---►►Referencia◄◄--->
           	 <td valign="top" align="right"> <cfif form.tipo NEQ "C"> Referencia:&nbsp;</cfif>
             </td>
          ...
          <cfif isdefined('rsDocumento.EDexterno') and rsDocumento.EDexterno>
          	  <tr>
              	 <td colspan="6"><font color="##FF0000">El documentos provienen de un sistema o módulo externo, por lo que no puede ser modificado o eliminado.</font></td>
          	  </tr>
          </cfif>
        </table>
		<cfif modo NEQ "ALTA">
...
--->					    <option value="O" <cfif modoDet NEQ "ALTA" and rsLinea.DDtipo EQ "O">selected</cfif>>O-Orden Comercial en Tránsito</option>
		...
		<tr>
          ...
          <tr>
          	<td valign="top">Actividad Empresarial</td>
            <cfset idActividad = "">
			<cfset valores = "">
          ...
          <tr>
            <td colspan="11"><div align="center">
				<cfif NOT rsDocumento.EDexterno and PermisoModificar> 
                    <input name="Cambiar"  class="btnGuardar" tabindex="1" type="submit" value="Cambiar Documento" onclick="javascript: var estado = document.form1.EDtipocambio.disabled; document.form1.EDtipocambio.disabled = false; fnNoValidar(); if (validaE()) return true; else {document.form1.EDtipocambio.disabled = estado; return false;}" />
                </cfif>
                <cfif NOT rsDocumento.EDexterno and PermisoModificar and modoDet NEQ "ALTA"> 
                    <input name="CambiarD" class="btnGuardar" tabindex="1" type="submit" value="Cambiar Linea" onClick="javascript: var estado = document.form1.EDtipocambio.disabled; document.form1.EDtipocambio.disabled = false; if (valida()) return true; else {document.form1.EDtipocambio.disabled = estado; return false;}">
                </cfif>
                <cfif NOT rsDocumento.EDexterno and PermisoAgregar and modoDet EQ "ALTA">
                    <input name="AgregarD" class="btnGuardar" tabindex="1" type="submit" value="Agregar" onClick="javascript:   var estado = document.form1.EDtipocambio.disabled; document.form1.EDtipocambio.disabled = false;if (valida()) return true; else {document.form1.EDtipocambio.disabled = estado; return false;}">
                </cfif>
                <cfif NOT rsDocumento.EDexterno and PermisoBorrar>
                    <input name="BorrarE" class="btnEliminar" tabindex="1" type="submit" value="Borrar Documento" onClick="javascript:  fnNoValidar(); if (confirm('¿Desea borrar este documento?')) return true; else return false;">
                </cfif> 
                <cfif PermisoAplicar>
                ...
                <cfif PermisoAnular>
                    <input type="submit" class="btnNormal"   tabindex="1" name="btnAnular"  id="btnAnular"   			value="Anular" 		        onClick="javascript:return fnAnular(); fnNoValidar();return true;">
                </cfif>
                <cfif NOT rsDocumento.EDexterno and PermisoAgregar and LvarTipoMov EQ 'C'>
                	<input type="button" class="btnNormal"  tabindex="1" name="OrdenCompra" value="Orden Compra" onClick="javascript:NuevaVentana(<cfoutput>#rsNombreSocio.SNcodigo#,#rsDocumento.IDdocumento#,#rsDocumento.Mcodigo#</cfoutput>);">		    
                </cfif>
                ...
                <cfif NOT rsDocumento.EDexterno and form.tipo eq 'C' and PermisoAgregar and rsUsaPlanCuentas.Pvalor eq LvarParametroPlanCom>
                ...
                <cfif PermisoAgregar>
                    ...
                    <input type="button" class="btnImprimir"tabindex="1" name="Imprimir"      value="Imprimir trámite"      onClick="javascript:funcImprimir();">
                    <input type="button" class="btnImprimir"tabindex="1" name="ImprimirFactura"      value="Imprimir Factura"      onClick="javascript:funcImprimirFactura();">
                    <input type="submit" class="btnNormal"  tabindex="1" name="btnEnviarEmail"    value="Enviar Email" 		 onClick="javascript: fnNoValidar();return true;">
