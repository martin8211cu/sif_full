      		...
      		<td>
				<table width="100%" border="0">
							...
							<cf_conlis
								...
								filtro="a.Ecodigo  = #Session.Ecodigo#
								    ...
								    and (#codDoc#) not in (select (#codDoc2#)
								   	...
								   	and b.CPTtipo = 'D'
                                    and ((coalesce(b.CPTpago,0)=1 and coalesce(b.CPTanticipo,0)=0) or (coalesce(b.CPTpago,0)= 0 and coalesce(b.CPTanticipo,0)=1))"
					...
					<tr>
						...
						<td nowrap>
							<input type="hidden" name="IDpago" tabindex="-1" value="<cfif modo NEQ "ALTA"><cfoutput>#rsDocumento.IDpago#</cfoutput></cfif>">
          		...
          		<table width="100%" border="0">
					<tr>
						...
						<cfif modoDet neq "ALTA"><cfoutput>
								...
								<input name="DAdocref" type="text" tabindex="5" value="#rsLinea.DAdocref#" size="40" class="cajasinborde" readonly tabindex="-1">
								</cfoutput>
							<cfelse>
							<cfset valuesArray = ArrayNew(1)>
					...
					<tr align="center">
						<td colspan="4">
							<cfif modoDet EQ "ALTA">
                            	<cfoutput>
								<input name="AgregarD" type="submit"  tabindex="1" value="#BTN_Agregar#" onclick="javascript:setBtn(this);">
                            	</cfoutput>
							...
							<cfif rsTieneLineas.RecordCount GT 0 >
                           	<cfoutput>
								<input type="submit" name="Aplicar" value="#BTN_Aplicar#" tabindex="1" onclick="javascript:setBtn(this); deshabilitarValidacion(this.name); return Postear();">
                           	</cfoutput>
							</cfif>
                            <cfoutput>
