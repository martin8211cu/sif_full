...
<!---►►Se obtienen cada una de las lineas (detalle) de la Factura◄◄--->
...
<cfif modo NEQ 'ALTA'>
    <cfquery name="rsLineas" datasource="#Session.DSN#">
        ...
        inner join EDocumentosCPR edcpr
            on edcpr.IDdocumento = a.IDdocumento
...
<cf_templateheader title="SIF - Cuentas por Pagar">
	...
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#titulo#'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
            	<td>
                	<cfinclude template="formRegistroDocumentosRemision.cfm">
                </td>
            </tr>
            <!---►►Detalle◄◄--->
            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<cfoutput query="rsLineas">
                                <tr onClick="javascript:Editar('#rsLineas.IDdocumento#|#rsLineas.Linea#');"
                                    ...
                                    <cfif NOT rsDocumento.EDexterno and LvarTipDoc NEQ 'AF' and rsLineas.EVestado NEQ 2>
...
<script language="JavaScript1.2">
	...
	function borrar(documento, linea){
		if ( confirm('#MSG_Borrar#') ) {
			document.form2.action 			 = "SQLRegistroDocumentosRemision.cfm";
