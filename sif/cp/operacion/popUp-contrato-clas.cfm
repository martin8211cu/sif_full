...
<cfset LvarTipoMov    		= "C">
<cfset LvarTipDoc    		= "FA">
<cfset URLira 	      		= "popUp-contrato-clas.cfm?Contid=#url.Contid#">
<cfset URLNew	      		= "popUp-contrato-clas.cfm">
<cfset FiltroExtra	  		= "">
...
<cfif NOT LEN(TRIM(IDdocumento))>
	<cfset IDdocumento = -1>
<cfelse>
	<cfset myArrayList = ListToArray(IDdocumento,",")>
	<cfset IDdocumento = myArrayList[1]>
</cfif>

<!---►►Inicializacion de variables◄◄--->
<cf_navegacion name="Fecha">
<cf_navegacion name="datos">
<cf_navegacion name="modo" 			default="CAMBIO">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<cfoutput query="rsLineas">
                                <tr onClick="javascript:Editar('#rsLineas.IDdocumento#|#rsLineas.Linea#');"
                                    ...
                                    <!---►►Se pueden Eliminar las lineas siempre que no venga de un modulo externo y no se este en la pantalla de aplicacion de facturas--->
                                    <cfif NOT rsDocumento.EDexterno and LvarTipDoc NEQ 'AF'>
...
<script language="JavaScript1.2">
	...
	function borrar(documento, linea){
		if ( confirm('#MSG_Borrar#') ) {
			document.form2.action 			 = "popUp-contrato-clas-SQL.cfm?Contid=#url.Contid#";
