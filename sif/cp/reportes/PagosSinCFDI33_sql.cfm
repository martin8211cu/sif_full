...
<cfset LB_CosnsPago = t.Translate('LB_CosnsPago','Consulta de Pagos Sin CFDI Relacionado')>
	...
	<cfif isdefined("rsReporte") and rsReporte.recordcount gt 0>
		...
		<tr>
			...
			<td colspan="22" align="right">
				...
				<cf_rhimprime datos="/sif/cp/reportes/PagosSinCFDI33_sql.cfm" paramsuri="#params#">
		...
		<tr>
			...
			<td colspan="22" align="right" class="noprint">
				<cfoutput>
				<cfif isdefined("form.Pagos")>
					<a href="DocPagado_PagosSinCFDI33_form.cfm?1=1#params#">#BTN_Regresar#</a>  
				<cfelse>
					<a href="PagosSinCFDI33_form.cfm?1=1#params#">#BTN_Regresar#</a>
				</cfif>
				</cfoutput>
			</td>
		</tr>
		...
		<tr>
				...
				<cfoutput>
					...
					<tr class=<cfif LvarListaNon>"listaNon"<cfelse>"listaPar"</cfif>>
					 <cfset params2 = trim('&Recibo=#URLEncodedFormat(Recibo)#&CPTcodigoA=#CPTcodigo#&Fecha=#Fecha#&Asiento=#Asiento#&TC=#TC#&MontoOrigen=#MontoOrigen#&MontoLocal=#MontoLocal#')>
					  <td>&nbsp;</td>
					  <td class="niv4"><!---<a href="PagosSinCFDI33_DetallePago_form.cfm?1=1#params2##params#">--->#CPTcodigo# - #Recibo#</a></td>
					  <td align="left" class="niv4" ><!---<a href="PagosSinCFDI33_DetallePago_form.cfm?1=1#params2##params#">--->#dateformat(Fecha,'dd/mm/yyyy')#</a></td>
					 <!--- <td align="left" class="niv4" ><a href="PagosSinCFDI33_form.cfm?1=1#params2##params#">#Lote# - #Asiento#</a></td>--->
					  <td align="right" class="niv4" ><!---<a href="PagosSinCFDI33_form.cfm?1=1#params2##params#">#NumberFormat(TC,'_,_.__')#</a>---></td>
					  <td align="right" class="niv4" ><!---<a href="PagosSinCFDI33_DetallePago_form.cfm?1=1#params2##params#">--->#NumberFormat(MontoOrigen,'_,_.__')#</a></td>
					  <td align="right" class="niv4" colspan="22"><!---<a href="PagosSinCFDI33_DetallePago_form.cfm?1=1#params2##params#">--->#NumberFormat(MontoLocal,'_,_.__')#</a></td>
					</tr>
			...
			<tr>
				<td>&nbsp;</td>
				<td class="niv3" colspan="3" style="font-weight:bold">#LB_Total#:&nbsp;</td>
