...
<form name="form1" method="post" action="RRemisionesSaldos-Sql.cfm"
  ...
  <table width="80%" border="0" cellpadding="1" cellspacing="1" align="center">
	...
	<tr>
	  ...
	  <td nowrap>
	  	<cfif isdefined('form.SNcodigo') and LEN(TRIM(form.SNcodigo))>
			<cf_sifsociosnegocios2 tabindex="1" SNtiposocio="P" SNcodigo="SNcodigo" SNnombre="SNnombre" SNnumero="SNnumero" idquery="#rsSocio.SNcodigo#">
		<cfelse>
			<cf_sifsociosnegocios2 tabindex="1" SNtiposocio="P" SNcodigo="SNcodigo" SNnombre="SNnombre" SNnumero="SNnumero">
		</cfif>
	  </td>
	</tr>
	<tr>
