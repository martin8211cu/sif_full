...
<cfquery name="rsData" datasource="#Session.DSN#">
	select sn.SNnombre, a.CCTcodigo, t1.CCTdescripcion, a.Ddocumento, a.Dtotal as Dtotal, a.Mcodigo as Mcodigo, a.Dfecha, '1. Creación' as Movimiento, t1.CCTtipo, a.CCTRcodigo, a.DRdocumento
	...
	select sn.SNnombre, a.CCTcodigo, t1.CCTdescripcion, a.Ddocumento, a.Dtotal as Dtotal, a.Mcodigo as Mcodigo, a.Dfecha, '2. Creación Credito' , t1.CCTtipo, a.CCTRcodigo, a.DRdocumento
	...
	select sn.SNnombre, a.CCTRcodigo, t2.CCTdescripcion, a.DRdocumento, coalesce(a.BMmontoref,a.Dtotal) as Dtotal, coalesce(a.Mcodigoref,a.Mcodigo) as Mcodigo, a.Dfecha, '3. Aplicación ' || a.CCTcodigo || ' ' || a.Ddocumento, case t2.CCTtipo when 'D' then 'C' else 'D' end, a.CCTcodigo, a.Ddocumento
	from BMovimientos a, CCTransacciones t1, CCTransacciones t2, SNegocios sn
	where a.Ecodigo =  <cfqueryparam cfsqltype="cf_sql_integer" value="#session.ecodigo#">
		and (a.CCTcodigo <> a.CCTRcodigo or a.Ddocumento <> a.DRdocumento)
		and t1.CCTcodigo = a.CCTcodigo
	...
	select sn.SNnombre, a.CCTcodigo, t1.CCTdescripcion, a.Ddocumento, coalesce(a.BMmontoref,a.Dtotal) as Dtotal, coalesce(a.Mcodigoref,a.Mcodigo) as Mcodigo, a.Dfecha, '4. Aplicación a NC' || a.CCTRcodigo || ' ' || a.DRdocumento, case t1.CCTtipo when 'D' then 'C' else 'D' end, a.CCTRcodigo, a.DRdocumento
	from BMovimientos a, CCTransacciones t1, CCTransacciones t2, SNegocios sn
	where a.Ecodigo =  <cfqueryparam cfsqltype="cf_sql_integer" value="#session.ecodigo#">
		and (a.CCTcodigo <> a.CCTRcodigo or a.Ddocumento <> a.DRdocumento)
		and t1.CCTcodigo = a.CCTcodigo
