...
<cfquery name="conlis" datasource="#Session.DSN#">
	...
	from HEDocumentosCP a, CPTransacciones b, Monedas c, CContables d 
	where 	a.Ecodigo =  #Session.Ecodigo# 
		and a.Ecodigo = b.Ecodigo 
		and b.CPTtipo = <cfqueryparam cfsqltype="cf_sql_char" value="#url.CPTtipo#">
		...
		<cfif isdefined("url.codigo") and len(trim(url.codigo))>
			and b.CPTcodigo  = <cfqueryparam cfsqltype="cf_sql_char" value="#url.codigo#">
		</cfif>

		<cfif isdefined("Form.Filtrar") and (Form.CPTcodigo NEQ "")>
			and a.CPTcodigo like '%#Form.CPTcodigo#%'
		</cfif>

		<cfif isdefined("Form.Filtrar") and (Form.Ddocumento NEQ "")>
			and a.Ddocumento like '%#Form.Ddocumento#%'
		</cfif>
	...
	order by a.Dfecha asc, a.EDsaldo desc 
</cfquery>
...
<form action="" method="post" name="conlis">
  <table width="98%" align="center" border="0" cellspacing="0" cellpadding="2">
  	<tr>
		<td colspan="7" class="tituloAlterno">
    ...
    <cfoutput query="conlis" startRow="#StartRow_conlis#" maxRows="#MaxRows_conlis#"> 
      <tr> 
        <td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><input type="hidden" name="CPTcodigo#conlis.CurrentRow#" value="#conlis.CPTcodigo#"> 
          <a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#conlis.CPTcodigo#</a></td>
        <td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#conlis.Ddocumento#</a></td>
		
	    <td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><input type="hidden" name="CPTcodigo#conlis.CurrentRow#" value="#conlis.CPTcodigo#"> 
        	<a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#conlis.Dfecha#</a></td>

    	<td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><input type="hidden" name="CPTcodigo#conlis.CurrentRow#" value="#conlis.CPTcodigo#"> 
        	<div align="left"><a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#conlis.Mnombre#</a></div></td>

    	<td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><input type="hidden" name="CPTcodigo#conlis.CurrentRow#" value="#conlis.CPTcodigo#"> 
        	<div align="right"><a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#LSCurrencyFormat(conlis.Dtotal,'none')#</a></div></td>
      	<td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><input type="hidden" name="CPTcodigo#conlis.CurrentRow#" value="#conlis.CPTcodigo#"> 
          <div align="right"><a href="javascript:Asignar('#JSStringFormat(conlis.CPTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.EDsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#LSCurrencyFormat(conlis.EDsaldo,'none')#</a></div></td>
        </tr>
    </cfoutput> 
    <tr align="center"> 
    	<td colspan="7">
