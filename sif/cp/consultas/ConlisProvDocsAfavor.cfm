...
<cfset LB_FisJur 	= t.Translate('LB_FisJur','(F&iacute;sico/Jur&iacute;dico)')>
...
<form action="" method="post" name="conlis">
  <table width="53%" border="0" cellspacing="0">
  	<cfoutput>
    <tr> 
      <td width="44%" bgcolor="#006699" class="titulo"><div align="left"><font color="#FFFFFF" size="2">#LB_Nombre#</font></div></td>
      <td width="28%" bgcolor="#006699" class="titulo"><div align="left"><font color="#FFFFFF" size="2">#LB_Tipo# 
          #LB_FisJur#</font></div></td>
