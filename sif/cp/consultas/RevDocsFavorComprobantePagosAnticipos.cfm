<cf_rhimprime datos="/sif/cp/consultas/RevDocsFavorComprobante.cfm" paramsuri="&id=#url.id#&HEACPid=#url.HEACPid#"> 

<cfquery name="rsDisponible" datasource="#Session.DSN#">
	select a.HEACPid, a.ID, c.EDsaldo, sum(b.DAmonto) as MontoDet, round(c.EDsaldo - sum(b.DAmonto),2) as disponible
	...
	and a.HEACPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.HEACPid#">
	and a.ID 	    = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.id#">
	and rtrim(a.Ddocumento) = rtrim(c.Ddocumento)
	group by a.HEACPid, a.ID, c.Ecodigo, c.CPTcodigo, c.Ddocumento, c.EDsaldo			
</cfquery>
...
<cfquery name="data" datasource="#Session.DSN#">
	...
	where a.HEACPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.HEACPid#">
	and a.ID = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.id#">
</cfquery>
...
<cfquery name="detalle" datasource="#Session.DSN#">
	select  a.DAlinea,
			...
			a.DAidref
	from HDAplicacionCP a, HEDocumentosCP b, Monedas c
	where a.HEACPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.HEACPid#">
	  and a.ID = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.id#">
