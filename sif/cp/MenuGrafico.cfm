...
<cfelse>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="Ayuda">
	  <tr>
		<cfset MSG_SinDat 	= t.Translate('MSG_SinDat','No se encontraron datos para realizar el Gr&aacute;fico')>
...
<script language="javascript" type="text/javascript">
	...
	function consultavencimiento(inicio,fin){
		var PARAM  = "consultas/AntigSaldosDetCxP.cfm?SNcodigo=<cfoutput>#Form.SNcodigo#</cfoutput>&Ocodigo=<cfoutput>#Form.Ocodigo#</cfoutput>&FORMATO=<cfoutput>#Form.FORMATO#</cfoutput>&inicio="+ inicio +"&fin="+ fin;
