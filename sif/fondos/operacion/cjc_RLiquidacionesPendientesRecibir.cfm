...
<cf_templateheader title="Reporte de Liquidaciones Pendientes de Recibir por GL">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_LiquidacionesPendientesRecibir.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formRLiquidacionesPendientesRecibir.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
