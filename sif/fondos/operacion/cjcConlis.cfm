...
<cfparam name="Attributes.sizecodigo"	default="20" 						type="string">	<!--- tamaño del objeto de la descripcion --->
...
<cfparam name="Attributes.onblur" 	 	default=""							type="string"> 	<!--- funcion del on blur--->
<cfparam name="Attributes.filtrarfondo" default="false"						type="string"> 	<!--- funcion del on blur--->
<cfparam name="Attributes.filtrarinicio" default="true"		            type="boolean"> <!--- Para que cuando entre la pantalla no muestre la lista--->
...
<script language="JavaScript" type="text/javascript">
	...
	{
		var params = "";
			params = "<cfoutput>?form=#Attributes.form#&id=#Attributes.id#&filtro=#Attributes.filtro#&name2=#Attributes.name2#&name=#Attributes.name#&desc=#Attributes.desc#&desc2=#Attributes.desc2#&conexion=#Attributes.conexion#&filtrarUsuario=#Attributes.filtrarfondo#&filtrarinicio=#Attributes.filtrarinicio#</cfoutput> ";
	...
	{
		var params = "";
			params = "<cfoutput>&id=#Attributes.id#&filtro=#Attributes.filtro#&name=#Attributes.name#&desc=#Attributes.desc#&name2=#Attributes.name2#&desc2=#Attributes.desc2#&filtrarUsuario=#Attributes.filtrarfondo#&filtrarinicio=#Attributes.filtrarinicio#</cfoutput>";
	...
	<tr>
		<td>
			<input type="text"
				...
				onchange="javascript: TraeDescripcion#Attributes.name#(document.#Attributes.form#.#Evaluate('Attributes.name')#.value);"
				size="#Attributes.sizecodigo#"  
				maxlength="#Attributes.sizecodigo#"
		...
		<td nowrap>
			<input type="text"
				...
				tabindex="-1" disabled
				value="<cfif isdefined('Attributes.query') and ListLen(Attributes.query.columnList) GT 1><cfset Newdescripcion=replace(Evaluate('desc'),"##","####","ALL")>#Evaluate(Newdescripcion)# <!---#Evaluate('#desc#')#---></cfif>" 
				size="#Attributes.size#" 
				maxlength="80"
				style="border: medium none; visibility:visible;"
			>
		
			<a id="#Attributes.name#IMG" href="##" tabindex="-1" style="visibility:visible">
				<img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de selección" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doCJC_Conlis#Attributes.name#();'>
			</a>
