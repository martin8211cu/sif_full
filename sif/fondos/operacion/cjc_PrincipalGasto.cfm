...
<cfif isdefined("url.RESPOSTEO")>
	<cfif LSIsNumeric(url.RESPOSTEO)>
		<script language="JavaScript">
			...
			var direccion 	= "/cfmx/sif/fondos/Utiles/cjc_ErrorNap.cfm?NAP="+NAP
...
<table width="100%" border="0" >
	...
	<tr><td colspan="2" align="center"> 
		...
		<input type="hidden" name="HDValidaCta" value="0">
		...
		<cfif modo EQ "ALTA">
			...
			<input type="submit" name="AltaNueva" value="Agregar y Nueva Factura" onClick="javascript: this.form.botonSel.value = this.name; validar(); return validaOBJGTO();">
			<input type="submit" name="Alta" value="Agregar y Misma Factura" onClick="javascript: this.form.botonSel.value = this.name; validar(); return validaOBJGTO();">
		...
		<cfelse>	
			<cfif mododet EQ "ALTA">
				<input type="submit" name="Altadet" value="Agregar Linea" onClick="javascript: this.form.botonSel.value = this.name; validar(); return validaOBJGTO();">
			...
			<cfelse>			
				<input type="submit" name="Cambiodet" value="Modificar" onClick="javascript: this.form.botonSel.value = this.name; validar(); return validaOBJGTO();">
		...
		<td width="50%"  valign="top">
			<!---<cfif form.CJX19REL neq '0'> --->			
				...
				<cfinvoke 
					...
					<cfinvokeargument name="filtro" value=" CJX020.EMPCOD = PLM001.EMPCOD and CJX19REL =#Form.CJX19REL# ORDER BY CJX020.CJX19REL, CJX020.CJX20NUM"/>
...
<!---***************************************************** --->
<cf_templatefooter>
<iframe  name="frameValOBJ" id="frameValOBJ" height="0" width="0" frameborder="0"></iframe>
<cfinclude template="cjc_PrincipalGastoJs.cfm">
<!--- <SCRIPT LANGUAGE='Javascript'  src="../js/cjc_PrincipalGasto.js"></SCRIPT> --->