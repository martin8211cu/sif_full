...
<!--- class="estilo"  --->
	...
	<!---************************************************************ --->
	<!---*********       CHECV-Herramientas e Instrumentos  ********* --->
	<!---************************************************************ --->
	<div id='CHECV' style=" display:none ">
	<table >
		<tr>
			<td><strong>Ced. Empleado</strong></td>
			<td><INPUT ONFOCUS=""  NAME="EMPCE" id= "EMPCE"	VALUE="" size= "20" MAXLENGTH= "15" tabindex="1"></td>
		</tr>
		<tr>
			<td><strong>No. de Vale</strong></td>
			<td><INPUT NAME="NVALE" id="NVALE" VALUE="" size= "20" MAXLENGTH= "4" ONFOCUS="this.value=qf(this); this.select();" ONBLUR="fm(this,-1);" ONKEYUP="if(snumber(this,event,-1)){ if(Key(event)=='13') {this.blur(); ACEPTAR('campos_variables');}}" tabindex="2"></td>
		</tr>
		<tr>
			<td><strong>Fecha de Vale</strong></td>
			<td><cf_CJCcalendario  tabindex    ="3" name="FECV" form="form1" ><td> 	
		</tr>
		<tr>
			<td><strong>Det. de Factura</strong></td>
			<td><INPUT ONFOCUS=""  NAME="CART" id= "CART"	VALUE="" size= "20" MAXLENGTH= "15" tabindex="4"></td>
		</tr>	
