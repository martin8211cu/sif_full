...
<!---******************************************************************************************* --->
		<cfif isdefined("form.Alta")>
			...
			VALUES (
				@CJX19REL,
				@CJX23CON,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23TIP)#">,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#trim(form.CJX23MON)#">,
				<cfif trim(form.CJX23TIP) eq "V">
					<cfqueryparam  cfsqltype="cf_sql_integer"  value="#trim(form.CJX5IDE)#">,
					null,
					null,
					null,
					null,
				...
				<cfelse>
					null,
					<cfif len(trim(form.TS1COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" 	value="#trim(form.TS1COD)#"><cfelse>null</cfif>,
					<cfif len(trim(form.TR01NUT)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.TR01NUT)#"><cfelse>null</cfif>,
					<cfif len(trim(form.CJX23CHK)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23CHK)#"><cfelse>null</cfif>,
					<cfif len(trim(form.CP9COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CP9COD)#"><cfelse>null</cfif>,
					<cfif len(trim(form.EMPCOD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.EMPCOD)#"><cfelse>null</cfif>,
					<cfif len(trim(form.CJX23TTR)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23TTR)#"><cfelse>null</cfif>,
					<cfif len(trim(form.CJX23AUT)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23AUT)#"><cfelse>null</cfif>,
					<cfif len(trim(form.CJX23FEC)) gt 0>convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(Form.CJX23FEC)#">, 103)<cfelse>null</cfif>
...
<!---******************************************************************************************* --->
		<cfelseif isdefined("form.Cambio")>
			UPDATE CJX023 SET 
			CJX23TIP =	<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23TIP)#">,
			CJX23MON =	<cfqueryparam cfsqltype="cf_sql_float"  value="#trim(form.CJX23MON)#">,
			<cfif trim(form.CJX23TIP) eq "V">
				CJX5IDE 	= 	<cfqueryparam  cfsqltype="cf_sql_integer"  value="#trim(form.CJX5IDE)#">,
				TS1COD 		=  	null,
				TR01NUT 	= 	null,
				CJX23CHK 	= 	null,
				CP9COD 		=	null,
			...
			<cfelse>
				CJX5IDE 	= 	null,
				TS1COD 		=  	<cfif len(trim(form.TS1COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" 	value="#trim(form.TS1COD)#"><cfelse>null</cfif>,
				TR01NUT 	= 	<cfif len(trim(form.TR01NUT)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.TR01NUT)#"><cfelse>null</cfif>,
				CJX23CHK 	= 	<cfif len(trim(form.CJX23CHK)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23CHK)#"><cfelse>null</cfif>,
				CP9COD 		=	<cfif len(trim(form.CP9COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CP9COD)#"><cfelse>null</cfif>,
				EMPCOD 		=	<cfif len(trim(form.EMPCOD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.EMPCOD)#"><cfelse>null</cfif>,
				CJX23TTR 	=	<cfif len(trim(form.CJX23TTR)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23TTR)#"><cfelse>null</cfif>,
				CJX23AUT 	=	<cfif len(trim(form.CJX23AUT)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.CJX23AUT)#"><cfelse>null</cfif>
			</cfif>	
			WHERE CJX19REL = <cfqueryparam cfsqltype="cf_sql_integer" 	value="#trim(form.CJX19REL)#">	
			AND   CJX23CON = <cfqueryparam cfsqltype="cf_sql_integer" 	value="#trim(form.CJX23CON)#">	
