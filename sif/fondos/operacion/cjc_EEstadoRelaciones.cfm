...
<cf_templateheader title="Reporte de Estado de las Relaciones">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_EstadoRelaciones.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formEstadoRelaciones.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
