...
<cf_templateheader title="Reintegros de Caja Pendientes">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_ReintegrosPendientes.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formReintegrosPendientes.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
