...
<cf_templateheader title="Administracion de Datos del Banco">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_AdministracionBancaria.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfif isdefined("pan")>
				<cfinclude template="../operacion/cjc_formAdmBancAnticipo.cfm">
			<cfelse>
				<cfinclude template="../operacion/cjc_formAdministracionBancaria.cfm">
			</cfif>
		</td>
  	</tr>
 </table>
