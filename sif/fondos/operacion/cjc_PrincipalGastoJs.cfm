<script language="JavaScript1.2" type="text/javascript">
	...
	function validardet()
	{
		CtaMayor = document.form1.CGM1IM.value;	
		var Vifrm = document.getElementById("frameValOBJ");
		Vifrm.src = "/cfmx/sif/fondos/operacion/ValCtaOBJ.cfm?CtaMayor="+CtaMayor;
	}
	
	function validaOBJGTO()
	{
		OBJ = document.form1.CGM1CD.value.substring(document.form1.CGM1CD.value.length-3,document.form1.CGM1CD.value.length);		
		CP7SUB = document.form1.CP7SUB.value;
		
		if (document.form1.HDValidaCta.value == 1)
		{
			if (CP7SUB != parseInt(OBJ,10))
			{
				alert("ERROR: El objeto de gasto del Grupo-Subgrupo no \n corresponde al objeto de gasto de la cuenta contable");
				return false;
			}
		}
		return true;	
	...
	function finalizardet() {
		...
		if (!objform1.CGM1CD.required)
		  return true;
		else if (document.form1.errorFlag.value == '0') // Se empieza la ejecucin
		{
			document.form1.errorFlag.value = '1';  // La ejecuci n est en proceso
			validacampos();
		...
		else if (document.form1.errorFlag.value == '2') // La validaci n es correcta
		{
			document.form1.errorFlag.value = '0';
			return true;
		}
		...
		// No ha pasado por Validacin correcta
	...
	function Cargar_CN() {
		...
		//Valida la cuenta contable de acuerdo al OBJ GASTO
		validardet();		
	...
	function ActivaDet(item) {
		...
		if (item == "ACFI") {
			...
			objform1.EMPCE.required = false;
			objform1.FECV.required = false;
			objform1.NVALE.required = false;			
			objform1.CART.required = false;			
			...
			CHECV.style.display = "none"				
		}
		else if (item == "CA01") {
			objform1.CEDF.required = true;
			objform1.CEDF.description="C d. Fisica";
			objform1.EMPL.required = false;
			...
			objform1.NUM.description="Nmero";
			...
			objform1.NUMEN.description="N mero";
			...
			objform1.TIPEN.description="Tipo Entidad";
			objform1.NUMEN.required = true;
			objform1.NUMEN.description="Nmero";
			objform1.NOMEN.required = true;
			objform1.NOMEN.description="Nombre";			
			objform1.NUMRE.required = true;
			objform1.NUMRE.description="N mero Recibo";
			...
			objform1.CEDF.required = true;
			objform1.CEDF.description="Cd. Fisica";
			objform1.EMPL.required = false;
			objform1.EMPL.description="Empleado";			
			objform1.AF4PL.required = false;
			objform1.AF25C.required = false;
			...
			objform1.NOVEH.description="No. Veh culo";
			...
			objform1.NOVEH.required = true;
			objform1.NOVEH.description="No. Vehculo";
			objform1.KILOM.required = true;
			objform1.KILOM.description="Kilometraje";
			...
			objform1.EMPCE.required = true;
			objform1.EMPCE.description="Ced. de Empleado";
			objform1.NVALE.required = true;
			objform1.NVALE.description="No. de Vale"
			objform1.FECV.required = true;
			objform1.FECV.description="Fecha de Vale"
			objform1.CART.required = true;
			objform1.CART.description="Cod. Articulo";
	...
	objform1.CJX21DSC.description="Descripci n";	
