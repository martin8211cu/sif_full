...
<cf_templateheader title="Reimpresion de Referencias">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_ReimpReferencias.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >	
	<tr>
		<td>
			<cfinclude template="../operacion/cjc_ReimprimeReferencias.cfm">
		</td>
  	</tr>	
 </table>
<!---***************************************************** --->
