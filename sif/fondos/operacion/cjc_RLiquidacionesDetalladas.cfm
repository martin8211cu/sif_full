...
<cf_templateheader title="Reporte de Liquidaciones de Caja Detallado">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_LiquidacionesDetalladas.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formRLiquidacionesDetalladas.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
