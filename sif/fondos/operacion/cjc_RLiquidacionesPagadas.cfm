...
<cf_templateheader title="Reporte de Liquidaciones Pagadas">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_LiquidacionesPagadas.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formRLiquidacionesPagadas.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
