...
<cf_templateheader title="Estadisticas">

<cfif IsDefined("url.IDSESSION")>
	<cflocation url="../operacion/cjc_EstadisticaGenerales.cfm">
</cfif>
<!--- *********************** --->
<!---** AREA DE PINTADO    ** --->
<!---************************ --->
...
<table width="100%" border="0" >
	<tr>
		<td>		
			<cfinclude template="../operacion/cjc_formEstadisticaGenerales.cfm">
		</td>
  	</tr>
 </table>
<!---***************************************************** --->
