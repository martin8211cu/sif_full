<cfquery name="rs" datasource="#session.Fondos.dsn#">
	select CJX19REL,CJX20NUM,CJX21LIN,CJX21DSC , convert(varchar(14),CJX21MDU,1) CJX21MDU  from CJX021
...
<cfoutput query="rs" startRow="#StartRow_rs#" maxRows="#MaxRows_rs#" >
	<tr onClick="javascript:editar(#rs.CJX19REL#,#rs.CJX20NUM#,#rs.CJX21LIN#);" 
