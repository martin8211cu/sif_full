...
<cfif ThisTag.ExecutionMode Is 'End'>
	...
	<cfif Attributes.Debug>
		<cfsavecontent variable="translated_value"><cfoutput><span style="border:1px dotted red; background-color:##FFFF99" title="Key: #Attributes.Key# Default: #HTMLEditFormat(ThisTag.GeneratedContent)#<cfif Len(Attributes.XmlFile)> Attributes.XmlFile:#Attributes.XmlFile#</cfif><cfif Len(Attributes.Idioma)> Attributes.Idioma:#Attributes.Idioma#</cfif>">#translated_value#</span></cfoutput></cfsavecontent>
	</cfif>
