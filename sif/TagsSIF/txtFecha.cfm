...
<table width="" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
		<td nowrap>
		  ...
		  >
		  <a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/DATE_D.gif" alt="Calendario" name="Calendar#Attributes.name#" width="16" height="14" border="0" onClick="javascript: showCalendar('document.'+document.getElementById('#Attributes.name#').form.name+'.#Attributes.name#');"></a>
		</td>
	</tr>
	</cfoutput>
</table>
