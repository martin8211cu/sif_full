...
<cfparam name="Attributes.id" default="PRJPPid" type="string"> <!--- Nombre del id --->
<cfparam name="Attributes.name" default="PRJPPcodigo" type="string"> <!--- Nombre del Código --->
...
<cfparam name="Attributes.desc" default="PRJPPdescripcion" type="string"> <!--- Nombre de la Descripción --->
...
<script language="JavaScript" type="text/javascript">
	...
	//Llama el conlis
	function doConlisProductos<cfoutput>#Attributes.name#</cfoutput>() {
		var params ="";
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/Utiles/ConlisProductos.cfm"+params,160,200,800,430);
	}
	//Obtiene la descripción con base al código
	function TraeProductos<cfoutput>#Attributes.name#</cfoutput>(dato) {
		var params ="";
		...
		if (dato!="") {
			...
			fr.src = "/cfmx/sif/Utiles/sifproductoquery.cfm?dato="+dato+"&formulario="+"<cfoutput>#Attributes.form#</cfoutput>"+params;
		}
		else{
	...
	<tr>
		<td>
			...
			<input type="text"
				...
				onBlur="javascript: TraeProductos#Attributes.name#(document.#Attributes.form#.#Attributes.name#.value);" onFocus="this.select()"
				size="10" 
				maxlength="10" <cfif isdefined("modo") and modo eq 'CAMBIO'>disabled</cfif>>
		...
		<td nowrap>
			<input type="text"
				...
				<cfif not isdefined("modo")>
					<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Art&iacute;culos" name="img#Attributes.name#" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doConlisProductos#Attributes.name#();'></a>
				<cfelse>
					<cfif modo eq 'ALTA'>
						<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Art&iacute;culos" name="img#Attributes.name#" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doConlisProductos#Attributes.name#();'></a>
					</cfif>
