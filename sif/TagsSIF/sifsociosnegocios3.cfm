...
<cfparam name="Attributes.Ecodigo" 			default="#Session.Ecodigo#" 	type="string"> <!--- SNid --->

<!--- consultas --->
<!--- Caso Proveduria Corporativa --->
<cfif #Attributes.Ecodigo# eq -1>
    ...
    <cfif rsProvCorp.recordcount gt 0 and rsProvCorp.Pvalor eq 'S'>
        ...
        <cfif rsEProvCorp.recordcount gte 1>
            ...
            <cfset Attributes.Ecodigo = Ecodigos>
        </cfif>    
...
<cfif isdefined("Attributes.idquery") and len(trim(Attributes.idquery))>
	...
	<cfquery name="#queryName#" datasource="#Attributes.Conexion#">
		...
		from SNegocios 
		where Ecodigo in <cfqueryparam value="#Attributes.Ecodigo#" cfsqltype="cf_sql_integer" list="yes">
...
function doConlisSocio<cfoutput>#Attributes.SNcodigo#</cfoutput>() {
	<cfif Attributes.modificable>
			...
			var params ="";
			params = "<cfoutput>?formulario=#Attributes.form#&id=#Attributes.SNcodigo#&codigo=#Attributes.SNnumero#&desc=#Attributes.SNnombre#&tipo=#Attributes.SNtiposocio#&Ecodigo=#Attributes.Ecodigo#</cfoutput>";
			...
			popUpWindow<cfoutput>#Attributes.SNcodigo#</cfoutput>("/cfmx/sif/Utiles/ConlisSociosNegocios3.cfm"+params,250,200,650,400);
	</cfif>
}
...
function TraeSocio<cfoutput>#Attributes.SNcodigo#</cfoutput>(codigo) {
	<cfif Attributes.modificable>
			...
			fr.src = "/cfmx/sif/Utiles/sifsocionegociosquery3.cfm?codigo="+codigo+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
			}
			else{
