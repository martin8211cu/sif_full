...
<cfparam name="Attributes.id" default="GSNid" type="string"> <!--- Nombre del id --->
<cfparam name="Attributes.name" default="GSNcodigo" type="string"> <!--- Nombre del Código --->
<cfparam name="Attributes.desc" default="GSNdescripcion" type="string"> <!--- Nombre de la Descripción --->
<cfparam name="Attributes.frame" default="frgruposn" type="string"> <!--- Nombre del frame --->
...
<script language="JavaScript" type="text/javascript">
	...
	//Llama el conlis
	function doConlisGrupoSN<cfoutput>#Attributes.name#</cfoutput>() {
		var params ="";
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/Utiles/ConlisGrupoSN.cfm"+params,250,200,650,400);
	}
	//Obtiene la descripción con base al código
	function TraeGrupoSN<cfoutput>#Attributes.name#</cfoutput>(dato) {
		var params ="";
		...
		if (dato!="") {
			...
			fr.src = "/cfmx/sif/Utiles/sifGrupoSNquery.cfm?dato="+dato+"&form="+"<cfoutput>#Attributes.form#</cfoutput>"+params;
		}
		else{
			limpiarGrupoSN();
		}
	...
	<tr>
		<td>
			...
			<input type="text"
				...
				onBlur="javascript: TraeGrupoSN#Attributes.name#(document.#Attributes.form#.#Evaluate('Attributes.name')#.value); 
		...
		<td nowrap>
			<input type="text"
				...
				maxlength="80">
			<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista Grupo de Socios de Negocios" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doConlisGrupoSN#Attributes.name#();'></a>
		</td>
	</tr>
	</cfoutput>
</table>
