...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisLineasOrdenCM<cfoutput>#Attributes.idlinea#</cfoutput>() {
		...
		popUpWindow<cfoutput>#Attributes.idlinea#</cfoutput>("/cfmx/sif/Utiles/ConlisLineasOrdenCM.cfm"+params,160,200,800,430);
...
<table width="" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
			...
			<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Art&iacute;culos" name="img#Attributes.idlinea#" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doConlisLineasOrdenCM#Attributes.idlinea#();'></a>
			<cfelse>
				#iddesc#
			</cfif>
		</td>
