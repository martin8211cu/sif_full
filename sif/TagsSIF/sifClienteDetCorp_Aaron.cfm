...
function doConlisSocio<cfoutput>#Attributes.CDCcodigo#</cfoutput>() {
	...
	popUpWindow("/cfmx/sif/Utiles/ConlisClientesDetallistasCorp.cfm"+params,250,200,650,400);
}

function TraeCliente<cfoutput>#Attributes.CDCidentificacion#</cfoutput>(codigo) {
	var params ="";
	...
	if (codigo!=""){
		...
		obj_frame.src="/cfmx/sif/Utiles/ConlisClientesDetallistasCorp.cfm?codigo="+codigo+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
	}else{
...
<!--- 
	...
	onblur="javascript:TraeCliente#Attributes.CDCidentificacion#(document.#Attributes.form#.#Evaluate('Attributes.CDCidentificacion')#.value);"

 --->		
		
			<input type="text" name="#Attributes.CDCidentificacion#" id="#Attributes.CDCidentificacion#" maxlength="15" size="10" onblur="javascript:TraeCliente#Attributes.CDCidentificacion#(this.value);" onfocus="this.select()"	tabindex="#Attributes.tabindex#"
