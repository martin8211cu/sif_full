...
function doConlisOficina<cfoutput>#Attributes.Oficodigo#</cfoutput>() {
	 <cfif Attributes.modificable>
		...
		popUpWindow("/cfmx/sif/Utiles/ConlisOficinas.cfm"+params,250,200,650,400);
	</cfif>
}
...
function TraeOficina<cfoutput>#Attributes.Oficodigo#</cfoutput>(valor) {
	...
	if (valor!="") {
		...
		fr.src = "/cfmx/sif/Utiles/sifOficinaquery.cfm?valor="+valor+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;		
	}
	else{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="98%" nowrap>
			<a href="##" tabindex="-1"><img id="Almimagen" src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Oficinas" name="Almimagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisOficina#Attributes.Oficodigo#();'></a>
