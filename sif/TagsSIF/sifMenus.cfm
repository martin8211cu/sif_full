...
<script language="JavaScript">
	...
	function doConlisMenus<cfoutput>#Attributes.id_root#</cfoutput>() {
		...
		popUpWindow<cfoutput>#Attributes.id_menu#</cfoutput>("/cfmx/sif/Utiles/ConlisMenus.cfm"+params,250,200,650,400);
	...
	function TraeMenus<cfoutput>#Attributes.id_root#</cfoutput>(valor) {
		...
		if (valor!='') {
			document.all["<cfoutput>#Attributes.frame#</cfoutput>"].src="/cfmx/sif/Utiles/sifMenusquery.cfm?valor="+valor+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
