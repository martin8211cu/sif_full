...
<cfparam name="Attributes.Agencia" default="false" type="boolean"> <!--- Indica si es agencia  --->
<cfparam name="Attributes.Oficina" default="-1" type="numeric"> <!--- La oficina para para el filtro  --->
<cfparam name="Attributes.id_direccion" default="false" type="boolean"> <!--- Indica si solo los documentos de una direccion  --->
...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisDocsPagoCxC#Attributes.name#(DatoCCTcodigo) {
		...
		params = "&form=#Attributes.form#&CCTcodigoConlis=#Attributes.CCTcodigoConlis#&id=#Attributes.id#&name=#Attributes.name#&desc=#Attributes.desc#&conexion=#Attributes.conexion#&Ocodigo=#Attributes.Oficina#&empresa=#Attributes.empresa#&SNcodigo="+document.#Attributes.form#.SNcodigo.value;

		<cfif Attributes.GSNid eq 1>
		params = params + "&GSNid="+document.#Attributes.form#.GSNid.value;
		</cfif>

		<cfif Attributes.Agencia>
		params = params + "&Agencia="+document.#Attributes.form#.SNcodigo.value;
		</cfif>

		<cfif Attributes.id_direccion>
		params = params + "&id_direccion="+document.#Attributes.form#.id_direccion.value;
		</cfif>



		popUpWindow#Attributes.name#("/cfmx/sif/Utiles/ConlisDocsPagoCxC.cfm?DatoCCTcodigo="+DatoCCTcodigo+params,100,50,800,650);
	}
	...
	function TraeDocsPagoCxC#Attributes.name#(dato) {
		...
		params = "&id=#Attributes.id#&name=#Attributes.name#&desc=#Attributes.desc#&conexion=#Attributes.conexion#&ecodigo=#Attributes.empresa#&Ocodigo=#Attributes.Oficina#&SNcodigo="+document.#Attributes.form#.SNcodigo.value+"&CCTcodigoJss="+document.#Attributes.form#.#Attributes.CCTcodigoConlis#.value+"&DocumentoC="+doc+"&CCTcodigoConlis=#Attributes.CCTcodigoConlis#";
		<cfif Attributes.GSNid eq 1>
		params = params + "&GSNid="+document.#Attributes.form#.GSNid.value;
		</cfif>
		...
		if (dato.value!="") {
			...
			fr.src = "/cfmx/sif/Utiles/sifDocsPagoCxCquery.cfm?dato="+dato.value+"&form="+"#Attributes.form#"+params;
	...
	<tr>
		...
		<td nowrap>
			<input type="text"
				...
				maxlength="80">
			<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de documentos" name="imagen" width="18" height="14" border="0" align="absmiddle" <cfif isdefined('Attributes.query') and ListLen(Attributes.query.columnList) GT 1><cfelse>onClick='javascript: doConlisDocsPagoCxC#Attributes.name#(document.#Attributes.form#.#Attributes.CCTcodigoConlis#.value);'</cfif>></a>
		</td>
	</tr>
</table>
