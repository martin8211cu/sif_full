...
<script language="JavaScript" type="text/javascript">
	...
	function doConlisCTR<cfoutput>#Attributes.CCTR#</cfoutput>() {
		...
		<cfoutput>		
			...
			popUpWindow<cfoutput>#Attributes.CCTR#</cfoutput>("/cfmx/sif/Utiles/ConlisCTR.cfm"+params,250,200,650,400);		
		</cfoutput>
	...
	function TraeCTR<cfoutput>#Attributes.CTR#</cfoutput>(valor) {
		<cfoutput>
			...
			if (valor!='') {
				document.all["#Attributes.frame#"].src="/cfmx/sif/Utiles/sifCTRquery.cfm"+params+"&dato="+valor;
			}
			else
			{
	...
	<cfoutput>
		<td nowrap>
			...
			<input 	type="text" 
					...
					disabled="true"
					tabindex="-1">
			<a  href="##" tabindex="-1"><img id="CCTR" src="/cfmx/sif/imagenes/Description.gif" alt="Cuentas" name="BidImagen" width="18" height="14" border="0" align="absmiddle" onClick="javascript:doConlisCTR#Attributes.CCTR#();">
