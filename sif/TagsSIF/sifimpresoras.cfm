...
function doConlisImpresoras<cfoutput>#Attributes.FAM12CODD#</cfoutput>() {
   	<cfoutput>#Attributes.FuncJSalAbrir#</cfoutput>;
		...
		<cfif Len(Trim("<cfoutput>#Attributes.FuncJSalCerrar#</cfoutput>")) GT 0 > 
   		...
   		popUpWindow<cfoutput>#Attributes.FAM12COD#</cfoutput>("/cfmx/sif/Utiles/ConlisImpresoras.cfm"+params,250,200,650,400);
   }
...
function TraeImpresora<cfoutput>#Attributes.FAM12CODD#</cfoutput>(valor, descripcion, campo) {
	...
	if (valor!="") {
		document.getElementById("<cfoutput>#Attributes.frame#</cfoutput>").src="/cfmx/sif/Utiles/sifImpresoraquery.cfm?valor="+valor+"&descripcion="+descripcion+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+"&campo="+campo+params;
...
<tr>
   ...
   <td nowrap width="1%">
	...
	<cfif Attributes.modificable>
		<a  href="##" tabindex="-1"><img id="FAM12CODD" src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Impresoras" name="BidImagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisImpresoras#Attributes.FAM12CODD#();'></a>
	</cfif>
	</td>
