...
<cfparam name="Attributes.screen" default= 'general'>
...
<cfif attributes.action is 'input'>
	...
	<table border="0" width="100%">
	    ...
	    <tr>
	      ...
	      <td ><input <cfif Attributes.screen eq 'Preferencias'>readonly</cfif> name="#Attributes.prefix#id" id="#Attributes.prefix#id" onFocus="this.select()" size="30" maxlength="60" value="#userdata.id#" ></td>
    </tr>
	    <tr>
	      <td nowrap align="right"><b><cf_translate  key="LB_Nombre">Nombre</cf_translate>:&nbsp;</b></td>
	      <td ><input <cfif Attributes.screen eq 'Preferencias'>readonly</cfif> name="#Attributes.prefix#nombre" id="#Attributes.prefix#nombre" onFocus="this.select()" size="30" maxlength="60" value="#userdata.nombre#" ></td>
    </tr>
	    <tr>
	      <td nowrap align="right"><b><cf_translate  key="LB_Apellido1">Apellido 1</cf_translate>:&nbsp;</b></td>
	      <td ><input <cfif Attributes.screen eq 'Preferencias'>readonly</cfif> name="#Attributes.prefix#apellido1" id="#Attributes.prefix#apellido1" onFocus="this.select()" size="30" maxlength="60" value="#userdata.apellido1#" ></td>
    </tr>
	    <tr>
	      <td nowrap align="right"><b><cf_translate  key="LB_Apellido2">Apellido 2</cf_translate>:&nbsp;</b></td>
	      <td ><input <cfif Attributes.screen eq 'Preferencias'>readonly</cfif> name="#Attributes.prefix#apellido2" id="#Attributes.prefix#apellido2" onFocus="this.select()" size="30" maxlength="60" value="#userdata.apellido2#"  ></td>
    </tr>
	    <tr>
...
<cfelseif Attributes.action is 'readform'>
	...
	<cfscript>
		...
		if (IsDefined("form." & Attributes.prefix & "nacimiento") and Len(Trim(form[Attributes.prefix & "nacimiento"])) )
			ret.nacimiento = LSParseDateTime( form[Attributes.prefix & "nacimiento"]);
