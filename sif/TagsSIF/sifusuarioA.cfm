...
<cfparam name="Attributes.Nombre2" 			default="Nombre2" 		type="string"> <!--- Nombres de la descripción del Usuario --->
...
<script language="JavaScript">
	...
	function doConlisUsuario<cfoutput>#Attributes.Usucodigo#</cfoutput>() {
		...
		var params ="";
		params = "<cfoutput>?formulario=#Attributes.form#&Usucodigo=#Attributes.Usucodigo#&Nombre2=#Attributes.Nombre2#</cfoutput>";
		...
		popUpWindow("/cfmx/sif/Utiles/ConlisUsuariosA.cfm"+params,95,190,830,400);
	}
</script>
...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td nowrap>
			<input tabindex="-1" type="text" name="#Attributes.Nombre2#" id="#Attributes.Nombre2#" maxlength="255" size="#Attributes.size#" readonly 
