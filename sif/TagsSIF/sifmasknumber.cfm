...
<cfset Attributes.formato = replacenocase(Attributes.formato,"N","##","all")>
...
<cfoutput>
	<input 
		...
		<script language="JavaScript1.2">
			...
			oNumberMask = new Mask("#Attributes.formato#", "number");
			oNumberMask.attach(document.#Attributes.form#.#Attributes.name#,"#Attributes.formato#", "number");
		</script>	  
</cfoutput>