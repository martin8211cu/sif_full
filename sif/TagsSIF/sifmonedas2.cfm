			 ...
			 <cfelse>
				...
				>
					...
					<cfif Attributes.Todas EQ 'S'>
						<option value="-1" <cfif isdefined("Attributes.value") and Attributes.value EQ "-1"> selected</cfif>>-- <cf_translate  key="LB_Todas">Todas</cf_translate> --</option>
					</cfif>
