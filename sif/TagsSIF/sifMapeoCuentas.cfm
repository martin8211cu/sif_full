...
function doConlisMapeo<cfoutput>#Attributes.Ccuenta#</cfoutput>() {
	<cfif Attributes.modificable>
			...
			popUpWindow<cfoutput>#Attributes.Ccuenta#</cfoutput>("/cfmx/sif/Utiles/ConlisMapeoCuentas.cfm"+params,150,100,750,700);
	</cfif>
}
...
function TraeMapeo<cfoutput>#Attributes.Ccuenta#</cfoutput>(codigo) {
	<cfif Attributes.modificable>
			...
			fr.src = "/cfmx/sif/Utiles/sifMapeoCuentasquery.cfm?codigo="+codigo+"&formulario="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
			}
			else{
	...
	<tr>
		...
		<td width="98%">
			<cfif isdefined("Attributes.conlis") and Attributes.conlis EQ true>
				<a  href="##" tabindex="-1">
					<img id="Mapeoimagen" src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Cuentas Contables Sin Mapear" name="Mapeoimagen"
