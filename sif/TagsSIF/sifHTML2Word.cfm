...
<CFPARAM NAME="Attributes.adjuntarCSSSitio" DEFAULT="true">
...
<CFIF ThisTag.HasEndTag>
    <CFSWITCH EXPRESSION="#ThisTag.ExecutionMode#">
        ...
        <CFCASE VALUE="START">
			...
			<cfif not Attributes.adjuntarCSSSitio>
				<cfset salida=''>
			</cfif>
			...
			<cfif not isdefined("url.imprimir")>
				<div align="right">
				<A href="/cfmx/sif/Utiles/sifHTML2Wordcont.cfm<cfoutput>?Archivo=#Attributes.FileName#&Titulo=#Attributes.Titulo#</cfoutput>">
					<img src="/cfmx/sif/imagenes/Cfinclude.gif" border="0"  alt="Documento en Formato MS Excel">
				</A>
				</div>
			</cfif>
