...
<script language="JavaScript" type="text/javascript">
	...
	function conlis_keyup_<cfoutput>#Attributes.name#</cfoutput>(e) {
		...
		if (keycode == 113) {<!--- El código 113 corresponde a la tecla F2 --->
			doConlisSNClasificacion<cfoutput>#Attributes.name#</cfoutput>();
		}
	}
	
	//Llama el conlis
	function doConlisSNClasificacion<cfoutput>#Attributes.name#</cfoutput>() {
		var params ="";
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/Utiles/ConlisSNClasificacion.cfm"+params,250,200,650,400);
	}
	//Obtiene la descripción con base al código
	function TraeSNClasificacion<cfoutput>#Attributes.name#</cfoutput>(dato) {
		var params ="";
		...
		if (dato!="") {
			...
			fr.src = "/cfmx/sif/Utiles/sifSNClasificacionquery.cfm?dato="+dato+"&form="+"<cfoutput>#Attributes.form#</cfoutput>"+params;
		}
		else{
			limpiarSNClasificacion<cfoutput>#Attributes.name#</cfoutput>();
		}
		return;
	}
	function limpiarSNClasificacion<cfoutput>#Attributes.name#</cfoutput>(){
	<cfoutput>
	...
	<tr>
		<td>
			...
			<input type="text"
				...
				onblur="javascript: TraeSNClasificacion#Attributes.name#(document.#Attributes.form#.#Evaluate('Attributes.name')#.value); 
		...
		<td>
			<a href="##" tabindex="-1"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista Clasificaci&oacute;n Socios de Negocios" name="imagen" width="18" height="14" border="0" align="absmiddle" onclick='javascript: doConlisSNClasificacion#Attributes.name#();'></a>
		</td>
	</tr>
	</cfoutput>
</table>
