...
<!---
	...
	*	y en el Componente sif.rh.Componentes.pListas
...
<cfif Attributes.enterAction NEQ "" AND Attributes.enterActionDefault NEQ "">
	<cf_errorCode	code = "50697" msg = "ERROR EN LA DEFINICION DEL CF_OnEnterKey: El atributo 'enterActionDefault' y 'enterAction' son excluyentes">
<cfelseif Attributes.enterActionDefault NEQ "" AND NOT listFind("submit,tab,none",Attributes.enterActionDefault)>
	<cf_errorCode	code = "50698" msg = "ERROR EN LA DEFINICION DEL CF_OnEnterKey: El atributo 'enterActionDefault' solo permite: submit,tab,none">
<cfelseif Attributes.enterAction NEQ "" AND NOT listFind("submit,tab,none",Attributes.enterAction)>
	<cf_errorCode	code = "50699" msg = "ERROR EN LA DEFINICION DEL CF_OnEnterKey: El atributo 'enterAction' solo permite: submit,tab,none">
<cfelseif Attributes.enterAction NEQ "" AND (Attributes.onKeyDown EQ ":" OR Attributes.onKeyPress EQ ":")>
	<cf_errorCode	code = "50700" msg = "ERROR EN LA DEFINICION DEL CF_OnEnterKey: El atributo 'enterAction' requiere los atributos 'onKeyDown' y 'onKeyPress'">
</cfif>
...
<cfif NOT isdefined("request.scriptOnEnterKeyDefinition")>
	...
	<script language="javascript" type="text/javascript" src="/cfmx/sif/js/utilesOnEnterKey.js"></script>
	</cfoutput>
</cfif>
<cfif Attributes.enterActionDefault NEQ "">
	<cfoutput>
	<script>CF_onEnter_Initializate("#Attributes.enterActionDefault#");</script>
	</cfoutput>
</cfif>
