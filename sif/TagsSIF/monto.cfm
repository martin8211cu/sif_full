...
<cfif isdefined("Attributes.enteros")>
	<cf_errorCode	code = "50696" msg = "ERROR EN LA DEFINICION DEL cf_monto: El atributo ENTEROS no es permitido, debe utilizar SIZE">
</cfif>
...
<CF_inputNumber 
	...
	obligatorio		= "#Attributes.obligatorio#"
>
