...
<cfif isdefined("Attributes.idempleado") and len(trim(Attributes.idempleado)) >
	...
	<cf_dbfunction name="concat"	args="DEnombre,DEapellido1,DEapellido2" returnvariable="LvarDEnombre" >
	<cfquery name="#queryDEid#" datasource="#session.DSN#">
		select DEid, DEidentificacion, #LvarDEnombre# as DEnombre 
		from DatosEmpleado 
