...
--->
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="MSG_Advertencia" default="Advertencia" returnvariable="MSG_Advertencia" xmlfile="PleaseWait.xml"/>
<CFIF ((Trim(Attributes.TITLE) IS "") AND (IsDefined("Attributes.FIELDNAMES")) AND (Attributes.JAVASCRIPT IS "NO")) OR (Attributes.DISPLAY IS "JAVASCRIPT")>
	<CFSET Attributes.TITLE = "#MSG_Advertencia#!">
<CFELSEIF Trim(Attributes.TITLE) IS "">
