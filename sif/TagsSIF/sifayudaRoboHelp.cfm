...
<cfoutput>
	<img	name="#Attributes.name#"
		src=
			<cfif Attributes.imagen EQ 0>"#cgi.CONTEXT_PATH#/sif/imagenes/help_u.gif"</cfif>
			<cfif Attributes.imagen EQ 1>"#cgi.CONTEXT_PATH#/sif/imagenes/Help01_T.gif"</cfif>
			<cfif Attributes.imagen EQ 2>"#cgi.CONTEXT_PATH#/sif/imagenes/Bulb.gif"</cfif>
			<cfif Attributes.imagen EQ 3>"#cgi.CONTEXT_PATH#/sif/imagenes/Help02_T.gif"</cfif>
		border="0" 
		style="cursor:hand;"
