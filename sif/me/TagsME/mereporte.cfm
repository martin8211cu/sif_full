...
<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#DFDFDF">
  <tr align="left"> 	
<!--- 	<td nowrap>
	<a href="/cfmx/sif/me/index.cfm"><cfoutput>Sistema Modelo Entidad#Request.Translate('Sistema Modelo Entidad','ME','/cfmx/sif/me/Utiles/Generales.xml')#</cfoutput></a>
	</td>
 --->
	<td nowrap>
		<a href="/cfmx/sif/me/index.cfm"><cfoutput>Sistema Modelo Entidad</cfoutput></a>
	</td>
 
 	<td>|</td>	
	<cfif len(trim(Attributes.modulo)) gt 0 and len(trim(Attributes.modulolink)) gt 0 and len(trim(Attributes.modulodesc)) gt 0>
		<td nowrap>
			<cfoutput><a href="#Attributes.modulolink#">#Request.Translate(Attributes.modulo,Attributes.modulodesc,'/sif/me/Utiles/Generales.xml')#</a></cfoutput>
		</td>
		<td>|</td>
	</cfif>
	<td>
