<cfcomponent>
<script type="text/javascript" language="JavaScript" src="/cfmx/sif/me/js/pLista1.js"></script>
<cf_templatecss>
<cffunction name="pListaME" access="public" returntype="string" output="true">
