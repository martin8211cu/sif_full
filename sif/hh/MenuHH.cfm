        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr class="area"> 
            ...
            <td nowrap>
              ...
              <div align="center"><span class="superTitulo"><font size="5">Ayudas del Sistema</font></span></div>
			</td>
          </tr>
          <tr class="area"> 
...
<!--- 		<cf_web_portlet border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Ayudas del Sistema'> --->
 		  ...
 		  <!--- <cfinclude template="../Utiles/Parametrizado.cfm"> --->
            <table width="80%" border="0" align="center" cellpadding="1" cellspacing="0">
              ...
              <tr> 
                <td width="1%"><font size="2">&nbsp;</font></td>
                <td width="5%" nowrap><font size="2">&nbsp;</font></td>
                <td width="1%" align="right" valign="middle"> <div align="right"><a href="../hh/operacion/Ayudas.cfm"><img src="../imagenes/ftv4doc.gif" width="24" height="22" border="0"></a></div></td>
                <td nowrap><font size="2"><a href="../hh/operacion/Ayudas.cfm">Registro 
                  de Ayuda</a></font></td>
                <td>&nbsp;</td>
                <td width="1%">&nbsp;</td>
                <td width="5%">&nbsp;</td>
              ...
              <tr> 
                <td width="1%">&nbsp;</td>
                <td width="5%" nowrap><font size="2">&nbsp;</font></td>
                <td width="1%" align="right" valign="middle"> <div align="right"><a href="/cfmx/sif/hh/catalogos/Idiomas.cfm"><img src="../imagenes/ftv4doc.gif" width="24" height="22" border="0"></a></div></td>
                <td nowrap><font size="2"><a href="/cfmx/sif/hh/catalogos/Idiomas.cfm">Idiomas</a></font></td>
                <td>&nbsp;</td>
                <td width="1%">&nbsp;</td>
                <td width="5%">&nbsp;</td>
                <td>&nbsp;</td>
