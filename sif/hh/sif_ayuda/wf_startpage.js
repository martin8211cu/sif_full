...
function DoCommand(cmd, param1, param2) {
	switch (cmd) {
		...
		case "CmdCanFocusBeSet":
			SendCmdToMasterHTML("CmdFocusCanBeSet", ((gbIE) ? true : false));
			break;
...
function TestLoaded(bVert) {
	...
	gsFlashHelpVersion="FlashHelp 1.00";
...
var gsFlashHelpVersion="FlashHelp%201.00";
