...
<cfoutput>#producto.Adescripcion#</cfoutput></center>
<cfif data.RecordCount GT 1>
	...
	<cfoutput query="data">
	<td height="60"><a href="##" onClick="loadImage('foto#data.ILinea#')"><img 
		src="producto_img.cfm?tid=#session.Ecodigo#&id=#URLEncodedFormat(data.Aid)
		#&fid=#URLEncodedFormat(data.ILinea)#&dft=na&sz=sm" id='foto#data.ILinea#' height="60" style="border:2px solid white"></a></td>
	</cfoutput>	
	</tr></table>
	</div>
</cfif>
...
<cfoutput>
<img align="absmiddle" src="producto_img.cfm?tid=#session.Ecodigo#&id=#URLEncodedFormat(data.Aid)
	#&fid=#URLEncodedFormat(data.ILinea)#&dft=na&sz=nr"  height="240" border="1" id="bigimage" >
</cfoutput>
