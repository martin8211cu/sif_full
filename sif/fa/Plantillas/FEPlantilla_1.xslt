            ...
            <table border="0">
                ...
                <table border="1" cellspacing="0" cellpadding="2" style="font-size:12px;" width="851px">
                    <tr>
                        ...
                        <td align = "center" width="10%"><strong>Clave Unidad de Medida</strong></td>
                        <td align = "center" width="10%"><strong>Unidad de Medida</strong></td>
                        <td align = "center" width="10%"><strong>Clave de Servicio/Producto</strong></td>
                        <td align = "center" width="40%"><strong>Descripci&#243;n</strong></td>
                        <td align = "center" width="10%"><strong>Precio Unitario</strong></td>
                    ...
                    <xsl:for-each select = "//cfdi:Conceptos/cfdi:Concepto">
                        <tr>
                            ...
                            <td align = "center" style = "border-left : 1px solid black;"><xsl:value-of select = "@ValorUnitario"/></td>
