                    ...
                    <tr>
                        ...
                        <td>
                            <table style = "font-size : 10px;">
                                ...
                                <tr>
                                    <td>
                                        <span style="font-weight:900;position:relative;bottom:1px;">VERSI&#211;N : </span>&#160;3.3
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <td width="100%">
                                        <table width="100%" style = "font-size : 10px;" cellspacing = "0" cellpadding = "0">
                                            <tr style = "background-color : #d80000; color : white; font-size : 12px;">
                                                ...
                                                <td align = "center" style = "border : 1px solid black;">TOTAL</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style = "border-top : 1px solid black; padding-bottom : 50px;" colspan = "6">
                                                    <p>
