  ...
  <!---Es x plan de compras?---->
   ...
   <cfif rsOrden.Mcodigo neq  rsMontoMax.Mcodigo>
	...
	<cfif LvarMontoDoc gt LvarMontoMaxCMC and modo EQ "CAMBIO" and rsOrden.EOestado neq -7 and rsOrden.EOestado neq 9 and rsOrden.EOestado neq -8 >
        ...
        <tr align="center">
			<td class="style7"> Si aplica esta orden pasará a un proceso de aprobación, donde el jefe de compras deberá autorizar el pedido.			</td>
	   </tr>
	</cfif>
	<tr>
    ...
    <td>
	  <table align="right" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right">
					<input class="cajasinbordeb" type="text" style="text-align:right" readonly id="_iEPS" name="_iEPS" value="<cfif modo EQ "CAMBIO">#LSCurrencyFormat(rsTotales.ieps,'none')#<cfelse>0.00</cfif>">
				</td>
			</tr>
			...
			<tr>
				...
				<td align="right">
					<input class="cajasinbordeb" type="text" style="text-align:right; " readonly id="_total" name="_total" value="<cfif modo EQ "CAMBIO">#LSCurrencyFormat(rsTotales.total,'none')#<cfelse>0.00</cfif>">
				</td>
			</tr>
	  </table>
