...
<cfif isdefined("form.Alta")>
    <cfinvoke component="sif.Componentes.Pedido_AplicaOC" method="insert_EOrdenCM" returnvariable="LvarEOidorden">
...
<cfelseif isdefined("form.Baja")>
	...
	<cfloop query="rsdel">
		<cfinvoke component="sif.Componentes.Pedido_AplicaOC" method="delete_DOrdenCM">
	...
	<cfinvoke component="sif.Componentes.Pedido_AplicaOC" method="delete_EOrdenCM">
    	<cfinvokeargument name="eoidorden" value="#form.EOidorden#">
        <cfinvokeargument name="ecodigo"   value="#lvarFiltroEcodigo#">
    </cfinvoke>
...
<cfelseif isdefined("form.AltaDet")>
	...
	<cfif not vbHayContrato>
		...
		<cfinvoke component="sif.Componentes.Pedido_AplicaOC" method="insert_DOrdenCM">
        	<cfinvokeargument name="eoidorden" 			value="#form.EOidorden#">
...
<cfelseif isdefined("form.CambioDet")>
	<cfif not isdefined('form.EOestado') OR form.EOestado EQ 5>
		...
		<cfif not vbHayContrato>
            <cfinvoke component="sif.Componentes.Pedido_AplicaOC" method="update_DOrdenCM">
		...
		<cfelse>
				<cfquery name="rsActualizaFechaReq" datasource="#session.dsn#">
					update DPedido set DOfechaes = <cfif len(trim(form.DOfechaes)) ><cfqueryparam cfsqltype="cf_sql_timestamp"	value="#LSParseDateTime(form.DOfechaes)#"><cfelse>null</cfif>
					where EOidorden = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.EOidorden#">
						and DOlinea = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.DOlinea#">
				</cfquery>
		</cfif>
...
<cfelseif isdefined("Form.btnAplicar")>
	...
	<cfinvoke component="sif.Componentes.Pedido_AplicaOC" method ="fnAplicaOC" returnvariable ="LvarNap">
    	<cfinvokeargument name="EOidorden"  value="#form.EOidorden#">
        <cfinvokeargument name="CMCid" 		value="#vnCMCid#">
        <cfinvokeargument name="Ecodigo" 	value="#lvarFiltroEcodigo#">
    </cfinvoke>
...
<cfelseif isdefined('form.btnReiniciar')>
	<cfinvoke component="sif.Componentes.Pedido_OrdenCompra" method="ReiniciaAutorizacion">
    	<cfinvokeargument name="EOidorden" value="#form.EOidorden#">
        <cfinvokeargument name="Ecodigo" value="#lvarFiltroEcodigo#">
    </cfinvoke>
...
<cffunction name="calculaMonto" access="private" output="no">
	...
	<cfinvoke 	component	= "sif.Componentes.Pedido_AplicaOC"
