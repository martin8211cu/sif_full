	...
	<cfoutput>
		<script language="javascript1.2" type="text/javascript">
			...
			function imprime() {				
				...
				popUpWindow("/cfmx/sif/fa/pedidos/operacion/imprimeOrden.cfm?EOidorden=#url.EOidorden#&primeravez=ok" + params,250,200,650,400);
			}
			imprime();
		</script>
	</cfoutput>
...
<cf_templateheader title="Pedidos">
	<cfinclude template="../../../portlets/pNavegacionCM.cfm">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Pedidos'>
			<table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td nowrap >
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Debe de ir al mantenimiento y completar los datos requeridos para poder aplicar el Pedido.</font>
					</td>
				</tr>
				<tr><td>&nbsp;</td></tr>
			</table>
...
<script language="javascript1.2" type="text/javascript">
	...
	function funcAplicar(){
		...
		if (document.lista.chk) {
			...
			alert('No se han seleccionado Órdenes')		}         
	...
	function fnPuede(o)
	{
		...
		if (LvarKeys[1] == 1)
			...
			return confirm('¿Si aplica esta orden de compra, se generara una jerarquía de aprobación, desea Continuar?');
	}
</script>