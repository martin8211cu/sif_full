...
<!---<cfthrow message="-#url.Cuenta#">---->
	...
	<cfif url.servicioTimbre eq "FACTUS">
		<cfquery name="AgregarUrl" datasource="#Session.DSN#">
				update Parametros
				set Pvalor = <cf_jdbcquery_param cfsqltype="cf_sql_varchar"  value="#url.Urlv_factus#">
				where Ecodigo = #Session.Ecodigo#
				and Pcodigo = 4411
		</cfquery>
		<cfquery name="Agregartkn" datasource="#Session.DSN#">
				update Parametros
				set Pvalor = <cf_jdbcquery_param cfsqltype="cf_sql_varchar"  value="#url.tkn_factus#">
				where Ecodigo = #Session.Ecodigo#
				and Pcodigo = 4412
		</cfquery>
	<cfelse>--->
