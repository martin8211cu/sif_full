...
<cfparam name="Attributes.FMT01COD" default="FACT">
<cfparam name="Attributes.OImpresionID" default="0">
...
<script language="javascript">
	function sbDownload(pObjeto)
	{
		...
		location.href = "ProcImprimeDocumento.cfm?modo=DATA&Download=1";
	}
</script>
<script language="javascript">
	sbDownload("Imprime1");
...
<iframe width="00" height="00" id="ifrDatos" src="ProcImprimeDocumento.cfm?modo=DATA&amp;FMT01COD=#Attributes.FMT01COD#&amp;OImpresionID=#Attributes.OImpresionID#" 
		style="display:none">
</iframe>                                    
<!---ya--->
</cfoutput>