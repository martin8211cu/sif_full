...
<cfif isdefined("form.Alta")>
    <cfinvoke component="sif.Componentes.FAP_AplicaPedidos" method="insert_EOrdenCM" returnvariable="LvarEOidorden">
        ...
        <cfinvokeargument name="eotc" 				value="1"/>
...
<cfelseif isdefined("form.Baja")>
	...
	<cfinvoke component="sif.Componentes.FAP_AplicaPedidos" method="delete_EOrdenCM">
    	<cfinvokeargument name="eoidorden" value="#form.EOidorden#">
        <cfinvokeargument name="ecodigo"   value="#lvarFiltroEcodigo#">
    </cfinvoke>
...
<cfelseif isdefined("form.AltaDet")>
	...
	<cfif not vbHayContrato>
        ...
        <cfset params = AddParam(params,'Ecodigo_f',lvarFiltroEcodigo)>
	<cfelse>
		<cf_errorCode	code = "50308" msg = "El bien de la línea esta asociada a un contrato, por lo tanto no puede ser agregado al Pedido">
	</cfif>
...
<cfelseif isdefined("Form.btnAplicar")>
	...
	<cfif dataMonto.EOtotal lte 0>
		<cf_errorCode	code = "50309" msg = "El monto del Pedido debe ser mayor a cero!">
	</cfif>

	<cfinvoke component="sif.Componentes.FAP_AplicaPedidos" method ="fnAplicaOC" returnvariable ="LvarNap">
    	<cfinvokeargument name="EOidorden"  value="#form.EOidorden#">
        <cfinvokeargument name="CMCid" 		value="#vnCMCid#">
        <cfinvokeargument name="Ecodigo" 	value="#lvarFiltroEcodigo#">
    </cfinvoke>
    ...
    <cfquery datasource="#Session.DSN#">
        ...
        select
            'CCAP',
            1,
            'Rem: '+ cast(err.EOnumero as varchar(30)) as des,
            'SN',
            DOtotal,
            'D',
            'DOCRemision:',
            ...
            DOtotal,
            drr.CFid
            from ERemisionesFA err
            inner  join  DRemisionesFA drr
            on err.EOidorden = drr.EOidorden
          where err.EOidorden = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.EOidorden#">
    </cfquery>
    ...
    <cfquery datasource="#Session.DSN#">
        ...
        select
            'CCAP',
            1,
            'COMPRA'+ cast(err.EOnumero as varchar(30)) as des,
            'SN',
           ...
           from ERemisionesFA err
            ...
            on err.EOidorden = drr.EOidorden
            where err.EOidorden = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.EOidorden#">
            group by  drr.EOidorden,err.EOnumero,err.Mcodigo,err.EOtc,drr.CFid
    </cfquery>
    ...
    <cfinvoke
        ...
        emes            = "#Mes#"
        efecha          = "#now()#"
        edescripcion    = "Poliza Remision Venta"
        edocbase        = "#form.EOidorden#"
        ereferencia     = "SN"
        debug           = "false"
        usuario         = "#usuario#"
        Ocodigo         = "0"
        Usucodigo       = "#form.Ucodigo#"
...
<cfelseif isdefined('form.btnReiniciar')>
	<cfinvoke component="sif.Componentes.FAP_Pedidos" method="ReiniciaAutorizacion">
    	<cfinvokeargument name="EOidorden" value="#form.EOidorden#">
        <cfinvokeargument name="Ecodigo" value="#lvarFiltroEcodigo#">
    </cfinvoke>
