...
<cfif isdefined("form.DOlinea") and len(trim(form.DOlinea))>
	...
	<cfquery name="rsLinea" datasource="#Session.DSN#">
		...
		from DRemisionesFA a
			left outer join ERemisionesFA eo
...
<input type = "hidden" name = "eotc" value = "<cfif isdefined("rsOrden") and len(trim(rsOrden.CMCid))>#rsOrden.eotc#</cfif>">

<table align="center" width="99%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="subTitulo"><font size="2">Detalle de Pedidos</font></td>
  </tr>
</table>
