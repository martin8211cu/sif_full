...
<cfquery name="rsEOrden" datasource="#Session.DSN#">
	select Mcodigo from ERemisionesFA where EOidorden = #form.LLave#
</cfquery>
...
--->
<form style="margin: 0" action="popUp-contrato.cfm?EOidorden=<cfoutput>#form.llave#</cfoutput>" name="fcontrato" id="fcontrato" method="post">
...
<br />
    ...
    <cfquery name="rsListaItems" datasource="#session.dsn#">
	   ...
	   where e.Ecodigo=#session.Ecodigo#
	   	and getdate() between e.CTfechaIniVig and e.CTfechaFinVig + 1
	   	and e.CTMcodigo = #rsEOrden.Mcodigo#
            ...
            <td>
				...
				<cfif (isdefined("form.TipoItem") and trim(form.TipoItem) EQ 'C') >
                 ...
                 <cfinvoke component="sif.Componentes.pListas" method="pListaQuery">
                    ...
                    <cfinvokeargument name="irA" value="popUp-contrato-SQL.cfm?EOidorden=#form.llave#">
                    ...
                    <cfinvokeargument name="keys" value="CPDDid,llave,modulo">
    ...
    <!--//
		function funcAgregar(){
			<cfoutput>
			if (document.fcontrato.Modulo.value =='EO' && document.fcontrato.Icodigo.value.length == 0 ){
