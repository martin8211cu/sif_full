...
<cfif isdefined("form.linea") and len(trim(form.linea)) and form.modo eq "CAMBIO">
	 ...
	 <cfquery name="rsUpdate" datasource="#session.dsn#">
		update DRemisionesFA set DOcantidad = <cfqueryparam cfsqltype="cf_sql_float" value="#form.cantidad#">,
...
<cfelseif isdefined("url.linea") and len(trim(url.linea)) and url.modo eq "BAJA">  
	 ...
	 delete DRemisionesFA where DOlinea = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.linea#">
	 </cfquery>
