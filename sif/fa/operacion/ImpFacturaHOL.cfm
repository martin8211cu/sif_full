        	...
        	<td colspan="6">
        		<table align="center" width="100%" border="0" cellpadding="0" cellspacing="3">
                    ...
                    <cfif rsDirOficina.direccion GT 0>
                    	<tr>
                        	<td class="LetraTitulo"><cfoutput>#rsOficina.Odescripcion#</cfoutput></td>
                    	</tr>
                        <tr>
                    ...
                    <tr>
                      <td class="LetraInfo" nowrap="nowrap"><cfoutput>#rsDatosfac.SNidentificacion# #rsDatosfac.SNidentificacion2#</cfoutput></td>
                    </tr>
                    <tr>
...
<cffunction name="PrintLineasHeader">
    ...
    <cfelse>
		<cfif rsDatosfac.CCTcodigo EQ 'FC' OR rsDatosfac.CCTcodigo EQ 'FA'> <cfset docs='FACTURA #rsDatosfac.PFDocumento#'>
        <cfelseif rsDatosfac.CCTcodigo EQ 'NC'> <cfset docs='NOTA DE CREDITO #rsDatosfac.PFDocumento#'>
        <cfelseif rsDatosfac.CCTcodigo EQ 'ND'> <cfset docs='NOTA DE DEBITO #rsDatosfac.PFDocumento#'>
        </cfif>
    </cfif>    
