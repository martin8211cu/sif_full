<cfif isdefined("url.download")>
    ...
    <cflocation url="../MenuFA.cfm">
</cfif>

<cfparam name="impresion_CBidioma" default="-1">
<cfparam name="var_PrimerFAC" default="000">
<cfparam name="var_Cantidad" default="1">
<cfparam name="form.FMT01COD" default="FACREDITO">
...
<cfquery name="rsFormatoDoc" datasource="#session.dsn#">
    SELECT
        ...
        'DdocumentoId'	as FMT01KEY,  /* Numero Doc para corte */
...
<!--- parametros --->
<cfset LvarSQL = ReplaceNoCase(LvarSQL, "##ETnumero##", "#url.ETnumero#", "ALL")>
<cfset LvarSQL = ReplaceNoCase(LvarSQL, "##FCid##", "#url.FCid#", "ALL")>

<cfquery name="rsDatos" datasource="#session.dsn#">
	#preservesinglequotes(LvarSQL)#
</cfquery>

<cfquery name="rsqDocumento" dbtype="query">
	select count(distinct #rsFormatoDoc.FMT01KEY#) as cantidad
	 		, min (#rsFormatoDoc.FMT01KEY#) as PrimerFAC
	  from rsDatos
</cfquery>

<cfset var_PrimerFAC = rsqDocumento.PrimerFAC>
...
<cfif LvarLinea NEQ "" or len(trim(LvarLinea)) neq 0>
