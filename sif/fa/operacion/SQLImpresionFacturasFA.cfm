	...
	<cfif isDefined("Form.Aplicar")>
		...
		<cfif imprimir>
			<cflocation addtoken="no" url="ImpresionFacturasFA.cfm?tipo=#Url.tipo#&imprimirPDF=S&FCid=#valores[1]#&ETnumero=#valores[2]#">
		<cfelse>
			<cflocation addtoken="no" url="ImpresionFacturasFA.cfm?tipo=#Url.tipo#">				
		</cfif>	
