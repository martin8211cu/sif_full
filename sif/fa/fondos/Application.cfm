...
<cfif IsDefined("Form.logout")>
 	<cflogout>
	<cflocation url="http://sab-sifweb:8083/servlet/soin.sif.cjc.cjc_PU?CARPETA=#url.CARPETA#&PANTALLA=#url.PANTALLA#">
</cfif>
<cfif IsDefined("url.IDSESSION")>
	...
	<cfif isdefined("QueryID") and QueryID.recordcount eq 0>	
		<cflocation url="http://sab-sifweb:8083/nossesionPU.htm"> 
	</cfif>
