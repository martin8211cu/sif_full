	...
	<cftry>
		<cfquery datasource="#session.Fondos.dsn#"  name="sql" > 
			...
			<cfif isdefined("form.Alta")>
				...
				@CJX19REL,
				@CJX20NUM,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.CJX20TIP#" >,
				<cfif len(trim(form.PROCOD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.PROCOD#"><cfelse>null</cfif>,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.CJX20NUF#" >,
				convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CJX20FEF#">, 103), 
				<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.EMPCOD#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20TOT#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20DES#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20MUL#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20RET#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20IMP#" >,
				<cfqueryparam cfsqltype="cf_sql_float"  value="#form.CJX20MNT#" >,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.CP9COD#" >,
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.DEPCOD#" >
				)
				<cfset modo = "CAMBIO">
			...
			<cfelseif isdefined("form.Cambio")>
				UPDATE CJX020 SET 
				CJX20TIP  = <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX20TIP#" >,
				PROCOD   = <cfif len(trim(form.PROCOD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.PROCOD#"><cfelse>null</cfif>,
				CJX20NUF  = <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX20NUF#" >,
				CJX20FEF  = convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CJX20FEF#">, 103),
				EMPCOD   = <cfqueryparam cfsqltype="cf_sql_varchar"   value="#form.EMPCOD#" >,
				CJX20TOT  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20TOT#" >,
				CJX20DES  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20DES#" >,
				CJX20MUL  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20MUL#" >,
				CJX20RET  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20RET#" >,
				CJX20IMP  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20IMP#" >,
				CJX20MNT  = <cfqueryparam cfsqltype="cf_sql_float"    value="#form.CJX20MNT#" >,
				CP9COD   = <cfqueryparam cfsqltype="cf_sql_varchar"   value="#form.CP9COD#" >,
				I04COD   = <cfqueryparam cfsqltype="cf_sql_varchar"   value="#form.DEPCOD#" >
			...
			<cfif isdefined("form.Altadet") OR isdefined("form.Cambiodet")>
			   ...
			   <!---************************************************ --->
				<cfquery datasource="#session.Fondos.dsn#"  name="sql3" > 
					...
					WHERE  CJM07COD =<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >
				</cfquery>
				<!---************************************************ --->
				...
				<cfquery datasource="#session.Fondos.dsn#"  name="sql4" > 
					SELECT  CJX20FEF
					FROM  CJX020
					WHERE CJX19REL = <cfqueryparam cfsqltype="cf_sql_integer" value="#CJX19REL#" > 
					AND   CJX20NUM = <cfqueryparam cfsqltype="cf_sql_integer" value="#CJX20NUM#" >
				</cfquery> 
				<!---************************************************ --->
				...
				<cfif len(trim(sql3.CJM07VAL)) gt 2> 
						<cfquery datasource="#session.Fondos.dsn#"  name="proc" >
							set nocount on
							exec  #sql3.CJM07VAL#
							@CJ01ID = <cfqueryparam  cfsqltype="cf_sql_varchar" value="#trim(ltrim(session.Fondos.Caja))#" >
							,@CJX19REL = <cfqueryparam  cfsqltype="cf_sql_integer" value="#CJX19REL#" >
							,@CJX20NUM = <cfqueryparam  cfsqltype="cf_sql_integer" value="#CJX20NUM#" >
							,@CJX21MNT = <cfqueryparam  cfsqltype="cf_sql_integer" value="#CJX21MNT#" >
							,@CJX20FEC = <cfqueryparam cfsqltype="cf_sql_varchar" value="#sql4.CJX20FEF#">
							,@CGM1ID = <cfqueryparam  cfsqltype="cf_sql_integer" value="#form.CGM1ID#" >
							,@CGM1IM = <cfqueryparam  cfsqltype="cf_sql_varchar" value="#form.CGM1IM#" >
							,@CGM1CD = <cfqueryparam  cfsqltype="cf_sql_varchar" value="#form.CGM1CD#" >
		...
		<cfquery datasource="#session.Fondos.dsn#"  name="sql" > 
			...
			<cfif isdefined("form.Altadet")>
				...
				select @CJX19REL = <cfqueryparam  cfsqltype="cf_sql_integer" value="#CJX19REL#" >
				select @CJX20NUM = <cfqueryparam  cfsqltype="cf_sql_integer" value="#CJX20NUM#" >
				...
				VALUES (
					 ...
					 @CJX20NUM,
					 @CJX21LIN,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21TIP#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MDU#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21IIN#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21DSC#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21CAN#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21PRE#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21PDS#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MDS#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MNT#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21IGA#" >,
					 <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21ICF#" >,
					 <cfif len(trim(form.CJM16COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM16COD#"><cfelse>null</cfif>,    
					 ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGE1COD#" >)),
					 ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGE5COD#" >)),
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.PR1COD#" >,
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.PRT7IDE#" >,
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CP6RUB#" >,
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CP7SUB#" >,
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CJM12ID#" >,
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CJM13ID#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.I92COD#" >,
					 <cfif len(trim(form.I06COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.I06COD#"><cfelse>null</cfif>,    
					 <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CGM1ID#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGM1IM#" >,
					 <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGM1CD#" >
				)
				<cfif len(trim(CJX22INF)) NEQ 0>
					 ...
					 VALUES (
						 ...
						 @CJX21LIN, 
						<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >,
						ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#CJX22INF#" >)),
						<cfif isdefined ("proc.empresa") and  proc.empresa neq "">
							<cfif len(trim(proc.empresa)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#proc.empresa#"><cfelse>null</cfif>,
						<cfelse>
							null,
						</cfif>
						<cfif isdefined ("proc.sucursal") and  proc.sucursal neq "">
							<cfif len(trim(proc.sucursal)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#proc.sucursal#"><cfelse>null</cfif>
						<cfelse>
							null
						</cfif>
					)
			...
			<cfelseif isdefined("form.Cambiodet")>
				UPDATE CJX021 SET
				CJX21TIP =    <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21TIP#" >,
				CJX21MDU =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MDU#" >,
				CJX21IIN =      <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21IIN#" >,
				CJX21DSC =   <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJX21DSC#" >,
				CJX21CAN =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21CAN#" >,
				CJX21PRE =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21PRE#" >,
				CJX21PDS =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21PDS#" >,
				CJX21MDS =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MDS#" >,
				CJX21MNT =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21MNT#" >,
				CJX21IGA =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21IGA#" >,  
				CJX21ICF =   <cfqueryparam cfsqltype="cf_sql_money"   value="#form.CJX21ICF#" >, 
				CJM16COD =   <cfif len(trim(form.CJM16COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM16COD#"><cfelse>null</cfif>,
				CGE1COD =    ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGE1COD#" >)),
				CGE5COD =    ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGE5COD#" >)),
				PR1COD =     <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.PR1COD#" >, 
				PRT7IDE =     <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.PRT7IDE#" >,
				CP6RUB =     <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CP6RUB#" >, 
				CP7SUB =      <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CP7SUB#" >,
				CJM12ID =    <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CJM12ID#" >,  
				CJM13ID =      <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CJM13ID#" >,
				CJM07COD =   <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >,
				I92COD =    <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.I92COD#" >,
				I06COD =    <cfif len(trim(form.I06COD)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.I06COD#"><cfelse>null</cfif>, 
				CGM1ID =    <cfqueryparam  cfsqltype="cf_sql_integer"  value="#form.CGM1ID#" >,
				CGM1IM =    <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGM1IM#" >,
				CGM1CD =  <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CGM1CD#" >
				WHERE CJX19REL = <cfqueryparam cfsqltype="cf_sql_integer" value="#CJX19REL#" > 
				...
				<cfif len(trim(CJX22INF)) NEQ 0>
					UPDATE CJX022 SET
					CJM07COD =  <cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >,
					CJX22INF = ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#CJX22INF#" >)),
					<cfif isdefined ("proc.empresa") and  proc.empresa neq "">
						CGE1COD  =  <cfif len(trim(proc.empresa)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#proc.empresa#"><cfelse>null</cfif>,
					<cfelse>
						CGE1COD  =  null,
					</cfif>
					<cfif isdefined ("proc.sucursal") and  proc.sucursal neq "">
						CGE5COD  =  <cfif len(trim(proc.sucursal)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#proc.sucursal#"><cfelse>null</cfif>
					<cfelse>
						CGE5COD  =  null
					</cfif>     
					 WHERE CJX19REL = <cfqueryparam cfsqltype="cf_sql_integer" value="#CJX19REL#" > 
				...
				<cfif len(trim(CJX22INF)) NEQ 0>
					...
					INSERT CJX022 (CJX19REL ,CJX20NUM, CJX21LIN,CJM07COD,CJX22INF,CGE1COD ,CGE5COD) 
					VALUES (
						<cfqueryparam cfsqltype="cf_sql_integer" value="#CJX19REL#" >,
						<cfqueryparam cfsqltype="cf_sql_integer" value="#CJX20NUM#" >,
						<cfqueryparam cfsqltype="cf_sql_integer" value="#form.CJX21LIN#" >, 
						<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.CJM07COD#" >,
						ltrim(rtrim(<cfqueryparam cfsqltype="cf_sql_varchar"  value="#CJX22INF#" >)),
						<cfif isdefined ("proc.empresa") and  proc.empresa neq "">
							<cfif len(trim(proc.empresa)) gt 0><cfqueryparam cfsqltype="cf_sql_varchar"  value="#proc.empresa#"><cfelse>null</cfif>,
