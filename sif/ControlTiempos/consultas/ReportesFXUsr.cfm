<cf_template>
	<cf_templatearea name="title">
		Reporte Faltantes por Usuario
	</cf_templatearea>
	<cf_templatearea name="body">
		<cf_web_portlet titulo="Faltantes por Usuario">
	 		<cfinclude template="../../portlets/pNavegacion.cfm">
			<br>
			<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td>
					<form name="form1" action="SQLReportesFXUsr.cfm" method="post" >
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td>Este reporte muestra todas las actividades faltantes 
						...
						<table width="100%" cellspacing="0" cellpadding="0" class="AreaFiltro">
						  ...
						  <tr>
							...
							<td width="9%">
								<input name="ckVerFines" type="checkbox" id="ckVerFines" 
									   value="ckVerFines" <cfif isdefined('form.ckVerFines')> checked</cfif>>
							</td>	
