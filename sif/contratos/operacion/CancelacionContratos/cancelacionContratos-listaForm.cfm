...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_PPres" Default= "Periodo del Presupuesto" XmlFile="cancelacionContratos.xml" returnvariable="LB_PPres"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_NumContrato" Default= "Numero de contrato" XmlFile="cancelacionContratos.xml" returnvariable="LB_NumContrato"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_InVig" Default= "Fecha de inicio de vigencia" XmlFile="cancelacionContratos.xml" returnvariable="LB_InVig"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Fecha" Default= "Fecha" XmlFile="cancelacionContratos.xml" returnvariable="LB_Fecha"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_FnVig" Default= "Fecha de fin de vigencia" XmlFile="cancelacionContratos.xml" returnvariable="LB_FnVig"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Proveedor" Default= "Proveedor" XmlFile="cancelacionContratos.xml" returnvariable="LB_Proveedor"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Contrato" Default= "Contrato" XmlFile="cancelacionContratos.xml" returnvariable="LB_Contrato"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Desc" Default= "Descripci&oacute;n del Contrato" XmlFile="cancelacionContratos.xml" returnvariable="LB_Desc"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Monto" Default= "Monto del Contrato" XmlFile="cancelacionContratos.xml" returnvariable="LB_Monto"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Saldo" Default= "Saldo" XmlFile="cancelacionContratos.xml" returnvariable="LB_Saldo"/>
...
<form name="form1" method="post" action="cancelacionContratos-lista.cfm?key=1">
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="areaFiltro">
  ...
  <tr> 
  	<td><cfoutput>#LB_NumContrato#</cfoutput>:&nbsp;
        <input  name="CTCnumContrato" id="CTCnumContrato" type="text" tabindex="1"  value="" size="20" maxlength="30">
		<div align="right"></div>
  	</td> 
    ...
    <td>
	  ...
	  <cfinvoke 
		 ...
		 returnvariable="pListaRet">
		  ...
		  <cfinvokeargument name="desplegar" value="CTCnumContrato, CTCdescripcion, SNnombre, CTmonto, CTfecha"/>
		  <cfinvokeargument name="etiquetas" value="#LB_Contrato#, #LB_Desc#, #LB_Proveedor#, #LB_Monto#, #LB_Fecha#"/>
		  <cfinvokeargument name="formatos" value="V,V,V,M,D"/>
		  <cfinvokeargument name="align" value="center, center, center, center, center"/>
		  <cfinvokeargument name="ajustar" value="N"/>
		  <cfinvokeargument name="keys" value="CTContid, PeriodoPres"/>
		  <cfinvokeargument name="irA" value="cancelacionContratos.cfm"/>
