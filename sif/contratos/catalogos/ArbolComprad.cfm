...
function Procesar2(lin, Usucodigo, CTCnombre, CTCid) {
	document.arbol.CTCid.value = CTCid;
...
<cfquery name="rs" datasource="#Session.DSN#">
	select
		...
		Usucodigo
		<!--- CMCjefe --->
	from CTCompradores where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">
<!--- 	order by CTCnombre --->
</cfquery>
...
<script language="JavaScript">
	...
	<cfoutput>
		<cfloop query="rsnivn">
			arreglo[indice] = new Array('#CTCnombre#'<!--- , '#CMCjefe#' --->, '#Usucodigo#', '0', '#CTCid#');
			indice = indice + 1;
		</cfloop>
	</cfoutput>
	...
	<cfoutput>
	<cfloop query="rsniv1">
		texto="#Replace(rsniv1.CTCnombre,chr(34),'''')#";
		Funcion="javascript:Procesar2(0, #rsniv1.Usucodigo#, '#rsniv1.CTCnombre#', #rsniv1.CTCid#);";
...
<!--- 	<input type="hidden" name="CMCjefe" value=""> --->
	...
	<input type="hidden" name="CTCid" value="">
