...
<cfquery name="rsForm" datasource="emperador">
	select FMT02LIN, FMT02CAM, FMT02DES, FMT07NIV, FMT02TOT, FMT02STS, FMT02FMT, FMT02LON, FMT02DEC, 
		   ...
		   FMT02JUS, FMT02PRE, FMT02SUF, FMT02TIP, FMT02PAG, FMT02SQL, FMT02AJU, timestamp 
	from FMT002
...
<!--- Niveles --->
<cfquery name="rsNiveles" datasource="emperador">
	select FMT07NIV
	from FMT007
...
<cfquery name="rsLinea" datasource="emperador">
	select isnull(max(FMT02LIN)+1,1) as FMT02LIN
...
<cfset error = false>
<cftry>
	<cfquery name="rsCampos" datasource="emperador">
		set nocount on
...
<script language="JavaScript1.2" type="text/javascript">
	...
	// Muestra una paleta de colores.
		window.open("color.cfm?obj=FMT02CLR&tabla=colorBox","Paleta",'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbar=no,resizable=no,copyhistory=yes,height=60,width=308,left=375, top=250');
	}
			...
			<td>
				...
				<table width="100%">
					...
					<tr>
						...
						<td><input type="text" name="FMT02LON" maxlength="10" size="10" value="<cfif modo neq 'ALTA'><cfoutput>#rsForm.FMT02LON#</cfoutput></cfif>" style="text-align: right;" onblur="fm(this,-1);" onfocus="javascript:this.value=qf(this); this.select();"  onkeyup="javascript:if(snumber(this,event,-1)){ if(Key(event)=='13') {this.blur();}}" alt="La Longitud" ></td>
					</tr>
							...
							<td>
								...
								<table width="100%" class="cuadro">
									...
									<tr>
										...
										<!--- Pos.x --->
										<td align="right" nowrap>Pos. X:&nbsp;</td>
										...
										<!--- Pos.y --->
										<td align="right" nowrap>Pos. Y:&nbsp;</td>
