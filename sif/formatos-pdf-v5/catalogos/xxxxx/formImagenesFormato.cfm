...
<cfquery name="rsForm" datasource="emperador">
	select a.FMT01COD, a.FMT03LIN, a.FMT03IMG, a.FMT03FIL, a.FMT03COL, a.FMT03ALT, a.FMT03ANC, a.FMT03BOR, a.FMT03CFN, a.FMT03CBR, FMT03EMP, a.timestamp 
	...
	function validar(form){
		...
		if ( boton != 'btnEliminar' && boton != 'btnNuevo' && boton != 'btnRegresar'){
			if (!salir && form.FMT03COL.value == ""){
				mensaje = mensaje + "La posicin X es requerida.\n";
				salir = true;								
			}
			if (!salir && form.FMT03FIL.value == ""){
				mensaje = mensaje + "La posicin Y es requerida.\n";
				salir = true;
			}
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td nowrap><div align="right">Posicin X:&nbsp;</div></td>
  ...
  <tr>
    <td colspan="2" valign="top" nowrap><div align="center">
		<cfif modo NEQ "ALTA">
			<cf_sifleerimagen autosize="true" border="false"  tabla="FMT003" campo="FMT03IMG" condicion="FMT01COD = '#Form.FMT01COD#' and FMT03LIN = #Form.FMT03LIN#" conexion="emperador" imgname="Img#Form.FMT03LIN#" width="80" height="80">
		</cfif>							
	</div></td>
    </tr>
  <tr>
