...
<cfset hayCuentaDescuentosCxP = 0 >
...
<cffunction name="ObtenerCuenta" returntype="query">
	...
	<cfquery name="rsCuenta" datasource="#Session.DSN#">
		select a.Pvalor as Ccuenta, b.Cdescripcion, b.Cformato
		from Parametros a, CContables b
		where a.Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">  
		  and a.Pcodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Arguments.pcodigo#">
		  and a.Ecodigo = b.Ecodigo
		  and convert(varchar,a.Pvalor) = convert(varchar,b.Ccuenta)
	</cfquery>
	<cfreturn #rsCuenta#>
</cffunction>
...
<cfquery name="rsTransaccionesOrigenBancos" datasource="#Session.DSN#">
	select convert(varchar,BTid) as BTid, BTdescripcion from BTransacciones 
	where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">
	  and BTtipo = 'C'
</cfquery>
...
<cfquery name="rsTransaccionesCC" datasource="#Session.DSN#">
	select convert(varchar,CCTcodigo) as CCTcodigo, CCTdescripcion from CCTransacciones 
	where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#"> 
	  and CCTpago = 1
</cfquery>

<cfquery name="rsTransaccionesCP" datasource="#Session.DSN#">
	select convert(varchar,CPTcodigo) as CPTcodigo, CPTdescripcion from CPTransacciones 
	where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">  
	  and CPTpago = 1
</cfquery>
...
<cfif rsExistenCContables.existe EQ "1" >
...
<form action="SQLParametrosCuentasAD.cfm" method="post" name="form1">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td><div align="right">Cuenta de Descuentos CxC:</div></td>
      <td><cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta#" auxiliares="N" movimiento="S" frame="frame6" ccuenta="CcuentaDescuentosCxC" cdescripcion="CdescripcionDescuentosCxC" cformato="CformatoDescuentosCxC"></td>
    </tr>
    <tr> 
      ...
      <td><div align="right">Cuenta de Descuentos CxP:</div></td>
      <td><cf_cuentas Conexion="#Session.DSN#" Conlis="S" query="#cuenta#" auxiliares="N" movimiento="S" frame="frame7" ccuenta="CcuentaDescuentosCxP" cdescripcion="CdescripcionDescuentosCxP" cformato="CformatoDescuentosCxP"></td>
    </tr>
    <tr> 
	...
	<input type="hidden" name="hayCuentaDescuentosCxC" value="<cfoutput>#hayCuentaDescuentosCxC#</cfoutput>">
	<input type="hidden" name="hayCuentaDescuentosCxP" value="<cfoutput>#hayCuentaDescuentosCxP#</cfoutput>">
	<input type="hidden" name="hayCuentaMovOficinas" value="<cfoutput>#hayCuentaMovOficinas#</cfoutput>">
	<input type="hidden" name="hayCuentaAjusteRedondeo" value="<cfoutput>#hayCuentaAjusteRedondeo#</cfoutput>">
	<input type="hidden" name="hayCuentaIngresoDifCambCxC" value="<cfoutput>#hayCuentaIngresoDifCambCxC#</cfoutput>">
	<input type="hidden" name="hayCuentaEgresoDifCambCxC" value="<cfoutput>#hayCuentaEgresoDifCambCxC#</cfoutput>">
	<input type="hidden" name="hayCuentaIngresoDifCambCxP" value="<cfoutput>#hayCuentaIngresoDifCambCxP#</cfoutput>">
	<input type="hidden" name="hayCuentaEgresoDifCambCxP" value="<cfoutput>#hayCuentaEgresoDifCambCxP#</cfoutput>">
	<input type="hidden" name="hayCuentaRetenciones" value="<cfoutput>#hayCuentaRetenciones#</cfoutput>">
	<input type="hidden" name="hayCuentaAnticiposCxC" value="<cfoutput>#hayCuentaAnticiposCxC#</cfoutput>">
	<input type="hidden" name="hayCuentaAnticiposCxP" value="<cfoutput>#hayCuentaAnticiposCxP#</cfoutput>">
	<input type="hidden" name="hayCuentaActivosTransito" value="<cfoutput>#hayCuentaActivosTransito#</cfoutput>">
	<input type="hidden" name="hayCuentaBalance" value="<cfoutput>#hayCuentaBalance#</cfoutput>">
	<input type="hidden" name="hayCuentaIngresoDifCambCG" value="<cfoutput>#hayCuentaIngresoDifCambCG#</cfoutput>">
	<input type="hidden" name="hayCuentaEgresoDifCambCG" value="<cfoutput>#hayCuentaEgresoDifCambCG#</cfoutput>">
	<input type="hidden" name="hayCuentaUtilPeriodo" value="<cfoutput>#hayCuentaUtilPeriodo#</cfoutput>">
	<input type="hidden" name="hayCuentaUtilAcumulada" value="<cfoutput>#hayCuentaUtilAcumulada#</cfoutput>">

	<input type="hidden" name="hayMovOrigenBancos" value="<cfoutput>#hayMovOrigenBancos#</cfoutput>">
	<input type="hidden" name="hayMovDestinoBancos" value="<cfoutput>#hayMovDestinoBancos#</cfoutput>">
	<input type="hidden" name="hayTransPagosCC" value="<cfoutput>#hayTransPagosCC#</cfoutput>">
	<input type="hidden" name="hayTransPagosCP" value="<cfoutput>#hayTransPagosCP#</cfoutput>">
...
<script language="JavaScript1.2">
	function valida() {
		...
		return confirm('Desea guardar estos parámetros');		
	}
</script>
