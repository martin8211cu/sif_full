...
<cfif isdefined("Form.btnRechazar")>
	<cflock name="RecharTraslado" type="exclusive" timeout="600"><!--- Espera 10 minutos como maximo para obtener el bloqueo --->
		...
		<cftransaction>
			...
			<!--- Cambia estados de las variaciones, estado rechazada --->
			...
			<cfinvoke component="sif.Componentes.FPRES_Equilibrio" method="CambioEstadoMasivo">
				...
				<cfinvokeargument name="Filtro" 		value="CPPid = #form.CPPid# and FPEEestado = 5 and FPTVid in (select b.FPTVid from TipoVariacionPres b where b.FPTVid = FPEEstimacion.FPTVid and b.FPTVTipo in(1,4) and b.Ecodigo = #Session.Ecodigo#)">
			</cfinvoke>
		</cftransaction>
	</cflock>
<cfelseif isdefined("Form.btnAplicar")>
	...
	<!---=================Insert las lineas nuevas del plan de compras=========--->	
		<cfloop query="preInsert">
			...
			<cfif not len(trim(preInsert.PCGDid))>
				...
				<cfinvoke component="sif.Componentes.PlanCompras" method="AltaDPlanCompras" returnvariable="insertDplan">
					...
					<cfinvokeargument name="PCGDcostoOri"			value="0"><!--- Se ingresa 0, ya que mas adelante se actualiza por medio del componente de presupuesto --->
				...
				<cfif preInsert.FPEPmultiperiodo eq 1>
					<cfinvoke component="sif.Componentes.PlanCompras" method="AltaMPlanCompras" returnvariable="insertMulti">
						...
						<cfinvokeargument name="PCGDcostoOri" 				value="#preInsert.DPDEcosto#">
		...
		<cfinvoke component="sif.Componentes.FPRES_Equilibrio" method="CambioEstadoMasivo">
			...
			<cfinvokeargument name="Filtro" 		value="CPPid = #form.CPPid# and FPEEestado = 5 and FPTVid in (select b.FPTVid from TipoVariacionPres b where b.FPTVid = FPEEstimacion.FPTVid and FPTVTipo in(1,2,3,4) and b.Ecodigo = #Session.Ecodigo#)">
		</cfinvoke>
