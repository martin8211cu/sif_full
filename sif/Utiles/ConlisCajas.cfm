...
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_LstCajas" returnvariable="LB_LstCajas" default = "Lista de Cajas">
...
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "BTN_Limpiar" returnvariable="BTN_Limpiar" default = "Limpiar" xmlfile="/sif/generales.xml">

<html>
<head>
<title><cfoutput>#LB_LstCajas#</cfoutput></title>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro">
			<tr>
				...
				<td align="center">
					...
					<input name="btnLimpiar" type="button" id="btnLimpiar" value="#BTN_Limpiar#" onClick="document.filtro.FAM01CODD_f.value=''; document.filtro.FAM01DES_f.value='';" >
