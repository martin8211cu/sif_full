...
<td valign="top">
	...
	<cf_dbfunction name="to_date00"	args="#now#" returnvariable="hoy">
	<cfquery name="rsLista"  datasource="#session.DSN#">
		...
		<!---and B.AFRfini <= #hoy#
		and B.AFRffin >= #hoy#--->
		and B.AFRfini <= <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#now()#">
		and B.AFRffin >= <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#now()#">
