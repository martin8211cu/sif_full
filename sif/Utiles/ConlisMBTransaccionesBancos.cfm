...
<cfif isdefined("Url.BTEtce") and not isdefined("Form.BTEtce")>
	<cfparam name="Form.BTEtce" default="#Url.BTEtce#">
</cfif>
...
<!---FILTRO TARJETAS DE CREDITO--->
<cfif isdefined("Form.BTEtce") and Len(Trim(Form.BTEtce)) NEQ 0>
	<cfset filtro = filtro & " and BTEtce  =  #Form.BTEtce#">
</cfif>
