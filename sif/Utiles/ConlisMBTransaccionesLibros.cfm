...
<cfif isdefined("Url.BTtce") and not isdefined("Form.BTtce")>
	<cfparam name="Form.BTtce" default="#Url.BTtce#">
</cfif>
...
<cfif isdefined("Form.BTtce") and Len(Trim(Form.BTtce)) NEQ 0>
	<cfset filtro = filtro & "and BTtce  =  #Form.BTtce#">
</cfif>
