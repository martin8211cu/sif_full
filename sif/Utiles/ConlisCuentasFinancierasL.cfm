...
<cfif rsMayor.PCEMid EQ "" OR rsMayor.PCEMplanCtas NEQ 1>
	<cf_errorCode	code = "50801"
					msg  = "La cuenta @errorDat_1@ no tiene plan de cuentas"
					errorDat_1="#url.Cmayor#"
	>
</cfif>
	...
	<table border="0" width="100%">
		<tr>
			...
			<td>
				...
				<cf_translate key=LB_Estructura>Estructura de la Máscara para la Cuenta</cf_translate> #url.Cmayor#
				</strong>
			<cfelse>
			<td colspan="10">
				<strong style="font-size:24px">
				<cf_translate key=LB_Detalle>Detalle del Plan de Cuenta</cf_translate> #url.Cmayor#
				</strong>
			</td></cfif>
