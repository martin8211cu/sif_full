...
<cftry>
	<cfif not isdefined("url.OCid") OR trim(url.OCid) EQ "">
		<cf_errorCode	code = "50806" msg = "Debe indicar Orden Comercial">
	</cfif>
	<cfif not isdefined("url.Aid") OR trim(url.Aid) EQ "">
		<cf_errorCode	code = "50807" msg = "Debe indicar Articulo">
	</cfif>
	<cfif not isdefined("url.SNid") OR trim(url.SNid) EQ "">
		<cf_errorCode	code = "50808" msg = "Debe indicar Socio Negocio">
	</cfif>
