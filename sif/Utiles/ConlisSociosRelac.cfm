<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaSociosNegocios" default = "Lista de Socios de Negocio" returnvariable="LB_ListaSociosNegocios" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaProveedores" default = "Lista de Proveedores" returnvariable="LB_ListaProveedores" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaClientes" default = "Lista de Clientes" returnvariable="LB_ListaClientes" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Numero" default = "N&uacute;mero" returnvariable="LB_Numero" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Codigo" default = "C&oacute;digo" returnvariable="LB_Codigo" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Descripcion" default = "Descripci&oacute;n" returnvariable="LB_Descripcion" xmlfile = "ConlisSociosRelac.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "BTN_Filtrar" default = "Filtrar" returnvariable="BTN_Filtrar" xmlfile = "ConlisSociosRelac.xml">
