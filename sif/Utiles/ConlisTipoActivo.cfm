...
function Asignar(id, codigo,desc, nivel, CAid) {
	if (window.opener != null) {
		...
		if (window.opener.#Url.funcionTipo#){<!---Se agrega para llamar a funcionTipo en Cambio de Valores a Activo Fijo RVD 04/06/2014 --->
					window.opener.#Url.funcionTipo#(#Url.Aid#,id);<!---Se agrega para llamar a funcionTipo en Cambio de Valores a Activo Fijo RVD 04/06/2014 --->
				}
