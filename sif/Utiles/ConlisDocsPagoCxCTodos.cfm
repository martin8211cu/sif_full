		   ...
		   (select min(pp.PPnumero)
			...
			coalesce( (select pp.PPprincipal + pp.PPinteres
		   	from PlanPagos pp
				...
				and pp.PPnumero = (select min (pp.PPnumero) from PlanPagos pp 
                             where pp.Ecodigo = b.Ecodigo 
                             and pp.CCTcodigo = b.CCTcodigo 
                             and pp.Ddocumento = b.Ddocumento 
                             and pp.PPfecha_pago is null )), 0) as MontoCuota,
			...
			coalesce( (select pp.PPpagomora
		   	from PlanPagos pp
				...
				and pp.PPnumero = (select min (pp.PPnumero) from PlanPagos pp 
                             ...
                             and pp.CCTcodigo = b.CCTcodigo 
                             and pp.Ddocumento = b.Ddocumento 
                             and pp.PPfecha_pago is null )),0) as InteresMora,
			...
			(select pp.PPfecha_vence
		   	from PlanPagos pp
				...
				and pp.PPnumero = (select min (pp.PPnumero) from PlanPagos pp 
                             ...
                             and pp.CCTcodigo = b.CCTcodigo 
                             and pp.Ddocumento = b.Ddocumento 
                             and pp.PPfecha_pago is null )) as PPfecha_vence,
