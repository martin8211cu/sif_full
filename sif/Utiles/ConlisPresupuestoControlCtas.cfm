...
<body style="margin:0;">
	...
	<!--- PARAMETRO DE PERMITIR O NO TRASLADOS CON CUENTAS DE CONTROL ABIERTO --->	
	<cfparam name="url.CFidTipo" default="">
	<cfparam name="form.CFidTipo" default="#url.CFidTipo#">
	<cfif form.CFidTipo NEQ "R">
		...
		<cfset LvarDeniegaControlAbierto = (rsSQL.Pvalor NEQ "S")>
	<cfelse>
		<cfset LvarDeniegaControlAbierto = false>
	</cfif>
	...
	<cfif isdefined("Form.CPcuenta")>
		...
		<script language="javascript" type="text/javascript">
			<cfoutput>
			<cfif LvarDeniegaControlAbierto AND LstrDisponible.CPCPtipoControl EQ "0">
	...
	<cfif LvarDeniegaControlAbierto>
	...
	<cfelse>
		<cf_errorCode	code = "50803"
						msg  = "Falta indicar el tipo de Centro Funcional en la pantalla origen *@errorDat_1@*"
						errorDat_1="#form.CFidTipo#"
		>
	</cfif>
