<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Titulo" returnvariable="LB_Titulo" default = "Lista de Cuentas Financiera" xmlfile="ConlisCuentasFinancierasCtas.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Codigo" Default="C&oacute;digo" returnvariable="LB_CODIGO" xmlfile="ConlisCuentasFinancierasCtas.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Descripcion" Default="Descripci&oacute;n" returnvariable="LB_Descripcion" xmlfile="ConlisCuentasFinancierasCtas.xml"/>		
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="BTN_Buscar" Default="Buscar" returnvariable="BTN_Buscar" xmlfile="ConlisCuentasFinancierasCtas.xml"/>			
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_AceptaMovs" Default="Acepta Movs." returnvariable="LB_AceptaMovs"/>			
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Auxiliar" Default="Auxiliar" returnvariable="LB_Auxiliar" xmlfile="ConlisCuentasFinancierasCtas.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="MSG_NoDefCtas" Default="No se han definido cuentas para la cuenta mayor" returnvariable="MSG_NoDefCtas" xmlfile="ConlisCuentasFinancierasCtas.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="MSG_NoCtasAsoc" Default="No hay cuentas asociadas a las máscaras del Centro Funcional en la cuenta mayor" returnvariable="MSG_NoCtasAsoc" xmlfile="ConlisCuentasFinancierasCtas.xml"/>
	  ...
	  <tr>
		<td>
			...
			<cfif varParametroI EQ 1>
            	<cfset vartabla =  "CFinanciera a 
										left join CFinancieraIdioma id
											inner join Idiomas i on id.Iid = i.Iid and i.Icodigo = '#session.Idioma#'
										on a.Ecodigo = id.Ecodigo and a.CFcuenta = id.CFcuenta
										inner join CContables c on a.Ccuenta = c.Ccuenta
										left join Caracteristicas aux on coalesce(c.Mcodigo,1) = aux.Mcodigo">
                <cfset varcampos = "rtrim(a.CFformato) as Valor, 
										case when CFdescripcionF is null OR CFdescripcionF = CFdescripcion 
										then coalesce(id.CFdescripcionI, a.CFdescripcion) 
										else {fn concat ({fn concat({fn concat(CFdescripcionF , ' ('  )}, CFdescripcion  )},  ')' )} 
										end as Descripcion,
			...
			<cfinvoke 
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="columnas" value="#varcampos#"/>
				...
				<cfif form.CFid EQ -1>
					<cfinvokeargument name="EmptyListMsg" value="#MSG_NoDefCtas# #form.Cmayor#"/>
				<cfelse>
					<cfinvokeargument name="EmptyListMsg" value="#MSG_NoCtasAsoc# #form.Cmayor#"/>
				</cfif>
			</cfinvoke>
		</td>
	  </tr>
