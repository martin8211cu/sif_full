...
<cfif isdefined("url.valor") and len(trim(url.valor)) and isdefined("url.descripcion") and len(trim(url.descripcion))>
	...
	<script language="JavaScript">
		...
		location.href="/cfmx/sif/Utiles/sifImpresoraquery.cfm?valor=<cfoutput>#url.valor#&descripcion=#url.descripcion#&formulario=#url.formulario#</cfoutput>&campo=1" + params;
	</script>	
</cfif>
