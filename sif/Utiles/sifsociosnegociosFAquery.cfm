...
<script language="JavaScript">
	window.parent.document.<cfoutput>#url.form#.#url.identificacion#</cfoutput>.value = "<cfoutput>#rs.SNnumero#</cfoutput>";
	...
	<cfif Len(Trim(url.FuncJSalCerrar)) GT 0> window.parent.<cfoutput>#url.FuncJSalCerrar#</cfoutput> </cfif>
</script>