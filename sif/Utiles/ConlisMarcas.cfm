	...
	if (window.opener != null) {
		<cfoutput>
			...
			if(descAnt != window.opener.document.#Url.form#.#Url.desc#.value){
				...
				if (window.opener.#Url.funcionMar#){<!---Se agrega para llamar a funcionMar en Cambio de Valores a Activo Fijo RVD 04/06/2014 --->
					window.opener.#Url.funcionMar#(#Url.Aid#,key);<!---Se agrega para llamar a funcionMar en Cambio de Valores a Activo Fijo RVD 04/06/2014 --->
				}
