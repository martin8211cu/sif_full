...
<html>
<head>
<title>Lista de <cfif Url.tipo EQ "P">Proveedores<cfelseif Url.tipo EQ "C">Clientes<cfelse>Socios de Negocio</cfif></title>
    ...
    <cfoutput query="conlis" startRow="#StartRow_conlis#" maxRows="#MaxRows_conlis#"> 
      <tr> 
        <td <cfif #conlis.CurrentRow# MOD 2>class="listaPar"<cfelse>class="listaNon"</cfif>><input type="hidden" name="SNnumero#conlis.CurrentRow#" value="#conlis.SNnumero#"> 
          <a href="javascript:Asignar('#conlis.SNcodigo#', '#JSStringFormat(conlis.SNnombre)#', '#JSStringFormat(conlis.SNnumero)#');">#conlis.SNnumero#</a></td>
        <td colspan="2" <cfif #conlis.CurrentRow# MOD 2>class="listaPar"<cfelse>class="listaNon"</cfif>><a href="javascript:Asignar('#conlis.SNcodigo#', '#JSStringFormat(conlis.SNnombre)#', '#JSStringFormat(conlis.SNnumero)#');">#conlis.SNnombre#</a></td>
      </tr>
    </cfoutput> 
    <tr> 
      <td colspan="3">&nbsp; </td>
          ...
          <cfoutput> 
            <tr> 
              <td width="23%" align="center"> <cfif PageNum_conlis GT 1>
                  <a href="#CurrentPage#?PageNum_conlis=1#QueryString_conlis#"><img src="../imagenes/First.gif" width="18" height="13" border=0></a> 
                </cfif> </td>
              <td width="31%" align="center"> <cfif PageNum_conlis GT 1>
                  <a href="#CurrentPage#?PageNum_conlis=#Max(DecrementValue(PageNum_conlis),1)##QueryString_conlis#"><img src="../imagenes/Previous.gif" width="14" height="13" border=0></a> 
                </cfif> </td>
              <td width="23%" align="center"> <cfif PageNum_conlis LT TotalPages_conlis>
                  <a href="#CurrentPage#?PageNum_conlis=#Min(IncrementValue(PageNum_conlis),TotalPages_conlis)##QueryString_conlis#"><img src="../imagenes/Next.gif" width="14" height="13" border=0></a> 
                </cfif> </td>
              <td width="23%" align="center"> <cfif PageNum_conlis LT TotalPages_conlis>
                  <a href="#CurrentPage#?PageNum_conlis=#TotalPages_conlis##QueryString_conlis#"><img src="../imagenes/Last.gif" width="18" height="13" border=0></a> 
                </cfif> </td>
            </tr>
