	...
	<cfelse>
		<script language="JavaScript">
			...
			if(confirm('¿Desea agregar la impresora?')){
				location.href="/cfmx/sif/Utiles/sifMaquinaInserta.cfm?valor=<cfoutput>#url.valor#&formulario=#url.formulario#</cfoutput>";
				...
				location.href="/cfmx/sif/Utiles/sifMaquinasquery.cfm?valor=<cfoutput>#url.valor#&formulario=#url.formulario#</cfoutput>" + params;
			}else{ 
