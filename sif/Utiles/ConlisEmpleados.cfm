<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Nombre" default="Nombre" returnvariable="LB_Nombre" xmlfile="ConlisEmpleados.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Apellidos" default="Apellidos" returnvariable="LB_Apellidos" xmlfile="ConlisEmpleados.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "BTN_Filtrar" default="Filtrar" returnvariable="BTN_Filtrar" xmlfile="ConlisEmpleados.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Identificacion" default="Identificaci&oacute;n" returnvariable="LB_Identificacion" xmlfile="ConlisEmpleados.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_TituloListaEmpleados" default="Lista de Empleados" returnvariable="LB_TituloListaEmpleados" xmlfile="ConlisEmpleados.xml">
...
<html>
<head>
<title><cfoutput>#LB_TituloListaEmpleados#</cfoutput></title>
...
<table width="100%" cellpadding="2" cellspacing="0">
	<tr><td>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro">
			<tr>
				...
				<td align="right"><strong>#LB_Apellidos#</strong></td>
				<td width="1%"> 
	...
	<tr><td>
		...
		<cfset select = " distinct a.llave, 
						  c.Pid,
						  a.Usucodigo,
						  c.Pnombre, 
						  c.Papellido1,
						  c.Papellido2,
						  c.Pnombre #LvarCNCT# ' ' #LvarCNCT# c.Papellido1 #LvarCNCT# ' '  #LvarCNCT#  c.Papellido2 as Nombre " >
		<cfset from = " UsuarioReferencia a
						...
						on b.datos_personales = c.datos_personales 
						 #filtro#
						inner join vUsuarioProcesos d
						on b.Usucodigo = d.Usucodigo 
   						   and d.Ecodigo = #session.EcodigoSDC# " >
		<cfset where = " a.STabla='DatosEmpleado' and a.Ecodigo=#session.EcodigoSDC# " >
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="fparams" value="llave,Usucodigo,Nombre,Pid"/>
