<cfif isdefined('form.btnGenerar')>
	...
	<cfif rs.recordCount GT 0>
		<cf_errorCode
			code = "80024"
			msg  = "Existen cuentas en el grupo de Empresas que no se han creado en la Empresa de Eliminación">
	</cfif>
...
<cfelseif isdefined('form.btnPrepXML')>
    ...
    <cfquery name="rshayBalanzasP" datasource="#session.DSN#">
        ...
        FROM
            ...
            FROM CEBalanzaSAT
            WHERE Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.Ecodigo#">
                AND CEBalanzaId = <cfqueryparam cfsqltype="cf_sql_numeric" value="#idBalCompSAT#">) as BalanzaActual
