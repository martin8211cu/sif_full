...
<cfquery name="EmpList" datasource="#Session.DSN#">
	SELECT
		ROW_NUMBER() OVER(ORDER BY ce.Cformato) AS Row,
 		ce.Cformato,
		ce.Cdescripcion
	FROM
		CEInactivas ce
...
<cfinvoke key="LB_Titulo" default="Cuentas Excluidas" returnvariable="LB_Titulo" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLCuentExcluidasCEGE.xml"/>
<cfinvoke key="LB_Formato" default="Formato" returnvariable="LB_Formato" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLCuentExcluidasCEGE.xml"/>
<cfinvoke key="LB_Descripcion" default="Descripcion" returnvariable="LB_Descripcion" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLCuentExcluidasCEGE.xml"/>
