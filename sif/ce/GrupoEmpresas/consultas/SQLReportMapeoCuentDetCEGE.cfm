...
<cfquery name="rsReporte" datasource="#session.DSN#">
	...
	WHERE cem.GEid = (SELECT  a.GEid FROM AnexoGEmpresa a
					inner join AnexoGEmpresaDet b
						on a.GEid = b.GEid
					where b.Ecodigo = #Session.Ecodigo#)
		and cem.Ecodigo = #Session.Ecodigo# and cea.CAgrupador = '#Form.CAgrupador#' AND (cea.Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#"> OR cea.Ecodigo IS NULL)
