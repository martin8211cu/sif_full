	...
	<form action="#LvarAction#" method="post" name="form1">
		<div style="background-color:rgb(232,232,232); width:100%">
			...
			<table align="center" cellpadding="0" cellspacing="2" border="0">
				<tr>
					<td nowrap align="right"><strong><cf_translate key=LB_Codigo>Mapeo</cf_translate>:</strong>&nbsp;</td>
					<td colspan="3">
							<cf_conlis
			    ...
			    <tr>
					...
					<td colspan="2" align="right"><input type="submit" value="filtrar" id="friltrar" name="friltrar" class="btnFiltrar" onclick="return funcFiltrar()"></td>
				</tr>
				<tr>
				...
				<td colspan="3">
					...
					<cfinvoke component="sif.Componentes.pListas" method="pLista" returnvariable="pListaRet"
						tabla				= "CEXMLEncabezadoCuentas cex INNER JOIN  CEAgrupadorCuentasSAT cea ON  cea.CAgrupador = cex.CAgrupador
						                       AND cea.Version = cex.Version AND cex.GEid = -1 #LvarFiltro#"
						...
						etiquetas			= "#LB_Codigo#, #LB_Descripcion#,#LB_Version#, #LB_Version#, #LB_Mes#, #LB_Estatus#"
