			...
			<tr valign="baseline" >
				...
				<td style="vertical-align:bottom">
			          ...
			          tabla="(SELECT ctas.Ccuenta, ctas.Cformato, ctas.Cdescripcion, ctas.Ecodigo,ctas.Cmayor, ctas.PCDCniv,ctas.Ctipo
	                          ...
	                          left join (select Ccuenta from CEInactivas	where Ecodigo = #Session.Ecodigo#) inc
	    	          ...
	    	          filtro="cSAT.Ccuenta is null #PreserveSingleQuotes(LvarOrden)# order by ctasSaldos.Cformato"
