...
<cfquery name="rsReporte" datasource="#session.DSN#">
	...
	INNER JOIN CContables cc on cem.Ccuenta = cc.Ccuenta #PreserveSingleQuotes(lvarValorS)# #PreserveSingleQuotes(lvarValorN)#
	...
	WHERE cem.CCuentaSAT = cec.CCuentaSAT
		...
		and cem.Ecodigo = #Session.Ecodigo#) AS numMapeo, cea.Version
...
<cfinvoke key="LB_Titulo" default="Mapeo de Cuentas" returnvariable="LB_Titulo" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLReporteMapeoCuentasCE.xml"/>
<cfinvoke key="LB_Codigo" default="C&oacute;digo Cuenta" returnvariable="LB_Codigo" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLReporteMapeoCuentasCE.xml"/>
<cfinvoke key="LB_Cuenta" default="Cuenta" returnvariable="LB_Cuenta" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLReporteMapeoCuentasCE.xml"/>
<cfinvoke key="LB_Mapeadas" default="Mapeadas" returnvariable="LB_Mapeadas" component="sif.Componentes.Translate" method="Translate" xmlfile="SQLReporteMapeoCuentasCE.xml"/>
