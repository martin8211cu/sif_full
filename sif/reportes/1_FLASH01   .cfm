...
select '#session.enombre#' as TituloEmpresa, 
...
from      EOrdenCM a
		...
		left outer join DOrdenCM b
				...
				left outer join ACategoria atl
							on atl.Ecodigo = b.Ecodigo
							and  atl.ACcodigo =b.ACcodigo
...
<cfreport format="flashpaper" template="1_FLASH01   .cfr" query="rsReporte"></cfreport>
