...
<cfquery name="rsTarjetaCredito" datasource="#session.DSN#">
	select CBTCid, CBTCDescripcion, CBTTid, CBSTid, CBTNumTarjeta, DEid,
    CBTCfechainico, CBTCfechacorte, CBTCfechacancelacion, CBTCfechapago, 
    CBTCfechavencimiento, EIid,ts_rversion
...
<cfquery name="rsMonedaExc" datasource="#session.DSN#">
    ...
    from Monedas 
    where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
    and Mcodigo not in (#rsMonedaLoc.Mcodigo#, #rsMonedaExt.Mcodigo#)
</cfquery>
...
<!---Redireccion Bancos o TCEBancos (Tarjetas de Credito)--->
<form method="post" name="form1" action="TCECatalogo-SQL.cfm<cfif isdefined('url.desde') and Trim(url.desde) eq 'rh'>?desde=rh</cfif>">
	...
	<table align="center" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr valign="baseline"> 
			...
			<td>
				<input type="text" tabindex="4" name="CBTarjeta" 
				value="<cfif modo NEQ "ALTA"><cfoutput>#rsTarjetaCredito.CBTNumTarjeta#</cfoutput></cfif>" 
				size="32" maxlength="20" onkeypress="return validar(event)">
			</td>
		</tr>
        <tr valign="baseline">
		...
		<tr valign="baseline"> 
			...
			<td>
            	<cfset LvarTitular = "">
            	<cfif (MODO neq "ALTA")>
	                <cfset LvarTitular = rsTarjetaCredito.DEid>
                </cfif>
                <cf_rhempleados Conexion="#session.DSN#" form="form1" idempleado="#LvarTitular#">
           	</td>		  
		</tr>
		</cfoutput>
        <tr valign="baseline">
			...
			<td>
            	...
            	<cf_sifcalendario name="fechaIV" value="#LvarfechaIV#" tabindex="1">                                				  
			</td>
		</tr>
        <tr valign="baseline">
			<td align="right" nowrap><cf_translate key="LB_FechaCorte">Fecha de Corte</cf_translate>:&nbsp;</td>
			<td>
            	<cfset LvarfechaCorte = "">
            	<cfif (MODO neq "ALTA")>
	                <cfset LvarfechaCorte = rsTarjetaCredito.CBTCfechacorte>
                </cfif>
            	<cf_sifcalendario name="fechaCorte" value="#LvarfechaCorte#" tabindex="1">				  
			</td>
		</tr>
        <tr valign="baseline">
			...
			<td>
            	...
            	<cf_sifcalendario name="fechaCancelacion" value="#LvarfechaCancelacion#" tabindex="1">				  
			</td>
		</tr>
        <tr valign="baseline">
			...
			<td>
            	...
            	<cf_sifcalendario name="fechaPago" value="#LvarfechaPago#" tabindex="1">				  
			</td>
		</tr>
		<tr valign="baseline">
			...
			<td>
            	...
            	<cf_sifcalendario name="fechaVencimiento" value="#LvarfechaVencimiento#" tabindex="1">				  
			</td>
		</tr>
		<tr>
      		...
      		<td colspan="2" nowrap>
        		...
        		<table width="100%" cellpadding="2" cellspacing="0" border="0" >
          			<tr>
                        ...
                        <cfif modo NEQ "ALTA">
							...
							<cfloop query="rsMonedas">
                            	...
                            	<cfif rsMonedaExt.Mnombre eq rsMonedas.Mnombre>
                    ...
                    <tr>
                        ...
                        <td align="left">
                        	<cf_sifmonedas  FechaSugTC="#LSDateformat(Now(),'DD/MM/YYYY')#" form="form1" Mcodigo="McodigoOri" quitar="#rsMonedaLoc.Mcodigo# #Mcodigos#" tabindex="1">
                        </td> 
