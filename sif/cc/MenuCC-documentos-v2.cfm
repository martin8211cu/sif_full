...
<cfset MSG_Vencim = t.Translate('MSG_Vencim','Vencimientos de Saldos de Los &Uacute;ltimos 30 D&iacute;as (Analisis por')>
<cfset LB_Total 	= t.Translate('LB_Total','Total','/sif/generales.xml')>
<cfset LB_Saldo 	= t.Translate('LB_Saldo','Saldo')>
<cfset LB_VerDet 	= t.Translate('LB_VerDet','Ver Detalles')>
<cfset LB_CerrarDet	= t.Translate('LB_CerrarDet','Cerrar Detalles')>
<cfset LB_VerDoc 	= t.Translate('LB_VerDet','Ver Documentos')>
<cfset LB_CerrarDoc	= t.Translate('LB_CerrarDet','Cerrar Documentos')>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0" style="border:0;">
	...
	<cfif Lista.recordcount eq 0>
		<tr>
            ...
            <cfset MSG_NoReg = t.Translate('MSG_NoReg','No se encontraron registros')>
				--- #MSG_NoReg# ---
			</td>
		</tr>
	</cfif>
