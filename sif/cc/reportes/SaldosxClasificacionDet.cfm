...
<cfquery name="rsReporte" datasource="#session.DSN#" maxrows="5001">
	select a.Ddocumento, a.Dfecha,   a.Dvencimiento, a.Dtotal,   a.Dsaldo,  
	case b.CCTtipo when 'D' then '#LB_Debito#' else '#LB_Credito#' end as CCTtipo, b.CCTcodigo, d.Mcodigo, d.Mnombre, e.Edescripcion,
	...
	where  #filtro#
		...
		order by a.Mcodigo, a.SNcodigo,c.SNnombre
	</cfquery>
...
<!--- Invoca el Reporte --->
    ...
    <cfif rsactivatejsreports.valParam EQ 1 AND coldfusionV EQ 2018>
	  ...
	  <cf_js_reports_service_tag queryReport = "#rsReporte#" 
		isLink = False 
		typeReport = #typeRep#
		fileName = "cc.reportes.SaldosxClasificacionDet"/>
	<cfelse>
	<cfreport format="#formatos#" template= "SaldosxClasificacionDet.cfr" query="rsReporte">
	...
	<cfif isdefined("url.TClasif") and url.TClasif EQ 0>
		<cfset TIT_SalXClas = t.Translate('TIT_SalXClas','Saldos por Clasificación: Detallado por Socio')>
		<cfreportparam name="Titulo" value="#TIT_SalXClas#">
	<cfelse>
		<cfset TIT_SalXClas = t.Translate('TIT_SalXClas','Saldos por Clasificación: Detallado por Dirección')>
		<cfreportparam name="Titulo" value="#TIT_SalXClas#">
	</cfif>
