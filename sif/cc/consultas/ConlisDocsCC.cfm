<!---
	Modificado por Gustavo Fonseca H.
		Fecha: 28-11-2005.
		Motivo: Se elimina los cfuotput anidados. Esto para evitar que se cree páginas muy pesadas.
--->
...
<cfquery name="conlis" datasource="#Session.DSN#">
	select 	a.CCTcodigo, a.CCTcodigo, a.Ddocumento, a.Mcodigo, a.Ccuenta,
		  	c.Mnombre, d.Cdescripcion, a.Dsaldo, b.CCTdescripcion,a.Ddocumento,
			a.Dtipocambio, a.Dtotal, a.Dsaldo, 
	...
	<cfif isdefined("Form.CCTcodigo") and (Form.CCTcodigo NEQ "")>
		and upper(a.CCTcodigo) like '%#Ucase(Form.CCTcodigo)#%'
	</cfif>

	<cfif isdefined("Form.Ddocumento") and (Form.Ddocumento NEQ "")>
		and upper(a.Ddocumento) like '%#Ucase(Form.Ddocumento)#%'
	</cfif>

	<cfif isdefined("Form.Dfecha") and (Form.Dfecha NEQ "")>
		and a.Dfecha = <cfqueryparam cfsqltype="cf_sql_date" value="#lsparsedatetime(Form.Dfecha)#">
	</cfif>
	...
	order by a.Dfecha asc, a.Dsaldo desc
</cfquery>
...
<form action="" method="post" name="conlis">
  <table width="100%" border="0" cellspacing="0">
    ...
    <cfoutput query="conlis" startRow="#StartRow_conlis#" maxRows="#MaxRows_conlis#"> 
      <tr> 
        <td <cfif #conlis.CurrentRow# MOD 2>class="listaPar"<cfelse>class="listaNon"</cfif>><input type="hidden" name="CCTcodigo#conlis.CurrentRow#" value="#conlis.CCTcodigo#"> 
        ...
        <td <cfif #conlis.CurrentRow# MOD 2>class="listaPar"<cfelse>class="listaNon"</cfif>><a href="javascript:Asignar('#JSStringFormat(conlis.CCTcodigo)#','#JSStringFormat(conlis.Ddocumento)#','#JSStringFormat(conlis.Mnombre)#',#conlis.Dtipocambio#,#conlis.Dsaldo#,#conlis.Mcodigo#, #conlis.Ccuenta#);">#conlis.Ddocumento#</a></td>
