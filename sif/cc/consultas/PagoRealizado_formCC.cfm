...
<cfset LB_templateheader = t.Translate('LB_templateheader','SIF - Cuentas por Pagar')>
<cfset LB_Tit = t.Translate('LB_Tit','Pagos Realizados','PagoRealizado_formCC.xml')>
<cfset LB_DatosRep = t.Translate('LB_DatosRep','Datos del Reporte','PagoRealizado_formCC.xml')>
...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#LB_Tit#'>
...
<cfoutput>
	<form name="form1" method="post" action="PagoRealizado_sqlCC.cfm">
		...
		<tr>
			...
			<fieldset><legend>#LB_DatosRep#</legend>
				<table  width="100%" align="center" cellpadding="2" cellspacing="0" border="0">
					...
					<tr>
						<cfoutput><td nowrap align="right" width="47%"><strong>#LB_SocioNegocio#</strong></td></cfoutput>
						<td>
