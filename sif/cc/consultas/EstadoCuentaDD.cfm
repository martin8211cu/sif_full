...
<cfset FileName = "IntegracionSalgosDD">
<cfset FileName = FileName & Session.Usucodigo & DateFormat(Now(),'yyyymmdd') & TimeFormat(Now(),'hhmmss') & '.xls'>
<cf_htmlreportsheaders title="Integración de Saldos por Movimiento de Documento" 
	filename="#FileName#" 
	ira="EstadoCuenta.cfm?1=1#paramsuri#">

<cfflush interval="256">
<cfinclude template="formEstadoCuentaDD.cfm"> 