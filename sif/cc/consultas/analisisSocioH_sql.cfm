...
<cfset MSG_CodSocio = t.Translate('MSG_CodSocio','El codigo de Socio debe ser numérico')>
<cfset MSG_CodDir = t.Translate('MSG_CodSocio','El codigo de direcció debe ser numérico')>

<cfif not isnumeric(url.SNcodigo)>
	<cf_errorCode	code = "50164" msg = "#MSG_CodSocio#">
</cfif>
...
<cfif isdefined("url.id_direccionFact") and url.id_direccionFact NEQ ''>
	...
	<cfif not isnumeric(url.id_direccionFact)>
		<cf_errorCode	code = "50165" msg = "#MSG_CodDir#">
	</cfif>
	<cfquery name="rs" datasource="#session.DSN#">
		select 
