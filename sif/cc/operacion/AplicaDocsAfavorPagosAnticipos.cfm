...
<cfset LB_TituloH = t.Translate('LB_TituloH','SIF - Cuentas por Cobrar','listaDocsAfavorPagosAnticipos.cfm')>
				...
				<td valign="top">	
					...
					<cfif isDefined("Form.Aplicar") and Len(Trim(Form.CCTcodigo)) NEQ 0 and Len(Trim(Form.Ddocumento)) NEQ 0>
						...
						<cfquery name="rsSocio" datasource="#session.dsn#">
						 select sn.SNid 
						   ...
						   where a.CCTcodigo  = <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CCTcodigo#">
							and  a.Ddocumento = <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.Ddocumento#">						 
						</cfquery>
						...
						<cfinvoke component="sif.Componentes.CC_PosteoDocsFavorPagosAnticipos"
						...
						<cfelse>
							<cflocation url="listaDocsAfavorPagosAnticipos.cfm#params#" addtoken="no">
						</cfif>
					</cfif>
					<cfset IDpago = "">
					<cfset CCTcodigo = "">
	                ...
	                <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#MSG_AplDoc#'>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr> 
								<td valign="top"><cfset regresar = "listaDocsAfavorPagosAnticipos.cfm"><cfinclude template="../../portlets/pNavegacionCC.cfm"></td>
							</tr>
							<tr> 
								<td width="77%" valign="top"> <cfinclude template="formDocsAfavorPagosAnticipos.cfm"></td>
							</tr>
							<cfif Len(Trim("CCTcodigo")) NEQ 0>
								<cfif modo NEQ "ALTA">
									<cfif rsLineas.recordCount GT 0>
										<tr> 
											<td> 
												<form action="AplicaDocsAfavorPagosAnticipos.cfm" method="post" name="form2">
									...
									<cfelse>
                                        ...
                                        <cfoutput>
										<tr><td class="listaCorte" align="center">#LB_DocSinDet#</td></tr>
                                        </cfoutput>
										<tr><td>&nbsp;</td></tr>
									</cfif>
								</cfif>
						...
						function Editar(data) {
							if (data!="") {
								document.form2.action='AplicaDocsAfavorPagosAnticipos.cfm';
