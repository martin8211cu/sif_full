	...
	where a.Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
		...
		<cfif isdefined("url.Typ") AND #url.Typ# EQ "C">
			and a.Ddocumento not in(
				select Ddocumento
				from DocCompensacionDCxC b inner join DocCompensacion c
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="text-transform:uppercase" align="center" bgcolor="#CCCCCC"><strong>Lista de Documentos de Cuentas por Cobrar</strong></td>
  </tr>
</table>
<cfinvoke
