 ...
 <cfinvoke component="sif.Componentes.Translate" method="init" returnvariable="t">
			...
			<cfquery name="rsDocumentos" datasource="#Session.DSN#">
                ...
                where EFavor.Ecodigo			=  #Session.Ecodigo#
				  ...
				  and ((coalesce(CCTransacciones.CCTpago,0)=1 and coalesce(CCTransacciones.CCTanticipo,0)=0) or (coalesce(CCTransacciones.CCTpago,0)= 0 and coalesce(CCTransacciones.CCTanticipo,0)=1))
...
<cf_templateheader title="#LB_TituloH#">
	<cfinclude template="../../portlets/pNavegacion.cfm">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#LB_Titulo#'>			
 			<form style="margin:0" action="listaDocsAfavorPagosAnticipos.cfm" method="post" name="form1">           
		      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tituloListas">
                ...
                <tr> 
				  ...
				  <td width="1%">
				  	<input name="NuevoE" type="submit" value="#BTN_Nuevo#" onclick= "javascript:document.form1.action='AplicaDocsAfavorPagosAnticipos.cfm';">
				  </td>
				  <cfif rsDocumentos.RecordCount>
				  <td width="1%">
				  ...
				  <td width="1%">
				    <cfif rsDocumentos.RecordCount GT 0>
						<input name="Reporte" type="submit" id="Reporte" value="#LB_Reporte#" onClick="javascript: document.form1.method='get'; document.form1.action='../reportes/ReporteAplicaDocPagosAnticipos.cfm'">
				  	</cfif>
				  </td>
				  </cfoutput>                   
                </tr>
...
<script language="JavaScript1.2">
	...
	function validaChecksOld() {
		document.form1.action='listaDocsAfavorPagosAnticipos.cfm';
		<cfif rsDocumentos.recordCount GT 0> 
