...
<cfif modo NEQ "ALTA">
	...
	<cfif rsCalculaSaldo.recordcount EQ 0>
		<cfset MSG_Recup = t.Translate('MSG_Recup','No se pudo recuperar los saldos del Documento.')>
		<cfthrow message="#MSG_Recup#">
	</cfif>     
...
<cfset BTN_Regresar	= t.Translate('BTN_Regresar','Regresar','/sif/generales.xml')> 
<cfset LB_Metodo_Pago = t.Translate('LB_Metodo_Pago','Codigo de Pago SAT')>
...
//-----------------------------------------------------------------------------------------------------------
	...
	function Lista() {
		...
		<cfelse>
			location.href="listaDocsAfavorCC.cfm" + params;
		</cfif>
	}
...
<form action="SQLDocsAfavorCC.cfm" method="post" name="form1" onsubmit="javascript:return validaForm(this);">
	<cfoutput>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr> 
			<td> 
            	...
            	<tr> 
              	...
              	<td nowrap>
					...
					<cfelse>
						<cf_sifsociosnegociosFA SNtiposocio="C" tabindex="1">
					</cfif>
              	</td>
                <cfoutput>
              	...
              	<td width="26%" nowrap>
					...
					<cfif isdefined('form.CCTcodigo')>
						...
						columnas="a.CCTcodigo, a.Ddocumento, a.Mcodigo as McodigoE, a.Ccuenta as CcuentaE, c.Mnombre, d.Cdescripcion, a.Dsaldo, b.CCTdescripcion,
								  a.Ddocumento , coalesce(a.Dtcultrev, a.Dtipocambio) as EFtipocambio, a.Dtotal, a.Dsaldo as SaldoEncabezado, Dfecha, a.CodTipoPago"
						...
						asignar="CCTcodigo,Ddocumento,Mnombre,EFtipocambio,SaldoEncabezado,McodigoE,CcuentaE,CodTipoPago"
						asignarformatos="S,S,S,F,M,S,S,S"
						left="125"
						top="100"
						width="750"
						tabindex="1">
            ...
            <tr> 
			  <td nowrap align="right"><strong><cfoutput>#LB_Metodo_Pago#:&nbsp;</cfoutput></strong></td>
              <td nowrap>
				<input name="CodTipoPago" tabindex="-1"  value="<cfif modo NEQ "ALTA"><cfoutput> #rsDocumento.CodTipoPago#</cfoutput></cfif>"  style="text-align:center" type="text" class="cajasinborde" size="3" readonly="">
				<input name="Descrip_CodTipoPago" tabindex="-1"  value="<cfif modo NEQ "ALTA"><cfoutput>
					<cfquery name="TipoPagoSAT" datasource="#Session.DSN#">
						select nombre_TipoPago from FATipoPago where TipoPagoSAT like '#rsDocumento.CodTipoPago#' and ecodigo = #session.ecodigo#; 
					</cfquery>
					<cfif TipoPagoSAT.RecordCount eq 1>#TipoPagoSAT.nombre_TipoPago#</cfif>
				  </cfoutput></cfif>"  style="text-align:left" type="text" class="cajasinborde" size="15" readonly="">
...
<script language="JavaScript">
	...
	function Postear(){
		if (confirm('¿<cfoutput>#MSG_AplicarDocto#</cfoutput>?')) {
			document.form1.CCTcodigo.value = "<cfoutput>#CCTcodigo#</cfoutput>";
