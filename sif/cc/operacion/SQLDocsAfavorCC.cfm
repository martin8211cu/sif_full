...
<cfif isdefined("Form.AgregarE")>
		<cfset arrFecha="#listToArray(Form.EFfecha,'/')#">
		<cfset lvarFecha = CreateDateTime(arrFecha[3],
			arrFecha[2],
			arrFecha[1],
			                          HOUR(now()),
			                          MINUTE(now()),
	...
	<cfquery datasource="#Session.DSN#">
		...
		(
			...
			<cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CodtipoPago#">
			)
	</cfquery>
	<cfset modo="CAMBIO">
	<cfset modoDet="ALTA">
...
<cfelse>
	<cfset action = "AplicaDocsAfavorCC.cfm">
</cfif>
