<cf_templateheader title="	Reasignaci&oacute;n de &Oacute;rdenes de Compra">
		<cf_web_portlet_start titulo="Reasignaci&oacute;n de &Oacute;rdenes de Compra">
		...
		<form name="form1" method="post" action="ReasignacionOrdenes-form.cfm" style="margin: 0;">
			  ...
			  <tr>
				<td width="50%" valign="top">
				  <table width="100%" cellpadding="2" cellspacing="0">
					<tr>
					  <td valign="top"> 
					  <cf_web_portlet_start border="true" titulo="Reasignaci&oacute;n de &Oacute;rdenes de Compra" skin="info1">
						<div align="justify">
						  <p>Este reporte muestra todas las &Oacute;rdenes de Compra reasignadas en el rango de fechas que usted especifique.</p>
						</div>
