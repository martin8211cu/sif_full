...
<cfif isdefined("url.EOnumero") and len(url.EOnumero) and not isdefined("form.EOnumero")>
	<cf_rhimprime datos="/sif/cm/consultas/OrdenesCompra-vistaForm.cfm" paramsuri="&EOnumero=#url.EOnumero#"> 
<cfelse>
	<cf_rhimprime datos="/sif/cm/consultas/OrdenesCompra-vistaForm.cfm" paramsuri="&EOidorden=#url.EOidorden#"> 
</cfif>
