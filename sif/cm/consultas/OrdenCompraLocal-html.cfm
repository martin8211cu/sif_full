...
<cfsavecontent variable="encabezado">
	<table width="98%" border="0" cellpadding="0"  cellspacing="0" align="center">
		...
		<tr>
			<td align="center" bgcolor="##CCCCCC"><font size="1">C O M P R A S</font></td>
		</tr>
		<tr>
		...
		<tr>
			<td>
				<table width="90%" border="0" align="center">
					<tr>
						<td nowrap class="LetraEncab">Tel&eacute;fono:</td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr>
			<td align="center"><strong><font size="2">ORDEN DE COMPRA No: #dataEncabezado.EOnumero#</font></strong></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			<td>
		...
		<cfloop query="data">
			<cfif (isdefined("Url.imprimir") and contador eq max_lineas) or data.Currentrow eq 1>
				...
				<tr class="titulolistas">
					...
					<td class="LetraEncab">Rubro</td>
					<td nowrap class="LetraEncab">Subrubro</td>
			...
			<tr>
				...
				<td align="right" class="LetraDetalle">#LSNumberFormat(data.DOcantidad,',9')#</td>
			...
			<tr>
				<td colspan="2" style="border-bottom: 1px solid gray;" class="LetraDetalle" align="right">Detalle&nbsp;</td>
				<td colspan="9" style="border-bottom: 1px solid gray;" class="LetraDetalle">## - ##</td>
			</tr>
		...
		<tr>
			<td>
				<table width="90%" align="center" border="0" cellpadding="2" cellspacing="0">
					...
					<tr>
						<td class="LetraEncab">Usuario Solicitante:</td>
						<td class="LetraDetalle">#NombreComprador#</td>
						<td colspan="2" class="LetraEncab">Aprobado por</td>
					</tr>
				</table>
			</td>
		</tr>
