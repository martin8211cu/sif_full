<cf_templateheader title="Saldos por Orden de Compra">
	...
	<cfoutput>
		<form method="post" name="form1" action="saldosOrdenCompraCons.cfm"> 
				...
				<tr>
					...
					<td width="60%" valign="top">				  
						<table width="100%" cellpadding="0" cellspacing="0" align="center">
						  <tr>
							<td nowrap align="right"><strong>Del Proveedor:</strong></td>
						  ...
						  <tr align="left">
							...
							<td nowrap align="right"><strong>Hasta:</strong>&nbsp;</td>
							<td width="50%" nowrap ><cf_sifcalendario name="fechaf" value="" tabindex="1"></td>
							<td width="1%">&nbsp;</td>
						  </tr>
						  <tr align="left">
						  ...
						  <tr>
							<td colspan="5" align="center"><input type="submit" value="Consultar" name="Reporte" id="Reporte">
