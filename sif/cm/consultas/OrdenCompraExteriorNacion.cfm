...
<cfquery name="data" datasource="#session.DSN#">
	select 
	 ...
	 b.DOconsecutivo,
	 b.DOcantidad,	 
     b.DOdescripcion #_Cat#  case when LEN(b.numparte) > 1 then ' Num. Parte: ' #_Cat# b.numparte  else ' ' end as Descripcion,     
	 coalesce(b.DOobservaciones, 'N/A') #_Cat#' -- '#_Cat# coalesce(b.DOalterna,'N/A') as DescripcionDetalle,
	 #LvarOBJ_PrecioU.enSQL_AS("b.DOpreciou")#,
	 b.DOtotal,
     b.DOimpuestoCosto,
	 mi.Msimbolo as codMoneda, 
	 a.EOnumero,   
	 ...
	 (select min(CMCnombre) from CMCompradores where  CMCid = a.CMCid) as NombreComprador	 
		from EOrdenCM a 
        ...
        INNER JOIN  Monedas mi
        	on mi.Mcodigo = a.Mcodigo
        INNER JOIN Monedas me
        	ON me.Ecodigo = #session.Ecodigo#
            AND me.Miso4217 = mi.Miso4217
...
<cfif isdefined('data.Usucodigo')and len(trim(#data.Usucodigo#)) eq 0>
 <cfthrow message="La orden de compra #data.EOnumero#, no tiene el dato del comprador!">
</cfif>
     

    <cfquery name="rsCompradorOC" datasource="#session.dsn#">
          select   
    ...
    <cfif rsCompradorOC.recordcount eq 0>
	 <cfthrow message="No se obtuvieron datos del comprador para la la OC numero: #data.EOnumero#!">
	</cfif>    
	...
	<table width="100%" cellpadding="2" cellspacing="0" border="1" align="center" >
          ...
          <td width="40%" colspan="2"> 
                <table width="100%" border="0" align="center">
                   <tr>
                      <td>&nbsp;&nbsp;&nbsp;</td>
                      <td align="center"><strong>No.</strong>&nbsp;E-#data.EOnumero#</p></td>
                   </tr>
                   <tr>
             ...
             <td colspan="2">
                 <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td width="26%"><span class="LetraDetalle">#rsCompradorOC.telef#</span></td>
                    <td width="44%"><strong>Fax:</strong><span class="LetraDetalle">&nbsp;#rsCompradorOC.fax#</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td><strong>Incoterm:</strong></td><td colspan="2"><span class="LetraDetalle">#data.CMIcodigo# - #data.CMIdescripcion#</span></td>
                  </tr>
                </table>
             </td>
            </tr>
...
<cffunction name="fnColocarPiePagina" output="true">
    ...
    <tr>
  	...
  	<tr>
      <td colspan="6">
         <p class="LetraDetalle"><strong></strong> </p>
      </td>
      <td colspan="6">
