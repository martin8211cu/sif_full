...
function Asignar(ESidsolicitud,ESnumero,ESobservacion) {
	if (window.opener != null) {
		window.opener.document.form1.ESidsolicitud.value = ESidsolicitud;
		window.opener.document.form1.ESnumero.value = ESnumero;
		window.opener.document.form1.ESobservacion.value = ESobservacion;
		window.close();
	}
}
</script>
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<form style="margin:0;" name="filtroOrden" method="post" action="ConlisSolicitudes.cfm">
