<cf_templateheader title="Compras - Compradores ">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Consulta Hist&oacute;rica de Reclamos de Compras'>
			...
			<cfif isdefined("form.ERid") and len(trim(form.ERid)) neq 0>
				<cf_rhimprime datos="/sif/cm/consultas/ReclamosHistLista.cfm" paramsuri="&ERid=#form.ERid#"> 
			<cfelse>
				<cf_rhimprime datos="/sif/cm/consultas/ReclamosHistLista.cfm" paramsuri=""> 
			</cfif>
			
			<cfinclude template="ReclamosHistLista.cfm">
			
			<DIV align="center">
				<input name="btnRegresar" type="button" value="Regresar" onClick="javascript:location.href='ReclamosHist.cfm'" >
			</DIV>
