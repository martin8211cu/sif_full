...
<script language="JavaScript">
	function limpiar() {
		...
		document.form1.fEDRestado.value = 'T';
		document.form1.Mcodigo.value = '';
	}
</script>

<cf_templateheader title="Consulta de Recepción de Mercaderia (por lote)">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Recepcion de Mercadería (por lote)'>
			...
			<table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
	    		<tr>
      				<td>
						<form style="margin: 0" action="RecepMercaderia-vista.cfm" name="form1" method="post">
                            ...
                            <tr>
							  ...
							  <tr>
								...
								<td align="right" nowrap><strong>Tipo:&nbsp;</strong></td>
								  ...
								  <select name="fEDRestado" >
									<option value="T" <cfif isdefined("form.fEDRestado") and form.fEDRestado eq 'T'>selected</cfif> >Todos</option>
									<option value="10" <cfif isdefined("form.fEDRestado") and form.fEDRestado eq '10'>selected</cfif> >Aplicados</option>
									<option value="0" <cfif isdefined("form.fEDRestado") and form.fEDRestado  eq '0'>selected</cfif>>Sin Aplicar</option>
								    <cfif rsParametroTolerancia.RecordCount gt 0 and rsParametroTolerancia.Pvalor eq 1>
									    <option value="-5" <cfif isdefined("form.fEDRestado") and form.fEDRestado eq '-5'>selected</cfif>>En Aprobación de Tolerancia</option>
									    <option value="5" <cfif isdefined("form.fEDRestado") and form.fEDRestado eq '5'>selected</cfif>>Tolerancia Aprobada</option>
								    </cfif>
								  </select></td>
							  </tr>
							  <tr>
