...
<table width="99%" align="center"  border="0" cellspacing="0" cellpadding="2">
	<tr class="tituloListas">
		...
		<td nowrap width="15%" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;"><cf_translate key="LB_Comprador">Comprador</cf_translate></td>
		<cfif not isdefined("url.imprimir")>
			<td style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black; ">&nbsp;</td>
		</cfif>
		...
		<td nowrap width="3%" align="right" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;"><cf_translate key="LB_CantSurt">Cant.Surt</cf_translate>.</td>
		<td nowrap width="3%" align="right" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;"><cf_translate key="LB_CantCanc">Cant.Canc</cf_translate>.</td>
	...
	<cfelse>
		<cfoutput query="qryLista2">
			<tr class=<cfif (currentRow MOD 2)>"listaNon"<cfelse>"listaPar"</cfif>>
				...
				<td width="40%" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;">&nbsp;#DSdescripcion#&nbsp;</td>
				<td width="15%" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;">&nbsp;#Comprador#&nbsp;</td>
				<cfif not isdefined("url.imprimir")>
					<td style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;">
						<cfset varDSdescalterna = trim(Replace(DSobservacion,chr(34),'&quot;','ALL' ))>
						<cfset varDSobservacion = trim(Replace(DSdescalterna,chr(34),'&quot;','ALL' ))>
				...
				<td nowrap width="3%" align="right" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;">&nbsp;#DScantsurt#&nbsp;</td>
				<td nowrap width="3%" align="right" style="padding-right: 5px; border-bottom: 1px solid black; border-left: 1px solid black;">&nbsp;#DScantcancel#&nbsp;</td>
...
<table width="99%" align="center"  border="0" cellspacing="2" cellpadding="2" style="border-top:1px solid black; ">
	...
	<cfif rsPreTotales.recordcount gt 0>
		<cfquery name="rsTotales" dbtype="query">
			select sum(MotoIEPS) as TotalIEPS,  sum(IVA) as impuesto,
