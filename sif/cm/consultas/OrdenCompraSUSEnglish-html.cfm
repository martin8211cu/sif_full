...
<cfsavecontent variable="encabezado">
	<table width="100%" border="0" cellpadding="0"  cellspacing="0" align="center">
        <tr>
            ...
            <td align="right" class="titulo2">PURCHASE ORDER</td>
        </tr>
        <tr>
		...
		<tr>
            ...
            <td align="right" class="LetraEncablight" bgcolor="##CCCCCC">Phone1: #dataEncabezado.ETelefono1#</td>
		</tr>
        <tr>
            <td align="left" class="LetraEncablight" bgcolor="##CCCCCC">#dataEncabezado.EDireccion3#</td>
            <td align="right" class="LetraEncablight" bgcolor="##CCCCCC">Phone2: #dataEncabezado.ETelefono2#</td>
		</tr>
	...
	<table width="100%" border="0" cellpadding="0"  cellspacing="0" align="center">
			...
			<td colspan="2" align="center">
				<table width="100%" border="0" cellpadding="2" cellspacing="0">
					<tr>
						...
						<td align="right" nowrap class="LetraEncab">Order Date:</td>
					...
					<tr>
						...
						<td align="right" nowrap class="LetraEncab">Currency:</td>
					...
					<tr>
						<td align="left" nowrap class="LetraEncab">Phone:</td>
        ...
        <tr>
			<td colspan="2" align="center">
				<table width="100%" border="0" cellpadding="2" cellspacing="0">
                	<tr>
                    	<td style="border-top: 2px solid black;" width="25%" class="LetraEncab">Ship To:</td>
                        <td style="border-top: 2px solid black;" width="25%">&nbsp;</td>
                        <td style="border-top: 2px solid black;" width="25%">&nbsp;</td>
                        <td style="border-top: 2px solid black;" width="25%" class="LetraEncab">Invoice To:</td>
                    </tr>
                    <tr>
...
--->
		...
		<cfloop query="data">
			<cfif (isdefined("Url.imprimir") and NPAG EQ 1) or data.Currentrow eq 1>
				...
				<tr class="titulolistas">
					<td style="border-top: 2px solid black;" class="LetraEncab">Line</td>
					<td style="border-top: 2px solid black;" class="LetraEncab">Item</td>
					<td style="border-top: 2px solid black;" class="LetraEncab">Description</td>
					<td style="border-top: 2px solid black;" align="right" class="LetraEncab">Qty.</td>
					<!---<td class="LetraEncab">UM</td>--->
					<td style="border-top: 2px solid black;" align="right" class="LetraEncab">Unit Price</td>
					<!---<td align="right" nowrap class="LetraEncab">% Disc.</td>--->
					<!---<td align="right" class="LetraEncab">Tax</td>--->
            ...
            <cfif len(trim(data.Descripcion)) GT 0>
                <tr>
                  <td class="LetraDetalle">Alternative Desc.: </td>
            ...
            <cfif len(trim(data.ObservacionesOrden)) GT 0>
                <tr>
                    <td class="LetraDetalle">Comments: </td>
                    <td colspan="6" class="LetraDetalle">
			...
			<tr>
                <td style="border-bottom: 1px solid gray;" class="LetraDetalle">Req. Date:</td>
                ...
                <td style="border-bottom: 1px solid gray;" class="LetraDetalle">Est. Date:</td>
	...
	<table width="99%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td>
				<table width="70%" align="center" border="0" cellpadding="2" cellspacing="0">
					<tr>
						<td nowrap class="LetraEncab">Credit Term:</td>
                    ...
                    <tr>
						<!---<td class="LetraEncab">Sending User:</td>--->
						<td nowrap>&nbsp;</td>
						<td align="center" colspan="2" class="LetraEncab">Signature</td>
                        <td nowrap>&nbsp;</td>
					</tr>
					<tr>
		...
		<cfif (len(trim(dataEncabezado.EOImpresion)) EQ 0) or (isdefined("url.primeravez"))><!----or (trim(dataEncabezado.EOImpresion) eq 'I'----->
			<tr><td align="right" class="LetraEncab">ORIGINAL - PROVIDER</td></tr>	
		<cfelseif len(trim(dataEncabezado.EOImpresion))><!--- neq 'I'---->
			<tr><td align="right" class="LetraEncab">(COPY NON-NEGOTIABLE)</td></tr>
		</cfif>
		<cfif isdefined("Url.imprimir") and data.recordCount>
			<tr><td align="right" class="LetraDetalle"><strong>Page #PagImp#</strong></td></tr>
		</cfif>
	</table>
</cfoutput>
