...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<form style="margin:0;" name="filtroOrden" method="post" action="ConlisOCHastaNoAplic.cfm">
			<cfif Len(Trim(index))>
	...
	<tr>
		<td>
			<cfinvoke 
				...
				<cfinvokeargument name="irA" value="ConlisOCHastaNoAplic.cfm"/> 
