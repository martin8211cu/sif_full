<cf_templateheader title="	Solicitudes Pendientes">
		<cf_web_portlet_start titulo="Solicitudes Pendientes">
		...
		<form name="form1" method="get" action="SolicitudesPendCotizar-rep.cfm">
				...
				<tr>
					<td width="50%" valign="top">
						<table width="100%">
							<tr>
								<td> 
									<cf_web_portlet_start border="true" titulo="Consulta de Solicitudes Pendientes por Cotizar" skin="info1">
										<div align="justify">
											<p> 
											En &eacute;ste reporte se muestran las solictudes pendientes de cotizar por comprador, 
											donde tiene la opci&oacute;n de verlas por un rango de fechas o todas las que tenga 
											asociadas en ese momento, las solicitudes pendientes de cotizar est&aacute;n agrupadas 
											por un Centro Funcional o Departamento.
											</p>
										</div>
									<cf_web_portlet_end> 
								</td>
