...
<cfif isdefined("Url.CMCcodigo") and not isdefined("Form.CMCcodigo")>
	<cfparam name="Form.CMCcodigo" default="#Url.CMCcodigo#">
</cfif>
...
<script language="JavaScript" type="text/javascript">
	...
	function Asignar(CMCid,CMCcodigo,nombre) {
		if (window.opener != null) {
			window.opener.document.#form.formulario#.#form.CMCid#.value = CMCid;
			window.opener.document.#form.formulario#.#form.CMCcodigo#.value = CMCcodigo;
			window.opener.document.#form.formulario#.#form.desc#.value = trim(nombre);
			
			if (window.opener.func#form.CMCid#) {
				window.opener.func#form.CMCid#()
			}
			window.close();
		}
}
...
<!--- Filtro --->
<cfset filtro = "">
<cfset navegacion = "&formulario=#form.formulario#&CMCid=#form.CMCid#&CMCcodigo=#form.CMCcodigo#&desc=#form.desc#&Ecodigo=#Form.Ecodigo#">
...
<table width="100%" cellpadding="2" cellspacing="0">
	<tr><td>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro">
			<tr>
				...
				<td> 
					<input name="CMCnombre" type="text" id="desc" size="25" maxlength="80" onClick="this.select();" value="<cfif isdefined("Form.CMCnombre")>#Form.CMCnombre#</cfif>">
				</td>
				...
				<td align="center">
					...
					<cfif isdefined("form.CMCcodigo") and len(trim(form.CMCcodigo))>
						<input type="hidden" name="CMCcodigo" value="#form.CMCcodigo#">
					</cfif>
	...
	<tr><td>
		<cfset select = " a.CMCid, rtrim(a.CMCcodigo) as CMCcodigo, a.CMCnombre " >
		<cfset from = " CMCompradores a " >
		<cfset where = " a.Ecodigo in (#form.Ecodigo#)" >
		<cfset where = where & filtro & " order by a.CMCcodigo, a.CMCnombre">
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="desplegar" value="CMCcodigo,CMCnombre"/>
			...
			<cfinvokeargument name="fparams" value="CMCid,CMCcodigo,CMCnombre"/>
