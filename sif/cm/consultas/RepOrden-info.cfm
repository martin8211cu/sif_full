...
<script type="text/javascript" language="javascript1.2">
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.form1.DOobservaciones#url.index#.value;
	document.form1.descalterna.value = window.opener.document.form1.DOalterna#url.index#.value;
	function salir(){
		window.close();
	}
	</cfoutput>
