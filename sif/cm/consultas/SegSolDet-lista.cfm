...
<cf_templateheader title="Compras - Consulta Seguimiento de Solicitudes Detallada">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Consulta Seguimiento de Solicitudes Detallada'>
			...
			<form name="form1" method="post" action="SegSolDet-form.cfm" style="margin: 0"><!----onSubmit="return Valida()">----->
...
---> 							  
			...
			<script language="JavaScript" type="text/javascript">	
				...
				function doConlisOCHasta(valor) {
					popUpWindow2("/cfmx/sif/cm/consultas/ConlisSolicitudesDet.cfm?idx="+valor,10,150,1000,450);
				}
				 
				function traeSolicitud(value,valor){
				  if (value!=''){
				 	   document.getElementById("fr").src = 'traerSolicitudDet.cfm?ESnumero='+value+'&idx='+valor;
				 }
				  else{
						if (valor == 1){
