...
<cfquery name="rsLEPD" datasource="#session.dsn#">
	...
	where poliza.Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.Ecodigo#">
		and poliza.EPDestado = 0
		<!---and poliza.Usucodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.Usucodigo#">--->
...
<cfinvoke component="sif.Componentes.pListas"	method="pListaQuery" returnvariable="pListaRet">
	...
	<cfinvokeargument name="etiquetas" 			value="Póliza, Descripcion, Agencia Aduanal, Aduana, Bultos, Peso Bruto, Peso Neto"/>
	...
	<cfinvokeargument name="keys" 				value="EPDid"/>
	<cfinvokeargument name="inactivecol" 		value="EPDid"/>
</cfinvoke>