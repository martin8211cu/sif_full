...
<html>
<head>
<title>Registro del Detalle de Facturas</title>
...
<!--// //poner a código javascript 
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.formDocDet.DDIobs.value;

	function info(){
		window.opener.document.formDocDet.DDIobs.value = document.form1.observaciones.value;
		window.close();
	}
	</cfoutput>
//-->
