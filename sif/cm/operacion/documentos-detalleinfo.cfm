...
<html>
<head>
<title>Registro de Documentos de Recepci&oacute;n - Observaciones</title>
...
<!--// //poner a código javascript 
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.form2.DDRobsreclamo.value;

	function info(){
		window.opener.document.form2.DDRobsreclamo.value = document.form1.observaciones.value;
		window.close();
	}
	</cfoutput>
//-->
