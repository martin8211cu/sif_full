...
<!----*/*/-*/-*/-*/-*/CALCULO DEL MONTO DEL RECLAMO-*/-*/-*/-*/-*---->
<cfset vnmonto = 0>			<!----Variable con el la suma de todos los montos por linea---->
<cfset vnmtoImp = 0>		<!----Variable con el monto del impuesto calculado según el parámetro---->
<cfset vnmtoImpFact = 0>	<!----Variable con el monto del impuesto por linea del dcto--->
<cfset vnTotal = 0>			<!----Variable con el monto total del reclamo X LINEA----->
<cfset vnDesc =0>			<!---Variable con el monto de descuento X LINEA---->
<cfquery name="rsMontos" datasource="#session.DSN#">
	select  dd.DDRtotallincd,
			dd.DDRtotallin,
			dd.DDRcantorigen,
			dd.DDRcantrec,
			dd.DDRprecioorig, 
	...
	from   DDocumentosRecepcion dd
			...
			<!----Impuesto del dcto de recepcion---->
			left outer join Impuestos i	
				on dd.Ecodigo = i.Ecodigo
				and dd.Icodigo = i.Icodigo						
	
	where dd.Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
		and dd.EDRid=<cfqueryparam cfsqltype="cf_sql_numeric" value="#form.EDRid#">
		and dd.DDRgenreclamo = 1
</cfquery>
<cfoutput query="rsMontos">	<!---Recorrido de todas las lineas con reclamos---->
	<!----////////////////// RECLAMO POR PRECIO /////////////////---->
	<cfif rsMontos.DDRpreciou NEQ rsMontos.DDRprecioorig and rsMontos.DDRcantrec EQ rsMontos.DDRcantorigen>		
		<cfset vnTotal = rsMontos.DDRcantorigen*rsMontos.DDRpreciou><!---Total de la factura por linea--->
		<cfset vnDesc  = (vnTotal*rsMontos.DDRdescporclin)/100><!---Descuento por linea--->
		<cfif rsOrden.Pvalor EQ 1><!---Calculo del impuesto del DCTO según parámetro---->
			<cfset vnmtoImpFact =(vnTotal*rsMontos.DDRimptoporclin)/100><!---(((rsMontos.DDRcantorigen*rsMontos.DDRpreciou)*rsMontos.DDRimptoporclin)/100)>---->
		<cfelse>
			<cfset vnmtoImpFact = ((vnTotal - vnDesc)*rsMontos.DDRimptoporclin)/100>	<!---((((rsMontos.DDRcantorigen*rsMontos.DDRpreciou)-((rsMontos.DDRcantorigen*rsMontos.DDRpreciou)*rsMontos.DDRdesclinea)/100)+rsMontos.DDRimptoporclin)/100)>--->
		</cfif>
		<cfif rsOrden.Pvalor EQ 1><!---Calculo del impuesto de la OC---->
			<cfset vnmtoImp =((rsMontos.DOtotal*rsMontos.Iporcentaje)/100)>
		<cfelse>
			<cfset vnmtoImp =(((rsMontos.DOtotal-rsMontos.DOmontodesc)*rsMontos.Iporcentaje)/100)>
		</cfif>			
		<cfset vnmonto = vnmonto+(vnTotal-vnDesc+vnmtoImpFact)-(rsMontos.DOtotal-rsMontos.DOmontodesc+vnmtoImp)><!----(((rsMontos.DDRcantorigen*rsMontos.DDRpreciou)-rsMontos.DDRdesclinea)+rsMontos.DDRmtoimpfact)-(rsMontos.DOtotal-rsMontos.DOmontodesc+vnmtoImp)>---->
	<!---////////////////// RECLAMO POR CANTIDADES /////////////////---->
	<cfelse>
		<cfif rsMontos.DDRcantorigen NEQ rsMontos.DDRcantrec and rsMontos.DDRcantorigen LTE rsMontos.DOcantidad>			
			<cfset vnTotal = (rsMontos.DDRcantorigen-rsMontos.DDRcantrec)*rsMontos.DDRpreciou>
			<cfset vnDesc  = (vnTotal*rsMontos.DDRdescporclin)/100>
			...
			<cfset vnmonto = vnmonto+(vnTotal-vnDesc+vnmtoImpFact)><!---((((rsMontos.DDRcantorigen-DDRcantrec)*rsMontos.DDRpreciou)-rsMontos.DDRdesclinea)+rsMontos.DDRmtoimpfact)>---->
		<!---////////////////////////////////////////////////////////----->
		<cfelseif rsMontos.DDRcantorigen NEQ rsMontos.DDRcantrec and rsMontos.DDRcantorigen GT rsMontos.DOcantidad>
			<cfset vnTotal = rsMontos.DDRcantorigen*rsMontos.DDRpreciou>
			<cfset vnDesc  = vnTotal*rsMontos.DDRdescporclin/100>
			...
			<cfset vnmonto = vnmonto+(rsMontos.DOtotal-rsMontos.DOmontodesc+vnmtoImp)-(vnTotal-vnDesc+vnmtoImpFact)><!----(rsMontos.DOtotal-rsMontos.DOmontodesc+vnmtoImp)-(rsMontos.DDRtotallin-rsMontos.DDRdesclinea+rsMontos.DDRmtoimpfact)>---->
		<!---////////////////////////////////////////////////////////----->
		<cfelseif rsMontos.DDRcantorigen EQ rsMontos.DDRcantrec and rsMontos.DDRcantorigen GT rsMontos.DOcantidad>						
			<cfset vnTotal = (rsMontos.DDRcantorigen-rsMontos.DOcantidad)*rsMontos.DDRpreciou>
			<cfset vnDesc  = (vnTotal*rsMontos.DDRdescporclin)/100>			
			<cfif rsOrden.Pvalor EQ 1><!---Calculo del impuesto del DCTO según parámetro---->
				<cfset vnmtoImpFact = (vnTotal*rsMontos.DDRimptoporclin)/100><!---(((rsMontos.DDRcantorigen*rsMontos.DDRpreciou)*rsMontos.DDRimptoporclin)/100)>---->
			<cfelse>
			...
			<cfset vnmonto = vnmonto+vnTotal-vnDesc+vnmtoImpFact> <!---(((rsMontos.DDRcantorigen-rsMontos.DOcantidad)*rsMontos.DDRpreciou)-rsMontos.DDRdesclinea)+rsMontos.DDRmtoimpfact>---->
		</cfif>
	</cfif>
</cfoutput>
<!----*/*/-*/-*/-*/-*/-*/-*/-*/-*/-*/*/*/-*/-*/-*/-*/-*/-*/-*/-*/-*/*/*/-*/-*/-*/-*/-*/-*/-*/-*/-*---->
...
<cfif isdefined('rsReclamos') and rsReclamos.recordCount GT 0>
	<table width="100%"  border="0" cellspacing="0" cellpadding="1">
		...
		<cfoutput query="rsReclamos">
			...
			<cfif rsReclamos.EDRestado eq 10 and rsReclamos.DOcantsaldo gt 0>
								<!--- <script language="javascript" type="text/javascript">
									alert('Tome1');
								 </script> --->
				<cfset lineaReclamo = calcularReclamo(rsReclamos.DDRcantorigen, rsReclamos.DDRpreciou, rsReclamos.DDRdescporclin,
																	  rsReclamos.Iporcentaje, rsReclamos.DOcantsaldo, rsReclamos.DDRprecioorig,
																	  rsReclamos.DOporcdesc, rsReclamos.IporcentajeOC, rsReclamos.DDRcantrec,
																	  rsReclamos.Ctolerancia, rsReclamos.Mcodigo, rsReclamos.McodigoOC,
																	  rsReclamos.EDRtc, rsReclamos.EOtc, rsReclamos.factorConversionU, 
																	  rsReclamos.DDRtipoitem, rsReclamos.ArticuloTieneTolerancia,idPoliza,rsReclamos.DDRaprobtolerancia)>
			<cfelseif rsReclamos.EDRestado eq 10 and rsReclamos.DOcantsaldo lte 0>
				<!--- <script language="javascript" type="text/javascript">
									alert('Tome2');
								 </script> --->
				<cfset lineaReclamo = calcularReclamo(rsReclamos.DDRcantorigen, rsReclamos.DDRpreciou, rsReclamos.DDRdescporclin,
																	  rsReclamos.Iporcentaje, rsReclamos.DOcantidad, rsReclamos.DDRprecioorig,
																	  rsReclamos.DOporcdesc, rsReclamos.IporcentajeOC, rsReclamos.DDRcantrec,
																	  rsReclamos.Ctolerancia, rsReclamos.Mcodigo, rsReclamos.McodigoOC,
																	  rsReclamos.EDRtc, rsReclamos.EOtc, rsReclamos.factorConversionU, 
																	  rsReclamos.DDRtipoitem, rsReclamos.ArticuloTieneTolerancia,idPoliza,rsReclamos.DDRaprobtolerancia)>														 
			...
			<tr class=<cfif LvarListaNon>"listaNon"<cfelse>"listaPar"</cfif> onmouseover="this.className='listaParSel';" onmouseout="this.className='<cfif LvarListaNon>listaNon<cfelse>listaPar</cfif>';">
				...
				<td align="center" width="3%">&nbsp;#LvarlineaUnidadesNoRecibidas#</td>
				
				<td align="center" width="3%">&nbsp;#LvarlineaUnidadesReclamo#</td>
				
				<td align="right" width="3%">&nbsp;#LvarOBJ_PrecioU.enCF_RPT(DDRprecioorig)#</td>
				<td align="right" width="10%">&nbsp;#LvarOBJ_PrecioU.enCF_RPT(DDRpreciou)#</td>
				...
				&nbsp;#LSNumberFormat(LvarlineaReclamo,',9.00')#			
				<cfset vnMontoReclamo = vnMontoReclamo + LvarlineaReclamo>									  																	  				
				</td>
			</tr>
			<tr>
				<td colspan="14">
