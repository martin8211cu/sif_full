...
<cfset email_subject = "Reasignación de Autorizador de Ordenes de Compra.">
...
<cfinclude template="reasignarAutorizadorOrden-sql.cfm">
...
<cflocation url="reasignarAutorizadorOrden-email-enviado.cfm?EOidorden=#URLEncodedFormat(form.EOidorden)#&email=#URLEncodedFormat(form.email)#&Ccemail=#URLEncodedFormat(form.Ccemail)#&nameBuyerTo=#URLEncodedFormat(form.nameBuyerTo)#&nameBuyerCc=#URLEncodedFormat(form.nameBuyerCc)#&rb=#URLEncodedFormat(form.rb)#&comprador=#form.comprador#">
