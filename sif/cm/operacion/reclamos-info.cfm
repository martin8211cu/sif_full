...
<tr><td align="center">
	<table width="98%" cellpadding="0" cellspacing="0" border="0" >
		...
		<tr>
			<td align="left"><textarea style=" width:100%" name="observaciones" rows="22" <cfif url.readonly eq 'true'>readonly</cfif> ></textarea></td>
		</tr>
...
<!--// //poner a código javascript 
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.form1.#url.name#.value;

	function info(){
		window.opener.document.form1.#url.name#.value = document.form1.observaciones.value;
		window.close();
	}
	</cfoutput>
//-->
