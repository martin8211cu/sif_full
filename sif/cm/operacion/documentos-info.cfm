...
<!--// //poner a código javascript 
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.form1.EDRobs.value;

	function info(){
		window.opener.document.form1.EDRobs.value = document.form1.observaciones.value;
		window.close();
	}
	</cfoutput>
//-->
