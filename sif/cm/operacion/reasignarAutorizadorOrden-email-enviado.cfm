<cf_templateheader title="Reasignaci&oacute;n de Autorizador de Ordenes de Compra - Env&iacute;o de Correo ">
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Reasignaci&oacute;n  de Autorizador de Ordenes de Compra -  Envio de Correo'>
			<cfinclude template="/home/menu/pNavegacion.cfm">
	
			<cfoutput>
				<form action="reasignarAutorizadorOrden.cfm" name="form1" id="form1" method="get">
					<input type="hidden" name="comprador" id="comprador" value="#url.comprador#">
								...
								<fieldset><legend><strong>Envío de Correo a Compradores&nbsp;</strong></legend>	
									<table width="90%" align="center">
										...
										<tr>
											...
											<td nowrap>&nbsp;</td>
											<td nowrap>
												Reasignaci&oacute;n de Autorizador de Ordenes de Compra.
											</td>
										</tr>
										<tr>
											<td colspan="3" class="subTitulo tituloListas">
