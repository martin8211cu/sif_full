...
<form name="lista" method="post" action="solicitudesACancelar.cfm">
...
<table  align="center"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="Ayuda" align="center"><span class="style1">Indíque en esta área el motivo de la cancelación!</span></td>
  </tr>
</table>
</fieldset>
<br>
<cfinvoke 
	...
	<cfinvokeargument name="desplegar" value="ESnumero, ESobservacion, CentroFunc, ESfecha, EStotalest, Mnombre"/>
	<cfinvokeargument name="etiquetas" value="N&uacute;mero, Descripci&oacute;n, Centro Funcional, Fecha, Monto Estimado, Moneda"/>
	...
	<cfinvokeargument name="irA" value="solicitudesACancelar.cfm"/>
...
//------
	function hayAlgunoChequeado(){
		if (document.lista.chk) {
			if (document.lista.chk.value) {entonces
