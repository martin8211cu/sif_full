<cfquery name="rs" datasource="#session.DSN#">
	...
	where DDAid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.DDAid#">
		...
		<cfif isdefined('Session.Compras.ProcesoCompra.CMPid') and Session.Compras.ProcesoCompra.CMPid neq ""> 
			and (CMPid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Compras.ProcesoCompra.CMPid#"> or CMPid is null)
		</cfif>
</cfquery>
