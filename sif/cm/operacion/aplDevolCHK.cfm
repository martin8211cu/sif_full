<cftransaction>
	...
	<cfquery datasource="#session.DSN#" name="dataOrden">
		select a.DDRlinea, a.DOlinea, DDRcantorigen, DDRgenreclamo, a.Ucodigo, b.Ucodigo as Ucodigo_OC
...
<!--- 		<cfif trim(form["UcodigoOC_#dataOrden.CurrentRow#"]) neq trim(form["Ucodigo_#dataOrden.CurrentRow#"])> --->
		<cfif trim(dataOrden.Ucodigo_OC) neq trim(dataOrden.Ucodigo)>		
			<cfquery name="rsConversion" datasource="#session.DSN#">
				select Ucodigo, Ucodigoref, CUfactor 
				from ConversionUnidades 
				where Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
					and Ucodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#dataOrden.Ucodigo_OC#">
			...
			<cfelse>
				<cfquery name="rsConversionArt" datasource="#session.DSN#">
					...
					where a.Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
						...
						and b.Ucodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#dataOrden.Ucodigo_OC#">
						and c.Ucodigo = <cfqueryparam cfsqltype="cf_sql_char" value="#dataOrden.Ucodigo#">
				</cfquery>
		...
		<cfif factor eq 0 >
			...
			<cf_errorCode	code = "50284"
							...
							errorDat_1="#dataOrden.Ucodigo_OC#"
							errorDat_2="#dataOrden.Ucodigo#"
			>
			<cfabort>
		</cfif>
	...
	<cfquery name="dataComprador" datasource="#session.DSN#">
		...
		where a.Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
		and a.EDRid=<cfqueryparam value="#pkEDRid#" cfsqltype="cf_sql_numeric">
	</cfquery>
