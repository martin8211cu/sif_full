<!--- **************************************************** --->
<!--- SOLICITUDES DE COMPRA ÚNICAMENTE CON PLAN DE COMPRAS --->
<!--- **************************************************** --->
...
<form action="solicitudD-PCG.cfm" method="post" name="form1" onSubmit="javascript: return selecionarTodos();" >
	...
	<tr><td colspan="2">&nbsp;</td></tr>
		...
		<cfelse>
			...
			<td align="center"  valign="top">
					...
					<cfinvokeargument name="irA" 				value="solicitudD-PCG.cfm?tipo=#LvarTipo#&CFid=#LvarCFid#"/>
