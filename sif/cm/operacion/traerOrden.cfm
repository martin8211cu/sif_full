	...
	<script language="javascript1.2" type="text/javascript">
		<cfif rs.recordCount gt 0>
			<cfoutput>
				...
				window.parent.document.form1.EDRreferencia.value = '#rs.Observaciones#';
				window.parent.document.form1.SNcodigo.value = #rs.SNcodigo#;
				<cfif not isdefined("url.socioNoFijo")>
					window.parent.document.getElementById("socio").innerHTML = '#rs.SNnumero#' + " - " + '#rs.SNnombre#';				
				</cfif>
			</cfoutput>
		<cfelse>
			...
			window.parent.document.form1.EDRreferencia.value = '';
			window.parent.document.form1.SNcodigo.value = '';
			<cfif not isdefined("url.socioNoFijo")>			
				window.parent.document.getElementById("socio").innerHTML = 'Sin definir';
			</cfif>
		</cfif>
	</script>
</cfif>