...
<!--// //poner a código javascript 
	<cfoutput>
	document.form1.observaciones.value = window.opener.document.form1.EDobservaciones.value;

	function info(){
		window.opener.document.form1.EDobservaciones.value = document.form1.observaciones.value;
		window.close();
	}
	</cfoutput>
//-->
