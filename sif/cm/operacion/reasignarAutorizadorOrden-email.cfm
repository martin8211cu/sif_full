<cf_templateheader title="Reasignar Autorizador de Ordenes de Compra - Env&iacute;o de Correo ">
		...
		<script type="text/javascript" language="javascript1.2">
			...
			function validar(f){
				...
				if (confirm('Está seguro de que desea realizar la reasignación del autorizador a la orden de compra seleccionada?')) {
					return true;
				} else {
					return false;
				}
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Reasignaci&oacute;n de Autorización de Ordenes de Compra -  Envio de Correo'>
			<cfinclude template="/home/menu/pNavegacion.cfm">
			
			<cfoutput>
 				<form action="reasignarAutorizadorOrden-email-apply.cfm" name="form1" id="form1" method="post" onSubmit="javascript: return validar(this);">
									...
									<table width="90%" align="center">
										<tr>
											<td colspan="3" class="subTitulo tituloListas">
												<img src="Reclamos-email.gif" width="37" height="12">&nbsp;&nbsp;Env&iacute;o de Informaci&oacute;n de Reasignaci&oacute;n de Autorizador de Ordenes de Compra.</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td nowrap>&nbsp;</td>
											<td nowrap>
												<input size="60" type="text" readonly="" value="Reasignaci&oacute;n  de Autorizador de Ordenes de Compra.">
											</td>
										</tr>
										<tr>
											<td colspan="3" class="subTitulo tituloListas" align="center">
												...
												<input type="button" name="btnCancelar" value="Cancelar" onClick="javascript: location.href='reasignarAutorizadorOrden.cfm?comprador=#form.comprador#';">
 			...
 			<cfinclude template="reasignarAutorizadorOrden-Aviso.cfm">
