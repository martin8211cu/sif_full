...
<cf_templateheader title="Punto de Venta - Consulta de Adelantos por Cliente">
	<cf_templatecss>
		
			<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="Consulta de Adelantos por Cliente">
				<cfinclude template="../../portlets/pNavegacion.cfm">
					<cfoutput>
						<form method="post" name="form1" action="ConsultaAdelCliente-sql.cfm">
								...
								<tr>
								  <td width="50%">
										<table width="100%">
											<tr>
												<td valign="top">	
													<cf_web_portlet_start border="true" titulo="Adelantos por Cliente" skin="info1">
