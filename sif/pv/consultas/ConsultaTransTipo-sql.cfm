...
<cfquery name="rsReporte" datasource="#session.DSN#">
	...
	rtrim(D.FAM01CODD) #_Cat# ' ' #_Cat# (case A.FAX01TIP when '1' then 'FACT' when '2' then 'RCxC' when '4' then 'DEV' when '9' then 'ADEL' when 'D' then 'RCxP' end) as CajaTrans
	...
	<!--- FILTRO POR ESTADO DE TRANSACCION, TERMINADA, CONTABILIZADA O ANULADA --->
	...
	order by G.Miso4217, H.Oficodigo, D.FAM01CODD, A.FAX01TIP, A.FAX01TPG, A.FAX01NTR
</cfquery>
