...
<cf_templateheader title="Punto de Venta - Consulta de Adelantos">
	<cf_templatecss>
			...
			<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="Consulta de Adelantos">
				<cfinclude template="../../portlets/pNavegacion.cfm">
					<cfoutput>
						<form method="get" name="form1" action="ConsultaAdelantos-sql.cfm">
								  ...
								  <td width="50%" valign="top">
									...
									<td width="50%" valign="top">
									  ...
									  <tr>
									    ...
									    <td><cf_sifcalendario value="" form="form1" name="FAX14FEC_ini">                                        </td>
								      </tr>
									  <tr>
                                      ...
                                      <tr>
                                        <td align="right">
											<input type="checkbox" name="chkSaldos" value="1" />
										</td>
                                        <td>Mostrar &uacute;nicamente adelantos/notas de crédito generadas con saldos</td>
                                      </tr>
