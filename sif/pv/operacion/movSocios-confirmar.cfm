...
<cf_templateheader title="#nav__SPdescripcion#">
		...
		<form action="movSocios-confirmar.cfm" name="form1" method="post" style="margin:0;" >
		<table width="100%">
			<cfset vCodCliente = 0 >
			<cfset vCliente = '' >
			<cfset vIdCliente = '' >
			...
			<cfquery name="sociodest" datasource="#session.DSN#">
				...
				<td>
					...
					<table width="100%" align="center" cellpadding="3" cellspacing="0" class="areaFiltro">
						...
						<tr>
							...
							<td width="50%" ><strong>Socio Destino:&nbsp;</strong>#trim(sociodest.SNnumero)# - #sociodest.SNnombre#<input type="hidden" name="SNcodigo" value="#form.SNcodigo#" /></td>
						</tr>
						<tr>
							<td><strong>Identificaci&oacute;n:&nbsp;</strong>#vIdCliente#</td>
							<td ><strong>Identificaci&oacute;n:&nbsp;</strong>#sociodest.SNidentificacion#</td>
						</tr>
						<tr>											
							<td>
								...
								<strong>Tipo de Transacci&oacute;n:&nbsp;</strong>#trim(rsTransacciones.CCTcodigo)# - #rsTransacciones.CCTdescripcion#<input type="hidden" name="CCTcodigo" value="#rsTransacciones.CCTcodigo#" />
							</td>
							<td width="50%"><strong>Motivo:&nbsp;</strong>#form.FABmotivo#<input type="hidden" name="FABmotivo" value="#form.FABmotivo#" /></td>
						</tr>
					</table>
					</cfoutput>
				</td>
		...
		<script language="javascript1.2" type="text/javascript">
			function funcRegresar(){
				document.form1.action = 'movSocios-filtro.cfm';
			}
			function funcAplicar(){
				document.form1.action = 'movSocios-sql.cfm';
