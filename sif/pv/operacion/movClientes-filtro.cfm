...
<cfif isdefined("form.TraeAdelantos")>
	...
	<cfif rsLista.recordcount gt 0 >
		<form action="movClientes-confirmar.cfm" name="form1" method="post" onsubmit="javascript: return validar();" style="margin:0;" >
		<tr>
			<td>
				<cfoutput>
				<table>
					<tr>
						<td nowrap="nowrap" width="1%"><strong>Cliente Destino:</strong></td>
						<td >
							<cfset idquery = 0 >
							<cfif isdefined("form.CDCcodigodest") and len(trim(form.CDCcodigoDest))>
								<cfset idquery = form.CDCcodigodest >
							</cfif>	
							<cf_sifClienteDetCorp CDCcodigo="CDCcodigoDest" form='form1'  tabindex="1" idquery="#idquery#">
						</td>
					</tr>
					<tr>											
						<td nowrap="nowrap"><strong>Motivo:</strong></td>
						<td>
							<input type="text" name="FABMotivo" 
							size="75" maxlength="80"  tabindex="1" value="<cfif isdefined('form.FABmotivo')>#form.FABmotivo#</cfif>"/>
						</td>
					</tr>
				</table>
				</cfoutput>
		...
		<tr><td>
			<table width="100%" cellpadding="1" cellspacing="0" >
				...
				<cfoutput>
				<input type="hidden" name="CDCcodigo" value="#vCodCliente#" />
				...
				<cfoutput query="rsLista" group="Moneda">
					...
					<tr>
						<td colspan="9" align="center">
							...
							<input type="button" tabindex="1"  name="btnRegresar" class="btnAnterior" value="Regresar" onclick="javascript:location.href='opmovad.cfm'" />
						</td>
		...
		<script language="javascript1.2" type="text/javascript">
			function validar(){
				var mensaje = '';
				if ( document.form1.CDCcodigoDest.value == '' ){
					mensaje = ' - El Cliente destino es requerido.';
				}
	...
	<cfelse>
		<tr><td>
			<table width="80%" align="center" cellpadding="3" cellspacing="0" align="center">
