		<table width="100%">
			...
			<cfquery name="sociodest" datasource="#session.DSN#">
				select SNidentificacion, SNnumero, SNnombre
				from SNegocios
				...
				<td>
					...
					<table width="100%" align="center" cellpadding="3" cellspacing="0" class="areaFiltro">
						...
						<tr>
							...
							<td width="50%" ><strong>Cliente Destino:&nbsp;</strong>#trim(sociodest.SNnumero)# - #sociodest.SNnombre#</td>
						</tr>
						<tr>
						...
						<tr>											
							<td>
								...
								<strong>Tipo de Transacci&oacute;n:&nbsp;</strong>#trim(rsTransacciones.CCTcodigo)# - #rsTransacciones.CCTdescripcion#
							</td>
							<td width="50%" ><strong>Motivo:&nbsp;</strong>#url.FABmotivo#</td>
						</tr>
					</table>
					</cfoutput>
				</td>
			...
			<tr>
				<td align="center" >
					<input type="button" tabindex="1"  name="btnRegresar" class="btnAnterior" value="Nuevo Traslado de NC/Adelantos" onclick="javascript:location.href='movSocios-filtro.cfm'" />
				</td>
			</tr>
			</cfif>
		</table>