...
<cf_template template="#session.sitio.template#">
	...
	<cf_templatearea name="title">
		<cf_translate key="LB_SeguimientoDelTramite">Seguimiento del tr&aacute;mite</cf_translate>
	</cf_templatearea>
	...
	<cf_templatearea name="body">
		...
		<cfquery datasource="#session.dsn#" name="responsables">
			...
			<!--- <cfif Len(hdr.RequesterId) and Len(hdr.SubjectId) AND hdr.SubjectId EQ hdr.RequesterId>
				and xap.Usucodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#hdr.SubjectId#">
			<cfelseif Len(hdr.SubjectId) AND hdr.SubjectId NEQ 0>
				and xap.Usucodigo <> <cfqueryparam cfsqltype="cf_sql_numeric" value="#hdr.SubjectId#">
			</cfif> --->
		...
		<cfquery datasource="#session.dsn#" name="rsDiasAct">
			select
				DLobs,
				Usucodigo,
				DEid,
				isNull(RHAvdisf,0) as RHAvdisf,
				DLfvigencia,
				DLffin
			from RHAcciones
			where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.Ecodigo#">
			and RHAidtramite = <cfqueryparam cfsqltype="cf_sql_numeric" value="#url.ProcessInstanceId#">
		</cfquery>
		...
		<form name="form1" method="post" action="javascript:void(0)">
			<cfoutput>
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td valign="top"><strong><cf_translate key="LB_TramiteNumero">Tr&aacute;mite N&uacute;mero</cf_translate> </strong></td>
						<td valign="top">#hdr.ProcessInstanceId#</td>
					</tr>
					<tr>
						<td valign="top"><strong><cf_translate key="LB_Empresa" XmlFile="/sif/generales.xml">Empresa</cf_translate></strong></td>
						<td valign="top">#hdr.Edescripcion#</td>
					</tr>
					<tr>
						<td width="119" valign="top"><strong><cf_translate key="LB_TipoTramite">Tipo Tr&aacute;mite</cf_translate> </strong></td>
					...
					<cfif IsDefined('subject')>
						<tr>
							<td><strong><cf_translate key="LB_Interesado">Usuario Beneficiado</cf_translate> </strong></td>
							<td>#subject.FullName#</td>
						</tr>
					</cfif>
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td valign="top" nowrap="nowrap"><strong><cf_translate key="LB_Actividad">Actividad Actual</cf_translate></strong>&nbsp;</td>
					...
					<cfif rsDiasAct.RecordCount gt 0>
						<tr>
							<td valign="top" nowrap="nowrap">
								<strong><cf_translate key="LB_DiasAct">Periodo de actividad</cf_translate></strong>&nbsp;
							</td>
							<td>De: #LSDateFormat(rsDiasAct.DLfvigencia,'dd-MM-YYYY')# a  #LSDateFormat(rsDiasAct.DLffin,'dd-MM-YYYY')# (#rsDiasAct.RHAvdisf# dias).</td>
						</tr>
					</cfif>
					<tr><td>&nbsp;</td></tr>
					<tr>
					...
					<td width="50%" valign="top">
						<cfif isdefined('url.dataitem')>
							<table width="472"  border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="4"><strong><cf_translate key="LB_ValoresParaElTramite">Valores para el tr&aacute;mite</cf_translate> </strong></td>
								</tr>
								<tr class="tituloListas">
									<td width="31">&nbsp;</td>
									<td width="179"><em><cf_translate key="LB_Dato">Dato</cf_translate></em></td>
									<td width="16">&nbsp;</td>
									<td width="246"><em><cf_translate key="LB_Valor">Valor</cf_translate></em></td>
								</tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="1">
				...
				<tr>
					...
					<td colspan="5">
						...
						<cfoutput>
						<input type="button" onClick="history.back()" value="&lt;&lt; #BTN_Regresar#" tabindex="1">
						</cfoutput>
					</td>
					<td>&nbsp;</td>
				</tr>
		...
		<cfif LvarPermitirAcciones>
			<script language="javascript">
				...
				function do_transition (ProcessInstanceId, ActivityInstanceId, TransitionId) {
					location.href = 'aprobacion-apply.cfm?from=#url.from#&ProcessInstanceId=' + escape (ProcessInstanceId) +
