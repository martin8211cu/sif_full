...
<cfquery datasource="#session.Conta.dsn#"  name="sql" >	
	...
	periodo,
	replicate('0', (2 - datalength(convert(varchar,mesini,1)))) + convert(varchar,mesini,1) + '-' + replicate('0', (2 - datalength(convert(varchar,mesfin,1)))) + convert(varchar,mesfin,1) meses, 
	(case 
...
<!--- 				<td  align="left" >#sql.nombrearc#</td>
 ...
 --->				<td  align="center">#sql.fechasolic#</td>
				...
				<td  align="center">#sql.tpoarch#</td>
...
function BJ_ARCH(archivo,llave) {
	...
	open("/cfmx/sif/Contaweb/reportes/cmn_bajarArchivo.cfm"+PARAMS,"",formato);
