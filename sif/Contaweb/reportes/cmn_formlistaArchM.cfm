		...
		<tr>
			<td   colspan="2" align="left">
				<!---<input type="button" name="Consul" value="Consultar"   onClick="javascript:Consultar();"  tabindex="1">
				 <input type="button" name="ATRAS" value="Atras" onClick="javascript:history.back()"  tabindex="1"> --->
			</td>
		</tr>
		<tr>						
...
<!--- 		<td width="10%" align="left"><strong>Usuario :</strong></td>
 ...
 --->		<td align="left" width="9%" nowrap><strong>Estatus</strong></td>
		<td width="91%" nowrap>
...
function Consultar() {
	...
	frame.src 	= "/cfmx/sif/Contaweb/reportes/cmn_formlistaArch2M.cfm" + PARAMS;
}
</script>
