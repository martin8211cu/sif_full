...
<table width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<cfif not isdefined ("form.ID_incsucursal")>
			<tr>
				<td width="40%" colspan="2" class="xl25L" >&nbsp;</td>
				<td width="30%"  colspan="2" class="xl25">Movimientos Mensuales</td>				
				<td width="30%"  colspan="2" class="xl25">Acumulado Total</td>							
			</tr>
			<tr>
				<td width="40%" colspan="2" class="xl25L" >Cuenta</td>
				<td width="15%"  colspan="1" class="xl25R" >Débitos</td>
				<td width="15%"  colspan="1" class="xl25R" >Créditos</td>				
				<td width="15%"  colspan="1" class="xl25R" >Débitos  #form.AnoInicial#</td>
				<td width="15%"  colspan="1" class="xl25R" >Créditos #form.AnoInicial#</td>
	...
	<cfloop from="1" to ="#arraylen(arrSucursales)#" index="i">
		...
		<cfloop query="rscuentas">
			<cfquery name="rsDatos" datasource="#session.Conta.dsn#">
				select 
					coalesce((
						select sum(s.CTSSAN)  <!--- Se agrego el sum ---> 
						from CGM004 s
			...
			<cfif rsDatos.SaldoInicial NEQ 0.00 or rsDatos.Debitos NEQ 0.00 or rsDatos.Creditos NEQ 0.00 or rsDatos.DebitosPer NEQ 0.00 or rsDatos.CreditosPer NEQ 0.00>					
				<tr>			
					...
					<!---
				    <cfset CALCU 	= <!---rsDatos.SaldoInicial+--->  (rsDatos.Debitos-rsDatos.Creditos)>
					<cfif CALCU GT 0>
						<td colspan="1" class="xl28R" >#LSCurrencyFormat(CALCU,'none')#</td>
						<td colspan="1" class="xl28R" >0.00</td>
					<cfelse>
						<cfif CALCU LT 0>
							<td colspan="1" class="xl28R" >0.00</td>
							<td colspan="1" class="xl28R" >#LSCurrencyFormat(-1 * CALCU,'none')#</td>
						<cfelse>
							<td colspan="1" class="xl28R" >0.00</td>
							<td colspan="1" class="xl28R" >0.00</td>
						</cfif>
					...
					<cfset CALCU = rsDatos.SaldoInicialPer + rsDatos.DebitosPer - rsDatos.CreditosPer>
					<cfif  CALCU GT 0 >
						<td colspan="1" class="xl28R" >#LSCurrencyFormat(CALCU,'none')#</td>
						<td colspan="1" class="xl28R" >#LSCurrencyFormat(0.00,'none')#</td>
					<cfelse>
						<cfif  CALCU LT 0 >
							<td colspan="1" class="xl28R" >#LSCurrencyFormat(0.00,'none')#</td>
							<td colspan="1" class="xl28R" >#LSCurrencyFormat(CALCU * -1,'none')#</td>
						<cfelse>
							<td colspan="1" class="xl28R" >#LSCurrencyFormat(0.00,'none')#</td>
							<td colspan="1" class="xl28R" >#LSCurrencyFormat(0.00,'none')#</td>
						</cfif>
				...
				<cfif CALCU GT 0>
					<cfset TOTALDEBITOS 	= TOTALDEBITOS 		+ CALCU>
				<cfelse>	
					<cfset TOTALCREDITOS 	= TOTALCREDITOS 	+ (-1 * CALCU)>
				</cfif>
				
				<cfset TOTALSALDOINIPER = TOTALSALDOINIPER 	+ rsDatos.Debitos>
				<cfset TOTALSALDOFINPER = TOTALSALDOFINPER 	+ rsDatos.Creditos>		
...
<cfset session.tempfile_xls = #tempfile# & "/tmp_" & #session.usuario# & ".xls">
