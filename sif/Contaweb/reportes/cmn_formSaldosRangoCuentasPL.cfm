...
<table width="100%" border="0">
  <tr>
    <td>
      ...
      <!---********************************************************************************* --->
      <form action="cmn_GeneraArchivo.cfm" method="post" name="form1" onSubmit="">
        <cfoutput>
			  <table width="100%" border="0">
					<td align="left" colspan="4">
						...
						<input type="button" name="LISTA" value="Ver lista" onClick="javascript:if (window.verlista) verlista() ;"  tabindex="1">
					</td>
					<!---********************************************************************************* --->
					<tr>
					...
					<tr>
					<td>
					  <input type="button" name="agregardesde" value="Cuenta desde" onClick="javascript:if (window.agregaRango) agregaRango(1) ;"  tabindex="1">
					</td> 
					<td colspan="3">
						<INPUT 	TYPE="textbox" 
								NAME="DESDE" 
					...
					<tr>
					<td>
					  <input type="button" name="agregarhasta" value="Cuenta hasta " onClick="javascript:if (window.agregaRango) agregaRango(2)"  tabindex="1">
					</td> 
					<td colspan="3">
						<INPUT 	TYPE="textbox" 
								NAME="HASTA" 
					...
					<!---********************************************************************************* --->            
					<tr>
						<td align="left" nowrap><strong>Nivel a Consultar:</strong>&nbsp;</td>
...
<!--- 						<td nowrap><input tabindex="6" type="checkbox"   ONCLICK="ACTIVACAMPOS()"  value="" name="ENLINEA"></td>					
				...
				<input type="hidden" name="ID_REPORTE" id="ID_REPORTE" value="2" tabindex="7">
			    <INPUT type="hidden" style="visibility:hidden" name="ORIGEN" value="R" tabindex="7">
				<INPUT type="hidden" style="visibility:hidden" name="REP" value="R" tabindex="7">
...
<script language="JavaScript1.2" type="text/javascript">
	...
	objform1.DESDE.required = true;
	objform1.DESDE.description="Cuenta desde";	 
	objform1.HASTA.required = true;
	objform1.HASTA.description="Cuenta hasta";	 
    ...
    _addValidator("isCUENTASLIST", validarango);
	objform1.CUENTASLIST.validateCUENTASLIST();
	/***************************************************************************************************/
	function verlista() {
	...
	function validarango(){
		document.form1.CUENTASLIST.value = document.form1.DESDE.value + ","+ document.form1.HASTA.value;
	}
	/***************************************************************************************************/
	function marcados(){
