<cfquery name="query" datasource="#session.Conta.dsn#">
	select '' as vacio
</cfquery>
<!--- Parámetros del TAG --->
<cfparam name="Attributes.Conexion" 	default="#session.Conta.dsn#" 	type="String"> 	<!--- Nombre de la conexión --->
...
<script language="JavaScript" type="text/javascript">
	...
	function doCJC_Conlis<cfoutput>#Attributes.name#</cfoutput>() {
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/Contaweb/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>.cfm"+params,250,200,650,400);
	}
	...
	function TraeDescripcion<cfoutput>#Attributes.name#</cfoutput>(dato) {
		...
		if (dato != "") {
			...
			frame.src = "/cfmx/sif/Contaweb/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>query.cfm?dato="+dato+"&form="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
