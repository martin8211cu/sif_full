			  	...
			  	<table width="100%" border="0">
			  		<tr>
						<td align="left" colspan="4">
							<input type="submit" name="Reporte" value="Consultar" onClick="" tabindex="1">
								...
								<tr>
									...
									<td nowrap colspan="3">
										<input type="hidden" name="LastOneCuenta" id="LastOneCuenta" value="ListaNon" tabindex="2">
					  					<input type="button" name="agregarCuenta" value="Agregar" onClick="javascript:if (window.fnNuevaCuentaContable) fnNuevaCuentaContable();"  tabindex="2">
									</td> 
								</tr>
							</table>
						</td>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	function sbAgregaTdInput (LprmTR, LprmClass, LprmValue, LprmType, LprmName,origen) 
	{
		...
		if (LprmValue != "") { 
			if (origen == "CU") { 
				LvarInp.value = LprmValue +"¶" + document.form1.PRIMERNIVEL.value +"¶" + document.form1.VALORPRIMERNIVEL.value;
			}
			else
