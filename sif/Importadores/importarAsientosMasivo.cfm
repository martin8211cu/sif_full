...
<cf_dbtemp name="Polizas" returnvariable="Polizas" datasource="#session.dsn#">
    <cf_dbtempcol name="EDocBase" type="varchar(20)">
    <cf_dbtempcol name="Concepto" type="int">
    <cf_dbtempcol name="Edescrip" type="varchar(100)">
    <cf_dbtempcol name="Referencia" type="varchar(25)">
    <cf_dbtempcol name="Reversible" type="char(1)">
...
<cfquery name="rsEncabezado" datasource="#Session.DSN#">
	insert #Polizas# (EDocBase,Concepto,Edescrip,Referencia,Reversible,Fecha,Periodo,Mes)
...
<cfif bcheck7 and (not bcheck8 or not bcheck9)>
