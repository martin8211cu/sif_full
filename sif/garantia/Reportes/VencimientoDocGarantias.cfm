...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Documentos de Garant&iacute;as Vencidas'>

<form name="form1" method="post" action="VencimientoDocGarantiasInfo.cfm">
