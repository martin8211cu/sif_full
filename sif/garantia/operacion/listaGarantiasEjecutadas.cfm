...
<cf_web_portlet_start border="true" titulo="#nav__SPdescripcion#" skin="#Session.Preferences.Skin#">
<cfquery name="rsGarantias" datasource="#session.dsn#">
	...
	where a.COEGEstado = 4  <!--- En ejecucion --->
