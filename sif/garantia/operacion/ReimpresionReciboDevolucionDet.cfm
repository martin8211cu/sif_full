...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
		...
		<tr>
		  <td align="center"><strong>Reimpresión del Recibo de Devolución n° #rsEncabezado.COLGnumeroControl#, de la Garantía: #rsEncabezado.COEGReciboGarantia#-#rsEncabezado.COEGVersion# &nbsp; No. Control: #rsEncabezado.COEGNumeroControl#</strong></td>
		</tr>
		<tr>
			<td>
				<table width="100%" align="left" border="1" height="25px">
					  <tr>
							<td width="40%"  align="left">HORA OFICIAL:</td>
