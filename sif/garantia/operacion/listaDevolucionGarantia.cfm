...
<cf_web_portlet_start border="true" titulo="Devolución de Garantías de Participación" skin="#Session.Preferences.Skin#">
<cfquery name="rsGarantias" datasource="#session.dsn#">
	select  d.COLGid, d.COLGEstado, a.COEGid, a.COEGReciboGarantia, case when a.COEGTipoGarantia = 1 then 'Participación' else 'Cumplimiento' end as tipoGarantia, b.Mnombre, a.COEGMontoTotal
	...
	where a.COEGEstado = 7   <!---Liberada PARA PRUEBA PRUEBA SIN PROCESO NO PONER ESTE FILTRO ESTADO---> 
		  and a.COEGVersionActiva = 1 <!--- Version activa --->
		  and d.COLGEstado = 3
...
<cfoutput>
	<script language="javascript1.2" type="text/javascript">
		function ir(){
			<cfset msgt="Se generaron las siguientes solicitudes de pago: \n">
			<cfloop list="#msg#" index="i">
				<cfset msgt&="Orden Num #i#\n">
			</cfloop>
			<cfset msgt&="Esta deben de ser aprobadas.\n">
			if(confirm("Desea ver la lista de solicitudes de pago."))
				window.location.href="../../../sif/tesoreria/Solicitudes/solicitudesManual.cfm";
		}
		ir();
	</script>
</cfoutput>
