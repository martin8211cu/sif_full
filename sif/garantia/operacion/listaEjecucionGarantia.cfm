...
<cfquery name="rsGarantias" datasource="#session.dsn#">
	select  a.COEGid, a.COEGReciboGarantia, case when a.COEGTipoGarantia = 1 then 'Participación' else 'Complimiento' end as tipoGarantia, b.Mnombre, a.COEGMontoTotal
		,a.COEGReciboGarantia, c.SNnombre, a.COEGVersion, 2 as tipoMovimiento, a.COEGPersonaEntrega, a.COEGIdentificacion, case when a.COEGContratoAsociado = 'N' then  '<img src=''/cfmx/sif/imagenes/unchecked.gif'' border=''0''>'  else  '<img src=''/cfmx/sif/imagenes/checked.gif'' border=''0''>' end as COEGContratoAsociado
	from COHEGarantia a
	...
	where a.COEGEstado = 1 <!--- Estado Vigente --->
        ...
        and a.COEGEstado not in (5) <!--- 5: Ejecutada --->
	...
	<tr>
		<td valign="top">		        
			<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" 
				...
				etiquetas="Recibo Garantía, Proveedor, Persona Entrega, Identificacion,Tipo Garantía, Versión, Monto, Moneda, Asoc Contr"
				formatos="I, S, S, S, S, I, M, S, S"
				mostrar_filtro="true"
				align="right, left, left, left, left, right, right, left, center"
				ira="ejecucionGarantia.cfm"
				checkboxes="N"
				rsMnombre="#rsMonedas#"
