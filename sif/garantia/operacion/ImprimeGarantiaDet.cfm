...
<cf_rhimprime datos="/sif/garantia/operacion/ImprimeGarantiaDet.cfm" regresar="/cfmx/sif/garantia/operacion/ReimpresionReciboDevolucion.cfm">
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
		<tr>
			<td align="right">
			  ...
			  <table width="67%" align="left" border="0" height="25px">
				  <tr>
					<td  width="40%" align="center"><strong><span class="style17"><cfoutput>#session.Enombre#</cfoutput></span></strong></td>
		...
		<tr>
		  <td align="left"><span class="style18">En esta fecha he recibido del</span> <strong><span class="style18"><cfoutput>#session.Enombre#</cfoutput></span></strong> <span class="style18">la suma de #rsEncabezado.Msimbolo##LSNumberFormat(rsEncabezado.MontoTotal, ',9.00')#</span> </td></tr>
		<tr>
		...
		<tr><td align="left"><span class="style20"><cfoutput>#session.Enombre#</cfoutput>. Tel:(506)2225-4425 ó 2283-9717 Apto. 616-2010 San José, Costa Rica</span></td></tr>
