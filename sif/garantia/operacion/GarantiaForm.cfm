...
<script language="javascript">
	...
	function funcAltaD() {
			...
			{
				if(document.form2.CODGFechaIni.value != "" && document.form2.CODGFechaFin.value != "" && fnToFecha(document.form2.CODGFechaIni.value) > fnToFecha(document.form2.CODGFechaFin.value)){
					alert(" El campo Fecha Inicial no puede ser mayor a la Fecha Final.");
					return false;
				}
