...
<cffunction name="Create"
	...
	<input type="hidden" id="myEditor" name="myEditor" value="This is my initial html text." style="display:none" /> 
	<input type="hidden" id="myEditor___Config" value="" style="display:none" /> 
	<iframe id="myEditor___Frame" 
			src="/cfmx/rh/basura/fckeditor/editor/fckeditor.html?InstanceName=myEditor&amp;Toolbar=Default" 
			width="100%" 
			height="200" 
			frameborder="0" 
			scrolling="no">
...
>
	...
	<cfparam name="this.toolbarSet" 	type="string" 	default="SIF" />
	<cfparam name="this.value" 			type="string" 	default="" />
	<cfparam name="this.basePath" 		type="string" 	default="/cfmx/sif/js/FCKeditor2_6/" />
