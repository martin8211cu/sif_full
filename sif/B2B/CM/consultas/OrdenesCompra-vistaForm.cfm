...
<cfquery name="qryLista" datasource="#session.dsn#">
	...
	<cfquery name="rsDSLinea" datasource="#session.dsn#">
	   select distinct(b.CMPid) from DOrdenCM a
	                    ...
	                    where a.Ecodigo = #Session.Ecodigo# and a.EOidorden =  <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.EOidorden#">
	</cfquery>
...
<script language="JavaScript" type="text/javascript">
	...
	function formato(id){
		popUpOrdenC('/cfmx/sif/B2B/CM/operacion/imprimeOrden.cfm?consultar=true&EOidorden='+id+'&tipoImpresion=1', 160,200,800,430 )
	}
	function facturas(id){
		popUpFact('/cfmx/sif/B2B/CM/consultas/OrdenCompra-facturas.cfm?EOidorden='+id, 160,200,800,430 )
	}
</script>
...
<table width="99%" align="center"  border="0" cellspacing="0" cellpadding="2">
	<tr>
		...
		<td class="tituloListas" nowrap="nowrap"><strong><a href="javascript:formato('#qryLista.EOidorden#');">Ver Orden de Compra</a></strong></td>
		<td class="tituloListas" nowrap="nowrap" style="padding-left:20px;"><strong><a href="javascript:facturas('#qryLista.EOidorden#');">Ver Facturas de la Orden</a></strong></td>
	</tr>	
	<tr>
...
<table width="99%" align="center"  border="0" cellspacing="0" cellpadding="2">
	...
	<cfoutput query="qryLista"><!----group="EOidorden"> --->
		...
		<tr class=<cfif (currentRow MOD 2)>"listaNon"<cfelse>"listaPar"</cfif>>
			...
			<td colspan="10" width="5%" style="padding-left: 5px; border-bottom: 1px solid black;">#DOalterna#&nbsp;</td>
		</tr>
		<tr class=<cfif (currentRow MOD 2)>"listaNon"<cfelse>"listaPar"</cfif>>
			<td style="padding-right: 5px; border-bottom: 1px solid black;">&nbsp;</td>
			<td style="padding-right: 5px; border-bottom: 1px solid black;"><strong>Observaciones:&nbsp;</strong></td>
			<td colspan="10" width="5%" style="padding-left: 5px; border-bottom: 1px solid black;">#DOobservaciones#&nbsp;</td>
		</tr>
