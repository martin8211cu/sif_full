...
<cfelse>
	...
	<cfif isdefined("rsTipoTran") and rsTipoTran.cantidad eq 1>
		<cfquery name="rsDoc" datasource="#session.DSN#">
			...
			where ma.Ecodigo = #session.Ecodigo#
			  ...
			  and ma.SNcodigo   = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.B2B.SNcodigo#">
		</cfquery>
	...
	<cfelse>
		<cfquery name="rsDoc" datasource="#session.DSN#">
			...
			where d.SNcodigo = #session.B2B.SNcodigo#
		...
		<cfquery name="rsRetencion" datasource="#session.dsn#">
			...
			where e.SNcodigo =  <cfqueryparam cfsqltype="cf_sql_integer" value="#session.B2B.SNcodigo#">
					and e.Ddocumento =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsDoc.Ddocumento#">
					and e.CPTcodigo =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsDoc.CPTcodigo#">
	...
	<cfquery name="rsSeguimiento" datasource="#session.dsn#">
		...
		where a.SNcodigo       = <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.B2B.SNcodigo#">
	...
	<cfif isdefined("rsTipoTran") and rsTipoTran.cantidad eq 1>
		...
		<cfquery name="rsHistorialPagos" datasource="#session.DSN#">
			...
			where bm.Ecodigo = #session.Ecodigo#
			  ...
			  and bm.SNcodigo   = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.B2B.SNcodigo#">
			...
			<table width="100%" cellpadding="2" cellspacing="0" align="center">
				<tr>
					<td valign="top" width="50%">
						<cfset regresar = "/cfmx/sif/B2B/CxP/consultas/RFacturasCP2.cfm"> 
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								...
								<td colspan="8" align="right">
									...
									<cf_rhimprime datos="/sif/B2B/CxP/consultas/RFacturasCP2-DetalleDoc.cfm" paramsuri="#params#">
