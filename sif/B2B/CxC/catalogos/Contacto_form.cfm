...
<cfoutput>
	<form name="form1" action="Contacto_sql.cfm" method="post">
		...
		<input name="SNcodigo" type="hidden" tabindex="-1" value="#session.B2B.SNcodigo#">	
			...
			<tr>
				...
				<td>
					...
					<cf_conlis
						...
						filtro="a.SNcodigo = #session.B2B.SNcodigo#
		...
		<cf_botones modo="#modo#" tabindex="1" exclude="Baja,Cambio,Nuevo" include="Cerrar">
	</form>
</cfoutput>
