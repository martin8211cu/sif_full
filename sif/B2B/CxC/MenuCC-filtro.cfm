		...
		<form name="formfiltro" action="MenuCC.cfm" method="post" style="margin:0;">
			...
			<tr>
				...
				<td class="cfmenu_titulo">
					<cfsavecontent variable="l1tooltiptext">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									El Filtro de oficina es el único que afecta la lista y además los gráficos. Los demás solo afectan la lista.
								</td>
							</tr>
						</table>
					</cfsavecontent>
				...
				<cfsavecontent variable="Filtro_Moneda">
					<td class="cfmenu_titulo">Moneda&nbsp;:&nbsp;</td>
					<td class="cfmenu_titulo">
				...
				<cfsavecontent variable="Filtro_Socio">
					<td class="cfmenu_titulo">Socio&nbsp;:&nbsp;</td>
					<td class="cfmenu_titulo">
				...
				<cfsavecontent variable="Filtro_Documento">
					<td class="cfmenu_titulo">Documento&nbsp;:&nbsp;</td>
					<td class="cfmenu_titulo">
						<table width="1%"  border="0" cellspacing="0" cellpadding="0">
						  <tr>
