...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td rowspan="2" valign="top" class="style1"><textarea name="sql" id="sql" rows="18" cols="40" wrap="off" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;width:350px">#form.sql#</textarea></td>
    <td valign="top">&nbsp;</td>
