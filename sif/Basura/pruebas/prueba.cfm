...
<cf_dump var="#dummy#">
<cfif dummy ge 2> <cfthrow message="fue horrible"> </cfif>
...
<script language="JavaScript" type="text/javascript">
	...
	function eclk(arbol_pos){<!--- event: Click --->
		location.href="pruebacarga.cfm?ARBOL_POS="+arbol_pos+"<cfoutput>#JSStringFormat(QueryString_ARBOL)#</cfoutput>";
	}
</script>
...
<table cellpadding="0" cellspacing="1" border="0" width="100%">
	...
	<cfloop query="ARBOL">
		<tr valign="middle"	
			<cfif ARBOL.CCcodigo is url.ARBOL_POS> class='ar1'
			<cfelse>class='ar2' onMouseOver="eovr(this)" onMouseOut="eout(this)" onClick="eclk('#ARBOL.CCid#')"
			</cfif> >
			<td nowrap>
