...
<form action="ceptos.cfm" method="post" name="form1" onSubmit="return validar();">
	<table width="67%" height="75%" align="center" cellpadding="2" cellspacing="0">
		<tr><td colspan="2">&nbsp;</td></tr>
		<tr> 
			<td align="right" nowrap>C&oacute;digo:&nbsp;</td>
			<td>
				<input name="CCcodigo" type="text" value="<cfif modo neq "ALTA" >#trim(rsCConceptos.CCcodigo)#</cfif>" size="10" maxlength="5"  alt="El Código del Concepto" onBlur="javascript:validaCodigo(this.value);" onFocus="this.select();"> 
				<cfif modo neq 'ALTA'>
