...
// *************************************************************
	...
	int marginLft = 0;				// margen izquierdo
	int marginRgt = 0;				// margen derecho
...
// *************************************************************
	...
	String sql_sp =  " select FMT001.FMT01ANC, FMT001.FMT01LAR, FMT001.FMT01TOP, FMT001.FMT01BOT, FMT000.FMT01SQL " +
		   ...
		   " where FMT001.Ecodigo=" + Ecodigo + " and FMT001.FMT01COD='"+FMT01COD+"'" ;
...
// *************************************************************
	...
	int i = 1;
	while( rs_img.next() ){
		String imagen = "\"" + path + Ecodigo + "_" + FMT01COD +  "_" + String.valueOf(i) + ".gif" + "\"";
