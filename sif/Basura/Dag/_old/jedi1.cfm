		  ...
		  <tr>
			...
			<td width="33%" valign="top">
				...
				<table width="100%"  align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="##CCCCCC">
				  <cfoutput>
				  <tr>
					<td width="0" height="30" bgcolor="##666666" style="color: ##FFFFFF; font-weight: bold;" onMouseOver="javascript:getfocus(#col#,#currentrow#);" onMouseOut="javascript:;">#Name#</td>
				  </tr>
				  <tr>
					<td>
						<div id="xyz#currentrow#" style="display:<cfif not show>none</cfif>;">
						<cfset show = false>
...
<script language="javascript1.2" type="text/javascript">
	function getfocus(c,l){
		<cfset col = 0>
		<cfoutput query="rsMenues" group="category">
			<cfset col = col + 1>
			<cfoutput>
			if (c==#col#)
			losefocus(#currentrow#);
			</cfoutput>
		</cfoutput>		
		_xyz = document.getElementById('xyz'+l);			
		_xyz.style.display = '';
	}
	function losefocus(l){
		_xyz = document.getElementById('xyz'+l);			
		_xyz.style.display = 'none';
	}
</script>