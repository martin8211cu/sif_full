...
<cfinclude template="luke-options-v2.cfm">
<table width="150"  border="0" cellspacing="2" cellpadding="0">
	<cfoutput query="Menues" group="Category">
		<tr>
		  <td class="smenu1"><cfif Len(Link)><a href="#Link#" class="smenu1"></cfif>#Category#<cfif Len(Link)></a>
		  </cfif></td>
		</tr>
		...
		<cfoutput>
			...
			<tr>
				<td class="smenu<cfif CurrentPage eq CurrentLink>5<cfelse>4</cfif>"><cfif Len(Link)><a a href="#Link#" class="smenu<cfif CurrentPage eq CurrentLink>5<cfelse>4</cfif>"></cfif><li>#Name#</li><cfif Len(Link)></a></cfif></td>
			</tr>
			</cfif>
		</cfoutput>
		</cfif>
	...
	<tr>
	<td><img src="../../imagenes/bottom.gif" width="100%" height="19"></td>
	</tr>
</table>