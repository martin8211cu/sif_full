...
<script language="javascript" type="text/javascript">
	function funcTraePersona#Attributes.index#(){
		if (document.#Attributes.form#.identificacion_persona#Attributes.index#.value!=""){
			window.id_persona#Attributes.index# = document.#Attributes.form#.id_persona#Attributes.index#;
			...
			fr.src = "/cfmx/home/tramites/vistas/persona-query.cfm?index=#Attributes.index#&identificacion_persona="+document.#Attributes.form#.identificacion_persona#Attributes.index#.value+"&id_tipoident="+document.#Attributes.form#.id_tipoident#Attributes.index#.value;
		} else {
			funcLimpiarPersona#Attributes.index#();
		}
	}
	function funcLimpiarPersona#Attributes.index#(){
		document.#Attributes.form#.id_persona#Attributes.index#.value="";
	...
	function doConlisPersona#Attributes.index#(){
		...
		var nuevo = window.open('/cfmx/home/tramites/vistas/persona-conlis.cfm?index=#Attributes.index#&form=#Attributes.form#&id_tipoident='+document.#Attributes.form#.id_tipoident#Attributes.index#.value,'ListaPersonas','menu=no,scrollbars=yes,top='+top+',left='+left+',width='+width+',height='+height);
		nuevo.focus();
	}
</script>
<table width="1%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<td>
		...
		<input type="hidden" name="id_persona#Attributes.index#" value="#Lvar_id_persona#">
		...
		value="#Lvar_identificacion_persona#">
	</td>
	<td>
