...
<cfif isdefined('form.btnConsultar') and form.btnConsultar NEQ ''>
	...
	<cfif isdefined("Form.CRMEid_filtro") and Len(Trim(Form.CRMEid_filtro)) NEQ 0>
		<cfset filtro = filtro & " and dd.CRMEid=" & #Form.CRMEid_filtro#>
	...
	<!--- <cf_sifHTML2Word Titulo="Donaciones por Entidad"> ---> 
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td align="center" class="tituloAlterno">
				<cfif isdefined('rsEntidad') and rsEntidad.recordCount GT 0>
					Donaciones de <cfoutput>#rsEntidad.Nombre_Completo#</cfoutput>
				<cfelse>
					Donaciones Emitidas por Entidad 
				</cfif>
			</td>
		  </tr>
		  <tr>
				...
				<cfinvoke 
				 ...
				 returnvariable="pListaCRMRet">
					...
					<cfinvokeargument name="columnas" value="
						...
						CRMDmonto"/>
					<cfinvokeargument name="desplegar" value="CRMEnombre,CRMDDdescripcion,CRMEDfecha,CRMDDtipopago,CRMDmonto"/>
					<cfinvokeargument name="etiquetas" value="Entidad beneficiada,Detalle Donaci&oacute;n,Fecha,Tipo Pago, Monto"/>
 					<cfinvokeargument name="formatos" value="T,T,D,T,M"/> 
					...
					<cfinvokeargument name="Cortes" value="CRMEDdescripcion"/>	
