<form name="formRepDonacEntidad" method="post" action="DonacionesEntidadPlan.cfm" style="margin: 0" onSubmit="return validar(this);">
  ...
  <tr>
    ...
    <td>
		<cfif isdefined('form.fechaini_filtro') and form.fechaini_filtro NEQ "">
			<cf_sifcalendario form="formRepDonacEntidad" name="fechaini_filtro" value="#form.fechaini_filtro#">
		<cfelse>
			<cf_sifcalendario form="formRepDonacEntidad" name="fechaini_filtro">
		</cfif>	
	</td>
    <td>
		<cfif isdefined('form.fechafin_filtro') and form.fechafin_filtro NEQ "">
			<cf_sifcalendario form="formRepDonacEntidad" name="fechafin_filtro" value="#form.fechafin_filtro#">
		<cfelse>
			<cf_sifcalendario form="formRepDonacEntidad" name="fechafin_filtro">
		</cfif>	
	</td>
  </tr> 
</table>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	objForm = new qForm("formRepDonacEntidad");
