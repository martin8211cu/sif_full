...
returnvariable="LB_Titulo" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Lote" default="Lote" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Lote" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Descripcion" default="Descripci&oacute;n" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Descripcion" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Fecha" default="Fecha" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Fecha" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Periodo" default="Peri&oacute;do" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Periodo" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Mes" default="Mes" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Mes" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Debitos" default="D&eacute;bitos" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Debitos" xmlfile="DocContablesImportacion-lista.xml"/>
<cfinvoke  key="LB_Creditos" default="Cr&eacute;ditos" component="sif.Componentes.Translate" method="Translate"
returnvariable="LB_Creditos" xmlfile="DocContablesImportacion-lista.xml"/>
		...
		<cfoutput>
			...
			<table width="100%"  border="0" cellspacing="2" cellpadding="0">
				<tr>
					...
					<td align="right" nowrap><strong><cf_translate key=LB_FechaIni>Fecha Desde</cf_translate>:&nbsp;</strong></td>
					<td align="left" nowrap>
						<cf_sifcalendario form="filtros" value="#LSDateFormat(form.fechadesde,'dd/mm/yyyy')#" name="fechadesde">
					</td>
					<td align="right" nowrap><strong><cf_translate key=LB_FechaFin>Fecha Hasta</cf_translate>:&nbsp;</strong></td>
					<td align="left" nowrap>
						<cf_sifcalendario form="filtros" value="#LSDateFormat(form.fechahasta,'dd/mm/yyyy')#" name="fechahasta">
					</td>
				</tr>
				<tr>
					<td align="right" nowrap><strong><cf_translate key=LB_Periodo>Periodo</cf_translate>:&nbsp;</strong> </td>
					<td>
						<select name="periodo">
							<option value="-1"><cf_translate key=LB_Todos>Todos</cf_translate></option>
							<cfloop query="rsPer">
					...
					<td align="right" nowrap><strong><cf_translate key=LB_Mes>Mes</cf_translate>:&nbsp;</strong> </td>
					<td align="left" nowrap>
						<select name="mes">
							<option value="-1"><cf_translate key=LB_Todos>Todos</cf_translate></option>				  
					...
					<td align="right" nowrap><strong><cf_translate key=LB_Ver>Ver</cf_translate>:&nbsp;</strong> </td>
					<td align="left" nowrap>
				...
				<tr>
					...
					<td>
						<select name="Usucodigo">
							<option value="-11"><cf_translate key=LB_Todos>Todos</cf_translate></option>
				...
				<tr>
					<cfif rsLista.recordcount GT 0>
						<td align="center" nowrap><input name="chkTodos" type="checkbox" value="" border="0" onClick="javascript:Marcar(this);"><strong><cf_translate key=LB_Seleccionartodos>Seleccionar Todos</cf_translate></strong></td>
					<cfelse>
						<td>&nbsp;</td>
					</cfif>
					<td colspan="5" align="center"><input type="submit" name="bFiltrar" value="#BTN_Filtrar#">
						<input type="submit" name="bLimpiar" value="#BTN_Limpiar#" onclick=" return funcLimpiar();">
					</td>
				</tr>
			</table>
			</form>
		...
		<form name="form1" method="post" action="DocContablesImportacion.cfm" style="margin:0;">
			...
			<cfinvoke 
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="etiquetas" value="#LB_Lote#, #LB_Descripcion#, #LB_Fecha#, #LB_Periodo#, #LB_Mes#, #LB_Debitos#, #LB_Creditos#, &nbsp;"/>
