...
<cf_navegacion name="Form.Oorigen" default="">
...
<cfif isdefined("Form.AgregarE")>
	<cftransaction>
		<cfquery name="rsAsiento" datasource="#Session.DSN#">
			insert into EContablesImportacion (Ecodigo, Cconcepto, Eperiodo, Emes, Efecha, Edescripcion, Edocbase, Ereferencia, ECIreversible, BMfalta, BMUsucodigo,Oorigen)
			values (
				 #session.Ecodigo# ,
				<cfqueryparam cfsqltype="cf_sql_integer" value="#Form.Cconcepto#">, 
				<cfqueryparam cfsqltype="cf_sql_integer" value="#Form.Eperiodo#">, 
				...
				<cfqueryparam cfsqltype="cf_sql_date" value="#Now()#">,
				 #Session.Usucodigo# ,
                 <cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#Form.Oorigen#" voidnull>
			)
	...
	<cftransaction>
		<cfquery name="rsAsiento" datasource="#Session.DSN#">
			update EContablesImportacion set
                ...
                Oorigen 	 = <cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#Form.Oorigen#" voidnull>,
				ECIreversible= 
				<cfif isdefined("form.ChkReversible") and len(trim(form.ChkReversible))>
				<cfqueryparam cfsqltype="cf_sql_integer" value="#form.ChkReversible#">
				<cfelse>
...
<cfelseif isdefined("Form.btnVerificarCtas")>
		<cfinvoke component="sif.Componentes.CG_AplicaImportacionAsiento" method="CG_VerficaImportacionAsiento" returnvariable="LvarMSG">
