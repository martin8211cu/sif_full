<cfinvoke  key="BTN_VerificarCtas" default="Verificar Ctas" component="sif.Componentes.Translate" method="Translate"
returnvariable="BTN_VerificarCtas" xmlfile="DocContablesImportacion-form.xml"/>
<cfinvoke  key="BTN_Balancear" default="Balancear" component="sif.Componentes.Translate" method="Translate"
returnvariable="BTN_Balancear" xmlfile="DocContablesImportacion-form.xml"/>
<cfinvoke  key="BTN_IraLista" default="Ir a Lista" component="sif.Componentes.Translate" method="Translate"
returnvariable="BTN_IraLista" xmlfile="DocContablesImportacion-form.xml"/>
...
<cfinvoke  key="BTN_Importar" default="Importar" component="sif.Componentes.Translate" method="Translate"
returnvariable="BTN_Importar" xmlfile="/sif/generales.xml"/>
...
<cfinvoke  key="BTN_Consultar" default="BTN_Consultar" component="sif.Componentes.Translate" method="Translate"
...
returnvariable="BTN_Cambiar" xmlfile="/sif/generales.xml"/>
		...
		<cfquery name="rsBalanceO" datasource="#Session.DSN#">
			...
			select * from (
						...
						and a.Ocodigo in(SELECT Ocodigo
									...
									WHERE ISNUMERIC(o.Oficodigo)=1
									AND Ecodigo=#Session.Ecodigo#)
						group by Ecodigo, Ocodigo,Mcodigo
						)tt
			Order by  CODNEW asc
...
<cfif modo NEQ "ALTA">
	<cfquery name="rsOficinasDet" datasource="#Session.DSN#">
		SELECT 0 as CODNEW,o.Ecodigo, o.Ocodigo,
		''+cast(o.Oficodigo as varchar(4))+' - '+ o.Odescripcion as Odescripcion
		FROM Oficinas o
		WHERE ISNUMERIC(o.Oficodigo)<>1
		and Ecodigo=#session.Ecodigo# 
		union
		select CODNEW,tt.Ecodigo, tt.Ocodigo,
		''+cast(tt.Oficodigo as varchar(4))+' - '+ tt.Odescripcion as Odescripcion
		from(
		SELECT RIGHT('0000' + Ltrim(Rtrim(Oficodigo)),4) as CODNEW,*
		FROM Oficinas  
		WHERE ISNUMERIC(Oficodigo)=1
		and Ecodigo=#session.Ecodigo# ) tt
		ORder by CODNEW asc
	</cfquery>
...
<cfset PolizaMon3 = t.Translate('PolizaMon3','La Póliza no está balanceada para la Moneda')>
...
<table width="94%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <tr>
		<!---►►Descripción◄◄--->
        <td nowrap align="right"><cf_translate key="descripcion">Descripción</cf_translate>:&nbsp;</td>
        <td colspan="1">
        	<input name="Edescripcion" type="text" tabindex="1" value="<cfif modo NEQ "ALTA"><cfoutput>#rsDocumento.Edescripcion#</cfoutput></cfif>" size="30" maxlength="100" onFocus="javascript:this.select();">
        </td>
		<!---►►Origen◄◄--->
            <cfparam name="rsDocumento.Oorigen" default="">
        <td nowrap align="right"><cf_translate key="descripcion">Origen</cf_translate>:&nbsp;</td>
        <td align="left">
        	<input name="Oorigen" type="text" tabindex="1" size="5" value="<cfoutput>#rsDocumento.Oorigen#</cfoutput>" maxlength="4"/>
        </td>
        <!---►►Reversible◄◄--->
        	<cfparam name="rsDocumento.ECIreversible" default="0">
        <td align="right">
        	<input name="ChkReversible" type="checkbox" tabindex="1" value="1" <cfif isdefined("Intercompany") and Intercompany>disabled<cfelseif rsDocumento.ECIreversible eq 1>checked </cfif>>
        </td>
        <td align="left">
         	Reversible
        </td>
	...
	<td colspan="12" align="center">
		<cfif not isDefined("Form.NuevoE") and modo NEQ "ALTA">
			<cfif modoDet EQ "ALTA">
				<cfoutput><input name="AgregarD" type="submit" value="#BTN_Agregar# Lin."  tabindex="2" class="btnGuardar" onClick="javascript: return valida('AgregarD');"></cfoutput>
			<cfelse>
				<cfif not isdefined("rsLinea.Ddescripcion") OR rsLinea.Ddescripcion NEQ 'Ajuste para balancear diferencias en tipos de cambio'>
				<cfoutput><input name="CambiarD" type="submit" value="#BTN_Cambiar# Lin."  tabindex="2" class="btnGuardar" onClick="javascript:return valida('CambiarD');" ></cfoutput>
				</cfif>
				<cfoutput><input name="NuevoD"   type="submit" value="#BTN_Nuevo# Lin."    tabindex="2" class="btnNuevo"></cfoutput>
			</cfif>
			&nbsp;
		</cfif>
		<cfif modo EQ "ALTA">
			<cfoutput><input type="submit" name="AgregarE" value="#BTN_Agregar# Doc."    tabindex="2" class="btnGuardar"></cfoutput>
		<cfelse>
			<cfoutput><input type="submit" name="CambiarE" value="#BTN_Modificar# Doc."  tabindex="2" class="btnGuardar" onClick="javascript:return valida('CambiarE');"></cfoutput>
			<cfif rsCheck1.CantidadRegistros GT 0>
			<cfoutput><input type="submit" name="Aplicar"  value="#BTN_Aplicar#" 	     tabindex="2" class="btnAplicar" onClick="javascript:return Postear();" ></cfoutput>
			</cfif>
			<cfoutput><input type="button" name="ConsultarDoc"  	 value="#BTN_Consultar#"		tabindex="2"  class="btnNormal"  onClick="javascript:location.href='CDIMPContables.cfm?ECIid=<cfoutput>#Form.ECIid#</cfoutput>&regresar=<cfoutput>#URLEncodedFormat('DocContablesImportacion.cfm?ECIid=#Form.ECIid#')#</cfoutput>'"></cfoutput>
			<cfoutput><input type="submit" name="NuevoE" 			 value="#BTN_Nuevo# Doc." 	tabindex="2"  class="btnNuevo"   onClick="javascript: deshabilitarValidacion();"></cfoutput>
			<cfoutput><input type="submit" name="btnImportar" 	 value="#BTN_Importar#" 		tabindex="2"  class="btnNormal"  onClick="javascript: deshabilitarValidacion();"></cfoutput>
			<cfoutput><input type="button" name="btnVerificarCtas" value="#BTN_VerificarCtas#" tabindex="2"  class="btnNormal"  onClick="javascript: doConlisDocsContablesImport();" ></cfoutput>
		</cfif>
		<cfif isdefined("rsBalanceT") and isdefined("rsBalanceOfic") and rsBalanceT.DebitosL EQ rsBalanceT.CreditosL and rsBalanceOfic.Recordcount NEQ 0 and (isdefined("modoDet") and modoDet EQ "ALTA")>
			<cfoutput><input type="submit" name="btnBalanceaOfic" value="#BTN_Balancear#"   tabindex="2" class="btnNormal"    onClick="javascript: deshabilitarValidacion();" alt="Balancea por Oficina" ></cfoutput>
		</cfif>
		    <cfoutput><input type="button" name="ListaE" 		    value="#BTN_IraLista#"  tabindex="2" class="btnAnterior"  onClick="javascript:Lista();"></cfoutput>
		<cfif modo EQ "CAMBIO">
			<cfoutput><input type="submit" name="BorrarE" 		value="#BTN_Borrar# Doc." tabindex="2" class="btnEliminar"  onClick="javascript: document.form1.Ccuenta.value = '-1'; document.form1.CFcuenta.value = '-1'; document.form1.Ddescripcion.value = '.'; if (confirm('¿Desea borrar este documento?')) return true; else return false;"></cfoutput>
		</cfif>
	</td>
	</tr>
</table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr>
			...
			<td align="center" colspan="9">
				<input type="submit" name="btnBuscar" value="#BTN_Buscar#" tabindex="3" class="btnFiltrar">
			</td>
		  </tr>
		  <tr>
		  <td colspan="12">
			...
			if (confirm('¿Desea aplicar este documento?')) {
				...
				<cfloop query="rsBalanceO">
					<cfif rsBalanceO.Creditos - rsBalanceO.Debitos NEQ 0 or abs(rsBalanceO.CreditosL - rsBalanceO.DebitosL) GT rsBalanceO.HolguraL>
						<cfif Intercompany>
							alert('<cfoutput>#PolizaMon3# #rsBalanceO.Mnombre#</cfoutput>');
						<cfelse>
							alert('<cfoutput>#PolizaMon3# #rsBalanceO.Mnombre#</cfoutput> en la Oficina <cfoutput>#rsBalanceO.Odescripcion#!</cfoutput>');
						</cfif>
						correcto = false;
						<cfbreak>
					</cfif>
