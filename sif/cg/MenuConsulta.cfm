...
<cfsavecontent variable="LEstadoResultadosHTML">
    ...
    returnvariable="LB_EstadoDeResultados" xmlfile="MenuConsulta.xml"/>
    <cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Miles" default="en miles" 
    returnvariable="LB_Miles" xmlfile="MenuConsulta.xml"/>
    
    <form action="/cfmx/sif/cg/MenuCG.cfm" method="post" name="sql">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="100%" bgcolor="gainsboro" align="center">
                <b><font size="2"><cfoutput>#LB_EstadoDeResultados#</cfoutput></font></b>
            </td>
        </tr>
        <cfif Factor NEQ 1>
            <tr>
                <td width="100%" bgcolor="gainsboro" align="center">
                    <b><font size="2">(<cfoutput>#LB_Miles#</cfoutput>)</font></b>
                </td>
            </tr>
        </cfif>
    </table>
    ...
    <cfif isdefined('rs_CContables') and rs_CContables.recordCount NEQ 0>
        <cfinclude template="formMenuConsulta.cfm">
    </cfif>
</cfsavecontent>
