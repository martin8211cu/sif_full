...
<cfset QuerySetCell(Menues,"Description","Contabilidad General",Menues.RecordCount)>
<cfset QuerySetCell(Menues,"Link","/cfmx/sif/cg/MenuCG.cfm?Sub26",Menues.RecordCount)>
<cfset QuerySetCell(Menues,"Category","Contabilidad General",Menues.RecordCount)>
