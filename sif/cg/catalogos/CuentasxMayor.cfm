...
-->
	...
	<cf_templateheader title="Cat&aacute;logo al Plan de Cuentas - Valores por Cuentas Mayor">
	<cf_templatecss>
	<cf_web_portlet_start border="true" skin="#session.preferences.skin#" titulo="Valores por Cuentas Mayor">
		<table width="100%" align="center" cellpadding="0" cellspacing="0">
			<tr><td colspan="3"><cfinclude template="../../portlets/pNavegacion.cfm"></td></tr>
				...
				<!--- ******* Query utilizado para desplegar los datos del encabezado ************--->
                    ...
                    <cf_dbfunction name='concat' args="'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + c.PCEcodigo" returnvariable='LvarPCEcodigo' delimiters='+'>
					<cfquery name="lista" datasource="#session.DSN#">
						select '#Encabezado.PCEcatid#' as PCEcatid, a.PCDcatid, a.Ecodigo, rtrim(a.Cmayor) as Cmayor, 
							  '#LvarPCEcodigo#' as CatalogoxMaycod, c.PCEdescripcion as CatalogoxMaydes #LvarIncVal#
						from PCDCatalogoPorMayor a
					...
					<cfinvoke
						...
						<cfinvokeargument name="desplegar" value="CMayor, CatalogoxMaydes "/>
						<cfinvokeargument name="etiquetas" value="Cuenta, &nbsp;&nbsp;&nbsp;&nbsp;Descripci&oacute;n &nbsp;"/>
						<cfinvokeargument name="formatos" value="V,V "/>
						<cfinvokeargument name="align" value="left, left"/>
						<cfinvokeargument name="ajustar" value="S"/>
						<cfinvokeargument name="irA" value="CuentasxMayor.cfm"/>
						<cfinvokeargument name="keys" value="Ecodigo,Cmayor"/>
		    	...
		    	<td width="38%" valign="top">
					<cfinclude template="CuentasxMayor-form.cfm">
				</td>
			</tr>		
		</table>
	<cf_web_portlet_end>
