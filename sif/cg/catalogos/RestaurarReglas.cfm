...
<cfset LvarDias = 60>
	...
	<cf_templateheader title="Contabilidad General">
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="Borrado y Restauraci&oacute;n de Reglas">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					<td>
						...
						<form method="post" name="form1" action="RestaurarReglas.cfm">
						<table width="60%" class="ayuda" align="center">
							<tr>
								<td align="center">
									<p align="center">
					...
					<table width="100%"  border="0" cellspacing="5" cellpadding="0">						   
					  <tr valign="middle">
                      	<td colspan="2" align="center">
                        	<table class="ayuda" width="50%" border="0" cellpadding="0" cellspacing="5">
                            	<tr>
                                	<td>
										<p style="text-align:justify">
                                        	Las reglas presentes en esta lista, disponen de un m&aacute;ximo de <b><cfoutput>#LvarDias#</cfoutput> d&iacute;as</b>
                                            posterior a la fecha en que fueron eliminadas.
                                            Una vez concluido este tiempo ser&aacute;n eliminadas autom&aacute;ticamente mediante una tarea programada. 
                                        </p>
                                    </td>
                                </tr>
                            </table>
