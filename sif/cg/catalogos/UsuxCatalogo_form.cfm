...
<tr> 		
	<td colspan="4" valign="top">
		...
		<cfoutput>
		<form method="post" name="form1" action="UsuxCatalogo_sql.cfm">
			...
			<tr>
				<td colspan="4" align="center">
					...
					<input type="button" name="btnRegresar" value="Regresar" onClick="javascript:document.location='Catalogos.cfm?PCEcatid=<cfoutput>#Form.PCEcatid#</cfoutput>';" tabindex="2">
				</td>
			</tr>
			</table>			
