...
<!---Mini Reporte--->
	...
	<cfsavecontent variable="VR2">
		...
		value="999" 
		enteros = "3" decimales = "6" formatvalue="false"
		>
	</cfsavecontent>
		<cf_dbfunction name="OP_concat"	returnvariable="_Cat">
		<cf_dbfunction name="to_char" args="o.Ocodigo" returnvariable="LvarOcodigo">
        <cf_dbfunction name='to_char_float' args="coalesce(CGCporcentaje, 0)" dec="6" delimiters=';' returnvariable='LvarCGCporcentaje'>
		
		<cfset VR2	= replace(VR2,"'","''","ALL")>
		<cfset VR2	= replace(VR2,"AAAA","'  #_Cat##LvarOcodigo##_Cat#  '","ALL")>
		<cfset VR2	= replace(VR2,"999","' #_Cat##LvarCGCporcentaje##_Cat# '","ALL")>

	<cfsavecontent variable="oco">
	<a href="javascript: doConlis2(cod);">
					cod
	</a>	
	</cfsavecontent>
		<cfset oco	= replace(oco,"'","''","ALL")>
		<cfset oco	= replace(oco,"cod","' #_Cat#o.Oficodigo#_Cat#  '","ALL")>
