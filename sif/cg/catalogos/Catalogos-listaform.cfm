...
<cfoutput>
			...
			<td nowrap colspan="4" align="center">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="areaFiltro">
				  <tr>
					...
					<!---
					<td width="13%" align="center"><strong>Valores por empresa</strong></td>
					<td width="13%" align="center"><strong>Referenciado</strong></td>
					<td width="5%" align="center"><strong>Activo</strong></td>
					--->
				  </tr>
				  <tr>
					<td>
	...
	<!---
					<td align="center"><input name="ckPCEempresa" type="checkbox" class="areaFiltro" id="ckPCEempresa" value="PCEempresa" <cfif isdefined('form.ckPCEempresa')> checked</cfif>>
				</td>
					<td align="center"><input name="ckPCEref" type="checkbox" class="areaFiltro" id="ckPCEref" value="PCEref" <cfif isdefined('form.ckPCEref')> checked</cfif>></td>
					<td align="center"><input name="ckPCEactivo" type="checkbox" class="areaFiltro" id="ckPCEactivo" value="PCEactivo"  <cfif isdefined('form.ckPCEactivo')> checked</cfif>></td>
	--->
	...
	<!---
		<cfif isdefined('form.ckPCEempresa') and form.ckPCEempresa NEQ ''>
			<cfset filtro = filtro & " and PCEempresa = 1">
		<cfelse>
			<cfset filtro = filtro & " and PCEempresa = 0">
		</cfif>
		<cfif isdefined('form.ckPCEref') and form.ckPCEref NEQ ''>
			<cfset filtro = filtro & " and PCEref = 1">
		<cfelse>
			<cfset filtro = filtro & " and PCEref = 0">
		</cfif>
		<cfif isdefined('form.ckPCEactivo') and form.ckPCEactivo NEQ ''>
			<cfset filtro = filtro & " and PCEactivo = 1">
		<cfelse>
			<cfset filtro = filtro & " and PCEactivo = 0">
		</cfif>
	--->
			...
			<cfinvoke
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="columnas" value="PCEcatid, PCEcodigo, PCEdescripcion, PCElongitud,
															...
															case PCEactivo when 1 then '#img_checked#' else '#img_unchecked#' end as PCEactivo "/>
				...
				<cfinvokeargument name="filtro" value="CEcodigo = #Session.CEcodigo# #filtro# order by PCEcodigo"/>
