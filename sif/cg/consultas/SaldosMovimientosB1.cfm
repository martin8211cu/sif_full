...
<cfif isdefined("url.Ccuenta1") and len(trim(url.Ccuenta1)) and not isdefined("form.Ccuenta1")>
	<cfset form.Ccuenta1 = url.Ccuenta1>
</cfif>
<cfif isdefined("url.Ccuenta2") and len(trim(url.Ccuenta2)) and not isdefined("form.Ccuenta2")>
...
<cfif isdefined("url.Tabla") and len(trim(url.Tabla)) and not isdefined("form.Tabla")>
		...
		<tr>
			<cfoutput>
					<td align="right" width="6%"> 
						&nbsp;<a href="javascript:printURL('saldosymov02Impr.cfm?Impr=1&Periodo=#Form.Periodo#&PeriodoLista=#Form.PeriodoLista#&Ccuenta=#Form.Ccuenta#&Mes=#Form.Mes#&MesCierre=#Form.MesCierre#&Oficina=#Form.Oficina#&Tabla=#Form.Tabla#');"> 
						Imprimir
						</a>
					</td>	
			</cfoutput>
...
<cfinclude template="SaldosMovimientosB2.cfm">
<cf_web_portlet_end> 
<cf_templatefooter>
