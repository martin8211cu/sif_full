...
<cfinvoke key="CMB_Mes_Inicial"   default="Mes Inicial" returnvariable="CMB_MesI" 		component="sif.Componentes.Translate" method="Translate" xmlfile="/sif/generales.xml"/>
<cfinvoke key="CMB_Mes_Final" 	  default="Mes Final" 	returnvariable="CMB_MesF" 		component="sif.Componentes.Translate" method="Translate" xmlfile="/sif/generales.xml"/>
...
<cfinvoke key="MSG_Periodo_Inicial" default="Per&iacute;odo Inicial"	returnvariable="MSG_PeriodoI"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Periodo_Final" 	default="Per&iacute;odo Final"	 	returnvariable="MSG_PeriodoF"	component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="MSG_Empre_Ofic" 			default="Empresa u oficina"					returnvariable="MSG_Empre_Ofic"				component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="MSG_Saldos_Finales_Cero"	default="Mostrar Saldos Finales en Cero"	returnvariable="MSG_Saldos_Finales_Cero"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Saldos_por_Oficina"	default="Saldos por Oficina"				returnvariable="MSG_Saldos_por_Oficina"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Cierre_Anual"		default="Cierre Anual"						returnvariable="MSG_Cierre_Anual"			component="sif.Componentes.Translate" method="Translate"/>
...
<cfset Lvartitulo = 'Balance de Comprobación Por Rango de Meses'>
<!--- Variables --->
<cfparam name="url.ubicacion" default="">
 
<cfif isdefined("LvarSumasSaldos")>
 	<cfset Lvartitulo = 'Balance de Sumas y Saldos'>
</cfif>
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="SQLBalCompR2_Pre-rango.cfm" style="margin:0; " onsubmit="return sinbotones()">
			<cfif isdefined("LvarSumasSaldos")>
			...
			<tr> 
			  ...
			  <td nowrap>&nbsp;</td>
			  <td nowrap><div align="right"><cfoutput>#MSG_PeriodoI#</cfoutput>:&nbsp;</div></td>
			  <td> 
				<select name="periodoI" tabindex="3" onchange="fnValidaRangos()">
			...
			<tr> 
			  ...
			  <td nowrap>&nbsp;</td>
			  <td nowrap><div align="right"><cfoutput>#CMB_MesI#</cfoutput>:&nbsp;</div></td>
			  <td> 
				<select name="mesI" size="1" tabindex="4" onchange="fnValidaRangos()">
            ...
            <tr>
            <td>             
              <div align="right"><cfoutput>#MSG_Moneda#</cfoutput>:&nbsp;</div></td>
               <td rowspan="3">
                 <table border="0" cellspacing="0" cellpadding="2">
                 <tr>
                   <td nowrap="nowrap"><input name="mcodigoopt" type="radio" value="-2" checked="checked" tabindex="5" onclick="fnValidarMovMes(this.value)" /></td>
                   <td nowrap="nowrap"><cfoutput>#MSG_Local#</cfoutput>:</td>
                   <td><cfoutput><strong>#rsMonedaLocal.Mnombre#</strong></cfoutput></td>
                 </tr>
                 <cfif isdefined("rsMonedaConvertida")>
                   <tr>
                     <td nowrap="nowrap"><input name="mcodigoopt" type="radio" value="-3" tabindex="6" onclick="fnValidarMovMes(this.value)" /></td>
                     <td nowrap="nowrap"><cfoutput>#MSG_Convertida#</cfoutput>:</td>
                     <td><cfoutput><strong>#rsMonedaConvertida.Mnombre#</strong></cfoutput></td>
                   </tr>
                 </cfif>
                 <tr>
                   <td nowrap="nowrap"><input name="mcodigoopt" type="radio" value="-4" tabindex="6" onclick="fnValidarMovMes(this.value)" /></td>
                   <td nowrap="nowrap"><cfoutput>#MSG_Informe_B15#</cfoutput>:</td>
                   <td><cfoutput><strong>#lvarB15M#</strong></cfoutput></td>
                 </tr>
                 <tr>
                   <td nowrap="nowrap"><input name="mcodigoopt" type="radio" value="0" tabindex="7" onclick="fnValidarMovMes(this.value)" /></td>
                   <td nowrap="nowrap"><cfoutput>#MSG_Origen#</cfoutput>:</td>
            ...
            <tr> 
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td><div align="right"><cfoutput>#MSG_PeriodoF#</cfoutput>:&nbsp;</div></td>
                <td>
                  	<select name="periodoF" tabindex="3" onchange="fnValidaRangos()">
					<cfloop query = "rsPeriodos">
						<option value="<cfoutput>#rsPeriodos.Speriodo#</cfoutput>"><cfoutput>#rsPeriodos.Speriodo#</cfoutput></option>" <cfif periodo EQ "#rsPeriodos.Speriodo#">selected</cfif>></option>
					</cfloop>
				</select>
             ...
             <tr> 
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td><div align="right"><cfoutput>#CMB_MesF#</cfoutput>:&nbsp;</div></td>
                <td>
                 <select name="mesF" size="1" tabindex="4" onchange="fnValidaRangos()">
				   	<option value="1" <cfif mes EQ 1>selected</cfif>><cfoutput>#CMB_Enero#</cfoutput></option>
					<option value="2" <cfif mes EQ 2>selected</cfif>><cfoutput>#CMB_Febrero#</cfoutput></option>
					<option value="3" <cfif mes EQ 3>selected</cfif>><cfoutput>#CMB_Marzo#</cfoutput></option>
					<option value="4" <cfif mes EQ 4>selected</cfif>><cfoutput>#CMB_Abril#</cfoutput></option>
			...
			<tr> 
			  <td colspan="5"> 
				...
				<cfoutput>
				  ...
				  <input type="Reset"  name="Limpiar" value="#MSG_Limpiar#"   tabindex="17" class="btnFiltrar">
				</cfoutput>  
				</div>
			  </td>
			</tr>
        ...
        <cf_qforms form="form1">
            <cf_qformsRequiredField name="periodoI" 	 description="Periodo Inicial">
            <cf_qformsRequiredField name="periodoF" 	 description="Periodo Final">
		</cf_qforms>
		<script language="javascript1.2" type="text/javascript">
			...
			function fnValidaRangos(){              
    		  if(document.form1.periodoI.value >  document.form1.periodoF.value)
			  {
			    alert("El periodo Inicial no puede ser mayor al periodo Final");	  
				document.form1.periodoF.value = document.form1.periodoI.value;
			  }	
			  else
			  {
				 if(document.form1.mesI.value >  document.form1.mesF.value)
				 {
				      alert("El mes Inicial no puede ser mayor al mes Final");	
					  document.form1.mesF.value =  document.form1.mesI.value;	 
				 }
