...
<cfinvoke key="LB_Titulo"	 		default="Balanza General"		returnvariable="LB_Titulo"		component="sif.Componentes.Translate" method="Translate" xmlfile="BalGeneral.xml"/>
 
<cfif isdefined("LvarInfo")>
	<cfset LvarAction     = 'SQLBalGeneral_INFO.cfm'>
	<cfset LvarTitle 	  = 'Información a PEMEX'>
<cfelse>
	<cfset LvarAction     = 'SQLBalGeneral.cfm'>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
				...
				<tr>
				  ...
				  <td rowspan="2" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                    ...
                    <tr>
				  	  <td nowrap><input name="mcodigoopt" type="radio" value="-5" tabindex="6"></td>
