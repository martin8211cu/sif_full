...
<cfif isdefined("LvarInfo")>
	<cfset LvarAction     = 'EstadoResultadosMes-result_INFO.cfm'>
	<cfset LvarFuncines   = '../../cg/consultas/Funciones.cfm'>
	<cfset LvarTitle 	  = 'Información hacia Entes Externos'>
<cfelse>
	<cfset LvarAction     = 'EstadoResultadosMes-result.cfm'>
...
<cf_templateheader title="#LvarTitle#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Estado de Resultados por Mes'>
