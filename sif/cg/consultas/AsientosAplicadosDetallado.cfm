...
<table width="99%" align="center"  border="0" cellspacing="0" cellpadding="2">
	...
	<cfif isdefined("form.fechaApliIni") and len(trim(form.fechaApliIni)) or isdefined("form.fechaApliFin") and len(trim(form.fechaApliFin)) >
		<tr><td align="center" colspan="9"><font size="2"><strong>#LB_FechaAIni#:</strong>&nbsp;&nbsp;#form.fechaApliIni#&nbsp;&nbsp;<strong>#LB_FechaAFin#:</strong>&nbsp;&nbsp;#form.fechaApliFin#</font></td></tr>
	</cfif>
	...
	<cfif isdefined("queryAplicadoDetalle") and len(trim(queryAplicadoDetalle)) gt 0>	
		<cftry>
			<cf_jdbcquery_open datasource="#session.dsn#" name="rsAplicadoDetalle">
				<cfoutput>#PreserveSingleQuotes(queryAplicadoDetalle)#</cfoutput>
			</cf_jdbcquery_open>

			<cfif isdefined("form.toExcel")>
				<cf_exportQueryToFile query="#rsAplicadoDetalle#" separador="#chr(9)#" filename="#FileNameTab#.txt" jdbc="true">
			</cfif>

			<cfset Lvar_bx = false>
			<cfoutput query="rsAplicadoDetalle">
				<cfif not Lvar_bx>
					<cfset Lvar_bx = true>
					<tr>
						...
						<td nowrap bgcolor="##CCCCCC" align="right"><strong>#LB_FechaAplicacion#</strong></td>
				...
				<tr>
					...
					<td nowrap align="center">#LSDateFormat(ECfechaaplica,'dd/mm/yyyy')#</td>
