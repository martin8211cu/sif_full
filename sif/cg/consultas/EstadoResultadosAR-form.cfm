	...
	<!--- <cftransaction>	--->
		<cfinvoke returnvariable="rsProc" component="sif.Componentes.CG_GastosResultadosAR" method="estadoResultados" 
...
<cfoutput>
	...
	<cfset colspan = (form.nivel * 2)+3 > 
	
	<table width="99%" border="0" cellspacing="0" cellpadding="1" style="padding-left: 5px; padding-right: 10px" align="center">
    	<tr><td align="center" colspan="#colspan#"><font face="Verdana, Arial, Helvetica, sans-serif" size="4"><strong>#session.Enombre#</strong></font></td></tr>
    	<tr><td align="center" colspan="#colspan#"><b><font face="Times New Roman, Times, serif" size="4">Estado de Resultados</font></b></td></tr>
		<cfif isdefined("area")>
			<tr><td align="center" colspan="#colspan#"><b><font face="Times New Roman, Times, serif" size="3">Area de Responsabilidad: #area.descripcion#</font></b></td></tr>
		</cfif>
    	<tr>
			<td align="center" style="padding-right: 20px" colspan="#colspan#">
				<b>Mes:</b>&nbsp;
