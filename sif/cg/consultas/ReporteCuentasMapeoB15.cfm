...
<cfelse>--->
	<cfset LvarAction     = 'ReporteCuentasMapeoB15_SQL.cfm'>
	<cfset LvarReporte1   = 'ReporteCuentasMapeoB15_SQL.cfm'>
	<cfset LvarReporte2   = 'ReporteCuentasMapDetB15_SQL.cfm'>
	<cfset LvarReporte3   = 'ReporteCuentasSinMapearB15_SQL.cfm'>
	<cfset LvarReporte4   = 'ReporteSalidaLayoutExternoB15.cfm'>
<!---</cfif>--->
		...
		<cfoutput>
			<form name="form1" method="post" action="#LvarAction#" onsubmit="return Valida();">
				<table width="100%" cellpadding="2" cellspacing="0" border="0">
                    ...
                    <tr id="SalidaExternaF" style="display:''">
						<td align="right"><strong><cf_translate key=LB_Selecciona2>Conversión</cf_translate>:&nbsp;</strong></td>
						<td colspan="3">
							<select name="Conversion" id="Conversion" tabindex="1">
								<option value="-1"> <cf_translate key=LB_Selecciona2>Escoger uno</cf_translate> </option>
                                <option value="1"> <cf_translate key=LB_Selecciona2>Funcional</cf_translate> </option>
                                <option value="2"> <cf_translate key=LB_Selecciona2>Informe</cf_translate> </option>
							</select>
						</td>
					</tr>
...
<script language="javascript" type="text/javascript">
	...
	function funcVisualizar(){
		...
		document.getElementById("SalidaExternaF").style.display = ''
		...
		document.getElementById("SalidaExternaF").style.visibility = 'visible'
	}
	function funcDesVisualizar(){
		...
		document.getElementById("SalidaExternaF").style.display = 'none';
		...
		document.getElementById("SalidaExternaF").style.visibility = 'hidden';
	}
