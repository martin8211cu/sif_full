<cfinvoke key="LB_TituloR1" 			default="Reporte de Saldos por Cuenta" 			returnvariable="LB_TituloR1" 				component="sif.Componentes.Translate" method="Translate" xmlfile="GenerarReporte.xml"/>
<cfinvoke key="LB_TituloR2" 			default="Reporte de Saldos por Rango de Cuentas" 			returnvariable="LB_TituloR2" 				component="sif.Componentes.Translate" method="Translate" xmlfile="GenerarReporte.xml"/> 
<cfinvoke key="LB_TituloR3" 			default=" Reporte de Saldos por Lista de Cuentas" 			returnvariable="LB_TituloR3" 				component="sif.Componentes.Translate" method="Translate" xmlfile="GenerarReporte.xml"/>
<cfinvoke key="LB_TodasLasOficinas" 			default="Todas las Oficinas" 			returnvariable="LB_TodasLasOficinas" 				component="sif.Componentes.Translate" method="Translate" xmlfile="GenerarReporte.xml"/>
<cfinvoke key="LB_Todas" 			default="Todas" 			returnvariable="LB_Todas" 				component="sif.Componentes.Translate" method="Translate" xmlfile="GenerarReporte.xml"/>
...
<cffunction name="fnPreparaParametros" access="private" output="no" returntype="any">
	...
	<cfset TituloReporte = "#LB_TituloR1#">
	<cfswitch expression="#Id_Reporte#">
		<cfcase value="1"> 
			<cfset TituloReporte = "#LB_TituloR1#">
		</cfcase>
		<cfcase value="2"> 
			<cfset TituloReporte = "#LB_TituloR2#">
		</cfcase>
		<cfcase value="3"> 
			<cfset TituloReporte = "#LB_TituloR3#">
		</cfcase>
	</cfswitch>	
	...
	<cfif isdefined("form.MesInicial") and len(trim(form.MesInicial))>
		<cfif form.MesInicial EQ 1>
			<cfset MesInicial = "#CMB_Enero#">
		</cfif>
		<cfif form.MesInicial EQ 2 >
			<cfset MesInicial = "#CMB_Febrero#">
		</cfif>
		<cfif form.MesInicial EQ 3 >
			<cfset MesInicial = "#CMB_Marzo#">
		</cfif>
		<cfif form.MesInicial EQ 4 >
			<cfset MesInicial = "#CMB_Abril#">
		</cfif>
		<cfif form.MesInicial EQ 5 >
			<cfset MesInicial = "#CMB_Mayo#">
		</cfif>
			<cfif form.MesInicial EQ 6 >
		<cfset MesInicial = "#CMB_Junio#">
		</cfif>
		<cfif form.MesInicial EQ 7 >
			<cfset MesInicial = "#CMB_Julio#">
		</cfif>
		<cfif form.MesInicial EQ 8 >
			<cfset MesInicial = "#CMB_Agosto#">
		</cfif>
		<cfif form.MesInicial EQ 9 >
			<cfset MesInicial = "#CMB_Setiembre#">
		</cfif>
		<cfif form.MesInicial EQ 10 >
			<cfset MesInicial = "#CMB_Octubre#">
		</cfif>
		<cfif form.MesInicial EQ 11 >
			<cfset MesInicial = "#CMB_Noviembre#">
		</cfif>
		<cfif form.MesInicial EQ 12 >
			<cfset MesInicial = "#CMB_Diciembre#">
		</cfif>
	</cfif>
	<cfif isdefined("form.MesFinal") and len(trim(form.MesFinal))>
		<cfif form.MesFinal EQ 1>
			<cfset MesFinal = "#CMB_Enero#">
		</cfif>
		<cfif form.MesFinal EQ 2>
			<cfset MesFinal = "#CMB_Febrero#">
		</cfif>
		<cfif form.MesFinal EQ 3>
			<cfset MesFinal = "#CMB_Marzo#">
		</cfif>
		<cfif form.MesFinal EQ 4>
			<cfset MesFinal = "#CMB_Abril#">
		</cfif>
		<cfif form.MesFinal EQ 5>
			<cfset MesFinal = "#CMB_Mayo#">
		</cfif>
		<cfif form.MesFinal EQ 6>
			<cfset MesFinal = "#CMB_Junio#">
		</cfif>
		<cfif form.MesFinal EQ 7>
			<cfset MesFinal = "#CMB_Julio#">
		</cfif>
		<cfif form.MesFinal EQ 8>
			<cfset MesFinal = "#CMB_Agosto#">
		</cfif>
		<cfif form.MesInicial EQ 9>
			<cfset MesFinal = "#CMB_Setiembre#">
		</cfif>
		<cfif form.MesFinal EQ 10>
			<cfset MesFinal = "#CMB_Octubre#">
		</cfif>
		<cfif form.MesInicial EQ 11>
			<cfset MesFinal = "#CMB_Noviembre#">
		</cfif>
		<cfif form.MesFinal EQ 12>
			<cfset MesFinal = "#CMB_Diciembre#">
		</cfif>
	</cfif>

	<cfset TituloCalcDesc = "#LB_TodasLasOficinas#">
	<cfif isdefined("form.ubicacion") and len(trim(form.ubicacion))>
		<cfset LarrUbicacion = ListToarray(form.ubicacion)>
		<cfif 	len(trim(LarrUbicacion[1])) and LarrUbicacion[1] eq 'ge'>   <!--- GRUPO DE EMPRESAS --->
