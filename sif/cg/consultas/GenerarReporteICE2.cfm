		...
		<cfcase value="1">  <!--- 1 - SALDOS PARA 1 CUENTA           --->
			...
			<cfquery datasource="#session.dsn#">
				...
				select
					...
					0.00, 0.00, 0.00, 0.00,
					<cfqueryparam value="#form.PERIODOS#" 		 cfsqltype="cf_sql_integer">,
					<cfqueryparam value="#form.MESINICIAL#" 	 cfsqltype="cf_sql_integer">,
					<cfqueryparam value="#form.MESFINAL#" 		 cfsqltype="cf_sql_integer">,
					1, <cfqueryparam value="#form.NIVELDET#"     cfsqltype="cf_sql_integer">
				from CContables c
