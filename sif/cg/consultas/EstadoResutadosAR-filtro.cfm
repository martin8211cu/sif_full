	...
	<cf_templateheader title="Contabilidad General">
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Consultas por Area de Responsabilidad'>
		 ...
		 <script language="JavaScript1.2" type="text/javascript" src="../../js/sinbotones.js"></script>
		  <form name="form1" method="post" action="EstadoResultadosAR-result.cfm" onsubmit="javascript:return validar(this); sinbotones();">
							  ...
							  <tr>
								<td>
									<div align="justify" style="font-size:12px;">
										<br />
										Este reporte detalla el estado de resultados o la consulta de Gastos
										durante un per&iacute;odo contable, en una o varias &aacute;reas de responsabilidad espec&iacute;ficas, permitiendo mostrar variantes como cortes por cuenta de mayor y resumen de gastos a un nivel espec&iacute;fico de las cuentas.
										<br />
										<br />
									</div>
								</td>
					...
					<td valign="top" align="center">
						<table width="50%" align="center" cellpadding="1" cellspacing="0">
							...
							<tr><td >
								...
								<select name="CGARepid" id="CGARepid" onchange="javascript:DesactivaCorte();">
							...
							<tr>
								<td>
									<table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
											<td colspan="2"><input name="Resumido" id="Resumido" type="checkbox" />Presentar Resumido a este nivel</td>
										</tr>
						  <tr>
							<td colspan="2"><input type="checkbox" name="CorteMayor" id="CorteMayor"/>Cortes por Cuenta de Mayor </td>
						  </tr>
                          <tr>
							<td colspan="2"><input type="checkbox" name="CodigoPlan" id="CodigoPlan"/>Mostrar valores del Plan de Cuentas </td>
						  </tr>
		...
		<script language="javascript1.2" type="text/javascript">
			...
			function DesactivaCorte(){
				if(document.getElementById('CGARepid').value==2) {
					document.getElementById('Resumido').checked=false;
					document.getElementById('CorteMayor').checked=false;
					document.getElementById('CodigoPlan').checked=false;
					document.getElementById('Resumido').disabled=true;
					document.getElementById('CorteMayor').disabled=true;
					document.getElementById('CodigoPlan').disabled=true;
				}
				else {
					document.getElementById('Resumido').disabled=false;
					document.getElementById('CorteMayor').disabled=false;
