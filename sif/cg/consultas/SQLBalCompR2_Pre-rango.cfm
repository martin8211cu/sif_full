...
<cfif rsMesCierreConta.Pvalor NEQ url.mesI and url.CHKMesCierre EQ "1">
...
<cfset LvarAction = "BalCompR-rango.cfm" >
...
<cfset LvarComponente = "SQLBalCompR2-rango.cfm">
...
<cfif form.formato EQ "HTML">
	<form name="form1n" action="#LvarComponente#" method="post">
		...
		<input type="hidden" name="MESI" value="#url.mesI#" />
  		<input type="hidden" name="MESF" value="#url.mesF#" />
		<input type="hidden" name="NIVEL" value="#url.NIVEL#" />
		<input type="hidden" name="PERIODOI" value="#url.periodoI#" />
   		<input type="hidden" name="PERIODOF" value="#url.periodoF#" />
...
<cfelse>
	...
	<cfset LvarSrc = "#LvarComponente#?IncluirOficina=#url.IncluirOficina#&CHKMesCierre=#LvarCHKMesCierre#&CMAYOR_CCUENTA1=#url.CMAYOR_CCUENTA1#&CMAYOR_CCUENTA2=#url.CMAYOR_CCUENTA2#&FORMATO=#form.FORMATO#&MCODIGO=#url.MCODIGO#&MCODIGOOPT=#url.MCODIGOOPT#&MESI=#url.MESI#&MESF=#url.MESF#&NIVEL=#url.NIVEL#&PERIODOI=#url.PERIODOI#&PERIODOF=#url.PERIODOF#&UBICACION=#url.UBICACION#&MostrarCeros=#url.chkCeros#">
	<cfif isdefined("url.LvarSumasSaldos")>
		<cfset LvarSrc = "#LvarComponente#?IncluirOficina=#url.IncluirOficina#&CHKMesCierre=#LvarCHKMesCierre#&CMAYOR_CCUENTA1=#url.CMAYOR_CCUENTA1#&CMAYOR_CCUENTA2=#url.CMAYOR_CCUENTA2#&FORMATO=#form.FORMATO#&MCODIGO=#url.MCODIGO#&MCODIGOOPT=#url.MCODIGOOPT#&MESI=#url.MESI#&MESF=#url.MESF#&NIVEL=#url.NIVEL#&PERIODOI=#url.PERIODOI#&PERIODOF=#url.PERIODOF#&UBICACION=#url.UBICACION#&MostrarCeros=#url.chkCeros#&LvarSumasSaldos=1">
	</cfif>
