...
<cfinvoke key="LB_ConCodigo"		default="Con Código"		returnvariable="LB_ConCodigo"		component="sif.Componentes.Translate" method="Translate" xmlfile="EstadoResultados.xml"/>
<cfinvoke key="LB_MostrarNivel"		default="Mostrar solo Nivel Seleccionado"		returnvariable="LB_MostrarNivel"		component="sif.Componentes.Translate" method="Translate" xmlfile="EstadoResultados.xml"/>
...
<cfinvoke key="MSG_GenerarExcel" 	default="Generar a Excel"	returnvariable="MSG_GenerarExcel"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Unidades" 		default="Unidades"			returnvariable="MSG_Unidades"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Moneda2"			default="Moneda"			returnvariable="MSG_Moneda2"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Miles" 			default="Miles"				returnvariable="MSG_Miles"			component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="MSG_Millones" 		default="Millones"			returnvariable="MSG_Millones"		component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="LB_Idioma"	 		default="Idioma"		returnvariable="LB_Idioma"		component="sif.Componentes.Translate" method="Translate" xmlfile="BalGralConvMon.xml"/>
<cfinvoke key="LB_Local"	 		default="Local"			returnvariable="LB_Local"		component="sif.Componentes.Translate" method="Translate" xmlfile="BalGralConvMon.xml"/>
<cfinvoke key="LB_Alterno"	 		default="Alterno"		returnvariable="LB_Alterno"		component="sif.Componentes.Translate" method="Translate" xmlfile="BalGralConvMon.xml"/>
...
<cfset LvarAction     = 'EstadoResCM-result.cfm'>
<cfset LvarFuncines   = 'Funciones.cfm'>
<cfset LvarTitle 	  = '#LB_Titulo#'>
		...
		<script language="JavaScript1.2" type="text/javascript" src="../../js/sinbotones.js"></script>
		  <form name="form1" method="post" action="<cfoutput>#LvarAction#</cfoutput>" onsubmit="return sinbotones()">
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
              ...
              <tr>
                <td width="30%" align="right"><cfoutput>#MSG_GrupoOficinas#</cfoutput></td>
                <td width="24%">
					<select name="GOid">
              ...
              <tr>
                <td width="30%" align="right"><cfoutput>#MSG_Oficina#</cfoutput>:</td>
                <td width="24%">
					<select name="Oficina">
						<option value="-1"><cfoutput>#LB_Todas#</cfoutput></option>
              ...
              <tr>
                <td align="right"><cfoutput>#MSG_Moneda#</cfoutput>:</td>
...
--->
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td align="right"><cfoutput>#LB_Nivel#</cfoutput>:</td>
                <td>
                  <select name="nivel">
                  ...
                  <input type="checkbox" name="chkNivelSeleccionado" value="1" <cfif session.Conta.balances.nivelSeleccionado>checked</cfif>/>&nbsp;<cfoutput>#LB_MostrarNivel#</cfoutput>
              ...
              <tr>
			  	<td></td>
                <td><input type="checkbox" name="toExcel"/><cfoutput>#MSG_GenerarExcel#</cfoutput> </td>
				<td align="right" ><cfoutput>#MSG_Unidades#</cfoutput>:</td>
				<td> 
					<select name="Unidades" size="1" tabindex="1">
						<option value="1" <cfif Unidades EQ 1>selected</cfif>><cfoutput>#MSG_Moneda2#</cfoutput></option>
						<option value="1000" <cfif Unidades EQ 2>selected</cfif>><cfoutput>#MSG_Miles#</cfoutput></option>
						<option value="1000000" <cfif Unidades EQ 3>selected</cfif>><cfoutput>#MSG_Millones#</cfoutput></option>
					</select> 
				</td>              
			  </tr>
              <tr>
              ...
              <tr>
				...
				<cfoutput>
					<input type="submit" name="Submit" value="#MSG_Consultar#">
				 </cfoutput>
                </td>
              </tr>
              <tr>
