...
<cfoutput>	
<form name="form1" action="TESReintegroCB_sql.cfm" method="post">
		...
		<tr>			
			...
			<td>
				...
				<cf_conlis
					...
					Filtro=" cf.TESid = #session.Tesoreria.TESid#  and cf.CBid = $CBidOriCL,numeric$ and TESTMPtipo in (2,3,4) order by cf.TESMPcodigo"
	...
	<cfif modo eq 'CAMBIO'>
		<tr>
			<td colspan="2">
				<cfinclude template="TESReintegroCB_detalles.cfm">
			</td>
		</tr>
	</cfif>
</table>
...
<script language="javascript" type="text/javascript">
	...
	{	
		...
		{
			if (!confirm('¿Desea REALIZAR una Orden de Pago para realizar un TEF'))
				return false;
		}	
		else if (tipo == "manual")
		{
			if (!confirm('¿Desea REALIZAR un lote de transferencia entre cuentas para su REGISTRO MANUAL'))
				return false;
		}	
