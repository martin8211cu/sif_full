...
<cfif isdefined ('form.Agregar')>
	...
	<cflocation url="CCHReintegroCc.cfm?TESRnumero=#rsMaxNum.numero#">
</cfif>

<!---                                  Regresar                                           --->
<cfif isdefined ('form.Regresar')>
	<cflocation url="CCHReintegroCc.cfm">
</cfif>

<!---                                  Limpiar                                           --->
<cfif isdefined ('form.Limpiar')>
	<cflocation url="CCHReintegroCc.cfm?Nuevo=nuevo">
</cfif>
...
<cfif isdefined ('form.btnElimina')>
	...
	<cflocation url="CCHReintegroCc.cfm?TESRnumero=#form.TESRnumero#">
</cfif>
...
<cfif isdefined ('form.Nuevo')>
	<cflocation url="CCHReintegroCc.cfm?Nuevo=1">
</cfif>
...
<cfif isdefined ('form.GenerarOP') OR isdefined ('form.ManualTF')>
	...
	<cfif isdefined ('form.GenerarOP')>
		<cflocation url="CCHReintegroCc.cfm?OPnum=#LvarOP#">
	<cfelse>
		<cflocation url="CCHReintegroCc.cfm?TESTILid=#LvarTESTILid#">
	</cfif>
</cfif>
