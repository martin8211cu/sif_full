		...
		insert into TESdetallePago 
			...
			select		1, 
					...
					<cfif #fDesde# NEQ "" AND #fHasta# NEQ "">	
						<cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#rtrim(GEAdescripcion)# (#fDesde# - #fHasta#) "null="#rtrim(GEAdescripcion) EQ ""#">,
					<cfelse>
						<cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#rtrim(GEAdescripcion)#" null="#rtrim(GEAdescripcion) EQ ""#">,
					</cfif>
						a.CFcuenta,
						<cf_jdbcquery_param cfsqltype="cf_sql_numeric" value="#rsAnticipos.Ocodigo#">,
						#rsCPT.TESRPTCid#,
						a.CFid,
						b.Linea,
						a.GEAmanual,
