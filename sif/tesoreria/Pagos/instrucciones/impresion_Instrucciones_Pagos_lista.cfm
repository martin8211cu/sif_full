...
<table width="100%" border="0" cellspacing="6">
  <tr>
	<td width="50%" valign="top">
		<form name="formFiltro" method="post" action="impresion_Instrucciones_Pagos.cfm" style="margin: '0' ">
			...
			<input type="checkbox" name="chkReimprimir" tabindex="2"
				<cfif isdefined("form.chkReimprimir")>checked</cfif>
				onclick="this.form.submit();"
				> Listar Ordenes a Reimprimir
		</form>
		...
		<cfquery datasource="#session.dsn#" name="lista">
			...
			where fl.TESid=<cfqueryparam cfsqltype="cf_sql_numeric" value="#session.Tesoreria.TESid#">
				...
				<cfif isdefined("form.chkReimprimir")>
		...
		<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
			...
			ira="impresion_Instrucciones_Pagos.cfm"
			form_method="post"
...
<cfif NOT isdefined("form.chkReimprimir")>
	<tr>		  
		<td>		
			  <input name="btnNuevo" type="button" tabindex="2"
			  	value="Agregar Nuevo Lote de Impresión" 
				onClick="location.href='impresion_Instrucciones_Pagos.cfm?btnNuevo=1'">
		</td>
	</tr>		  
</cfif>
</table>
