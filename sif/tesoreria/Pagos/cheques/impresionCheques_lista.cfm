<!---------
	...
	Motivo:	Se modificó el filtro eliminando el beneficiario
----------->
...
<table width="100%" border="0" cellspacing="6">
	<tr>
		<td width="50%" valign="top">
			<form name="formFiltro" method="post" action="impresionCheques.cfm" style="margin: '0' ">
	...
	<tr>		  
		<td>		
			  <input name="btnNuevo" type="button" value="Agregar Nuevo Lote de Impresión" 
			  	onClick="location.href='impresionCheques.cfm?btnNuevo=1'" tabindex="2">
		</td>
	</tr>		  
</table>
