		...
		<td valign="top" colspan="4">
			<form name="formFiltro" method="post" action="reimpresionCheques.cfm" style="margin: '0' ">
				<table class="areaFiltro" width="100%"  border="0" cellpadding="0" cellspacing="0">
			 		 ...
			 		 <tr>
						<td align="right" nowrap><strong>Cuenta Pago:</strong></td>					
						<td><cf_cboTESCBid name="CBidPago_F" Ccompuesto="yes" all="yes" onChange="javascript: cambioCB(this);" tabindex="1"></td>										
						<td width="9%" nowrap align="right" valign="middle"><strong>Fecha del Lote:</strong></td>
...
<cfif NOT isdefined("form.chkCancelados")>
	<tr>		  
		<td width="18%" align="left">		
			<form name="formAgrega" method="post">
			<cf_botones tabindex="2" 
				include="AgregaN" 
				includevalues="Agregar Nuevo Lote de reimpresión"
				exclude="Cambio,Baja,Nuevo,Alta,Limpiar">
			</form>
			 <!---  <input name="btnNuevo" type="button" value="Agregar Nuevo Lote de reimpresión" 
			  onClick="location.href='reimpresionCheques.cfm?btnNuevo=1'" tabindex="2"> --->
		</td>
...
<script language="javascript" type="text/javascript">
	function funcAgregaN(){
		location.href='reimpresionCheques.cfm?btnNuevo=1';
		return false;
	}
