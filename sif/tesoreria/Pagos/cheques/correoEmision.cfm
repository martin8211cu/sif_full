...
<cfquery datasource="#session.dsn#" name="lista">
			Select	op.TESOPid,
                    ...
                    ,lfd.TESCFDnumFormulario as Cheque           
       	...
       	Estimado proveedor,
        <cfoutput>#rsEmpresa.Edescripcion#</cfoutput>  emitió un pago a través del cheque numero:<cfoutput>#lista.Cheque#</cfoutput> 
        por un monto de <cfoutput>#LSNumberFormat(lista.TESOPtotalPago,"9,9.99")#</cfoutput>.<cfoutput>#lista.Miso4217Pago#</cfoutput>, por concepto de:
        </p> 
	...
	Favor retirar el cheque los días acordados de pago.
