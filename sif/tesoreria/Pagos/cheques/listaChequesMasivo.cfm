	...
	<table width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td>
	     	...
	     	<form name="formListaChk" method="post" action="#irA#" style="margin: '0' ">
				<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
					...
					navegacion="#navegacion#"                    
	     			keys="TESid,TESOPid,TESCFDnumFormulario,TESMPcodigo,CBid"
  		    		checkboxes="S"                   
				/>		
               	<BR>
			<cf_botones values="Continuar" tabindex="2">
			</td>
	  	</tr>
	  </cfoutput>
	</table>
...
<script language="javascript">
	...
	function funcContinuar(){
		var marcado =0;
		var chk = document.formListaChk.chk;
    	for(i=0;i< chk.length; i++ )
		{			
			if (document.formListaChk.chk[i].checked == true )
			{
				marcado = marcado + 1;
		...
		if(marcado == 0)
		{			
			alert ("Debe de elegir al menos uno o varios cheques");	
			return false;
		}
 	}
