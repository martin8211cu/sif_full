<!--- 
	Creado por: Oscar Bonilla
		...
		Motivo: Emisión de Transferencias de Fondos
				Lotes de Instrucciones de Pago Impresas
--->

<cfset GvarTEF = structNew()>
<cfset GvarTEF.TEF			= "TRI">
<cfset GvarTEF.TESTMPtipo	= "2">
<cfset GvarTEF.Proceso		= "Emisión de Órdenes de Pago - Impresión de Instrucciones de Pago">
<cfset GvarTEF.Lote			= "Lote de Impresión de Instrucciones de Pago">
<cfset GvarTEF.Accion		= "Impresión">
<cfset GvarTEF.Accion2		= "Imprimir">
