	...
	<cfif rsErrores.cantidad eq 0>
			<cfquery datasource="#session.dsn#" name="rs">
				...
				where GEPVcodigo=<cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#rsImportador.GEPVcodigo#"> 
                     ...
                     and GEPVfechaini = <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#rsImportador.GEPVfechaini#">
                     and GEPVfechafin = <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#rsImportador.GEPVfechafin#">
			</cfquery>
            
            <cfset FechaFin = DateAdd("d",-1,#rsImportador.GEPVfechaini#)>
            
            <cfquery datasource="#session.dsn#" name="act">
				update GEPlantillaViaticos 
                set GEPVfechafin = <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#FechaFin#">
				where GEPVcodigo=<cf_jdbcquery_param cfsqltype="cf_sql_varchar" value="#rsImportador.GEPVcodigo#"> 
					 and Ecodigo = #session.Ecodigo#
                     and GEPVfechafin >= <cf_jdbcquery_param cfsqltype="cf_sql_timestamp" value="#rsImportador.GEPVfechaini#">
			</cfquery>
