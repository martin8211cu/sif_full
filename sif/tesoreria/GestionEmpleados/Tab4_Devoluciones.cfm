<cfoutput>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_DevolucionCajaChica" default ="Devoluci&oacute;n a la Caja Chica" returnvariable="LB_DevolucionCajaChica" xmlfile = "TabT5_DepositosE.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="BTN_Agregar" default ="Agregar" returnvariable="BTN_Agregar" xmlfile = "TabT5_DepositosE.xml">
...
<cfquery name="rsDev" datasource="#session.dsn#">
	...
	<table align="center">
		<tr>
			<td>
				<strong>#LB_DevolucionCajaChica#:&nbsp;</strong>
			</td>
			<td>
		...
		<tr>
			<td colspan="3" align="center">
				<input type="submit" name="AgregarD" value="#BTN_Agregar#">
			</td>
		</tr>
	</table>
</cfoutput>
