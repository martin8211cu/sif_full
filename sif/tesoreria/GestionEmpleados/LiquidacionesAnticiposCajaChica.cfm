...
<!--- Validaciones Liquidaciones--->	
	...
	<cfif Busqueda.GELreembolso GT 0>
		...
		<cfif rsAnticipos.recordcount gt 0>
            ...
            <cf_translate key = LB_ElEmpleadoTieneAnticiposConSaldosEnContraQueDebeLiquidarAntesDePoderleReintegarDinero xmlfile="LiquidacionAnticiposCajaChica.xml">
			...
			<table border="1" width="75%" bordercolor="333399">
				<tr>
                    ...
                    <cf_translate key = LB_NumeroAnticipo xmlfile="LiquidacionAnticiposCajaChica.xml">
						NumeroAnticipo
                    <cf_translate>
					</font></strong>
					</td>				
					<td align="center"><strong><font color="0000FF">
                    <cf_translate key = LB_SaldoLiquidar xmlfile="LiquidacionAnticiposCajaChica.xml">
						Saldo a Liquidar
                    <cf_translate</font></strong>
					</td>
