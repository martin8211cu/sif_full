<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Deposito" Default="Dep&oacute;sito" returnvariable="LB_Deposito" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Fecha" Default="Fecha" returnvariable="LB_Fecha" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Cuenta" Default="Cuenta" returnvariable="LB_Cuenta" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Moneda" Default="Moneda" returnvariable="LB_Moneda" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Monto" Default="Monto" returnvariable="LB_Monto" xmlfile = "Tab3_Depositos.xml"/>
...
returnvariable="LB_RevisaDatos" xmlfile = "Tab3_Depositos.xml"/>
...
returnvariable="LB_CampoFactorConversion" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_CampoTipoCambioMayor0" Default="El Tipo de Cambio debe ser mayor que cero" 
returnvariable="LB_CampoTipoCambioMayor0" xmlfile = "Tab3_Depositos.xml"/>
...
returnvariable="LB_CampoTipoCambio" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_CampoBanco" Default="Debe seleccionar un Banco" returnvariable="LB_CampoBanco" 
xmlfile = "Tab3_Depositos.xml"/>
...
returnvariable="LB_CampoReferencia" xmlfile = "Tab3_Depositos.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_CampoMontoSolicitadoMayor0" Default="El monto solicitado debe ser mayor que cero" 
returnvariable="LB_CampoMontoSolicitadoMayor0" xmlfile = "Tab3_Depositos.xml"/>
	...
	<tr>
		<td  valign="top">
			<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" 
				...
				etiquetas="#LB_Deposito#, #LB_Fecha#, #LB_Cuenta#, #LB_Moneda#, #LB_Monto#"
				formatos="S,D,S,S,M"
...
<!---cuentabancaria--->	
	<tr>
		<td nowrap="nowrap"  align="right"><strong><cf_translate key = LB_CuentaBancaria xmlfile="Tab3_Depositos.xml">Cuenta Bancaria</cf_translate>:</strong></td>
		<td>	
			...
			<select name="CBid" onchange="CambiaMoneda()">
				<option value="" selected> - <cf_translate key = LB_Bancos xmlfile="Tab3_Depositos.xml">Bancos</cf_translate> - </option>
...
<!---Transaccion --->	
	...
	<cfquery name="rsBTid" datasource="#session.dsn#">
		...
		and BTtipo='D' and BTcodigo  not in('PC','PT','TO','P8','P9','XC','XT','TF','X8','X9')
	</cfquery>
	<tr>	
		<td  align="right"><strong><cf_translate key = LB_Transaccion xmlfile="Tab3_Depositos.xml">Transacci&oacute;n</cf_translate>:</strong></td>
			<td>
				<select name="BTid">  
					<cfif rsBTid.RecordCount>
						<cfloop query="rsBTid">
							<option value="#rsBTid.BTid#"<cfif modo neq "ALTA" and rsBTid.BTid  eq rsDepo.BTid>selected="selected"</cfif>>#rsBTid.BTcodigo# - #rsBTid.BTdescripcion#</option>
						</cfloop>
					</cfif>
				</select>
			</td>
...
<!---Depósito--->
	<tr>
		<td width="28%" align="right" valign="top"><strong><cf_translate key = LB_Referencia xmlfile="Tab3_Depositos.xml">Referencia</cf_translate>: </strong></td>
		<td width="69%">
...
<!---Fecha --->	
	<tr>	
		<td  align="right"><strong><cf_translate key = LB_Fecha xmlfile="Tab3_Depositos.xml">Fecha</cf_translate>:</strong></td>
			<td>
...
<!---monto--->
	<tr>
		<td valign="top"  align="right"><strong><cf_translate key = LB_Monto xmlfile="Tab3_Depositos.xml">Monto</cf_translate>: </strong></td>
			<td>
				<cfset valor_dep = 0 >
					<cfif modo neq 'ALTA'>
						<cfset valor_dep = LSNumberFormat(abs(rsDepo.GELDtotalOri),"0.00") >
					</cfif>
				<cf_inputNumber name="montodep" value="#valor_dep#" size="20" enteros="13" decimales="2" onChange="CambiaMonto()" onFocus="this.value=qf(this); this.select(); GvarFocus='MD';">
...
<!---Tipo de cambio--->
		<tr>	
			<td nowrap="nowrap"  align="right"><strong><cf_translate key = LB_TipoCambio xmlfile="Tab3_Depositos.xml">Tipo de Cambio</cf_translate>:</strong></td>
				<td>
...
<!---Factor de conversion--->
		<tr>			
				<td nowrap="nowrap"  align="right"><strong><cf_translate key = LB_FactorConversion xmlfile="Tab3_Depositos.xml">Factor de conv</cf_translate>:</strong></td>
				<td >
...
<!---Monto en moneda liquidante--->
		<tr>			
				<td nowrap="nowrap"  align="right"><strong><cf_translate key = LB_MontoLiq xmlfile="Tab3_Depositos.xml">Monto LIQ</cf_translate>:</strong></td>
				<td >
...
function funcCambioDep()
{
	...
	if (GvarFocus == "") 
		return true;
	GvarFocus = "";
	window.setTimeout("document.formDep.CambioDep.click();",100);
	return false;
}
...
<!---VALIDACIONES--->	
	...
	var error_msg = '';
				...
				{
				error_msg += "\n - <cfoutput>#LB_CampoBanco#</cfoutput>.";
				...
				error_input = formulario.montodep;
					...
					{
					error_msg += "\n - <cfoutput>#LB_CampoMontoSolicitadoMayor0#</cfoutput>.";
			}
				...
				error_input = formulario.tipoCambio;
					...
					{
					error_msg += "\n - <cfoutput>#LB_CampoTipoCambioMayor0#</cfoutput>.";
			}
