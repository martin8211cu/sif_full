<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Titulo" default="Reimpresión Anticipos de Empleados" returnvariable="LB_Titulo" 
xmlfile ="ReimpresionAnt.xml"/>
