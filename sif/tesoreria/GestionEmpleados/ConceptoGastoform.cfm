...
<form method="post" name="form1" action="ConceptoGastoSQL.cfm">
	<table align="center">
		...
		<tr valign="baseline"> 
			<td nowrap align="right">Código de Servicio Asociado: </td>
		  	<td>
			<cfif modo NEQ 'ALTA'>
	  ...
	  <tr>
		...
		<tr valign="baseline"> 
			<td nowrap align="right">Complemento Gasto No Deducible:</td>
			<td>
		  		<input type="text" name="GECcomplemento2" id='GECcomplemento2' maxlength="25" value="<cfif modo NEQ 'ALTA'><cfoutput>#trim(rsID_concepto_gasto.GECcomplemento2)#</cfoutput></cfif>" size="32" tabindex="1" onfocus="javascript: this.select();" alt="El campo Ccomplemento No Deducible">
			</td>
		</tr>
		<tr>
			<td align="right">
				Monto por Deducible Diario:
			</td>
			<td>
				<cfif modo eq 'ALTA'>
					<cf_inputNumber name="GECmontoDeducibleDia" size="20" value="0" enteros="13" decimales="2" maxlenght="15">
				<cfelse>
					 <cf_inputNumber name="GECmontoDeducibleDia" size="20" value="#rsID_concepto_gasto.GECmontoDeducibleDia#" enteros="13" decimales="2" maxlenght="15">
				</cfif>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="GECajusteDias">
					<option value="1"<cfif isdefined("rsID_concepto_gasto.GECajusteDias") and rsID_concepto_gasto.GECajusteDias EQ 0> selected</cfif>>Por día</option>
					<option value="0"<cfif isdefined("rsID_concepto_gasto.GECajusteDias") and rsID_concepto_gasto.GECajusteDias EQ 0> selected</cfif>>Por noche</option>
				</select>
			</td>
		</tr>
		<tr>
...
<cf_qforms form='form1'>
	<cf_qformsrequiredfield name='Ccodigo' description='Código de Servicio Asociado'>
