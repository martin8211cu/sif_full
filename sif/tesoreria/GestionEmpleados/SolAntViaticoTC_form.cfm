<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_DetallesAnticipoTipoCambio" default ="Detalles del Anticipo Tipo de Cambio" returnvariable="LB_DetallesAnticipoTipoCambio" xmlfile = "SolAntViaticoTC_form.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_ModificacionTipoCambio" default ="Modificaci&oacute;n del tipo de Cambio" returnvariable="LB_ModificacionTipoCambio" xmlfile = "SolAntViaticoTC_form.xml">


<cfparam name="modo" default="ALTA"></cfparam>
<cfset CurrentPage=GetFileFromPath(GetTemplatePath())>
<cf_templateheader title="#LB_DetallesAnticipoTipoCambio#">
<cfinclude template="../../../sif/portlets/pNavegacion.cfm">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#LB_DetallesAnticipoTipoCambio#">
	...
	<table width="100%" border="0" align="center">
		...
		<td valign="top" width="40%" align="left" >
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<cf_web_portlet_start border="true" titulo="#LB_ModificacionTipoCambio#" skin="info1">
							<p><cf_translate key = LB_ParrafoMoModificacionTipoCambio xmlfile = "SolAntViaticoTC_form.xml">En esta pantalla se muestra las monedas extranjeras que se encuentran ligadas al anticipo seleccionado. 
							Dando asi la posibilidad de escojer el tipo de cambio para cada moneda para dicho anticipo. 
							A la hora de modificar este tipo de cambio afecta los montos de pago de dicho anticipo</cf_translate>.</p>
							<p align="justify">&nbsp;</p>
						<cf_web_portlet_end>
					</td>
				</tr>
	 ...
	 <table width="100%" border="0" align="center">
		 <tr>
		 	<td><div align="left" style="font-size:16px"><strong><cf_translate key = LB_DATOSDELANTICIPO xmlfile = "SolAntViaticoTC_form.xml">DATOS DEL ANTICIPO</cf_translate></strong></div></td>
		</tr>
		<tr>
			<td><div align="left"><strong><cf_translate key = LB_Moneda xmlfile = "SolAntViaticoTC_form.xml"> Moneda </cf_translate>: #rsDatos.Mnombre#</strong></div> </td>
