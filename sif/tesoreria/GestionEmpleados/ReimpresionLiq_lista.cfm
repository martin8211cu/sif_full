...
<table width="100%" border="0" cellspacing="6">
	<tr>
		...
		<form name="formFiltro" method="post" action="<cfoutput>ReimpresionLiq#LvarSAporEmpleadoCFM#.cfm</cfoutput>" style="margin: '0' ">
...
<td>
	<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
		query="#lista#"
		Cortes="#LvarCortes#"
		desplegar="GELnumero,CFcodigo,Empleado,GELfecha,Moneda,GELtotalGastos,usuario,pago"
		etiquetas="Num.<BR>Liquidación,Ofi:Centro<BR>Funcional,Nombre Empleado,Fecha Liquidación, Moneda,   Gastos,  Solicitante,Tipo Pago "
		formatos="I,S,S,D,S,M,S,S,S"
		align="left,left,left,left,left,left,left,left,left"
		ira="ReimpresionLiq#LvarSAporEmpleadoCFM#.cfm"
		form_method="post"
