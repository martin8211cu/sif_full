<cfif isdefined ('form.GELid')>
	<cfquery datasource="#session.dsn#" name="listaDet">
		select 
			...
			coalesce(c.GECdescripcion,i.Idescripcion) as GECdescripcion,
			c.GECid, 
			1 as Det
		...
		<tr>
			...
			<cfelse>
				<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
					...
					etiquetas="Num.Doc,Fecha,Concepto,Descripci&oacute;n Gasto,Moneda,Monto<BR>Documentos,Monto<BR>Autorizado,Autorizado<BR>Liq. #rsMonedaLocal.Miso4217#"
					formatos="S,D,S,S,S,M,M,M"
					align="right,center,center,left,center,right,right,right"
