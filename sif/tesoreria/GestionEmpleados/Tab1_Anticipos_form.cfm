<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Anticipo" Default="Anticipo" returnvariable="LB_Anticipo" xmlfile = "Tab1_Anticipos_form.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Fecha" Default="Fecha" returnvariable="LB_Fecha" xmlfile = "Tab1_Anticipos_form.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Descripcion" Default="Descripci&oacute;n" returnvariable="LB_Descripcion" xmlfile = "Tab1_Anticipos_form.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Monto" Default="Monto" returnvariable="LB_Monto" xmlfile = "Tab1_Anticipos_form.xml"/>
...
xmlfile = "Tab1_Anticipos_form.xml"/>
...
<cfif CompruebaAnticipos.cantidad eq 0>
	<tr>
		<td align="center"><strong>***<cf_translate key = MSG_ElEmpleadoNoTieneAnticiposRelacionados xmlfile = "Tab1_Anticipos_form.xml">El empleado no tiene anticipos relacionados</cf_translate>***</strong></td>
	</tr>
<cfelse>
<tr>
...
<td align="center" valign="top" width="45%" class="tituloListas" >
	<div align="center"><cf_translate key = LB_ListaDeAnticiposDisponiblesParaElEmpleado xmlfile = "Tab1_Anticipos_form.xml"> Lista de Anticipos disponibles para el empleado</cf_translate></div>	
		<!--- 
		...
		<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" 
			...
			etiquetas="#LB_Anticipo#,#LB_Fecha#,#LB_Descripcion#,#LB_Monto##LvarViatico2#"
			formatos="S,D,S,M,S"
...
<cfif modoAnt eq 'Cambio'>
	...
	<!---NUMEROANT-FECHA--->	
			<tr>
				<td  nowrap="nowrap" align="right" valign="top"><strong>#LB_Anticipo#:</strong></td>
				<td><input disabled="disabled" type="text" name="Ant" id="Ant" value="<cfif modoAnt neq 'Alta'>#rsAnt.GEAnumero#</cfif>"/></td>
				<td  nowrap="nowrap" align="right" valign="top"><strong>#LB_Fecha#:</strong></td>
				<td><input disabled="disabled" type="text" name="Fecha" id="Fecha" value="<cfif modoAnt neq 'Alta'>#DateFormat(rsAnt.GEAfechaSolicitud,'DD/MM/YYYY')#</cfif>"/></td>
			</tr>
			
	<!---DESCRIPCION--->		
			<tr>
				<td  nowrap="nowrap" align="right" valign="top"><strong>#LB_Descripcion#:</strong></td>
				<td nowrap="nowrap" colspan="3"><input disabled="disabled" type="text" size="55" name="Desc" id="Desc" value="<cfif modoAnt neq 'Alta'>#rsAnt.GEAdescripcion#</cfif>"/></td>
			</tr>
	
	<!---CONCEPTO--->		
			<tr>
				<td  nowrap="nowrap" align="right" valign="top"><strong><cf_translate key = LB_ConceptoGasto xmlfile = "Tab1_Anticipos_form.xml">Concepto Gasto</cf_translate>:</strong></td>
				<td><input  disabled="disabled" type="text" name="Concepto" id="Concepto" value="<cfif modoAnt neq 'Alta'>#rsAnt.GECdescripcion#</cfif>"/></td>
			</tr>
	
	<!---TOTAL--->
			<tr>
				<td  nowrap="nowrap" align="right" valign="top"><strong><cf_translate key = LB_MontoAnticipo xmlfile = "Tab1_Anticipos_form.xml">Monto Anticipo</cf_translate>:</strong></td>
				<td>
					<cfset valor_montoT = 0 >
					<cfset valor_montoT = LSNumberFormat(abs(rsAnt.GEADmonto),"0.00") >		
	...
	<!---MONTOSaldo--->
		<tr>
			<td width="173" align="right" valign="top"><strong><cf_translate key = LB_SaldoAnticipo xmlfile = "Tab1_Anticipos_form.xml">Saldo Anticipo</cf_translate>:</strong></td>
			<td width="800"> 
				<cfif modoAnt EQ 'CAMBIO'>
	...
	<!---MONTOALIQUIDAR--->
		<tr>
				<td  nowrap="nowrap" align="right" valign="top"><strong><cf_translate key = LB_MontoLiquidar xmlfile = "Tab1_Anticipos_form.xml">Monto a Liquidar</cf_translate>:</strong></td>
				<td >
					<cfset valor_monto = 0 >
						<cfif modoAnt neq 'ALTA'>
							<cfset valor_monto = LSNumberFormat(abs(rsAnt.GELAtotal),"0.00") >
						</cfif>
