<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_NumLiquidacion" default ="N&uacute;m. Liquidaci&oacute;n" returnvariable="LB_NumLiquidacion" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Tipo" default ="Tipo" returnvariable="LB_Tipo" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_NumTransaccion" default ="N&uacute;m. Transacci&oacute;n" returnvariable="LB_NumTransaccion" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_OfiCentroFuncional" default ="Ofi:Centro Funcional" returnvariable="LB_OfiCentroFuncional" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_NombreEmpleado" default ="Nombre Empleado" returnvariable="LB_NombreEmpleado" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Fecha" default ="Fecha" returnvariable="LB_Fecha" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Moneda" default ="Moneda" returnvariable="LB_Moneda" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Gastos" default ="Gastos" returnvariable="LB_Gastos" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Estado" default ="Estado" returnvariable="LB_Estado" xmlfile = "GE_lista_GASTO.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Solicitante" default ="Solicitante" returnvariable="LB_Solicitante" xmlfile = "GE_lista_GASTO.xml">
...
<cfquery datasource="#session.dsn#" name="lista" maxrows="300">
    ...
    <cfif isdefined('Attributes.FormaPago') and len(trim(Attributes.FormaPago)) and Attributes.FormaPago EQ 'TES'>
		and not exists (select 1 from CCHica where CCHid = ant.CCHid)
	</cfif>	
    <cfif isdefined('Attributes.CancelacionLiq') and Attributes.CancelacionLiq>
		and not exists (select 1 from TESsolicitudPago tsp
        				where tsp.TESSPid = ant.TESSPid_Adicional)
	</cfif>	
...
<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
		...
		etiquetas="#LB_NumLiquidacion#,#LB_Tipo#,#LB_NumTransaccion#,#LB_NombreEmpleado#,#LB_Fecha#,#LB_Moneda#,#LB_Gastos#, #LB_Estado#, #LB_Solicitante#, #LvarMSGrechazo#"
