<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Titulo" default="Transacciones de Caja Chica" returnvariable="LB_Titulo"
xmlfile ="CCHReintegro.xml"/>
