...
<cfform action="catalogoItinerarioComision-SQL.cfm" method="post" name="form1" onSubmit="return validar(this);">
	<table align="center">
		<tr> 
			<td align="right" nowrap><cf_translate key=LB_CiudadOrigen>Ciudad Origen</cf_translate>:&nbsp;</td>
			<td>
		...
		<tr> 
			<td align="right" nowrap><cf_translate key=LB_CiudadDestino>Ciudad Destino</cf_translate>:&nbsp;</td>
			<td>
        ...
        <tr>
			<td nowrap align="right"><cf_translate key=LB_FechaSalida>Fecha de Salida</cf_translate>:&nbsp;&nbsp;</td>
			<td colspan="5"><cf_sifcalendario name="GECIfsalida" tabindex="1" value="#LSDateFormat(GECIfsalida,'dd/mm/yyyy')#"></td>
		</tr>
        <tr> 
      		<td nowrap align="right"><cf_translate key=LB_HoraInicio>Hora Inicio</cf_translate>:</td>
      		<td>
				<cf_hora name="GECIhinicio" form="form1" value="#GECIhinicio#">
			</td>
	    </tr>
		<tr> 
      		<td nowrap align="right"><cf_translate key=LB_HoraFin>Hora Fin</cf_translate>:</td>
			<td>
		...
		<tr> 
			<td align="right" nowrap><cf_translate key=LB_LineaAerea>Linea Aerea</cf_translate>:&nbsp;</td>
			<td>
		...
		<tr> 
			<td align="right" nowrap><cf_translate key=LB_NumeroVuelo>Numero de vuelo</cf_translate>:&nbsp;</td>
			<td>
