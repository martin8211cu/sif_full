...
<cfoutput>
	...
	/>
              ...
              <tr>
                ...
                <td align="right" nowrap="nowrap">
					<select name="TipoProveedor" id="TipoProveedor" onchange="
						...
						"
					>
						<option value="SN" <cfif modoD EQ "CAMBIO" and rsFormDet.SNcodigo NEQ "">selected</cfif>>Socio Negocio</option>
						<option value="B"  <cfif modoD EQ "CAMBIO" and rsFormDet.TESBid NEQ "">selected</cfif>>Beneficiario</option>
					</select>:
				</td>
              ...
              <tr>
				...
				<cfif modoD EQ "ALTA" AND LvarConPlanCompras>
					<select name="Tipo" id="tipo" disabled>
						<option value="">(Plan de Compras)</option>
					</select>
				<cfelseif modoD EQ "ALTA">
					<select name="Tipo" id="tipo" onchange="ajaxFunction_ComboConcepto();" tabindex="1">
					<cfif LvarHayAnts>
						<option value="0">(Anticipos)</option>
					</cfif>
					<cfloop query="rsTipoGasto">
						<option value="#rsTipoGasto.GETid#">#rsTipoGasto.GETdescripcion#</option>
					</cfloop>
					<option value="-1">(Impuestos Crédito Fiscal)</option>
					</select>
				<cfelse>
					...
					<span id="contenedor_Concepto">
						...
						<cfelseif modoD EQ "ALTA">
							...
							<cfloop query="rsID_concepto_gasto">
								<option value="#rsID_concepto_gasto.GECid#">#rsID_concepto_gasto.GECdescripcion#</option>
							</cfloop>
							</select>
						<cfelse>
							<select name="Concepto" id="Concepto" disabled>
							<cfloop query="rsID_concepto_gasto">
								<cfif rsID_concepto_gasto.GECid eq rsFormDet.GECid OR rsID_concepto_gasto.GECid eq rsFormDet.Icodigo>
									<option value="#rsID_concepto_gasto.GECid#"selected="selected">
					...
					<tr>
						...
						<!--- Tipo Cambio --->
		                    ...
		                    <cf_inputNumber name="GELGtipoCambio" value="#LvarMonto#" size="11" enteros="6" decimales="4" 
											onchange="CambiaTipoD()" onfocus="GvarFocus='TC';" 
						...
						<!--- Factor de Conversin--->
		                    ...
		                    <cf_inputNumber name="factor" value="#LvarMonto#" size="11" enteros="6" decimales="6" 
											onchange="CambiaFactorD()" onfocus="GvarFocus='FC';" 
			...
			<tr>
                ...
                <td valign="top">
                    <cf_inputNumber name="GELGmontoOri" value="#LvarMontoOri#" size="15" id="monto" enteros="13" decimales="2" tabindex="1" onChange="CambiaMontoD();" onfocus="GvarFocus='MD';" >
				...
				<td>
                    <cf_inputNumber name="GELGnoAutOri" value="#LvarNoAutOri#" size="15" id="monto" enteros="13" decimales="2" tabindex="1" onChange="CambiaMontoD();" onfocus="GvarFocus='MD';" >
