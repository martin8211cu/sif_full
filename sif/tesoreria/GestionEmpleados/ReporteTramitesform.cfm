<cf_navegacion name="LvarCFM">
<cf_navegacion name="LvarSAporEmpleadoSolicitante">

<cf_templatecss>
<cf_htmlReportsHeaders 
	irA="GEReportes#url.LvarCFM#.cfm"
...
<cfif rsDatosEmpleado.recordcount lte 0>
	...
	<cfquery  name="rsAnticipos" datasource="#session.DSN#">
        ...
        <cfif #url.LvarSAporEmpleadoSolicitante#>
    		and a.UsucodigoSolicitud=#session.Usucodigo#
    	</cfif>    
	...
	<cfquery name="rsLiquidacion" datasource="#session.DSN#">
		...
		<cfif #url.LvarSAporEmpleadoSolicitante#>
    		and l.UsucodigoSolicitud=#session.Usucodigo#
    	</cfif>    
