...
<cfset LvarSAporEmpleadoCFM = "Responsable">
<cfset GvarPorResponsable=true>
<cf_templateheader title="Reimpresión de Liquidaciones por Responsable"> 
	<cf_navegacion name="GELid" navegacion="">
		<cfset titulo = 'Reimpresión Liquidaciones de Empleados por Responsable'>
