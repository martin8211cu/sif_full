<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Anticipo" default ="Anticipo" returnvariable="LB_Anticipo" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Fecha" default ="Fecha" returnvariable="LB_Fecha" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Concepto" default ="Concepto" returnvariable="LB_Concepto" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Descripcion" default ="Descripcion" returnvariable="LB_Descripcion" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Moneda" default ="Moneda" returnvariable="LB_Moneda" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_MontoOriginalAnticipo" default ="Monto Original del Anticipo" returnvariable="LB_MontoOriginalAnticipo" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_SaldoAnticipo" default ="Saldo del Anticipo" returnvariable="LB_SaldoAnticipo" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_MontoLiquidar" default ="Monto a Liquidar" returnvariable="LB_MontoLiquidar" xmlfile = "TabT1_Anticipos_Aprobar.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Viatico" default ="Viatico" returnvariable="LB_Viatico" xmlfile = "TabT1_Anticipos_Aprobar.xml">
...
<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" 
				...
				etiquetas="#LB_Anticipo#,#LB_Fecha#,#LB_Concepto#,#LB_Descripcion#,#LB_Moneda#,#LB_MontoOriginalAnticipo#,#LB_SaldoAnticipo#,#LB_MontoLiquidar#,#LB_Viatico#, "
				formatos="S,D,S,S,S,M,M,M,S, G"
				align="right, center, left, left, center, right, right, right, center, right"
