...
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_NumTransaccion" default="Num. Transaccion" returnvariable="LB_NumTransaccion" 
xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_CajaChica" default="Caja Chica" returnvariable="LB_CajaChica" 
xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Transaccion" default="Transacci&oacute;n" returnvariable="LB_Transaccion" 
xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Estado" default="Estado" returnvariable="LB_Estado" xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Monto" default="Monto" returnvariable="LB_Monto" xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Moneda" default="Moneda" returnvariable="LB_Moneda" xmlfile ="CCHReintegro_lista.xml"/>
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Fecha" default="Fecha" returnvariable="LB_Fecha" xmlfile ="CCHReintegro_lista.xml"/>
<cfset navegacion=''>
...
<cfparam name="rsUsu.DEid" default="">
...
<cfquery name="rsSQL" datasource="#session.dsn#">
	select
		...
		tp.CCHcod,
		tp.Mcodigo,
		(select coalesce(sum(CCHTAmonto),0) from CCHTransaccionesAplicadas where CCHTtipo='GASTO' and CCHTAreintegro=tp.CCHTid) as disponible,
	...
	inner join CCHica c
		on c.CCHid=tp.CCHid
		and tp.CCHTtipo in ('REINTEGRO')
	<!---inner join CCHTransaccionesAplicadas ap
		on  ap.CCHTAreintegro=tp.CCHTid--->
	<cfif GvarPorResponsable>	
		and CCHresponsable=#rsUsu.DEid#
    </cfif>
	where 
...
<form name="form1" method="post">
	<table width="100%">
		<tr>
			...
			<td align="right">
				<strong><cf_translate key=LB_Fecha>Fechas</cf_translate>:</strong>
			</td>
		...
		<tr>
			...
			<td  align="right">
				<cfoutput><input type="submit" value="#BTN_Filtrar#" name="filtrar"></cfoutput>
			</td>
		</tr>
		<tr>
			<td nowrap="nowrap" colspan="6">
				<cfif not isdefined ('Attributes.entrada') or len(trim(Attributes.entrada)) eq 0>
				<input type="checkbox" name="chkRechazadas" onclick="irA()" <cfif isdefined ('form.chkRechazadas') and form.chkRechazadas eq 'on'>checked="checked"</cfif> /><strong><cf_translate key=LB_ListaTransaccionesRechazadas>Lista de Transacciones Rechazadas</cf_translate></strong>
		...
		<tr>
			<td colspan="7">
				<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
					query="#rsSQL#"
					columnas="CCHTid,CCHcodigo,Mcodigo,CCHTestado,disponible,CCHTtipo,CCHid,BMfecha,CCHcod,Moneda"
					desplegar="CCHcod,CCHcodigo,CCHTtipo,CCHTestado,disponible,Moneda,BMfecha"
					etiquetas="#LB_NumTransaccion#,#LB_CajaChica#,#LB_Transaccion#,#LB_Estado#,#LB_Monto#,#LB_Moneda#,#LB_Fecha#"
					formatos="S,S,S,S,M,S,D"
					align="left,left,left,left,right,center,left"
					ira="CCHReintegro.cfm?#LvarD#"
					incluyeForm="yes"
					formName="formX"
					form_method="post"
