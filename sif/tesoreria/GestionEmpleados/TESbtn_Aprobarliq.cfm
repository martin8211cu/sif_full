<cfinvoke component="sif.Componentes.Translate" method="Translate" key="CHK_ImprimirAnticipoEnviada" default ="Imprimir Anticipo enviada" returnvariable="CHK_ImprimirAnticipoEnviada" xmlfile = "TESbtn_Aprobarliq.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="CHK_ImprimirLiquidacionEnviada" default ="Imprimir Liquidacion enviada" returnvariable="CHK_ImprimirLiquidacionEnviada" xmlfile = "TESbtn_Aprobarliq.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="BTN_ListaLiquidaciones" default ="Lista Liquidacion" returnvariable="BTN_ListaLiquidaciones" xmlfile = "TESbtn_Aprobarliq.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key="MSG_DeseaAprobarLaLiquidacion" default ="¿Desea APROBAR la Liquidación" returnvariable="MSG_DeseaAprobarLaLiquidacion" xmlfile = "TESbtn_Aprobarliq.xml">
...
<cfset LvarInclude = "#LvarBotones#,irLista">
<cfparam name="LvarIncludeValues" default="">
<cfset LvarIncludeValues = "#LvarBotonesValues#,#BTN_ListaLiquidaciones#">
...
<cfif modo NEQ "ALTA">
	...
	{
		if (fnVerificaMonto())
			return confirm('<cfoutput>#MSG_DeseaAprobarLaLiquidacion#</cfoutput> ## #rsForm.GELnumero#?');
		else
			return false;
	}
