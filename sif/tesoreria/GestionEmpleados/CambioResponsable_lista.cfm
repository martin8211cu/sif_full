<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "LB_Codigo" default = "C&oacute;digo" returnvariable="LB_Codigo" xmlfile = "CambioResponsable_lista.xml">
<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "LB_Responsable" default = "Responsable" returnvariable="LB_Responsable" xmlfile = "CambioResponsable_lista.xml">
<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "LB_Moneda" default = "Moneda" returnvariable="LB_Moneda" xmlfile = "CambioResponsable_lista.xml">
<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "BTN_Filtrar" default = "Filtrar" returnvariable="BTN_Filtrar" xmlfile = "CambioResponsable_lista.xml">
<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "LB_Descripcion" default = "Descripci&oacute;n" returnvariable="LB_Descripcion" xmlfile = "CambioResponsable_lista.xml">
<cfinvoke component ="sif.Componentes.Translate" method = "Translate" key = "LB_Estado" default = "Estado" returnvariable="LB_Estado" xmlfile = "CambioResponsable_lista.xml">
...
<cfquery name="rsSQL" datasource="#session.dsn#">
	select c.CCHcodigo,c.CCHdescripcion,c.CCHid,CCHestado, (select (DEnombre#LvarCNCT#' '#LvarCNCT#DEapellido1#LvarCNCT#' '#LvarCNCT# DEapellido2) from DatosEmpleado where DEid=c.CCHresponsable) as responsable,
...
<form name="form1" method="post" action="CambioResponsable.cfm">
<cfoutput>
	<table width="100%">
		<tr>
			<td align="right">
		...
		<tr>
			<td colspan="7">
				<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
					...
					desplegar="CCHcodigo,CCHdescripcion,responsable,CCHestado"
					etiquetas="#LB_Codigo#,#LB_Descripcion#,#LB_Responsable#,#LB_Estado#"
					formatos="S,S,S,S"
					align="left,left,left,left"
					ira="CambioResponsable.cfm"
					incluyeForm="yes"
					formName="formX"
					form_method="post"
