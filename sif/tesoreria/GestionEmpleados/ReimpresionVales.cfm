<cfinvoke component="sif.Componentes.Translate" method="Translate" key="LB_Titulo" default="Reimpresión de Vales al Empleado" returnvariable="LB_Titulo" xmlfile ="ReimpresionVales.xml"/>
