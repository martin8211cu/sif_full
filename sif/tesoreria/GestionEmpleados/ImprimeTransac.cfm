<cf_htmlReportsHeaders 
	title="Aprobacion de Transacciones" 
	filename="Aprobar.xls"
	irA="AprobarTrans.cfm?Tipo=ANTICIPO&CCHTrelacionada=#form.GEAid#"
	download="no"
	preview="no"
>
	...
	<cfquery datasource="#session.dsn#" name="rsReporteTotal">
		...
		left join TESsolicitudPago x
			left join Usuario uR
					...
					on uR.Usucodigo=x.UsucodigoAprobacion
				left join Usuario uA
					on uA.Usucodigo=x.UsucodigoAprobacion			
				...
				<cfif rsReporteTotal.GEAidDuplicado EQ "">
					...
					<tr>
						<td style="border-top:solid 1px gray; padding-left:2px; padding-right:2px;">
							...
							#rsReporteTotal.GEAmsgRechazo#<!---#LvarTESSPnumD#--->
						</td>
					</tr>
				</cfif>
				</table>
