<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_PrimeroConcepto" default = "Digite primero el Concepto" 
returnvariable="LB_PrimeroConcepto" xmlfile = "verificaConcepto.xml"/>
<cfif url.concepto EQ "">
	<script language="javascript">
		alert('<cfoutput>#LB_PrimeroConcepto#</cfoutput>');
		<cfif url.dir eq 1>
