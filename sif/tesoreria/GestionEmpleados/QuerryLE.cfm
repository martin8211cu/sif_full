...
<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
		query="#lista#"
		Cortes="#LvarCortes#"
		desplegar="GELnumero,CFcodigo,Empleado,GELfecha,Moneda,GELtotalGastos,estado,usuario, GELmsgRechazo"
		etiquetas="Num.<BR>Liquidación,Ofi:Centro<BR>Funcional,Nombre Empleado,Fecha Liquidación, Moneda,   Gastos, Estado, Solicitante, #LvarMSGrechazo#"
