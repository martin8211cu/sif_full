...
<cfelseif rsReporteTotal.TESOPid NEQ ''>
	...
	<tr>
		...
		<tr><td height="22" align="center"><strong>#rsCodICTS.Edescripcion#</strong></td>
	</tr>
	<tr>
		...
		<cfelse>						
			<td height="20" align="center"><strong>Tipo de Pago: (Con Cheque o Transferencia)</strong></td>
		</cfif>
	</tr>
	<tr>
...
<cfloop query="rsReporteTotal">
 		 ...
 		 select Rubro = case  
		    when TESDPmoduloOri = 'CPFC' then (select top 1 case DD.DDtipo 
				...
				from TESsolicitudPago O
  				...
  				where  D.TESSPid =<cfqueryparam cfsqltype="integer"  value="#rsReporteTotal.TESSPid#">
			    ...
			    when TESDPmoduloOri = 'CPFC' then (select top 1 Rubro = case DD.DDtipo
					...
					where Ccodigo = 'AF') 
		 			...
		 			from TESsolicitudPago O
  					...
  					inner join HEDocumentosCP CP on CP.IDdocumento = D.TESDPidDocumento 
  					inner join HDDocumentosCP DD on DD.IDdocumento  = CP.IDdocumento 
  		  			where  D.TESSPid = <cfqueryparam cfsqltype="cf_sql_integer" value="#rsReporteTotal.TESSPid#">
                    and TESDPidDocumento = <cfqueryparam cfsqltype="cf_sql_integer" value="#rsReporteTotal.TESDPidDocumento#">
  					and D.TESDPtipoDocumento = <cfqueryparam cfsqltype="cf_sql_integer" value="#rsReporteTotal.TESDPtipoDocumento#">
		...
		from  TESdetallePago
		where TESSPid = <cfqueryparam cfsqltype="cf_sql_integer" value="#rsReporteTotal.TESSPid#">
	</cfquery>
