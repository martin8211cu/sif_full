...
<cfquery name="rsSQL" datasource="#session.dsn#">
	select 	c.CCHtipo,
			case c.CCHtipo when 1 then 'CAJAS CHICAS PARA COMPRAS MENORES:' else 'CAJAS ESPECIALES PARA ENTRADA Y SALIDA DE EFECTIVO:' end as tipo,
		...
		<tr>
			<td colspan="7">
				<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"
					...
					etiquetas="C&oacute;digo,Descripci&oacute;n,Responsable,Estado,Disponible,Moneda"
