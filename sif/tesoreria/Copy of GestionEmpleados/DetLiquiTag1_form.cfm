...
<cfset valuesArrayAnt = ArrayNew(1)>
	<cfif modo EQ "CAMBIO">
		...
		<cfelse>
				...
				campos = "TESSAid,TESSAnumero,TESSADescrip,CFcuenta,TESSAMonto" 
				desplegables = "N,S,S,N" 
				modificables = "S,S,S,S" 
				size = "10,5,40,0"
				asignar="TESSAid,TESSAnumero,TESSADescrip,CFcuenta,TESSAMonto"
				asignarformatos="S,S,S,S.S"
				tabla="GASTOE_SoliAnticipos"
				columnas="TESSAid,TESSAnumero,TESSADescrip,CFcuenta,TESSAMonto"
				filtro="Ecodigo = #Session.Ecodigo# and TESBid=#filtronombre.TESBid# and TESSAestado=2"
				desplegar="TESSAnumero,TESSADescrip,CFcuenta,TESSAMonto"
				etiquetas="NumeroSolicitud,Descripción,Detalle,Detalle"
				formatos="S,S,S,M"
				...
				left="70"
				top="20"
				filtrar_por="TESSAid,TESSAnumero,TESSADescrip,TESSAtotalPagarOri"
				index="3"			
				funcion="funcCargaMto"
                fparams="TESSAtotalPagarOri"
				debug="false"/>	</td>
		</cfif>
</tr>
