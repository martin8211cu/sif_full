...
<cfparam name="Attributes.Nombre" 			default="Nombre" 		type="string"> <!--- Nombres de la descripci&oacute;n del empleado --->
<cfparam name="Attributes.Pid" 				default="Pid" 			type="string"> <!--- Nombres de la descripci&oacute;n del empleado --->
...
<cfif isdefined("Attributes.idempleado") and len(trim(Attributes.idempleado)) >
	...
	<cfquery name="#queryDEid#" datasource="#session.DSN#">
		select GEAid,GEAnumero,GEAfechaPagar,GEAdescripcion,GEAtotalOri,TESBid
		from GEanticipo
		where GEAid=<cfqueryparam cfsqltype="cf_sql_numeric" value="#Attributes.idempleado#">
...
<script language="JavaScript">
	...
	function doConlisAnticipos<cfoutput>#Attributes.DEid#</cfoutput>() {
		...
		popUpWindow("/cfmx/sif/tesoreria/GestionEmpleados/ConlisAnticipos.cfm"+params,250,200,650,400);
	}
</script>
...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td nowrap>
			...
			<cfif Attributes.Conlis><a href="##" tabindex="-1"><img src="/cfmx/aspweb/imagenes/Description.gif" alt="Lista de Empleados" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript:doConlisAnticipos#Attributes.DEid#();'></a></cfif>
		</td>
		
	</tr>
	<input type="text" name="#Attributes.DEid#" id="#Attributes.DEid#" value="<cfif isdefined("Attributes.idempleado") and len(trim(Attributes.idempleado)) >#Trim(Evaluate(queryDEid).DEid)#</cfif>">
