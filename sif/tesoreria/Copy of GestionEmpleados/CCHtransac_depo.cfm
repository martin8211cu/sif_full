...
<table width="55%"  align="left">
		<tr>
			<cfoutput>
			<td valign="top"><strong><font  color="666666" style="background-color:CCCCCC">Monto a Depositar:#rsTot.CCHTmonto##rsMonedaLocalE.Miso4217#</font></strong>
			<strong><font  color="666666" style="background-color:CCCCCC">Monto Depositado:#rsDepoT.total##rsMonedaLocalE.Miso4217#</font></strong></td>
			</cfoutput>
		</tr>
		<tr>
			<td  valign="top">
				...
				etiquetas="Dep&oacute;sito, Fecha, Cuenta</br>Bancaria, Monto</br>Deposito, Monto"
				formatos="S,D,S,S,M"
  ...
  <form action="CCHtransac_sql.cfm" method="post" name="formDep" style="border:0px;" id="formDep" onSubmit="return validarDep(this);" >
			<td>
				<input type="submit" value="Aplicar" name="Confirmar" onClick="javascript: inhabilitarValidacion(); "  />
			</td>
		</tr>
	</table>
...
<!---Monto en moneda liquidante--->
		<tr>			
				<td nowrap="nowrap"  align="right"><strong>Monto Dep&oacute;sito:</strong></td>
				<td >
		...
		<tr >
			<td align="center" nowrap="nowrap" colspan="4">
				<cfif modo eq 'ALTA'>
				<input type="submit" name="Ingresar" value="Ingresar" onClick="javascript: habilitarValidacion(); " />
				<input type="submit" name="RegresarD" value="Regresar" onClick="javascript: inhabilitarValidacion(); "/>
				<cfelse>
				<input type="submit" name="NuevoD" value="Nuevo" onClick="javascript: inhabilitarValidacion(); " />
				<input type="submit" name="ModificarD" value="Modificar" onClick="javascript: habilitarValidacion(); " />
				<input type="submit" name="EliminarD" value="Eliminar" onClick="return confirm('¿Desea eliminar el registro de Depósito?');""  />
				<input type="submit" name="RegresarD" value="Regresar" onClick="javascript: inhabilitarValidacion(); " />
				</cfif>				
			</td>
		</tr>
