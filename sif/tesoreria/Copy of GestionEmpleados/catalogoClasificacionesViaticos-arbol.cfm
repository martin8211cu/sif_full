...
<cfquery datasource="#session.dsn#" name="ARBOL">
	select c.GECVid, c.GECVcodigo, c.GECVdescripcion, c.GECVnivel as nivel,  
	       ( select count(1) 
		     from GEClasificacionViaticos c2
...
<script language="JavaScript" type="text/javascript">
	...
	function eclk(arbol_pos){<!--- event: Click --->
		location.href="catalogoClasificacionesViaticos.cfm?ARBOL_POS="+arbol_pos+"<cfoutput>#JSStringFormat(QueryString_ARBOL)#</cfoutput>";
	}
</script>
...
<table cellpadding="0" cellspacing="1" border="0" width="100%">
	...
	<cfloop query="ARBOL">
		<tr valign="middle"	
			<cfif ARBOL.GECVcodigo is url.ARBOL_POS> class='ar1'
			<cfelse>class='ar2' onMouseOver="eovr(this)" onMouseOut="eout(this)" onClick="eclk('#ARBOL.GECVid#')"
			</cfif> >
			<td nowrap>
