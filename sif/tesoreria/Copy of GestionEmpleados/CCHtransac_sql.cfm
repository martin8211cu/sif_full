...
<cfif isdefined ('form.Rechazar')>
	...
	<cfquery name="rsRechaza" datasource="#session.dsn#">
		update CCHTransaccionesProceso set CCHTmsj='#form.motivo#',CCHTestado='RECHAZADO' where CCHTid=#form.CCHTid#
	</cfquery>
	<cflocation url="CCHtransacA.cfm">
</cfif>
...
<cfif isdefined ('form.Enviar')>
	...
	<cfinvoke component="sif.tesoreria.Componentes.TEScajaChica" method="CambiaEstadoTP">
		...
		<cfinvokeargument name="CCHtipo" 	value="#form.tipo#"/>
	</cfinvoke>	
	<cflocation url="CCHtransac.cfm">
</cfif>
...
<cfset LobjControl = createObject( "component","sif.Componentes.PRES_Presupuesto")>
	...
	<cfif rsSQL.CCHTtipo eq 'REINTEGRO' or rsSQL.CCHTtipo eq 'AUMENTO'>
	...
	<cfif rsSQL.CCHTtipo eq 'AUMENTO'>
		...
		<!---crear solicitud de pago de reintegro--->
	<cfif rsSQL.CCHTtipo eq 'REINTEGRO'>
		...
		<cfif rsSQL.CCHTtipo eq 'CIERRE' or rsSQL.CCHTtipo eq 'DISMINUCION'>
