	...
	<cfquery datasource="#session.dsn#" name="rsReporteTotal">
		...
		,{fn concat({fn concat({fn concat({fn concat(dp.Pnombre , ' ' )}, dp.Papellido1 )}, ' ' )}, dp.Papellido2 )} as confeccionadoPor
			...
			, case sa.GEAestado					
				...
				when 1   then 'En Proceso de Aprobaci&oacute;n'
				when 2   then 'Solicitud Aprobada'
				when 3   then 'Solicitud Rechazada'
				when 23  then 'Solicitud Rechazada en Tesorer&iacute;a'
				when 10  then 'Solicitud Aprobada e Incluida en Preparaci&oacute;n de OP. ' 
				when 101 then 'Solicitud Aprobada e Incluida en Proceso de Aprobaci&oacute;n de OP. ' 
				when 103 then 'Solicitud Rechazada en OP. '
				when 11  then 'Solicitud Aprobada e Incluida en Proceso de Emisi&oacute;n de OP. '
...
<cfif isdefined('rsReporteTotal') and rsReporteTotal.recordCount GT 0>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<cfif len(trim(#rsReporteTotal.CCHid#))>
				<cfif rsCajas.recordcount gt 0>
					<td colspan="4" align="center"><strong>Pagada por:#rsCajas.CCHcodigo#-#rsCajas.CCHdescripcion#</strong></td>
				</cfif>
			</cfif>
		</tr>
		...
		<tr>
			...
			<td nowrap align="right"><strong>NM.ANTICIPO:&nbsp;&nbsp;</strong></td>
		...
		<cfif isdefined ('form.TESSPid') and len(trim(#form.TESSPid#))>
			<tr>
				<cfif NOT listFind("0,1,3",rsReporteTotal.TESSPestado)>
					<td nowrap><strong>TESORERIA ASIGNADA:&nbsp;</strong></td>
					<td><span class="style4">#rsReporteTotal.TESdescripcion#</span></td>
				<cfelse>
					<td nowrap></td>
					<td></td>			
				</cfif>			
				<td nowrap align="right"><strong>NÚM. SP:&nbsp;&nbsp;</strong></td>
				<td nowrap align="center"><span class="style1">#rsReporteTotal.TESSPnumero#</span></td>
			</tr>
		</cfif>	
		...
		<tr>
	  	...
	  	<tr>
			...
			<td>#rsReporteTotal.GEAdescripcion#</td>
	  	</tr>
	...
	<table width="100%"  border="1" cellspacing="0" cellpadding="0" class="caja">
		  <tr>
			<td width="500">
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<!---<td width="150" bgcolor="##E4E4E4" align="center" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style7">CUENTA FINANCIERA</span></td>--->
					<td width="480" bgcolor="##E4E4E4" align="center" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style7">DETALLE DEL PAGO</span></td>
					<td width="450" bgcolor="##E4E4E4" align="center" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style7">Fechas</span></td>
					<td width="160" bgcolor="##E4E4E4" align="center" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style7">Monto</span></td>
					<!---<td width="210" bgcolor="##E4E4E4" align="center" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style7">CR&Eacute;DITO</span></td>--->
			...
			<!---	</table>					
			  ...
			  <cfloop query="rsReporteTotal">
				  ...
				  <tr class=<cfif LvarListaNon>"listaNon"<cfelse>"listaPar"</cfif> onmouseover="this.className='listaParSel';" onmouseout="this.className='<cfif LvarListaNon>listaNon<cfelse>listaPar</cfif>';">
					...
					<td align="left" style="border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style8">#rsReporteTotal.CFformato#</span></td>	--->					
					...
					<cfelse>
						...
						<td align="right" style="border-right-width: 1px; border-right-style: solid; border-right-color: gray;"><span class="style8">#LSNumberFormat(Abs(rsReporteTotal.GEADmonto),',9.00')#</span>&nbsp;&nbsp;</td>
					</cfif>--->
				  </tr>				  
			  </cfloop>		  
