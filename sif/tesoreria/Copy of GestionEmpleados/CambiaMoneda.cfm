...
<!---Impresiones de validaciones--->


<cfoutput>
<script language="javascript1.2" type="text/javascript">
<!---Caso 1 (Mlocal=MLiquidacion=Mdetalle)--->
	if (#rsMonedaLocal.Mcodigo# == #MonedaEncabezado.Mcodigo# && #MonedaEncabezado.Mcodigo# ==#McodigoOri# ) {	
			...
			<cfelse>
				...
				window.parent.document.formDep.factor.disabled=true;
					<cfif isdefined ('url.Monto')>
						window.parent.document.formDep.liqui.value=fm("#url.Monto#",4)
						window.parent.document.formDep.liqui.disabled=true;
					<cfelse>
						window.parent.document.formDep.liqui.value=fm(window.parent.document.formDep.montodep.value,4);
						window.parent.document.formDep.liqui.disabled=true;
...
<!---Caso 2 (Mlocal=MLiquidacion!=Mdetalle)--->
	...
	//alert('caso 2: local=liquidacion!=detalle');
			...
			window.parent.document.formDep.liqui.value=fm(MTotal,4);
			window.parent.document.formDep.liqui.disabled=true;
			window.parent.document.formDep.LvarMo.value="#rsMoneda.Miso4217#"
		}

<!---Caso 3 (MLiquidacion!=Mdetalle==Mlocal)--->
		if( #MonedaEncabezado.Mcodigo# !=  #McodigoOri# && #McodigoOri# == #rsMonedaLocal.Mcodigo#){
...
<!---Caso 4 (MLiquidacion==Mdetalle)--->
		if( #MonedaEncabezado.Mcodigo# ==  #McodigoOri# ){
