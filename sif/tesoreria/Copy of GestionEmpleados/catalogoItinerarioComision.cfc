<cfcomponent>
	<cffunction name="ALTA" access="public" returntype="numeric">
		...
		<cfargument name="GECInumeroVuelo"	type="numeric" 	required="no">        
		...
		<cfquery datasource="#session.dsn#">
			insert into GECitinerario (
   			...
   			values(
				...
				<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.GECInumeroVuelo#" null="#arguments.GECInumeroVuelo EQ ""#">,
	...
	<cffunction name="CAMBIO" access="public" returntype="numeric">
		...
		<cfquery datasource="#session.dsn#">
            ...
            set 		GECIorigen		= <cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.GECIorigen#" null="#arguments.GECIorigen EQ ""#">,     
                        ...
                        GECInumeroVuelo	= <cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.GECInumeroVuelo#" null="#Len(arguments.GECInumeroVuelo) is 0#">, 
