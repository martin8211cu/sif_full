...
<cfif isdefined("Form.CambioAnt")>
	...
	<cfif monto LT 0>					
		<cflocation url="LiquidacionAnticipos#url.tipo#.cfm?GELid=#form.GELid#&Mensaje=#mensaje#&GEADid=#form.GEADid#">
	<cfelse>
		<cftransaction>
		...
		<cflocation url="LiquidacionAnticipos#url.tipo#.cfm?GELid=#form.GELid#&GEADid=#GEADid#"> 
	</cfif>
</cfif>
