			...
			function funcImprimir()
				{
					...
					var url ='/cfmx/sif/Utiles/genImpr.cfm?archivo=#JSStringFormat("/sif/tesoreria/GestionEmpleados/imprValeA_form.cfm")#  &imprime=1&GEAid=#form.id#';	
					<cfelse>
var url ='/cfmx/sif/Utiles/genImpr.cfm?archivo=#JSStringFormat("/sif/tesoreria/GestionEmpleados/imprVale_form.cfm")# &imprime=1&GELid=#form.id#';
					</cfif>			
