...
<table width="100%" cellpadding="0" cellspacing="0" border="0">	
	...
	<tr class="listaPar" align="center">
		<td align="center"  style="font-size:16px" colspan="3">
			<strong>Reporte de Estado de Cuenta por Empleado</strong>
		</td>
	</tr>
	<tr class="listaPar" align="center">
		<td align="center" >
			...
			<table width="100%" cellpadding="2" cellspacing="0" border="1">	
				<cfoutput>		
					<tr bgcolor="CCCCCC" nowrap="nowrap" style="background-color:CCCCCC" align="center" class="tituloListas">
						<td width="8%" colspan="0" align="left" nowrap="nowrap">N°Liquidaci&oacute;n</td>
						<td width="16%" colspan="0" align="left" nowrap="nowrap">Empleado</td>
						<td width="14%" colspan="0" align="left" nowrap="nowrap">Fecha</td>
						<td width="35%" colspan="0" align="left" nowrap="nowrap">Descripción</td>
						<td width="15%" colspan="0" align="left" nowrap="nowrap">Estado</td>
						<td width="35%" colspan="0" align="left" nowrap="nowrap">Monto Anticipos</td>
						<td width="35%" colspan="0" align="left" nowrap="nowrap">Monto Gastos</td>
						<td width="35%" colspan="0" align="left" nowrap="nowrap">Monto Depósito</td>
						<td width="18%" colspan="0" align="left" nowrap="nowrap">Pago al Empleado</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">N° Solicido Pago/Estado</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">N° Orden Pago/Estado</td>
					</tr>
...
<cfif isdefined ('form.formaPago') and form.formaPago gt 0 or form.formaPago EQ "">
	<cfif rsReporteCCH.recordcount gt 0>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td align="center" colspan="8">
					<strong>Liquidaciones pagadas por Caja Chica</strong>
				</td>
			</tr>	
		</table>
		</cfoutput>
			...
			<table width="100%" cellpadding="2" cellspacing="0" border="1">	
					<cfoutput>	
					<tr bgcolor="CCCCCC" nowrap="nowrap" style="background-color:CCCCCC" align="center" class="tituloListas">
						<td width="9%" colspan="0" align="left" nowrap="nowrap">N°Liquidaci&oacute;n</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">Empleado</td>
						<td width="8%" colspan="0" align="left" nowrap="nowrap">Fecha</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">Descripción</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">Caja Chica</td>
						<td width="10%" colspan="0" align="left" nowrap="nowrap">Estado/N°Reintegro/N°SP/N°OP</td>
						<td width="11%" colspan="0" align="left" nowrap="nowrap">Monto Anticipos</td>
						<td width="12%" colspan="0" align="left" nowrap="nowrap">Monto Gastos</td>
						<td width="11%" colspan="0" align="left" nowrap="nowrap">Monto Depósito</td>
						<td width="9%" colspan="0" align="left" nowrap="nowrap">Pago al Empleado</td>
					</tr>
		...
		<table width="100%" cellpadding="2" cellspacing="0" border="0">
			...
			<tr>
				<td align="center" colspan="8">
					<strong>Anticipos Sin Forma de Pago Definida</strong>
				</td>
			</tr>	
			</cfoutput>
		</table>
		...
		<table width="100%" cellpadding="2" cellspacing="0" border="1">	
			<cfoutput>		
				<tr bgcolor="CCCCCC" nowrap="nowrap" style="background-color:CCCCCC" align="left" class="tituloListas">
					<td width="7%" colspan="0" align="left" nowrap="nowrap">N°Anticipo</td>
					<td width="15%" colspan="0" align="left" nowrap="nowrap">Empleado</td>
					<td width="13%" colspan="0" align="left" nowrap="nowrap">Fecha</td>
					<td width="17%" colspan="0" align="left" nowrap="nowrap">Pago al Empleado</td>
					<td width="32%" colspan="0" align="left" nowrap="nowrap">Descripción</td>
					<td width="16%" colspan="0" align="left" nowrap="nowrap">Estado</td>
				</tr>
					<cfloop query="antiND">
						<tr class="<cfif currentrow mod 2>listaPar<cfelse>listaNon</cfif>">
							<td align="left" style="font-size:9px">
	...
	<cfif isdefined ('form.formaPago') and form.formaPago EQ 0 or form.formaPago EQ "">	
		...
		<table width="100%" cellpadding="2" cellspacing="0" border="0">
			...
			<tr>
				<td align="center" colspan="8">
					<strong>Anticipos Pagados por Tesorería</strong>
				</td>
			</tr>	
			</cfoutput>
		</table>
	...
	<cfif isdefined ('form.formaPago') and form.formaPago GT 0 or form.formaPago EQ "">		
		...
		<table width="100%" cellpadding="2" cellspacing="0" border="0">
			...
			<tr>
				<td align="center" colspan="8">
					<strong>Anticipos Pagados por Caja Chica</strong>
				</td>
			</tr>	
			</cfoutput>
		</table>
		...
		<table width="100%" cellpadding="2" cellspacing="0" border="1">	
			<cfoutput>		
				<tr bgcolor="CCCCCC" nowrap="nowrap" style="background-color:CCCCCC" align="left" class="tituloListas">
					<td width="9%" colspan="0" align="left" nowrap="nowrap">N°Anticipo</td>
					<td width="10%" colspan="0" align="left" nowrap="nowrap">Empleado</td>
					<td width="10%" colspan="0" align="left" nowrap="nowrap">Caja Chica</td>
					<td width="10%" colspan="0" align="left" nowrap="nowrap">Fecha</td>
					<td width="13%" colspan="0" align="left" nowrap="nowrap">Pago al Empleado</td>
					<td width="34%" colspan="0" align="left" nowrap="nowrap">Descripción</td>
					<td width="14%" colspan="0" align="left" nowrap="nowrap">Estado</td>
