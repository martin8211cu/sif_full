<cfset LvarTitulo = "Reporte de Obras terminadas no liquidadas">
<cf_templateheader title="#LvarTitulo#">
	<cf_web_portlet_start titulo="#LvarTitulo#">
		<form name="form_filtro" method="post" action="obrasXasiento_imprimir.cfm">
		<table width="100%" align="center">
			<tr>
				...
				<td colspan="2">
					<cf_conlis
						...
						Asignar="OBTPid, OBTPcodigo, OBTPdescripcion, Cmayor, Cformato1=Cmayor, MaxNivel"
			...
			<tr>
				<td><strong>Para los meses:</strong></td>
				<td>
					...
					<select name="Speriodo1">
						<cfif rsPeriodos.recordcount GT 0 and LEN(TRIM(rsPeriodos.ini)) and LEN(TRIM(rsPeriodos.fin))>
							<cfloop index="LvarPer" from="#rsPeriodos.fin#" to="#rsPeriodos.ini#" step="-1">
								<cfoutput>
								<option value="#LvarPer#">#LvarPer#</option>
								</cfoutput>
							</cfloop>
						</cfif>
					</select>
			...
			<tr>
				...
				<td nowrap>
					<input type="text" name="Cformato1" size="40">
					<input type="text" name="Cformato2" size="40">
				</td>
			</tr>
	...
	<cf_qforms form="form_filtro" objForm="LvarQForm_OBetapa" onsubmit="fnDeshabilitarSubmit">
		...
		<cf_qformsRequiredField args="Cformato1,Formato de la Cuenta,fnCformato1">
