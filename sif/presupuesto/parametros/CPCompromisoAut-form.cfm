...
<form action="CPCompromisoAut-SQL.cfm" method="post" name="form1" onSubmit="return ValidaIngreso(this);">
<cfinclude template="../../Utiles/sifConcat.cfm">
	...
	select 
		...
		as Periodo	
	from CPresupuestoComprometidas a		
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" >
    	...
    	<tr>
	      	<td colspan="5" align="center" class="tituloListas">Configuraci&oacute;n de Cuentas de Presupuesto Comprometidas Automáticamente</td>
    	</tr>
...
<script language="JavaScript1.2">
	...
	function borrar(cuenta){
		...
		document.form1.action = "CPCompromisoAut-SQL.cfm";	
