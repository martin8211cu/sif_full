...
<script language="javascript" type="text/javascript">
	function ValidaIngreso(form){
		...
		if 	(document.form1.CPmascaraExcepciones.value == "")
		{
...
<form action="cuentasTipoPresupuestoSQL.cfm" method="post" name="form1" onSubmit="return ValidaIngreso(this);">

<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" >
        <tr><td>&nbsp;</td></tr>
    
    	<tr>
	      	<td colspan="5" align="center" class="tituloListas">Representa los Origen de Fondos o Fuentes de Financiamiento:</td>
    	</tr>
        
        <tr> 
       		<td>&nbsp;</td>
       		<td align="right"> 
				<strong>Todas las cuentas de Ingresos</strong>:&nbsp;
			</td>
       		<td>&nbsp;</td>
            <td> 
				(excepto las especiales de Egresos Presupuestales)
			</td>
       		<td>&nbsp;</td>
		</tr>
        ...
        <tr>
       		<td>&nbsp;</td>
       		<td align="right"> 
				<strong>Todas las cuentas de Capital</strong>:&nbsp;
			</td>
       		<td>&nbsp;</td>
            <td> 
				(excepto las especiales de Egresos Presupuestales)
         ...
         <tr>
       		<td>&nbsp;</td>
       		<td align="right"> 
				<strong>Todas las cuentas de Pasivo</strong>:&nbsp;
			</td>
       		<td>&nbsp;</td>
            <td> 
				(excepto las especiales de Egresos Presupuestales)
    	...
    	<tr>
	      	<td colspan="5" align="center" class="tituloListas">Cuentas especiales de Activos y Gastos para Ingresos Presupuestales:</td>
    	</tr>
        	...
        	<td colspan="5">
            	<table border="0">
        			...
        			<tr>
        				...
        				<td>&nbsp;</td>
        	        	<td align="rigth">			
							<cf_cajascuenta index="1" form="form1" tabindex="2" objeto="CPmascaraExcepciones" presupuesto="true" CMtipos="A,G">
						</td>
             			<td>&nbsp;</td>
        			</tr>
				</table>
	...
	from CPtipoCtas a		
		inner join CPresupuestoPeriodo b
    		on b.CPPid = a.CPPid     	
    where a.CPTCtipo  = <cfqueryparam cfsqltype="cf_sql_char" value="I">
			...
			<cfoutput query="rsLineas"> 
                <tr style="cursor: pointer;"
                    ...
                    <td width="17%">#replace(rsLineas.CPTCmascara,"_","?","ALL")#</td>
                   	<td width="1%">
                        <a href="javascript:borrar('#rsLineas.CPTCid#', '#rsLineas.CPTCtipo#');">
...
<script language="JavaScript1.2">
	...
	function borrar(cuenta, tipo){
		if ( confirm('¿Desea borrar esta cuenta de la lista?') ) {
		document.form1.action = "cuentasTipoPresupuestoSQL.cfm";	
		document.form1.BorrarD.value = "BORRAR";
