...
<script language="javascript" type="text/javascript">
	function ValidaCostos(form){
		if (window.FrameFunction) FrameFunction();
		if 	(document.form3.CPmascaraExcepciones.value == "")
		{
...
<form action="cuentasTipoPresupuestoSQL.cfm" method="post" name="form3" onSubmit="javascript: return ValidaCostos(this);">
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" >
		<tr><td>&nbsp;</td></tr>
    
    	<tr>
       		<td colspan="5" align="center" class="tituloListas">Representa dentro del Presupuesto de Egresos Presupuestales aquellos que corresponden a los Costos de Operación:</td>
    	</tr>
    	...
    	<tr>
       		<td>&nbsp;</td>
	      	<td align="center" class="tituloListas">Cuentas especiales para costos:</td>
          	<td>&nbsp;</td>
    	</tr>
            	...
            	<table border="0">
        			...
        			<tr>
        	        	...
        	        	<td align="rigth" colspan="2">				
							<cf_cajascuenta index="3" form="form3" tabindex="2" objeto="CPmascaraExcepciones" presupuesto="true">
						</td>
             			<td>&nbsp;</td>
        			</tr>
				</table>
	...
	from CPtipoCtas a		
		inner join CPresupuestoPeriodo b
    		on b.CPPid = a.CPPid     	
    where a.CPTCtipo = <cfqueryparam cfsqltype="cf_sql_char" value="C">
...
<script language="JavaScript1.2">
	...
	objForm3.CPPid.required = true;
	objForm3.CPPid.description="Periodo del Presupuesto";
	
	objForm3.Descripcion.required = true;
	objForm3.Descripcion.description="Descripción";
			
	objForm3.txt_Cmayor3.required = true;
	objForm3.txt_Cmayor3.description="Mascara";
				
	function deshabilitarValidacion(){
		objForm3.CPPid.required = false;
		objForm3.Descripcion.required = false;
		objForm3.txt_Cmayor3.required = false;
	}
		
	function borrar3(cuenta, tipo){
		if ( confirm('¿Desea borrar esta cuenta de la lista?') ) {
		document.form3.action = "cuentasTipoPresupuestoSQL.cfm";	
		document.form3.BorrarD.value = "BORRAR";
		document.form3.CPTCid.value = cuenta;
		document.form3.CPTCtipo.value = tipo;
