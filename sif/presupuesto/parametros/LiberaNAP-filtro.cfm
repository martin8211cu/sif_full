...
<cfoutput>	
<form name="form1"style="margin:0;" method="post" action="LiberaNAP.cfm">
...
<cfif isdefined("form.btnFiltrar")>
	<cfquery name="rsLista" datasource="#Session.DSN#">
		...
		order by Pdescripcion desc, a.CPNAPnum desc
	</cfquery>
	...
	<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="desplegar" value="CPNAPnum, CPNAPmoduloOri, CPNAPdocumentoOri, CPNAPreferenciaOri, CPNAPfechaOri, CPNAPfecha, monto, NombreAutoriza"/>
			<cfinvokeargument name="etiquetas" value="NAP, Modulo, Documento, Referencia, Fecha<BR>Documento, Fecha<BR>Autorizacion, Monto<BR>Autorizado<BR>#LvarMnombreEmpresa#, &nbsp;Autorizado por"/>
			<cfinvokeargument name="cortes" value="Pdescripcion"/>
			<cfinvokeargument name="formatos" value="V,S,S,S,D,D,M,V"/>
			<cfinvokeargument name="align" value="right,center,left,left,center,center,right,left"/>
