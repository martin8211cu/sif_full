...
<script language="javascript" type="text/javascript">
	function funcNuevo() {
		document.listaReserva.CPDEID.value = "";
	}
</script>

<form name="filtroAcciones" method="post" action="reserva-lista.cfm">
    ...
    <td>
		<cfquery name="rsListaQRY" datasource="#Session.DSN#">
			select 
				   ...
				   a.CPDEdescripcion, 
				   case when a.CPDEsuficiencia = 1 then 'Sí' end as suficiencia, 
				   a.Usucodigo, 
			...
			order by b.CPPfechaDesde desc, a.CPDEnumeroDocumento
		</cfquery>
	  ...
	  <cfinvoke 
		 ...
		 returnvariable="pListaRet">
		  ...
		  <cfinvokeargument name="desplegar" value="CPDEnumeroDocumento, CPDEdescripcion, CPDEfechaDocumento, CFcodigo, suficiencia"/>
		  <cfinvokeargument name="etiquetas" value="No. Documento, Descripci&oacute;n, Fecha, Centro Funcional, Suf"/>
		  <cfinvokeargument name="formatos" value="V,V,D,S,S"/>
		  <cfinvokeargument name="align" value="left, left, center, left, center"/>
		  <cfinvokeargument name="ajustar" value="N"/>
		  <cfinvokeargument name="formName" value="listaReserva"/>
		  <cfinvokeargument name="keys" value="CPDEid"/>
		  <cfinvokeargument name="botones" value="Nuevo"/>
		  <cfinvokeargument name="irA" value="reserva.cfm"/>
