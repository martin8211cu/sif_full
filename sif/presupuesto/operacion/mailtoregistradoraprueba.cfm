...
<body>
<cfoutput>
	<p> El traslado registrado por un monto de #LSCurrencyFormat(Lvar_MontoOrigen,'none')# fue aprobado por el Centro Funcional
	#Lvar_CFaprueba# por #Lvar_nombrefrom#.</p>
