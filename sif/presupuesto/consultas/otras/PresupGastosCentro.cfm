...
<cfquery name="rsReporte" datasource="#session.dsn#">	
	...
	cpc.CPCpresupuestado + cpc.CPCmodificado + cpc.CPCvariacion + cpc.CPCtrasladado + cpc.CPCtrasladadoE + cpc.CPCmodificado as PresupuestoAutorizado , 
...
<cfreport format="flashpaper" query="rsReporte" template="PresupGastosCentro.cfr">
