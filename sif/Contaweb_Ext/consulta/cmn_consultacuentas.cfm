...
<cfquery name="param_ano" datasource="#session.dsn#">
Select '2007' as CGPANO
</cfquery>


<cfif param_ano.recordcount gt 0>

	<cfset Vano = param_ano.CGPANO>
...
<body>
    ...
    <area shape="rect" coords="332,3,456,27" href="http://10.129.20.145/cfmx/sif/Contaweb_Ext/consulta/cmn_consultacuentas.cfm">

    <area shape="rect" coords="194,2,256,30" href="http://intranet.ice/daf/contabilidad/codigoweb/home.htm">

    <area shape="rect" coords="468,1,538,31" href="http://intranet.ice/daf/contabilidad/codigoweb/segmentos/SEGMENTOS.htm">

    <area shape="rect" coords="551,3,635,25" href="http://intranet.ice/daf/contabilidad/codigoweb/actualizacion/formularindex.htm" target="_blank">

    <area shape="rect" coords="260,3,327,29" href="http://intranet.ice/daf/contabilidad/codigoweb/codigo/Codigomain.htm">

    <area shape="rect" coords="636,3,701,23" href="http://intranet.ice/daf/contabilidad/codigoweb/Glosario/Glosariohome.htm">

    <area shape="rect" coords="704,2,772,26" href="http://intranet.ice/daf/contabilidad/codigoweb/criterio/Criteriohome.htm">
		...
		<!---********************************************************************************* --->
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<cf_sifcalendario name="txtFecha" value="#LSDateFormat(Now(),'dd/mm/yyyy')#"  tabindex="1">			  			  

						<input type="hidden"

						name="txtperiodo" id="txtperiodo"
				...
				<tr>
					...
					<td width="92%">
						<img 	id="img_plan"	
								alt="Estructura de Máscara y Detalle del Plan de Cuentas" 
				...
				<tr>
					...
					<td  colspan=" 2" width="20%">
						...
						<iframe id="FRAMECJNEGRA2" name="FRAMECJNEGRA2" marginheight="0" marginwidth="0" frameborder="0" height="300" width="770" src="" scrolling="yes" style="visibility:"></iframe>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	function valida(){
		...
		if (document.form1.CGE5COD.value == "" || document.form1.CGE5DES.value == "") { alert("Para la verificación de la cuenta es requerido digitar el segmento"); document.form1.CGE5COD.focus();return false}
		...
		if (document.form1.txtperiodo.value == "") { alert("Debe digitar el periodo contable");  document.form1.txtperiodo.focus();return false}
	...
	function  consultar(){
		...
		if(valida()){
			...
			var  params = "?CGE5COD="+document.form1.CGE5COD.value+"&CGM1IM="+document.form1.CGM1IM.value+"&CGM1CD="+document.form1.CGM1CD.value+"&PERIODO="+document.form1.txtperiodo.value+"&FechaCta="+document.form1.txtFecha.value+"&MASCARA="+document.form1.MASCARA.value;
	...
	{
		var V_fecha = document.form1.txtFecha.value;
		var V_mayor = document.form1.CGM1IM.value;
		var V_Oficina = document.form1.Ocodigo.value;

		<cfoutput>
		var LvarParam = "/cfmx/sif/Utiles/ConlisCuentasFinancierasL.cfm?Ecodigo=#URLEncodedFormat(session.Ecodigo)#&Cmayor=" + V_mayor + "&CPVfecha=" + V_fecha + "&Ocodigo=" + V_Oficina;
		</cfoutput>
		var x = window.open(LvarParam,"PlanCuentas","height=350, width=600,resizable=yes,menu=no,scrollbars=no,toolbar=no,menubar=no,personalbar=no,status=no,location=no");
		x.focus();
	}
</script> 
