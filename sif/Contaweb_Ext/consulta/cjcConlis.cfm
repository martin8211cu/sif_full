...
<cfparam name="Attributes.name" 						 				type="string">	<!--- Nombre del Cdigo --->

<cfparam name="Attributes.desc" 								 		type="string"> 	<!--- Nombre de la Descripcin --->

<cfparam name="Attributes.id"    		default="#Attributes.name#" 	type="string"> 	<!--- Nombre de la Descripcin --->

<cfparam name="Attributes.name2"   		default="#Attributes.desc#" 	type="string"> 	<!--- Nombre de la Descripcin --->

<cfparam name="Attributes.desc2"   		default="#Attributes.desc#" 	type="string"> 	<!--- Nombre de la Descripcin --->

<cfparam name="Attributes.frame" 		default="frConlis" 				type="string">	<!--- Nombre del frame --->

<cfparam name="Attributes.tabindex" 	default="" 						type="string">	<!--- nmero del tabindex --->

<cfparam name="Attributes.size" 		default="40" 					type="string">	<!--- tamao del objeto de la descripcion --->
...
<script language="JavaScript" type="text/javascript">
	...
	function doCJC_Conlis<cfoutput>#Attributes.name#</cfoutput>() {
		...
		popUpWindow<cfoutput>#Attributes.name#</cfoutput>("/cfmx/sif/Contaweb_Ext/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>.cfm"+params,250,200,650,400);

	}



	//Obtiene la descripcin con base al cdigo
	...
	function TraeDescripcion<cfoutput>#Attributes.name#</cfoutput>(dato) {
		...
		if (dato != "") {
			...
			frame.src = "/cfmx/sif/Contaweb_Ext/Utiles/<cfoutput>#Attributes.cjcConlisT#</cfoutput>query.cfm?dato="+dato+"&form="+'<cfoutput>#Attributes.form#</cfoutput>'+params;
			...
			//document.<cfoutput>#Attributes.form#</cfoutput>.CGM1IM.value = "";
			if (document.<cfoutput>#Attributes.form#</cfoutput>.CGM1IM.disabled == false && document.<cfoutput>#Attributes.form#</cfoutput>.CGM1IM.value != "")
			{
				ValidaCuenta(document.<cfoutput>#Attributes.form#</cfoutput>.CGM1IM.value);
				limpiaframe();
			}
			document.<cfoutput>#Attributes.form#</cfoutput>.CGM1IM.disabled = false;
...
<table width="" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td nowrap>
			...
			<a id="#Attributes.name#IMG" href="##" tabindex="-1" style="visibility:visible"><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de seleccin" name="imagen" width="18" height="14" border="0" align="absmiddle" onClick='javascript: doCJC_Conlis#Attributes.name#();'></a>
