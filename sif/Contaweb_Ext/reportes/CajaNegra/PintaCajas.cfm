...
<cfquery name="blackbox" datasource="#session.dsn#">
	<!---
	...
	Select  b.PCEMid as CG15ID , PCNid as CG13ID , PCNlongitud as CG16NE
	from CFinanciera a
			...
			inner join PCNivelMascara b
				on b.PCEMid = c.PCEMid
