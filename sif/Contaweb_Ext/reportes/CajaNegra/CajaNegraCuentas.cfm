<!--- <table width="100%" border="0"  id="tblcajanegra">
	...
	<tr> --->
		...
		<td width="83%"  colspan="3" nowrap>
			...
			<input 	tabindex="1" type="textbox" name="CG13ID_1"  ID="CG13ID_1"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,1)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_2"  ID="CG13ID_2"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,2)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_3"  ID="CG13ID_3"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,3)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_4"  ID="CG13ID_4"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,4)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_5"  ID="CG13ID_5"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,5)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_6"  ID="CG13ID_6"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,6)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_7"  ID="CG13ID_7"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,7)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_8"  ID="CG13ID_8"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,8)"  > 

			<input 	tabindex="1" type="textbox" name="CG13ID_9"  ID="CG13ID_9"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,9)"  >

			<input 	tabindex="1" type="textbox" name="CG13ID_10" ID="CG13ID_10"  size="1" maxlength="4"	style="visibility:hidden;" onfocus= "javascript: limpiaframe();escuenta(this,event,10)"  >
		...
		<iframe id="FRAMECJNEGRA" name="FRAMECJNEGRA" marginheight="0" marginwidth="0" frameborder="1" height="0" width="0" src="" style="visibility:hidden"></iframe>
...
function PintaCajas(mayor,detalle) {
	...
	var per = document.form1.txtperiodo.value

	if (per == '')

	{

		alert("Es necesario indicar el periodo")
...

	{
		...
		PARAMS = PARAMS + "&PERIODO=" + per

		var frame  = document.getElementById("FRAMECJNEGRA");

		frame.src 	= "/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/PintaCajas.cfm" + PARAMS;
...
function ValidaCuenta(mayor) {
...

	{
		...
		frame.src 	= "/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/ValidaCuenta.cfm" + PARAMS;
...

	{
...

		{
			...
			{										
				...
				open("/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/ConlisCuentaMayor.cfm"+params,"",formato);
...

			{
				...
				frame.src 	= "/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/ConlisCuentaMayor.cfm"+params;
...

{
    ...
    if(t==TECLA_CONLIS){
		...
		if((StringNivel.indexOf('_') == -1 )){
			...
			var CPVFecha = document.form1.txtFecha.value;
			
			var OFICINA = document.form1.CGE5COD.value;

			var ValNivelAnt = ''
			if (NIVEL > 1)
			{
				LvarNivelAnt = NIVEL-1;
				ValNivelAnt = eval('document.form1.CG13ID_' + LvarNivelAnt + '.value');
			}
			
			params = "?CGM1IM="+CGM1IM+"&NIVEL="+NIVEL+"&StringNivel="+StringNivel+"&ORIGEN="+ORIGEN+"&CPVfecha="+CPVFecha+"&ValNivelAnt="+ValNivelAnt+"&OFICINA="+OFICINA;
...

			{
				...
				{			
					...
					open("/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/ConlisCuentaDetalle.cfm"+params,"",formato);
...

				{
					...
					frame.src 	= "/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/ConlisCuentaDetalle.cfm"+params;
...
function cargadetalle() {
	...
	if(document.form1.CGM1IM.value != ""){	
		...
		//alert("Para la verificación de la cuenta es requerido digitar el segmento")
...

{
...

	{
		...
		frame.src 	= "/cfmx/sif/Contaweb_Ext/reportes/CajaNegra/validainfo.cfm" + PARAMS;
