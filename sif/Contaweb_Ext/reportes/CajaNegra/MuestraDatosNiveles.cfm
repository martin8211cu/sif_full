...
<body style="margin:0;">
	...
	<cfif isdefined("url.accion") and url.accion eq "exportar">
		...
		<cfquery name="Niveles" datasource="#session.dsn#">
			...
			where c.PCEcatid = #form.CatalogoID#
				and c.PCEactivo = 1
	...
	<cfelse>
		<script language="javascript" type="text/javascript">
			...
			function AsignarNivel(CG12ID, descr) {
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="3">
					  <tr>
						...
						<td align="center">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<input name="btnExportar" type="button" value="#BTN_Exportar#" onclick="window.location='MuestraDatosNiveles.cfm?#CGI.QUERY_STRING#&accion=exportar'">
