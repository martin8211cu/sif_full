...
<cfif bcheck0>
	<cfquery name="rsCheck1" datasource="#Session.DSN#">
        ...
        where not exists (select 1 
                        from SNegocios
                        where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Ecodigo#"> 
                        and (SNnumero = a.SNcodigoext or SNcodigoext = a.SNcodigoext)
...
<cfif bcheck4>
	<cfquery name="rsCheck5" datasource="#Session.DSN#">
        ...
        (	select 1
            ...
            and (s.SNnumero = a.SNcodigoext or s.SNcodigoext = a.SNcodigoext)
...
<cfif bcheck5>
    ...
    <cfif isdefined("rsCuentas") and rsCuentas.recordcount GTE 1>
    	<cfloop query="rsCuentas">
        	<!--- Obtiene el CFcuenta--->
            ...
            <cfquery name="rsSNcodigo" datasource="#session.DSN#">
                ...
                from SNegocios
                where Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Ecodigo#">
                and (SNnumero 	 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsCuentas.SNcodigoext#">
				  or SNcodigoext = <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsCuentas.SNcodigoext#">) 
            </cfquery>
			<cfif rsCuentas.Modulo EQ "CC">
                <cfquery datasource="#session.DSN#">
                    ...
                    (<cfqueryparam cfsqltype="cf_sql_numeric" value="#Session.Ecodigo#">,
                     ...
                     <cfqueryparam cfsqltype="cf_sql_numeric" value="#rsCFcuenta.CFcuenta#">,
