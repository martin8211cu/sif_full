<cfif modo neq 'ALTA'>
	<cfquery name="rsForm" datasource="sifcontrol">
		select
			...
			EIcfimporta, EIcfexporta,EIcfparam, charset 
		from EImportador a
...
<cfoutput>
	<table border="0" width="980" cellpadding="0" cellspacing="0" align="center">
		...
		<tr><td colspan="5" class="tituloAlterno"><cf_translate  key="LB_EncabezadodeFormato">Encabezado de Formato</cf_translate></td></tr>
		...
		<tr>
		  <td><select name="EIdelimitador" tabindex="1">
            ...
            <option value="T" <cfif modo neq 'ALTA' and rsForm.EIdelimitador eq 'T'>selected</cfif> ><cf_translate  key="CMB_Tab">Tab</cf_translate></option>
            ...
            <option value="X" <cfif modo neq 'ALTA' and rsForm.EIdelimitador eq 'X'>selected</cfif> ><cf_translate  key="CMB_PComa">Punto y Coma</cf_translate></option>
          </select></td>
		  <td>&nbsp;</td>
	  </tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td valign="middle">
							...
							&nbsp;&nbsp;&nbsp;
							<label for="EIcharsetL"><cf_translate  key="CHK_charset">charset:</cf_translate></label>
							  <select name="EIcharset" tabindex="1">
								<option value="0" <cfif modo neq 'ALTA' and rsForm.charset eq 'utf-8'>selected</cfif> >utf-8</option>
								<option value="1" <cfif modo neq 'ALTA' and rsForm.charset eq 'utf-16'>selected</cfif> >utf-16</option>
								<option value="2" <cfif modo neq 'ALTA' and rsForm.charset eq 'iso-8859-1'>selected</cfif> >iso-8859-1</option>
								<option value="3" <cfif modo neq 'ALTA' and rsForm.charset eq 'windows-1252'>selected</cfif> >windows-1252</option>
							  </select>
					...
					<tr>
						<td width="50%" valign="top" ><cf_translate  key="LB_SQLImportacion">SQL Importaci&oacute;n</cf_translate>
							...
							<br clear="none">
							<textarea name="EIsql" wrap="off" tabindex="1" <cfif modo neq 'ALTA'><cfif rsForm.EIimporta eq 0 >disabled</cfif><cfelse>disabled</cfif> rows="8" cols="6000" style="color: black; width:83%; background: white;font: 10px verdana;"><cfif modo neq 'ALTA'>#trim(rsForm.EIsql)#</cfif></textarea>
						</td>
						<td width="50%" valign="top" ><cf_translate  key="LB_SQLImportacion">SQL Exportaci&oacute;n</cf_translate>
							...
							<br clear="none">
							<textarea wrap="off"  name="EIsqlexp" tabindex="1" <cfif modo neq 'ALTA'><cfif rsForm.EIexporta eq 0 >disabled</cfif><cfelse>disabled</cfif>  rows="8" cols="6000" style="color: black; width:83%; background: white;font: 10px verdana;"><cfif modo neq 'ALTA'>#trim(rsForm.EIsqlexp)#</cfif></textarea>
				  ...
				  <tr>
					  <td valign="top"><input name="EIcfparam" onBlur="pagina(this)" type="text" id="EIcfparam" tabindex="1" onFocus="this.select();" value="<cfif modo neq 'ALTA'>#trim(rsForm.EIcfparam)#</cfif>" size="60" maxlength="255" >
						...
						<cf_sifayuda
							...
							tip="false"
							scrollbars="yes"
							url="/cfmx/sif/importar/Ayuda_Exportador.cfm">	
						</td>
				  </tr>				  			  
				</table>
			</td>
