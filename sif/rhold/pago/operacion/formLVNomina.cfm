...
<!---
<cfinvoke component="sif.rh.Componentes.pListas" method="pListaQuery" returnvariable="pListaEduRet">
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<cfloop query="QueryLista">
			...
			<tr class="<cfif QueryLista.currentRow mod 2>listaNon<cfelse>listaPar</cfif>" 
				...
				<td style="cursor:hand;" onClick="javascript:procesar(#QueryLista.ERNid#);" align="right">#LSNumberFormat(QueryLista.Importe,',9.00')#</td>
			</tr>
