...
<cf_templateheader title="Bancos">
		<table width="100%" cellpadding="2" cellspacing="0">
			<tr>
				<td valign="top">
		            <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Reporte de Conciliaci&oacute;n'>
				...
				<cfinclude template="formConciliacion.cfm">
	            <cf_web_portlet_end>
				</td>	
			</tr>
		</table>	
