...
<table width="100%" cellpadding="0" cellspacing="1" border="0">	
    ...
    <tr nowrap="nowrap" align="left">
        <td colspan="#LvarColSpan#" style="font-size:36px"><strong>Movimientos realizados entre &nbsp;#form.QPLfechaD#&nbsp;y&nbsp;#form.QPLfechaH#</strong></td>
    </tr>
    <tr>
    <td colspan="#LvarColSpan#">&nbsp;</td>
    </tr>
    </cfoutput>
    <tr nowrap="nowrap" style="background-color:#ca76af" align="center" class="tituloListas">
    ...
    <cfoutput>
        ...
        <tr>
            <td style="background-color:##ca76af" align="center" nowrap="nowrap" colspan="#LvarColSpan#">Servicio al Cliente Tel. 2287-1000</td>
        </tr>
	</cfoutput>
</table>
