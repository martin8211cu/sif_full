									...
									<cfset LvarMovimiento = "">
										...
										<tr>
											...
											<cfloop query="rsCausa">
												...
												<cf_inputNumber name="QPCid_#rsCausa.QPCid#" value="#QPCmonto#" enteros="8" decimales="2" comas="false" readonly = "true">
													<cfelse>
												<cf_inputNumber name="QPCid_#rsCausa.QPCid#" value="#QPCmonto#" enteros="8" decimales="2" comas="false">
													</cfif>
													<td nowrap="nowrap">
