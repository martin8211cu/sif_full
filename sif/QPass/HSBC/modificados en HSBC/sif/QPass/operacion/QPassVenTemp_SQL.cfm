...
<cfelseif isdefined("Form.Cambio")>
	<cftransaction>
        ...
        <cfquery  datasource="#session.DSN#">
            update QPventaTags set 
                QPvtaAutoriza = 
					<cfif isdefined("form.QPvtaAutoriza") and len(trim(form.QPvtaAutoriza))>
	...
	<cflocation url="QPassVenTemp.cfm?QPvtaTagid=#form.QPvtaTagid#&QPcteid=#form.QPcteid#" addtoken="no">
</cfif>
	...
	<cftransaction>
        ...
        <cfif rscedula.cantidad eq 0>
			...
			<cfif isdefined('form.QPCente') and form.QPCente eq -1>
				null,
			<cfelse>
				<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.QPCente#">
			</cfif>
                        )
        ...
        <cfelse>
            ...
            <cfquery datasource="#session.DSN#">
                ...
                set QPcteNombre 	= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.QPcteNombre#">,
                    ...
                    QPcteTelefonoC  = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.QPcteTelefonoC#">,
                    QPcteCorreo     = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.QPcteCorreo#">,
		    QPCente         = <cfif isdefined('form.QPCente') and form.QPCente neq -1>#form.QPCente#</cfif>
        ...
        <cfquery name="rsQPventaTags" datasource="#session.DSN#">
            ...
            values(
                ...
                <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.QPvtaTagPlaca#">,
                <cfqueryparam cfsqltype="cf_sql_date" value="#form.QPvtaTagFecha#">,
