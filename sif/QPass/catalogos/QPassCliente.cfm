...
<cf_templateheader title="SIF - Quick Pass">
	<cf_web_portlet_start border="true" titulo="Clientes" >
		<script language="JavaScript" src="/cfmx/sif/js/MaskApi/masks.js"></script>
		
	<table width="98%" align="center"  border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				<cfinclude template="QPassCliente_form.cfm"> 
			</td>			
		</tr>
	</table>
	<br>
...
<script language="JavaScript" type="text/javascript">
	...
	oQPcteTelefono.attach(document.form1.QPcteTelefonoC, oQPcteTelefono, "string");
</script>
