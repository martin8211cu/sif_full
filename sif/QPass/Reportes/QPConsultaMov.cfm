						...
						<tr>
							<td width="300">
								<cf_web_portlet_start border="true" titulo="Consulta de Movimientos de TAGs" skin="info1">
									<p align="justify">Esta consulta muestra los movimientos hechos a un dispositivo (TAG), en un rango de fechas.
					...
					<form name="form1" method="post" action="QPConsultaMov_SQL.cfm" onsubmit="return validar(this);">
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr>
								...
								<td>
									<cfset QPLfechaD = DateFormat(dateadd('m', -1, Now()),'dd/mm/yyyy')>
