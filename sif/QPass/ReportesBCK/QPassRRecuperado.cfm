<cf_templateheader title="Reporte de Recuperados">
	<cf_web_portlet_start titulo="Generaci&oacute;n de Recuperados">
	<br>

	<cfoutput>
	<form name="form1" action="QPassRRecuperado_form.cfm" method="post" onsubmit="return validar(this);">
