<cf_templateheader title="Reporte de Movimientos">
	<cf_web_portlet_start titulo="Generaci&oacute;n de Movimientos">
	<br>

	<cfoutput>
	<form name="form1" action="QPassRMovimientos_form.cfm" method="post" onsubmit="return validar(this);">
