...
<!--- <cfset application.HSBCWSAddress = 'http://SVRBROKE04/SolicitudSConsultasWS'>--->
	...
	<cfif LvarBanderaWS>
		...
		<cfoutput>
			<script language="javascript" type="text/javascript">
				...
				window.parent.document.form1.QPCente.value = "#MyDoc.CONSULTACTASCTERESPUESTA.CUENTAS.CUENTA[1].CLIENTE.XMLtext#";
...
<cffunction name="fnObtieneDireccionWS" access="private" output="no" returntype="string">
	...
	<cfelse>
		<cfreturn "http://SVRBROKE04/SolicitudSConsultasWS">
		<!--- <cfreturn "http://svrdes04/SolicitudSConsultasWS"> Dirección de pruebas en desarrollo --->
	</cfif>
</cffunction>
