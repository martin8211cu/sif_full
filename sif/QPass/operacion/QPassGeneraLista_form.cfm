...
<cftransaction>
    ...
    <cfset LvarLista = This.ListaColor.fnVentasPostpago()>
...
<cfoutput>
	<form name="form1" action="QPassGeneraLista.cfm" method="post">
		<p>El Archivo fue generado. <!--- Presione <strong><a href="QPassGeneraLista_form.cfm">AQUI</a></strong> para descargarlo---></p>
		<p><input type="submit" name="Regresar" value="Regresar" /></p>
	</form>
</cfoutput>
