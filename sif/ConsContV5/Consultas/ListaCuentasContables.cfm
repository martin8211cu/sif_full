...
<script language="javascript" type="text/javascript">
	...
	function doConlisCuentaContable() 
	{
		var params 	= "";
			params += "&CGM1IM=CGM1IM&CGM1CD=CGM1CD";
		fnPopUpWindow("ConlisCuentas.cfm?formulario=form1" + params,250,200,650,400);
	}
	
	function traeCuentaContable()
	{
		alert("Randall Asiento Contable");
	}
	...
	function fnNuevaCuentaContable() 
	{
		...
		var p1 		= document.form1.CGM1IM.value.toString();	// Código
		var p2 		= document.form1.CGM1CD.value;				// Descripción
...
<fieldset><legend></legend>
	<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td class="subtitulo_seccion_small">&nbsp;Cuentas Contables </td>
		</tr>
		<tr>
			<td>
				<table id="tblcuenta" width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td>&nbsp;</td>
						<td colspan="2"><strong>Cuenta Contable :</strong>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					  	<td nowrap>
							<input type="text" name="CGM1IM" maxlength="4" value="" size="4" >
                            <input type="text" name="CGM1CD" maxlength="40" value="" size="40" >
							<a href="#" tabindex="-1" ><img src="/cfmx/sif/imagenes/Description.gif" alt="Lista de Cuentas Contables" name="imagen2" width="18" height="14" border="0" align="absmiddle"  onClick='javascript:doConlisCuentaContable();'></a>						  <a href="#" tabindex="-1" >
						  </a>&nbsp;
						</td>
						<td align="right" nowrap>
							<input type="hidden" name="LastOneCuenta" id="LastOneCuenta" value="ListaNon" tabindex="3">
							<input type="button" name="agregarCuenta" value="+" onClick="javascript:if (window.fnNuevaCuentaContable) fnNuevaCuentaContable();"  tabindex="3">
						</td>
					</tr>
					<tbody>
					</tbody>
