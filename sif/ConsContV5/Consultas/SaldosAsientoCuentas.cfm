<cf_template template="#session.sitio.template#">
	<cf_templatearea name="title">
    	Contabilidad - Consulta de Saldos por Asiento de las Cuentas Contables
	</cf_templatearea>
	<cf_templatearea name="body">
		<cf_web_portlet titulo="Consulta de Saldos por Asiento de las Cuentas Contables">
		...
		<form name="form1" method="post" action="SaldosAsientoCuentas.cfm">
				...
				<tr>					
				  <td align="center" valign="top">
						<table width="100%" cellpadding="2" cellspacing="0" align="center">
							<tr>
								<td nowrap>&nbsp;</td>
								<td nowrap colspan="4"><cfinclude template="ListaCuentasContables.cfm"></td>
								<td nowrap>&nbsp;</td>
							</tr>
							...
							<tr>
								<td nowrap>&nbsp;</td>
								<td nowrap colspan="4"><cfinclude template="SaldosFiltrosSinNiveles.cfm"></td>
								<td nowrap>&nbsp;</td>
							</tr>
							...
							<tr><td nowrap colspan="6"> <!---<cfinclude template="Reporte.cfm">---> </td></tr>
							<tr><td nowrap colspan="6">&nbsp;</td></tr>
