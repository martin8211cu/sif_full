<cf_template template="#session.sitio.template#">
	<cf_templatearea name="title">
    	Contabilidad - Consulta de Saldos por un Rango de Cuentas Contables
	</cf_templatearea>
	<cf_templatearea name="body">
		<cf_web_portlet titulo="Consulta de Saldos por un Rango de Cuentas Contables">
		...
		<form name="form1" method="post" action="SolicitudesPendCotizar-rep.cfm">
				...
				<tr>					
				  <td align="center" valign="top">
						<table width="100%" cellpadding="2" cellspacing="0" align="center">
							<tr>
								<td nowrap>&nbsp;</td>
								<td nowrap colspan="4"><cfinclude template="RangoCuentaContable.cfm"></td>
								<td nowrap>&nbsp;</td>
							</tr>
