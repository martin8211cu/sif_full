<table width="100%" cellpadding="2" cellspacing="0">
	<tr>
		...
		<cfif not isdefined("form.btnConsultar")>
			<cflocation addtoken="no" url="ComparativoInventarios.cfm">
		</cfif>
		...
		<cfif not  isdefined("form.toExcel")>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#DFDFDF">
			  <tr align="left"> 
				...
				<td>|</td>
				<td><a href="../consultas/ComparativoInventarios.cfm">Regresar</a></td>
				<td align="right" width="100%">
				<cfoutput>
					<a href="javascript:printURL('ComparativoInventariosImpr.cfm?almini=#form.almini#&almfin=#form.almfin#&ACodigo1=#form.Acodigo1#&Acodigo2=#form.Acodigo2#&periodo=#form.periodo#&mes=#form.mes#');">Imprimir</a>
				</cfoutput>
				</td>
			  </tr>
			</table>
		</cfif>	
		<cfinclude template="formComparativoInventarios.cfm">
