...
<cf_templateheader title="Kardex Detallado por Cuenta Contable">
		
	
		<table width="100%" cellpadding="2" cellspacing="0">
			<tr>
				<td valign="top">
        <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Kardex Detallado por Cuenta Contable'>
			...
			<form action="KardexCuentaContable-SQL.cfm" method="get" name="consulta">
				<table width="100%" border="0" cellpadding="1" cellspacing="1" align="center">
                    ...
                    <tr> 
						...
						<td valign="baseline" nowrap> 
							...
							<tr>
                            	<td><div align="right"><strong>Corte por Almac&eacute;n:&nbsp;</strong></div></td>
							  	<td><input type="checkbox" name="Corte" /></td>
                                <td colspan="2">&nbsp;</td>
						    </tr>
