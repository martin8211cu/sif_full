<cfquery name="rs" datasource="#session.DSN#">
	...
	order by b.Acodigo
	<!---
	--compute sum(CCVPpreciouloc) by b.Acodigo
	--compute sum(CCVPpreciouloc)
	--->
</cfquery>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td colspan="5" align="center"><b>Consulta de Detalle de Ventas</b></td>
    </tr>
	<tr>
	...
	<cfloop query="rs" >
		...
		<cfif Compare(corte, vCodigo) neq 0 >
			<cfif corte neq ''>
				<tr>
					<td colspan="2" class="topline" style="text-indent:10"><b>Total:</b></td>
					<td align="right" class="topline" style="text-indent:10">
						<b>
							<cfif total_cantidad_corte lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_corte,',9.00')#<cfif total_cantidad_corte gt 0></font></cfif>
						</b>
					</td>
				  	<td align="right" class="topline" style="text-indent:10"><b><cfif total_corte lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_cantidad_corte,',9.00')#<cfif total_cantidad_corte gt 0></font></cfif></b></td>
				</tr>
			...
			<tr><td colspan="5" class="tituloListas"><font size="1">#vCodigo# - #rs.Articulo#</font></td></tr>
		<cfelse>
			<cfset hayCorte = false >
		</cfif>
		...
		<tr>
			<!---
			<td style="text-indent:10" class="articulo" nowrap>#rs.Codigo#</td>
			<td style="text-indent:10" class="articulo" nowrap>#rs.Articulo#</td>
			--->
	...
	<tr class="topline"><td class="topline" style="text-indent:10"><b>Total:</b></td>
	  <td colspan="2" align="right" class="topline" style="text-indent:10"><b>
	    <cfif total_cantidad_corte lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_corte,',9.00')#
	    <cfif total_cantidad_corte gt 0></font></cfif>
      </b></td>
	  <td class="topline" align="right"  style="text-indent:10"><b><cfif total_corte lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_cantidad_corte,',9.00')#<cfif total_corte lt 0></font></cfif></b></td>
	</tr>
	...
	<tr><td>&nbsp;</td></tr>
	<tr class="topline">
		<td class="topline" colspan="2" style="text-indent:10"><b>Total General:</b></td>
		<td class="topline" align="right"><b><cfif total_cantidad_general lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_general,',9.00')#<cfif total_cantidad_general lt 0></font></cfif></b></td>
		<td class="topline" align="right"><b><cfif total_general lt 0><font color="##FF0000"></cfif>#LSNumberFormat(total_cantidad_general,',9.00')#<cfif total_general lt 0></font></cfif></b></td>
	</tr>
</table>
</cf_sifHTML2Word>
</cfoutput>