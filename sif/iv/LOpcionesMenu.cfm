...
<cfset QuerySetCell(Menues,"Description","Inventarios",Menues.RecordCount)>
<cfset QuerySetCell(Menues,"Link","/cfmx/sif/iv/MenuIV.cfm",Menues.RecordCount)>
<cfset QuerySetCell(Menues,"Category","Inventarios",Menues.RecordCount)>
