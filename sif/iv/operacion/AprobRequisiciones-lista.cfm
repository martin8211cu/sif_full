<cf_templateheader title="Aprobar Requisiciones de Inventario">
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Aprobar Requisiciones de Inventario'>
			<cfparam name="LvarUsuarioAprobador" default="false">
			<cfparam name="LvarUsuarioDespachador" default="false">
			<cfparam name="LvarEstado" default="1">
			<cfinclude template="../../portlets/pNavegacion.cfm">
			<br><table width="99%" align="center" border="0" cellpadding="0" cellspacing="0"><tr><td>
			<cfset filtro = "">
			<cfinclude template="Requisiciones-filtro.cfm">
			<cfquery name="rsQuery" datasource="#session.dsn#">
				...
				<cfif LvarUsuarioAprobador eq 'true'>
					and Estado = 0
				<cfelseif LvarUsuarioDespachador eq 'true' or LvarEstado eq 1>
					and Estado in (1,2)
				</cfif>
			...
			<cfelse>
				<cfset LvarDirec2 = "AprobRequisiciones.cfm">
			</cfif>
			...
			<script language="JavaScript1.2" type="text/javascript">
				...
				function funcAplicar() {
					if (algunoMarcado())
						document.lista.action = "AprobRequisiciones-sql.cfm";
					else
						return false;
				}
				function unMarkOne(){
