...
<cflocation url="AprobRequisiciones-lista.cfm?LvarUsuarioAprobador=#LvarUsuarioAprobador#&LvarUsuarioDespachador=#LvarUsuarioDespachador#">
...
<cffunction access="private" name="Cambio" returntype="boolean">
	...
	<cfquery datasource="#session.dsn#">
		...
		set ERdescripcion = <cfqueryparam value="#Form.ERdescripcion#" cfsqltype="cf_sql_varchar">,
			...
			,Observaciones =  left(<cfqueryparam value="#Form.ERObservaciones#" cfsqltype="cf_sql_varchar">,250)
		where Ecodigo   =  #Session.Ecodigo# 
		  and ERid      = <cfqueryparam value="#Form.ERid#" cfsqltype="cf_sql_numeric">
	</cfquery>
	<cfreturn true>
