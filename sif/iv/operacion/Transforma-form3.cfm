...
<script language="javascript" type="text/javascript">
	...
	function goPrevious(f) {
		location.href = "/cfmx/sif/iv/operacion/Transforma-form2.cfm";
	}

	function goConcil(f) {
		location.href =  "/cfmx/sif/iv/consultas/ConciliaTransito-SQL.cfm?ETid=<cfoutput>#Form.ETid#</cfoutput>";
	}
	...
	<table width="90%" border="0" cellspacing="1" cellpadding="1"  align="center">
		 <tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					 <tr>
						<td width="1%" align="left"><img src="../imagenes/num3.GIF" border="0"></td>
						<td align="left">
							<strong style="font-family:'Times New Roman', Times, serif; font-size:15pt; font-variant:small-caps; font-weight:bolder; padding-left:20px">Conciliaci&oacute;n de Art&iacute;culos: </strong>
						</td>
					   ...
					   <tr>
							<td colspan="3" class="tituloListas" nowrap>
								Proceso de Conciliación de Artículos:
							</td>
						</tr>
				</table>
			</td>
	  ...
	  <tr>
	  	<td align="center">
			...
			<input  type="button" name="Conciliar" value="Conciliar"   onClick="javascript: goConcil(this.form);">
	  ...
	  <tr>
		...
		<td>
			<input type="hidden" name="ETid" value="<cfoutput>#Form.ETid#</cfoutput>"></strong></td>
		</td>
	  </tr>
	</table>
  <cf_web_portlet_end>
