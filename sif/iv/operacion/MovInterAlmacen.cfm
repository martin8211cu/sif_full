<cf_templateheader title="Movimientos Interalmacen ">
	<table width="100%" cellpadding="2" cellspacing="0">
		<tr>
			...
			<cfif isdefined("form.chk") AND isdefined("form.btnAplicar") >
				...
				<cflocation addtoken="no" url="listaMovInterAlmacen.cfm">
			</cfif> 
			<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Movimientos InterAlmac&eacute;n'>
				<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">		
					<cfset regresar = "listaMovInterAlmacen.cfm">	
					<tr><td><cfinclude template="../../portlets/pNavegacion.cfm"></td></tr>
					
					<tr>
						<td align="center">
							<cfinclude template="formMovInterAlmacen.cfm">
						</td>
					</tr>
						...
						<td align="center">
							<cfif isdefined('form.EMid') and len(trim(form.EMid)) gt 0 >
								...
								<cfinvoke component="sif.Componentes.pListas" method="pListaQuery" returnvariable="pListaRet">
									...
									<cfinvokeargument name="irA" value="MovInterAlmacen.cfm"/>
