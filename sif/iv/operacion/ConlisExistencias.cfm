<html>
<head>
<title>Lista de Existencias de Artículos</title>
...
<cfquery name="conlis" datasource="#session.DSN#">
	...
	where a.Ecodigo = #Session.Ecodigo# 
	  ...
	  order by b.Acodigo, b.Adescripcion, a.Eexistencia
</cfquery>
...
<form action="" method="post" name="conlis">
  <table width="97%" border="0" cellspacing="0">
    <tr> 
      <td width="14%"class="tituloListas"><div align="left">C&oacute;digo</div></td>
      <td width="50%"  class="tituloListas"><div align="left">Art&iacute;culo</div></td>
      <td width="36%"  class="tituloListas"><div align="left">Existencias 
          <input type="submit" name="Filtrar" value="Filtrar"></div></td>
    </tr>
    <tr> 
      <td><input name="Acodigo" type="text" size="15" maxlength="15"></td>
      <td ><input name="Adescripcion" type="text" size="60" maxlength="80"></td>
      <td >&nbsp;</td>
    </tr>
    <cfoutput query="conlis" startRow="#StartRow_conlis#" maxRows="#MaxRows_conlis#"> 
      <tr> 
        ...
        <td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><a href="javascript:Asignar(#conlis.Aid#, '#JSStringFormat(conlis.Adescripcion)#', #conlis.Eexistencia#);">#conlis.Adescripcion#</a></td>
        <td <cfif #conlis.CurrentRow# MOD 2><cfoutput>class="listaPar"</cfoutput><cfelse><cfoutput>class="listaNon"</cfoutput></cfif>><a href="javascript:Asignar(#conlis.Aid#, '#JSStringFormat(conlis.Adescripcion)#', #conlis.Eexistencia#);">#conlis.Eexistencia#</a></td>
      </tr>
    </cfoutput> 
    <tr> 
      <td colspan="3">&nbsp; </td>
