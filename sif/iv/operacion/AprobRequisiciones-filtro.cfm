...
<cfoutput>
<form action="AprobRequisiciones-lista.cfm?LvarUsuarioAprobador=#LvarUsuarioAprobador#&LvarUsuarioDespachador=#LvarUsuarioDespachador#" name="frequisicion"  method="post" style="margin:0">
