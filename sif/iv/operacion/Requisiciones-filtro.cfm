...
<cfoutput>
<form action="Requisiciones-lista.cfm?LvarUsuarioAprobador=#LvarUsuarioAprobador#&LvarUsuarioDespachador=#LvarUsuarioDespachador#" name="frequisicion"  method="post" style="margin:0">
