<cf_templateheader title="Movimientos Interalmacen con Aprobacion">
		...
		<tr>
			...
			<cfif isdefined("form.chk") AND isdefined("form.btnAplicar") >
				...
				<cfloop index = "index" list = "#Form.chk#" delimiters = ",">
					...
					<cfinvoke component="sif.Componentes.IN_MovInterAlmacen" method="MovInterAlmacenconAprobacion">
						<cfinvokeargument name="Ecodigo" value="#session.Ecodigo#"/>
						<cfinvokeargument name="EMid" value="#datos[1]#"/>				
						<cfinvokeargument name="usuario" value="#Session.usuario#"/>						
					</cfinvoke>	
				</cfloop>
				<cflocation addtoken="no" url="listaMovInterAlmacenconAprobacion.cfm">
			</cfif> 
			<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Movimientos InterAlmac&eacute;n con Aprobaci&oacute;n'>
				<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">		
					...
					<tr>
						<td align="center">
							<cfinclude template="formMovInterAlmacenconAprobacion.cfm">
						</td>
					</tr>
