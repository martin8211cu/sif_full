<cf_templateheader title="  Inventarios">
	...
	<script language="javascript" type="text/javascript">
		...
		function goNext(f) {
			location.href =  "/cfmx/sif/iv/operacion/SQLFinalizar.cfm";
		}
	
	</script>

	<form name="form1" method="post" style="margin: 0;" action="SQLFinalizar.cfm" onSubmit="javascript: validar(this);">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="Transformación de Productos">
		...
		<table width="90%" border="0" cellspacing="1" cellpadding="1" align="center">
		 <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					 <tr>
						<td width="1%" align="left">
							<img src="../imagenes/num7.GIF" border="0">
						</td>
						<td align="left"><strong style="font-family:'Times New Roman', Times, serif; font-size:15pt; font-variant:small-caps; font-weight:bolder; padding-left:20px">
							Cierre de Ciclo:
						</strong></td>
						<td align="right">
		  ...
		  <tr>
		    <td align="center">
				<cfinclude template="frame-TransformacionProducto.cfm">
			</td>
	      </tr>
		  <tr>
			<td align="center">
