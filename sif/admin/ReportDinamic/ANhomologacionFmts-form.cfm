...
<cfoutput>
 <form method="post" name="form1" action="ANhomologacionCta-sql.cfm" onSubmit="return validar();">
	...
	<tr valign="baseline">
	  ...
	  <input type="radio" name="AnexoSigno" id="AnexoSignoMas" value="+1" #LvarMas#><label for="AnexoSignoMas">Sumar</label>
		&nbsp;&nbsp;
	  <input type="radio" name="AnexoSigno" id="AnexoSignoMenos" value="-1" #LvarMenos#><label for="AnexoSignoMenos">Restar</label>
	  </td>
    </tr>
    <tr valign="baseline"> 
