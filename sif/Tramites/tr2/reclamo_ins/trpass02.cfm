              ...
              <table width="100%" border="0" cellspacing="1">
                ...
                <tr> 
                  ...
                  <td colspan="5"><p align="justify"><strong><font size="3">Paso 
                      2 de 3:</font></strong> <span class="subTitulo">Estado actual 
                      de su seguro </span></p></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                ...
                <tr> 
                  <td>&nbsp;</td>
                  <td colspan="7">Seg&uacute;n los registros del INS, el reclamante de la c&eacute;dula <font color="#006699"><strong> 
				    <cfoutput>#tramite.Cedula#</cfoutput> 
                    </strong></font>
					<cfif #Len(Trim(tramite.Pnombre))# NEQ 0> 
						(<cfoutput>#tramite.Pnombre#</cfoutput>)</cfif>
					<br> 
					no	tiene	su seguro al d&iacute;a y no tiene reclamos pendientes, por lo que el tr&aacute;mite puede proseguir.<br>
                    <br>
                    Le recordamos que a la hora de retirar su cheque, usted deber&aacute; traer original y copia del parte del oficial de tr&aacute;nsito, reporte del inspector del INS y del expediente del juzgado de tr&aacute;nsito. </td>
                  <td>&nbsp;</td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                ...
                <tr> 
                  <td>&nbsp;</td>
                  <td colspan="5"><strong>Usted puede realizar:</strong></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                  ...
                  <td colspan="4"><table width="100%" border="0">
                      ...
                      <tr> 
						...
						<label> 
                          ...
                          Reclamo de gastos por accidente </label></td>
                      </tr>
