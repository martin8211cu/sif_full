              ...
              <table width="100%" border="0" cellspacing="1">
                ...
                <tr> 
                  ...
                  <td colspan="5"><p align="justify"><strong><font size="3">Paso 
                      ...
                      de su cuenta con el ICE </span></p></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                ...
                <tr> 
                  <td>&nbsp;</td>
                  <td colspan="7">Seg&uacute;n el ICE, la c&eacute;dula <font color="#006699"><strong> 
				    <cfoutput>#tramite.Cedula#</cfoutput> 
                    </strong></font>					no tiene cuentas pendientes, y la solicitud puede proceder.<br>                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                  ...
                  <td colspan="4"><table width="100%" border="0">
                      ...
                      <tr> 
						...
						<label> 
                          ...
                          Solicitar una l&iacute;nea telef&oacute;nica residencial.</label></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        Solicitar una l&iacute;nea telef&oacute;nica comercial.</td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
                        <td width="89%">&nbsp;</td>
