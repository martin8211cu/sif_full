...
<cfinvoke component="sif.Componentes.pListas" method="pListaQuery"  returnvariable="pListaRet">
	...
	<cfinvokeargument name="desplegar" value="Clase, AFIperiodo, AFImes, Oficina, IndiceProm"/>
	<cfinvokeargument name="etiquetas" value="Clase, Periodo, Mes, Oficina, Índice Promedio"/>
	...
	<cfinvokeargument name="keys" value="ACcodigoCat,ACcodigoClas,ACidClas,AFIperiodo,AFImes, Ocodigo"/>
	<cfinvokeargument name="showLink" value="true"/>
	<cfinvokeargument name="irA" value="AFexcepciones.cfm"/>
...
<script language="javascript" type="text/javascript">
	function funcEliminar(){
		document.linea.action="SQLAFexcepciones.cfm";
