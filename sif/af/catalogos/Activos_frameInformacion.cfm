...
<cfoutput>
	...
	<table width="100%" cellpadding="2" cellspacing="0" align="center">
				...
				<tr>
					...
					<td nowrap><strong><font size="+1" >#rsActivo.Adescripcion#</font></strong></strong></td>
					<td nowrap align="right">Serie:</td>
					<td><strong>#rsActivo.Aserie#</strong></td>
				</tr>
				
				<tr>
					<td nowrap align="right">Categor&iacute;a:</td>
					<td><strong>#rsActivo.ACCcodigodesc# - #rsActivo.ACCdescripcion#</strong></strong></td>
					<td width="13%" nowrap div align="right">Marca:</td>
					<td colspan="2"><strong>#rsActivo.AFMdescripcion#</strong></td>
				</tr>
				<tr> 
					<td width="24%" nowrap div align="right">Clase:</td>
					<td width="33%"><strong>#rsActivo.ACcodigodesc# - #rsActivo.ACdescripcion#</strong></td>
					<td width="13%" nowrap div align="right">Modelo:</td>
					<td colspan="2"><strong>#rsActivo.AFMMdescripcion#</strong></td>
				</tr>	
				<tr> 
					<td nowrap div align="right">Monto Adquisici&oacute;n:</td>
				  	<td><strong>#LSCurrencyFormat(rsActivo.Amontoadq,"none")#</strong></td>
				...
				<tr>
					<td nowrap align="right">Tipo:</td>
				  	<td><strong>#rsActivo.AFCdescripcion#</strong></td>
				...
				<tr>
					<td nowrap align="right">Proveedor:</td>
				  	<td><strong>#rsActivo.SNnombre#</strong></td>
                ...
                <tr>
                    ...
                    <td><strong>#rsActivo.TipoMovimiento#</strong></td>
                </tr>
                <tr>
                    <td nowrap="nowrap" align="right"> Fecha Entrada/Salida:&nbsp;</td>
                    <td><strong>#LSDateFormat(rsActivo.Fecha,"dd/mm/yyyy")#</strong></td>
                </tr>
				...
				<tr>
					<td nowrap align="right">&nbsp;</td>
				  	<td>&nbsp;</td>
					<td nowrap align="right">Asiento:</td>
					<td><strong>#rsActivo.ECAsiento#</strong></td>
				</tr>
				<tr>
					<td nowrap align="right">&nbsp;</td>
				  	<td>&nbsp;</td>
					<td nowrap align="right">P&oacute;liza:</td>
					<td><strong>#rsActivo.ECPoliza#</strong></td>
				</tr>
				<tr>
					<td nowrap align="right">&nbsp;</td>
				  	<td>&nbsp;</td>
					<td nowrap align="right">Referencia:</td>
					<td><strong>#rsActivo.ECReferencia#</strong></td>
				</tr>
				<tr>				
					<td colspan="4">&nbsp;</td>
				</tr>
				<cfif rsSaldos.query.recordcount gt 0>
					...
					<tr>
						...
						<td><strong>#rsSaldos.query.AFSperiodo#</strong></td>
						<td nowrap="nowrap" align="right">Mes:&nbsp;</td>
						<td><strong>#rsSaldos.query.AFSmesenletras#</strong></td>
					</tr>
					<cfif isdefined("rsSaldos.query.CFid") and len(trim(rsSaldos.query.CFid))>
						<tr>
						  <td nowrap="nowrap" align="right">Centro Funcional:&nbsp;</td>
						  <td nowrap="nowrap"><strong>#rsSaldos.query.CFcodigo# - #rsSaldos.query.CFdescripcion#</strong></td>
						  <td nowrap="nowrap" align="right">Oficina:&nbsp;</td>
						  <td nowrap="nowrap"><strong>#rsSaldos.query.Oficodigo# - #rsSaldos.query.Odescripcion#</strong></td>
						</tr>
					</cfif>
					<tr>
					...
					<tr>
						<cfset total = (rsSaldos.query.AFSvaladq+rsSaldos.query.AFSvalmej+rsSaldos.query.AFSvalrev)>
						<cfset totalD = (rsSaldos.query.AFSdepacumadq+rsSaldos.query.AFSdepacummej+rsSaldos.query.AFSdepacumrev)>
						<td nowrap="nowrap" align="right"> Total:&nbsp;</td>
						<td><strong>#LSCurrencyFormat(total,"none")#</strong></td>
						<td nowrap="nowrap" align="right"> Total:&nbsp;</td>
						<td><strong>#LSCurrencyFormat(totalD,"none")#</strong></td>
					</tr>                    
				...
				<cfelse>
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">-- No se encontraron saldos para el Activo para el Periodo #rsSaldos.Periodo# Mes #rsSaldos.Mes#. --</td>
						<td>&nbsp;</td>
					</tr>
				</cfif>
		</table>
