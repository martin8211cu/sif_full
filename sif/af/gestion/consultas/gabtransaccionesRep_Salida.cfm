...
<iframe src="" id="prueba" style="visibility:hidden"  frameborder="0" width="0" height="0" ></iframe>
...
<cftry>
	...
	<cf_jdbcquery_close>
	<cflocation addtoken="no" url="gabTransacciones.cfm">
	<cfabort>
</cfif>
...
<cfset nCols = 13>				<!--- Total de columnas del encabezado. --->
...
<cfsavecontent variable="encabezado">
	<cfoutput>	
		...
		<tr><td colspan="#nCols#" class="titulo_reporte">#LvarTituloReporte#</td></tr>
...
<cfif isdefined('url.export')>
	<cfcontent type="application/msexcel">
		<cfheader 	name="Content-Disposition"  
			value="attachment;filename=TransAplicadas#session.Usulogin##LSDateFormat(now(),'yyyymmdd')#.xls" >
</cfif> 
...
<script language="javascript1.2" type="text/javascript">
	...
	function SALVAEXCEL() {
		...
		document.getElementById("prueba").src="gabtransaccionesRep.cfm" + ira;
	}
</script>
