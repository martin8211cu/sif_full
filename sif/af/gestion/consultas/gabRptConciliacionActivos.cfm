<!---
	Mdulo      : Gestin de Activos Fijos / Consultas
	Nombre      : Conciliacion de Activos Fijos
	Descripcin : 
		Muestra un reporte que compara los montos de los asientos contables
		con los datos de la tabla de Gestion de Activos y a la vez indica si
		los datos estan (Conciliados,Aplicados o Incompletos)
	Hecho por   : Aarn Vargas
	Creado      : 13/10/2006
 --->

<!--- Definicin de los aos --->
...
<cf_templateheader title="#nav__SPdescripcion#">
		...
		<cfif not isdefined("form.btnConsultar")>	
			<form action="gabRptConciliacionActivosRep.cfm" method="post" name="form1" onSubmit="return fnVerificar()">
				<cfoutput>				  
				<table width="100%" border="0">
					<tr>
						<td  valign="top"width="45%"> <cf_web_portlet_start border="true" titulo="Transacciones Sin Aplicar" skin="info1">
							<div align="center">
						  		<p align="justify">
									Muestra un reporte que compara los montos de gestin de activos,
									contra los montos de la contabilidad, y a la vez indica el estado
