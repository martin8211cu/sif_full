<!---
	...
	Nombre      : Transacciones Eliminadas
	Descripción : 
		Muestra un reporte de la bitácora de gestión de activos
		fijos, para aquellas que fueron eliminadas, en un período,
...
<cf_templateheader title="#nav__SPdescripcion#">
		...
		<cfif not isdefined("form.btnConsultar")>	
			<form action="gabtransaccionesEliminadasRep.cfm" method="post" name="form1" onSubmit="return fnVerificar()">
				<cfoutput>				  
				<table width="100%" border="0">
					<tr>
						<td  valign="top"width="45%"> <cf_web_portlet_start border="true" titulo="Transacciones Eliminadas" skin="info1">
							<div align="center">
						  		<p align="justify">
								Muestra un reporte de la bitácora de gestión de activos
								fijos, para aquellas que fueron eliminadas, en un período,
