...
<cfquery name="rsConceptos" datasource="#session.dsn#">
	select -1 as value, '--Todos--' as description, -2 as orden from dual
	union
	select -10 as value, '--(NA) Sin Asignar--' as description, -1 as orden from dual
	union
...
<cfif isdefined("url.Completar") and len(trim(url.Completar))>
	<cfset form.Completar = url.Completar>
</cfif>
