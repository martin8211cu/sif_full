...
<cfelseif isdefined("form.Aplicar")>
	...
	<cfif INS_Error.actsaldos gt 0>
		...
		set AFMovsDValorAdq = c.AFSvaladq, 
			...
			AFMovsDSaldoMej = (af.AFSvalmej - af.AFSdepacummej),
...
--->					   
				...
				<cfquery datasource="#session.dsn#">
					...
					Select 
							#Session.Ecodigo# as Ecodigo, 
						   'TA' as EAcpidtrans,
						    <cf_dbfunction name="to_char" datasource="#session.dsn#" args="b.Ocodigo"> #_Cat# '-#Vper##RepeatString('0',2-len(Vmes))#-#form.AFMovsID#-#Lvar_empresa#' as EAcpdoc,
				   		1 as EAcplinea,
						   b.Ocodigo,
						   ...
						   <cf_jdbcquery_param cfsqltype="cf_sql_integer" value="null"> as SNcodigo,
							<cf_jdbcQuery_param cfsqltype="cf_sql_varchar" len="80"  value="Activos Fijos Adquiridos por Traslado desde la empresa: #_CAT# ' ' #_CAT# #nombreEmp#"> as EAdescripcion,
						   1 as EAcantidad,						   
				...
				<cfquery datasource="#session.dsn#">
					...
					Select 
						   ...
						   a.ACcodigo,
						   a.ACid,
							<cf_dbfunction name="sPart"	args="b.Adescripcion,1,80">,
						   b.Aserie,
						   b.Aplaca,
						   b.Afechainidep,
						   b.Afechainirev,
