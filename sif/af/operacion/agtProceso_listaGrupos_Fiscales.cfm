...
<!---filtro--->
<cfset filtro = "a.Ecodigo=#session.Ecodigo# and a.IDtrans IN (#IDtrans#, 12) and a.AGTPecodigo > 0 and a.AGTPestadp <= 2 ">
...
<cfset botonAccion[11][1] = "Generar">
<cfset botonAccion[11][2] = "DEPRECIACION_Fiscal">
<cfset botonAccion[11][3] = "Lista de Grupos de Transacciones de Depreciaci&oacute;n Fiscal">
<cfset botonAccion[11][4] = "">
<cfset botonAccion[11][5] = "programa">
<cfset botonAccion[11][6] = 0>
<cfset botonAccion[11][7] = "detalles">
<!---Estados--->
...
<cfif isdefined("form.btnEliminar") and isdefined("form.chk") and len(trim(Form.chk))>
	...
	<cfloop index = "item"	list = "#Form.chk#"	delimiters = ",">
		...
		<cfquery name="rsCheckToDelete" datasource="#session.dsn#">
			...
			and IDtrans IN (<cfqueryparam cfsqltype="cf_sql_integer" value="#IDtrans#">,12)
			and AGTPestadp < 4
		</cfquery>
