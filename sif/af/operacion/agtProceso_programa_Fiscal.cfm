...
<cfset botonAccion[11][1] = "DEPRECIACION_Fiscal">
<cfset botonAccion[11][2] = "Programación de Aplicación de Grupos de Transacciones de Depreciaci&oacute;n Fiscal">
<cfset botonAccion[11][3] = "DEPRECIACION_FISCAL">
...
<cf_templateheader title="Activos Fijos">
	  <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#botonAccion[11][2]#">
...
<!--//
	function funcbtnRegresar(){
		<cfoutput>
			document.fagtproceso.action = "agtProceso_#botonAccion[IDtrans][3]##LvarPar#.cfm?#params#";
		</cfoutput>
	}
//-->
</script>