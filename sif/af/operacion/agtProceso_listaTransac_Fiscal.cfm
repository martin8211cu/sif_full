...
<!---filtro--->
<cfset filtro = "a.Ecodigo=#session.Ecodigo# and a.IDtrans IN (#IDtrans#,12) and a.AGTPid=#AGTPid#">
<!---navegacion--->
...
<cfset botonAccion[11][1] = "Regresar">
<cfset botonAccion[11][2] = "DEPRECIACION_FISCAL">
<cfset botonAccion[11][3] = "Lista de Transacciones de Depreciaci&oacute;n del grupo #grupodesc#">
<cfset botonAccion[11][4] = "Depreciación">
<cfset botonAccion[11][5] = "afs.AFSvaladq, a.TAmontolocadq as TAmontolocadq, a.TAmontolocmej as TAmontolocmej, a.TAmontodepadq as TAmontodepadq, a.TAmontodepmej as TAmontodepmej, a.TAmontodepadqFiscal as TAmontodepadqFiscal, a.TAmontodepmejFiscal as TAmontodepmejFiscal">
<cfset botonAccion[11][6] = "AFSvaladq,TAmontolocadq,TAmontolocmej,TAmontodepadq,TAmontodepmej,TAmontodepadqFiscal,TAmontodepmejFiscal">
<cfset botonAccion[11][7] = "Valor Adquisición, Valor Adquisicion Actualizado, Valor Mejora Actualizado, Depreciación Adquisición Actualizado, Depreciación Mejoras Actualizado, Depreciación Fiscal Adquisicion, Depreciación Fiscal Mejoras">
<!--- REVALUACION --->
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="tabla" value="ADTProceso a 
												...
												on c.Aid = a.Aid
												"/>
			<cfinvokeargument name="filtro" value="#filtro# order by CentroF, Categoria, Clase, a.Aid, a.TAmes, Aplaca, Adescripcion"/>
