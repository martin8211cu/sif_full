...
<!---filtro--->
<cfset filtro = "a.Ecodigo=#session.Ecodigo# and a.IDtrans IN (#IDtrans#) and a.AGTPid=#AGTPid#">
<!---navegacion--->
...
<cfset botonAccion[14][1] = "Regresar">
<cfset botonAccion[14][2] = "Retiro_Fiscal">
<cfset botonAccion[14][3] = "Lista de Transacciones de Retiro Fiscal del grupo #grupodesc#">
<cfset botonAccion[14][4] = "Retiro">
<cfset botonAccion[14][5] = "a.TAvaladq as AFSvaladq, a.TAmontolocadq as TAmontolocadq, a.TAmontolocmej as TAmontolocmej, a.TAmontodepadq as TAmontodepadq, a.TAmontodepmej as TAmontodepmej, a.TAmontodepadqFiscal as TAmontodepadqFiscal, a.TAmontodepmejFiscal as TAmontodepmejFiscal">
<cfset botonAccion[14][6] = "AFSvaladq,TAmontolocadq,TAmontolocmej,TAmontodepadq,TAmontodepmej,TAmontodepadqFiscal,TAmontodepmejFiscal">
<cfset botonAccion[14][7] = "Valor Adquisición, Valor Adquisicion Actualizado, Valor Mejora Actualizado, Depreciación Adquisición Actualizado, Depreciación Mejoras Actualizado, Retiro Fiscal Adquisicion, Retiro Fiscal Mejoras">
<!--- REVALUACION --->
