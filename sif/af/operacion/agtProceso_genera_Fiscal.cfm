		...
		<form name="fagtproceso" action="agtProceso_sql_<cfoutput>#botonAccion[IDtrans][1]##LvarPar#</cfoutput>.cfm" method="post">
			<table border="0" align="center" width="100%">
				<tr>
					...
					<td>
						<cfif IDtrans EQ 11 or IDtrans EQ 3>
...
<cffunction name="fnFiltros_AGT" access="private" output="no" hint="Genera las variables de control">
	...
	<cfset botonAccion[11][2] = "filtro_Fiscal">
	<cfset botonAccion[11][3] = "Generaci&oacute;n de Grupos de Transacciones de Depreciaci&oacute;n Fiscal">
	<cfset botonAccion[11][4] = "Depreciación_Fiscal">
</cffunction>
