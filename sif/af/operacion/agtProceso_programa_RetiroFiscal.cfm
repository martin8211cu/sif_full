...
<cfset botonAccion[14][2] = "Programación de Aplicación de Grupos de Transacciones de Retiro Fiscal">
<cfset botonAccion[14][3] = "Retiro_Fiscal">
...
<cf_templateheader title="Activos Fijos">
	  <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#botonAccion[14][2]#">
