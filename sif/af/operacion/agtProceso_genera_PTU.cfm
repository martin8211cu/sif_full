		...
		<form name="fagtproceso" action="agtProceso_sql_<cfoutput>#botonAccion[IDtrans][1]##LvarPar#</cfoutput>.cfm" method="post">
			<table border="0" align="center" width="100%">
				<tr>
					...
					<td>
						<cfif IDtrans EQ 13 or IDtrans EQ 3>
...
<cffunction name="fnFiltros_AGT" access="private" output="no" hint="Genera las variables de control">
	...
	<cfset botonAccion[13][1] = "DEPRECIACION_PTU">
	<cfset botonAccion[13][2] = "filtro">
	<cfset botonAccion[13][3] = "Generaci&oacute;n de Grupos de Transacciones de Depreciaci&oacute;n para efecto de PTU">
	<cfset botonAccion[13][4] = "Depreciación_PTU">
