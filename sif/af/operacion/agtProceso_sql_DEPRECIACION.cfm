...
<cfif session.debug>
	...
	<cfdump var="#Form#">
	<a href="../MenuAF.cfm">Activos Fijos</a> | <a href="agtProceso_DEPRECIACION.cfm?#params#">Lista de Grupos de Transacciones</a> | <a href="agtProceso_genera_DEPRECIACION.cfm?#params#">Generar Depreciacion</a><br>
</cfif>

<cfif isdefined("btnGenerar")>
	<cf_PleaseWait SERVER_NAME="/cfmx/sif/af/operacion/agtProceso_sql_DEPRECIACION#LvarPar#.cfm" >
	<cfif session.debug>
		Generando...<br>
	</cfif>
