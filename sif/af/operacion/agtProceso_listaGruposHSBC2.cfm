...
<cf_templateheader title="Activos Fijos">
	  <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#botonAccion[IDtrans][3]#">
			...
			<cfif (IDtrans EQ 4)>
				<cfset botones = botones & ",Dep_Manual">
			</cfif>
            ...
            <cfelseif (IDtrans EQ 4 and (isdefined("session.LvarJA") and not session.LvarJA))>
            	<cfset LvarBotones = "Generar,Eliminar,Dep_Manual">
            </cfif>
			...
			<cfinvoke 
			 ...
			 method="pLista">
				...
				<cfinvokeargument name="columnas" value="a.AGTPid, a.Ecodigo, a.IDtrans, a.AGTPdescripcion, a.AGTPperiodo, 
														...
														when 1 then #PorGenerar#
														when 2 then #PorAplicar#
														when 4 then 'Aplicado' 
														end as AGTPestadodesc,
														1 as valido"/>
				
				<cfinvokeargument name="filtro" value="#preservesinglequotes(filtro)#
