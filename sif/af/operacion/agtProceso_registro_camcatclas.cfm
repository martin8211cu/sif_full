			...
			<table width="0%" align="center"  border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						...
						<cfelse>
							<fieldset><legend>Relaci&oacute;n de Cambio Categor&iacute;a Clase</legend>
								<table width="100%" align="center"  border="0" cellspacing="0" cellpadding="0">
									<tr>
								...
								<cfinclude template="transfcatclas.cfm">
						</cfif>
					<td>
			</tr>
		</table>
...
<!--//
	...
	function habilitarValidacion(){
		...
		<cfif modocambio>
			qffagtproceso.AGTPid.required = false;
		</cfif>
	}
	...
	<cfif modocambio>
	<cfoutput>
	qffagtproceso.AGTPid.description = "#JSStringFormat('Activo')#";
