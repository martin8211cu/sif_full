	...
	<tr>
		<td align="center">	
			<table width="0%" align="center"  border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
                    	<fieldset><legend>Tipo de Depreciaci&oacute;n Fiscal</legend>
							<table width="100%" align="center"  border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><strong>Forma de Depreciaci&oacute;n&nbsp;:&nbsp;</strong></td>
                                    <td style="width: 286px;">
                                    	<select name="FDepreciacion" tabindex="1" style="width: 135px;" onChange="javascript:setDescripcion();">
										<option value="">---Seleccione---</option>
                                        <option value="DFNormal">Normal</option>
										<option value="DFAcelerada">Acelerada</option>
										</select>
									</td>
								</tr>
							</table>
...
<!--//
	...
	function _qfinit(){
		...
		qffagtproceso.FDepreciacion.description= "#JSStringFormat('Forma de Depreciación')#" ;
		</cfoutput>
	}
	function getForDDesc(lValue){
		if (lValue!="" && lValue=="DFNormal") {return "Normal";}
		if (lValue!="" && lValue=="DFAcelerada") {return "Acelerada";}
	}
	...
	function setDescripcion(){
		...
		<cfoutput>
			...
			if (form.FDepreciacion.value!="")
				lFiltrosAux = lFiltrosAux + ", " + getForDDesc(form.FDepreciacion.value);
...
<cffunction name="fnParametros_AGT" access="private" output="no" hint="Procesa los parametros de la pantalla">
	<!--- FILTROS DE LA LISTA --->
	<cfset params = ''>
	<cfif isdefined('url.Filtro_FDepreciacion')>
		<cfset params = params & 'Filtro_FDepreciacion=#url.Filtro_FDepreciacion#'>
	</cfif>
