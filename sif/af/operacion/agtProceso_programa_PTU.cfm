...
<cfset botonAccion[13][2] = "Programación de Aplicación de Grupos de Transacciones de Depreciaci&oacute;n PTU">
...
<cf_templateheader title="Activos Fijos">
	  <cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="#botonAccion[13][2]#">
