				...
				<cfquery name="rsIndiceF" datasource="#arguments.conexion#">
					...
					<cfquery name="rsCalculoDepLineaRecta" datasource="#arguments.conexion#">
						...
						select 
                            ...
                            ,(case when a.AFSvaladq > ac.ACImporteMaximo then ac.ACImporteMaximo else a.AFSvaladq end / a.AFSvutiladq) * (#PreserveSingleQuotes(CantidadMeses)# + 1) as  TAmontodepadq <!---25---> <!---==============================================================================================================================
                    ...
                    set TAmontolocadq = 
                                            ...
                                            case 
												...
												when 
                                                 ...
                                                 <cf_dbfunction name="to_number"	args="ap.TAmes/2" isInteger="false" dec="0" returnvariable="LvarMesInd2">
