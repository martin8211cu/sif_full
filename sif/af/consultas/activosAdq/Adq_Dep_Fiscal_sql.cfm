...
<cfif isdefined("url.FDepreciacion") and not isdefined("form.FDepreciacion")>
	<cfset form.FDepreciacion = url.FDepreciacion>
</cfif>
...
<cfsavecontent variable="myQuery">
	<cfoutput>
		select  distinct
			...
			acl.ACPorcentajeFiscal as ProcentajeFiscal,
            acl.ACVidaUtilFiscal as MVida,
            asf.AFSsaldovutilfis as MFalta,   
			...
			asf.AFSvaladqact as AdquisicionAct,
			asf.AFSvalmejact as MejoraAct,
			asf.AFSdepacumadqfiscal as DepFisAdq,
			asf.AFSdepacummejfiscal as DepFisMej
		from AFSaldos af
        	inner join AFSaldosFiscales asf
			on asf.AFSid = af.AFSid
		...
		where af.Ecodigo = #session.Ecodigo#
		  and af.AFSperiodo = #form.PeriodoInicial#
		  and af.AFSmes = #form.MesInicial#
          and tac.IDtrans = #form.FDepreciacion#
		  and (af.AFSvaladq + af.AFSvalrev + af.AFSvalmej) <> 0
...
<cfif form.formatos EQ 1>
	...
	<head>
        ...
        <title>Adquisiciones y Depreciaciones Fiscales</title>
		<style type="text/css">
		...
		<tr>
			...
			<td colspan="24" align="right" class="noprint">
				<cfoutput>
					...
					<a href="Adq_Dep_Fiscal_form.cfm?1=1#params#">Regresar <img border="0" title="Regresar" style="cursor:pointer" src="/cfmx/sif/imagenes/back.png" class="noprint"></a> 
				</cfoutput>
			</td>
		</tr>
	</table>
	...
	<cftry>
		...
		<cfif isdefined("form.Exportar")>
			<cf_exportQueryToFile query="#rsReporte#" filename="Adq_Dep_Fiscal_#session.Usucodigo#_#dateformat(now(),'ddmmyyyy')#_#hour(now())#_#Minute(now())#_#second(now())#.xls" jdbc="true">
		</cfif>
		<table border="0" align="center" cellpadding="2" cellspacing="0" style="width:100%">
		<tr>
			<td colspan="24" align="right">
				<cf_rhimprime datos="/sif/af/consultas/activosAdq/Adq_Dep_Fiscal_sql.cfm" paramsuri="#params#">
		...
		<tr style="font-weight:bold">
		  <td colspan="24" align="center" class="niv2">Consulta de Adquisiciones y Depreciaciones</td>
		</tr>
		<tr align="center">
			<td align="right" class="niv3" style="width:50%">Per&iacute;odo:&nbsp;<cfoutput>#form.PeriodoInicial#</cfoutput></td>
			<td align="left" class="niv3">&nbsp;&nbsp;Mes:&nbsp;<cfoutput>#form.MesInicial#</cfoutput></td>
		</tr>
		<tr align="center">
		...
		<table cellpadding="2" cellspacing="0" border="0" width="100%" align="center">
			...
			<cfset TotalAdquisicionActGen = 0>
			<cfset TotalMejoraActGen = 0>
			<cfset TotalDepFisAdqGen = 0>
			<cfset TotalDepFisMejGen = 0>
			
			<cfoutput query="rsReporte" group="Categoria">
				<cfset TotalValorCat = 0>
				<cfset TotalAdquisicionActCat = 0>
				<cfset TotalMejoraActCat = 0>
				<cfset TotalDepFisAdqCat = 0>
				<cfset TotalDepFisMejCat = 0>
				<tr>
				...
				<cfset TotalValor = 0>
				<cfset TotalAdquisicionAct = 0>
				<cfset TotalMejoraAct = 0>
				<cfset TotalDepFisAdq = 0>
				<cfset TotalDepFisMej = 0>
					...
					<tr style="font-weight:bold">
					  ...
					  <cfif form.FDepreciacion EQ 11>
                          <td nowrap="nowrap" align="right" class="niv4" style="width:1%">M.&nbsp;Vida Fiscal</td>
                          <td nowrap="nowrap" align="right" class="niv4" style="width:1%">M.&nbsp;Falta Fiscal</td> 
                      <cfelse>
                      	  <td nowrap="nowrap" align="right" class="niv4" style="width:1%">Porcentaje Fiscal</td>	
                      </cfif>                                                        
					  <td nowrap="nowrap" align="right" class="niv4" style="width:1%">Valor</td>
					  <td nowrap="nowrap" align="right" class="niv4" style="width:1%">Adquisici&oacute;n Act.</td>
					  <td nowrap="nowrap" align="right" class="niv4" style="width:1%">Mejora Act.</td>
					  <td nowrap="nowrap" align="right" class="niv4" style="width:1%">Depreciaci&oacute;n Fiscal Adq.</td>
					  <td nowrap="nowrap" align="right" class="niv4" style="width:1%"colspan="1">Depreciaci&oacute;n Fiscal Mej.</td>
					</tr>
				<cfoutput>
					...
					<tr class=<cfif LvarListaNon>"listaNon"<cfelse>"listaPar"</cfif>>
                     ...
                     <cfelse>
	                    <td align="right" class="niv4">#ProcentajeFiscal#</td>
                     </cfif>
                      <td align="right" class="niv4">#NumberFormat(Valor,'_,_.__')#</td>
                      <td align="right" class="niv4">#NumberFormat(AdquisicionAct,'_,_.__')#</td>
                      <td align="right" class="niv4">#NumberFormat(MejoraAct,'_,_.__')#</td>
                      <td align="right" class="niv4">#NumberFormat(DepFisAdq,'_,_.__')#</td>
                      <td align="right" colspan="1" class="niv4">#NumberFormat(DepFisMej,'_,_.__')#</td>
					</tr>
					<cfset TotalValor = TotalValor + Valor>
                    <cfset TotalAdquisicionAct = TotalAdquisicionAct + AdquisicionAct>
                    <cfset TotalMejoraAct = TotalMejoraAct + MejoraAct>
                    <cfset TotalDepFisAdq = TotalDepFisAdq + DepFisAdq>
                    <cfset TotalDepFisMej = TotalDepFisMej + DepFisMej>
                    
				</cfoutput>
				
				<tr>
					<td colspan="<cfif form.FDepreciacion EQ 11>7<cfelse>6</cfif>">&nbsp;</td>
                    ...
                    <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalAdquisicionAct,'_,_.__')#</td>
                    <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalMejoraAct,'_,_.__')#</td>
                    <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisAdq,'_,_.__')#</td>
                    <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisMej,'_,_.__')#</td>
				</tr>
					<cfset TotalValorCat = TotalValorCat + TotalValor>
                   
						<cfset TotalAdquisicionActCat = TotalAdquisicionActCat + TotalAdquisicionAct>
                        <cfset TotalMejoraActCat = TotalMejoraActCat + TotalMejoraAct>
                        <cfset TotalDepFisAdqCat = TotalDepFisAdqCat + TotalDepFisAdq>
                        <cfset TotalDepFisMejCat = TotalDepFisMejCat + TotalDepFisMej>
			...
			<tr>
                ...
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalAdquisicionActCat,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalMejoraActCat,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisAdqCat,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisMejCat,'_,_.__')#</td>
			</tr>
					<cfset TotalValorGen = TotalValorGen + TotalValorCat>
					
						<cfset TotalAdquisicionActGen = TotalAdquisicionActGen + TotalAdquisicionActCat>
                        <cfset TotalMejoraActGen= TotalMejoraActGen + TotalMejoraActCat>
                        <cfset TotalDepFisAdqGen = TotalDepFisAdqGen + TotalDepFisAdqCat>
                        <cfset TotalDepFisMejGen = TotalDepFisMejGen + TotalDepFisMejCat>
		</cfoutput>
		...
		<cfoutput>
			 <tr>
                ...
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalAdquisicionActGen,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalMejoraActGen,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisAdqGen,'_,_.__')#</td>
                <td class="niv4" align="right" style="font-weight:bold">#NumberFormat(TotalDepFisMejGen,'_,_.__')#</td>
