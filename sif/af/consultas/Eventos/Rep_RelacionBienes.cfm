...
<cfoutput>
	<form name="form1" method="post" action="Rep_RelacionBienes_sql.cfm">
		...
		<tr>
			...
			<fieldset><legend>Datos del Reporte</legend>
				<table  width="100%" align="center" cellpadding="2" cellspacing="0" border="0">
					...
					<tr>
						<td align="right"><strong>Salida de Activo:</strong>&nbsp;</td>
						<td>
							<select name="SalidaActivo" tabindex="7">
								<option value="0" <cfif isDefined('url.SalidaActivo')and #url.SalidaActivo# eq 0>selected </cfif>>--Selecciona--</option>
								<option value="2" <cfif isDefined('url.SalidaActivo')and #url.SalidaActivo# eq 2>selected </cfif>>Mantenimiento</option>
								<option value="3" <cfif isDefined('url.SalidaActivo')and #url.SalidaActivo# eq 3> selected </cfif>>Comodato</option>
							</select>
						</td>
					</tr>
...
<script language="javascript" type="text/javascript">
	function funcLimpiar(){
		...
		document.form1.SalidaActivo.value = 0;
