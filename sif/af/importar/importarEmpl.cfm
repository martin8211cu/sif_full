...
<cfelse>
	...
	<!---8- Actualiza los datos del los Empleado que ya existen 													--->
		<cf_dbtemp name="ImportEmp_v2" returnvariable="EmpleImport" datasource="#session.dsn#">
	...
	<cftransaction>
		...
		<cfquery datasource="#Session.dsn#">
			...
			and DEid not in(select DEid 
							  from DatosEmpleado a
							     inner join #EmpleImport#  temporal
								 	on a.DEidentificacion = temporal.DEidentificacion
							   where a.Ecodigo =  #Session.Ecodigo#)
		</cfquery>
	<!---4- Inserta los Empleados que no existen--->
		<cfquery datasource="#Session.dsn#">
			insert into DatosEmpleado (Ecodigo, Bid, NTIcodigo, DEidentificacion, DEnombre, DEapellido1, DEapellido2,
				 CBcc, Mcodigo, DEdireccion, DEtelefono1, DEtelefono2, DEemail, 
				 DEcivil, DEfechanac, DEsexo, DEcantdep, Usucodigo, Ulocalizacion, DEsistema, Ppais, BMUsucodigo)
			select #Session.Ecodigo#, #rsBanco.Bid#, a.NTIcodigo, a.DEidentificacion, a.DEnombre, a.DEapellido1, a.DEapellido2, 
				 a.DEidentificacion, #rsMoneda.Mcodigo#, a.DEdireccion, a.DEtelefono1, a.DEtelefono2, a.DEemail, 
				a.DEcivil, coalesce(a.DEfechanac,<cf_dbfunction name="now">), a.DEsexo, 0, #Session.Usucodigo#, '00', 1, '#rsPais.Ppais#', #Session.Usucodigo#
			from #EmpleImport# a
			where a.marca = 0
		</cfquery>
	<!---5- Crea la Linea del Tiempo para los Empleados que no existen --->
