...
<cfinvoke 
	...
	columnas="distinct  a.CRTDid, a.CRTCid, a.CRDRfdocumento, a.CRCCid,
			a.CRDRdocori,(select EOnumero from DOrdenCM where DOlinea = a.DOlinea) as OCnumero,
			#PreserveSingleQuotes(CRCentroCustodia)# as CRCentroCustodia, rtrim(a.CRDRplaca) as CRDRplaca, g.Usulogin, ' ' as e"
	...
	filtro="a.Ecodigo=#Session.Ecodigo#
	      and CRDRestado = 0  
		  and CRDR_TipoReg is not null 
		  and 
		  ( 
		  	   ( a.CRCCid  in (#CCUsuarios#) and a.BMUsucodigo  = #Session.Usucodigo#) 
			or ( a.CRCCid  in (#CCADmin#))
		  )
		  order by a.CRDRfdocumento"
		  
	desplegar="CRDRdocori,CRDRfdocumento,Usulogin,OCnumero"
	etiquetas="Documento,Fecha,Usuario,Orden de Compra"
	filtrar_por="CRDRdocori, a.CRDRfdocumento, g.Usulogin,a.OCnumero"
...
<script language="javascript" type="text/javascript">
		...
		function funcFactura(){
					document.lista.action="documentoFactura-form.cfm";
					return true;
		}
