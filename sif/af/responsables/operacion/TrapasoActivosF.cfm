...
<cf_dbfunction name="OP_concat"	returnvariable="_Cat">
	...
	<cfquery name="newLista" datasource="#session.dsn#">
		...
		where Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
		and <cf_dbfunction name="to_date00"	args="BMfecha"> = <cf_dbfunction name="today">
	</cfquery>
		...
		<cfquery datasource="#session.dsn#" name="cf">
			select cf.CFid , cf.CFdescripcion,
			  ...
			  from EmpleadoCFuncional eaf
				...
				inner join CFuncional cf on cf.CFid = eaf.CFid
			 where eaf.Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
				and eaf.DEid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.DEidT#">
				and <cf_dbfunction name="today"> between ECFdesde and ECFhasta
		</cfquery>
		
		<cfif cf.recordcount neq 0>
<!---			<cfthrow message="El Empleado a quien se le va hacer la transferencia No esta asociado a un Centro Funcional. Ir a (Activos Fijos-Catálogo de Responsables)">
		<cfelse>
--->			<cfquery datasource="#session.dsn#" name="buscar_cfx">
		...
		<cfelse>
			<cfthrow message="El Usuario no está asociado a ningún Centro Funcional... Acción cancelada! (Ver Activos Fijos>Catálogos>Catálogo de Responsables)">
...
--->		</cfif>
		...
		<cfquery name="rsDatos" datasource="#session.DSN#">
			select 	
					cat.ACcodigo,
					ACORI.Adescripcion as Descripcion,
					ACORI.Aplaca,  
					b.CRDRdescripcion,
					ACORI.Adescripcion, 
					ACORI.Aserie, 
			...
			from AFResponsables b 
				...
				inner join AClasificacion cl
					on cl.Ecodigo= ACORI.Ecodigo
					and  cl.ACid = ACORI.ACid
					and cl.ACcodigo  = ACORI.ACcodigo
				...
				inner join AFMarcas mar
					on ACORI.AFMid = mar.AFMid
					and ACORI.Ecodigo = mar.Ecodigo
				inner join AFMModelos mod
					on  mod.AFMMid =ACORI.AFMMid 
					and mod.Ecodigo = ACORI.Ecodigo
...
<link href="/cfmx/plantillas/login02/sif_login02.css" rel="stylesheet" type="text/css">
		...
		<cfoutput><fieldset style="background-color:##F3F4F8; border-top: none; border-left: 1px solid ##CCCCCC; border-right: 1px solid ##CCCCCC; border-bottom: 1px solid ##CCCCCC; "></cfoutput>
			<table width="100%"  cellpadding="2" cellspacing="2" border="0">
				...
				<tr>
				  ...
				  <cfoutput><img src="/cfmx/home/public/logo_empresa.cfm?EcodigoSDC=#session.EcodigoSDC#&amp;ts=#tsurl#" alt="logo" width="86" height="36" border="0" class="iconoEmpresa"/></cfoutput>					
				 	</td>
				 </tr> 
				...
				<tr>
     			  <td colspan="5" align="center"><font size="3"><strong>TRASPASO Y/O DESCARGO DE BIENES - N° <cfoutput>#Cons#</cfoutput> </strong></font>	</td>		  
				</tr>					
				<tr>
				...
				<tr>
					<td colspan="5" align="center"><font size="2"><strong>M&oacute;dulo: (Autogesti&oacute;n)</strong></font></td>
			  </tr>	
			  ...
			  <tr>
				  ...
				  <tr nowrap="nowrap" align="center" class="tituloListas">
						...
						<td width="19%"  align="left"><font size="2"><strong>Marca</strong></font></td>
	...
	<tr>
		<td>
			<fieldset style="background-color:##F3F4F8; border-top: none; border-left: 1px solid ##CCCCCC; border-right: 1px solid ##CCCCCC; border-bottom: 1px solid ##CCCCCC; ">
				...
				Entrega: <cfoutput>#rsEmpleado.CFdescripcion#</cfoutput>
				</legend>
				<table width="100%"  cellpadding="2" cellspacing="2" border="0">
					<tr>
						<td colspan="2"align="center">&nbsp;</td>
	...
	<tr>
		<td>
			<fieldset style="background-color:##F3F4F8; border-top: none; border-left: 1px solid ##CCCCCC; border-right: 1px solid ##CCCCCC; border-bottom: 1px solid ##CCCCCC; ">
				<legend align="center" style="color:##003366;font-family:'Times New Roman', Times, serif; font-size:11pt; font-variant:small-caps; font-weight:bolder;">
				Recibe: <cfoutput>#cf.CFdescripcion#</cfoutput>
				</legend>				
				<table width="100%"  cellpadding="2" cellspacing="2" border="0">
					<tr>
						<td colspan="2"align="center">&nbsp;</td>
			...
			<fieldset style="background-color:##F3F4F8; border-top: none; border-left: 1px solid ##CCCCCC; border-right: 1px solid ##CCCCCC; border-bottom: 1px solid ##CCCCCC; ">
				...
				<table width="100%"  cellpadding="2" cellspacing="2" border="0">
					...
					<tr>
						...
						<td align="right"><b> 
							<cfloop query="rsDatos">
								<cfif #rsDatos.ACcodigo# eq #rsCategoria.Pvalor#>
									<cfset LvarCat = 1>
								</cfif>
							</cfloop>
							
							<cfif isdefined('LvarCat') and #LvarCat# eq 1>
								Encargado de Informática:__________________________________</b>
							</cfif>
						</td>
					</tr>	
