...
<cfquery name="lista" datasource="#session.DSN#">
	select 	a.IDtrans,
			a.AGTPid, a.Ecodigo, a.IDtrans, a.AGTPdescripcion, a.AGTPperiodo, b.VSdesc as AGTPmesdesc, a.AGTPfalta, 
			case a.AGTPestadp 
	...
	from	AGTProceso a
			inner join VSidioma b 
				on <cf_dbfunction name="to_number" args="b.VSvalor" datasource="#session.dsn#">  = a.AGTPmes 
				and b.VSgrupo = 1
			inner join Idiomas c 
				on c.Iid = b.Iid
	...
	where a.Ecodigo=<cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
		...
		<cfif isdefined('form.FAGTPfalta') and len(trim(form.FAGTPfalta))>
			and a.AGTPfalta >= <cfqueryparam cfsqltype="cf_sql_date" value="#form.FAGTPfalta#">
		</cfif>
  ...
  <tr>
    <td>
		 ...
		 returnvariable="pListaRHRet">
			...
			<cfinvokeargument name="irA" value="repMejoras.cfm"/>
