<cf_htmlReportsHeaders 
	title="Impresion de Reporte de Depreciacion Fiscal"
	filename="RepDepreciacionFiscal.xls"
	irA="repDepreciacionFiscal.cfm?AGTPid="
	download="yes"
	preview="no">
...
<table width="100%" border="0" cellspacing="4" cellpadding="0">
  ...
  <tr class="style7">
    ...
    <!---Depreciacion Fiscal Adquisicion--->
    <td align="center">Depreciacion Fiscal de Adquisici&oacute;n</td>
    <!---Depreciacion Mejoras--->
    <td align="center">Depreciacion de Mejoras</td>
    <!---Depreciacion Fiscal Mejoras--->
    <td align="center">Depreciaci&oacute;n Fiscal de Mejora</td>
  </tr>
