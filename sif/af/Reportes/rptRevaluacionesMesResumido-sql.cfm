...
<cfinclude template="rptRevaluacionesMesResumido-query.cfm">
					...
					<cfif isdefined('url.imprimir')>	
						<cfinvoke 
						 ...
						 returnvariable="pListaRHRet">
							...
							<cfinvokeargument name="desplegar" value="CategoriaSinRepetidos, ClaseSinRepetidos, TipoMonto, Adquisicion, Mejoras, Revaluacion, MontoTotal, Indice, MontoRevaluacion"/>
							<cfinvokeargument name="etiquetas" value="Categor&iacute;a, Clase, , Monto Adquisici&oacute;n, Monto Mejoras, Monto Revaluaci&oacute;n, Monto Total, &Iacute;ndice, Monto Revaluaci&oacute;n"/>
