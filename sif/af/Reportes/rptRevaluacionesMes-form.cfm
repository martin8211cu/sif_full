<form action="rptRevaluacionesMes.cfm" method="get" name="form1" style="margin:0px;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" class="tituloAlterno">Reporte de Revaluaci&oacute;n por Periodo Mes</td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="tituloListas">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Este reporte muestra Todas los Revaluaciones de Activos Realizadas en un Periodo / Mes.</td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
