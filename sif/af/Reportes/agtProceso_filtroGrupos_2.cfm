<!---FAGTPperiodo, FAGTPmes, FAGTPcategoria, FAGTPclase, Oficodigo--->
<cfscript>
...
if (isdefined("url.Oficodigo") and len(trim(url.Oficodigo))) Oficodigo = url.Oficodigo;
...
if (isdefined("form.FAGTPclase") and len(trim(form.FAGTPclase))) FAGTPclase = form.FAGTPclase;
if (isdefined("form.Oficodigo") and len(trim(form.Oficodigo))) Oficodigo = form.Oficodigo;
...
if (isdefined("Oficodigo") and len(trim(Oficodigo))) { filtro = filtro & " and a.FOcodigo = #Oficodigo#"; navegacion = navegacion & "&Oficodigo=#Oficodigo#";}
...
<!---Categorias Reevaluables se llenan automáticamente cuando cambia la categoria--->
<cfquery name="rsCategoriasRev" datasource="#Session.DSN#">
	select distinct a.ACcodigo, b.ACdescripcion
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0" class="tituloListas" align="center">
<tr>
	<td align="center">
		<table border="0" cellspacing="0" cellpadding="0" style="margin:0" align="center">
		<tr>
		...
		<tr>
			<td nowrap="nowrap" align="right"><strong>Mes:</strong>&nbsp;</td>
			<td><select name="FAGTPmes"><option value="0">(indicar)</option><cfloop query="rsMeses"><option value="#Pvalor#" <cfif (isdefined("FAGTPmes") and len(trim(FAGTPmes)) and FAGTPmes eq Pvalor)>selected</cfif>>#Pdescripcion#</option></cfloop></select></td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap="nowrap" align="right"><strong>Formato:</strong>&nbsp;</td>
			<td><select name="FAGTPformato"><option value="1">HTML</option><option value="3">Texto</option></select></td>
		</tr>
		<tr>
			<td nowrap="nowrap" colspan="2"><cf_botones values="Generar"></td>
		</tr>
		</table>
	</td>
</tr>
