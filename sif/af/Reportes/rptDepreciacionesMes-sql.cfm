...
<cfinclude template="rptDepreciacionesMes-query.cfm">
					...
					<cfif isdefined('url.imprimir')>	
						<cfinvoke 
						 ...
						 returnvariable="pListaRHRet">
							...
							<cfinvokeargument name="desplegar" value="Placa, Activo, Oficina, CtaGastoDep, Adquisicion, Mejoras, Revaluacion, DepreciacionAdquisicion, DepreciacionMejoras, DepreciacionRevaluacion,  ValorLibrosDespues, espacio"/>
							...
							<cfinvokeargument name="etiquetas" value="Placa, Activo, Oficina, Cta. Gasto Dep., Adquisici&oacute;n, Mejoras, Revaluaci&oacute;n, Depreciacion Adquisici&oacute;n, Depreciacion Mejoras, Depreciaci&oacute;n Revaluaci&oacute;n,  Valor Libros Despues, "/>
