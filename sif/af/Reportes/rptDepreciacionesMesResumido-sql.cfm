...
<cfinclude template="rptDepreciacionesMesResumido-query.cfm">
  ...
  <tr>
    <td colspan="4">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td colspan="4" align="center"><span class="style1">Lista de Transacciones de Depreciaci&oacute;n</span></td>
			  </tr>
			  <tr>
				<td colspan="4" align="center"><span class="style1">Resumido por Categor&iacute;a Clase</span></td>
			  </tr>
					...
					<cfif isdefined('url.imprimir')>	
						<cfinvoke 
						 ...
						 returnvariable="pListaRHRet">
							...
							<cfinvokeargument name="cortes" value="CFuncional"/>
							<cfinvokeargument name="desplegar" value="Categoria, Clase, Oficina, CtaGastoDep, Adquisicion, Mejoras, Revaluacion, DepreciacionAdquisicion, DepreciacionMejoras, DepreciacionRevaluacion,  ValorLibrosDespues, espacio"/>
							<cfinvokeargument name="totales" value="Adquisicion,Mejoras,Revaluacion,DepreciacionAdquisicion,DepreciacionMejoras,DepreciacionRevaluacion,ValorLibrosDespues"/>
							<cfinvokeargument name="etiquetas" value="Categor&iacute;a, Clase, Oficina, Cta. Gasto Dep., Adquisici&oacute;n, Mejoras, Revaluaci&oacute;n, Depreciacion Adquisici&oacute;n, Depreciacion Mejoras, Depreciaci&oacute;n Revaluaci&oacute;n,  Valor Libros Despues, "/>
							<cfinvokeargument name="formatos" value="S,S,S,S,M,M,M,M,M,M,M,S"/>
							<cfinvokeargument name="align" value="left,left,left,left,right,right,right,right,right,right,right,left"/>							
					...
					<cfelse>
						<cfinvoke 
						 ...
						 returnvariable="pListaRHRet">
							...
							<cfinvokeargument name="totales" value="Adquisicion,Mejoras,Revaluacion,DepreciacionAdquisicion,DepreciacionMejoras,DepreciacionRevaluacion,ValorLibrosDespues"/>							
							<cfinvokeargument name="etiquetas" value="Categor&iacute;a, Clase, Oficina, Cta. Gasto Dep., Adquisici&oacute;n, Mejoras, Revaluaci&oacute;n, Depreciacion Adquisici&oacute;n, Depreciacion Mejoras, Depreciaci&oacute;n Revaluaci&oacute;n,  Valor Libros Despues, "/>
							<cfinvokeargument name="totalgenerales" value="Adquisicion,Mejoras,Revaluacion,DepreciacionAdquisicion,DepreciacionMejoras,DepreciacionRevaluacion,ValorLibrosDespues"/>
							<cfinvokeargument name="formatos" value="S,S,S,S,M,M,M,M,M,M,M,S"/>
							<cfinvokeargument name="align" value="left,left,left,left,right,right,right,right,right,right,right,left"/>							
							<cfinvokeargument name="showLink" value="false"/>
							<cfinvokeargument name="ajustar" value="N"/>
