...
<cfquery name="rsTiposGrupos" datasource="#Session.DSN#">
    ...
    where ID_Grupo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#fID_Grupo#">
...
<cfoutput>
<cfset campos = "">
<form name="filtro1" method="post" action="#GetFileFromPath(GetTemplatePath())#" style="margin: 0;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td class="tituloAlterno" align="center" style="text-transform: uppercase; ">
			<strong>Lista de Grupos de Cuentas de Mayor</strong>
		</td>
      </tr>
	  <tr>
		<td valign="top">
			...
			<cfinvoke
				...
				method="pLista"
				returnvariable="pListaReta"
				columnas="ID_Grupo, ID_Estr, EPGcodigo, EPGdescripcion"
				tabla="CGGrupoCtasMayor"
				filtro="1=1 #PreserveSingleQuotes(filtro)# order by ID_Grupo"
				desplegar="EPGcodigo,EPGdescripcion"
				etiquetas="C&oacute;digo,Descripci&oacute;n"
				formatos="S,S"
				align="left, left"
				checkboxes="N"
				ira="CatGrupoCtasMayor-form.cfm#params#"
				nuevo="CatGrupoCtasMayor-form.cfm#params#"
				formname="filtro1"
				showLink="true"
				showemptylistmsg="true"
				incluyeform="true"
				keys="ID_Grupo,ID_Estr"
				mostrar_filtro="true"
				filtrar_automatico="true"
				filtrar_por="ID_Grupo, ID_Estr"
				maxrows="15"
