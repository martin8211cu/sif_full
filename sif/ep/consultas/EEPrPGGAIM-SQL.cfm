...
<cfquery datasource="#session.dsn#">
    ...
    pcd.PCDvalor,pcd.PCDdescripcion,
    ...
    order by epv.EPCPcodigo,pcd.PCDvalor
</cfquery>
...
<cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_Estr,Seccion,CtpGsto,CGEPDescrip,TipoCta,Mcodigo,Campo8211,Campo8231A,Campo8231C,Campo8240,Campo8241, 
    Campo8251,Campo8261,Campo8271)
    values(4,36,'','SUMA GASTOS DE OPERACION','A',#varMcodigo#,
...
<cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_Estr,Seccion,CtpGsto,CGEPDescrip,TipoCta,Mcodigo,Campo8211,Campo8231A,Campo8231C,Campo8240,Campo8241, 
    Campo8251,Campo8261,Campo8271)
    values(4,50,'','TOTAL GASTO PROGRAMABLE','A',#varMcodigo#, 
