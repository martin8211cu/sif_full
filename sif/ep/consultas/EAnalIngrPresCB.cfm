...
<cfset Lvartitulo = 'Estado de Ejecuci&oacute;n de Ingresos por Rubros'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EAnalIngrPresCB-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
