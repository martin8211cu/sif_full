<!--- 
	Creado por E. Raúl Bravo Gómez
		Fecha: 03-01-2013.
	Reporte Estado del Ejercicio del Presupuesto de Egresos por Clasificación Económica y Capítulos del Gasto
 --->
...
<cfset Lvartitulo = 'Estado del Ejercicio del Presupuesto de Egresos por Clasificación Económica y Capítulos del Gasto'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EEPrEgrClsEcoCGst-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
