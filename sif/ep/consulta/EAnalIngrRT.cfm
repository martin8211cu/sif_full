<!--- 
	Creado por E. Raúl Bravo Gómez
		Fecha: 11-06-2013.
	Reporte Analítico de Ingresos por Rubro y Tipo
 --->
...
<cfinvoke key="Lvartitulo"	default='Estado Anal&iacute;tico por Rubro' 	returnvariable="Lvartitulo"					component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_PeríodoPresupuestario"	default='Periodo Presupuestario' 	returnvariable="LB_PeríodoPresupuestario"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LBMesdepresupuesto"	default='Mes de presupuesto' 				returnvariable="LBMesdepresupuesto"			component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_MensualAcumulado"	default='Mensual Acumulado' 				returnvariable="LB_MensualAcumulado"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Formato"		default='Formato' 				returnvariable="LB_Formato"			component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Presentacion"	default='Presentaci&oacute;n' 	returnvariable="LB_Presentacion"	component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="LB_Miles"	default='Miles' 		returnvariable="LB_Miles"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Millones"	default='Millones' 		returnvariable="LB_Millones"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Detallado"	default='Por Rubro y Tipo' returnvariable="LB_Detallado"	component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="post" action="EAnalIngrRT-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
			  ...
			  <td colspan="8"> 
				<div align="center">
                	...
                	<cfif isdefined('url.rsMensaje')> 
                    	<strong>#url.rsMensaje#</strong>                    
                    <cfelse>
				  		<input type="submit" name="Submit" value="#BTN_Consultar#" tabindex="18">&nbsp;
                        <input type="Reset" name="Limpiar" value="#BTN_Limpiar#" tabindex="19">                    
                    </cfif>
                    </cfoutput>
				</div>
			  </td>
