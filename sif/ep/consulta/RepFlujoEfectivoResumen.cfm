...
<cfset Lvartitulo = 'Flujo de Efectivo Resumen'>
<!--- Variables --->
...
<cfquery name="rsSaldos" datasource="#Session.DSN#">
	...
	order by EPSImes
		...
		<form name="form1" method="post" action="RepFlujoEfectivoResumen-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
			...
			<tr>
                ...
                <td>
                    <select name="mensAcum" size="1" tabindex="4" onchange="this.form.botonSel.value = ''; submit()">
                        ...
                        <option value="2" <cfif (isdefined("form.mensAcum") and form.mensAcum EQ "2")>selected</cfif>>Acumulado</option>
                    </select>
                </td>
            </tr>
           <tr>
            ...
            <cfloop from="1" to="3" index="j">
                ...
                <td>
                    <table width="100%" align="center" border="0" >
                        ...
                        <tr>
                            <td align="right" nowrap><div align="right">Utilidad (P&eacute;rdida) en Cambio:&nbsp;</div></td>
                            <td nowrap>
                                <div align="left">
