...
<cfset Lvartitulo = 'Estado Anal&iacute;tico por Fuente de Ingresos Presupuestales'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EAxFIngrPres-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
            ...
            <tr>
            	<td colspan="3" align="left" nowrap="nowrap">Saldo contable de las disponibilidades y activos financieros</td>
            </tr>
            <tr>
            	<script language="javascript" src="../../js/utilesMonto.js"></script>
                <td align="left" colspan="2">Presupuesto de Ingresos Aprobado</td>
                <td align="right">
                	<input 	name="PrIngAprob" id="PrIngAprob" tabindex="16" 
                    <!---onblur="formatCurrency(this,2);"---> 
            ...
            <tr> 
                <td align="left" colspan="2">Presupuesto de Ingresos Modificado</td>            
               <td align="right">
                	<input 	name="PrIngModif" id="PrIngModif" tabindex="17" 
                    <!---onblur="formatCurrency(this,2);"---> 
                    onfocus="javascript:this.select();"  
                    size="18" value=0.00
                    onkeyup="javascript:if(snumber(this,event,2)){ if(Key(event)=='13') {this.blur();}}">
