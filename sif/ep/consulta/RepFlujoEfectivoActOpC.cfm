...
<cfset Lvartitulo = 'Flujo de Efectivo por Actividades de Operaci&oacute;n (CONAC)'>
<!--- Variables --->
...
<form name="form1" method="post" action="RepFlujoEfectivoActOpC-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
        ...
        <cfloop from="1" to="#PageCount#" index="i">
            ...
            <cfloop from="1" to="3" index="j">
                <cfif ix LTE Arguments.mes>
                 ...
                 <tr>
                    <td align="right" nowrap><div align="right">Cheques en Transito:&nbsp;</div></td>
                <td nowrap>
                <div align="left">
                    <cf_inputNumber  readonly="true" name="ChequeI#ix#" value="#arSaldos[ix].chequef - arSaldos[ix].chequei#" enteros = "15" decimales = "2">
                    </div>
                    </td>
                    </tr>
                   <!--- <tr>
                    ...
                    <td nowrap>
                    <div align="left">
                    <cf_inputNumber  name="ChequeF#ix#" value="0" enteros = "15" decimales = "2">
                    </div>
                    </td>
                    </tr> --->
                    <tr>
