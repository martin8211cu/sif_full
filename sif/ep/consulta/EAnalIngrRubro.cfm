<!--- 
	Creado por E. Raúl Bravo Gómez
		Fecha: 11-06-2013.
	Reporte Analítico de Ingresos por Rubro
 --->
...
<cfinvoke key="LB_Detallado"	default='Por Rubro' returnvariable="LB_Detallado"	component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="post" action="EAnalIngrRubro-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
