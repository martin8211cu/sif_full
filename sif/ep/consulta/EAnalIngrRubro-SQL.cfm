...
--->
<cfset LvarIrA  = 'EAnalIngrRubro.cfm'>
<cfset LvarFile = 'EAnalIngrRubro'>
...
<cfif isdefined('rsMensaje')>
	<cflocation url="EAnalIngrRubro.cfm?rsMensaje=#rsMensaje#">
</cfif>
...
<cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_GrupoCat, ID_EstrCtaVal, EPCPcodigo, Descripcion,Nota, ID_DEstrCtaVal, PCDcatid, Mcodigo, IngrEst, Modific, IngrMod, IngrDev, IngrRec, ModificPer)
    select c.ID_Grupo,c.ID_EstrCtaVal ,c.EPCPcodigo,c.EPCPdescripcion,c.EPCPcodigoref, coalesce(d.ID_DEstrCtaVal,0), coalesce(p.PCDcatid,0), #varMcodigo#, 0 ,0 ,0 ,0, 0, 0
