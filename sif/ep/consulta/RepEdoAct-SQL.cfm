...
<!---  <cf_dump var="#form#"> --->
<cfinvoke key="MSG_EdoAct" default="Estado de Actividades"	returnvariable="MSG_EdoAct"
...
<cfset LvarIrA = 'RepEdoAct.cfm'>
<cfset LvarFile = 'RepEdoAct'>
<cfset Request.LvarTitle = #MSG_EdoAct#>
...
<cfif isdefined('rsMensaje')>
	<cflocation url="RepEdoAct.cfm?rsMensaje=#rsMensaje#">
</cfif>
