...
<cfinvoke key="MSG_ReporteAnalitico" default="Estado del Ejercicio del Presupuesto  por Programa, Actividad institucional, Clasificaci&oacute;n Econ&oacute;mica y Cap&iacute;tulos del Gasto"	returnvariable="MSG_ReporteAnalitico"	
...
<cfquery name="rsPrograma" datasource="#session.dsn#">
    ...
    case d.PCCDvalor
        ...
        when 'E527' then 'COMERCIALIZACIÓN DE PETRÓLEO Y PRESTACIÓN DE SERVICIOS COMERCIALES Y ADMINISTRATIVOS'
...
<cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_Estr,Seccion,CtpGsto,PCCDclaid,CGEPDescrip,TipoCta,Mcodigo,Campo8211,Campo8231A,Campo8231C, Campo8240,Campo8241,Campo8251,Campo8261,Campo8271)
    values(8,4,9100,'','TOTAL PROGRAMA J007','A',#varMcodigo#, #GstoCorrJ8211#, #GstoCorrJ8231A#, #GstoCorrJ8231C#, #GstoCorrJ8240#, #GstoCorrJ8241#, #GstoCorrJ8251#, #GstoCorrJ8261#, #GstoCorrJ8271#)
</cfquery>
<cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_Estr,Seccion,CtpGsto,PCCDclaid,CGEPDescrip,TipoCta,Mcodigo,Campo8211,Campo8231A,Campo8231C, Campo8240,Campo8241,Campo8251,Campo8261,Campo8271)
...
<cfquery name="rsDetalle" datasource="#Session.DSN#">
    ...
    s.Seccion,
    case s.Seccion
        when 1 then 'ACTIVIDADES DE APOYO A LA FUNCIÓN PÚBLICA Y BUEN GOBIERNO'
        when 2 then 'ACTIVIDADES DE APOYO ADMINISTRATIVO'
        when 3 then 'COMERCIALIZACIÓN DE PETRÓLEO Y PRESTACIÓN DE SERVICIOS COMERCIALES Y ADMINISTRATIVOS'
