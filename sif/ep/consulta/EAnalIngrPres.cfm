...
<cfset Lvartitulo = 'Estado Anal&iacute;tico de Ingresos Presupuestales'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EAnalIngrPres-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
            ...
            <tr>
            	<td colspan="4" align="left" nowrap="nowrap">Saldo contable de las disponibilidades y activos financieros</td>
            </tr>
            <tr>
