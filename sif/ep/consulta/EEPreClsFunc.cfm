...
<cfset Lvartitulo = 'Estado del Ejercicio del Presupuesto por Clasificación Funcional'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EEPreClsFunc-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
