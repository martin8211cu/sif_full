...
<cfinvoke key="Lvartitulo"	default="Papel de Trabajo Cap&iacute;tulo 3000"	returnvariable="Lvartitulo"	component="sif.Componentes.Translate" method="Translate"/>
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="post" action="PapelTrCap3000-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
