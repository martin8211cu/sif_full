...
<cfinvoke key="LB_Funcion" 		default="Funci&oacute;n"		returnvariable="LB_Funcion"		component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_SubFuncion" 	default="Subfunci&oacute;n"	returnvariable="LB_SubFuncion"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Total"		default="Total" 		returnvariable="LB_Total"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Gobierno"		default="Gobierno" 		returnvariable="LB_Gobierno"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_DesEco"		default="Desarrollo Econ&oacute;mico" 		returnvariable="LB_DesEco"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_AdmPub"		default="Administraci&oacute;n P&uacute;blica" 		returnvariable="LB_AdmPub"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Energia"		default="Energ&iacute;a"	returnvariable="LB_Energia"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_FuncPub"		default="Funci&oacute;n P&uacute;blica" 	returnvariable="LB_FuncPub"	component="sif.Componentes.Translate" method="Translate"/>
<cfinvoke key="LB_Hidro"		default="Hidrocarburos" returnvariable="LB_Hidro"	component="sif.Componentes.Translate" method="Translate"/>
...
<cfquery datasource="#session.dsn#">
 ...
 <cfquery datasource="#session.dsn#">
	insert into #saldoscuenta#(ID_Estr,Seccion,CGEPCtaMayor,CGEPDescrip,TipoCta,Mcodigo,Campo1000,Campo2000)
    values(4,10,'#CtaModPresExtr# (Cargo)','REDUCCIONES','C',#varMcodigo#,0 ,0)
 </cfquery>
...
<cfelse>
    ...
    <cfoutput>
		...
		<table width="100%">
        	<tr>
                <td align="center" rowspan="6" valign="middle" nowrap="nowrap"><strong>#LB_CtaMayor#</strong></td>
                <td align="left"   rowspan="6" valign="middle" nowrap="nowrap"><strong>#LB_Ejerc# #LB_Momentos#</strong></td>
                <td align="center"><strong>#LB_Finalidad#(1)</strong></td>
                <td align="center"><strong>#LB_Finalidad#(3)</strong></td>          
                <td align="center" rowspan="4" valign="middle" nowrap="nowrap"><strong>#LB_Total#</strong></td>
            </tr>
            <tr>
                <td align="center"><strong>#LB_Gobierno#</strong></td>
                <td align="center"><strong>#LB_DesEco#</strong></td>                          
            </tr>
            <tr>
            ...
            <tr>
                <td align="center"><strong>#LB_AdmPub#</strong></td>
                <td align="center"><strong>#LB_Energia#</strong></td>
			</tr>
            <tr>
            ...
            <tr>
                <td align="center"><strong>#LB_FuncPub#</strong></td>
                <td align="center"><strong>#LB_Hidro#</strong></td>
			</tr>            
