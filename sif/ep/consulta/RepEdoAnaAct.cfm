...
<cfset Lvartitulo = 'Estado Analítico del Activo'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="RepEdoAnaAct-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
			<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
			<tr>
			  <td nowrap><div align="right">Período inicial:&nbsp;</div></td>
			  <td>
				<select name="periodo1" tabindex="3">
			...
			<td nowrap><div align="right">Mes inicial:&nbsp;</div></td>
              <td>
                <select name="mes1" size="1" tabindex="4">
			...
			<tr>
			  ...
			  <td nowrap><div align="right">Período final:&nbsp;</div></td>
			  <td>
				...
				<td nowrap><div align="right">Mes final:&nbsp;</div></td>
                <td>
			...
			<tr>
				<td colspan="4"/>
				<td align="right" nowrap><div align="right">Presentar codificación:&nbsp;</div></td>
                <td nowrap>
              	<div align="left">
					<input type="checkbox" name="chkCeros" checked tabindex="17">
			  	</div>
               </td>
			</tr>
			<tr>
