...
<cfset Lvartitulo = 'Estado del Ejercicio del Presupuesto por Programa, Partida Genérica del Gasto, Actividad Institucional y Modalidad'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EEPrPGGAIM-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
            ...
            <tr>
              <td align="right" nowrap><div align="right">Modalidad:&nbsp;</div></td>
			  <td colspan="5">
				<select name="Modalidad" tabindex="5">
					<cfoutput query="rsPrograma">
                      <option value="#rsPrograma.PCCDclaid#">#rsPrograma.PCCDvalor# #rsPrograma.descrip#</option>
                    </cfoutput>
				</select>
			  </td>
            </tr>
			<tr> 
			  ...
			  <td rowspan="3" valign="top">
              	<table border="0" cellspacing="0" cellpadding="2">
                    <tr>
                      <td nowrap><input name="mcodigoopt" type="radio" value="-2" checked tabindex="6"></td>
			...
			<tr> 
			  <td colspan="6"> 
				<div align="center">
                    ...
                    <cfelse>
				  		<input type="submit" name="Submit" value="Consultar" tabindex="17">&nbsp;
                        <input type="Reset" name="Limpiar" value="Limpiar" tabindex="18">                    
                    </cfif>
				</div>
			  </td>
			</tr>
