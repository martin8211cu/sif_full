...
<cfinvoke key="MSG_ReporteAnalitico" default="Estado Anal&iacutetico; de Ingresos por Rubro y Tipo"	returnvariable="MSG_ReporteAnalitico"	
...
<cfinvoke key="LB_Rubro" 	 default="Rubros de los"	returnvariable="LB_Rubro"	  	component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="MSG_Reduciones" 	default="Reducciones"	returnvariable="MSG_Reduciones"		component="sif.Componentes.Translate" method="Translate"/>
...
<cfinvoke key="MSG_Avance" 		default="% Avance"		returnvariable="MSG_Avance"			component="sif.Componentes.Translate" method="Translate"/>
...
<cfset LvarIrA = 'EAnalIngrCB.cfm'>
<cfset LvarFile = 'EAnalIngrCB'>
...
<cfquery name="rsDetalle" datasource="#Session.DSN#">
	select left(p.PCDvalor,1) as Agrup,
    left(p.PCDvalor,1)+'.'+substring(p.PCDvalor,2,2) as PCDvalor,
	p.PCDdescripcion,
    CampoA/#varUnidad# as CampoA,
   	CampoB/#varUnidad# as CampoB,
    CampoC*(-1)/#varUnidad# as CampoC,
	CampoD*(-1)/#varUnidad# as CampoD,
    CampoE*(-1)/#varUnidad# as CampoE,
    case (CampoA + CampoB)
        when 0 then 0
        else CampoD*100/(CampoA + CampoB)
	end as Avance
    from #saldoscuenta# s
...
<cfif form.formato NEQ "HTML">
    ...
    <cfset TotalCampoD  = 0>
    <cfset TotalCampoE  = 0>
	<cfset TotalICampoA = 0>
    <cfset TotalICampoB = 0>
    <cfset TotalICampoC = 0>
    ...
    <cfif (TotalICampoA+TotalICampoB) eq 0>
    	<cfset TotalIAvance = 0> 
    <cfelse>
    	<cfset TotalIAvance = TotalICampoD*100/(TotalICampoA+TotalICampoB)> 
    </cfif>
    <cfset TotalIAvance = Abs(TotalIAvance)>
    <cfset TotalICampoF = #TotalICampoA# + #TotalCampoB#>
    <cfreport format="#form.formato#" template= "EAnalIngrCB.cfr" query="rsDetalle">
        ...
        <cfreportparam name="TotalICampoF" 	value="#TotalICampoF#">
    </cfreport> 
<cfelse>
    <cfoutput>
    ...
    <cfoutput>
		...
		<table width="100%">
            ...
            <cfloop query="rsDetalle">
				<cfif vRubro neq rsDetalle.Agrup>
                	<cfset vRubro = #rsDetalle.Agrup#>
                    <cfswitch expression="#vRubro#">
                    	<cfcase value="7">
                        	<cfset DescrRubro= 'INGRESOS POR VENTA DE BIENES Y SERVICIOS'>
                        </cfcase>
                    	<cfcase value="8">
                        	<cfset DescrRubro= 'APORTACIONES'>
                        </cfcase>
                    	<cfcase value="9">
                        	<cfset DescrRubro= 'TRANSFERENCIAS, ASIGNACIONES Y DONATIVOS RECIBIDOS'>
                        </cfcase>
                        <cfdefaultcase>
                        	<cfset DescrRubro=''>
                        </cfdefaultcase>
                    ...
                    <tr>
                        <td nowrap align="left"><strong>#UCase(rsDetalle.Agrup)#&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#UCase(DescrRubro)#</strong></td>
                    </tr>    
				</cfif>
                <tr>
					<td nowrap align="left">#UCase(rsDetalle.PCDvalor)# #UCase(rsDetalle.PCDdescripcion)#</td>
                    <td nowrap align="right">#numberformat(rsdetalle.CampoA, ",9.00")#</td>
                    <td nowrap align="right">#numberformat(rsdetalle.CampoB, ",9.00")#</td>
                    <td nowrap align="right">#numberformat(rsdetalle.CampoA+rsdetalle.CampoB, ",9.00")#</td>
                    ...
                    <td nowrap align="right">
                    	<cfif (rsdetalle.CampoA+rsdetalle.CampoB) eq 0>
                       		<cfset CampoF = 0>
                        <cfelse>
                        	<cfset CampoF = #rsdetalle.CampoD#/(#rsdetalle.CampoA#+#rsdetalle.CampoB#)>
...
--->            
			<tr>
                ...
                <td nowrap align="right">#numberformat(TotalICampoA + TotalICampoB, ",9.00")#</td>
                ...
                <td nowrap align="right">
					<cfif (TotalICampoA+TotalICampoB) eq 0>
                        <cfset CampoF = 0>
                    <cfelse>
                        <cfset CampoF = #TotalICampoD#/(#TotalICampoA#+#TotalICampoB#)>
                        <cfset CampoF = CampoF * 100>
                    </cfif>
                    #numberformat(CampoF, ",9.00")#
                </td>   
