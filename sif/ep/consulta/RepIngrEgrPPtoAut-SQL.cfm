...
<!---  <cf_dump var="#form#"> --->
<cfinvoke key="MSG_SitucionFDet" default="Presupuesto de Ingresos y Presupuesto de Egresos Autorizados para el Ejercicio "	returnvariable="MSG_SitucionFDet"
...
<cfset LvarIrA = 'RepIngrEgrPPtoAut.cfm'>
<cfset LvarFile = 'RepIngrEgrPPtoAut.cfm'>
...
<cfif rsCPPid.RecordCount eq 0>
	<cfset rsMensaje = "No se encuentran parametrizadas las cuentas de la contabilidad presupuestaria para el periodo &#form.periodo#">
<!--- <cfelse>
...
<cfif isdefined('rsMensaje')>
	<cflocation url="RepIngrEgrPPtoAut.cfm?rsMensaje=#rsMensaje#">
</cfif>
...
<cfquery name="rsActivos" datasource="#session.dsn#">
	...
	from #rsArbol# ar
	left join (
		select ID_EstrCtaVal, sum(CPCpresupuestado) CPCpresupuestado
		from #rsSaldoMes#
            	...
            	<td valign="top">
					<table width="100%" border="0" cellspacing="0">
						...
						<tr>
						    ...
						    <td nowrap align="right"><strong>#LSNumberFormat(LSParseNumber(form.disponibilidad) + rsTActivos.Saldo - rsTPasivos.Saldo, ',9.00')#</strong></td>
						</tr>
					</table>
				</td>
            </tr>
