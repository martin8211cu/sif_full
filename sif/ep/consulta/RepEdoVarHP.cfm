...
<cfset Lvartitulo = 'Estado de Variaciones en la Hacienda Publica'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="RepEdoVarHP-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
