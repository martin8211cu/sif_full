...
<cfset Lvartitulo = 'Estado del Ejercicio del Presupuesto por Modalidad, Actividad Institucional y Programa'>
<!--- Variables --->
...
<cf_templateheader title="#Lvartitulo#">
	<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#Lvartitulo#'>
		...
		<form name="form1" method="get" action="EEPresMAIP-SQL.cfm" style="margin:0; " onsubmit="return sinbotones()">
