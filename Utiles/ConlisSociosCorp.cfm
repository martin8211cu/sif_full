<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaSociosNegocios" default = "Lista de Socios de Negocio" returnvariable="LB_ListaSociosNegocios" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaProveedores" default = "Lista de Proveedores" returnvariable="LB_ListaProveedores" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_ListaClientes" default = "Lista de Clientes" returnvariable="LB_ListaClientes" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Numero" default = "N&uacute;mero" returnvariable="LB_Numero" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Codigo" default = "C&oacute;digo" returnvariable="LB_Codigo" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_Descripcion" default = "Descripci&oacute;n" returnvariable="LB_Descripcion" xmlfile = "ConlisSociosCorp.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "BTN_Filtrar" default = "Filtrar" returnvariable="BTN_Filtrar" xmlfile = "ConlisSociosCorp.xml">
...
<cfset descripcion = "#LB_ListaSociosNegocios#" >
<cfif isdefined("form.tipo") and len(trim(form.tipo))>
	...
	<cfif form.tipo eq 'P'>
		<cfset descripcion = "#LB_ListaProveedores#" >
	<cfelse>
		<cfset descripcion = "#LB_ListaClientes#" >
	</cfif>
</cfif> 
...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<tr><td>
		<cfoutput>
		<form style="margin:0;" name="filtroEmpleado" method="post" action="ConlisSociosCorp.cfm" >
		<table width="100%" border="0" cellpadding="2" cellspacing="0" class="areaFiltro">
			<tr>
				<td align="right"><strong>#LB_Numero#</strong></td>
				<td> 
	...
	<tr><td>
		...
		<cfinvoke 
		 ...
		 returnvariable="pListaRet">
			...
			<cfinvokeargument name="irA" value="ConlisSociosCorp.cfm"/>
