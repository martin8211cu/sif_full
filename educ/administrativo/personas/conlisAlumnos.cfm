...
<cfif isdefined('Url.quitar') and Url.quitar NEQ ''>
	<cfoutput>
		<cfset filtro = filtro & " and Apersona not in (#Url.quitar#)">
	</cfoutput>
</cfif>
...
<cfinvoke 
 ...
 returnvariable="pListaRet">
	<cfinvokeargument name="tabla" value="Alumno"/>
	<cfinvokeargument name="columnas" value="
		(Pnombre + ' ' + Papellido1 + ' ' + Papellido2) as nombreAl
		, convert(varchar, Apersona) as Apersona"/>
	<cfinvokeargument name="desplegar" value="nombreAl"/>
	<cfinvokeargument name="etiquetas" value="Alumno"/>
	...
	<cfinvokeargument name="irA" value="conlisAlumnos.cfm"/>
	<cfinvokeargument name="formName" value="listaAlumnos"/>
	<cfinvokeargument name="MaxRows" value="15"/>
	<cfinvokeargument name="funcion" value="Asignar"/>
	<cfinvokeargument name="fparams" value="Apersona"/>
