...
<cfif IsDefined("url.otros")>Seleccione los Cobros por Aplicar
<cfset link='otros_pagos2.cfm'>
<cfelse>Seleccione los Cobros por Efectuar
<cfset link='payment.cfm'>
</cfif></cf_templatearea>

<cf_templatearea name="body">


<cfinvoke component="cobros" method="generar_documentos_de_cobro" />
...
<cfinvoke component="sif.rh.Componentes.pListas" method="pListaQuery"
	...
	EmptyListMsg="<h2>No hay cobros pendientes</h2>" >
