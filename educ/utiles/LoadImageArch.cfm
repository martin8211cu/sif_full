<cfif isdefined("url.codigo") and Len(Trim(url.codigo)) NEQ 0
  ...
  and isdefined("Session.Usucodigo") and Len(Trim(Session.Usucodigo)) NEQ 0>

	<cfheader name="Content-Disposition" value="filename=#url.nombre#">
	<cfcontent type="#url.tipocont#" file="#gettempdirectory()##Session.Usucodigo##url.codigo#.dat" deleteFile="yes">
