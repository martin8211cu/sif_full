...
<cfoutput>
  ...
  <cfif form.chkCerrarPeriodo eq "0" and form.hdnCerrarPeriodoAnt eq "1">
	<cfinvoke 
	 ...
	 returnvariable="qryCorreos">
		...
		<cfinvokeargument name="addWhere" value="cu.Ccodigo  = #form.cboCurso#
                                             and cu.CEcodigo = #Session.CEcodigo#
	...
	<!---
    <cfquery datasource="#Session.DSN#" name="qryCorreos">
      set nocount on
...
<cfcatch>
    <cfset LvarURL = "/cfmx/educ/errorPages/BDerror.cfm?errType=0&errMsg=" & urlencodedformat(cfcatch.Detail) 
