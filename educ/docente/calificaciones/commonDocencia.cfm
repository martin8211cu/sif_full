...
<cfif isdefined("Form.CEcodigo")>
  <cfset Session.CEcodigo = Form.CEcodigo>
	<!--- al cambiar de Centro de Estudio, hay que reinicializar los combos --->
    ...
    <cfif LprmUsucodigo neq "" and LprmUsucodigo neq "-1" and LprmUlocalizacion neq ""
	  ...
	  <cfcatch>
        <cfset LvarTblError = "fnNotificarCorreoBuzon: Error al utilizar Servidor de correos<br><br>" & cfcatch.Message>
          ...
          <cfset LvarURL="/cfmx/educ/errorPages/BDerror.cfm?errType=0&errMsg=" & urlencodedformat(LvarTblError)>
...
<cffunction name="sbInitFromSessionChks">
  ...
  <cfif LprmNoChange>
    <cfset Form[LprmChk] = Session.docencia[LprmChk]>
  <cfelseif isdefined("Form.#LprmChk#")>
    <cfset Form[LprmChk] = 1>
  <cfelseif isdefined("Form.hdn#LprmChk#")>
    <cfset Form[LprmChk] = 0>
  <cfelse>
    <cfset Form[LprmChk] = Session.docencia[LprmChk]>
  </cfif>
...
<cffunction name="sbInitFromCookie">
           <cfargument name="LprmControl" required="true" type="string">
           <cfargument name="LprmDefault" required="true" type="string">
           <cfargument name="LprmNoChange" required="false" type="boolean" default=false>
  <cfparam name="cookie.docencia.#LprmControl#" default="#LprmDefault#">
  <cfif isdefined("session.docencia.#LprmControl#")>
    <cfset sbInitFromSession(LprmControl,LprmDefault,LprmNoChange)>
  <cfelseif LprmNoChange>
    <cfset Form[LprmControl] = evaluate("cookie.docencia.#LprmControl#")>
  <cfelseif not isdefined("Form.#LprmControl#")>
    <cfset Form[LprmControl] = evaluate("cookie.docencia.#LprmControl#")>
  </cfif>
  <cfset "cookie.docencia.#LprmControl#" = Form[LprmControl]>
  <cfset "session.docencia.#LprmControl#" = Form[LprmControl]>
</cffunction>

<cffunction name="sbInitFromCookieChks">
           <cfargument name="LprmChk"     required="true" type="string">
           <cfargument name="LprmDefault" required="true" type="string">
           <cfargument name="LprmNoChange" required="false" type="boolean" default=false>
		   <!--- 
		   ...
		   Si no, siempre va a encender encender el chkCAMPO
		   --->
  <cfparam name="cookie.docencia.#LprmChk#" default="#LprmDefault#">
  <cfif isdefined("session.docencia.#LprmChk#")>
    <cfset sbInitFromSessionChks(LprmChk,LprmDefault,LprmNoChange)>
  <cfelseif LprmNoChange>
    <cfset Form[LprmChk] = evaluate("cookie.docencia.#LprmChk#")>
  <cfelseif isdefined("Form.#LprmChk#")>
    <cfset Form[LprmChk] = 1>
  <cfelseif isdefined("Form.hdn#LprmChk#")>
    <cfset Form[LprmChk] = 0>
  ...
  <cfset "cookie.docencia.#LprmChk#" = Form[LprmChk]>
  <cfset "session.docencia.#LprmChk#" = Form[LprmChk]>
</cffunction>
