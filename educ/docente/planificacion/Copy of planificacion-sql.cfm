		...
		<cfif isdefined("Form.Alta")>
			<cfquery name="ABC_Evaluacion" datasource="#Session.DSN#">
				...
				values (
					...
					convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CEVfechaPlan#">, 103),
				...
				update CursoEvaluacion
				   set CEVnombre = <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CEVnombre#">,
					...
					<cfelseif Form.CEVtipoCalificacion EQ 'T'>
					   ...
					   CEVfechaPlan = convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CEVfechaPlan#">, 103),
					<cfif isdefined("Form.CEVfechaReal") and Len(Trim(Form.CEVfechaReal)) NEQ 0>
					   CEVfechaReal = convert(datetime, <cfqueryparam cfsqltype="cf_sql_varchar" value="#Form.CEVfechaReal#">, 103),
					<cfelse>
					   CEVfechaReal = null,
					</cfif>
