<!-- InstanceBegin template="/Templates/tUniv.dwt.cfm" codeOutsideHTMLIsLocked="false" --><cf_template >
	...
	<!-- InstanceBeginEditable name="cuerpo" -->
		...
		<cfif isdefined("Url.TabsPlan") and not isdefined("Form.TabsPlan")>
			<cfparam name="Form.TabsPlan" default="#Url.TabsPlan#">
		</cfif>
		<cfif isdefined("Url.PEScodigo") and not isdefined("Form.PEScodigo")>
			<cfparam name="Form.PEScodigo" default="#Url.PEScodigo#">
		</cfif>
		<cfif isdefined("Url.CARcodigo") and not isdefined("Form.CARcodigo")>
			<cfparam name="Form.CARcodigo" default="#Url.CARcodigo#">
		</cfif>
...
<!--- <cfdump var="#form#"		> --->
		...
		<cfelse>
			...
			<cfif Form.nivel EQ 2>
				<cfif isdefined('form.TabsPlan') and form.TabsPlan EQ 1>
					...
					<cfset titulo = "Plan">
				<cfelseif isdefined('form.TabsPlan') and form.TabsPlan EQ 2>
					<cfset titulo = "Documentaciones">
				<cfelseif isdefined('form.TabsPlan') and form.TabsPlan EQ 3>
					<cfif isdefined('form.modo') and form.modo EQ "MPalta" or form.modo EQ "MPcambio">
						<cfset navBarItems[3] = "Bloques">
						<cfset navBarLinks[3] = "/cfmx/educ/director/planAcademico/CarrerasPlanes.cfm?modo=CAMBIO&nivel=2&TabsPlan=3&PEScodigo=#form.PEScodigo#&CARcodigo=#form.CARcodigo#">				
