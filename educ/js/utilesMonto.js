// Validación de campos tipo fecha en el evento onblur
...
function Key(evento)
 ...
 if (version4) { // Navigator 4.0x 
  ...
  if (evento.type.substring(0,3) == "key") { // the user entered a character
...
//------------------------------------------------------------------------------------------
// Se utiliza para realizar Colices, esta funci'on abre una nueva ventana con la liga de lo que se
//va a pintar como primer parametro, los dem'as son los tamaños de la ventana que se abre 
