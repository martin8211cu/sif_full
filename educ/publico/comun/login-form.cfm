...
<body>
--->
<cfparam name="url.uri" default="#GetFileFromPath(GetTemplatePath())#">
  ...
  <table cellpadding="0" cellspacing="0" >
    ...
    <tr> 
      <td valign="top" class="g"><table border="0" cellpadding="0" cellspacing="0" align="center" >
          ...
          <tr>
            <td colspan="2" align="left" valign="top" ><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0000"><b>Usuario o contrase&ntilde;a incorrectos. </b></font></div></td>
          </tr>
          <tr>
...
<cfif Len(session.sitio.CEcodigo) EQ 0>
          ...
          <tr> 
            <td align=left valign=top colspan="2"> <div align="center"><font size="1"> 
                ...
                <input type="checkbox" name="recordar" value="checkbox" tabindex="4">
