...
<form name="form1" action="TransferirTransacciones.cfm" method="post">
<cfoutput>
					...
					<td colspan="3">
						...
						<table width="100%" border="0" cellspacing="5" cellpadding="5" align="center">
							...
							<cfloop query = 'q_Transacciones'>
								...
								<tr>
									...
									<td style="#tdStyle#" align="center">#q_Transacciones.TipoMov#</td>
									...
									<td style="#tdStyle#">
										...
										<cfif arrayFind(['VC','TC','TM','RC'], trim(q_Transacciones.TipoTransaccion)) gt 0>
											<button type="button" onclick="openDetail(#q_Transacciones.id#);"><i alt="Transferir" class="fa fa-share"></i></button>
										<cfelse>&nbsp;</cfif>
						...
						<script>
							function openDetail(id){
								window.location.href = "TransferirTransacciones.cfm?tran_id="+id;
							}
						</script>
					</td>
				</tr>
