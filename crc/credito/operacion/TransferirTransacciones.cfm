...
<cfset LB_TituloH 					= t.Translate('LB_TituloH','Transferir Transacciones')>
<cfset TIT_ConsultaTransacciones 	= t.Translate('TIT_ConsultaTransacciones','Transferir Transacciones')>
...
<cfset LB_TituloH 		= t.Translate('LB_TituloH','Transferir de Transacciones')>
...
<cfif isdefined("url.tran_id")>
	<cfinclude template="TransferirTransacciones_form.cfm">
<cfelse>
	<cfinclude template="TransferirTransacciones_lista.cfm">
</cfif>
<cf_web_portlet_end>			
