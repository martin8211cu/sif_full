<!--- ** Creado por Jose Gutierrez ---Marzo 2018---***********
***********************************************************************************************--->
...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_ReAplicacionPagos" Default="Re aplicaci&oacute;n de pagos TC" XmlFile="/sif/generales.xml" returnvariable="LB_ReAplicacionPagos"/>
...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_SociosNegocio" Default= "Re aplicaci&oacute;n de pagos TC" XmlFile="listaSocios.xml" returnvariable="LB_SociosNegocio"/>
...
<cfset Filtro2 = " and (TarjH = 1)">
			<cfinvoke
				...
				<cfinvokeargument name="irA" value="ReAplicacionPagosTC_form.cfm"/>
