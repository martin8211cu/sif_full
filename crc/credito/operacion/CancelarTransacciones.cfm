...
<cfset LB_TituloH 					= t.Translate('LB_TituloH','Cancelar Transacciones')>
<cfset TIT_ConsultaTransacciones 	= t.Translate('TIT_ConsultaTransacciones','Cancelar Transacciones')>
...
<cfif isdefined("url.tran_id")>
	<cfinclude template="CancelarTransacciones_form.cfm">
<cfelse>
	<cfinclude template="CancelarTransacciones_lista.cfm">
</cfif>
<cf_web_portlet_end>			
