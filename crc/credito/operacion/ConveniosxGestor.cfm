...
<cfset filterUsr = "(B.DatosEmpleadoDEid = #q_usuario.llave# or B.DatosEmpleadoDEid2 = #q_usuario.llave#) and">
			...
			<tr>
				<td>
					<cfinvoke component="commons.Componentes.pListas" method="pListaRH"
						...
						filtro="#filterUsr# A.Ecodigo=#session.Ecodigo#"
						align="left,left,left,left,left,left"
						checkboxes="N"
						mostrar_filtro="yes"
						filtrar_automatico="yes"
						ira="Convenios_form.cfm?b=1&a=0"
						keys="id">
					</cfinvoke>
				</td>
				<td>
			...
			<tr>
				<td colspan="2" align="center">
					<form action="Convenios_form.cfm" method="POST">
						...
						<input type="hidden" name="parentEntrancePoint" value="ConveniosxGestor.cfm">
					</form>
				</td>
			</tr>
