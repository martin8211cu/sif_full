<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Title" Default="Registro de incidencias" returnvariable="LB_Title"/>
...
<cfset parentEntrancePoint="registroIncidencia.cfm">
						...
						<cfif isdefined('form.id')>
							<cfif isdefined('form.whatToDo')>
								<cfif form.whatToDo neq "">
									<cfinclude template="IncidenciasSQL.cfm">
								</cfif>
							</cfif>
