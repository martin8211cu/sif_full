<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Title" Default="Impresion de Estados de Cuentas" returnvariable="LB_Title"/>
...
<cfset parentEntrancePoint="EstadosCuenta.cfm">
			...
			<tr>
				<td>
					<cfif isdefined('form.id')>
						<cfif isdefined('form.codigoselect')>
							<cfinclude template="EstadosCuenta_sql.cfm">
						</cfif>
						<cfinclude template="EstadosCuenta_form.cfm">
					<cfelse>
						<cfinclude template="EstadosCuenta_lista.cfm">
					</cfif>
				</td>
			</tr>
			<tr>
