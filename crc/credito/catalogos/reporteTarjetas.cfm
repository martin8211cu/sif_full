...
<cfset LB_TituloH 		= t.Translate('LB_TituloH','Reporte de Uso de Tarjetas')>
<cfset TIT_ReporteTarjetas 	= t.Translate('TIT_ReporteTarjetas','Reporte de Uso de Tarjetas')>
...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='#TIT_ReporteTarjetas#'>
...
<cfquery name="rsCorte" datasource="#session.DSN#">
	...
	from CRCCortes
	where Ecodigo = #session.Ecodigo#
	and Tipo = 'TC' or Tipo = 'TM'
</cfquery>
 

<cfinclude template="../../../sif/Utiles/sifConcat.cfm">
<form name="form1" action="reporteTarjetas_sql.cfm?p=0" method="post" >
<cfoutput>
				...
				<tr align="left">
					...
					<cf_conlis
						...
						Columnas="
							...
							, sn.SNid"
						form="form1"
						Filtro="sn.Ecodigo = #Session.Ecodigo# and cc.Tipo = 'TC'"
