...
<cfset LB_Resumen 		= t.Translate('LB_Resumen', 'Resumen')>
<cfset LB_TipoCuenta	= t.Translate('LB_TipoCuenta','Forma de Pago')>
...
<form name="form1" action="reporteVentasxTienda_sql.cfm?p=0" method="post">
<cfoutput>
	...
	<tr>
		<td align="center">
			...
			<table  width="60%" cellpadding="2" cellspacing="0" border="0">
				...
				<tr align="left">
					<cfquery name="rsTiendas" datasource="sifinterfaces">
						select  eq.EQUcodigoOrigen, eq.EQUcodigoSIF, eq.EQUdescripcion, eq.EQUcodigoSIF + ' ' + eq.EQUdescripcion as TiendaDesc
						from SIFLD_Equivalencia eq
					...
					<td width="10%" nowrap>
						...
						<select name="tienda">
							...
							<cfloop query="#rsTiendas#">
								<option value="#rsTiendas.EQUcodigoOrigen#">#rsTiendas.TiendaDesc#</option>
							</cfloop>
						</select>
					</td>
					 <td>
				...
				<tr>
					<td align="center">
						<input type="checkbox" name="resumen" checked>
