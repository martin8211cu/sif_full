...
<cfset LB_TituloH 		= t.Translate('LB_TituloH','Reporte de Convenios por Cuenta')>
...
<cfset LB_Detalle		= t.Translate('LB_Detalle','Mostrar Detalles')>
<cfset LB_Cancelados	= t.Translate('LB_Cancelados','Mostrar Cancelados')>
...
<form name="form1" action="reporteConvenio_sql.cfm?p=0" method="post">
<cfoutput>
	...
	<tr>
		<td align="center">
			...
			<table  width="50%" cellpadding="2" cellspacing="0" border="0">
				...
				<tr align="left">
					...
					<cf_conlis
						...
						Columnas="
							...
							, cc.tipo"
						form="form1"
						Filtro="sn.Ecodigo = #Session.Ecodigo# and cc.CRCEstatusCuentasid = #EstadoCuentaID#"
				...
				<tr align="center">
					<td><strong>#LB_Detalle#:&nbsp;</strong></td>
					<td align="left"> <input type="checkbox" name="detallesT" ></td>
				</tr>
				<tr align="center">
					<td><strong>#LB_Cancelados#:&nbsp;</strong></td>
					<td align="left"> <input type="checkbox" name="CanceladosT" ></td>
				</tr>
				<tr>
					<td >&nbsp;</td>
				</tr>
