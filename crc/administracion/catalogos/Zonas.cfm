<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Title" Default="Zonas" returnvariable="LB_Title"/>
...
<cfinvoke component="sif.Componentes.Translate" method="Translate" Key="LB_Porciento" Default="Porciento" returnvariable="LB_Porciento"/>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td width="50%" valign="top">
					...
					<cf_exportarCatalogo tableName="CRCZonas" keyColumnName="Codigo">
				</td>
				<td width="50%">
					<cfinclude template="Zonas_form.cfm">
				</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
