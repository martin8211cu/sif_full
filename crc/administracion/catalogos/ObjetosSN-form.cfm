...
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_TipoArchivo" default = "Tipo de Archivo" returnvariable="LB_TipoArchivo" xmlfile = "ObjetosSN-form.xml">

<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_OpcionTipo1" default = "Firma" returnvariable="LB_OpcionTipo1" xmlfile = "ObjetosSN-form.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_OpcionTipo2" default = "Personal" returnvariable="LB_OpcionTipo2" xmlfile = "ObjetosSN-form.xml">
<cfinvoke component="sif.Componentes.Translate" method="Translate" key = "LB_OpcionTipo3" default = "Otros" returnvariable="LB_OpcionTipo3" xmlfile = "ObjetosSN-form.xml">
...
<cfset modo='CAMBIO'>
	<cfquery name="rsSNegociosObjeto" datasource="#session.DSN#">
		select a.SNOid, a.Ecodigo, a.SNcodigo,a.SNOTipoArchivo, a.SNOdescripcion, a.SNOarchivo as nombre_archivo, a.SNOcontenttype as extencion,
...
<form enctype="multipart/form-data" action="ObjetosSN-sql.cfm" method="post" name="form6" onsubmit="javascript:document.form6.dir.value=document.form6.OLPdato.value;"><!---  --->
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0" align="center">
		...
		<tr>
			<td align="right" nowrap><strong>#LB_TipoArchivo#:</strong>&nbsp;</td>
			<td>
				<select name="SNOTipoArchivo"  tabindex="1">
					<option value="FIRMA" <cfif modo neq 'ALTA'><cfif rsSNegociosObjeto.SNOTipoArchivo eq "FIRMA">selected</cfif></cfif>>#LB_OpcionTipo1#</option>
					<option value="PERSONAL" <cfif modo neq 'ALTA'><cfif rsSNegociosObjeto.SNOTipoArchivo eq "PERSONAL">selected</cfif></cfif>>#LB_OpcionTipo2#</option>
					<option value="OTROS" <cfif modo neq 'ALTA'><cfif rsSNegociosObjeto.SNOTipoArchivo eq "OTROS">selected</cfif></cfif>>#LB_OpcionTipo3#</option>
				</select>
			</td>
		</tr>
		<tr>
