				...
				<td align="center" valign="top" height="600">
					...
					<cf_tabs width="99%">
							<cf_tab text="Direcci&oacute;n" selected="#form.tabs eq 1#">
								 <cfinclude template="/sif/ad/catalogos/formSociosDireccion.cfm">
							</cf_tab>
						<cfif Len(form.id_direccion)>
							<cf_tab text="Clasificación" selected="#form.tabs eq 2#">
								 <cfinclude template="/sif/ad/catalogos/SociosClasifDireccion.cfm">
							</cf_tab>
							<cf_tab text="Límite de Crédito Adicional" selected="#form.tabs eq 3#">
								 <cfinclude template="/sif/ad/catalogos/SociosLimCredAdic.cfm">
							</cf_tab>
							<cf_tab text="Contactos" selected="#form.tabs eq 4#">
								 <cfinclude template="/sif/ad/catalogos/ContactosxDireccion.cfm">
							</cf_tab>
						</cfif>
					</cf_tabs>
				</td>
