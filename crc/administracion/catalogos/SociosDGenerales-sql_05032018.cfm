	...
	<cfif rsExisteSNegocios.Cantidad EQ 0>
		...
		<cfquery name="insertSNegocios" datasource="#session.DSN#">
			insert into SNegocios (Ecodigo, SNcodigo, SNidentificacion, SNtiposocio, SNnombre,
				SNFecha, SNtipo, SNnumero, ESNid,Mcodigo, EcodigoInclusion)
		...
		<cftransaction>
			...
			<cfif modalidad.replicar and form.ALTA_CORPORATIVO and session.EcodigoCorp NEQ session.Ecodigo>
				...
				<cfquery name="insertCorp" datasource="#session.DSN#">
					insert into SNegocios (Ecodigo, SNcodigo, SNidentificacion, SNidentificacion2,  SNnombre, SNcodigoext, Mcodigo,
										   ...
										   SNtiposocio, SNMid, intfazLD, sincIntfaz,IdFisc,Nacional
										   )
			...
			<cfquery name="insert" datasource="#session.DSN#">
				...
				insert into SNegocios (Ecodigo, SNcodigo, SNidentificacion, SNidentificacion2,  SNnombre, SNcodigoext, Mcodigo,
									   ...
									   SNtiposocio,SNMid,intfazLD,sincIntfaz,IdFisc,Nacional,disT,TarjH,Mayor
									   )
					...
					<cfset modo="ALTA">
						<cfcatch type = "Database">
							<cfif Find('IntegrityConstraintViolationException',CFCATCH.Cause.Type)>
								...
								<cfset resultT = "El socio no puede ser eliminado, porque está siendo utilizado por otro proceso">
			...
			<cfquery name="update" datasource="#Session.DSN#">
				...
				set  				 
					...
					<cfif not modalidad.readonly>,
						...
						SNdireccion 	 = 	<cfqueryparam cfsqltype="cf_sql_varchar" 	value="#la_direccion.completaCorta#">,
