...
<cfif not isdefined("Form.NuevoContacto")>
	<cfif isdefined("Form.ALTAContacto")>
		<cfquery name="RsinsSNContactos" datasource="#Session.DSN#">		
			insert into SNContactos (Ecodigo, SNcodigo, SNCidentificacion, SNCnombre, SNAval,
			...
			values (
				 ...
				 <cfqueryparam cfsqltype="cf_sql_bit" value="#Form.SNAval#">, 
