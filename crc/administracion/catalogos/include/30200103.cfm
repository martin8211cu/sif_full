...
<cf_conlis
	Campos="f_30200103,SNnumero_30200103,SNnombre_30200103"
	Desplegables="N,S,S"
	Modificables="N,S,N"
	Size="0,10,30"
	tabindex="2"
	ValuesArray="#ArrSN#"
	Tabla="Snegocios"
	Columnas="SNid as f_30200103,SNnumero as SNnumero_30200103,SNnombre as SNnombre_30200103"
	form="form1"
	Filtro="Ecodigo = #Session.Ecodigo# and (SNtiposocio = 'C' or SNtiposocio = 'A')
			order by SNnombre"
	Desplegar="SNnumero_30200103,SNnombre_30200103"
	Etiquetas="Codigo, Nombre"
	filtrar_por="SNnumero,SNnombre"
	Formatos="S,S"
	Align="left,left"
	Asignar="f_30200103,SNnumero_30200103,SNnombre_30200103"
