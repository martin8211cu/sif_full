...
<cfquery name="rsTPagos" datasource="#Session.DSN#">
    ...
    Union Select 'E' as TPid, 'Efectivo' as TPdesc, 2 as orden
...
<cfquery name="rsTTarjeta" datasource="#Session.DSN#">
    Select FATid,FATdescripcion as TTdesc
     from FATarjetas
     where FATvisible = 1   
      and Ecodigo = #session.Ecodigo#   
     order by FATid   
  ...
  <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
    <cfoutput> 
      ...
      <tr> 
        ...
        <td nowrap> <font size="2">#rsMonedaTran.Msimbolo# #LSCurrencyFormat(rsETransaccion.ETtotal - rsETransaccion.retencion - rsETransaccion.Comision,'none')# (#rsMonedaTran.Miso4217#) </font></td>
        <cfset LvarFacturado = rsETransaccion.ETtotal - (rsETransaccion.retencion + rsETransaccion.Comision)>
    ...
    <tr> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cuadro" align="center">
          ...
          <tr> 
            ...
            <td nowrap> <font size="2"> 
              <input type="text" name="FPmontoori"   id="FPmontoori" maxlength="20" size="16" style="text-align: right;" onBlur="fm(this,2); setMontoLocal(); setPartePago();" onChange="setMontoLocal(); setPartePago();" onFocus="javascript:this.value=qf(this); this.select(); "  onkeyup="javascript:if(snumber(this,event,2)){ if(Key(event)=='13') {this.blur();}}" value="<cfif modo neq 'ALTA'><cfoutput>#rsFPagoLinea.FPmontoori#</cfoutput></cfif>"
              >
          ...
          <tr>
           <td >&nbsp;</td>
           <td ><font size="2"><b>Pago al documento</b></font></td>
           <td colspan="4">&nbsp;</td>
          </tr>
           <tr>
           <td >&nbsp;</td>
           <td ><input type="text" style="text-align:right" maxlength="10" size="16" name="PagoAlDoc" value="<cfif modo NEQ 'CAMBIO'>0.00<cfelse><cfoutput>#LSNumberFormat(rsFPagoLinea.FPagoDoc,',9.0000')#</cfoutput></cfif>"  disabled>
                ...
                <select name="T_FPtipotarjeta">
                  ...
                  <cfoutput query="rsTTarjeta"> 
                    <cfif modo neq 'ALTA' and #rsFPagoLinea.Tipo# eq 'T' and #rsFPagoLinea.FPtipotarjeta# eq #FATid#>
                      <option value="#FATid#" selected>#TTdesc#</option>
                      <cfelse>
                      <option value="#FATid#">#TTdesc#</option>
                    </cfif>
                  </cfoutput> 
                </select>
                </font></div>
   ...
   <tr> 
    ...
    <tr> 
      <td nowrap colspan="6"> <table width="100%" border="0" cellspacing="0" cellpadding="0"align="center">
          ...
          <cfset Monto = 0>
          <cfset VueltoTotal = 0>
          <cfset Saldo = rsETransaccion.ETtotal - rsETransaccion.retencion>
            ...
            <tr <cfif CurrentRow MOD 2>class="listaNon"<cfelse>class="listaPar"</cfif>> 
              ...
              <cfif not isdefined('form.CC')>
                   <input  name="btnBorrar" type="image" alt="Eliminar elemento" 
								onClick="javascript: Editar('#FPlinea#','#Tipo#','#FPautorizacion#','#FPdocnumero#');" src="../../imagenes/Borrar01_T.gif" width="16" height="16">
				...
				<!---No se permite modificar la informacion del deposito, por lo cual solo se puede eliminar--->
						...
						onClick="javascript: Modificar('#FPlinea#','0','#FPtc#','#Mcodigo#');" src="../../imagenes/edit_o.gif" width="16" height="16">
                   
                <cfelse>
                   <input  name="btnBorrar" type="image" alt="Eliminar elemento" 
					onClick="javascript: Editar2('#FPlinea#','#Tipo#','#Form.CCTcodigo#','#FPdocnumero#','#form.CC#','#Form.Mcodigo#');" src="../../imagenes/Borrar01_T.gif" width="16" height="16">
					
					
                		<input name="btnEditar" type="image" alt="Editar elemento" 
						onClick="javascript: Modificar('#FPlinea#','#FPtc#','#Form.Mcodigo#','#Form.CCTcodigo#');" src="../../imagenes/edit_o.gif" width="16" height="16">
