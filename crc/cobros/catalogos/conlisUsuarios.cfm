...
<cfloop query="rsUsuarios">
	...
	<cfquery name="rsExiste" dbtype="query">
		select * from rsAlterno where EUcodigo = '#rsUsuarios.EUcodigo#'
	</cfquery>
...
<form action="" method="post" name="conlis">
  <table width="55%" border="0" cellspacing="0" align="center">
    ...
    <tr class="areaFiltro">
      ...
      <td><input name="Papellido1" type="text" size="30" maxlength="100"></td>
      <td><input name="Pnombre" type="text" size="30" maxlength="60"></td>
