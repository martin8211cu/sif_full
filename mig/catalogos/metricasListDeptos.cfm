...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<td valign="middle" align="center">
		<input name="btnAdd" type="button" value="&gt;&gt;" class="btnNormal" onclick="Javascript: addDeptoMet()"><br>
		<input name="btnOut" type="button" value="&lt;&lt;" class="btnNormal" onclick="Javascript: delDeptoMet()">	</td>
	 <td><strong>
	 <cfif url.tipo EQ 'D'>
	...
	<tr><td colspan="3" align="center"><input name="BTNSubmit" type="button" class="btnGuardar" value="Guardar" onclick="javascript: funcBTNSubmitMet(document.formMet.Flista,document.formMet.Fselected)"/></td></tr>
</table>
</form>
</cfoutput>