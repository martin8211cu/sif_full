<cfif isdefined ('form.Importar')>
	<cflocation url="PaisImportador.cfm">
</cfif>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td valign="top"> 
			<cfinvoke component="commons.Componentes.pListas" method="pListaRH"
				tabla="MIGPais"
				columnas="MIGPaid, MIGPacodigo, MIGPadescripcion, case Dactiva when 0 then 'Inactivo' when 1 then 'Activo' end as Dactiva"
				desplegar="MIGPacodigo, MIGPadescripcion, Dactiva"
				etiquetas="C&oacute;digo, Descripci&oacute;n, Estado"
				formatos="S,S,S"
				filtro=" Ecodigo=#session.Ecodigo# order by MIGPacodigo"
				...
				mostrar_filtro="true"
				filtrar_por="MIGPacodigo, MIGPadescripcion, Dactiva,&nbsp;, &nbsp;"
				ira="Pais.cfm"
	...
	<tr>
		...
		<form name="formRedirec" method="post" action="Pais.cfm" style="margin: '0' ">
