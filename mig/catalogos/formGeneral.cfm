...
function regresa()
{
	location.href ="/cfmx/mig/catalogos/CFuncional-lista.cfm";
}
...
<form action="SQLCFuncional.cfm" method="post" name="form1" onSubmit="javascript: return valida(this);">
	...
	<table border="0" cellspacing="1" cellpadding="0">
			<tr> 
				<td align="left"><cf_translate key="LB_Codigo" XmlFile="/mig/generales.xml">C&oacute;digo</cf_translate>:</td>
			...
			<tr> 
				<td align="left"><cf_translate key="LB_Descripcion" XmlFile="/mig/generales.xml">Descripci&oacute;n</cf_translate>:</td>
				<td  valign="middle">
			...
			<tr>
				<td align="left"><cf_translate key="LB_Oficina" XmlFile="/mig/generales.xml">Oficina</cf_translate>:</td>
				<td valign="middle">
			...
			<tr>
			<td align="left"><cf_translate key="LB_Departamento" XmlFile="/mig/generales.xml">Departamento</cf_translate>:</td>
				<td valign="middle">
					<cfif modo NEQ "ALTA" and rsPlazasCF.valor GT 0>
						<cfset descripcion = "">
						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>&nbsp;
									...
									<img style="cursor:hand; " src="/cfmx/rh/imagenes/delete.small.png" 
										   alt="#LB_LimpiarUsuarioResponsable#" name="imagenLimpiarUR" width="16" height="16" 
										   border="0" align="absmiddle" 
			...
			<tr> 
				<td colspan="2" align="center">
					<cfif modo EQ "ALTA" or isDefined("Form.Nuevo")>
						...
						<input type="submit" name="Alta" value="#BTN_Agregar#" onClick="javascript: setBtn(this);" tabindex="3">
						<input type="reset" name="Limpiar" value="#BTN_Limpiar#" onClick="javascript: setBtn(this);" tabindex="3">
					<cfelse>
						<cfinvoke component="mig.Componentes.Translate"
						method="Translate"
						Key="BTN_Modificar"
						...
						<input type="submit" name="Cambio" value="#BTN_Modificar#" tabindex="3"
							   onClick="javascript: setBtn(this);" >
						<input type="submit" name="Baja" value="#BTN_Eliminar#" tabindex="3" 
							   onClick="javascript: setBtn(this); return confirm('¿#MGS_DeseaEliminarEsteRegistro#?');">
						<input type="submit" name="Nuevo" value="#BTN_Nuevo#" tabindex="3" onClick="javascript: setBtn(this);">
					</cfif>
						<cfinvoke component="mig.Componentes.Translate"
						method="Translate"
						Key="BTN_Regresar"
