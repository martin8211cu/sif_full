<cfif not isdefined("Form.Nuevo")>
	<cfif isdefined("Form.Alta")>
		...
		<cfif rsOficodigo.RecordCount LTE 0>
			...
			<cf_Ddireccion action="readform" name="direccion">
			<cf_Ddireccion action="insert" data="#direccion#" name="direccion">
			...
			<cfquery name="rsAlta" datasource="#Session.DSN#">
				...
				,Onumpatronal, Oadscrita, Onumpatinactivo, ZEid)
				values
				(				
	...
	<cfelseif isdefined("Form.Cambio")>
		...
		<cf_Ddireccion action="readform" name="direccion">
		<cf_Ddireccion action="update" data="#direccion#" name="direccion">
...
<form action="Oficinas.cfm" method="post" name="sql">
