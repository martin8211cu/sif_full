...
<!---<cfinclude template="/home/menu/pNavegacion.cfm">--->
	...
	<table width="771"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">&nbsp;</td>
        <td  valign="top"></td>
        <td valign="top"align="right"><input type="submit" value="#HTMLEditFormat(transition_info.Name)#"> 
        <input type="button" name="btnRegresar" value="CANCELAR" onClick="javascript: window.location.href ='<cfoutput>#CGI.HTTP_REFERER#</cfoutput>';"></td>
        <td>
        </td>
      </tr>
    </table> 
