...
<cfif isdefined('form.LTidRecargo') and form.LTidRecargo GT 0>
	<cfinclude template="../rh/nomina/operacion/AccionesRecargos-queries.cfm">
<cfelse>
	<cfinclude template="../rh/nomina/operacion/Acciones-queries.cfm">
</cfif>
...
<form name="form1" method="post" action="/cfmx/rh/nomina/operacion/Acciones-sql.cfm" onsubmit="javascript: return validaForm(this);">
    ...
    <table style="width:inherit" border="0" cellspacing="0" cellpadding="2" align="center">
			...
			<td width="10%" align="right" nowrap class="fileLabel"><cf_translate key="LB_porcentajepagoIMSS">Porcentaje pago IMSS</cf_translate>:</td>
				...
				<cfif modo EQ "ALTA">
					<input  name="PorcImss" onfocus="this.select();" 
						...
						type="text"
						value="<cfif modo neq 'ALTA'>#LSCurrencyFormat(rsAccion.RHporcimss,'none')#<cfelse>0.00</cfif>" maxlength="6"/>
				<cfelse>
					<cfif modo EQ "CAMBIO" and rsAccion.RHTcomportam EQ 5 and rsAccion.RHTsubcomportam GT 0 and #UsaSBC# EQ 1>
...
<!---ljimenez FIN DE CAMBIO--->
      ...
      <tr> 
        ...
        <td colspan="5" nowrap>
			...
			<cfelse>
				<input type="text" name="DLobs"  maxlength="255" value="<cfif modo NEQ "ALTA">#HtmlEditFormat(rsAccion.DLobs)#</cfif>" tabindex="6">
			</cfif>
		</td>
      </tr>
        		...
        		<td colspan="6">
						  ...
						  <tr>
							<td width="45%" valign="top">
								<cfinclude template="../rh/nomina/operacion/AccionesSP-form-sitact.cfm">
							</td>
							<td width="55%" valign="top">
								  <cfinclude template="../rh/nomina/operacion/AccionesSP-form-sitpos.cfm">  
							</td>
						  </tr>
						</table>
				</td>
        		...
        		<td colspan="6">
		 			...
		 			<cfelse>
						...
						<table border="0" cellspacing="0" cellpadding="2">
						  <tr>
							<td  valign="top">
								<cfinclude template="../rh/nomina/operacion/Acciones-form-sitact.cfm">
							</td>
							<td valign="top">
							  <cfinclude template="../rh/nomina/operacion/Acciones-form-sitpos.cfm">
							</td>
						  </tr>
						  <cfif Lvar_Recargos>
						   ...
						   <tr>
							<td valign="top" colspan="2">
								<cfinclude template="../rh/nomina/operacion/AccionesRecargos-form-recargact.cfm"><!---recargos actuales--->
							</td>
						  </tr>
						  </cfif>
						  <tr <cfif modo EQ "CAMBIO" and RHTNoMuestraCS eq 1 >style="display:none"</cfif>>
							<td valign="top">
								<cfinclude template="../rh/nomina/operacion/Acciones-form-compact.cfm">
							</td>
							<td valign="top">
								<cfinclude template="../rh/nomina/operacion/Acciones-form-comppos.cfm">
							</td>
						  </tr>
						</table>
				 </cfif>
		...
		<cfif rsAccion.RHTcomportam EQ 2>
		  ...
		  <tr> 
			...
			<cfif isdefined("rsConceptosPago") and rsConceptosPago.recordCount GT 0 and rsAccion.RHTNoMuestraCS eq 0>
			  <tr>
				<td colspan="6">
					<cfinclude template="../rh/nomina/operacion/Acciones-form-conceptos.cfm">
				</td>
			  </tr>
			</cfif>
