...
<cfif IsDefined("form.chk")>
	...
	<cfabort>
<cfelseif isdefined ('form.botonSel') and form.botonSel EQ "Aprobar">
	<cfset LvarTESOPid = -1>
	<cfset sbAprobar (form.TESSPid)>
    <cf_SP_imprimir location="solicitudesAprobar_form.cfm?TESSPid=#form.TESSPid#">
<cfelseif IsDefined("form.GenerarOP")>
	...
	<cfset sbAprobar (form.TESSPid)>
	<cf_SP_imprimir location="solicitudesAprobar_form.cfm?TESSPid=#form.TESSPid#">
<cfelseif isdefined ('form.botonSel') and form.botonSel EQ "Rechazar">
