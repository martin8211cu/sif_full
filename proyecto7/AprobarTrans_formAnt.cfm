...
<cfif isdefined('url.GEAid') and len(trim(url.GEAid))>
...
<cfset btnValueTC= "Tipos de Cambio">--->
	...
	<cfoutput>
		...
		<cfif isdefined("LvarComision")>
			...
			<input type="hidden" name="GECid_comision" value="#url.GECid_comision#">
...
<div style="width:inherit">
			<table align="center" style="width:inherit" summary="Tabla de entrada" border="0">
				<tr>
					<td valign="top" align="right"><strong>Núm. Anticipo:&nbsp;</strong></td>
					<td valign="top"><strong>#rsForm.TESSPnumero#</strong></td>
				...
				<tr>
					...
					<td rowspan="3" valign="top">
					    <input type="text" maxlength="200"  disabled="disabled" style="width:inherit;text-align:left; border:solid 1px ##CCCCCC; "value="<cfif modo NEQ 'ALTA'>#trim(rsForm.GEAdescripcion)#</cfif>">
					</td>
				</tr>
				<tr>
...
<!---			<cf_web_portlet_start border="true" titulo="#LvarTitulo#" skin="#Session.Preferences.Skin#">--->
	...
	<script language="javascript">
		...
		function funcAprobar()
		{
			...
			{ 
				if (confirm('¿Desea APROBAR la Transaccion ## <cfoutput>#rsform.TESSPnumero#</cfoutput> para pago por '+document.form1.FormaPago.options[document.form1.FormaPago.selectedIndex].text + '?')){
