...
<cfif isdefined("url.identificacion_persona") and isdefined("url.id_tramite")>
	...
	<cfif len(trim(persona.id_persona)) eq 0 >
		<cfset ir = ir & '?&identificacion_persona=#url.identificacion_persona#&noexistepersona=1' >
	<cfelse>
...
<cfelseif isdefined("url.tramite")>
	<cfquery name="instancia" datasource="tramites_cr">
		select id_instancia, id_persona 
