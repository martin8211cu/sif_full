...
<cfquery datasource="tramites_cr" name="rsSucursales">
...
<cfquery datasource="tramites_cr" name="rsServicios">
...
<cfif isdefined("form.id_tramite") and len(trim(form.id_tramite))>
	<cfquery datasource="tramites_cr" name="rsRequisito">
	...
	<cfquery datasource="tramites_cr" name="RSTieneAgenda">
...
<cfif  (fechabusqueda gte fechaH) >
	 <cfif  isdefined("form.id_tiposerv") and len(trim(form.id_tiposerv)) and isdefined("form.id_inst") and len(trim(form.id_inst))>
		 <cfquery datasource="tramites_cr" name="traeHorarios">
				select a.id_agenda
					,ciudad as direccion
			 ...
			 <cfif traeHorarios.recordcount gt 0>
				<cfloop query="traeHorarios">
					...
					<cfif arreglo[diaarreglo] eq '1'>
						...
						<cfquery datasource="tramites_cr" name="traedatos">
						...
						<cfquery datasource="tramites_cr" name="rsvalidaferiado">
			...
			<td   width="380" align="center" valign="top"  style="padding:3px;">
					...
					<cfoutput>
						...
						<cfif isdefined("form.id_tramite")>
							<cfquery datasource="tramites_cr" name="RSinst">
								select  ts_rversion
