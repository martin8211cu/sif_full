...
<cfif rsParam.recordCount>
 	<cfset PolizaElim = #rsParam.Pvalor# >
</cfif>
...
<cfif isdefined("Form.mcodigoopt") and Form.mcodigoopt EQ "-2">
	...
	<cfset moneda=rsMonedaLocal.Miso4217>
...
<cfelseif  isdefined("Form.mcodigoopt") and Form.mcodigoopt EQ "0">
	...
	<cfset moneda = rsMonedaSel.Miso4217>
</cfif>
    ...
    <cfloop query="rsEmpresasG">
        <cfquery name="rsValidaMonedaLocal" datasource="#Session.DSN#">
            ...
            where a.Ecodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#rsEmpresasG.Ecodigo#">
                ...
                and a.Mcodigo = b.Mcodigo
                and b.Miso4217 like <cfqueryparam cfsqltype="cf_sql_varchar" value="#moneda#">
        </cfquery>
        <cfif rsValidaMonedaLocal.recordcount EQ 0>
            <cfthrow message="Las Empresas que pertenecen al grupo no tienen la misma moneda Local. El Reporte solo se puede Generar por Moneda Origen">
        </cfif>
    </cfloop>
</cfif>

<cfquery name = "rsValoresXEmpresa" datasource="#session.DSN#">
	<cfif isdefined("form.mcodigoopt") and trim(form.mcodigoopt) EQ -3>
        ...
        (coalesce((
        select <!---sum(dc.Doriginal)---> sum(dc.Dlocal)
        from HDContables dc,Monedas n, CContables c
        where dc.Ecodigo = #emprCons#  and n.Miso4217='#moneda#'
...
<cfset Title = "Balance de Comprobaci&oacute;n Por Cuenta Mayor">
<cfset FileName = "BalanceComprobacionPorCuentaMayor.xls">
<cf_htmlreportsheaders
	title="#Title#" 
	filename="#FileName#" 
	ira="BalCompPorCtaMayorCons.cfm">
...
<table width="99%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr align="center"><td align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Balance de Comprobación x Cuenta de Mayor </strong></font></td></tr>
...
<table cellpadding="2" cellspacing="0">
    ...
    <tr>
        ...
        <cfoutput>
			<cfif #rsValoresXEmpresa.Ecodigo# neq #emprCons#>
