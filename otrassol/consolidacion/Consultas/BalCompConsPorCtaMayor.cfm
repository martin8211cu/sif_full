...
<cf_templateheader title="Balance de Comprobaci&oacute;n Por Cuenta Mayor"> 
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Balance de Comprobaci&oacute;n Por Cta. Mayor Convertido'>
			<cfinclude template="../../../sif/portlets/pNavegacion.cfm">
			<cfset periodo = "#get_val(30).Pvalor#">
			<cfset mes = "#get_val(40).Pvalor#">
			<form action="BalCompConsPorCtaMayor-sql.cfm" method="post" name="form1" style="margin:0;" >
				<cfoutput>
