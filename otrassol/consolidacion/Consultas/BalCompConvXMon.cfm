...
<cfset mes_contable = ObtenerDato(#EmpresaCons#,40)>
    ...
    <script language="JavaScript1.2" type="text/javascript" src="../../js/sinbotones.js"></script>
		...
		<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo="Balance de Comprobaci&oacute;n Convertido x Moneda">
			<cfinclude template="../../../sif/portlets/pNavegacionCG.cfm">
            <cfoutput>
			<table width="100%" cellpadding="2" cellspacing="0">
				<tr>
					<td>
						<form name="form1" method="post" action="SQLBalCompConvXMon.cfm" style="margin:0;" onSubmit="javascript: return funcValidar(#periodo_actual.Pvalor#,#mes_contable.Pvalor#)">                        
							<table width="100%" cellpadding="2" cellspacing="0">
                               <tr>
                                    <td align="right" nowrap><strong>Empresa:&nbsp;</strong> </td>	
                                    <td>		
                                        <select name="Empresa" id="Empresa" tabindex="1" 
                                        onchange="document.location.href='BalCompConvXMon.cfm?Empresa='+this.value;">
