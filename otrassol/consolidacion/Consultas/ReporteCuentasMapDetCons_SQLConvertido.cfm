...
<cfquery name="rsReporte" datasource="#session.DSN#">
	...
	where e.Ecodigo in (Select Ecodigo from AnexoGEmpresaDet where GEid=#gpoElimina#)
	...
	order by e.Ecodigo,m.CGICMcodigo, me.CGICCcuenta, c.Cformato
</cfquery>
