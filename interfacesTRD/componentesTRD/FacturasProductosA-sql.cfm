...
<cfif rsVerifica.recordcount GT 0>
	<cfquery name="rsTipoAlloc" datasource="preicts">
		...
		where a1.trade_num = <cfqueryparam cfsqltype="cf_sql_integer" value="#rsVerifica.trade_num#">
		   and a1.order_num = <cfqueryparam cfsqltype="cf_sql_smallint" value="#rsVerifica.order_num#">
		   and a1.item_num = <cfqueryparam cfsqltype="cf_sql_smallint" value="#rsVerifica.item_num#">
		...
		<cfif LvarBanderaErrores_registro EQ false>
			...
			<cfquery datasource="sifinterfaces">
				...
				values(
					...
					'#LvarOCTtipo#', '#rsTipoAlloc.acct_ref_num#', '#queryCompras.c_orden#', '#LvarConceptoCompra#'
					)
			</cfquery>>
		</cfif>
	</cfif>
	...
	<cfif LvarBanderaErrores_registro EQ false>
		...
		<cfelse>
			...
			<cfset LvarPrecioUnitario = (rsVerifica.OCPprecioTotal + querycompras.f_importe) /
				 (rsVerifica.OCPcantidad + querycompras.f_volumen)>
		...
		<cfquery name="rsVerifica" datasource="#Session.Dsn#">
			...
			from OCtransporte
			where Ecodigo = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.Ecodigo#">
			  and OCTtransporte = <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsTipoAlloc.acct_ref_num#">
		</cfquery>
		...
		<cfif vOCTid EQ 0>
			<cfquery name="query" datasource="#Session.Dsn#">
				...
				values (
				  ...
				  <cfqueryparam cfsqltype="cf_sql_char" value="#rsTipoAlloc.acct_ref_num#">,
		...
		<cfif rsVerifica.recordcount EQ 0>
			<cfquery name="query" datasource="#Session.Dsn#">
				...
				values (
				  ...
				  <cfqueryparam cfsqltype="cf_sql_varchar" value="#rsTipoAlloc.acct_ref_num#">,
				  <cfif isdate(rsTrade.fecha_allocation)>
					  <cfqueryparam cfsqltype="cf_sql_date" value="#rsTrade.fecha_allocation#">,
				  <cfelse>
					  <cfqueryparam cfsqltype="cf_sql_date" value="#now()#">,
