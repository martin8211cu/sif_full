...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Documentos NoFact de Swaps'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcNoFactSwap.cfm">
