<!--- Archivo    :  NoFactSwapsA.cfm
      Creado Por :  Marco Saborío Chaves
	  Descripción:  Consulta, valida y graba los documentos NoFact de Swaps en la 
...
<cfobject name="ONoFactSwap" component="interfacesPMI.Componentes.CNoFactSwap">
...
<cfset queryCompras = ONoFactSwap.ConsultaCompras(vFechaI, vFechaF)>
...
<cfloop query="queryCompras"> 
	...
	<cfif SESSION.HayErrores EQ false>
		...
		<cfset queryCostos = OGeneralProcA.ConsultaCostos(queryCompras.trade_num, 
		                     queryCompras.order_num, queryCompras.item_num,'C',querycompras.cmdty_code)>
	</cfif>
...
<cfset queryVentas = ONoFactSwap.ConsultaVentas(vFechaI, vFechaF)>
