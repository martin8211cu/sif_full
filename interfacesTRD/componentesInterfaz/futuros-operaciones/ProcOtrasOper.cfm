...
<cf_templateheader title="Procesa Futuros Otras Operaciones">
	  <cf_web_portlet_start titulo="Futuros Otras Operaciones #etiquetaT#">
		<cfinclude template="/sif/portlets/pNavegacion.cfm">

		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnImprimir">
				<cflocation url="/cfmx/interfacesTRD/Consultas/SQLOtrasOperR2.cfm?Regresa=ProcOtrasOper.cfm&CodICTS=#form.CodICTS#">
			</cfif>
		</cfif>
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnRegresar">
				<cfquery datasource="sifinterfaces">
					delete from OtrOperaPMI 
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btn#BErrores#">
				<cflocation url="/cfmx/interfacesTRD/Consultas/SQLOtrasOperErroresR2.cfm?Regresa=ProcOtrasOper.cfm&CodICTS=#form.CodICTS#">
			</cfif>
		</cfif>
