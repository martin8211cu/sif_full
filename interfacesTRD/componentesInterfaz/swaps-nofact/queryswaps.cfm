...
<cftransaction>
	<cfquery datasource="preicts" name="yahay">
		...
		where anio = <cfqueryparam cfsqltype="cf_sql_integer" value="#anio_proceso#">
		  ...
		  and EmpresaICTS = <cfqueryparam cfsqltype="cf_sql_integer" value="#varCodICTS#">
	</cfquery>
	...
	<cfif yahay.cantidad is 0>
		<cfquery datasource="preicts">
			...
			select distinct
				...
				<cfqueryparam cfsqltype="cf_sql_integer" value="#varCodICTS#">,
			...
			from trade_item ti
				...
				on oo.trade_num = ti.trade_num
				   ...
				   inner join cost co
					  ...
					  and co.cost_book_comp_num = <cfqueryparam cfsqltype="cf_sql_integer" value="#varCodICTS#">
			<!---where ti.booking_comp_num = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.EmpresaICTS#">--->
			where ti.booking_comp_num = <cfqueryparam cfsqltype="cf_sql_integer" value="#varCodICTS#">
