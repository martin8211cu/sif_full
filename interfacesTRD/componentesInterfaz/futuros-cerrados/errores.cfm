...
<cfif url.formato EQ "HTML">
		...
		<cfoutput>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="##99CCFF">
					...
					<tr>
						<td nowrap><strong>Fecha Mercado</strong></td>
					...
					<cfoutput>
						<tr>
							<td align="left" nowrap >#DateFormat(rsErrores.market_day, 'dd/mm/yyyy')#</td>
