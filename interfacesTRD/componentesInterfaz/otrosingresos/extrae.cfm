...
<cfquery name="qextra" datasource="preicts">
	...
	and not exists(select 1 from #LvarDsource#InterfazBitacoraProcesos ib, #LvarDsource#IE10 ie 
					...
					and ib.EcodigoSDC=<cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDC#">
...
<cfloop query="queryVentas"> 
	...
	<cfquery datasource="sifinterfaces">
		...
		values(getdate(), #session.monitoreo.sessionid#,
			#ConseIE10#, #session.EcodigoSDC#, '#queryVentas.acct_num#', '#ws_tipo_modulo#',
