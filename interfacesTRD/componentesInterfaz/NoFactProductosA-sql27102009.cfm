...
<cfquery name="rsVerifica" datasource="preicts">
	insert #LvarDsource#nofactProdPMI (fecharegistro, sessionid, tipoconsulta, trade_num, order_num,
		...
		alloc_num,alloc_item_num,alloc_type_code, del_term_code, bl_ticket_num, bl_date, transportation, load_compl_date, 
	...
	select getdate(), #session.monitoreo.sessionid# as sessionid, 'N',
	    ...
	    ai.title_tran_date, ai.alloc_num,ai.alloc_item_num, 
	...
	where (ti.p_s_ind = 'P' or ti.p_s_ind = 'S')
		...
		and ti.booking_comp_num = <cfqueryparam cfsqltype="cf_sql_integer" value="#varCodICTS#">
...
<cfloop query="rsNofact"> 
	...
	<cfif rsNofact.p_s_ind EQ "P">	
		<cfset rsCostos = OGeneralProcA.ConsultaCostosNoFactProd(rsNofact.trade_num, rsNofact.order_num,
					 rsNofact.item_num, rsNofact.alloc_num, rsNofact.alloc_item_num,
					 'C',rsNofact.cmdty_code, rsNofact.tipoconsulta,
					 vFechaI, vFechaF)>
	<cfelse>
		<cfset rsCostos = OGeneralProcA.ConsultaCostosNoFactProd(rsNofact.trade_num, rsNofact.order_num,
					 rsNofact.item_num, rsNofact.alloc_num, rsNofact.alloc_item_num,
					 'V',rsNofact.cmdty_code, rsNofact.tipoconsulta,
					 vFechaI, vFechaF)>
	</cfif>
	...
	<cfif rsCostos.recordcount GT 0>
		...
		<cfquery datasource="sifinterfaces">
			...
			where trade_num = #rsNofact.trade_num#
			  ...
			  and alloc_item_num = #rsNofact.alloc_item_num#
