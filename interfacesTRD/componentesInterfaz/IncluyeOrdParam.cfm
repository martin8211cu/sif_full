...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Incluye Ordenes de Compra'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcInclOrde.cfm">
