...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Consulta Compra de Productos'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcConsCompr.cfm">
