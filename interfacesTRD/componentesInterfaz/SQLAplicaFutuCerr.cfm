...
<cfloop query="rsFuturos"> 
	...
	<!--- crear folio de futuros cerrados    --->
	...
	<cfquery datasource="#session.dsn#">
		...
		values(#session.Ecodigo#,0,#ws_Eperiodo#, #ws_EMes#, 
			...
			<cfelse>
		 	...
		 	'Futuros Cerrados','#ws_folio#',null,
	...
	<cfset ws_detalle = "CuentaSocio Futuro No. #rsFuturos.realized_profits_detail_num#">
	...
	<cfloop from="1" to="#ArrayLen(ArregloProductos)#" index="i">
		...
		<cfset ws_detalle = "Detalle del Futuro No. #rsFuturos.realized_profits_detail_num#">
		<cfif ws_PrimeraVez>
