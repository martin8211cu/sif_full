	  ...
	  <cf_web_portlet_start titulo="Procesa Documentos NoFact de Producto #etiquetaT#">
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnImprimir">
				<cfif isdefined("url.ModoV")>
					<cfif url.ModoV EQ 1>
						<cflocation url="/cfmx/interfacesTRD/Consultas/SQLNoFactProductosR2.cfm?Regresa=ProcNoFactProd.cfm&ModoV=1&CodICTS=#form.CodICTS#">
					<cfelse>
						<cflocation url="/cfmx/interfacesTRD/Consultas/SQLNoFactProductosR2.cfm?Regresa=ProcNoFactProd.cfm&ModoV=2&CodICTS=#form.CodICTS#">			
					</cfif>
				</cfif>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnErrores(#varErrores#)">
				<cfif isdefined("url.ModoV")>
					<cfif url.ModoV EQ 1>
						<cflocation url="/cfmx/interfacesTRD/Consultas/SQLNoFactProductosErroresR2.cfm?Regresa=ProcNoFactProd.cfm&ModoV=1&CodICTS=#form.CodICTS#">
					<cfelse>
						<cflocation url="/cfmx/interfacesTRD/Consultas/SQLNoFactProductosErroresR2.cfm?Regresa=ProcNoFactProd.cfm&ModoV=2&CodICTS=#form.CodICTS#">			
					</cfif>
				</cfif>
			</cfif>
		</cfif>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnMostrar_Doctos._Costo_Parcial_rev_ICTS">
				<cflocation url="/cfmx/interfacesTRD/componentesInterfaz/ProcNoFactProd.cfm?ModoV=2&botonsel=nada&CodICTS=#form.CodICTS#">
			<cfelseif form.botonsel EQ "btnOcultar_Doctos._Costo_Parcial_rev_ICTS">
				<cflocation url="/cfmx/interfacesTRD/componentesInterfaz/ProcNoFactProd.cfm?ModoV=1&botonsel=nada&CodICTS=#form.CodICTS#">
			</cfif>
		</cfif>
