	  ...
	  <cf_web_portlet_start titulo="Procesa Seguros">
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnImprimir">
				<cflocation url="/cfmx/interfacesTRD/Consultas/SQLSegurosR2_Pre.cfm">
			</cfif>
		</cfif>
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnRegresar">
				...
				<cflocation url="/cfmx/interfacesTRD/componentesInterfaz/SegurosParam.cfm">
			</cfif>
		</cfif>
		<cfif isdefined("Form.botonsel")>
		...
		<cfif isdefined("Form.botonsel")>
			<cfif form.botonsel EQ "btnErrores">
				<cflocation url="/cfmx/interfacesTRD/Consultas/SQLErroresR2_Pre.cfm?Regresa=ProcSeguros.cfm">
			</cfif>
		</cfif>
