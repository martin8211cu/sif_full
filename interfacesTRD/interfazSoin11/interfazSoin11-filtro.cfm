<!-- Consultas -->
<cfoutput>
<form action="interfazSoin11-lista.cfm" method="post"  name="frequisicion" style="margin:0">
		...
		<tr>
			...
			<td>
				<select name="Modulo" tabindex="1" >
					...
					<option value="C" <cfif isdefined("form.Modulo") and form.Modulo eq 'C'> selected</cfif>>Cuentas Por Cobrar</option>
					<option value="P" <cfif isdefined("form.Modulo") and form.Modulo eq 'P'> selected</cfif>>Cuentas Por Pagar</option>
				</select>
			</td>
			<td width="8">&nbsp;</td>
			<td>
