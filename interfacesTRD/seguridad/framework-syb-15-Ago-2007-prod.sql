...
SScodigo, SMcodigo, SPcodigo, SPdescripcion,
  ...
  SPpublico, SPinterno)
values (
  'SIF       ', 'INTERPMI  ', 'IN_ORDEN  ', 'Incluye Ordenes de Compra',
  '/interfacesTRD/componentesInterfaz/IncluyeOrdParam.cfm', 0, '20070308 13:48:22.033', 1,
  null, ' ', null, 0,
  0, 0)
end else begin 
update SProcesos
...
print 'SComponentes fila: 1 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 2 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 3 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 4 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 5 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 6 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 7 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 8 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 9 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 10 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 11 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 12 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 13 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 14 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 15 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 16 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 17 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 18 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 19 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 20 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 21 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 22 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 23 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 24 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 25 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 26 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 27 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 28 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 29 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 30 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 31 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 32 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 33 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 34 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 35 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 36 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 37 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 38 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 39 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 40 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 41 de 41'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
select 'Componentes          ' as tipo, count(1) as real, 41 as esperado
from SComponentes
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
...
select 'Menues               ' as tipo, count(1) as real, 12 as esperado
from SMenues
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
