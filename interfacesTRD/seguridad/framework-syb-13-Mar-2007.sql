...
print 'SProcesosRol fila: 1 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 2 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 3 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 4 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 5 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 6 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 7 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 8 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 9 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 10 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 11 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 12 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 13 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 14 de 14'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
print 'SComponentes fila: 1 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 2 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 3 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 4 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 5 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 6 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 7 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 8 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 9 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 10 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 11 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 12 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 13 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 14 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 15 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 16 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 17 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 18 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 19 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 20 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 21 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 22 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 23 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 24 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 25 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 26 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 27 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 28 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 29 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 30 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 31 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 32 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 33 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 34 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 35 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 36 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 37 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 38 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 39 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 40 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 41 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 42 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 43 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 44 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 45 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
commit 
go
print 'SComponentes fila: 46 de 46'
declare @n int 
begin tran
select @n = count(1)
from SComponentes 
...
select 'Procesos             ' as tipo, count(1) as real, 15 as esperado
from SProcesos
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
...
select 'Componentes          ' as tipo, count(1) as real, 46 as esperado
from SComponentes
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
...
select 'ProcesosRol          ' as tipo, count(1) as real, 14 as esperado
from SProcesosRol
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
