 ...
 -- Exportacion del proceso SIF INTERPMI ComprasF
...
where 1=1
  and ((SSorigen = 'SIF' and SMorigen = 'INTERPMI' and SPorigen = 'ComprasF')
   or (SSdestino = 'SIF' and SMdestino = 'INTERPMI' and SPdestino = 'ComprasF'))
  and not exists (select * from TMPDATA_IMPORT
...
select 'ProcesosRol          ' as tipo, count(1) as real, 1 as esperado
from SProcesosRol
where SScodigo = 'SIF'
and SMcodigo = 'INTERPMI'
and SPcodigo = 'ComprasF'
...
where (SSorigen = 'SIF' and SMorigen = 'INTERPMI' and SPorigen = 'ComprasF')
   or (SSdestino = 'SIF' and SMdestino = 'INTERPMI' and SPdestino = 'ComprasF')
