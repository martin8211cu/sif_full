...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Documentos Otros Ingresos'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcOtrosIngr.cfm">
