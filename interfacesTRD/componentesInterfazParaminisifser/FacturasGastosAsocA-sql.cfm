<!--- Archivo    :  FacturasGastosAsocA.cfm
...
<cfobject name="OFacturaGastosAsoc" component="interfacesPMI.Componentes.CFacturaGastosAsoc">
...
<cfset queryGastos = OFacturaGastosAsoc.ConsultaGastos(vFechaI, vFechaF)>
