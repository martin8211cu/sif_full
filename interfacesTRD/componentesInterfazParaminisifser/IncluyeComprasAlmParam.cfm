...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='Incluye Compra de Almacén'>
...
<cfoutput>
	<form name="form1" method="post" action="ProcInclComprAlm.cfm">
