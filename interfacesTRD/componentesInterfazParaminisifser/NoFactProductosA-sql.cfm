...
<!--- Para desarrollo "sif_interfacesser.." y para produccción "sif_interfacesser.."  --->
...
create table sif_interfacesser..nofactProdPMI (fecharegistro date null,sessionid numeric null, MensajeError varchar(255) null,
...
drop table sif_interfacesser..DocumentoReversion
go
create table sif_interfacesser..DocumentoReversion(IDREV numeric identity, fecharegistro date not null, sessionid int not null,
...
on sif_interfacesser..DocumentoReversion(IDREV)
create unique clustered index ID_INDEX 
on sif_interfacesser..DocumentoReversion(IDREV)
create table sif_interfacesser..PMICOMP_ID10(sessionid numeric not null, FechaRegistro date not null,
