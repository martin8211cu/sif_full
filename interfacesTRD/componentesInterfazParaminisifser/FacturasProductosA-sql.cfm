...
create table sif_interfacesser..ProductosPMI (fecharegistro date null,sessionid numeric null,
...
drop table sif_interfacesser..facturasProdPMI
...
<cfquery datasource="preicts">
	...
	and not EXISTS(select ac.ID from sif_interfacesser..IE10 ac where ac.VoucherNo = CONVERT(varchar,aa.voucher_num)
