...
<cfloop query="queryComprasE">
			...
			<cfelse>
				...
				<cfif varInsertaControl EQ 1>
					...
					<cfquery datasource="sifinterfaces">
						...
						values( 
							#LvarID#, <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDCSoin#">,
					...
					<cfif varItemServicio>
						...
						<cfquery datasource="sifinterfaces">
							...
							values(
								...
								null, '#rsComplementoID10.ContractNo#','#rsComplementoID10.CodigoImpuesto#', 0.00,	0.00, null, null,
	...
	<cfquery name="rsIE10" datasource="sifinterfaces">
		...
		where EcodigoSDC=<cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDCSoin#">
		  ...
		  <cfqueryparam cfsqltype="cf_sql_numeric" value="#session.EcodigoSDCSoin#"> and NumeroInterfaz=10) 
