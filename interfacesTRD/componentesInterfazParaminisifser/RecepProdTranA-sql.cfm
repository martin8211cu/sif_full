...
<cfloop query="rsProducto"> 
	...
	<cfif len(rp_OCTid) EQ 0 AND len(rp_OCid) GT 0>
		...
		<cfset LvarTipoError = LvarTipoError & "No hay transporte para Orden Comercial en estructura OC SOIN-SIF">
	</cfif>
	<!---Valida el Almacen--->
...
<cfquery name="Debug" datasource="sifinterfaces">
	select * from #LvarDsource#RecProdTranPMI a where  sessionid = #session.monitoreo.sessionid# 
</cfquery>
<cf_dump var="#Debug#" label = "Salida">
--->