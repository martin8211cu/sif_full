...
<cfinvoke 
 ...
 returnvariable="pListaRet">
	...
	<cfinvokeargument name="desplegar" value="Documento, acct_num, cmdty_code, market_day, trade_num, mtm_pl, currency_code,Modulo"/>
	<cfinvokeargument name="etiquetas" value="Documento, Socio, Producto, Fecha Mercado, No.Trade, Monto, Moneda, Modulo"/>
	<cfinvokeargument name="formatos" value="S,S,S,D,S,M,S,S"/>
	<cfinvokeargument name="ajustar" value="N,N,N,N,N,N,N,N"/>
	<cfinvokeargument name="align" value="left,left,left,left,left,right,left,left"/>
