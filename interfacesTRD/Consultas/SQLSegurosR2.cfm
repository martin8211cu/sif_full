...
<cfquery name="rsErrores" datasource="sifinterfaces">
	select Documento,orden, fecha_creacion, 
		trade_num, prima_cargo as monto, moneda, tipo_poliza
