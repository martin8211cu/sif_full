		...
		<cfoutput>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="##99CCFF">
					...
					<tr>
						...
						<td nowrap align="right"><strong>Producto</strong></td>
						<td nowrap align="right"><strong>Fecha Voucher</strong></td>
						<td nowrap align="right"><strong>No. Voucher</strong></td>
						<td nowrap align="right"><strong>Importe</strong></td>
						<td nowrap align="right"><strong>Módulo</strong></td>
						<td nowrap align="right"><strong>T.T.</strong></td>
						<td nowrap align="right"><strong>Tipo Venta</strong></td>
					</tr>
					...
					<cfloop query="session.qproductos">
						<tr>
							...
							<td nowrap >#session.qproductos.fechavoucher#</td>
							<td nowrap >#session.qproductos.vouchernum#</td>
							<td nowrap >#session.qproductos.importe#</td>
							...
							<td nowrap ><cfif isdefined("form.btndownload")>&nbsp;</cfif>#url.formato#</td>
						</tr>
					</cfloop>
		</cfoutput>
</cfif>
