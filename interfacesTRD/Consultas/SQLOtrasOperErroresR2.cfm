...
<cfquery name="rsErrores" datasource="sifinterfaces">
	select Documento,Concepto,Ccontable,TipoCD,Moneda,Tcambio,MontoCalculado,MensajeError
	from OtrOperaPMI
...
<cfif url.formato EQ "HTML">
		<cf_htmlreportsheaders
			title="Errores en Proceso Futuros Otras Operaciones" 
		...
		<cfoutput>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="##99CCFF">
					...
					<tr>
						...
						<td nowrap align="right"><strong>Mensaje Error</strong></td>
					</tr>
					...
					<cfloop query="rsErrores">
						<tr>
							...
							<td align="right" >#rsErrores.MensajeError#</td>
						</tr>
					</cfloop>
		</cfoutput>
</cfif>
