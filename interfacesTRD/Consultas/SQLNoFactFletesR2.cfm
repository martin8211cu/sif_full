...
<cfif url.formato EQ "HTML">
		<cf_htmlreportsheaders
			title="NoFact de Fletes" 
			filename="NoFactFletes-#Session.Usucodigo#.xls" 
			ira="/cfmx/interfacesTRD/componentesInterfaz/ProcNoFactFlet.cfm">
		...
		<cfoutput>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="##99CCFF">
					...
					<tr>
						<td style="font-size:16px" align="center" colspan="3">
						<strong>NoFact de Fletes</strong>
						</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
