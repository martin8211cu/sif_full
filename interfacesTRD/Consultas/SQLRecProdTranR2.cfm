...
<cfquery name="rsErrores" datasource="sifinterfaces">
	select distinct Almacen,title_tran_date as CambioPropiedad, Compra, Producto, Unidad, sum(Volumen) as Volumen
...
<cfif url.formato EQ "HTML">
		<cf_htmlreportsheaders
			title="Recepción de Producto en Tránsito" 
			filename="Recepción de Producto en Tránsito-#Session.Usucodigo#.xls" 
		...
		<cfoutput>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="##99CCFF">
					...
					<tr>
						...
						<td nowrap align="left"><strong>Unidad</strong></td>
						<td nowrap align="left"><strong>Volumen</strong></td>
					</tr>
					...
					<cfloop query="rsErrores">
						<tr>
							...
							<td >#rsErrores.Unidad#</td>
							<td >#rsErrores.Volumen#</td>
						</tr>
					</cfloop>
		</cfoutput>
</cfif>
