...
<cfset filtro = "
		cliente_empresarial = #Form.paramClienteEmpresarial#
				and e.Ecodigo=em.Ecodigo
				and em.modulo=m.modulo
				and m.sistema=r.sistema
				and (rtrim(r.rol) + '~' + convert(varchar,e.Ecodigo))  not in (
...
<body>
<cfoutput>
	<form name="formFiltroRoles" action="ConlisRoles.cfm" method="post">
...
<cfinvoke 
 ...
 returnvariable="pListaMarcasMod">
	...
	<cfinvokeargument name="irA" value="conlisRoles.cfm"/>
