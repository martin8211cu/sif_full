<cfparam name="r_modo" default="ALTA">
		...
		<cfquery name="Acciones" datasource="#Session.DSN#">
			...
			<cfif isDefined("Form.rAlta") or isdefined("form.rCambio") >
				...
				set nombre      	= <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.nombre)#">,
					...
					BMfechamod		= getdate(),
					referencia      = <cfqueryparam cfsqltype="cf_sql_char" value="#form.referencia#">,
					etiqueta_referencia = <cfif form.referencia neq '0'><cfqueryparam cfsqltype="cf_sql_varchar" value="#form.etiqueta_referencia#"><cfelse>null</cfif>,
					query_referencia = <cfif form.referencia neq '0'><cfqueryparam cfsqltype="cf_sql_longvarchar" value="#form.query_referencia#"><cfelse>null</cfif>
				...
				if @@rowcount = 0 begin
					insert Rol (rol, Rolcod, sistema, nombre, descripcion, Rolinfo, empresarial, interno, activo, BMUsucodigo, BMUlocalizacion, BMUsulogin, BMfechamod, referencia, etiqueta_referencia, query_referencia )
					values ( <cfqueryparam cfsqltype="cf_sql_char" value="#trim(rol)#">,
							 ...
							 getdate(),
							<cfqueryparam cfsqltype="cf_sql_char" value="#form.referencia#">,
							<cfif form.referencia neq '0'><cfqueryparam cfsqltype="cf_sql_varchar" value="#form.etiqueta_referencia#"><cfelse>null</cfif>,
							<cfif form.referencia neq '0'><cfqueryparam cfsqltype="cf_sql_longvarchar" value="#form.query_referencia#"><cfelse>null</cfif>
					)
				end
...
<form action="#action#" method="post" name="sql">
	...
	<input name="r_modo" type="hidden" value="<cfif isdefined("r_modo")>#r_modo#</cfif>">
