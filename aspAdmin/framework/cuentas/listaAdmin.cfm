...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr class="itemtit"><td colspan="2"><font size="2"><b>Lista de Usuarios Administradores</b></font></td></tr>
		...
		<td valign="top">
			...
			<cfinvoke 
			 ...
			 returnvariable="pListaRet">
				...
				<cfinvokeargument name="irA" value="formUsuario.cfm"/>
...
<script language="JavaScript1.2" type="text/javascript">
	...
	function funcAgregar(){
		...
		document.lista.action = 'formUsuario.cfm';
		document.lista.submit();
	}

	function funcDesactivar(){
		if ( checkeados() ){
			if ( confirm('Va deshabilitar como administrador a los usuarios seleccionados. Desde continuar?' ) ){
				document.lista.CLIENTE_EMPRESARIAL.value = '<cfoutput>#form.cliente_empresarial#</cfoutput>';
