...
<form action="cons_usuario.cfm" method="post" name="f" style="margin:0">
  ...
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
          <td><input type="text" name="lg1">
          </td>
          <td><input type="text" name="lg2"></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="6"><strong>
            <input type="checkbox" name="chkall" onClick="checkall()" value="1">
            Roles</strong></td>
        </tr>
		<tr>
		  <cfset sis=""><cfset n="0">
