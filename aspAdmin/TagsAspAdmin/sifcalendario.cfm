	...
	<tr valign="#Attributes.valign#"> 
      <td nowrap valign="#Attributes.valign#">
		...
		<input 
			...
			<a href="##" tabindex="-1"> <img src="/cfmx/sif/imagenes/DATE_D.gif" alt="Calendario" name="Calendar#Attributes.name#" width="16" height="14" border="0" onClick="javascript: showCalendar('document.#Attributes.form#.#Evaluate('Attributes.name')#');"></a>
			</cfif>
			<script language="JavaScript1.2">
