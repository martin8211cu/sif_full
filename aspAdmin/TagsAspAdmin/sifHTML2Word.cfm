...
<CFIF ThisTag.HasEndTag>
    <CFSWITCH EXPRESSION="#ThisTag.ExecutionMode#">
        ...
        <CFCASE VALUE="START">
            ...
            <CFSET HTMLFilePath = Attributes.Directory & HTMLFileName  & ".doc">
            ...
            <CFFILE ACTION="read" FILE="#ExpandPath('/sif/css/sif.css')#" variable="salida">
			
			<CFFILE ACTION="Append" FILE="#HTMLFilePath#"  OUTPUT="<style>#salida#</style></HEAD><BODY>">

			<div align="right"><A href="/cfmx/sif/Utiles/sifHTML2Wordcont.cfm<cfoutput>?Archivo=#Attributes.FileName#&Titulo=#Attributes.Titulo#</cfoutput>">
		    <img src="/cfmx/sif/imagenes/Cfinclude.gif" border="0"  alt="Documento en Formato MS Word">
		    </A>
	    </div>
