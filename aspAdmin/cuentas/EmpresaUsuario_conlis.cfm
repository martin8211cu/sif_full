...
<body>
	...
	<cfoutput>
	<form name="filtro" style="margin:0;" action="EmpresaUsuario_conlis.cfm" method="post">
	...
	<cfset select = " ue.cliente_empresarial,case u.Usutemporal when 0 then u.Usulogin else '-' end as Usulogin,
