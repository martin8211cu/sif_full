...
<cfif modo NEQ 'ALTA'>
	<cfquery name="rsForm" datasource="#session.DSN#">
		select convert(varchar,c.cliente_empresarial) as cliente_empresarial
			, convert(varchar,v.VFPcodigo) as VFPcodigo
			, convert(varchar,v.FPcodigo) as FPcodigo
			, v.VFPnombre
			, v.VFPdefault
		from CuentaFormaPago c, ValorFormaPago v
		where v.VFPcodigo = <cfqueryparam cfsqltype="cf_sql_numeric" value="#form.VFPcodigo#">
		  and c.cliente_empresarial = #form.cliente_empresarial#
		  and v.VFPcodigo = c.VFPcodigo
	</cfquery>
</cfif>
...
<form action="cuentaFormaPago_SQL.cfm" method="post" name="formcuentaFormaPago">
 	<input name="cliente_empresarial" type="hidden" value="<cfoutput>#form.cliente_empresarial#</cfoutput>">		 
	<cfif modo NEQ 'ALTA'>
	...
	<table width="95%" border="0" cellpadding="2" cellspacing="0" align="center">
		<tr>
		  	<td class="tituloMantenimiento" colspan="3" align="center">
				<cfif modo eq "ALTA">
					Nueva Forma de Pago para la Cuenta
					<cfelse>
					Modificar Forma de Pago para la Cuenta
				</cfif>
			</td>
		</tr>
		<tr> 
		...
		<tr> 
		  <td width="28%" align="right" valign="baseline" nowrap><strong>Cuenta por defecto</strong>:&nbsp;</td>
		...
		<tr> 
		  <td colspan="2" align="center">
			...
			<input type="submit" name="btnLista" value="Ir a lista" onClick="javascript:<cfif modo NEQ 'ALTA'>this.form.VFPcodigo.value='';</cfif>this.form.action='CuentaPrincipal_tabs.cfm';deshabilitarValidacion();">
		  </td>
		</tr>				
  </table>
</form>	  
...
//---------------------------------------------------------------------------------------
	...
	objForm = new qForm("formcuentaFormaPago");
//---------------------------------------------------------------------------------------
	objForm.VFPnombre.required = true;
