...
<cfif modo NEQ "ALTA">
	<cfinvoke 
	 ...
	 method="fnTabsInclude">
		<cfinvokeargument name="pTabID" value="TabIDContratos"/>
		<cfinvokeargument name="pTabs" value=#
			 "|Paquetes,cuentaContratoPaquetes_list.cfm,Definir los paquetes del contrato"
			& "|Tarifas,cuentaContratoTarifas.cfm,Definir las tarifas del contrato"
		#/> 
		<cfinvokeargument name="pDatos" value="COcodigo=#form.COcodigo#,cliente_empresarial=#form.cliente_empresarial#"/>
		<cfinvokeargument name="pNoTabs" value="false"/>
