	...
	<cfoutput query="rsFormD">
		  <tr>
			...
			<cfelseif #rsFormD.FPDtipoDato# EQ 'C' AND #rsFormD.FPDlongitud# GT 50>
			  <textarea name="VFPDvalor_#rsFormD.currentRow#" cols="50" rows="5" style="background-color: ##FAFAFA; font-size: xxx-small;font-family: Verdana, Arial, Helvetica, sans-serif;">#rsFormD.VFPDvalor#</textarea>
			<cfelse>
