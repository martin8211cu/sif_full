...
<table width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>				
		<td valign="top">
			<cfoutput>
			<form name="filtro" style="margin:0;" action="CuentaPrincipal_lista.cfm" method="post">
			...
			<cfset select = "convert(varchar, cce.cliente_empresarial) as cliente_empresarial, u.Usucuenta, cce.nombre" >
