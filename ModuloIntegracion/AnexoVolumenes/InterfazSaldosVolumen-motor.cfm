...
<cfquery name="rsAnexoVolumen" datasource="#GvarConexion#">
   	select Ecodigo, #form.fltPeriodo# as Periodo, #form.fltMes# as Mes, Clas_Venta_Lin, Cod_Item, Clas_Venta, 
    isnull(Volumen,0) as Volumen, Usuario
	from AnexoVolumen
...
<cfloop query="rsAnexoVolumen">			
	<cfquery datasource="#GvarConexion#">
	   ...
	   <cfquery name="rsValores" datasource="#GvarConexion#">
                 	select Ecodigo, sum(isnull(Volumen,0)) as Vol_Barriles,#form.fltPeriodo# as Periodo, #form.fltMes# as Mes, 				                    Clas_Venta_Lin, Cod_Item  
					from AnexoVolumen
					where Usuario = <cfqueryparam cfsqltype="cf_sql_integer" value="#GvarUsucodigo#">
		...
		<cfquery name="rsNasa" datasource = "#GvarConexion#">
			...
			inner join #sifinterfacesdb#..DSIFLD_HFacturas_Venta D on E.ID_DocumentoV = D.ID_DocumentoV
		...
		<cfquery name="rsAnexoVolumenN" datasource="#GvarConexion#">
   			select Ecodigo, #form.fltPeriodo# as Periodo, #form.fltMes# as Mes, Clas_Venta_Lin, Cod_Item, Clas_Venta, 																            isnull(Volumen,0) as Volumen, Usuario
			from AnexoVolumen
			where Usuario = <cfqueryparam cfsqltype="cf_sql_integer" value="#GvarUsucodigo#">
		</cfquery>	
	...
	<cfif rsEquiv.recordcount GT 0>
		...
		<cfif rsIDIntermedia.recordcount GT 0>
			<cfloop query="rsIDIntermedia">
			  <cfquery datasource="#GvarConexion#">
				update #sifinterfacesdb#..ESIFLD_HFacturas_Venta set Contabilizado = 1, Mes_Contabilizado = <cfqueryparam                cfsqltype= "cf_sql_integer" value="#form.fltMes#"> where ID_DocumentoV = <cfqueryparam cfsqltype=                "cf_sql_integer" value="#rsIDIntermedia.ID_DocumentoV#">
			  </cfquery>
			</cfloop>
		</cfif>
