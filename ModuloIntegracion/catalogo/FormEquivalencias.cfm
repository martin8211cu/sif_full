				...
				<cfif isdefined("form.CATcodigo") and trim(form.CATcodigo) GT 0>
					<cfquery name="rsCatalogo" datasource="#session.dsn#">
						...
						<cfelseif form.CATcodigo EQ "SOCIO_ANEX">
							select E.Ecodigo as id, E.EcodigoSDC as Codigo, E.Edescripcion as Descripcion
							from Empresas E
							inner join AnexoGEmpresaDet A on A.Ecodigo = E.Ecodigo
						</cfif>
						<cfif form.CATcodigo NEQ "PAIS" and form.CATcodigo NEQ "SOCIO_ANEX">
							where 
