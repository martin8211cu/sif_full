				...
				<cfquery datasource="sifinterfaces">
					insert into SIFLD_IE18
						(ID, Ecodigo, Cconcepto, Eperiodo, Emes, Efecha,
						 ...
						 CEcodigo, EcodigoSDC, Usulogin, Usucodigo, ECIreversible)
					values
