 			...
 			<cfloop query="rsIDEVentas">
				...
				<cfquery name="rsEVentas" datasource="sifinterfaces">
					select 	Ecodigo, Origen, ID_DocumentoV, Tipo_Documento, Tipo_Venta,
							...
							Direccion_Fact, Retencion, Observaciones, Tipo_CEDI, Factura_Cambio, TimbreFiscal, IEPS
					from 	ESIFLD_Facturas_Venta
				...
				<cfloop query="rsEVentas">
					<cftry>
						...
						<!--- ACTUALIZA ORIGEN --->
						<cfif listfind('C,D,E',rsEVentas.Tipo_Venta)>
							...
							<cfloop query = "rsDVentas">
								<cfif VentaxIVA>
									<cfif rsDVentas.Cod_Impuesto EQ 1>
										<cfset descIVA = '16%'>
									<cfelseif rsDVentas.Cod_Impuesto EQ 2>
										<cfset descIVA = '0%'>
									</cfif>
								</cfif>
								...
								<cfif rsEVentas.Tipo_Venta EQ "C" OR rsEVentas.Tipo_Venta EQ "E">
									...
									<cfquery datasource="sifinterfaces">
										...
										(<cfqueryparam cfsqltype ="cf_sql_numeric" value="#Maximus#">,
										 ...
										 0, 0, 0, 0,
										 abs(<cfqueryparam cfsqltype="cf_sql_money" value="#numberformat(rsDVentas.Total,'9.99')#">),
										 abs(<cfqueryparam cfsqltype="cf_sql_money" value="#numberformat(rsDVentas.Total * rsEVentas.Tipo_Cambio,'9.99')#">),
										 <cfqueryparam cfsqltype="cf_sql_float" value="#rsEVentas.Tipo_Cambio#">,
										 <cfqueryparam cfsqltype="cf_sql_integer" value="#varCconcepto#">,
										 getdate(), 0,
									...
									<cfquery datasource="sifinterfaces">
										...
										values
											(<cfqueryparam cfsqltype ="cf_sql_numeric" value="#Maximus#">,
											 ...
											 <cfqueryparam cfsqltype="cf_sql_integer" value="#Mes#">,
											 <cfif rsEVentas.Tipo_Venta EQ 'C'>
											 	<cfqueryparam cfsqltype="cf_sql_varchar" value="IVA Acreditable">,
											 <cfelse>
								...
								<cfif rsDVentas.MontoIEPS GT 0>
									...
									<cfif isdefined ("rsIEPS") and rsIVA.recordcount GT 0>
									...
									<cfquery datasource="sifinterfaces">
										...
										values
											(<cfqueryparam cfsqltype ="cf_sql_numeric" value="#Maximus#">,
											 ...
											 <cfqueryparam cfsqltype="cf_sql_integer" value="#Mes#">,
											 <cfif rsEVentas.Tipo_Venta EQ 'C'>
											 	<cfqueryparam cfsqltype="cf_sql_varchar" value="IEPS Acreditable">,
											 <cfelse>
											 	<cfqueryparam cfsqltype="cf_sql_varchar" value="IEPS Acreditable Pagado">,
											 </cfif>
											 ' ', ' ',
											 <!--- Naturaleza del movimiento depende si es venta o devolucion --->
											 <cfif rsEVentas.Tipo_Venta NEQ "D">
