...
<!--- Modificado por: Alejandro Bolaños
		Motivo: Se agregan las transacciones a los updates y se agrega la ejecucion de los procesos de Compra y Tesoreria
		Fecha: 10-Nov-2011--->
                    ...
                    <cfelse>
                        ...
                        <cfelse>
                            ...
                            <cfelse>						
								<cftransaction action="begin">
                                    <cftry>
                                        <!--- Encolamiento de Procesos de SWAPS --->
                                        <cfquery datasource="sifinterfaces">
                                            update ESIFLD_Facturas_Compra 
                                                set Estatus = 99
                                            where Estatus = 1 
                                ...
                                <cfelse>
									<!--- Ejecuta el Proceso Historicos --->
                                    <cfinvoke component="Interfaz_Historicos" method="Ejecuta" SIScodigo="LD"/>
                                </cfif>
							</cfif>
                        </cfif>
                    </cfif>
