<!--- ABL: Integracion de Ventas PMI --->
<!--- La Integracion de Venta, procesa todas las ventas de producto FACT y NOFACT generando los documentos de CxC correspondientes --->
<!--- La Interfaz solo funciona con versiones de Coldfusion 8.0 en adelante --->
<!--- Elaboró: Maria de los Angeles Blanco López 23 de Mayo del 2011--->
		...
		<cfif Application.dsinfo.sifinterfaces.type EQ "sybase">
			<cfquery name="rsActualiza" datasource="sifinterfaces" result="Rupdate">
        	    ...
        	    <cfif isdefined("Arguments.Disparo") and Arguments.Disparo>
            	    Estatus = 1 
	                and not exists (select 1 from ESIFLD_Facturas_Venta where Estatus in (10, 11,94,92,99,100)) <!----Quitar estatus 94--->
    	        <cfelse>    
        	    	Estatus = 99
