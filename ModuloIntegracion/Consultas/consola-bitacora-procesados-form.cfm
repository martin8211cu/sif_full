...
<cfif not isdefined("form.fltFuente")>
	<cfset form.fltFuente="-1">
</cfif>
...
<cfif isdefined("form.fltFuente") and (trim(form.fltFuente) EQ "1" or trim(form.fltFuente) EQ "-1")> 
    <cfquery name="rsCifrasControl" datasource="sifinterfaces">
        ...
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'PRFC' and Estatus in (1,2,3,0,6)
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros,
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'PRNF' and Estatus in (1,2,3,0,6)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Compra
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error'	 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'PRFC' and Estatus in (1,2,3,0,6)
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'PRNF' and Estatus in (1,2,3,0,6)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Venta
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros,
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'GAFC' and Estatus in (1,2,3,6,0)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Compra
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when	 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'GANF' and Estatus in (1,2,3,6,0)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Compra
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'OICO' and Estatus in (1,2,3,0,6)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Venta
        union 
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'OISO' and Estatus in (1,2,3,0,6)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Venta
        union
        ...
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'CE' and Estatus in (1,2,3,0) and Tipo_Documento != 'FU'
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Compra
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros,
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Compra where Clas_Compra = 'AB' and Estatus in (1,2,3,0) and Tipo_Documento != 'FU'
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Compra
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'CE' and Estatus in (1,2,3,0) and Tipo_Documento != 'FU'
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Venta
        union
        ...
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when 	12 then 'Diciembre'end as Mes, count (1) as Registros, 
        sum(isnull(Total,0)) as Importe, Usuario, Estatus = case Estatus  when 1 then 'Pendiente' when 2 then 'Procesado' when 3 then 'Error' when 6 then 'Error' 	when 0 then 'Eliminado' end, Moneda
        from ESIFLD_HFacturas_Venta where Clas_Venta = 'AB' and Estatus in (1,2,3,0) and Tipo_Documento != 'FU'
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda, Clas_Venta
        union
        ...
        from ESIFLD_HMovimientos_Inventario E
        inner join DSIFLD_HMovimientos_Inventario D on E.ID_Movimiento = D.ID_Movimiento where Estatus in (1,2,3,0,6)
        ...
        from SIFLD_HCosto_Venta where Estatus in (1,2,3,0,6)
        group by Ecodigo, Periodo, Mes, Usuario, Estatus, Moneda 
    </cfquery>
</cfif>

<cfif isdefined("form.fltFuente") and (trim(form.fltFuente) EQ "0" or trim(form.fltFuente) EQ "-1")> 
    <cfquery name="rsCifrasControl" datasource="sifinterfaces">
        insert into #TmpProcesos# (Ecodigo, Interfaz, Periodo, NumMes, Mes, Registros, Importe, Usuario, Estatus, Moneda)
        select Ecodigo,Interfaz = 'Compras FACT', Periodo, Mes as NumMes, case Mes when 1 then 'Enero' when 2 then    'Febrero' 	when 3 then 'Marzo' when 	4 then 'Abril' when 5 then 'Mayo' when 6 then 'Junio'
        when 7 then 'Julio' when 8 then 'Agosto' when 9 then 'Septiembre' when 10 then 'Octubre' when 11 then 'Noviembre' when			 	12 then 'Diciembre'end as Mes,count (1) as Registros, 
...
<form method="post" action = "consola-bitacora-procesados-form.cfm" name="formBitacora" style="margin:0 0 0 0">
    <table class="AreaFiltro" width="100%">
        ...
        <tr>
			...
			<td>
            	<select name="fltFuente">
                    <option value="-1" selected="selected">(Ambos...)</option>
                    <option value="0" <cfif isdefined("form.fltFuente") and trim(form.fltFuente) EQ "0">selected="selected"</cfif>>Achivos de Trabajo</option>
                    <option value="1" <cfif isdefined("form.fltFuente") and trim(form.fltFuente) EQ "1">selected="selected"</cfif>>Achivos Históricos</option>
                </select>
            </td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>	
