...
<!---				<cfset ArrayTrREF=ArrayNew(1)>
				...
				Tabla="#sifinterfacesdb#..ESIFLD_Facturas_Venta E inner join #sifinterfacesdb#..SIFLD_Costo_Venta V on V.Venta = E.Contrato inner join #sifinterfacesdb#..int_ICTS_SOIN I on I.CodICTS = convert (varchar(10),E.Ecodigo)"
