	...
	<table width="100%">
				...
				<!---<cfset ArrayTrREF=ArrayNew(1)>
			 	 <cfquery name="rsOrden" datasource="sifinterfaces">
				 	 select '' as Orden 
 					 union
					 select distinct(isnull(E.Contrato,V.Venta)) as Orden from ESIFLD_Facturas_Venta E
					 inner join SIFLD_Costo_Venta V on V.Venta = E.Contrato
					 inner join int_ICTS_SOIN I on I.CodICTS = convert (varchar(10),E.Ecodigo) 
				...
				Tabla="#sifinterfacesdb#..ESIFLD_Facturas_Venta E inner join #sifinterfacesdb#..SIFLD_Costo_Venta V on V.Venta = E.Contrato inner join #sifinterfacesdb#..int_ICTS_SOIN I on I.CodICTS = convert (varchar(10),E.Ecodigo) and  I.CodICTS = convert (varchar(10),V.Ecodigo) "
