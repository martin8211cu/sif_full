...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='IE 12 Neteo'>
...
<cfoutput>
	<form name="form1" method="post" action="interfaz12PMI-sql.cfm">
