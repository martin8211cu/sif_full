...
<cf_web_portlet_start border="true" skin="#Session.Preferences.Skin#" tituloalign="center" titulo='IE 14 Registro de Transferencias entre Cuentas'>
...
<cfoutput>
	<form name="form1" method="post" action="interfaz14PMI-sql.cfm">
					...
					<!--- CAMBIO PARA EXTRAER DATOS DE MAS DE UNA EMPRESA ICTS POR CADA EMPRESA EN SIF --->
							...
							<tr>
								<td colspan="2" align="center">
									<select name="EcodigoSDC">
										<cfloop query="rsCodICTS">
											<option value="#rsCodICTS.EcodigoSDC#"> #rsCodICTS.EcodigoSDC# - #rsCodICTS.Edescripcion# </option>
										</cfloop>
									</select>
								</td>
							</tr>
