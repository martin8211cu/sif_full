<cf_template template="#session.sitio.template#">
	...
	<cf_templatearea name="body">
	  ...
	  <cf_web_portlet_start titulo="Consulta de la Estructura de las Tablas de Entrada y Salida para la Interfaz #form.NumeroInterfaz#">
			...
			<form action="parametrosInterfaz.cfm" method="post" name="sql">
...
<cffunction name="sbMostrar" output="true">
	...
	<cfif rsStruct.recordCount GT 0>
		<cf_web_portlet_start titulo="TABLA: #Arguments.Tabla#" width="95%">
