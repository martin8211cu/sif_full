<cfcomponent>
	...
	<cffunction name="Procesa_Pago" access="public" returntype="boolean" output="no">
	...
	<cffunction name="Procesa_Pago_Normal" access="private" returntype="boolean" output="no">
		<cfargument name="query" required="yes" type="query">
	...
	<cffunction name="Procesa_Reembolso" access="public" returntype="boolean" output="no">
		<cfargument name="query" required="yes" type="query">
		<!--- 
	...
	<cffunction access="private" name="getCFident" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getCid" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getIcodigo" output="no" returntype="string">
		<cfargument name="InvokerName" required="no" type="string" default=""><!--- Nombre del método que lo invoca --->
	...
	<cffunction access="private" name="getTipoCambio" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getFecha_vIntegridad" output="no" returntype="date">
	...
	<cffunction access="private" name="getTipoCP" output="no" returntype="string">
	...
	<cffunction access="private" name="getBid" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getCBcc_vIntegridad" output="no" returntype="query">
	...
	<cffunction access="private" name="getTipPago_vIntegridad" output="no" returntype="string">
	...
	<cffunction access="private" name="getSNegocios" output="no" returntype="query">
	...
	<cffunction access="private" name="getMcodigobyMiso" output="no" returntype="string">
	...
	<cffunction access="private" name="getCodTran" output="no" returntype="string">
	...
	<cffunction access="private" name="getCodBTid" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getDoc" output="no" returntype="query">
	...
	<cffunction access="private" name="getMontoDoc" output="no" returntype="numeric">
	...
	<cffunction access="private" name="getMontoTotal" output="no" returntype="numeric">
	...
	================================================================================================--->
	<cffunction access="private" name="getNC_CcuentaCP" output="no" returntype="numeric">
		<cfargument name="SNcodigo"   required="yes" type="numeric">
