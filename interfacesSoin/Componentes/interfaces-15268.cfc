...
<cffunction name="fnGeneraQueryToXML" access="public" output="false" returntype="string">
...
<cffunction name="fnGeneraXMLToQuery" access="public" output="false" returntype="query">
	<cfargument name="XML" 		type="string"	required="yes">
...
<cffunction name="sbActivarCola" access="public" output="no">
	...
	<cfset var LvarControlLock	= now()>		<!--- now() OK --->
	...
	<cftry>
		...
		<cflock name="ColaCE#Arguments.CEcodigo#" timeout="10" throwontimeout="yes" type="exclusive">
			<!--- LvarControlLock: Se usa con la hora del CF --->
			<cfif datediff("s",LvarControlLock,now()) GT 1>		<!--- now() OK --->
...
<cffunction name="sbActivarColaInterfaz" access="public" output="no">
 ...
 <!--- OJO: aqui deberia verificarse los minutos de retardo --->
				...
				<cfloop query="rsProc">
					<cfset LvarMSG = fnActivarProceso	(Arguments.CEcodigo, Arguments.NumeroInterfaz, rsProc.IdProceso, rsProc.SecReproceso, rsInterfaz42.Componente, 'A', rsInterfaz42.ManejoDatos, rsProc.ParametrosSOIN, rsProc.TipoMovimientoSOIN, rsProc.EcodigoSDC, rsProc.UsucodigoInclusion)> 
				</cfloop>
			</cfloop>
			<cfquery name="rsInterfaz" datasource="sifinterfaces">
				update Interfaz
...
<cffunction name="sbActivarColaProceso" access="public" output="no">
	...
	<cfif rsProc.recordCount GT 0>
		<cfset fnActivarProceso	(Arguments.CEcodigo, Arguments.NumeroInterfaz, Arguments.IdProceso, rsProc.SecReproceso, rsProc.Componente, 'A', rsProc.ManejoDatos, rsProc.ParametrosSOIN, rsProc.TipoMovimientoSOIN, rsProc.EcodigoSDC, rsProc.UsucodigoInclusion)>
	<cfelse>
...
<cffunction name="sbDSINFO" access="public" output="false">
	...
	<cfif 	Len(trim(Application.dsinfo["sifinterfaces"].schema)) EQ 0 OR
...
<cffunction name="fnNow" access="public" output="no">
	...
	<cfelseif Application.dsinfo.sifinterfaces.type EQ "oracle">
		<cfreturn "SYSDATE">
	<cfelse>
		<cfthrow message="Base de datos #Application.dsinfo.sifinterfaces.type# no implementado">
	</cfif>
</cffunction>
...
<cffunction name="fnDataExists" returntype="boolean">
...
<cffunction name="fnUrlLocalhost" returntype="string" access="public">
	<cfargument name="url" type="string" required="true">
	<cfargument name="str" type="boolean" default="false">

	<cfif Arguments.str and find("/localhost:0/",arguments.url) GT 0>
		<cfreturn "(LOCAL) " & replace(arguments.url,"/localhost:0/","/#CGI.SERVER_NAME#:#CGI.SERVER_PORT#/","ONE")>
	<cfelse>
