...
BEGIN
	...
	/* Se generan los Datos de Entrada para la Interfaz: se insertan en las tablas remotas de Entrada IE7, ID7 e IS7, en la Base de Datos del Motor de Interfaces */
	insert into IE7
	...
	/* Si hubiera sub-detalle se inserta en IS7 dentro de un ciclo */
	...
	select @MSG = interfazToSoin(
		'http://desarrollo/cfmx/interfacesSoin/webService/interfaz-service.cfm',
	...
	BEGIN
		...
		/* Si la interfaz es Sincrónica o Directa, los datos de salida entarían en las tablas remotas de salida OE7, OD7 y OS7, en la base de datos del motor de interfaces */
