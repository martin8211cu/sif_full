...
Dim LvarConn As New clsSoinInterfaz
...
"        <CuentaFinanciera>" & LvarConn.XMLEncode("Esto es una '<Prueba>' de Ángel ") & "</CuentaFinanciera>" + _
