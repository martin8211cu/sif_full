...
print 'create function interfazSTRencode'
go

create function interfazSTRencode
	(
		strData varchar(16384)
	)
	returns varchar(16384)
	not deterministic
	language java
	parameter style java
	external name 'com.soin.interfaces.interfazToSoinSybase.STRencode(java.lang.String)'
go

print 'create function interfazSTRdecode'
go

create function interfazSTRdecode
	(
		xmlData varchar(16384)
	)
	returns varchar(16384)
	not deterministic
	language java
	parameter style java
	external name 'com.soin.interfaces.interfazToSoinSybase.STRdecode(java.lang.String)'
go

print 'create function interfazBASE64encode'
go

create function interfazBASE64encode
	(
	...
	language java
	parameter style java
	external name 'com.soin.interfaces.interfazToSoinSybase.BASE64encode(byte[])'
go

print 'create function interfazBASE64decode'
go

create function interfazBASE64decode
	(
		xmlData varchar(16384)
	)
	returns varbinary(16384)
	not deterministic
	language java
	parameter style java
	external name 'com.soin.interfaces.interfazToSoinSybase.BASE64decode(java.lang.String)'
go
