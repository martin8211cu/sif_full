...
<cfset LvarCconcepto	= #datosXML.row.Cconcepto.xmltext#>
<cfset LvarFechaIni		= #datosXML.row.Efecha_ini.xmltext#>
<cfset LvarFechaFin 	= #datosXML.row.Efecha_fin.xmltext#>
<cfset LvarEmodo 		= #datosXML.row.EModo.xmltext#>
