...
<cftransaction isolation="read_uncommitted">
	...
	<cfquery name="readInterfaz22" datasource="sifinterfaces">
		select IE22.ID,
        		Ecodigo,
                NumeroSocio,
                CodigoTransacion as CodigoTransaccion,
                Documento,
                CodigoMoneda,
                FechaTipoCambio,
                TipoCambio,
	...
	<cfif readInterfaz22.recordcount eq 0>
		<cfthrow message="Error en Interfaz 22. No existen datos de Entrada para el ID='#GvarID#' o no tiene detalles definidos. Proceso Cancelado!.">
	</cfif>
</cftransaction>
