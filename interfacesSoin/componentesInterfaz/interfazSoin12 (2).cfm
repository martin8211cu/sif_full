...
<cftransaction>
	...
	<cfoutput query="rsInput" group="ID">
		...
		<cfoutput>
			...
			<cfset LobjControl.Alta_DocNeteoDet(rsInput.Modulo, LvarID, rsInput.CodigoTransacion, rsInput.NumeroSocioDoc, rsInput.Monto, rsInput.Documento, rsInput.TransaccionOrigen)>
		</cfoutput>
	</cfoutput>
</cftransaction>
